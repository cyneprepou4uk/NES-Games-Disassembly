...
C - - - - - 0x00008C 00:C07C: 10 FB     BPL bra_C079_loop
...
C - - - - - 0x000099 00:C089: 20 91 D4  JSR sub_D491
C - - - - - 0x00009C 00:C08C: A9 00     LDA #$00
C - - - - - 0x00009E 00:C08E: 85 4F     STA ram_scroll_pos_Y
C - - - - - 0x0000A0 00:C090: 85 50     STA ram_base_nmt
C - - - - - 0x0000A2 00:C092: 20 67 D4  JSR sub_D467
loc_C095:
C D 2 - - - 0x0000A5 00:C095: 20 7F D1  JSR sub_D17F
...
C - - - - - 0x0000AF 00:C09F: 20 AB C7  JSR sub_C7AB
loc_C0A2:
C D 2 - - - 0x0000B2 00:C0A2: 20 C0 C9  JSR sub_C9C0_title_screen_handler
C - - - - - 0x0000B5 00:C0A5: 20 B5 C3  JSR sub_C3B5_demo_settings
C - - - - - 0x0000B8 00:C0A8: 20 1D C4  JSR sub_C41D
C - - - - - 0x0000BB 00:C0AB: 4C 9C C0  JMP loc_C09C
...
C - - - - - 0x0000C2 00:C0B2: 20 70 D4  JSR sub_D470
C - - - - - 0x0000C5 00:C0B5: 20 B0 C9  JSR sub_C9B0
...
C - - - - - 0x0000D9 00:C0C9: A9 84     LDA #$84
C - - - - - 0x0000DB 00:C0CB: 85 A0     STA ram_tank_status
C - - - - - 0x0000DD 00:C0CD: A9 00     LDA #$00
C - - - - - 0x0000DF 00:C0CF: 85 A8     STA ram_tank_type
C - - - - - 0x0000E1 00:C0D1: 85 6E     STA ram_006E
C - - - - - 0x0000E3 00:C0D3: 85 B0     STA ram_tank_wheels
C - - - - - 0x0000E5 00:C0D5: 85 81     STA ram_0081
C - - - - - 0x0000E7 00:C0D7: 85 7B     STA ram_007B
C - - - - - 0x0000E9 00:C0D9: 85 5C     STA ram_005C
C - - - - - 0x0000EB 00:C0DB: 85 4F     STA ram_scroll_pos_Y
C - - - - - 0x0000ED 00:C0DD: 85 50     STA ram_base_nmt
C - - - - - 0x0000EF 00:C0DF: 85 6F     STA ram_stun_timer
C - - - - - 0x0000F1 00:C0E1: 85 70     STA ram_stun_timer + 1
...
loc_C0EA:
C D 2 - - - 0x0000FA 00:C0EA: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
...
C - - - - - 0x000103 00:C0F3: A5 0B     LDA ram_frame_cnt_lo
C - - - - - 0x000105 00:C0F5: 29 10     AND #$10
C - - - - - 0x000107 00:C0F7: F0 03     BEQ bra_C0FC
C - - - - - 0x000109 00:C0F9: 20 A6 DE  JSR sub_DEA6
bra_C0FC:
...
C - - - - - 0x000118 00:C108: A5 81     LDA ram_0081
C - - - - - 0x00011A 00:C10A: D0 05     BNE bra_C111
C - - - - - 0x00011C 00:C10C: E6 81     INC ram_0081
C - - - - - 0x00011E 00:C10E: 4C 44 C1  JMP loc_C144
bra_C111:
C - - - - - 0x000121 00:C111: E6 5C     INC ram_005C
C - - - - - 0x000123 00:C113: A5 5C     LDA ram_005C
C - - - - - 0x000125 00:C115: C9 0E     CMP #$0E
C - - - - - 0x000127 00:C117: D0 2B     BNE bra_C144
C - - - - - 0x000129 00:C119: A9 00     LDA #$00
C - - - - - 0x00012B 00:C11B: 85 5C     STA ram_005C
...
C - - - - - 0x000136 00:C126: A5 81     LDA ram_0081
C - - - - - 0x000138 00:C128: D0 05     BNE bra_C12F
C - - - - - 0x00013A 00:C12A: E6 81     INC ram_0081
C - - - - - 0x00013C 00:C12C: 4C 44 C1  JMP loc_C144
bra_C12F:
C - - - - - 0x00013F 00:C12F: C6 5C     DEC ram_005C
C - - - - - 0x000141 00:C131: A5 5C     LDA ram_005C
C - - - - - 0x000143 00:C133: C9 FF     CMP #$FF
C - - - - - 0x000145 00:C135: D0 0D     BNE bra_C144
C - - - - - 0x000147 00:C137: A9 0D     LDA #$0D
C - - - - - 0x000149 00:C139: 85 5C     STA ram_005C
...
bra_C144:
loc_C144:
C D 2 - - - 0x000154 00:C144: 20 C6 C6  JSR sub_C6C6
bra_C147:
C - - - - - 0x000157 00:C147: A5 08     LDA ram_btn_press
C - - - - - 0x000159 00:C149: 29 08     AND #con_btn_Start
C - - - - - 0x00015B 00:C14B: D0 03     BNE bra_C150_return_to_title
C - - - - - 0x00015D 00:C14D: 4C EA C0  JMP loc_C0EA
bra_C150_return_to_title:
C - - - - - 0x000160 00:C150: A9 20     LDA #$20
C - - - - - 0x000162 00:C152: 85 6E     STA ram_006E
C - - - - - 0x000164 00:C154: E6 4B     INC ram_constr_usage_cnt
C - - - - - 0x000166 00:C156: 4C A2 C0  JMP loc_C0A2



loc_C159:
C D 2 - - - 0x000169 00:C159: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x00016C 00:C15C: 20 51 EA  JSR sub_EA51
C - - - - - 0x00016F 00:C15F: A9 1C     LDA #$1C
C - - - - - 0x000171 00:C161: 85 05     STA ram_0005
C - - - - - 0x000173 00:C163: A9 00     LDA #$00
C - - - - - 0x000175 00:C165: 85 4F     STA ram_scroll_pos_Y
C - - - - - 0x000177 00:C167: 85 50     STA ram_base_nmt
C - - - - - 0x000179 00:C169: 85 6D     STA ram_pause_flag
C - - - - - 0x00017B 00:C16B: A9 04     LDA #$04
C - - - - - 0x00017D 00:C16D: 85 4D     STA ram_bg_palette_id
C - - - - - 0x00017F 00:C16F: 20 90 CC  JSR sub_CC90
loc_C172_loop:
bra_C172_loop:
C D 2 - - - 0x000182 00:C172: 20 91 CA  JSR sub_CA91
C - - - - - 0x000185 00:C175: A5 4C     LDA ram_004C
...
C - - - - - 0x0001E4 00:C1D4: 20 B0 C9  JSR sub_C9B0
...
C - - - - - 0x0001F9 00:C1E9: 20 27 CC  JSR sub_CC27
C - - - - - 0x0001FC 00:C1EC: 20 B2 CC  JSR sub_CCB2
C - - - - - 0x0001FF 00:C1EF: A9 00     LDA #$00
C - - - - - 0x000201 00:C1F1: 85 4D     STA ram_bg_palette_id
C - - - - - 0x000203 00:C1F3: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x000206 00:C1F6: 20 31 C3  JSR sub_C331
bra_C1F9_loop:
C - - - - - 0x000209 00:C1F9: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
...
C - - - - - 0x000216 00:C206: 20 D8 E0  JSR sub_E0D8
C - - - - - 0x000219 00:C209: 20 A6 DE  JSR sub_DEA6
...
C - - - - - 0x000257 00:C247: 20 D8 E0  JSR sub_E0D8
...
sub_C295:
C - - - - - 0x0002A5 00:C295: 20 70 D4  JSR sub_D470
C - - - - - 0x0002A8 00:C298: 20 7E D4  JSR sub_D47E_clear_0400_07FF
C - - - - - 0x0002AB 00:C29B: 20 B4 D7  JSR sub_D7B4
C - - - - - 0x0002AE 00:C29E: 20 67 D4  JSR sub_D467
...
C - - - - - 0x0002C0 00:C2B0: 85 09     STA ram_btn_press + 1
bra_C2B2_RTS:
...
C - - - - - 0x0002C5 00:C2B5: 20 FE D9  JSR sub_D9FE_prepare_memory_for_bcd
C - - - - - 0x0002C8 00:C2B8: A2 1D     LDX #< ram_p2_score
C - - - - - 0x0002CA 00:C2BA: 20 FE D9  JSR sub_D9FE_prepare_memory_for_bcd
sub_C2BD:
C - - - - - 0x0002CD 00:C2BD: A9 00     LDA #$00
C - - - - - 0x0002CF 00:C2BF: 8D 01 01  STA ram_tank_upgrade
C - - - - - 0x0002D2 00:C2C2: 8D 02 01  STA ram_tank_upgrade + 1
...
C - - - - - 0x0002DB 00:C2CB: 85 4C     STA ram_004C
C - - - - - 0x0002DD 00:C2CD: A9 03     LDA #$03
C - - - - - 0x0002DF 00:C2CF: 85 51     STA ram_lives
C - - - - - 0x0002E1 00:C2D1: 85 52     STA ram_lives + 1
C - - - - - 0x0002E3 00:C2D3: 85 6A     STA ram_enemy_spawn_pos ; bzk useless write, it won't be read and will be overwritten
C - - - - - 0x0002E5 00:C2D5: A5 83     LDA ram_game_mode
C - - - - - 0x0002E7 00:C2D7: D0 04     BNE bra_C2DD    ; 2p mode
C - - - - - 0x0002E9 00:C2D9: A9 00     LDA #$00    ; 2nd player won't spawn if his lives = 00
C - - - - - 0x0002EB 00:C2DB: 85 52     STA ram_lives + 1
bra_C2DD:
...
; line 1815 at russian disassembly
...
C - - - - - 0x00032D 00:C31D: A5 0B     LDA ram_frame_cnt_lo
...
bra_C34A:
C - - - - - 0x00035A 00:C34A: A5 52     LDA ram_lives + 1
...
C - - - - - 0x00036D 00:C35D: 85 0A     STA ram_frame_cnt_hi
C - - - - - 0x00036F 00:C35F: 85 4B     STA ram_constr_usage_cnt
C - - - - - 0x000371 00:C361: 85 45     STA ram_shovel_timer
C - - - - - 0x000373 00:C363: 85 6F     STA ram_stun_timer
C - - - - - 0x000375 00:C365: 85 70     STA ram_stun_timer + 1
C - - - - - 0x000377 00:C367: 85 89     STA ram_helmet_timer
C - - - - - 0x000379 00:C369: 85 8A     STA ram_helmet_timer + 1
...
C - - - - - 0x0003C9 00:C3B9: A9 00     LDA #$00
C - - - - - 0x0003CB 00:C3BB: 85 4D     STA ram_bg_palette_id
C - - - - - 0x0003CD 00:C3BD: 20 BD C2  JSR sub_C2BD
C - - - - - 0x0003D0 00:C3C0: A9 03     LDA #$03
C - - - - - 0x0003D2 00:C3C2: 85 52     STA ram_lives + 1
C - - - - - 0x0003D4 00:C3C4: A9 00     LDA #$00
C - - - - - 0x0003D6 00:C3C6: 85 4F     STA ram_scroll_pos_Y
C - - - - - 0x0003D8 00:C3C8: 85 50     STA ram_base_nmt
C - - - - - 0x0003DA 00:C3CA: 85 0A     STA ram_frame_cnt_hi
C - - - - - 0x0003DC 00:C3CC: 85 0B     STA ram_frame_cnt_lo
C - - - - - 0x0003DE 00:C3CE: 20 B0 C9  JSR sub_C9B0
C - - - - - 0x0003E1 00:C3D1: A9 FF     LDA #$FF
...
C - - - - - 0x0003F0 00:C3E0: 20 70 D4  JSR sub_D470
C - - - - - 0x0003F3 00:C3E3: A2 1A     LDX #$1A
C - - - - - 0x0003F5 00:C3E5: 86 56     STX ram_0056
C - - - - - 0x0003F7 00:C3E7: A0 46     LDY #$46
C - - - - - 0x0003F9 00:C3E9: 84 57     STY ram_0057
C - - - - - 0x0003FB 00:C3EB: A9 D2     LDA #> tbl_D299_txt___battle
...
C - - - - - 0x00040C 00:C3FC: 84 57     STY ram_0057
C - - - - - 0x00040E 00:C3FE: A9 D2     LDA #> tbl_D2A0_txt___city
...
C - - - - - 0x000425 00:C415: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
...
sub_C41D:
bra_C41D_loop:
C - - - - - 0x00042D 00:C41D: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
...
C - - - - - 0x000458 00:C448: 4C A2 C0  JMP loc_C0A2



sub_C44B:
C - - - - - 0x00045B 00:C44B: 20 70 D4  JSR sub_D470
C - - - - - 0x00045E 00:C44E: A9 1C     LDA #$1C
C - - - - - 0x000460 00:C450: 85 05     STA ram_0005
C - - - - - 0x000462 00:C452: A9 00     LDA #$00
C - - - - - 0x000464 00:C454: 85 4F     STA ram_scroll_pos_Y
...
C - - - - - 0x00046D 00:C45D: 86 56     STX ram_0056
C - - - - - 0x00046F 00:C45F: A0 32     LDY #$32
C - - - - - 0x000471 00:C461: 84 57     STY ram_0057
C - - - - - 0x000473 00:C463: A9 D2     LDA #> tbl_D2B5_txt___hiscore
...
C - - - - - 0x000489 00:C479: 85 0A     STA ram_frame_cnt_hi
...
bra_C486_loop:
C - - - - - 0x000496 00:C486: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x000499 00:C489: A5 0B     LDA ram_frame_cnt_lo
...
C - - - - - 0x0004A7 00:C497: A9 00     LDA #$00
...
C - - - - - 0x0004AC 00:C49C: 20 70 D4  JSR sub_D470
C - - - - - 0x0004AF 00:C49F: A9 1C     LDA #$1C
C - - - - - 0x0004B1 00:C4A1: 85 05     STA ram_0005
C - - - - - 0x0004B3 00:C4A3: A9 00     LDA #$00
C - - - - - 0x0004B5 00:C4A5: 85 4F     STA ram_scroll_pos_Y
C - - - - - 0x0004B7 00:C4A7: 85 50     STA ram_base_nmt
C - - - - - 0x0004B9 00:C4A9: 20 7E D4  JSR sub_D47E_clear_0400_07FF
C - - - - - 0x0004BC 00:C4AC: 20 B4 D7  JSR sub_D7B4
C - - - - - 0x0004BF 00:C4AF: 20 67 D4  JSR sub_D467
C - - - - - 0x0004C2 00:C4B2: 20 67 C5  JSR sub_C567_wait_64_frames_
C - - - - - 0x0004C5 00:C4B5: 20 67 C5  JSR sub_C567_wait_64_frames_
C - - - - - 0x0004C8 00:C4B8: A9 D3     LDA #> tbl_D30F_txt___this_program_was
C - - - - - 0x0004CA 00:C4BA: 85 12     STA ram_0012
C - - - - - 0x0004CC 00:C4BC: A9 0F     LDA #< tbl_D30F_txt___this_program_was
C - - - - - 0x0004CE 00:C4BE: 85 11     STA ram_0011
C - - - - - 0x0004D0 00:C4C0: A2 08     LDX #$08
C - - - - - 0x0004D2 00:C4C2: A0 08     LDY #$08
C - - - - - 0x0004D4 00:C4C4: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x0004D7 00:C4C7: 20 67 C5  JSR sub_C567_wait_64_frames_
C - - - - - 0x0004DA 00:C4CA: A9 D2     LDA #> tbl_D284_txt___written_by
C - - - - - 0x0004DC 00:C4CC: 85 12     STA ram_0012
C - - - - - 0x0004DE 00:C4CE: A9 84     LDA #< tbl_D284_txt___written_by
C - - - - - 0x0004E0 00:C4D0: 85 11     STA ram_0011
C - - - - - 0x0004E2 00:C4D2: A2 08     LDX #$08
C - - - - - 0x0004E4 00:C4D4: A0 0A     LDY #$0A
C - - - - - 0x0004E6 00:C4D6: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x0004E9 00:C4D9: 20 67 C5  JSR sub_C567_wait_64_frames_
C - - - - - 0x0004EC 00:C4DC: A9 D3     LDA #> tbl_D334_txt___open_reach
C - - - - - 0x0004EE 00:C4DE: 85 12     STA ram_0012
C - - - - - 0x0004F0 00:C4E0: A9 34     LDA #< tbl_D334_txt___open_reach
C - - - - - 0x0004F2 00:C4E2: 85 11     STA ram_0011
C - - - - - 0x0004F4 00:C4E4: A2 08     LDX #$08
C - - - - - 0x0004F6 00:C4E6: A0 0C     LDY #$0C
C - - - - - 0x0004F8 00:C4E8: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x0004FB 00:C4EB: 20 67 C5  JSR sub_C567_wait_64_frames_
C - - - - - 0x0004FE 00:C4EE: A9 D3     LDA #> tbl_D34D_txt___who_loves_noriko
C - - - - - 0x000500 00:C4F0: 85 12     STA ram_0012
C - - - - - 0x000502 00:C4F2: A9 4D     LDA #< tbl_D34D_txt___who_loves_noriko
C - - - - - 0x000504 00:C4F4: 85 11     STA ram_0011
C - - - - - 0x000506 00:C4F6: A2 08     LDX #$08
C - - - - - 0x000508 00:C4F8: A0 0E     LDY #$0E
C - - - - - 0x00050A 00:C4FA: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x00050D 00:C4FD: 20 67 C5  JSR sub_C567_wait_64_frames_
C - - - - - 0x000510 00:C500: A9 D3     LDA #> tbl_D341_tile___dot
C - - - - - 0x000512 00:C502: 85 12     STA ram_0012
C - - - - - 0x000514 00:C504: A9 3F     LDA #< tbl_D341_tile___dot
C - - - - - 0x000516 00:C506: 85 11     STA ram_0011
C - - - - - 0x000518 00:C508: A2 08     LDX #$08
C - - - - - 0x00051A 00:C50A: A0 10     LDY #$10
C - - - - - 0x00051C 00:C50C: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x00051F 00:C50F: 20 67 C5  JSR sub_C567_wait_64_frames_
C - - - - - 0x000522 00:C512: A9 D3     LDA #> tbl_D341_tile___dot
C - - - - - 0x000524 00:C514: 85 12     STA ram_0012
C - - - - - 0x000526 00:C516: A9 3F     LDA #< tbl_D341_tile___dot
C - - - - - 0x000528 00:C518: 85 11     STA ram_0011
C - - - - - 0x00052A 00:C51A: A2 09     LDX #$09
C - - - - - 0x00052C 00:C51C: A0 10     LDY #$10
C - - - - - 0x00052E 00:C51E: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000531 00:C521: 20 67 C5  JSR sub_C567_wait_64_frames_
C - - - - - 0x000534 00:C524: A9 D3     LDA #> tbl_D341_tile___dot
C - - - - - 0x000536 00:C526: 85 12     STA ram_0012
C - - - - - 0x000538 00:C528: A9 3F     LDA #< tbl_D341_tile___dot
C - - - - - 0x00053A 00:C52A: 85 11     STA ram_0011
C - - - - - 0x00053C 00:C52C: A2 0A     LDX #$0A
C - - - - - 0x00053E 00:C52E: A0 10     LDY #$10
C - - - - - 0x000540 00:C530: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000543 00:C533: 20 67 C5  JSR sub_C567_wait_64_frames_
C - - - - - 0x000546 00:C536: A9 D3     LDA #> tbl_D341_tile___dot
C - - - - - 0x000548 00:C538: 85 12     STA ram_0012
C - - - - - 0x00054A 00:C53A: A9 3F     LDA #< tbl_D341_tile___dot
C - - - - - 0x00054C 00:C53C: 85 11     STA ram_0011
C - - - - - 0x00054E 00:C53E: A2 0B     LDX #$0B
C - - - - - 0x000550 00:C540: A0 10     LDY #$10
C - - - - - 0x000552 00:C542: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000555 00:C545: 20 67 C5  JSR sub_C567_wait_64_frames_
C - - - - - 0x000558 00:C548: A9 D3     LDA #> tbl_D341_tile___dot
C - - - - - 0x00055A 00:C54A: 85 12     STA ram_0012
C - - - - - 0x00055C 00:C54C: A9 3F     LDA #< tbl_D341_tile___dot
C - - - - - 0x00055E 00:C54E: 85 11     STA ram_0011
C - - - - - 0x000560 00:C550: A2 0C     LDX #$0C
C - - - - - 0x000562 00:C552: A0 10     LDY #$10
C - - - - - 0x000564 00:C554: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000567 00:C557: 20 75 C5  JSR sub_C575
C - - - - - 0x00056A 00:C55A: 20 70 D4  JSR sub_D470
C - - - - - 0x00056D 00:C55D: 20 B0 C9  JSR sub_C9B0
C - - - - - 0x000570 00:C560: 20 B4 D7  JSR sub_D7B4
C - - - - - 0x000573 00:C563: 20 67 D4  JSR sub_D467
C - - - - - 0x000576 00:C566: 60        RTS



sub_C567_wait_64_frames_:
C - - - - - 0x000577 00:C567: A9 00     LDA #$00
C - - - - - 0x000579 00:C569: 85 0B     STA ram_frame_cnt_lo
bra_C56B_loop:
C - - - - - 0x00057B 00:C56B: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x00057E 00:C56E: A5 0B     LDA ram_frame_cnt_lo
...
C - - - - - 0x000587 00:C577: 85 56     STA ram_0056
...
bra_C595_loop:
C - - - - - 0x0005A5 00:C595: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x0005A8 00:C598: E6 57     INC ram_0057
C - - - - - 0x0005AA 00:C59A: A9 9D     LDA #$9D
C - - - - - 0x0005AC 00:C59C: 85 53     STA ram_0053
C - - - - - 0x0005AE 00:C59E: A9 01     LDA #$01
C - - - - - 0x0005B0 00:C5A0: 85 04     STA ram_0004
C - - - - - 0x0005B2 00:C5A2: A6 56     LDX ram_0056
C - - - - - 0x0005B4 00:C5A4: A4 57     LDY ram_0057
C - - - - - 0x0005B6 00:C5A6: 20 7B DA  JSR sub_DA7B
C - - - - - 0x0005B9 00:C5A9: A5 57     LDA ram_0057
...
sub_C5B0:
C - - - - - 0x0005C0 00:C5B0: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
...
bra_C5C3:
C - - - - - 0x0005D3 00:C5C3: 85 00     STA ram_0000
C - - - - - 0x0005D5 00:C5C5: A9 03     LDA #$03
C - - - - - 0x0005D7 00:C5C7: 38        SEC
C - - - - - 0x0005D8 00:C5C8: E5 00     SBC ram_0000
C - - - - - 0x0005DA 00:C5CA: 0A        ASL
C - - - - - 0x0005DB 00:C5CB: 0A        ASL
C - - - - - 0x0005DC 00:C5CC: 18        CLC
C - - - - - 0x0005DD 00:C5CD: 69 A1     ADC #$A1
C - - - - - 0x0005DF 00:C5CF: 85 53     STA ram_0053
C - - - - - 0x0005E1 00:C5D1: A6 56     LDX ram_0056
C - - - - - 0x0005E3 00:C5D3: A4 57     LDY ram_0057
C - - - - - 0x0005E5 00:C5D5: 20 7B DA  JSR sub_DA7B
C - - - - - 0x0005E8 00:C5D8: 60        RTS



sub_C5D9:
C - - - - - 0x0005E9 00:C5D9: 20 70 D4  JSR sub_D470
C - - - - - 0x0005EC 00:C5DC: A9 1C     LDA #$1C
C - - - - - 0x0005EE 00:C5DE: 85 05     STA ram_0005
C - - - - - 0x0005F0 00:C5E0: A9 00     LDA #$00
C - - - - - 0x0005F2 00:C5E2: 85 4F     STA ram_scroll_pos_Y
...
C - - - - - 0x0005FB 00:C5EB: 86 56     STX ram_0056
C - - - - - 0x0005FD 00:C5ED: A0 46     LDY #$46
C - - - - - 0x0005FF 00:C5EF: 84 57     STY ram_0057
C - - - - - 0x000601 00:C5F1: A9 D3     LDA #> tbl_D343_txt___game
...
C - - - - - 0x000612 00:C602: 84 57     STY ram_0057
C - - - - - 0x000614 00:C604: A9 D3     LDA #> tbl_D348_txt___over
...
C - - - - - 0x000627 00:C617: 85 0A     STA ram_frame_cnt_hi
...
bra_C624_loop:
C - - - - - 0x000634 00:C624: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
...
C - - - - - 0x000642 00:C632: 20 70 D4  JSR sub_D470
C - - - - - 0x000645 00:C635: 20 7E D4  JSR sub_D47E_clear_0400_07FF
C - - - - - 0x000648 00:C638: 20 B4 D7  JSR sub_D7B4
C - - - - - 0x00064B 00:C63B: 20 67 D4  JSR sub_D467
C - - - - - 0x00064E 00:C63E: 20 51 EA  JSR sub_EA51
...
C - - - - - 0x000662 00:C652: 85 71     STA ram_0071
C - - - - - 0x000664 00:C654: A5 87     LDA ram_bonus_pos_Y
C - - - - - 0x000666 00:C656: 85 72     STA ram_0072
C - - - - - 0x000668 00:C658: 20 A2 DD  JSR sub_DDA2
C - - - - - 0x00066B 00:C65B: 4C A5 C6  JMP loc_C6A5
bra_C65E:
C - - - - - 0x00066E 00:C65E: B5 A2     LDA ram_tank_status + 2,X
C - - - - - 0x000670 00:C660: 10 12     BPL bra_C674
C - - - - - 0x000672 00:C662: C9 E0     CMP #$E0
C - - - - - 0x000674 00:C664: B0 0E     BCS bra_C674
C - - - - - 0x000676 00:C666: B5 92     LDA ram_tank_pos_X + 2,X
C - - - - - 0x000678 00:C668: 85 71     STA ram_0071
C - - - - - 0x00067A 00:C66A: B5 9A     LDA ram_tank_pos_Y + 2,X
C - - - - - 0x00067C 00:C66C: 85 72     STA ram_0072
C - - - - - 0x00067E 00:C66E: 20 A2 DD  JSR sub_DDA2
C - - - - - 0x000681 00:C671: 4C A5 C6  JMP loc_C6A5
bra_C674:
C - - - - - 0x000684 00:C674: B5 A4     LDA ram_tank_status + 4,X
C - - - - - 0x000686 00:C676: 10 12     BPL bra_C68A
C - - - - - 0x000688 00:C678: C9 E0     CMP #$E0
C - - - - - 0x00068A 00:C67A: B0 0E     BCS bra_C68A
C - - - - - 0x00068C 00:C67C: B5 94     LDA ram_tank_pos_X + 4,X
C - - - - - 0x00068E 00:C67E: 85 71     STA ram_0071
C - - - - - 0x000690 00:C680: B5 9C     LDA ram_tank_pos_Y + 4,X
C - - - - - 0x000692 00:C682: 85 72     STA ram_0072
C - - - - - 0x000694 00:C684: 20 A2 DD  JSR sub_DDA2
C - - - - - 0x000697 00:C687: 4C A5 C6  JMP loc_C6A5
bra_C68A:
C - - - - - 0x00069A 00:C68A: B5 A3     LDA ram_tank_status + 3,X
C - - - - - 0x00069C 00:C68C: 10 12     BPL bra_C6A0
C - - - - - 0x00069E 00:C68E: C9 E0     CMP #$E0
C - - - - - 0x0006A0 00:C690: B0 0E     BCS bra_C6A0
C - - - - - 0x0006A2 00:C692: B5 93     LDA ram_tank_pos_X + 3,X
C - - - - - 0x0006A4 00:C694: 85 71     STA ram_0071
C - - - - - 0x0006A6 00:C696: B5 9B     LDA ram_tank_pos_Y + 3,X
C - - - - - 0x0006A8 00:C698: 85 72     STA ram_0072
...
C - - - - - 0x0006E8 00:C6D8: E6 7B     INC ram_007B
C - - - - - 0x0006EA 00:C6DA: A9 00     LDA #$00
C - - - - - 0x0006EC 00:C6DC: 85 81     STA ram_0081
C - - - - - 0x0006EE 00:C6DE: 4C E5 C6  JMP loc_C6E5
bra_C6E1:
C - - - - - 0x0006F1 00:C6E1: A9 00     LDA #$00
C - - - - - 0x0006F3 00:C6E3: 85 7B     STA ram_007B
loc_C6E5:
C D 2 - - - 0x0006F5 00:C6E5: A5 7B     LDA ram_007B
...
C - - - - - 0x000703 00:C6F3: 20 51 E4  JSR sub_E451_check_dpad_buttons
...
C - - - - - 0x00070D 00:C6FD: 85 7B     STA ram_007B
...
bra_C722_loop:
C - - - - - 0x000732 00:C722: 95 73     STA ram_p1_enemy_type_kill_cnt,X
...
; bzk garbage
; hidden unused debug mode, displays content of ZP address
...
C - - - - - 0x0007BD 00:C7AD: 85 4F     STA ram_scroll_pos_Y
C - - - - - 0x0007BF 00:C7AF: 85 50     STA ram_base_nmt
bra_C7B1_loop:
C - - - - - 0x0007C1 00:C7B1: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x0007C4 00:C7B4: E6 4F     INC ram_scroll_pos_Y
C - - - - - 0x0007C6 00:C7B6: A5 08     LDA ram_btn_press
C - - - - - 0x0007C8 00:C7B8: 29 0C     AND #con_btns_SS
C - - - - - 0x0007CA 00:C7BA: D0 07     BNE bra_C7C3
C - - - - - 0x0007CC 00:C7BC: A5 4F     LDA ram_scroll_pos_Y
...
C - - - - - 0x0007D5 00:C7C5: 4C A2 C0  JMP loc_C0A2
...
C - - - - - 0x0007E4 00:C7D4: 85 12     STA ram_0012
C - - - - - 0x0007E6 00:C7D6: A9 41     LDA #< tbl_D341_tile___player_icon
C - - - - - 0x0007E8 00:C7D8: 85 11     STA ram_0011
C - - - - - 0x0007EA 00:C7DA: A2 1D     LDX #$1D
C - - - - - 0x0007EC 00:C7DC: A0 12     LDY #$12
...
C - - - - - 0x000804 00:C7F4: 85 12     STA ram_0012
C - - - - - 0x000806 00:C7F6: A9 41     LDA #< tbl_D341_tile___player_icon
C - - - - - 0x000808 00:C7F8: 85 11     STA ram_0011
C - - - - - 0x00080A 00:C7FA: A2 1D     LDX #$1D
C - - - - - 0x00080C 00:C7FC: A0 15     LDY #$15
...
C - - - - - 0x00082C 00:C81C: 65 00     ADC ram_0000
...
C - - - - - 0x00083D 00:C82D: 85 6B     STA ram_006B
C - - - - - 0x00083F 00:C82F: 60        RTS



sub_C830:
C - - - - - 0x000840 00:C830: A9 D2     LDA #> tbl_D2AB_txt___Ip
C - - - - - 0x000842 00:C832: 85 12     STA ram_0012
C - - - - - 0x000844 00:C834: A9 AB     LDA #< tbl_D2AB_txt___Ip
C - - - - - 0x000846 00:C836: 85 11     STA ram_0011
C - - - - - 0x000848 00:C838: A2 1D     LDX #$1D
C - - - - - 0x00084A 00:C83A: A0 11     LDY #$11
...
C - - - - - 0x000857 00:C847: F0 0F     BEQ bra_C858_RTS    ; 1p mode
bra_C849_it_is_demo:
C - - - - - 0x000859 00:C849: A9 D2     LDA #> tbl_D2AE_txt___IIp
C - - - - - 0x00085B 00:C84B: 85 12     STA ram_0012
C - - - - - 0x00085D 00:C84D: A9 AE     LDA #< tbl_D2AE_txt___IIp
C - - - - - 0x00085F 00:C84F: 85 11     STA ram_0011
C - - - - - 0x000861 00:C851: A2 1D     LDX #$1D
C - - - - - 0x000863 00:C853: A0 14     LDY #$14
...
sub_C859:
C - - - - - 0x000869 00:C859: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x00086C 00:C85C: A9 D3     LDA #> tbl_D365_tiles___flag1
C - - - - - 0x00086E 00:C85E: 85 12     STA ram_0012
C - - - - - 0x000870 00:C860: A9 65     LDA #< tbl_D365_tiles___flag1
C - - - - - 0x000872 00:C862: 85 11     STA ram_0011
C - - - - - 0x000874 00:C864: A2 1D     LDX #$1D
C - - - - - 0x000876 00:C866: A0 17     LDY #$17
C - - - - - 0x000878 00:C868: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x00087B 00:C86B: A9 D3     LDA #> tbl_D368_tiles___flag2
C - - - - - 0x00087D 00:C86D: 85 12     STA ram_0012
C - - - - - 0x00087F 00:C86F: A9 68     LDA #< tbl_D368_tiles___flag2
C - - - - - 0x000881 00:C871: 85 11     STA ram_0011
C - - - - - 0x000883 00:C873: A2 1D     LDX #$1D
C - - - - - 0x000885 00:C875: A0 18     LDY #$18
C - - - - - 0x000887 00:C877: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x00088A 00:C87A: A9 6E     LDA #$6E
C - - - - - 0x00088C 00:C87C: 85 60     STA ram_0060
C - - - - - 0x00088E 00:C87E: A5 85     LDA ram_stage
C - - - - - 0x000890 00:C880: 20 13 DA  JSR sub_DA13_calculate_decimal
C - - - - - 0x000893 00:C883: A0 36     LDY #$36
C - - - - - 0x000895 00:C885: A2 19     LDX #$19
C - - - - - 0x000897 00:C887: 20 34 D9  JSR sub_D934
C - - - - - 0x00089A 00:C88A: A0 19     LDY #$19
C - - - - - 0x00089C 00:C88C: 20 DD D6  JSR sub_D6DD
C - - - - - 0x00089F 00:C88F: A9 00     LDA #$00
C - - - - - 0x0008A1 00:C891: 85 60     STA ram_0060
...
C - - - - - 0x0008B7 00:C8A7: 85 12     STA ram_0012
C - - - - - 0x0008B9 00:C8A9: A9 62     LDA #< tbl_D362_tile___enemy_icon
C - - - - - 0x0008BB 00:C8AB: 85 11     STA ram_0011
...
C - - - - - 0x0008C6 00:C8B6: 85 12     STA ram_0012
C - - - - - 0x0008C8 00:C8B8: A9 6B     LDA #< tbl_D36B_tile___gray
C - - - - - 0x0008CA 00:C8BA: 85 11     STA ram_0011
...
C - - - - - 0x00090D 00:C8FD: A5 0B     LDA ram_frame_cnt_lo
...
C - - - - - 0x000915 00:C905: 85 04     STA ram_0004
C - - - - - 0x000917 00:C907: A9 00     LDA #$00
C - - - - - 0x000919 00:C909: 85 6E     STA ram_006E
C - - - - - 0x00091B 00:C90B: A2 64     LDX #$64
C - - - - - 0x00091D 00:C90D: A0 80     LDY #$80
C - - - - - 0x00091F 00:C90F: A9 17     LDA #$17
C - - - - - 0x000921 00:C911: 85 53     STA ram_0053
C - - - - - 0x000923 00:C913: 20 2B DA  JSR sub_DA2B_display_sprite
C - - - - - 0x000926 00:C916: A2 6C     LDX #$6C
C - - - - - 0x000928 00:C918: A0 80     LDY #$80
C - - - - - 0x00092A 00:C91A: A9 19     LDA #$19
C - - - - - 0x00092C 00:C91C: 85 53     STA ram_0053
C - - - - - 0x00092E 00:C91E: 20 2B DA  JSR sub_DA2B_display_sprite
C - - - - - 0x000931 00:C921: A2 74     LDX #$74
C - - - - - 0x000933 00:C923: A0 80     LDY #$80
C - - - - - 0x000935 00:C925: A9 1B     LDA #$1B
C - - - - - 0x000937 00:C927: 85 53     STA ram_0053
C - - - - - 0x000939 00:C929: 20 2B DA  JSR sub_DA2B_display_sprite
C - - - - - 0x00093C 00:C92C: A2 7C     LDX #$7C
C - - - - - 0x00093E 00:C92E: A0 80     LDY #$80
C - - - - - 0x000940 00:C930: A9 1D     LDA #$1D
C - - - - - 0x000942 00:C932: 85 53     STA ram_0053
C - - - - - 0x000944 00:C934: 20 2B DA  JSR sub_DA2B_display_sprite
C - - - - - 0x000947 00:C937: A2 84     LDX #$84
C - - - - - 0x000949 00:C939: A0 80     LDY #$80
C - - - - - 0x00094B 00:C93B: A9 1F     LDA #$1F
C - - - - - 0x00094D 00:C93D: 85 53     STA ram_0053
C - - - - - 0x00094F 00:C93F: 20 2B DA  JSR sub_DA2B_display_sprite
C - - - - - 0x000952 00:C942: A9 20     LDA #$20
C - - - - - 0x000954 00:C944: 85 6E     STA ram_006E
bra_C946_RTS:
...
C - - - - - 0x00097F 00:C96F: 85 6E     STA ram_006E
...
C - - - - - 0x0009DE 00:C9CE: A9 83     LDA #$83
C - - - - - 0x0009E0 00:C9D0: 85 A0     STA ram_tank_status
C - - - - - 0x0009E2 00:C9D2: A9 00     LDA #$00
C - - - - - 0x0009E4 00:C9D4: 85 0A     STA ram_frame_cnt_hi
C - - - - - 0x0009E6 00:C9D6: 85 A8     STA ram_tank_type
C - - - - - 0x0009E8 00:C9D8: 85 B0     STA ram_tank_wheels
C - - - - - 0x0009EA 00:C9DA: 85 6F     STA ram_stun_timer
C - - - - - 0x0009EC 00:C9DC: 85 70     STA ram_stun_timer + 1
C - - - - - 0x0009EE 00:C9DE: 85 4F     STA ram_scroll_pos_Y
...
bra_C9F5:
C - - - - - 0x000A05 00:C9F5: 20 A6 DE  JSR sub_DEA6
...
C - - - - - 0x000A12 00:CA02: 85 0A     STA ram_frame_cnt_hi
...
C - - - - - 0x000A1A 00:CA0A: A5 09     LDA ram_btn_press + 1
...
C - - - - - 0x000A23 00:CA13: 65 4A     ADC ram_hidden_cutscene_cnt
C - - - - - 0x000A25 00:CA15: 85 4A     STA ram_hidden_cutscene_cnt
...
C - - - - - 0x000A2D 00:CA1D: A5 09     LDA ram_btn_press + 1
C - - - - - 0x000A2F 00:CA1F: 29 02     AND #con_btn_B
C - - - - - 0x000A31 00:CA21: F0 02     BEQ bra_CA25
C - - - - - 0x000A33 00:CA23: C6 4A     DEC ram_hidden_cutscene_cnt
bra_CA25:
...
C - - - - - 0x000A3F 00:CA2F: 20 85 CA  JSR sub_CA85_calculate_cursor_position
C - - - - - 0x000A42 00:CA32: A5 0A     LDA ram_frame_cnt_hi
...
C - - - - - 0x000A59 00:CA49: A5 4A     LDA ram_hidden_cutscene_cnt
C - - - - - 0x000A5B 00:CA4B: C9 74     CMP #$74
C - - - - - 0x000A5D 00:CA4D: D0 03     BNE bra_CA52
C - - - - - 0x000A5F 00:CA4F: 20 9C C4  JSR sub_C49C_play_hidden_cutscene
bra_CA52:
C - - - - - 0x000A62 00:CA52: A9 00     LDA #$00
...
C - - - - - 0x000A6F 00:CA5F: 85 11     STA ram_0011
C - - - - - 0x000A71 00:CA61: B9 6A CA  LDA tbl_CA69_game_mode_handler + 1,Y
C - - - - - 0x000A74 00:CA64: 85 12     STA ram_0012
C - - - - - 0x000A76 00:CA66: 6C 11 00  JMP (ram_0011)
...
C - - - - - 0x000A88 00:CA78: 20 B3 C2  JSR sub_C2B3
...
sub_CA85_calculate_cursor_position:
; main menu
...
sub_CA91:
C - - - - - 0x000AA1 00:CA91: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x000AA4 00:CA94: A2 0C     LDX #$0C
C - - - - - 0x000AA6 00:CA96: A0 0E     LDY #$0E
C - - - - - 0x000AA8 00:CA98: 20 FB D5  JSR sub_D5FB_calculate_ppu_address
C - - - - - 0x000AAB 00:CA9B: A6 0C     LDX ram_buffer_index
C - - - - - 0x000AAD 00:CA9D: 18        CLC
C - - - - - 0x000AAE 00:CA9E: 69 1C     ADC #$1C
C - - - - - 0x000AB0 00:CAA0: 9D 80 01  STA ram_ppu_buffer,X
C - - - - - 0x000AB3 00:CAA3: E8        INX
C - - - - - 0x000AB4 00:CAA4: 98        TYA
C - - - - - 0x000AB5 00:CAA5: 9D 80 01  STA ram_ppu_buffer,X  ; 0181
C - - - - - 0x000AB8 00:CAA8: E8        INX
C - - - - - 0x000AB9 00:CAA9: A9 23     LDA #$23
C - - - - - 0x000ABB 00:CAAB: 9D 80 01  STA ram_ppu_buffer,X  ; 0182
C - - - - - 0x000ABE 00:CAAE: E8        INX
C - - - - - 0x000ABF 00:CAAF: A9 24     LDA #$24
C - - - - - 0x000AC1 00:CAB1: 9D 80 01  STA ram_ppu_buffer,X  ; 0183
C - - - - - 0x000AC4 00:CAB4: E8        INX
C - - - - - 0x000AC5 00:CAB5: A9 25     LDA #$25
C - - - - - 0x000AC7 00:CAB7: 9D 80 01  STA ram_ppu_buffer,X  ; 0184
C - - - - - 0x000ACA 00:CABA: E8        INX
C - - - - - 0x000ACB 00:CABB: A9 26     LDA #$26
C - - - - - 0x000ACD 00:CABD: 9D 80 01  STA ram_ppu_buffer,X  ; 0185
C - - - - - 0x000AD0 00:CAC0: E8        INX
C - - - - - 0x000AD1 00:CAC1: A9 27     LDA #$27
C - - - - - 0x000AD3 00:CAC3: 9D 80 01  STA ram_ppu_buffer,X  ; 0186
C - - - - - 0x000AD6 00:CAC6: E8        INX
C - - - - - 0x000AD7 00:CAC7: A9 11     LDA #$11
C - - - - - 0x000AD9 00:CAC9: 9D 80 01  STA ram_ppu_buffer,X  ; 0187
C - - - - - 0x000ADC 00:CACC: E8        INX
C - - - - - 0x000ADD 00:CACD: A9 11     LDA #$11
C - - - - - 0x000ADF 00:CACF: 9D 80 01  STA ram_ppu_buffer,X  ; 0188
C - - - - - 0x000AE2 00:CAD2: E8        INX
C - - - - - 0x000AE3 00:CAD3: A9 FF     LDA #$FF
C - - - - - 0x000AE5 00:CAD5: 9D 80 01  STA ram_ppu_buffer,X  ; 0189
C - - - - - 0x000AE8 00:CAD8: E8        INX
C - - - - - 0x000AE9 00:CAD9: 86 0C     STX ram_buffer_index
C - - - - - 0x000AEB 00:CADB: A9 6E     LDA #$6E
C - - - - - 0x000AED 00:CADD: 85 60     STA ram_0060
C - - - - - 0x000AEF 00:CADF: A5 85     LDA ram_stage
C - - - - - 0x000AF1 00:CAE1: 20 13 DA  JSR sub_DA13_calculate_decimal
C - - - - - 0x000AF4 00:CAE4: A0 36     LDY #$36
C - - - - - 0x000AF6 00:CAE6: A2 0E     LDX #$0E
C - - - - - 0x000AF8 00:CAE8: 20 34 D9  JSR sub_D934
C - - - - - 0x000AFB 00:CAEB: A0 0E     LDY #$0E
C - - - - - 0x000AFD 00:CAED: 20 DD D6  JSR sub_D6DD
C - - - - - 0x000B00 00:CAF0: A9 00     LDA #$00
C - - - - - 0x000B02 00:CAF2: 85 60     STA ram_0060
...
C - - - - - 0x000B07 00:CAF7: 85 12     STA ram_0012
C - - - - - 0x000B09 00:CAF9: A9 6D     LDA #< tbl_D36D_tiles___default_base___line1
C - - - - - 0x000B0B 00:CAFB: 85 11     STA ram_0011
C - - - - - 0x000B0D 00:CAFD: A2 0C     LDX #$0C
C - - - - - 0x000B0F 00:CAFF: A0 18     LDY #$18
...
C - - - - - 0x000B16 00:CB06: 85 12     STA ram_0012
C - - - - - 0x000B18 00:CB08: A9 74     LDA #< tbl_D374_tiles___default_base___line2
C - - - - - 0x000B1A 00:CB0A: 85 11     STA ram_0011
C - - - - - 0x000B1C 00:CB0C: A2 0C     LDX #$0C
C - - - - - 0x000B1E 00:CB0E: A0 19     LDY #$19
...
C - - - - - 0x000B25 00:CB15: 85 12     STA ram_0012
C - - - - - 0x000B27 00:CB17: A9 7B     LDA #< tbl_D37B_tiles___default_base___line3
C - - - - - 0x000B29 00:CB19: 85 11     STA ram_0011
C - - - - - 0x000B2B 00:CB1B: A2 0C     LDX #$0C
C - - - - - 0x000B2D 00:CB1D: A0 1A     LDY #$1A
...
C - - - - - 0x000B6F 00:CB5F: 85 12     STA ram_0012
C - - - - - 0x000B71 00:CB61: A9 A5     LDA #< tbl_D3A5_tiles___default_eagle___line1
C - - - - - 0x000B73 00:CB63: 85 11     STA ram_0011
C - - - - - 0x000B75 00:CB65: A2 0E     LDX #$0E
C - - - - - 0x000B77 00:CB67: A0 1A     LDY #$1A
...
C - - - - - 0x000BB0 00:CBA0: 85 12     STA ram_0012
C - - - - - 0x000BB2 00:CBA2: A9 89     LDA #< tbl_D389_tiles___protected_base___line1
C - - - - - 0x000BB4 00:CBA4: 85 11     STA ram_0011
C - - - - - 0x000BB6 00:CBA6: A2 0C     LDX #$0C
C - - - - - 0x000BB8 00:CBA8: A0 18     LDY #$18
...
C - - - - - 0x000BBF 00:CBAF: 85 12     STA ram_0012
C - - - - - 0x000BC1 00:CBB1: A9 90     LDA #< tbl_D390_tiles___protected_base___line2
C - - - - - 0x000BC3 00:CBB3: 85 11     STA ram_0011
C - - - - - 0x000BC5 00:CBB5: A2 0C     LDX #$0C
C - - - - - 0x000BC7 00:CBB7: A0 19     LDY #$19
...
C - - - - - 0x000BCE 00:CBBE: 85 12     STA ram_0012
C - - - - - 0x000BD0 00:CBC0: A9 97     LDA #< tbl_D397_tiles___protected_base___line3
C - - - - - 0x000BD2 00:CBC2: 85 11     STA ram_0011
C - - - - - 0x000BD4 00:CBC4: A2 0C     LDX #$0C
C - - - - - 0x000BD6 00:CBC6: A0 1A     LDY #$1A
...
C - - - - - 0x000C1A 00:CC0A: 85 12     STA ram_0012
C - - - - - 0x000C1C 00:CC0C: A9 AB     LDA #< tbl_D3AB_tiles___destroyed_eagle___line1
C - - - - - 0x000C1E 00:CC0E: 85 11     STA ram_0011
C - - - - - 0x000C20 00:CC10: A2 0E     LDX #$0E
C - - - - - 0x000C22 00:CC12: A0 1A     LDY #$1A
...
C - - - - - 0x000C39 00:CC29: A9 23     LDA #$23
C - - - - - 0x000C3B 00:CC2B: 85 12     STA ram_0012
C - - - - - 0x000C3D 00:CC2D: A9 C0     LDA #$C0
C - - - - - 0x000C3F 00:CC2F: 85 11     STA ram_0011
bra_CC31_loop:
C - - - - - 0x000C41 00:CC31: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x000C44 00:CC34: A6 0C     LDX ram_buffer_index
C - - - - - 0x000C46 00:CC36: A5 12     LDA ram_0012
C - - - - - 0x000C48 00:CC38: 9D 80 01  STA ram_ppu_buffer,X
C - - - - - 0x000C4B 00:CC3B: E8        INX
C - - - - - 0x000C4C 00:CC3C: A5 11     LDA ram_0011
C - - - - - 0x000C4E 00:CC3E: 9D 80 01  STA ram_ppu_buffer,X
C - - - - - 0x000C51 00:CC41: E8        INX
C - - - - - 0x000C52 00:CC42: B9 C0 07  LDA ram_07C0,Y
...
C - - - - - 0x000C64 00:CC54: 20 AA D7  JSR sub_D7AA
...
C - - - - - 0x000C6E 00:CC5E: 20 FB D5  JSR sub_D5FB_calculate_ppu_address
C - - - - - 0x000C71 00:CC61: 85 12     STA ram_0012
C - - - - - 0x000C73 00:CC63: 84 11     STY ram_0011
C - - - - - 0x000C75 00:CC65: A6 0C     LDX ram_buffer_index
C - - - - - 0x000C77 00:CC67: A5 12     LDA ram_0012
C - - - - - 0x000C79 00:CC69: 18        CLC
C - - - - - 0x000C7A 00:CC6A: 69 1C     ADC #$1C
C - - - - - 0x000C7C 00:CC6C: 9D 80 01  STA ram_ppu_buffer,X
C - - - - - 0x000C7F 00:CC6F: E8        INX
C - - - - - 0x000C80 00:CC70: A5 11     LDA ram_0011
C - - - - - 0x000C82 00:CC72: 9D 80 01  STA ram_ppu_buffer,X
C - - - - - 0x000C85 00:CC75: E8        INX
C - - - - - 0x000C86 00:CC76: A0 00     LDY #$00
bra_CC78_loop:
C - - - - - 0x000C88 00:CC78: A5 63     LDA ram_0063
C - - - - - 0x000C8A 00:CC7A: D0 02     BNE bra_CC7E
C - - - - - 0x000C8C 00:CC7C: B1 11     LDA (ram_0011),Y
bra_CC7E:
...
sub_CC90:
C - - - - - 0x000CA0 00:CC90: A9 11     LDA #$11
C - - - - - 0x000CA2 00:CC92: 85 63     STA ram_0063
C - - - - - 0x000CA4 00:CC94: A9 00     LDA #$00
C - - - - - 0x000CA6 00:CC96: 85 57     STA ram_0057
bra_CC98_loop:
C - - - - - 0x000CA8 00:CC98: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x000CAB 00:CC9B: A4 57     LDY ram_0057
C - - - - - 0x000CAD 00:CC9D: 20 5C CC  JSR sub_CC5C
C - - - - - 0x000CB0 00:CCA0: A9 1D     LDA #$1D
C - - - - - 0x000CB2 00:CCA2: 38        SEC
C - - - - - 0x000CB3 00:CCA3: E5 57     SBC ram_0057
C - - - - - 0x000CB5 00:CCA5: A8        TAY
C - - - - - 0x000CB6 00:CCA6: 20 5C CC  JSR sub_CC5C
C - - - - - 0x000CB9 00:CCA9: E6 57     INC ram_0057
C - - - - - 0x000CBB 00:CCAB: A5 57     LDA ram_0057
...
sub_CCB2:
C - - - - - 0x000CC2 00:CCB2: A9 00     LDA #$00
C - - - - - 0x000CC4 00:CCB4: 85 63     STA ram_0063
C - - - - - 0x000CC6 00:CCB6: A9 0F     LDA #$0F
C - - - - - 0x000CC8 00:CCB8: 85 57     STA ram_0057
bra_CCBA_loop:
C - - - - - 0x000CCA 00:CCBA: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x000CCD 00:CCBD: A4 57     LDY ram_0057
C - - - - - 0x000CCF 00:CCBF: 20 5C CC  JSR sub_CC5C
C - - - - - 0x000CD2 00:CCC2: A9 1D     LDA #$1D
C - - - - - 0x000CD4 00:CCC4: 38        SEC
C - - - - - 0x000CD5 00:CCC5: E5 57     SBC ram_0057
C - - - - - 0x000CD7 00:CCC7: A8        TAY
C - - - - - 0x000CD8 00:CCC8: 20 5C CC  JSR sub_CC5C
C - - - - - 0x000CDB 00:CCCB: C6 57     DEC ram_0057
C - - - - - 0x000CDD 00:CCCD: A5 57     LDA ram_0057
...
C - - - - - 0x000CE9 00:CCD9: 20 76 D2  JSR sub_D276
C - - - - - 0x000CEC 00:CCDC: A5 73     LDA ram_p1_enemy_type_kill_cnt
C - - - - - 0x000CEE 00:CCDE: 18        CLC
C - - - - - 0x000CEF 00:CCDF: 65 74     ADC ram_p1_enemy_type_kill_cnt + 1
C - - - - - 0x000CF1 00:CCE1: 18        CLC
C - - - - - 0x000CF2 00:CCE2: 65 75     ADC ram_p1_enemy_type_kill_cnt + 2
C - - - - - 0x000CF4 00:CCE4: 18        CLC
C - - - - - 0x000CF5 00:CCE5: 65 76     ADC ram_p1_enemy_type_kill_cnt + 3
C - - - - - 0x000CF7 00:CCE7: 85 7D     STA ram_007D
C - - - - - 0x000CF9 00:CCE9: A5 77     LDA ram_p2_enemy_type_kill_cnt
C - - - - - 0x000CFB 00:CCEB: 18        CLC
C - - - - - 0x000CFC 00:CCEC: 65 78     ADC ram_p2_enemy_type_kill_cnt + 1
C - - - - - 0x000CFE 00:CCEE: 18        CLC
C - - - - - 0x000CFF 00:CCEF: 65 79     ADC ram_p2_enemy_type_kill_cnt + 2
...
C - - - - - 0x000D10 00:CD00: A2 25     LDX #< ram_p1_tmp_score
C - - - - - 0x000D12 00:CD02: 20 FE D9  JSR sub_D9FE_prepare_memory_for_bcd
C - - - - - 0x000D15 00:CD05: A2 2D     LDX #< ram_p2_tmp_score
C - - - - - 0x000D17 00:CD07: 20 FE D9  JSR sub_D9FE_prepare_memory_for_bcd
C - - - - - 0x000D1A 00:CD0A: A9 00     LDA #$00
C - - - - - 0x000D1C 00:CD0C: 85 5D     STA ram_005D
C - - - - - 0x000D1E 00:CD0E: 85 5E     STA ram_005E
loc_CD10_loop:
C D 2 - - - 0x000D20 00:CD10: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
...
C - - - - - 0x000D42 00:CD32: E6 5D     INC ram_005D
C - - - - - 0x000D44 00:CD34: A2 02     LDX #$02
C - - - - - 0x000D46 00:CD36: 20 BE D9  JSR sub_D9BE
...
C - - - - - 0x000D60 00:CD50: E6 5E     INC ram_005E
C - - - - - 0x000D62 00:CD52: A2 03     LDX #$03
C - - - - - 0x000D64 00:CD54: 20 BE D9  JSR sub_D9BE
...
bra_CD5E:
C - - - - - 0x000D6E 00:CD5E: A0 16     LDY #$16
C - - - - - 0x000D70 00:CD60: A2 05     LDX #$05
C - - - - - 0x000D72 00:CD62: 20 34 D9  JSR sub_D934
C - - - - - 0x000D75 00:CD65: A0 09     LDY #$09
...
C - - - - - 0x000DAB 00:CD9B: F0 3B     BEQ bra_CDD8    ; 1p mode
C - - - - - 0x000DAD 00:CD9D: A0 1E     LDY #$1E
C - - - - - 0x000DAF 00:CD9F: A2 17     LDX #$17
C - - - - - 0x000DB1 00:CDA1: 20 34 D9  JSR sub_D934
C - - - - - 0x000DB4 00:CDA4: A0 09     LDY #$09
...
C - - - - - 0x000DEA 00:CDDA: 20 76 D2  JSR sub_D276
C - - - - - 0x000DED 00:CDDD: A5 7C     LDA ram_007C
...
C - - - - - 0x000DFE 00:CDEE: 20 76 D2  JSR sub_D276
C - - - - - 0x000E01 00:CDF1: 4C FA CC  JMP loc_CCFA_loop
bra_CDF4:
C - - - - - 0x000E04 00:CDF4: A2 1E     LDX #$1E
C - - - - - 0x000E06 00:CDF6: 20 76 D2  JSR sub_D276
C - - - - - 0x000E09 00:CDF9: A5 7D     LDA ram_007D
C - - - - - 0x000E0B 00:CDFB: 20 13 DA  JSR sub_DA13_calculate_decimal
C - - - - - 0x000E0E 00:CDFE: A0 36     LDY #$36
C - - - - - 0x000E10 00:CE00: A2 08     LDX #$08
C - - - - - 0x000E12 00:CE02: 20 34 D9  JSR sub_D934
C - - - - - 0x000E15 00:CE05: A0 17     LDY #$17
C - - - - - 0x000E17 00:CE07: 20 DD D6  JSR sub_D6DD
C - - - - - 0x000E1A 00:CE0A: A5 83     LDA ram_game_mode
C - - - - - 0x000E1C 00:CE0C: F0 11     BEQ bra_CE1F    ; 1p mode
C - - - - - 0x000E1E 00:CE0E: A5 7E     LDA ram_007E
C - - - - - 0x000E20 00:CE10: 20 13 DA  JSR sub_DA13_calculate_decimal
C - - - - - 0x000E23 00:CE13: A0 36     LDY #$36
C - - - - - 0x000E25 00:CE15: A2 0E     LDX #$0E
C - - - - - 0x000E27 00:CE17: 20 34 D9  JSR sub_D934
C - - - - - 0x000E2A 00:CE1A: A0 17     LDY #$17
C - - - - - 0x000E2C 00:CE1C: 20 DD D6  JSR sub_D6DD
bra_CE1F:
C - - - - - 0x000E2F 00:CE1F: A2 0F     LDX #$0F
C - - - - - 0x000E31 00:CE21: 20 76 D2  JSR sub_D276
...
C - - - - - 0x000E51 00:CE41: A2 00     LDX #$00
C - - - - - 0x000E53 00:CE43: 20 BE D9  JSR sub_D9BE
C - - - - - 0x000E56 00:CE46: A0 16     LDY #$16
C - - - - - 0x000E58 00:CE48: A2 05     LDX #$05
C - - - - - 0x000E5A 00:CE4A: 20 34 D9  JSR sub_D934
C - - - - - 0x000E5D 00:CE4D: A0 09     LDY #$09
C - - - - - 0x000E5F 00:CE4F: 20 DD D6  JSR sub_D6DD
C - - - - - 0x000E62 00:CE52: A0 36     LDY #$36
C - - - - - 0x000E64 00:CE54: A2 01     LDX #$01
C - - - - - 0x000E66 00:CE56: 20 34 D9  JSR sub_D934
C - - - - - 0x000E69 00:CE59: A0 1A     LDY #$1A
C - - - - - 0x000E6B 00:CE5B: 20 DD D6  JSR sub_D6DD
C - - - - - 0x000E6E 00:CE5E: A9 D3     LDA #> tbl_D3C4_txt___bonus
C - - - - - 0x000E70 00:CE60: 85 12     STA ram_0012
C - - - - - 0x000E72 00:CE62: A9 C4     LDA #< tbl_D3C4_txt___bonus
C - - - - - 0x000E74 00:CE64: 85 11     STA ram_0011
C - - - - - 0x000E76 00:CE66: A2 03     LDX #$03
C - - - - - 0x000E78 00:CE68: A0 19     LDY #$19
C - - - - - 0x000E7A 00:CE6A: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000E7D 00:CE6D: A9 D3     LDA #> tbl_D35E_pts_txt
C - - - - - 0x000E7F 00:CE6F: 85 12     STA ram_0012
C - - - - - 0x000E81 00:CE71: A9 5E     LDA #< tbl_D35E_pts_txt
C - - - - - 0x000E83 00:CE73: 85 11     STA ram_0011
C - - - - - 0x000E85 00:CE75: A2 08     LDX #$08
C - - - - - 0x000E87 00:CE77: A0 1A     LDY #$1A
...
C - - - - - 0x000E91 00:CE81: 8D 1C 03  STA ram_sfx_ind_data        ; bzk useless write, it won't be read and will be overwritten
C - - - - - 0x000E94 00:CE84: 8D 1D 03  STA ram_sfx_ind_data + 1    ; bzk useless write, it won't be read and will be overwritten
C - - - - - 0x000E97 00:CE87: 20 38 D1  JSR sub_D138_gain_extra_life_for_20000_pts
C - - - - - 0x000E9A 00:CE8A: 4C E5 CE  JMP loc_CEE5
bra_CE8D:
C - - - - - 0x000E9D 00:CE8D: A5 7D     LDA ram_007D
C - - - - - 0x000E9F 00:CE8F: C5 7E     CMP ram_007E
C - - - - - 0x000EA1 00:CE91: B0 52     BCS bra_CEE5
C - - - - - 0x000EA3 00:CE93: A5 52     LDA ram_lives + 1
C - - - - - 0x000EA5 00:CE95: F0 4E     BEQ bra_CEE5
C - - - - - 0x000EA7 00:CE97: A9 00     LDA #$00
C - - - - - 0x000EA9 00:CE99: 20 E1 D9  JSR sub_D9E1
C - - - - - 0x000EAC 00:CE9C: A2 01     LDX #$01
C - - - - - 0x000EAE 00:CE9E: 20 BE D9  JSR sub_D9BE
C - - - - - 0x000EB1 00:CEA1: A0 1E     LDY #$1E
C - - - - - 0x000EB3 00:CEA3: A2 17     LDX #$17
C - - - - - 0x000EB5 00:CEA5: 20 34 D9  JSR sub_D934
C - - - - - 0x000EB8 00:CEA8: A0 09     LDY #$09
C - - - - - 0x000EBA 00:CEAA: 20 DD D6  JSR sub_D6DD
C - - - - - 0x000EBD 00:CEAD: A0 36     LDY #$36
C - - - - - 0x000EBF 00:CEAF: A2 14     LDX #$14
C - - - - - 0x000EC1 00:CEB1: 20 34 D9  JSR sub_D934
C - - - - - 0x000EC4 00:CEB4: A0 1A     LDY #$1A
C - - - - - 0x000EC6 00:CEB6: 20 DD D6  JSR sub_D6DD
C - - - - - 0x000EC9 00:CEB9: A9 D3     LDA #> tbl_D3C4_txt___bonus
C - - - - - 0x000ECB 00:CEBB: 85 12     STA ram_0012
C - - - - - 0x000ECD 00:CEBD: A9 C4     LDA #< tbl_D3C4_txt___bonus
C - - - - - 0x000ECF 00:CEBF: 85 11     STA ram_0011
C - - - - - 0x000ED1 00:CEC1: A2 16     LDX #$16
C - - - - - 0x000ED3 00:CEC3: A0 19     LDY #$19
C - - - - - 0x000ED5 00:CEC5: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000ED8 00:CEC8: A9 D3     LDA #> tbl_D35E_pts_txt
C - - - - - 0x000EDA 00:CECA: 85 12     STA ram_0012
C - - - - - 0x000EDC 00:CECC: A9 5E     LDA #< tbl_D35E_pts_txt
C - - - - - 0x000EDE 00:CECE: 85 11     STA ram_0011
C - - - - - 0x000EE0 00:CED0: A2 1B     LDX #$1B
C - - - - - 0x000EE2 00:CED2: A0 1A     LDY #$1A
...
C - - - - - 0x000EEC 00:CEDC: 8D 1C 03  STA ram_sfx_ind_data        ; bzk useless write, it won't be read and will be overwritten
C - - - - - 0x000EEF 00:CEDF: 8D 1D 03  STA ram_sfx_ind_data + 1    ; bzk useless write, it won't be read and will be overwritten
C - - - - - 0x000EF2 00:CEE2: 20 38 D1  JSR sub_D138_gain_extra_life_for_20000_pts
bra_CEE5:
loc_CEE5:
C D 2 - - - 0x000EF5 00:CEE5: A2 78     LDX #$78
C - - - - - 0x000EF7 00:CEE7: 20 76 D2  JSR sub_D276
C - - - - - 0x000EFA 00:CEEA: A9 00     LDA #$00
C - - - - - 0x000EFC 00:CEEC: 85 50     STA ram_base_nmt
C - - - - - 0x000EFE 00:CEEE: 85 60     STA ram_0060
C - - - - - 0x000F00 00:CEF0: 85 6B     STA ram_006B
C - - - - - 0x000F02 00:CEF2: A9 00     LDA #$00
...
C - - - - - 0x000F07 00:CEF7: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x000F0A 00:CEFA: A9 01     LDA #$01
C - - - - - 0x000F0C 00:CEFC: 85 6B     STA ram_006B
C - - - - - 0x000F0E 00:CEFE: A9 24     LDA #$24
C - - - - - 0x000F10 00:CF00: 85 05     STA ram_0005
C - - - - - 0x000F12 00:CF02: A9 00     LDA #$00
C - - - - - 0x000F14 00:CF04: 85 4F     STA ram_scroll_pos_Y
C - - - - - 0x000F16 00:CF06: A9 02     LDA #$02
C - - - - - 0x000F18 00:CF08: 85 50     STA ram_base_nmt
C - - - - - 0x000F1A 00:CF0A: A9 30     LDA #$30
C - - - - - 0x000F1C 00:CF0C: 85 60     STA ram_0060
C - - - - - 0x000F1E 00:CF0E: A9 03     LDA #$03
C - - - - - 0x000F20 00:CF10: 85 4D     STA ram_bg_palette_id
C - - - - - 0x000F22 00:CF12: 20 70 D4  JSR sub_D470
C - - - - - 0x000F25 00:CF15: 20 7E D4  JSR sub_D47E_clear_0400_07FF
C - - - - - 0x000F28 00:CF18: 20 D9 D0  JSR sub_D0D9
C - - - - - 0x000F2B 00:CF1B: 20 B4 D7  JSR sub_D7B4
C - - - - - 0x000F2E 00:CF1E: 20 67 D4  JSR sub_D467
C - - - - - 0x000F31 00:CF21: A9 D2     LDA #> tbl_D2BD_txt___hi_score
C - - - - - 0x000F33 00:CF23: 85 12     STA ram_0012
C - - - - - 0x000F35 00:CF25: A9 BD     LDA #< tbl_D2BD_txt___hi_score
C - - - - - 0x000F37 00:CF27: 85 11     STA ram_0011
C - - - - - 0x000F39 00:CF29: A2 08     LDX #$08
C - - - - - 0x000F3B 00:CF2B: A0 03     LDY #$03
C - - - - - 0x000F3D 00:CF2D: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000F40 00:CF30: A0 3E     LDY #$3E
C - - - - - 0x000F42 00:CF32: A2 12     LDX #$12
C - - - - - 0x000F44 00:CF34: 20 34 D9  JSR sub_D934
C - - - - - 0x000F47 00:CF37: A0 03     LDY #$03
C - - - - - 0x000F49 00:CF39: 20 DD D6  JSR sub_D6DD
C - - - - - 0x000F4C 00:CF3C: A9 D3     LDA #> tbl_D3CB_txt___stage
C - - - - - 0x000F4E 00:CF3E: 85 12     STA ram_0012
C - - - - - 0x000F50 00:CF40: A9 CB     LDA #< tbl_D3CB_txt___stage
C - - - - - 0x000F52 00:CF42: 85 11     STA ram_0011
C - - - - - 0x000F54 00:CF44: A2 0C     LDX #$0C
C - - - - - 0x000F56 00:CF46: A0 05     LDY #$05
...
C - - - - - 0x000F60 00:CF50: A0 36     LDY #$36
C - - - - - 0x000F62 00:CF52: A2 0E     LDX #$0E
C - - - - - 0x000F64 00:CF54: 20 34 D9  JSR sub_D934
C - - - - - 0x000F67 00:CF57: A0 05     LDY #$05
C - - - - - 0x000F69 00:CF59: 20 DD D6  JSR sub_D6DD
C - - - - - 0x000F6C 00:CF5C: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x000F6F 00:CF5F: A9 D2     LDA #> tbl_D2D9_txt___I_player
C - - - - - 0x000F71 00:CF61: 85 12     STA ram_0012
C - - - - - 0x000F73 00:CF63: A9 D9     LDA #< tbl_D2D9_txt___I_player
C - - - - - 0x000F75 00:CF65: 85 11     STA ram_0011
C - - - - - 0x000F77 00:CF67: A2 03     LDX #$03
C - - - - - 0x000F79 00:CF69: A0 07     LDY #$07
C - - - - - 0x000F7B 00:CF6B: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000F7E 00:CF6E: A0 16     LDY #$16
C - - - - - 0x000F80 00:CF70: A2 05     LDX #$05
C - - - - - 0x000F82 00:CF72: 20 34 D9  JSR sub_D934
C - - - - - 0x000F85 00:CF75: A0 09     LDY #$09
C - - - - - 0x000F87 00:CF77: 20 DD D6  JSR sub_D6DD
C - - - - - 0x000F8A 00:CF7A: A9 D3     LDA #> tbl_D3B1_tile___arrow_left
C - - - - - 0x000F8C 00:CF7C: 85 12     STA ram_0012
C - - - - - 0x000F8E 00:CF7E: A9 B1     LDA #< tbl_D3B1_tile___arrow_left
C - - - - - 0x000F90 00:CF80: 85 11     STA ram_0011
C - - - - - 0x000F92 00:CF82: A2 0E     LDX #$0E
C - - - - - 0x000F94 00:CF84: A0 0C     LDY #$0C
C - - - - - 0x000F96 00:CF86: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000F99 00:CF89: A9 D3     LDA #> tbl_D3B1_tile___arrow_left
C - - - - - 0x000F9B 00:CF8B: 85 12     STA ram_0012
C - - - - - 0x000F9D 00:CF8D: A9 B1     LDA #< tbl_D3B1_tile___arrow_left
C - - - - - 0x000F9F 00:CF8F: 85 11     STA ram_0011
C - - - - - 0x000FA1 00:CF91: A2 0E     LDX #$0E
C - - - - - 0x000FA3 00:CF93: A0 0F     LDY #$0F
C - - - - - 0x000FA5 00:CF95: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000FA8 00:CF98: A9 D3     LDA #> tbl_D3B1_tile___arrow_left
C - - - - - 0x000FAA 00:CF9A: 85 12     STA ram_0012
C - - - - - 0x000FAC 00:CF9C: A9 B1     LDA #< tbl_D3B1_tile___arrow_left
C - - - - - 0x000FAE 00:CF9E: 85 11     STA ram_0011
C - - - - - 0x000FB0 00:CFA0: A2 0E     LDX #$0E
C - - - - - 0x000FB2 00:CFA2: A0 12     LDY #$12
C - - - - - 0x000FB4 00:CFA4: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000FB7 00:CFA7: A9 D3     LDA #> tbl_D3B1_tile___arrow_left
C - - - - - 0x000FB9 00:CFA9: 85 12     STA ram_0012
C - - - - - 0x000FBB 00:CFAB: A9 B1     LDA #< tbl_D3B1_tile___arrow_left
C - - - - - 0x000FBD 00:CFAD: 85 11     STA ram_0011
C - - - - - 0x000FBF 00:CFAF: A2 0E     LDX #$0E
C - - - - - 0x000FC1 00:CFB1: A0 15     LDY #$15
C - - - - - 0x000FC3 00:CFB3: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000FC6 00:CFB6: A5 83     LDA ram_game_mode
C - - - - - 0x000FC8 00:CFB8: F0 5A     BEQ bra_D014    ; 1p mode
C - - - - - 0x000FCA 00:CFBA: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x000FCD 00:CFBD: A9 D2     LDA #> tbl_D2E2_txt___II_player
C - - - - - 0x000FCF 00:CFBF: 85 12     STA ram_0012
C - - - - - 0x000FD1 00:CFC1: A9 E2     LDA #< tbl_D2E2_txt___II_player
C - - - - - 0x000FD3 00:CFC3: 85 11     STA ram_0011
C - - - - - 0x000FD5 00:CFC5: A2 15     LDX #$15
C - - - - - 0x000FD7 00:CFC7: A0 07     LDY #$07
C - - - - - 0x000FD9 00:CFC9: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000FDC 00:CFCC: A0 1E     LDY #$1E
C - - - - - 0x000FDE 00:CFCE: A2 17     LDX #$17
C - - - - - 0x000FE0 00:CFD0: 20 34 D9  JSR sub_D934
C - - - - - 0x000FE3 00:CFD3: A0 09     LDY #$09
C - - - - - 0x000FE5 00:CFD5: 20 DD D6  JSR sub_D6DD
C - - - - - 0x000FE8 00:CFD8: A9 D3     LDA #> tbl_D3B3_tile___arrow_right
C - - - - - 0x000FEA 00:CFDA: 85 12     STA ram_0012
C - - - - - 0x000FEC 00:CFDC: A9 B3     LDA #< tbl_D3B3_tile___arrow_right
C - - - - - 0x000FEE 00:CFDE: 85 11     STA ram_0011
C - - - - - 0x000FF0 00:CFE0: A2 11     LDX #$11
C - - - - - 0x000FF2 00:CFE2: A0 0C     LDY #$0C
C - - - - - 0x000FF4 00:CFE4: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x000FF7 00:CFE7: A9 D3     LDA #> tbl_D3B3_tile___arrow_right
C - - - - - 0x000FF9 00:CFE9: 85 12     STA ram_0012
C - - - - - 0x000FFB 00:CFEB: A9 B3     LDA #< tbl_D3B3_tile___arrow_right
C - - - - - 0x000FFD 00:CFED: 85 11     STA ram_0011
C - - - - - 0x000FFF 00:CFEF: A2 11     LDX #$11
C - - - - - 0x001001 00:CFF1: A0 0F     LDY #$0F
C - - - - - 0x001003 00:CFF3: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001006 00:CFF6: A9 D3     LDA #> tbl_D3B3_tile___arrow_right
C - - - - - 0x001008 00:CFF8: 85 12     STA ram_0012
C - - - - - 0x00100A 00:CFFA: A9 B3     LDA #< tbl_D3B3_tile___arrow_right
C - - - - - 0x00100C 00:CFFC: 85 11     STA ram_0011
C - - - - - 0x00100E 00:CFFE: A2 11     LDX #$11
C - - - - - 0x001010 00:D000: A0 12     LDY #$12
C - - - - - 0x001012 00:D002: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001015 00:D005: A9 D3     LDA #> tbl_D3B3_tile___arrow_right
C - - - - - 0x001017 00:D007: 85 12     STA ram_0012
C - - - - - 0x001019 00:D009: A9 B3     LDA #< tbl_D3B3_tile___arrow_right
C - - - - - 0x00101B 00:D00B: 85 11     STA ram_0011
C - - - - - 0x00101D 00:D00D: A2 11     LDX #$11
C - - - - - 0x00101F 00:D00F: A0 15     LDY #$15
C - - - - - 0x001021 00:D011: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
bra_D014:
C - - - - - 0x001024 00:D014: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x001027 00:D017: A9 D3     LDA #> tbl_D35E_pts_txt
C - - - - - 0x001029 00:D019: 85 12     STA ram_0012
C - - - - - 0x00102B 00:D01B: A9 5E     LDA #< tbl_D35E_pts_txt
C - - - - - 0x00102D 00:D01D: 85 11     STA ram_0011
C - - - - - 0x00102F 00:D01F: A2 08     LDX #$08
C - - - - - 0x001031 00:D021: A0 0C     LDY #$0C
C - - - - - 0x001033 00:D023: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001036 00:D026: A9 D3     LDA #> tbl_D35E_pts_txt
C - - - - - 0x001038 00:D028: 85 12     STA ram_0012
C - - - - - 0x00103A 00:D02A: A9 5E     LDA #< tbl_D35E_pts_txt
C - - - - - 0x00103C 00:D02C: 85 11     STA ram_0011
C - - - - - 0x00103E 00:D02E: A2 08     LDX #$08
C - - - - - 0x001040 00:D030: A0 0F     LDY #$0F
C - - - - - 0x001042 00:D032: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001045 00:D035: A9 D3     LDA #> tbl_D35E_pts_txt
C - - - - - 0x001047 00:D037: 85 12     STA ram_0012
C - - - - - 0x001049 00:D039: A9 5E     LDA #< tbl_D35E_pts_txt
C - - - - - 0x00104B 00:D03B: 85 11     STA ram_0011
C - - - - - 0x00104D 00:D03D: A2 08     LDX #$08
C - - - - - 0x00104F 00:D03F: A0 12     LDY #$12
C - - - - - 0x001051 00:D041: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001054 00:D044: A9 D3     LDA #> tbl_D35E_pts_txt
C - - - - - 0x001056 00:D046: 85 12     STA ram_0012
C - - - - - 0x001058 00:D048: A9 5E     LDA #< tbl_D35E_pts_txt
C - - - - - 0x00105A 00:D04A: 85 11     STA ram_0011
C - - - - - 0x00105C 00:D04C: A2 08     LDX #$08
C - - - - - 0x00105E 00:D04E: A0 15     LDY #$15
C - - - - - 0x001060 00:D050: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001063 00:D053: A5 83     LDA ram_game_mode
C - - - - - 0x001065 00:D055: F0 3F     BEQ bra_D096    ; 1p mode
C - - - - - 0x001067 00:D057: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x00106A 00:D05A: A9 D3     LDA #> tbl_D35E_pts_txt
C - - - - - 0x00106C 00:D05C: 85 12     STA ram_0012
C - - - - - 0x00106E 00:D05E: A9 5E     LDA #< tbl_D35E_pts_txt
C - - - - - 0x001070 00:D060: 85 11     STA ram_0011
C - - - - - 0x001072 00:D062: A2 1A     LDX #$1A
C - - - - - 0x001074 00:D064: A0 0C     LDY #$0C
C - - - - - 0x001076 00:D066: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001079 00:D069: A9 D3     LDA #> tbl_D35E_pts_txt
C - - - - - 0x00107B 00:D06B: 85 12     STA ram_0012
C - - - - - 0x00107D 00:D06D: A9 5E     LDA #< tbl_D35E_pts_txt
C - - - - - 0x00107F 00:D06F: 85 11     STA ram_0011
C - - - - - 0x001081 00:D071: A2 1A     LDX #$1A
C - - - - - 0x001083 00:D073: A0 0F     LDY #$0F
C - - - - - 0x001085 00:D075: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001088 00:D078: A9 D3     LDA #> tbl_D35E_pts_txt
C - - - - - 0x00108A 00:D07A: 85 12     STA ram_0012
C - - - - - 0x00108C 00:D07C: A9 5E     LDA #< tbl_D35E_pts_txt
C - - - - - 0x00108E 00:D07E: 85 11     STA ram_0011
C - - - - - 0x001090 00:D080: A2 1A     LDX #$1A
C - - - - - 0x001092 00:D082: A0 12     LDY #$12
C - - - - - 0x001094 00:D084: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001097 00:D087: A9 D3     LDA #> tbl_D35E_pts_txt
C - - - - - 0x001099 00:D089: 85 12     STA ram_0012
C - - - - - 0x00109B 00:D08B: A9 5E     LDA #< tbl_D35E_pts_txt
C - - - - - 0x00109D 00:D08D: 85 11     STA ram_0011
C - - - - - 0x00109F 00:D08F: A2 1A     LDX #$1A
C - - - - - 0x0010A1 00:D091: A0 15     LDY #$15
C - - - - - 0x0010A3 00:D093: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
bra_D096:
C - - - - - 0x0010A6 00:D096: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x0010A9 00:D099: A9 D3     LDA #> tbl_D3BB_tiles___underline
C - - - - - 0x0010AB 00:D09B: 85 12     STA ram_0012
C - - - - - 0x0010AD 00:D09D: A9 BB     LDA #< tbl_D3BB_tiles___underline
C - - - - - 0x0010AF 00:D09F: 85 11     STA ram_0011
C - - - - - 0x0010B1 00:D0A1: A2 0C     LDX #$0C
C - - - - - 0x0010B3 00:D0A3: A0 16     LDY #$16
C - - - - - 0x0010B5 00:D0A5: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x0010B8 00:D0A8: A9 D3     LDA #> tbl_D3B5_txt___total
C - - - - - 0x0010BA 00:D0AA: 85 12     STA ram_0012
C - - - - - 0x0010BC 00:D0AC: A9 B5     LDA #< tbl_D3B5_txt___total
C - - - - - 0x0010BE 00:D0AE: 85 11     STA ram_0011
C - - - - - 0x0010C0 00:D0B0: A2 06     LDX #$06
C - - - - - 0x0010C2 00:D0B2: A0 17     LDY #$17
...
sub_D0B8:
C - - - - - 0x0010C8 00:D0B8: A9 02     LDA #$02
C - - - - - 0x0010CA 00:D0BA: 85 04     STA ram_0004
C - - - - - 0x0010CC 00:D0BC: A0 64     LDY #$64
C - - - - - 0x0010CE 00:D0BE: A9 80     LDA #$80
C - - - - - 0x0010D0 00:D0C0: 20 30 D1  JSR sub_D130
C - - - - - 0x0010D3 00:D0C3: A0 7C     LDY #$7C
C - - - - - 0x0010D5 00:D0C5: A9 A0     LDA #$A0
C - - - - - 0x0010D7 00:D0C7: 20 30 D1  JSR sub_D130
C - - - - - 0x0010DA 00:D0CA: A0 94     LDY #$94
C - - - - - 0x0010DC 00:D0CC: A9 C0     LDA #$C0
C - - - - - 0x0010DE 00:D0CE: 20 30 D1  JSR sub_D130
C - - - - - 0x0010E1 00:D0D1: A0 AC     LDY #$AC
C - - - - - 0x0010E3 00:D0D3: A9 E0     LDA #$E0
C - - - - - 0x0010E5 00:D0D5: 20 30 D1  JSR sub_D130
...
C - - - - - 0x0010EB 00:D0DB: 8D C0 07  STA ram_07C0
...
sub_D130:
C - - - - - 0x001140 00:D130: 85 53     STA ram_0053
C - - - - - 0x001142 00:D132: A2 81     LDX #$81
C - - - - - 0x001144 00:D134: 20 7B DA  JSR sub_DA7B
C - - - - - 0x001147 00:D137: 60        RTS



sub_D138_gain_extra_life_for_20000_pts:
; life for first 20.000 points
...
C - - - - - 0x001156 00:D146: 90 07     BCC bra_D14F
...
C - - - - - 0x001161 00:D151: F0 16     BEQ bra_D169_RTS    ; 1p mode
C - - - - - 0x001163 00:D153: A5 67     LDA ram_p2_extra_life
C - - - - - 0x001165 00:D155: D0 12     BNE bra_D169_RTS    ; already gained
C - - - - - 0x001167 00:D157: A5 1F     LDA ram_p2_score + 2
C - - - - - 0x001169 00:D159: C9 02     CMP #$02    ; 20.000
C - - - - - 0x00116B 00:D15B: 90 0C     BCC bra_D169_RTS
C - - - - - 0x00116D 00:D15D: E6 52     INC ram_lives + 1
...
sub_D16A:
C - - - - - 0x00117A 00:D16A: 20 70 D4  JSR sub_D470
C - - - - - 0x00117D 00:D16D: A9 03     LDA #$03
C - - - - - 0x00117F 00:D16F: 85 4D     STA ram_bg_palette_id
C - - - - - 0x001181 00:D171: A9 1C     LDA #$1C
C - - - - - 0x001183 00:D173: 85 05     STA ram_0005
C - - - - - 0x001185 00:D175: 20 7E D4  JSR sub_D47E_clear_0400_07FF
C - - - - - 0x001188 00:D178: 20 B4 D7  JSR sub_D7B4
C - - - - - 0x00118B 00:D17B: 20 67 D4  JSR sub_D467
C - - - - - 0x00118E 00:D17E: 60        RTS



sub_D17F:
C - - - - - 0x00118F 00:D17F: 20 70 D4  JSR sub_D470
C - - - - - 0x001192 00:D182: A9 24     LDA #$24
C - - - - - 0x001194 00:D184: 85 05     STA ram_0005
C - - - - - 0x001196 00:D186: 20 7E D4  JSR sub_D47E_clear_0400_07FF
C - - - - - 0x001199 00:D189: A2 1A     LDX #$1A
C - - - - - 0x00119B 00:D18B: 86 56     STX ram_0056
C - - - - - 0x00119D 00:D18D: A0 2E     LDY #$2E
C - - - - - 0x00119F 00:D18F: 84 57     STY ram_0057
C - - - - - 0x0011A1 00:D191: A9 D2     LDA #> tbl_D299_txt___battle
...
C - - - - - 0x0011B2 00:D1A2: 84 57     STY ram_0057
C - - - - - 0x0011B4 00:D1A4: A9 D2     LDA #> tbl_D2A0_txt___city
...
C - - - - - 0x0011C7 00:D1B7: 85 60     STA ram_0060
C - - - - - 0x0011C9 00:D1B9: A9 D2     LDA #> tbl_D2A0_txt___I_
C - - - - - 0x0011CB 00:D1BB: 85 12     STA ram_0012
C - - - - - 0x0011CD 00:D1BD: A9 A5     LDA #< tbl_D2A0_txt___I_
C - - - - - 0x0011CF 00:D1BF: 85 11     STA ram_0011
C - - - - - 0x0011D1 00:D1C1: A2 02     LDX #$02
C - - - - - 0x0011D3 00:D1C3: A0 03     LDY #$03
C - - - - - 0x0011D5 00:D1C5: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x0011D8 00:D1C8: A0 16     LDY #$16
C - - - - - 0x0011DA 00:D1CA: A2 04     LDX #$04
C - - - - - 0x0011DC 00:D1CC: 20 34 D9  JSR sub_D934
C - - - - - 0x0011DF 00:D1CF: A0 03     LDY #$03
C - - - - - 0x0011E1 00:D1D1: 20 DD D6  JSR sub_D6DD
C - - - - - 0x0011E4 00:D1D4: A9 D2     LDA #> tbl_D2B1_txt___hi_
C - - - - - 0x0011E6 00:D1D6: 85 12     STA ram_0012
C - - - - - 0x0011E8 00:D1D8: A9 B1     LDA #< tbl_D2B1_txt___hi_
C - - - - - 0x0011EA 00:D1DA: 85 11     STA ram_0011
C - - - - - 0x0011EC 00:D1DC: A2 0B     LDX #$0B
C - - - - - 0x0011EE 00:D1DE: A0 03     LDY #$03
C - - - - - 0x0011F0 00:D1E0: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x0011F3 00:D1E3: A0 3E     LDY #$3E
C - - - - - 0x0011F5 00:D1E5: A2 0E     LDX #$0E
C - - - - - 0x0011F7 00:D1E7: 20 34 D9  JSR sub_D934
C - - - - - 0x0011FA 00:D1EA: A0 03     LDY #$03
C - - - - - 0x0011FC 00:D1EC: 20 DD D6  JSR sub_D6DD
C - - - - - 0x0011FF 00:D1EF: A5 83     LDA ram_game_mode
C - - - - - 0x001201 00:D1F1: F0 1B     BEQ bra_D20E    ; 1p mode
C - - - - - 0x001203 00:D1F3: A9 D2     LDA #> tbl_D2A8_txt___II_
C - - - - - 0x001205 00:D1F5: 85 12     STA ram_0012
C - - - - - 0x001207 00:D1F7: A9 A8     LDA #< tbl_D2A8_txt___II_
C - - - - - 0x001209 00:D1F9: 85 11     STA ram_0011
C - - - - - 0x00120B 00:D1FB: A2 15     LDX #$15
C - - - - - 0x00120D 00:D1FD: A0 03     LDY #$03
C - - - - - 0x00120F 00:D1FF: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001212 00:D202: A0 1E     LDY #$1E
C - - - - - 0x001214 00:D204: A2 17     LDX #$17
C - - - - - 0x001216 00:D206: 20 34 D9  JSR sub_D934
C - - - - - 0x001219 00:D209: A0 03     LDY #$03
C - - - - - 0x00121B 00:D20B: 20 DD D6  JSR sub_D6DD
bra_D20E:
C - - - - - 0x00121E 00:D20E: A9 00     LDA #$00
C - - - - - 0x001220 00:D210: 85 60     STA ram_0060
C - - - - - 0x001222 00:D212: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x001225 00:D215: A9 D2     LDA #> tbl_D2C6_txt___1_player
C - - - - - 0x001227 00:D217: 85 12     STA ram_0012
C - - - - - 0x001229 00:D219: A9 C6     LDA #< tbl_D2C6_txt___1_player
C - - - - - 0x00122B 00:D21B: 85 11     STA ram_0011
C - - - - - 0x00122D 00:D21D: A2 0B     LDX #$0B
C - - - - - 0x00122F 00:D21F: A0 11     LDY #$11
C - - - - - 0x001231 00:D221: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001234 00:D224: A9 D2     LDA #> tbl_D2CF_txt___2_players
C - - - - - 0x001236 00:D226: 85 12     STA ram_0012
C - - - - - 0x001238 00:D228: A9 CF     LDA #< tbl_D2CF_txt___2_players
C - - - - - 0x00123A 00:D22A: 85 11     STA ram_0011
C - - - - - 0x00123C 00:D22C: A2 0B     LDX #$0B
C - - - - - 0x00123E 00:D22E: A0 13     LDY #$13
C - - - - - 0x001240 00:D230: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001243 00:D233: A9 D2     LDA #> tbl_D2EB_txt___construction
C - - - - - 0x001245 00:D235: 85 12     STA ram_0012
C - - - - - 0x001247 00:D237: A9 EB     LDA #< tbl_D2EB_txt___construction
C - - - - - 0x001249 00:D239: 85 11     STA ram_0011
C - - - - - 0x00124B 00:D23B: A2 0B     LDX #$0B
C - - - - - 0x00124D 00:D23D: A0 15     LDY #$15
C - - - - - 0x00124F 00:D23F: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001252 00:D242: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x001255 00:D245: A9 D2     LDA #> tbl_D28F_logo___namcot
C - - - - - 0x001257 00:D247: 85 12     STA ram_0012
C - - - - - 0x001259 00:D249: A9 8F     LDA #< tbl_D28F_logo___namcot
C - - - - - 0x00125B 00:D24B: 85 11     STA ram_0011
C - - - - - 0x00125D 00:D24D: A2 0B     LDX #$0B
C - - - - - 0x00125F 00:D24F: A0 17     LDY #$17
C - - - - - 0x001261 00:D251: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001264 00:D254: A9 D2     LDA #> tbl_D30F_txt___1980_1985_namco_ltd
C - - - - - 0x001266 00:D256: 85 12     STA ram_0012
C - - - - - 0x001268 00:D258: A9 F8     LDA #< tbl_D30F_txt___1980_1985_namco_ltd
C - - - - - 0x00126A 00:D25A: 85 11     STA ram_0011
C - - - - - 0x00126C 00:D25C: A2 04     LDX #$04
C - - - - - 0x00126E 00:D25E: A0 19     LDY #$19
C - - - - - 0x001270 00:D260: 20 B3 D6  JSR sub_D6B3_fill_buffer_with_tiles
C - - - - - 0x001273 00:D263: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x001276 00:D266: A9 D3     LDA #> tbl_D320_txt___all_rights_reserved
C - - - - - 0x001278 00:D268: 85 12     STA ram_0012
C - - - - - 0x00127A 00:D26A: A9 20     LDA #< tbl_D320_txt___all_rights_reserved
C - - - - - 0x00127C 00:D26C: 85 11     STA ram_0011
C - - - - - 0x00127E 00:D26E: A2 06     LDX #$06
C - - - - - 0x001280 00:D270: A0 1B     LDY #$1B
...
sub_D276:
bra_D276_loop:
C - - - - - 0x001286 00:D276: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
C - - - - - 0x001289 00:D279: 8A        TXA
C - - - - - 0x00128A 00:D27A: 48        PHA
C - - - - - 0x00128B 00:D27B: 20 B8 D0  JSR sub_D0B8
...
tbl_D34D_txt___who_loves_noriko:
...
; bzk garbage
- - - - - - 0x0013ED 00:D3DD: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x0013F5 00:D3E5: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x0013FD 00:D3ED: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x001405 00:D3F5: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x00140D 00:D3FD: FF        .byte $FF, $FF, $FF   ; 
...
C - - - - - 0x001416 00:D406: A9 00     LDA #$00
C - - - - - 0x001418 00:D408: 8D 03 20  STA $2003
C - - - - - 0x00141B 00:D40B: A9 02     LDA #$02
C - - - - - 0x00141D 00:D40D: 8D 14 40  STA $4014
C - - - - - 0x001420 00:D410: AD 02 20  LDA $2002
C - - - - - 0x001423 00:D413: 20 FD D8  JSR sub_D8FD
C - - - - - 0x001426 00:D416: A5 4D     LDA ram_bg_palette_id
C - - - - - 0x001428 00:D418: 30 03     BMI bra_D41D_skip_bg_palette
C - - - - - 0x00142A 00:D41A: 20 0E D5  JSR sub_D50E_set_bg_palette
...
C - - - - - 0x00145F 00:D44F: A5 0F     LDA ram_000F
C - - - - - 0x001461 00:D451: 0A        ASL
C - - - - - 0x001462 00:D452: 0A        ASL
C - - - - - 0x001463 00:D453: 0A        ASL
C - - - - - 0x001464 00:D454: 38        SEC
C - - - - - 0x001465 00:D455: E5 0F     SBC ram_000F
C - - - - - 0x001467 00:D457: 18        CLC
C - - - - - 0x001468 00:D458: 65 0A     ADC ram_frame_cnt_hi
C - - - - - 0x00146A 00:D45A: E6 10     INC ram_0010
C - - - - - 0x00146C 00:D45C: A6 10     LDX ram_0010
C - - - - - 0x00146E 00:D45E: 75 00     ADC ram_0000,X
C - - - - - 0x001470 00:D460: 85 0F     STA ram_000F
C - - - - - 0x001472 00:D462: 68        PLA
C - - - - - 0x001473 00:D463: AA        TAX
C - - - - - 0x001474 00:D464: A5 0F     LDA ram_000F
...
sub_D470:
C - - - - - 0x001480 00:D470: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
...
bra_D481_loop:
C - - - - - 0x001491 00:D481: 9D 00 04  STA ram_stage_data_page_0,X
C - - - - - 0x001494 00:D484: 9D 00 05  STA ram_stage_data_page_1,X
C - - - - - 0x001497 00:D487: 9D 00 06  STA ram_stage_data_page_2,X
C - - - - - 0x00149A 00:D48A: 9D 00 07  STA ram_stage_data_page_3,X
...
C - - - - - 0x0014C4 00:D4B4: 20 FE D9  JSR sub_D9FE_prepare_memory_for_bcd
C - - - - - 0x0014C7 00:D4B7: A2 1D     LDX #< ram_p2_score
C - - - - - 0x0014C9 00:D4B9: 20 FE D9  JSR sub_D9FE_prepare_memory_for_bcd
C - - - - - 0x0014CC 00:D4BC: 20 EF D4  JSR sub_D4EF_check_copyrights
C - - - - - 0x0014CF 00:D4BF: D0 0D     BNE bra_D4CE_copyrights_are_valid
C - - - - - 0x0014D1 00:D4C1: A2 3D     LDX #< ram_hi_score
C - - - - - 0x0014D3 00:D4C3: 20 FE D9  JSR sub_D9FE_prepare_memory_for_bcd
C - - - - - 0x0014D6 00:D4C6: A9 02     LDA #$02    ; set default hiscore 20.000
C - - - - - 0x0014D8 00:D4C8: 85 3F     STA ram_hi_score + 2
C - - - - - 0x0014DA 00:D4CA: A9 00     LDA #$00
C - - - - - 0x0014DC 00:D4CC: 85 83     STA ram_game_mode
bra_D4CE_copyrights_are_valid:
C - - - - - 0x0014DE 00:D4CE: A9 1C     LDA #$1C
C - - - - - 0x0014E0 00:D4D0: 85 05     STA ram_0005
C - - - - - 0x0014E2 00:D4D2: 20 B4 D7  JSR sub_D7B4
C - - - - - 0x0014E5 00:D4D5: A9 24     LDA #$24
C - - - - - 0x0014E7 00:D4D7: 85 05     STA ram_0005
C - - - - - 0x0014E9 00:D4D9: 20 B4 D7  JSR sub_D7B4
C - - - - - 0x0014EC 00:D4DC: 20 E3 D4  JSR sub_D4E3_set_copyrights
C - - - - - 0x0014EF 00:D4DF: 20 51 EA  JSR sub_EA51
...
- - - - - - 0x00150C 00:D4FC: A9 01     LDA #$01    ; perfect match
...
C - - - - - 0x001515 00:D505: 20 3E D5  JSR sub_D53E_set_spr_palette
C - - - - - 0x001518 00:D508: A9 00     LDA #$00
C - - - - - 0x00151A 00:D50A: 20 0E D5  JSR sub_D50E_set_bg_palette
C - - - - - 0x00151D 00:D50D: 60        RTS



sub_D50E_set_bg_palette:
...
bra_D51F_loop:
C - - - - - 0x00152F 00:D51F: BD 65 D5  LDA tbl_D565_bg_palette,X
...
C - - - - - 0x001539 00:D529: A9 FF     LDA #$FF
C - - - - - 0x00153B 00:D52B: 85 4D     STA ram_bg_palette_id
C - - - - - 0x00153D 00:D52D: A9 3F     LDA #$3F
C - - - - - 0x00153F 00:D52F: 8D 06 20  STA $2006
C - - - - - 0x001542 00:D532: A9 00     LDA #$00
...
bra_D54A_loop:
C - - - - - 0x00155A 00:D54A: BD 55 D5  LDA tbl_D555_spr_palette,X
...
C - - - - - 0x001608 00:D5F8: 10 FB     BPL bra_D5F5_loop
C - - - - - 0x00160A 00:D5FA: 60        RTS



sub_D5FB_calculate_ppu_address:
C - - - - - 0x00160B 00:D5FB: A9 00     LDA #$00
C - - - - - 0x00160D 00:D5FD: 85 00     STA ram_0000
C - - - - - 0x00160F 00:D5FF: 98        TYA
C - - - - - 0x001610 00:D600: 4A        LSR
C - - - - - 0x001611 00:D601: 66 00     ROR ram_0000
C - - - - - 0x001613 00:D603: 4A        LSR
C - - - - - 0x001614 00:D604: 66 00     ROR ram_0000
C - - - - - 0x001616 00:D606: 4A        LSR
C - - - - - 0x001617 00:D607: 66 00     ROR ram_0000
C - - - - - 0x001619 00:D609: 48        PHA
C - - - - - 0x00161A 00:D60A: 8A        TXA
C - - - - - 0x00161B 00:D60B: 05 00     ORA ram_0000
...
sub_D612:
C - - - - - 0x001622 00:D612: 20 35 D6  JSR sub_D635
C - - - - - 0x001625 00:D615: A6 0C     LDX ram_buffer_index
C - - - - - 0x001627 00:D617: A9 23     LDA #$23
...
C - - - - - 0x00162F 00:D61F: 69 C0     ADC #$C0
C - - - - - 0x001631 00:D621: 9D 80 01  STA ram_ppu_buffer,X
C - - - - - 0x001634 00:D624: E8        INX
C - - - - - 0x001635 00:D625: B9 C0 07  LDA ram_07C0,Y
...
loc_D662:
C D 2 - - - 0x001672 00:D662: 85 01     STA ram_0001
C - - - - - 0x001674 00:D664: 98        TYA
C - - - - - 0x001675 00:D665: 0A        ASL
C - - - - - 0x001676 00:D666: 29 F8     AND #$F8
C - - - - - 0x001678 00:D668: 85 00     STA ram_0000
C - - - - - 0x00167A 00:D66A: 8A        TXA
C - - - - - 0x00167B 00:D66B: 4A        LSR
C - - - - - 0x00167C 00:D66C: 4A        LSR
C - - - - - 0x00167D 00:D66D: 18        CLC
C - - - - - 0x00167E 00:D66E: 65 00     ADC ram_0000
C - - - - - 0x001680 00:D670: A8        TAY
C - - - - - 0x001681 00:D671: A5 01     LDA ram_0001
C - - - - - 0x001683 00:D673: 49 FF     EOR #$FF
C - - - - - 0x001685 00:D675: 25 02     AND ram_0002
C - - - - - 0x001687 00:D677: 85 02     STA ram_0002
C - - - - - 0x001689 00:D679: B9 C0 07  LDA ram_07C0,Y
C - - - - - 0x00168C 00:D67C: 25 01     AND ram_0001
C - - - - - 0x00168E 00:D67E: 05 02     ORA ram_0002
C - - - - - 0x001690 00:D680: 99 C0 07  STA ram_07C0,Y
...
C - - - - - 0x001696 00:D686: 05 04     ORA ram_0004
C - - - - - 0x001698 00:D688: 60        RTS



sub_D689_read_joysticks:
...
bra_D693_loop:
C - - - - - 0x0016A3 00:D693: 84 00     STY ram_0000
...
C - - - - - 0x0016AE 00:D69E: 66 00     ROR ram_0000
...
C - - - - - 0x0016B7 00:D6A7: 25 00     AND ram_0000
C - - - - - 0x0016B9 00:D6A9: 95 08     STA ram_btn_press,X
C - - - - - 0x0016BB 00:D6AB: A5 00     LDA ram_0000
...
C - - - - - 0x0016C3 00:D6B3: 20 FB D5  JSR sub_D5FB_calculate_ppu_address
C - - - - - 0x0016C6 00:D6B6: 85 14     STA ram_0014
C - - - - - 0x0016C8 00:D6B8: 18        CLC
C - - - - - 0x0016C9 00:D6B9: 65 05     ADC ram_0005
...
C - - - - - 0x0016D6 00:D6C6: 85 13     STA ram_0013
C - - - - - 0x0016D8 00:D6C8: A0 00     LDY #$00
loc_D6CA_loop:
C D 2 - - - 0x0016DA 00:D6CA: B1 11     LDA (ram_0011),Y
...
C - - - - - 0x0016E4 00:D6D4: 91 13     STA (ram_0013),Y
...
sub_D706:
C - - - - - 0x001716 00:D706: 20 13 D7  JSR sub_D713
sub_D709:
C - - - - - 0x001719 00:D709: 20 FB D5  JSR sub_D5FB_calculate_ppu_address
C - - - - - 0x00171C 00:D70C: 85 12     STA ram_0012
C - - - - - 0x00171E 00:D70E: 84 11     STY ram_0011
C - - - - - 0x001720 00:D710: A0 00     LDY #$00
C - - - - - 0x001722 00:D712: 60        RTS



sub_D713:   ; divide by 08
...
sub_D71E:
C - - - - - 0x00172E 00:D71E: 86 47     STX ram_0047
C - - - - - 0x001730 00:D720: 84 48     STY ram_0048
C - - - - - 0x001732 00:D722: 20 06 D7  JSR sub_D706
sub_D725:
C - - - - - 0x001735 00:D725: A9 01     LDA #$01
C - - - - - 0x001737 00:D727: 85 00     STA ram_0000
C - - - - - 0x001739 00:D729: A5 48     LDA ram_0048
C - - - - - 0x00173B 00:D72B: 29 04     AND #$04
C - - - - - 0x00173D 00:D72D: F0 04     BEQ bra_D733
C - - - - - 0x00173F 00:D72F: 06 00     ASL ram_0000
C - - - - - 0x001741 00:D731: 06 00     ASL ram_0000
bra_D733:
C - - - - - 0x001743 00:D733: A5 47     LDA ram_0047
C - - - - - 0x001745 00:D735: 29 04     AND #$04
C - - - - - 0x001747 00:D737: F0 02     BEQ bra_D73B_RTS
C - - - - - 0x001749 00:D739: 06 00     ASL ram_0000
bra_D73B_RTS:
...
sub_D73C:
C - - - - - 0x00174C 00:D73C: A5 00     LDA ram_0000
C - - - - - 0x00174E 00:D73E: 09 F0     ORA #$F0
C - - - - - 0x001750 00:D740: 31 11     AND (ram_0011),Y
C - - - - - 0x001752 00:D742: 60        RTS



sub_D743:
C - - - - - 0x001753 00:D743: A5 00     LDA ram_0000
C - - - - - 0x001755 00:D745: 49 FF     EOR #$FF
C - - - - - 0x001757 00:D747: 31 11     AND (ram_0011),Y
C - - - - - 0x001759 00:D749: 20 84 D7  JSR sub_D784
C - - - - - 0x00175C 00:D74C: 60        RTS



sub_D74D:
C - - - - - 0x00175D 00:D74D: B1 11     LDA (ram_0011),Y
C - - - - - 0x00175F 00:D74F: 29 F0     AND #$F0
C - - - - - 0x001761 00:D751: D0 08     BNE bra_D75B_RTS
C - - - - - 0x001763 00:D753: A5 00     LDA ram_0000
C - - - - - 0x001765 00:D755: 49 FF     EOR #$FF
C - - - - - 0x001767 00:D757: 31 11     AND (ram_0011),Y
C - - - - - 0x001769 00:D759: 91 11     STA (ram_0011),Y
bra_D75B_RTS:
C - - - - - 0x00176B 00:D75B: 60        RTS


; bzk garbage
- - - - - - 0x00176C 00:D75C: A5 00     LDA ram_0000
- - - - - - 0x00176E 00:D75E: 11 11     ORA (ram_0011),Y
- - - - - - 0x001770 00:D760: 20 84 D7  JSR sub_D784
- - - - - - 0x001773 00:D763: 60        RTS



sub_D764:
C - - - - - 0x001774 00:D764: B1 11     LDA (ram_0011),Y
C - - - - - 0x001776 00:D766: 29 F0     AND #$F0
C - - - - - 0x001778 00:D768: D0 06     BNE bra_D770_RTS
C - - - - - 0x00177A 00:D76A: A5 00     LDA ram_0000
C - - - - - 0x00177C 00:D76C: 11 11     ORA (ram_0011),Y
C - - - - - 0x00177E 00:D76E: 91 11     STA (ram_0011),Y
bra_D770_RTS:
...
sub_D771:
C - - - - - 0x001781 00:D771: A5 12     LDA ram_0012
C - - - - - 0x001783 00:D773: 18        CLC
C - - - - - 0x001784 00:D774: 65 05     ADC ram_0005
C - - - - - 0x001786 00:D776: 8D 06 20  STA $2006
C - - - - - 0x001789 00:D779: A5 11     LDA ram_0011
C - - - - - 0x00178B 00:D77B: 8D 06 20  STA $2006
C - - - - - 0x00178E 00:D77E: B1 11     LDA (ram_0011),Y
...
sub_D784:
C - - - - - 0x001794 00:D784: 91 11     STA (ram_0011),Y
C - - - - - 0x001796 00:D786: 86 47     STX ram_0047
C - - - - - 0x001798 00:D788: A6 0C     LDX ram_buffer_index
C - - - - - 0x00179A 00:D78A: A5 12     LDA ram_0012
C - - - - - 0x00179C 00:D78C: 18        CLC
C - - - - - 0x00179D 00:D78D: 69 1C     ADC #$1C
C - - - - - 0x00179F 00:D78F: 9D 80 01  STA ram_ppu_buffer,X
C - - - - - 0x0017A2 00:D792: E8        INX
C - - - - - 0x0017A3 00:D793: A5 11     LDA ram_0011
C - - - - - 0x0017A5 00:D795: 9D 80 01  STA ram_ppu_buffer,X
C - - - - - 0x0017A8 00:D798: E8        INX
C - - - - - 0x0017A9 00:D799: B1 11     LDA (ram_0011),Y
...
C - - - - - 0x0017B7 00:D7A7: A6 47     LDX ram_0047
...
C - - - - - 0x0017BB 00:D7AB: 65 11     ADC ram_0011
C - - - - - 0x0017BD 00:D7AD: 85 11     STA ram_0011
C - - - - - 0x0017BF 00:D7AF: 90 02     BCC bra_D7B3_RTS
C - - - - - 0x0017C1 00:D7B1: E6 12     INC ram_0012
bra_D7B3_RTS:
...
sub_D7B4:
C - - - - - 0x0017C4 00:D7B4: A9 00     LDA #$00
C - - - - - 0x0017C6 00:D7B6: 85 11     STA ram_0011
...
bra_D7D0_loop:
C - - - - - 0x0017E0 00:D7D0: 9D 00 04  STA ram_stage_data_page_0,X
C - - - - - 0x0017E3 00:D7D3: 9D 00 05  STA ram_stage_data_page_1,X
C - - - - - 0x0017E6 00:D7D6: 9D 00 06  STA ram_stage_data_page_2,X
C - - - - - 0x0017E9 00:D7D9: 9D 00 07  STA ram_stage_data_page_3,X
...
bra_D7E3_loop:  ; clear 07C0-07FF
C - - - - - 0x0017F3 00:D7E3: 9D 00 07  STA ram_07C0 - $C0,X
C - - - - - 0x0017F6 00:D7E6: E8        INX
C - - - - - 0x0017F7 00:D7E7: D0 FA     BNE bra_D7E3_loop
C - - - - - 0x0017F9 00:D7E9: A6 56     LDX ram_0056
C - - - - - 0x0017FB 00:D7EB: A4 57     LDY ram_0057
C - - - - - 0x0017FD 00:D7ED: 20 FB D5  JSR sub_D5FB_calculate_ppu_address
C - - - - - 0x001800 00:D7F0: 85 12     STA ram_0012
C - - - - - 0x001802 00:D7F2: 84 11     STY ram_0011
loc_D7F4:
C D 2 - - - 0x001804 00:D7F4: A4 5B     LDY ram_005B
...
C - - - - - 0x001817 00:D807: 4C F4 D7  JMP loc_D7F4
bra_D80A_RTS:
...
sub_D80B:
C - - - - - 0x00181B 00:D80B: 48        PHA
C - - - - - 0x00181C 00:D80C: 85 00     STA ram_0000
C - - - - - 0x00181E 00:D80E: 20 13 D7  JSR sub_D713
C - - - - - 0x001821 00:D811: 86 47     STX ram_0047
C - - - - - 0x001823 00:D813: 84 48     STY ram_0048
C - - - - - 0x001825 00:D815: A4 00     LDY ram_0000
C - - - - - 0x001827 00:D817: B9 BB DA  LDA tbl_DABB,Y
C - - - - - 0x00182A 00:D81A: 85 04     STA ram_0004
C - - - - - 0x00182C 00:D81C: A4 48     LDY ram_0048
C - - - - - 0x00182E 00:D81E: 20 12 D6  JSR sub_D612
C - - - - - 0x001831 00:D821: A5 48     LDA ram_0048
C - - - - - 0x001833 00:D823: 29 FE     AND #$FE
C - - - - - 0x001835 00:D825: A8        TAY
C - - - - - 0x001836 00:D826: A5 47     LDA ram_0047
C - - - - - 0x001838 00:D828: 29 FE     AND #$FE
C - - - - - 0x00183A 00:D82A: AA        TAX
C - - - - - 0x00183B 00:D82B: 20 09 D7  JSR sub_D709
C - - - - - 0x00183E 00:D82E: 68        PLA
C - - - - - 0x00183F 00:D82F: 0A        ASL
C - - - - - 0x001840 00:D830: 0A        ASL
C - - - - - 0x001841 00:D831: AA        TAX
C - - - - - 0x001842 00:D832: BD CB DA  LDA tbl_DACB,X
C - - - - - 0x001845 00:D835: E8        INX
C - - - - - 0x001846 00:D836: 20 84 D7  JSR sub_D784
C - - - - - 0x001849 00:D839: A9 01     LDA #$01
C - - - - - 0x00184B 00:D83B: 20 AA D7  JSR sub_D7AA
C - - - - - 0x00184E 00:D83E: BD CB DA  LDA tbl_DACB,X
C - - - - - 0x001851 00:D841: E8        INX
C - - - - - 0x001852 00:D842: 20 84 D7  JSR sub_D784
C - - - - - 0x001855 00:D845: A9 1F     LDA #$1F
C - - - - - 0x001857 00:D847: 20 AA D7  JSR sub_D7AA
C - - - - - 0x00185A 00:D84A: BD CB DA  LDA tbl_DACB,X
C - - - - - 0x00185D 00:D84D: E8        INX
C - - - - - 0x00185E 00:D84E: 20 84 D7  JSR sub_D784
C - - - - - 0x001861 00:D851: A9 01     LDA #$01
C - - - - - 0x001863 00:D853: 20 AA D7  JSR sub_D7AA
C - - - - - 0x001866 00:D856: BD CB DA  LDA tbl_DACB,X
C - - - - - 0x001869 00:D859: E8        INX
C - - - - - 0x00186A 00:D85A: 20 84 D7  JSR sub_D784
C - - - - - 0x00186D 00:D85D: 60        RTS



sub_D85E:
C - - - - - 0x00186E 00:D85E: 86 5D     STX ram_005D
C - - - - - 0x001870 00:D860: AA        TAX
C - - - - - 0x001871 00:D861: 98        TYA
C - - - - - 0x001872 00:D862: 18        CLC
C - - - - - 0x001873 00:D863: 69 20     ADC #$20
C - - - - - 0x001875 00:D865: 85 5E     STA ram_005E
C - - - - - 0x001877 00:D867: A9 00     LDA #< $1000
C - - - - - 0x001879 00:D869: 85 11     STA ram_0011
C - - - - - 0x00187B 00:D86B: A9 10     LDA #> $1000
C - - - - - 0x00187D 00:D86D: 85 12     STA ram_0012
loc_D86F_loop:
C D 2 - - - 0x00187F 00:D86F: CA        DEX
C - - - - - 0x001880 00:D870: 30 08     BMI bra_D87A
C - - - - - 0x001882 00:D872: A9 10     LDA #$10
C - - - - - 0x001884 00:D874: 20 AA D7  JSR sub_D7AA
C - - - - - 0x001887 00:D877: 4C 6F D8  JMP loc_D86F_loop
bra_D87A:
C - - - - - 0x00188A 00:D87A: A5 12     LDA ram_0012
C - - - - - 0x00188C 00:D87C: 8D 06 20  STA $2006
C - - - - - 0x00188F 00:D87F: A5 11     LDA ram_0011
...
C - - - - - 0x0018AC 00:D89C: 85 03     STA ram_0003
bra_D89E:
C - - - - - 0x0018AE 00:D89E: A6 5D     LDX ram_005D
C - - - - - 0x0018B0 00:D8A0: A4 5E     LDY ram_005E
C - - - - - 0x0018B2 00:D8A2: 20 1E D7  JSR sub_D71E
C - - - - - 0x0018B5 00:D8A5: A5 02     LDA ram_0002
C - - - - - 0x0018B7 00:D8A7: 25 03     AND ram_0003
...
loc_D8B4:
C D 2 - - - 0x0018C4 00:D8B4: A5 5D     LDA ram_005D
C - - - - - 0x0018C6 00:D8B6: 18        CLC
C - - - - - 0x0018C7 00:D8B7: 69 04     ADC #$04
C - - - - - 0x0018C9 00:D8B9: 85 5D     STA ram_005D
C - - - - - 0x0018CB 00:D8BB: 46 03     LSR ram_0003
C - - - - - 0x0018CD 00:D8BD: 90 DF     BCC bra_D89E
C - - - - - 0x0018CF 00:D8BF: A5 5D     LDA ram_005D
C - - - - - 0x0018D1 00:D8C1: 38        SEC
C - - - - - 0x0018D2 00:D8C2: E9 20     SBC #$20
C - - - - - 0x0018D4 00:D8C4: 85 5D     STA ram_005D
C - - - - - 0x0018D6 00:D8C6: A5 5E     LDA ram_005E
...
loc_D8D6:
C D 2 - - - 0x0018E6 00:D8D6: B1 13     LDA (ram_0013),Y
C - - - - - 0x0018E8 00:D8D8: C9 FF     CMP #$FF
C - - - - - 0x0018EA 00:D8DA: F0 19     BEQ bra_D8F5_RTS
C - - - - - 0x0018EC 00:D8DC: C8        INY
C - - - - - 0x0018ED 00:D8DD: 84 5F     STY ram_005F
C - - - - - 0x0018EF 00:D8DF: A6 56     LDX ram_0056
C - - - - - 0x0018F1 00:D8E1: A4 57     LDY ram_0057
C - - - - - 0x0018F3 00:D8E3: 18        CLC
C - - - - - 0x0018F4 00:D8E4: 65 60     ADC ram_0060
C - - - - - 0x0018F6 00:D8E6: 20 5E D8  JSR sub_D85E
C - - - - - 0x0018F9 00:D8E9: A5 56     LDA ram_0056
C - - - - - 0x0018FB 00:D8EB: 18        CLC
C - - - - - 0x0018FC 00:D8EC: 69 20     ADC #$20
C - - - - - 0x0018FE 00:D8EE: 85 56     STA ram_0056
C - - - - - 0x001900 00:D8F0: A4 5F     LDY ram_005F
C - - - - - 0x001902 00:D8F2: 4C D6 D8  JMP loc_D8D6
bra_D8F5_RTS:
C - - - - - 0x001905 00:D8F5: 60        RTS



sub_D8F6_wait_1_frame_:
C - - - - - 0x001906 00:D8F6: A5 0B     LDA ram_frame_cnt_lo
bra_D8F8_infinite_loop:
C - - - - - 0x001908 00:D8F8: C5 0B     CMP ram_frame_cnt_lo
...
C - - - - - 0x001936 00:D926: BD 7F 01  LDA ram_ppu_buffer - 1,X
bra_D929:
...
sub_D934:
loc_D934_loop:
C D 2 - - - 0x001944 00:D934: B9 00 00  LDA ram_0000,Y
...
bra_D93E:
C - - - - - 0x00194E 00:D93E: C9 FF     CMP #$FF    ; check for end token which was set at 0x001A1E
C - - - - - 0x001950 00:D940: D0 08     BNE bra_D94A
C - - - - - 0x001952 00:D942: A5 6B     LDA ram_006B
...
C - - - - - 0x00195C 00:D94C: 85 12     STA ram_0012
C - - - - - 0x00195E 00:D94E: 84 11     STY ram_0011
...
C - - - - - 0x001963 00:D953: 85 56     STA ram_0056
C - - - - - 0x001965 00:D955: A9 64     LDA #$64
C - - - - - 0x001967 00:D957: 85 57     STA ram_0057
C - - - - - 0x001969 00:D959: A9 30     LDA #$30
C - - - - - 0x00196B 00:D95B: 85 60     STA ram_0060
C - - - - - 0x00196D 00:D95D: A0 3D     LDY #$3D
loc_D95F:
C D 2 - - - 0x00196F 00:D95F: B9 00 00  LDA ram_0000,Y
C - - - - - 0x001972 00:D962: D0 0B     BNE bra_D96F
C - - - - - 0x001974 00:D964: C8        INY
C - - - - - 0x001975 00:D965: A5 56     LDA ram_0056
C - - - - - 0x001977 00:D967: 18        CLC
C - - - - - 0x001978 00:D968: 69 20     ADC #$20
C - - - - - 0x00197A 00:D96A: 85 56     STA ram_0056
C - - - - - 0x00197C 00:D96C: 4C 5F D9  JMP loc_D95F
bra_D96F:
...
C - - - - - 0x00199C 00:D98C: 4C 81 D9  JMP loc_D981
bra_D98F:
...
C - - - - - 0x0019AA 00:D99A: D0 F7     BNE bra_D993
...
- - - - - - 0x0019C9 00:D9B9: D0 F7     BNE bra_D9B2
...
C - - - - - 0x0019DC 00:D9CC: 75 15     ADC ram_p1_score,X
...
loc_D9DA:
C D 2 - - - 0x0019EA 00:D9DA: 95 15     STA ram_p1_score,X
...
sub_D9E1:
C - - - - - 0x0019F1 00:D9E1: 85 00     STA ram_0000
C - - - - - 0x0019F3 00:D9E3: A2 35     LDX #< ram_com_dec_number
C - - - - - 0x0019F5 00:D9E5: 20 FE D9  JSR sub_D9FE_prepare_memory_for_bcd
C - - - - - 0x0019F8 00:D9E8: A5 00     LDA ram_0000
C - - - - - 0x0019FA 00:D9EA: F0 0D     BEQ bra_D9F9
C - - - - - 0x0019FC 00:D9EC: 29 0F     AND #$0F
C - - - - - 0x0019FE 00:D9EE: 85 3A     STA ram_com_dec_num_tens
C - - - - - 0x001A00 00:D9F0: A5 00     LDA ram_0000
...
sub_D9FE_prepare_memory_for_bcd:
...
C - - - - - 0x001A10 00:DA00: 95 00     STA ram_0000,X       ; millions
C - - - - - 0x001A12 00:DA02: 95 01     STA ram_0000 + 1,X   ; hundreds of thousands
C - - - - - 0x001A14 00:DA04: 95 02     STA ram_0000 + 2,X   ; tens of thousands
C - - - - - 0x001A16 00:DA06: 95 03     STA ram_0000 + 3,X   ; thousands
C - - - - - 0x001A18 00:DA08: 95 04     STA ram_0000 + 4,X   ; hundreds
C - - - - - 0x001A1A 00:DA0A: 95 05     STA ram_0000 + 5,X   ; tens
C - - - - - 0x001A1C 00:DA0C: 95 06     STA ram_0000 + 6,X   ; ones
C - - - - - 0x001A1E 00:DA0E: A9 FF     LDA #$FF
C - - - - - 0x001A20 00:DA10: 95 07     STA ram_0000 + 7,X   ; end token
...
; A = hex number
C - - - - - 0x001A23 00:DA13: 85 00     STA ram_0000
C - - - - - 0x001A25 00:DA15: A2 35     LDX #< ram_com_dec_number
C - - - - - 0x001A27 00:DA17: 20 FE D9  JSR sub_D9FE_prepare_memory_for_bcd
C - - - - - 0x001A2A 00:DA1A: A5 00     LDA ram_0000
loc_DA1C_loop:
...
C - - - - - 0x001A3C 00:DA2C: 85 47     STA ram_0047
...
C - - - - - 0x001A46 00:DA36: 85 48     STA ram_0048
C - - - - - 0x001A48 00:DA38: 20 06 D7  JSR sub_D706
C - - - - - 0x001A4B 00:DA3B: B1 11     LDA (ram_0011),Y
C - - - - - 0x001A4D 00:DA3D: C9 22     CMP #$22
C - - - - - 0x001A4F 00:DA3F: D0 06     BNE bra_DA47
C - - - - - 0x001A51 00:DA41: A5 04     LDA ram_0004
C - - - - - 0x001A53 00:DA43: 05 6E     ORA ram_006E
C - - - - - 0x001A55 00:DA45: 85 04     STA ram_0004
bra_DA47:
C - - - - - 0x001A57 00:DA47: A6 0D     LDX ram_000D
C - - - - - 0x001A59 00:DA49: A5 48     LDA ram_0048
C - - - - - 0x001A5B 00:DA4B: 9D 00 02  STA ram_spr_Y,X
C - - - - - 0x001A5E 00:DA4E: A5 53     LDA ram_0053
C - - - - - 0x001A60 00:DA50: 9D 01 02  STA ram_spr_T,X
C - - - - - 0x001A63 00:DA53: A5 04     LDA ram_0004
C - - - - - 0x001A65 00:DA55: 9D 02 02  STA ram_spr_A,X
C - - - - - 0x001A68 00:DA58: A5 47     LDA ram_0047
C - - - - - 0x001A6A 00:DA5A: 9D 03 02  STA ram_spr_X,X
C - - - - - 0x001A6D 00:DA5D: 8A        TXA
C - - - - - 0x001A6E 00:DA5E: 18        CLC
C - - - - - 0x001A6F 00:DA5F: 65 0E     ADC ram_000E
C - - - - - 0x001A71 00:DA61: 85 0D     STA ram_000D
...
C - - - - - 0x001A76 00:DA66: 65 53     ADC ram_0053
C - - - - - 0x001A78 00:DA68: 85 53     STA ram_0053
C - - - - - 0x001A7A 00:DA6A: 8A        TXA
C - - - - - 0x001A7B 00:DA6B: 38        SEC
C - - - - - 0x001A7C 00:DA6C: E9 05     SBC #$05
C - - - - - 0x001A7E 00:DA6E: AA        TAX
...
C - - - - - 0x001A87 00:DA77: 65 53     ADC ram_0053
C - - - - - 0x001A89 00:DA79: 85 53     STA ram_0053
sub_DA7B:
C - - - - - 0x001A8B 00:DA7B: 86 54     STX ram_0054
C - - - - - 0x001A8D 00:DA7D: 84 55     STY ram_0055
C - - - - - 0x001A8F 00:DA7F: 8A        TXA
C - - - - - 0x001A90 00:DA80: 38        SEC
C - - - - - 0x001A91 00:DA81: E9 08     SBC #$08
C - - - - - 0x001A93 00:DA83: AA        TAX
C - - - - - 0x001A94 00:DA84: 20 2B DA  JSR sub_DA2B_display_sprite
C - - - - - 0x001A97 00:DA87: E6 53     INC ram_0053
C - - - - - 0x001A99 00:DA89: E6 53     INC ram_0053
C - - - - - 0x001A9B 00:DA8B: A6 54     LDX ram_0054
C - - - - - 0x001A9D 00:DA8D: A4 55     LDY ram_0055
...
C - - - - - 0x001AA3 00:DA93: A6 0D     LDX ram_000D
C - - - - - 0x001AA5 00:DA95: A5 0E     LDA ram_000E
C - - - - - 0x001AA7 00:DA97: 49 FF     EOR #$FF
C - - - - - 0x001AA9 00:DA99: 18        CLC
C - - - - - 0x001AAA 00:DA9A: 69 01     ADC #$01
C - - - - - 0x001AAC 00:DA9C: 85 0E     STA ram_000E
bra_DA9E_loop:
C - - - - - 0x001AAE 00:DA9E: 8A        TXA
C - - - - - 0x001AAF 00:DA9F: 18        CLC
C - - - - - 0x001AB0 00:DAA0: 65 0E     ADC ram_000E
...
C - - - - - 0x001ABC 00:DAAC: 86 0D     STX ram_000D
...
- - - - - - 0x001AD9 00:DAC9: 00        .byte $00   ; 0E
...
- - - - - - 0x001B13 00:DB03: 00        .byte $00, $00, $00, $00   ; 0E
...
C - - - - - 0x001B4E 00:DB3E: B5 A0     LDA ram_tank_status,X
...
C - - - - - 0x001BAF 00:DB9F: 20 51 E4  JSR sub_E451_check_dpad_buttons
C - - - - - 0x001BB2 00:DBA2: 85 00     STA ram_0000
C - - - - - 0x001BB4 00:DBA4: 10 0E     BPL bra_DBB4
bra_DBA6:
loc_DBA6:
C D 2 - - - 0x001BB6 00:DBA6: A9 80     LDA #$80
C - - - - - 0x001BB8 00:DBA8: 20 20 E4  JSR sub_E420
C - - - - - 0x001BBB 00:DBAB: A9 08     LDA #$08
C - - - - - 0x001BBD 00:DBAD: 15 A0     ORA ram_tank_status,X
C - - - - - 0x001BBF 00:DBAF: 95 A0     STA ram_tank_status,X
C - - - - - 0x001BC1 00:DBB1: 4C ED DB  JMP loc_DBED
bra_DBB4:
C - - - - - 0x001BC4 00:DBB4: BD 03 01  LDA ram_0103,X
...
bra_DBE7:
C - - - - - 0x001BF7 00:DBE7: A5 00     LDA ram_0000
C - - - - - 0x001BF9 00:DBE9: 09 A0     ORA #$A0
C - - - - - 0x001BFB 00:DBEB: 95 A0     STA ram_tank_status,X
bra_DBED:
loc_DBED:
...
C - - - - - 0x001C1F 00:DC0F: A5 0B     LDA ram_frame_cnt_lo
...
C - - - - - 0x001C2D 00:DC1D: B5 A0     LDA ram_tank_status,X
...
sub_DC3D:
C - - - - - 0x001C4D 00:DC3D: B5 A0     LDA ram_tank_status,X
...
C - - - - - 0x001C58 00:DC48: 85 11     STA ram_0011
C - - - - - 0x001C5A 00:DC4A: B9 99 E4  LDA tbl_E498_tank_status_handler + 1,Y
C - - - - - 0x001C5D 00:DC4D: 85 12     STA ram_0012
C - - - - - 0x001C5F 00:DC4F: 6C 11 00  JMP (ram_0011)



ofs_DC52_08:
C - - J - - 0x001C62 00:DC52: E0 02     CPX #$02
C - - - - - 0x001C64 00:DC54: B0 15     BCS bra_DC6B
C - - - - - 0x001C66 00:DC56: BD 03 01  LDA ram_0103,X
C - - - - - 0x001C69 00:DC59: 10 10     BPL bra_DC6B
C - - - - - 0x001C6B 00:DC5B: 29 7F     AND #$7F
C - - - - - 0x001C6D 00:DC5D: F0 0C     BEQ bra_DC6B
C - - - - - 0x001C6F 00:DC5F: DE 03 01  DEC ram_0103,X
...
bra_DC6B:
C - - - - - 0x001C7B 00:DC6B: B5 A0     LDA ram_tank_status,X
C - - - - - 0x001C7D 00:DC6D: 38        SEC
C - - - - - 0x001C7E 00:DC6E: E9 04     SBC #$04
C - - - - - 0x001C80 00:DC70: 95 A0     STA ram_tank_status,X
C - - - - - 0x001C82 00:DC72: 29 0C     AND #$0C
C - - - - - 0x001C84 00:DC74: D0 05     BNE bra_DC7B_RTS
C - - - - - 0x001C86 00:DC76: A9 A0     LDA #$A0
C - - - - - 0x001C88 00:DC78: 20 20 E4  JSR sub_E420
bra_DC7B_RTS:
...
C - - - - - 0x001C8E 00:DC7E: 90 17     BCC bra_DC97
...
C - - - - - 0x001C9C 00:DC8C: 20 4D D4  JSR sub_D44D_roll_rng
...
bra_DC97:
loc_DC97:
C D 2 - - - 0x001CA7 00:DC97: B5 A0     LDA ram_tank_status,X
...
bra_DCDF:
C - - - - - 0x001CEF 00:DCDF: A5 56     LDA ram_0056
C - - - - - 0x001CF1 00:DCE1: 18        CLC
C - - - - - 0x001CF2 00:DCE2: 65 58     ADC ram_0058
C - - - - - 0x001CF4 00:DCE4: 38        SEC
C - - - - - 0x001CF5 00:DCE5: E5 59     SBC ram_0059
C - - - - - 0x001CF7 00:DCE7: 20 6E DD  JSR sub_DD6E
C - - - - - 0x001CFA 00:DCEA: AA        TAX
C - - - - - 0x001CFB 00:DCEB: A5 57     LDA ram_0057
C - - - - - 0x001CFD 00:DCED: 18        CLC
C - - - - - 0x001CFE 00:DCEE: 65 59     ADC ram_0059
C - - - - - 0x001D00 00:DCF0: 38        SEC
C - - - - - 0x001D01 00:DCF1: E5 58     SBC ram_0058
C - - - - - 0x001D03 00:DCF3: 20 76 DD  JSR sub_DD76
C - - - - - 0x001D06 00:DCF6: A8        TAY
C - - - - - 0x001D07 00:DCF7: 20 06 D7  JSR sub_D706
C - - - - - 0x001D0A 00:DCFA: B1 11     LDA (ram_0011),Y
...
C - - - - - 0x001D2E 00:DD1E: A9 80     LDA #$80
C - - - - - 0x001D30 00:DD20: 20 20 E4  JSR sub_E420
C - - - - - 0x001D33 00:DD23: A9 08     LDA #$08
C - - - - - 0x001D35 00:DD25: 15 A0     ORA ram_tank_status,X
C - - - - - 0x001D37 00:DD27: 95 A0     STA ram_tank_status,X
bra_DD29:
loc_DD29:
...
C - - - - - 0x001D4C 00:DD3C: A9 90     LDA #$90
C - - - - - 0x001D4E 00:DD3E: 20 20 E4  JSR sub_E420
bra_DD41:
C - - - - - 0x001D51 00:DD41: B5 A0     LDA ram_tank_status,X
C - - - - - 0x001D53 00:DD43: 49 02     EOR #$02
C - - - - - 0x001D55 00:DD45: 95 A0     STA ram_tank_status,X
C - - - - - 0x001D57 00:DD47: 60        RTS



ofs_DD48_09:
C - - J - - 0x001D58 00:DD48: 20 4D D4  JSR sub_D44D_roll_rng
C - - - - - 0x001D5B 00:DD4B: 29 01     AND #$01
C - - - - - 0x001D5D 00:DD4D: F0 1B     BEQ bra_DD6A
C - - - - - 0x001D5F 00:DD4F: 20 4D D4  JSR sub_D44D_roll_rng
C - - - - - 0x001D62 00:DD52: 29 01     AND #$01
C - - - - - 0x001D64 00:DD54: F0 08     BEQ bra_DD5E
C - - - - - 0x001D66 00:DD56: B5 A0     LDA ram_tank_status,X
C - - - - - 0x001D68 00:DD58: 18        CLC
C - - - - - 0x001D69 00:DD59: 69 01     ADC #$01
C - - - - - 0x001D6B 00:DD5B: 4C 63 DD  JMP loc_DD63
bra_DD5E:
C - - - - - 0x001D6E 00:DD5E: B5 A0     LDA ram_tank_status,X
C - - - - - 0x001D70 00:DD60: 38        SEC
C - - - - - 0x001D71 00:DD61: E9 01     SBC #$01
loc_DD63:
C D 2 - - - 0x001D73 00:DD63: 29 03     AND #$03
C - - - - - 0x001D75 00:DD65: 09 A0     ORA #$A0
C - - - - - 0x001D77 00:DD67: 95 A0     STA ram_tank_status,X
...
sub_DD6E:
C - - - - - 0x001D7E 00:DD6E: C5 56     CMP ram_0056
...
sub_DD76:
C - - - - - 0x001D86 00:DD76: C5 57     CMP ram_0057
...
C - - - - - 0x001D90 00:DD80: 85 71     STA ram_0071
C - - - - - 0x001D92 00:DD82: A5 98     LDA ram_tank_pos_Y
C - - - - - 0x001D94 00:DD84: 85 72     STA ram_0072
C - - - - - 0x001D96 00:DD86: 4C 9C DD  JMP loc_DD9C



ofs_DD89_0C:
C - - J - - 0x001D99 00:DD89: A5 91     LDA ram_tank_pos_X + 1
C - - - - - 0x001D9B 00:DD8B: 85 71     STA ram_0071
C - - - - - 0x001D9D 00:DD8D: A5 99     LDA ram_tank_pos_Y + 1
C - - - - - 0x001D9F 00:DD8F: 85 72     STA ram_0072
...
C - - - - - 0x001DEE 00:DDDE: 65 64     ADC ram_0064
C - - - - - 0x001DF0 00:DDE0: A8        TAY
C - - - - - 0x001DF1 00:DDE1: 4C E6 DD  JMP loc_DDE6
bra_DDE4:
C - - - - - 0x001DF4 00:DDE4: A4 64     LDY ram_0064
loc_DDE6:
C D 2 - - - 0x001DF6 00:DDE6: B9 86 E4  LDA tbl_E486,Y
...
ofs_DDEA_06:
ofs_DDEA_07:
C - - J - - 0x001DFA 00:DDEA: D6 A0     DEC ram_tank_status,X
C - - - - - 0x001DFC 00:DDEC: B5 A0     LDA ram_tank_status,X
...
ofs_DE55_0F:
C - - J - - 0x001E65 00:DE55: F6 A0     INC ram_tank_status,X
C - - - - - 0x001E67 00:DE57: B5 A0     LDA ram_tank_status,X
C - - - - - 0x001E69 00:DE59: 29 0F     AND #$0F
C - - - - - 0x001E6B 00:DE5B: C9 0E     CMP #$0E
C - - - - - 0x001E6D 00:DE5D: D0 04     BNE bra_DE63_RTS
C - - - - - 0x001E6F 00:DE5F: A9 E0     LDA #$E0
C - - - - - 0x001E71 00:DE61: 95 A0     STA ram_tank_status,X
bra_DE63_RTS:
...
ofs_DE64_0E:
C - - J - - 0x001E74 00:DE64: F6 A0     INC ram_tank_status,X
C - - - - - 0x001E76 00:DE66: B5 A0     LDA ram_tank_status,X
...
C - - - - - 0x001E86 00:DE76: C5 0A     CMP ram_frame_cnt_hi
C - - - - - 0x001E88 00:DE78: B0 05     BCS bra_DE7F
C - - - - - 0x001E8A 00:DE7A: A9 B0     LDA #$B0
C - - - - - 0x001E8C 00:DE7C: 4C A2 DE  JMP loc_DEA2    ; bzk optimize, BNE
bra_DE7F:
C - - - - - 0x001E8F 00:DE7F: 4A        LSR
C - - - - - 0x001E90 00:DE80: C5 0A     CMP ram_frame_cnt_hi
C - - - - - 0x001E92 00:DE82: 90 0A     BCC bra_DE8E
C - - - - - 0x001E94 00:DE84: 20 4D D4  JSR sub_D44D_roll_rng
C - - - - - 0x001E97 00:DE87: 29 03     AND #$03
C - - - - - 0x001E99 00:DE89: 09 A0     ORA #$A0
C - - - - - 0x001E9B 00:DE8B: 95 A0     STA ram_tank_status,X
C - - - - - 0x001E9D 00:DE8D: 60        RTS
bra_DE8E:
C - - - - - 0x001E9E 00:DE8E: A5 A0     LDA ram_tank_status
...
C - - - - - 0x001EA7 00:DE97: A5 A1     LDA ram_tank_status + 1
C - - - - - 0x001EA9 00:DE99: F0 05     BEQ bra_DEA0
bra_DE9B:
C - - - - - 0x001EAB 00:DE9B: A9 C0     LDA #$C0
C - - - - - 0x001EAD 00:DE9D: 4C A2 DE  JMP loc_DEA2    ; bzk optimize, BNE
bra_DEA0:
C - - - - - 0x001EB0 00:DEA0: A9 D0     LDA #$D0
loc_DEA2:
C D 2 - - - 0x001EB2 00:DEA2: 20 20 E4  JSR sub_E420
...
sub_DEB8:
C - - - - - 0x001EC8 00:DEB8: B5 A0     LDA ram_tank_status,X
...
C - - - - - 0x001ED3 00:DEC3: 85 11     STA ram_0011
C - - - - - 0x001ED5 00:DEC5: B9 B9 E4  LDA tbl_E4B8_tank_status_handler + 1,Y
C - - - - - 0x001ED8 00:DEC8: 85 12     STA ram_0012
C - - - - - 0x001EDA 00:DECA: 6C 11 00  JMP (ram_0011)
...
C - - - - - 0x001EDF 00:DECF: 85 6E     STA ram_006E
C - - - - - 0x001EE1 00:DED1: B5 A0     LDA ram_tank_status,X
...
C - - - - - 0x001EEF 00:DEDF: 85 6E     STA ram_006E
...
C - - - - - 0x001F03 00:DEF3: 85 53     STA ram_0053
C - - - - - 0x001F05 00:DEF5: A9 03     LDA #$03
C - - - - - 0x001F07 00:DEF7: 85 04     STA ram_0004
C - - - - - 0x001F09 00:DEF9: 20 7B DA  JSR sub_DA7B
...
C - - - - - 0x001F0F 00:DEFF: 85 6E     STA ram_006E
...
C - - - - - 0x001F22 00:DF12: 85 53     STA ram_0053
C - - - - - 0x001F24 00:DF14: A9 03     LDA #$03
C - - - - - 0x001F26 00:DF16: 85 04     STA ram_0004
C - - - - - 0x001F28 00:DF18: B4 98     LDY ram_tank_pos_Y,X
C - - - - - 0x001F2A 00:DF1A: B5 90     LDA ram_tank_pos_X,X
C - - - - - 0x001F2C 00:DF1C: AA        TAX
C - - - - - 0x001F2D 00:DF1D: 20 7B DA  JSR sub_DA7B
...
C - - - - - 0x001F40 00:DF30: 85 6E     STA ram_006E
...
C - - - - - 0x001F45 00:DF35: 85 6E     STA ram_006E
...
C - - - - - 0x001F53 00:DF43: 85 6E     STA ram_006E
...
C - - - - - 0x001F58 00:DF48: 85 04     STA ram_0004
C - - - - - 0x001F5A 00:DF4A: A9 00     LDA #$00
C - - - - - 0x001F5C 00:DF4C: 85 6E     STA ram_006E
...
C - - - - - 0x001F65 00:DF55: AA        TAX
C - - - - - 0x001F66 00:DF56: 98        TYA
C - - - - - 0x001F67 00:DF57: 38        SEC
C - - - - - 0x001F68 00:DF58: E9 08     SBC #$08
C - - - - - 0x001F6A 00:DF5A: A8        TAY
C - - - - - 0x001F6B 00:DF5B: 20 7B DA  JSR sub_DA7B
...
C - - - - - 0x001F77 00:DF67: AA        TAX
C - - - - - 0x001F78 00:DF68: 98        TYA
C - - - - - 0x001F79 00:DF69: 38        SEC
C - - - - - 0x001F7A 00:DF6A: E9 08     SBC #$08
C - - - - - 0x001F7C 00:DF6C: A8        TAY
C - - - - - 0x001F7D 00:DF6D: 20 7B DA  JSR sub_DA7B
...
C - - - - - 0x001F89 00:DF79: AA        TAX
C - - - - - 0x001F8A 00:DF7A: 98        TYA
C - - - - - 0x001F8B 00:DF7B: 18        CLC
C - - - - - 0x001F8C 00:DF7C: 69 08     ADC #$08
C - - - - - 0x001F8E 00:DF7E: A8        TAY
C - - - - - 0x001F8F 00:DF7F: 20 7B DA  JSR sub_DA7B
...
C - - - - - 0x001F9B 00:DF8B: AA        TAX
C - - - - - 0x001F9C 00:DF8C: 98        TYA
C - - - - - 0x001F9D 00:DF8D: 18        CLC
C - - - - - 0x001F9E 00:DF8E: 69 08     ADC #$08
C - - - - - 0x001FA0 00:DF90: A8        TAY
C - - - - - 0x001FA1 00:DF91: 20 7B DA  JSR sub_DA7B
C - - - - - 0x001FA4 00:DF94: A9 20     LDA #$20
C - - - - - 0x001FA6 00:DF96: 85 6E     STA ram_006E
...
C - - - - - 0x001FB0 00:DFA0: 85 00     STA ram_0000
C - - - - - 0x001FB2 00:DFA2: B5 A0     LDA ram_tank_status,X
...
C - - - - - 0x001FBC 00:DFAC: 65 00     ADC ram_0000
C - - - - - 0x001FBE 00:DFAE: 85 53     STA ram_0053
...
bra_DFCD:
C - - - - - 0x001FDD 00:DFCD: A5 0B     LDA ram_frame_cnt_lo
...
C - - - - - 0x001FE7 00:DFD7: B9 03 E0  LDA tbl_E003,Y
C - - - - - 0x001FEA 00:DFDA: 4C E9 DF  JMP loc_DFE9
bra_DFDD:
C - - - - - 0x001FED 00:DFDD: B5 6F     LDA ram_stun_timer,X
C - - - - - 0x001FEF 00:DFDF: F0 07     BEQ bra_DFE8
C - - - - - 0x001FF1 00:DFE1: A5 0B     LDA ram_frame_cnt_lo
...
loc_DFE9:
C D 2 - - - 0x001FF9 00:DFE9: 85 04     STA ram_0004
C - - - - - 0x001FFB 00:DFEB: B5 A0     LDA ram_tank_status,X
C - - - - - 0x001FFD 00:DFED: 29 03     AND #$03
C - - - - - 0x001FFF 00:DFEF: 48        PHA
...
C - - - - - 0x002007 00:DFF7: 85 53     STA ram_0053
C - - - - - 0x002009 00:DFF9: B4 98     LDY ram_tank_pos_Y,X
C - - - - - 0x00200B 00:DFFB: B5 90     LDA ram_tank_pos_X,X
C - - - - - 0x00200D 00:DFFD: AA        TAX
C - - - - - 0x00200E 00:DFFE: 68        PLA
C - - - - - 0x00200F 00:DFFF: 20 73 DA  JSR sub_DA73
...
ofs_E00B_0E:
ofs_E00B_0F:
C - - J - - 0x00201B 00:E00B: B5 A0     LDA ram_tank_status,X
...
C - - - - - 0x00202F 00:E01F: 85 53     STA ram_0053
C - - - - - 0x002031 00:E021: A9 03     LDA #$03
C - - - - - 0x002033 00:E023: 85 04     STA ram_0004
C - - - - - 0x002035 00:E025: B4 98     LDY ram_tank_pos_Y,X
C - - - - - 0x002037 00:E027: B5 90     LDA ram_tank_pos_X,X
C - - - - - 0x002039 00:E029: AA        TAX
C - - - - - 0x00203A 00:E02A: 20 7B DA  JSR sub_DA7B
...
C - - - - - 0x002054 00:E044: B9 D8 E4  LDA tbl_E4D8,Y
C - - - - - 0x002057 00:E047: 85 11     STA ram_0011
C - - - - - 0x002059 00:E049: B9 D9 E4  LDA tbl_E4D8 + 1,Y
C - - - - - 0x00205C 00:E04C: 85 12     STA ram_0012
C - - - - - 0x00205E 00:E04E: 6C 11 00  JMP (ram_0011)
...
C - - - - - 0x0020A2 00:E092: B0 05     BCS bra_E099
C - - - - - 0x0020A4 00:E094: A9 01     LDA #$01
C - - - - - 0x0020A6 00:E096: 8D 0F 03  STA ram_sfx_shot
bra_E099:
C - - - - - 0x0020A9 00:E099: B5 A0     LDA ram_tank_status,X
...
C - - - - - 0x0020FE 00:E0EE: B9 E2 E4  LDA tbl_E4E2,Y
C - - - - - 0x002101 00:E0F1: 85 11     STA ram_0011
C - - - - - 0x002103 00:E0F3: B9 E3 E4  LDA tbl_E4E2 + 1,Y
C - - - - - 0x002106 00:E0F6: 85 12     STA ram_0012
C - - - - - 0x002108 00:E0F8: 6C 11 00  JMP (ram_0011)
...
C - - - - - 0x002117 00:E107: 85 04     STA ram_0004
C - - - - - 0x002119 00:E109: A9 B1     LDA #$B1
C - - - - - 0x00211B 00:E10B: 85 53     STA ram_0053
...
C - - - - - 0x002181 00:E171: 20 4D D4  JSR sub_D44D_roll_rng
C - - - - - 0x002184 00:E174: 29 1F     AND #$1F
C - - - - - 0x002186 00:E176: D0 03     BNE bra_E17B
C - - - - - 0x002188 00:E178: 20 8C E0  JSR sub_E08C
bra_E17B:
...
C - - - - - 0x0021BE 00:E1AE: B0 19     BCS bra_E1C9
C - - - - - 0x0021C0 00:E1B0: B1 11     LDA (ram_0011),Y
C - - - - - 0x0021C2 00:E1B2: C9 21     CMP #$21
C - - - - - 0x0021C4 00:E1B4: D0 0B     BNE bra_E1C1
C - - - - - 0x0021C6 00:E1B6: A9 80     LDA #$80
C - - - - - 0x0021C8 00:E1B8: 1D 03 01  ORA ram_0103,X
C - - - - - 0x0021CB 00:E1BB: 9D 03 01  STA ram_0103,X
C - - - - - 0x0021CE 00:E1BE: 4C C9 E1  JMP loc_E1C9
bra_E1C1:
C - - - - - 0x0021D1 00:E1C1: BD 03 01  LDA ram_0103,X
C - - - - - 0x0021D4 00:E1C4: 29 7F     AND #$7F
C - - - - - 0x0021D6 00:E1C6: 9D 03 01  STA ram_0103,X
bra_E1C9:
loc_E1C9:
C D 3 - - - 0x0021D9 00:E1C9: 20 F3 E1  JSR sub_E1F3
...
C - - - - - 0x0021EA 00:E1DA: 20 F3 E1  JSR sub_E1F3
bra_E1DD:
...
sub_E1F3:
C - - - - - 0x002203 00:E1F3: B1 11     LDA (ram_0011),Y
C - - - - - 0x002205 00:E1F5: 09 80     ORA #$80
C - - - - - 0x002207 00:E1F7: 91 11     STA (ram_0011),Y
...
C - - - - - 0x00221A 00:E20A: 85 11     STA ram_0011
C - - - - - 0x00221C 00:E20C: B5 E8     LDA ram_tank_stage_pos_hi,X
C - - - - - 0x00221E 00:E20E: 29 03     AND #$03
C - - - - - 0x002220 00:E210: 09 04     ORA #$04
C - - - - - 0x002222 00:E212: 85 12     STA ram_0012
C - - - - - 0x002224 00:E214: A0 21     LDY #$21
C - - - - - 0x002226 00:E216: 20 34 E2  JSR sub_E234
...
C - - - - - 0x002231 00:E221: 20 34 E2  JSR sub_E234
bra_E224:
...
sub_E234:
C - - - - - 0x002244 00:E234: B1 11     LDA (ram_0011),Y
C - - - - - 0x002246 00:E236: 29 7F     AND #$7F
C - - - - - 0x002248 00:E238: 91 11     STA (ram_0011),Y
...
C - - - - - 0x00224F 00:E23F: A5 62     LDA ram_0062
C - - - - - 0x002251 00:E241: F0 16     BEQ bra_E259
C - - - - - 0x002253 00:E243: C6 62     DEC ram_0062
...
C - - - - - 0x002260 00:E250: 85 04     STA ram_0004
C - - - - - 0x002262 00:E252: A9 3B     LDA #$3B
C - - - - - 0x002264 00:E254: 85 53     STA ram_0053
C - - - - - 0x002266 00:E256: 4C 6C E2  JMP loc_E26C
bra_E259:
C - - - - - 0x002269 00:E259: A5 0B     LDA ram_frame_cnt_lo
...
C - - - - - 0x002271 00:E261: 85 04     STA ram_0004
...
C - - - - - 0x00227A 00:E26A: 85 53     STA ram_0053
loc_E26C:
C D 3 - - - 0x00227C 00:E26C: A6 86     LDX ram_bonus_pos_X
C - - - - - 0x00227E 00:E26E: A4 87     LDY ram_bonus_pos_Y
C - - - - - 0x002280 00:E270: A9 00     LDA #$00
C - - - - - 0x002282 00:E272: 85 6E     STA ram_006E
C - - - - - 0x002284 00:E274: 20 7B DA  JSR sub_DA7B
C - - - - - 0x002287 00:E277: A9 20     LDA #$20
C - - - - - 0x002289 00:E279: 85 6E     STA ram_006E
bra_E27B_RTS:
loc_E27B_RTS:
...
C - - - - - 0x0022A0 00:E290: 85 04     STA ram_0004
C - - - - - 0x0022A2 00:E292: B4 98     LDY ram_tank_pos_Y,X
C - - - - - 0x0022A4 00:E294: B5 90     LDA ram_tank_pos_X,X
C - - - - - 0x0022A6 00:E296: AA        TAX
C - - - - - 0x0022A7 00:E297: A5 0B     LDA ram_frame_cnt_lo
...
C - - - - - 0x0022BD 00:E2AD: A5 0B     LDA ram_frame_cnt_lo
C - - - - - 0x0022BF 00:E2AF: 29 0F     AND #$0F
C - - - - - 0x0022C1 00:E2B1: D0 1F     BNE bra_E2D2
C - - - - - 0x0022C3 00:E2B3: A5 0B     LDA ram_frame_cnt_lo
...
C - - - - - 0x0022D3 00:E2C3: A5 0B     LDA ram_frame_cnt_lo
...
C - - - - - 0x00230B 00:E2FB: 85 11     STA ram_0011
C - - - - - 0x00230D 00:E2FD: B9 07 E3  LDA tbl_E306_explosion_handler + 1,Y
C - - - - - 0x002310 00:E300: 85 12     STA ram_0012
C - - - - - 0x002312 00:E302: 6C 11 00  JMP (ram_0011)
bra_E305_RTS:
...
- D 3 - - - 0x002316 00:E306: F0 DB     .word ofs_DBF0_00_RTS
- D 3 - - - 0x002318 00:E308: 12 E3     .word ofs_E312_01
- D 3 - - - 0x00231A 00:E30A: 17 E3     .word ofs_E317_02
- D 3 - - - 0x00231C 00:E30C: 1C E3     .word ofs_E31C_03
- D 3 - - - 0x00231E 00:E30E: 2E E3     .word ofs_E32E_04
- D 3 - - - 0x002320 00:E310: 36 E3     .word ofs_E336_05



ofs_E312_01:
C - - J - - 0x002322 00:E312: A9 F1     LDA #$F1
C - - - - - 0x002324 00:E314: 4C 1E E3  JMP loc_E31E    ; bzk optimize, BNE

ofs_E317_02:
C - - J - - 0x002327 00:E317: A9 F5     LDA #$F5
C - - - - - 0x002329 00:E319: 4C 1E E3  JMP loc_E31E    ; bzk optimize, BNE

ofs_E31C_03:
C - - J - - 0x00232C 00:E31C: A9 F9     LDA #$F9
loc_E31E:
C D 3 - - - 0x00232E 00:E31E: A2 78     LDX #$78
C - - - - - 0x002330 00:E320: A0 D8     LDY #$D8
loc_E322:
C D 3 - - - 0x002332 00:E322: 85 53     STA ram_0053
C - - - - - 0x002334 00:E324: 20 7B DA  JSR sub_DA7B
...
C - - - - - 0x002339 00:E329: 65 69     ADC ram_0069
...
C - - - - - 0x002340 00:E330: 85 69     STA ram_0069
...
C - - - - - 0x002348 00:E338: 85 69     STA ram_0069
...
sub_E33E:
C - - - - - 0x00234E 00:E33E: A2 70     LDX #$70
C - - - - - 0x002350 00:E340: A0 D0     LDY #$D0
C - - - - - 0x002352 00:E342: A9 D1     LDA #$D1
C - - - - - 0x002354 00:E344: 20 28 E3  JSR sub_E328
C - - - - - 0x002357 00:E347: A2 80     LDX #$80
C - - - - - 0x002359 00:E349: A0 D0     LDY #$D0
C - - - - - 0x00235B 00:E34B: A9 D5     LDA #$D5
C - - - - - 0x00235D 00:E34D: 20 28 E3  JSR sub_E328
C - - - - - 0x002360 00:E350: A2 70     LDX #$70
C - - - - - 0x002362 00:E352: A0 E0     LDY #$E0
C - - - - - 0x002364 00:E354: A9 D9     LDA #$D9
C - - - - - 0x002366 00:E356: 20 28 E3  JSR sub_E328
C - - - - - 0x002369 00:E359: A2 80     LDX #$80
C - - - - - 0x00236B 00:E35B: A0 E0     LDY #$E0
C - - - - - 0x00236D 00:E35D: A9 DD     LDA #$DD
...
C - - - - - 0x002379 00:E369: B0 11     BCS bra_E37C
...
C - - - - - 0x002387 00:E377: 95 6F     STA ram_stun_timer,X
...
loc_E3A9:
C D 3 - - - 0x0023B9 00:E3A9: A9 F0     LDA #$F0
C - - - - - 0x0023BB 00:E3AB: 95 A0     STA ram_tank_status,X
...
C - - - - - 0x0023C4 00:E3B4: 20 0B D8  JSR sub_D80B
...
C - - - - - 0x0023CB 00:E3BB: 95 A0     STA ram_tank_status,X
C - - - - - 0x0023CD 00:E3BD: E0 02     CPX #$02
C - - - - - 0x0023CF 00:E3BF: B0 0A     BCS bra_E3CB
...
sub_E420:
C - - - - - 0x002430 00:E420: 85 00     STA ram_0000
C - - - - - 0x002432 00:E422: B5 A0     LDA ram_tank_status,X
C - - - - - 0x002434 00:E424: 29 0F     AND #$0F
C - - - - - 0x002436 00:E426: 05 00     ORA ram_0000
C - - - - - 0x002438 00:E428: 95 A0     STA ram_tank_status,X
...
C - - - - - 0x00243D 00:E42D: F0 05     BEQ bra_E434_it_is_1st_loop
C - - - - - 0x00243F 00:E42F: A9 23     LDA #$23
C - - - - - 0x002441 00:E431: 4C 36 E4  JMP loc_E436    ; bzk optimize, BNE
bra_E434_it_is_1st_loop:
...
C - - - - - 0x002451 00:E441: B9 79 E5  LDA tbl_E578_stage_enemies_type_counter + 1,Y
C - - - - - 0x002454 00:E444: 85 8C     STA ram_enemy_type_stage_cnt + 1
C - - - - - 0x002456 00:E446: B9 7A E5  LDA tbl_E578_stage_enemies_type_counter + 2,Y
C - - - - - 0x002459 00:E449: 85 8D     STA ram_enemy_type_stage_cnt + 2
C - - - - - 0x00245B 00:E44B: B9 7B E5  LDA tbl_E578_stage_enemies_type_counter + 3,Y
C - - - - - 0x00245E 00:E44E: 85 8E     STA ram_enemy_type_stage_cnt + 3
C - - - - - 0x002460 00:E450: 60        RTS



sub_E451_check_dpad_buttons:
...
- D 3 - - - 0x00248A 00:E47A: 58        .byte $58   ; 00 1p
- D 3 - - - 0x00248B 00:E47B: 98        .byte $98   ; 01 2p

tbl_E47C_player_spawn_pos_Y:
- D 3 - - - 0x00248C 00:E47C: D8        .byte $D8   ; 00 1p
- D 3 - - - 0x00248D 00:E47D: D8        .byte $D8   ; 01 2p



tbl_E47E:
- D 3 - - - 0x00248E 00:E47E: A0        .byte $A0   ; 00
- D 3 - - - 0x00248F 00:E47F: A0        .byte $A0   ; 01
- D 3 - - - 0x002490 00:E480: A2        .byte $A2   ; 02
- D 3 - - - 0x002491 00:E481: A2        .byte $A2   ; 03
- D 3 - - - 0x002492 00:E482: A2        .byte $A2   ; 04
- D 3 - - - 0x002493 00:E483: A2        .byte $A2   ; 05
- D 3 - - - 0x002494 00:E484: A2        .byte $A2   ; 06
- D 3 - - - 0x002495 00:E485: A2        .byte $A2   ; 07



tbl_E486:
- D 3 - - - 0x002496 00:E486: A0        .byte $A0   ; 00
- D 3 - - - 0x002497 00:E487: A0        .byte $A0   ; 01
- D 3 - - - 0x002498 00:E488: A0        .byte $A0   ; 02
- D 3 - - - 0x002499 00:E489: A1        .byte $A1   ; 03
- D 3 - - - 0x00249A 00:E48A: A0        .byte $A0   ; 04
- D 3 - - - 0x00249B 00:E48B: A3        .byte $A3   ; 05
- D 3 - - - 0x00249C 00:E48C: A2        .byte $A2   ; 06
- D 3 - - - 0x00249D 00:E48D: A2        .byte $A2   ; 07
- D 3 - - - 0x00249E 00:E48E: A2        .byte $A2   ; 08

- D 3 - - - 0x00249F 00:E48F: A1        .byte $A1   ; 00 (09)
- D 3 - - - 0x0024A0 00:E490: A0        .byte $A0   ; 01 (0A)
- D 3 - - - 0x0024A1 00:E491: A3        .byte $A3   ; 02 (0B)
- D 3 - - - 0x0024A2 00:E492: A1        .byte $A1   ; 03 (0C)
- D 3 - - - 0x0024A3 00:E493: A0        .byte $A0   ; 04 (0D)
- D 3 - - - 0x0024A4 00:E494: A3        .byte $A3   ; 05 (0E)
- D 3 - - - 0x0024A5 00:E495: A1        .byte $A1   ; 06 (0F)
- D 3 - - - 0x0024A6 00:E496: A2        .byte $A2   ; 07 (10)
- D 3 - - - 0x0024A7 00:E497: A3        .byte $A3   ; 08 (11)



tbl_E498_tank_status_handler:
- D 3 - - - 0x0024A8 00:E498: F0 DB     .word ofs_DBF0_00_RTS
- D 3 - - - 0x0024AA 00:E49A: EA DD     .word ofs_DDEA_01
- D 3 - - - 0x0024AC 00:E49C: EA DD     .word ofs_DDEA_02
- D 3 - - - 0x0024AE 00:E49E: EA DD     .word ofs_DDEA_03
- D 3 - - - 0x0024B0 00:E4A0: EA DD     .word ofs_DDEA_04
- D 3 - - - 0x0024B2 00:E4A2: EA DD     .word ofs_DDEA_05
- D 3 - - - 0x0024B4 00:E4A4: EA DD     .word ofs_DDEA_06
- D 3 - - - 0x0024B6 00:E4A6: EA DD     .word ofs_DDEA_07
- D 3 - - - 0x0024B8 00:E4A8: 52 DC     .word ofs_DC52_08
- D 3 - - - 0x0024BA 00:E4AA: 48 DD     .word ofs_DD48_09
- D 3 - - - 0x0024BC 00:E4AC: 7C DC     .word ofs_DC7C_0A
- D 3 - - - 0x0024BE 00:E4AE: 94 DD     .word ofs_DD94_0B
- D 3 - - - 0x0024C0 00:E4B0: 89 DD     .word ofs_DD89_0C
- D 3 - - - 0x0024C2 00:E4B2: 7E DD     .word ofs_DD7E_0D
- D 3 - - - 0x0024C4 00:E4B4: 64 DE     .word ofs_DE64_0E
- D 3 - - - 0x0024C6 00:E4B6: 55 DE     .word ofs_DE55_0F



tbl_E4B8_tank_status_handler:
- D 3 - - - 0x0024C8 00:E4B8: F0 DB     .word ofs_DBF0_00_RTS
- D 3 - - - 0x0024CA 00:E4BA: FD DE     .word ofs_DEFD_01
- D 3 - - - 0x0024CC 00:E4BC: 33 DF     .word ofs_DF33_02
- D 3 - - - 0x0024CE 00:E4BE: 46 DF     .word ofs_DF46_03
- D 3 - - - 0x0024D0 00:E4C0: 46 DF     .word ofs_DF46_04
- D 3 - - - 0x0024D2 00:E4C2: CD DE     .word ofs_DECD_05
- D 3 - - - 0x0024D4 00:E4C4: CD DE     .word ofs_DECD_06
- D 3 - - - 0x0024D6 00:E4C6: CD DE     .word ofs_DECD_07
- D 3 - - - 0x0024D8 00:E4C8: B6 DF     .word ofs_DFB6_08
- D 3 - - - 0x0024DA 00:E4CA: B6 DF     .word ofs_DFB6_09
- D 3 - - - 0x0024DC 00:E4CC: B6 DF     .word ofs_DFB6_0A
- D 3 - - - 0x0024DE 00:E4CE: B6 DF     .word ofs_DFB6_0B
- D 3 - - - 0x0024E0 00:E4D0: B6 DF     .word ofs_DFB6_0C
- D 3 - - - 0x0024E2 00:E4D2: B6 DF     .word ofs_DFB6_0D
- D 3 - - - 0x0024E4 00:E4D4: 0B E0     .word ofs_E00B_0E
- D 3 - - - 0x0024E6 00:E4D6: 0B E0     .word ofs_E00B_0F



tbl_E4D8:
- D 3 - - - 0x0024E8 00:E4D8: F0 DB     .word ofs_DBF0_00_RTS
- D 3 - - - 0x0024EA 00:E4DA: 76 E0     .word ofs_E076_01
- D 3 - - - 0x0024EC 00:E4DC: 76 E0     .word ofs_E076_02
- D 3 - - - 0x0024EE 00:E4DE: 76 E0     .word ofs_E076_03
- D 3 - - - 0x0024F0 00:E4E0: 51 E0     .word ofs_E051_04



tbl_E4E2:
- D 3 - - - 0x0024F2 00:E4E2: F0 DB     .word ofs_DBF0_00_RTS
- D 3 - - - 0x0024F4 00:E4E4: 12 E1     .word ofs_E112_01
- D 3 - - - 0x0024F6 00:E4E6: 12 E1     .word ofs_E112_02
- D 3 - - - 0x0024F8 00:E4E8: 12 E1     .word ofs_E112_03
- D 3 - - - 0x0024FA 00:E4EA: FB E0     .word ofs_E0FB_04



tbl_E4EC_stage_enemies:
; stage 01
- D 3 - - - 0x0024FC 00:E4EC: 80        .byte $80   ; 
- D 3 - - - 0x0024FD 00:E4ED: A0        .byte $A0   ; 
- - - - - - 0x0024FE 00:E4EE: C0        .byte $C0   ; 
- - - - - - 0x0024FF 00:E4EF: E0        .byte $E0   ; 
; stage 02
- D 3 - - - 0x002500 00:E4F0: E0        .byte $E0   ; 
- D 3 - - - 0x002501 00:E4F1: A0        .byte $A0   ; 
- - - - - - 0x002502 00:E4F2: C0        .byte $C0   ; 
- D 3 - - - 0x002503 00:E4F3: 80        .byte $80   ; 
; stage 03
- D 3 - - - 0x002504 00:E4F4: 80        .byte $80   ; 
- D 3 - - - 0x002505 00:E4F5: A0        .byte $A0   ; 
- - - - - - 0x002506 00:E4F6: C0        .byte $C0   ; 
- D 3 - - - 0x002507 00:E4F7: E0        .byte $E0   ; 
; stage 04
- D 3 - - - 0x002508 00:E4F8: C0        .byte $C0   ; 
- D 3 - - - 0x002509 00:E4F9: A0        .byte $A0   ; 
- D 3 - - - 0x00250A 00:E4FA: 80        .byte $80   ; 
- D 3 - - - 0x00250B 00:E4FB: E0        .byte $E0   ; 
; stage 05
- D 3 - - - 0x00250C 00:E4FC: C0        .byte $C0   ; 
- D 3 - - - 0x00250D 00:E4FD: E0        .byte $E0   ; 
- D 3 - - - 0x00250E 00:E4FE: 80        .byte $80   ; 
- D 3 - - - 0x00250F 00:E4FF: A0        .byte $A0   ; 
; stage 06
- D 3 - - - 0x002510 00:E500: C0        .byte $C0   ; 
- D 3 - - - 0x002511 00:E501: A0        .byte $A0   ; 
- D 3 - - - 0x002512 00:E502: 80        .byte $80   ; 
- D 3 - - - 0x002513 00:E503: E0        .byte $E0   ; 
; stage 07
- D 3 - - - 0x002514 00:E504: 80        .byte $80   ; 
- D 3 - - - 0x002515 00:E505: A0        .byte $A0   ; 
- D 3 - - - 0x002516 00:E506: C0        .byte $C0   ; 
- D 3 - - - 0x002517 00:E507: 80        .byte $80   ; 
; stage 08
- D 3 - - - 0x002518 00:E508: C0        .byte $C0   ; 
- D 3 - - - 0x002519 00:E509: E0        .byte $E0   ; 
- D 3 - - - 0x00251A 00:E50A: A0        .byte $A0   ; 
- D 3 - - - 0x00251B 00:E50B: 80        .byte $80   ; 
; stage 09
- D 3 - - - 0x00251C 00:E50C: 80        .byte $80   ; 
- D 3 - - - 0x00251D 00:E50D: A0        .byte $A0   ; 
- D 3 - - - 0x00251E 00:E50E: C0        .byte $C0   ; 
- D 3 - - - 0x00251F 00:E50F: E0        .byte $E0   ; 
; stage 10
- D 3 - - - 0x002520 00:E510: 80        .byte $80   ; 
- D 3 - - - 0x002521 00:E511: A0        .byte $A0   ; 
- D 3 - - - 0x002522 00:E512: C0        .byte $C0   ; 
- D 3 - - - 0x002523 00:E513: E0        .byte $E0   ; 
; stage 11
- D 3 - - - 0x002524 00:E514: A0        .byte $A0   ; 
- D 3 - - - 0x002525 00:E515: E0        .byte $E0   ; 
- D 3 - - - 0x002526 00:E516: C0        .byte $C0   ; 
- D 3 - - - 0x002527 00:E517: A0        .byte $A0   ; 
; stage 12
- D 3 - - - 0x002528 00:E518: C0        .byte $C0   ; 
- D 3 - - - 0x002529 00:E519: A0        .byte $A0   ; 
- - - - - - 0x00252A 00:E51A: 80        .byte $80   ; 
- D 3 - - - 0x00252B 00:E51B: E0        .byte $E0   ; 
; stage 13
- D 3 - - - 0x00252C 00:E51C: C0        .byte $C0   ; 
- D 3 - - - 0x00252D 00:E51D: A0        .byte $A0   ; 
- - - - - - 0x00252E 00:E51E: 80        .byte $80   ; 
- D 3 - - - 0x00252F 00:E51F: E0        .byte $E0   ; 
; stage 14
- D 3 - - - 0x002530 00:E520: C0        .byte $C0   ; 
- D 3 - - - 0x002531 00:E521: A0        .byte $A0   ; 
- - - - - - 0x002532 00:E522: 80        .byte $80   ; 
- D 3 - - - 0x002533 00:E523: E0        .byte $E0   ; 
; stage 15
- D 3 - - - 0x002534 00:E524: 80        .byte $80   ; 
- - - - - - 0x002535 00:E525: C0        .byte $C0   ; 
- D 3 - - - 0x002536 00:E526: A0        .byte $A0   ; 
- D 3 - - - 0x002537 00:E527: E0        .byte $E0   ; 
; stage 16
- D 3 - - - 0x002538 00:E528: 80        .byte $80   ; 
- - - - - - 0x002539 00:E529: C0        .byte $C0   ; 
- D 3 - - - 0x00253A 00:E52A: A0        .byte $A0   ; 
- D 3 - - - 0x00253B 00:E52B: E0        .byte $E0   ; 
; stage 17
- D 3 - - - 0x00253C 00:E52C: E0        .byte $E0   ; 
- D 3 - - - 0x00253D 00:E52D: A0        .byte $A0   ; 
- D 3 - - - 0x00253E 00:E52E: C0        .byte $C0   ; 
- D 3 - - - 0x00253F 00:E52F: 80        .byte $80   ; 
; stage 18
- D 3 - - - 0x002540 00:E530: E0        .byte $E0   ; 
- D 3 - - - 0x002541 00:E531: 80        .byte $80   ; 
- D 3 - - - 0x002542 00:E532: C0        .byte $C0   ; 
- D 3 - - - 0x002543 00:E533: A0        .byte $A0   ; 
; stage 19
- D 3 - - - 0x002544 00:E534: A0        .byte $A0   ; 
- D 3 - - - 0x002545 00:E535: E0        .byte $E0   ; 
- D 3 - - - 0x002546 00:E536: 80        .byte $80   ; 
- D 3 - - - 0x002547 00:E537: C0        .byte $C0   ; 
; stage 20
- D 3 - - - 0x002548 00:E538: A0        .byte $A0   ; 
- D 3 - - - 0x002549 00:E539: 80        .byte $80   ; 
- D 3 - - - 0x00254A 00:E53A: C0        .byte $C0   ; 
- D 3 - - - 0x00254B 00:E53B: E0        .byte $E0   ; 
; stage 21
- D 3 - - - 0x00254C 00:E53C: C0        .byte $C0   ; 
- D 3 - - - 0x00254D 00:E53D: A0        .byte $A0   ; 
- D 3 - - - 0x00254E 00:E53E: 80        .byte $80   ; 
- D 3 - - - 0x00254F 00:E53F: E0        .byte $E0   ; 
; stage 22
- D 3 - - - 0x002550 00:E540: A0        .byte $A0   ; 
- D 3 - - - 0x002551 00:E541: 80        .byte $80   ; 
- D 3 - - - 0x002552 00:E542: C0        .byte $C0   ; 
- D 3 - - - 0x002553 00:E543: E0        .byte $E0   ; 
; stage 23
- D 3 - - - 0x002554 00:E544: E0        .byte $E0   ; 
- - - - - - 0x002555 00:E545: 80        .byte $80   ; 
- D 3 - - - 0x002556 00:E546: C0        .byte $C0   ; 
- D 3 - - - 0x002557 00:E547: A0        .byte $A0   ; 
; stage 24
- D 3 - - - 0x002558 00:E548: C0        .byte $C0   ; 
- D 3 - - - 0x002559 00:E549: E0        .byte $E0   ; 
- D 3 - - - 0x00255A 00:E54A: A0        .byte $A0   ; 
- D 3 - - - 0x00255B 00:E54B: 80        .byte $80   ; 
; stage 25
- D 3 - - - 0x00255C 00:E54C: C0        .byte $C0   ; 
- D 3 - - - 0x00255D 00:E54D: A0        .byte $A0   ; 
- - - - - - 0x00255E 00:E54E: 80        .byte $80   ; 
- D 3 - - - 0x00255F 00:E54F: E0        .byte $E0   ; 
; stage 26
- D 3 - - - 0x002560 00:E550: A0        .byte $A0   ; 
- D 3 - - - 0x002561 00:E551: E0        .byte $E0   ; 
- D 3 - - - 0x002562 00:E552: 80        .byte $80   ; 
- D 3 - - - 0x002563 00:E553: C0        .byte $C0   ; 
; stage 27
- D 3 - - - 0x002564 00:E554: C0        .byte $C0   ; 
- D 3 - - - 0x002565 00:E555: E0        .byte $E0   ; 
- D 3 - - - 0x002566 00:E556: A0        .byte $A0   ; 
- D 3 - - - 0x002567 00:E557: 80        .byte $80   ; 
; stage 28
- D 3 - - - 0x002568 00:E558: A0        .byte $A0   ; 
- D 3 - - - 0x002569 00:E559: E0        .byte $E0   ; 
- D 3 - - - 0x00256A 00:E55A: 80        .byte $80   ; 
- D 3 - - - 0x00256B 00:E55B: C0        .byte $C0   ; 
; stage 29
- D 3 - - - 0x00256C 00:E55C: C0        .byte $C0   ; 
- D 3 - - - 0x00256D 00:E55D: A0        .byte $A0   ; 
- - - - - - 0x00256E 00:E55E: 80        .byte $80   ; 
- D 3 - - - 0x00256F 00:E55F: E0        .byte $E0   ; 
; stage 30
- D 3 - - - 0x002570 00:E560: 80        .byte $80   ; 
- D 3 - - - 0x002571 00:E561: A0        .byte $A0   ; 
- D 3 - - - 0x002572 00:E562: C0        .byte $C0   ; 
- D 3 - - - 0x002573 00:E563: E0        .byte $E0   ; 
; stage 31
- D 3 - - - 0x002574 00:E564: C0        .byte $C0   ; 
- D 3 - - - 0x002575 00:E565: A0        .byte $A0   ; 
- D 3 - - - 0x002576 00:E566: E0        .byte $E0   ; 
- D 3 - - - 0x002577 00:E567: C0        .byte $C0   ; 
; stage 32
- D 3 - - - 0x002578 00:E568: E0        .byte $E0   ; 
- D 3 - - - 0x002579 00:E569: 80        .byte $80   ; 
- D 3 - - - 0x00257A 00:E56A: C0        .byte $C0   ; 
- D 3 - - - 0x00257B 00:E56B: A0        .byte $A0   ; 
; stage 33
- D 3 - - - 0x00257C 00:E56C: A0        .byte $A0   ; 
- D 3 - - - 0x00257D 00:E56D: E0        .byte $E0   ; 
- D 3 - - - 0x00257E 00:E56E: C0        .byte $C0   ; 
- D 3 - - - 0x00257F 00:E56F: A0        .byte $A0   ; 
; stage 34
- D 3 - - - 0x002580 00:E570: C0        .byte $C0   ; 
- D 3 - - - 0x002581 00:E571: A0        .byte $A0   ; 
- - - - - - 0x002582 00:E572: 80        .byte $80   ; 
- D 3 - - - 0x002583 00:E573: E0        .byte $E0   ; 
; stage 35
- D 3 - - - 0x002584 00:E574: C0        .byte $C0   ; 
- D 3 - - - 0x002585 00:E575: A0        .byte $A0   ; 
- - - - - - 0x002586 00:E576: 80        .byte $80   ; 
- D 3 - - - 0x002587 00:E577: E0        .byte $E0   ; 



tbl_E578_stage_enemies_type_counter:
; stage 01
- D 3 - - - 0x002588 00:E578: 12        .byte $12   ; 
- D 3 - - - 0x002589 00:E579: 02        .byte $02   ; 
- D 3 - - - 0x00258A 00:E57A: 00        .byte $00   ; 
- D 3 - - - 0x00258B 00:E57B: 00        .byte $00   ; 
; stage 02
- D 3 - - - 0x00258C 00:E57C: 02        .byte $02   ; 
- D 3 - - - 0x00258D 00:E57D: 04        .byte $04   ; 
- D 3 - - - 0x00258E 00:E57E: 00        .byte $00   ; 
- D 3 - - - 0x00258F 00:E57F: 0E        .byte $0E   ; 
; stage 03
- D 3 - - - 0x002590 00:E580: 0E        .byte $0E   ; 
- D 3 - - - 0x002591 00:E581: 04        .byte $04   ; 
- D 3 - - - 0x002592 00:E582: 00        .byte $00   ; 
- D 3 - - - 0x002593 00:E583: 02        .byte $02   ; 
; stage 04
- D 3 - - - 0x002594 00:E584: 0A        .byte $0A   ; 
- D 3 - - - 0x002595 00:E585: 05        .byte $05   ; 
- D 3 - - - 0x002596 00:E586: 02        .byte $02   ; 
- D 3 - - - 0x002597 00:E587: 03        .byte $03   ; 
; stage 05
- D 3 - - - 0x002598 00:E588: 05        .byte $05   ; 
- D 3 - - - 0x002599 00:E589: 02        .byte $02   ; 
- D 3 - - - 0x00259A 00:E58A: 08        .byte $08   ; 
- D 3 - - - 0x00259B 00:E58B: 05        .byte $05   ; 
; stage 06
- D 3 - - - 0x00259C 00:E58C: 07        .byte $07   ; 
- D 3 - - - 0x00259D 00:E58D: 02        .byte $02   ; 
- D 3 - - - 0x00259E 00:E58E: 09        .byte $09   ; 
- D 3 - - - 0x00259F 00:E58F: 02        .byte $02   ; 
; stage 07
- D 3 - - - 0x0025A0 00:E590: 03        .byte $03   ; 
- D 3 - - - 0x0025A1 00:E591: 04        .byte $04   ; 
- D 3 - - - 0x0025A2 00:E592: 06        .byte $06   ; 
- D 3 - - - 0x0025A3 00:E593: 07        .byte $07   ; 
; stage 08
- D 3 - - - 0x0025A4 00:E594: 07        .byte $07   ; 
- D 3 - - - 0x0025A5 00:E595: 02        .byte $02   ; 
- D 3 - - - 0x0025A6 00:E596: 04        .byte $04   ; 
- D 3 - - - 0x0025A7 00:E597: 07        .byte $07   ; 
; stage 09
- D 3 - - - 0x0025A8 00:E598: 06        .byte $06   ; 
- D 3 - - - 0x0025A9 00:E599: 04        .byte $04   ; 
- D 3 - - - 0x0025AA 00:E59A: 07        .byte $07   ; 
- D 3 - - - 0x0025AB 00:E59B: 03        .byte $03   ; 
; stage 10
- D 3 - - - 0x0025AC 00:E59C: 0C        .byte $0C   ; 
- D 3 - - - 0x0025AD 00:E59D: 02        .byte $02   ; 
- D 3 - - - 0x0025AE 00:E59E: 04        .byte $04   ; 
- D 3 - - - 0x0025AF 00:E59F: 02        .byte $02   ; 
; stage 11
- D 3 - - - 0x0025B0 00:E5A0: 05        .byte $05   ; 
- D 3 - - - 0x0025B1 00:E5A1: 06        .byte $06   ; 
- D 3 - - - 0x0025B2 00:E5A2: 04        .byte $04   ; 
- D 3 - - - 0x0025B3 00:E5A3: 05        .byte $05   ; 
; stage 12
- D 3 - - - 0x0025B4 00:E5A4: 08        .byte $08   ; 
- D 3 - - - 0x0025B5 00:E5A5: 06        .byte $06   ; 
- D 3 - - - 0x0025B6 00:E5A6: 00        .byte $00   ; 
- D 3 - - - 0x0025B7 00:E5A7: 06        .byte $06   ; 
; stage 13
- D 3 - - - 0x0025B8 00:E5A8: 08        .byte $08   ; 
- D 3 - - - 0x0025B9 00:E5A9: 08        .byte $08   ; 
- D 3 - - - 0x0025BA 00:E5AA: 00        .byte $00   ; 
- D 3 - - - 0x0025BB 00:E5AB: 04        .byte $04   ; 
; stage 14
- D 3 - - - 0x0025BC 00:E5AC: 0A        .byte $0A   ; 
- D 3 - - - 0x0025BD 00:E5AD: 04        .byte $04   ; 
- D 3 - - - 0x0025BE 00:E5AE: 00        .byte $00   ; 
- D 3 - - - 0x0025BF 00:E5AF: 06        .byte $06   ; 
; stage 15
- D 3 - - - 0x0025C0 00:E5B0: 02        .byte $02   ; 
- D 3 - - - 0x0025C1 00:E5B1: 00        .byte $00   ; 
- D 3 - - - 0x0025C2 00:E5B2: 0A        .byte $0A   ; 
- D 3 - - - 0x0025C3 00:E5B3: 08        .byte $08   ; 
; stage 16
- D 3 - - - 0x0025C4 00:E5B4: 10        .byte $10   ; 
- D 3 - - - 0x0025C5 00:E5B5: 00        .byte $00   ; 
- D 3 - - - 0x0025C6 00:E5B6: 02        .byte $02   ; 
- D 3 - - - 0x0025C7 00:E5B7: 02        .byte $02   ; 
; stage 17
- D 3 - - - 0x0025C8 00:E5B8: 02        .byte $02   ; 
- D 3 - - - 0x0025C9 00:E5B9: 02        .byte $02   ; 
- D 3 - - - 0x0025CA 00:E5BA: 08        .byte $08   ; 
- D 3 - - - 0x0025CB 00:E5BB: 08        .byte $08   ; 
; stage 18
- D 3 - - - 0x0025CC 00:E5BC: 04        .byte $04   ; 
- D 3 - - - 0x0025CD 00:E5BD: 02        .byte $02   ; 
- D 3 - - - 0x0025CE 00:E5BE: 06        .byte $06   ; 
- D 3 - - - 0x0025CF 00:E5BF: 08        .byte $08   ; 
; stage 19
- D 3 - - - 0x0025D0 00:E5C0: 04        .byte $04   ; 
- D 3 - - - 0x0025D1 00:E5C1: 08        .byte $08   ; 
- D 3 - - - 0x0025D2 00:E5C2: 04        .byte $04   ; 
- D 3 - - - 0x0025D3 00:E5C3: 04        .byte $04   ; 
; stage 20
- D 3 - - - 0x0025D4 00:E5C4: 08        .byte $08   ; 
- D 3 - - - 0x0025D5 00:E5C5: 02        .byte $02   ; 
- D 3 - - - 0x0025D6 00:E5C6: 02        .byte $02   ; 
- D 3 - - - 0x0025D7 00:E5C7: 08        .byte $08   ; 
; stage 21
- D 3 - - - 0x0025D8 00:E5C8: 08        .byte $08   ; 
- D 3 - - - 0x0025D9 00:E5C9: 02        .byte $02   ; 
- D 3 - - - 0x0025DA 00:E5CA: 06        .byte $06   ; 
- D 3 - - - 0x0025DB 00:E5CB: 04        .byte $04   ; 
; stage 22
- D 3 - - - 0x0025DC 00:E5CC: 08        .byte $08   ; 
- D 3 - - - 0x0025DD 00:E5CD: 06        .byte $06   ; 
- D 3 - - - 0x0025DE 00:E5CE: 02        .byte $02   ; 
- D 3 - - - 0x0025DF 00:E5CF: 04        .byte $04   ; 
; stage 23
- D 3 - - - 0x0025E0 00:E5D0: 06        .byte $06   ; 
- D 3 - - - 0x0025E1 00:E5D1: 00        .byte $00   ; 
- D 3 - - - 0x0025E2 00:E5D2: 04        .byte $04   ; 
- D 3 - - - 0x0025E3 00:E5D3: 0A        .byte $0A   ; 
; stage 24
- D 3 - - - 0x0025E4 00:E5D4: 04        .byte $04   ; 
- D 3 - - - 0x0025E5 00:E5D5: 02        .byte $02   ; 
- D 3 - - - 0x0025E6 00:E5D6: 04        .byte $04   ; 
- D 3 - - - 0x0025E7 00:E5D7: 0A        .byte $0A   ; 
; stage 25
- D 3 - - - 0x0025E8 00:E5D8: 02        .byte $02   ; 
- D 3 - - - 0x0025E9 00:E5D9: 08        .byte $08   ; 
- D 3 - - - 0x0025EA 00:E5DA: 00        .byte $00   ; 
- D 3 - - - 0x0025EB 00:E5DB: 0A        .byte $0A   ; 
; stage 26
- D 3 - - - 0x0025EC 00:E5DC: 06        .byte $06   ; 
- D 3 - - - 0x0025ED 00:E5DD: 06        .byte $06   ; 
- D 3 - - - 0x0025EE 00:E5DE: 04        .byte $04   ; 
- D 3 - - - 0x0025EF 00:E5DF: 04        .byte $04   ; 
; stage 27
- D 3 - - - 0x0025F0 00:E5E0: 02        .byte $02   ; 
- D 3 - - - 0x0025F1 00:E5E1: 08        .byte $08   ; 
- D 3 - - - 0x0025F2 00:E5E2: 08        .byte $08   ; 
- D 3 - - - 0x0025F3 00:E5E3: 02        .byte $02   ; 
; stage 28
- D 3 - - - 0x0025F4 00:E5E4: 02        .byte $02   ; 
- D 3 - - - 0x0025F5 00:E5E5: 01        .byte $01   ; 
- D 3 - - - 0x0025F6 00:E5E6: 0F        .byte $0F   ; 
- D 3 - - - 0x0025F7 00:E5E7: 02        .byte $02   ; 
; stage 29
- D 3 - - - 0x0025F8 00:E5E8: 0A        .byte $0A   ; 
- D 3 - - - 0x0025F9 00:E5E9: 04        .byte $04   ; 
- D 3 - - - 0x0025FA 00:E5EA: 00        .byte $00   ; 
- D 3 - - - 0x0025FB 00:E5EB: 06        .byte $06   ; 
; stage 30
- D 3 - - - 0x0025FC 00:E5EC: 04        .byte $04   ; 
- D 3 - - - 0x0025FD 00:E5ED: 08        .byte $08   ; 
- D 3 - - - 0x0025FE 00:E5EE: 04        .byte $04   ; 
- D 3 - - - 0x0025FF 00:E5EF: 04        .byte $04   ; 
; stage 31
- D 3 - - - 0x002600 00:E5F0: 03        .byte $03   ; 
- D 3 - - - 0x002601 00:E5F1: 08        .byte $08   ; 
- D 3 - - - 0x002602 00:E5F2: 06        .byte $06   ; 
- D 3 - - - 0x002603 00:E5F3: 03        .byte $03   ; 
; stage 32
- D 3 - - - 0x002604 00:E5F4: 08        .byte $08   ; 
- D 3 - - - 0x002605 00:E5F5: 06        .byte $06   ; 
- D 3 - - - 0x002606 00:E5F6: 02        .byte $02   ; 
- D 3 - - - 0x002607 00:E5F7: 04        .byte $04   ; 
; stage 33
- D 3 - - - 0x002608 00:E5F8: 04        .byte $04   ; 
- D 3 - - - 0x002609 00:E5F9: 08        .byte $08   ; 
- D 3 - - - 0x00260A 00:E5FA: 04        .byte $04   ; 
- D 3 - - - 0x00260B 00:E5FB: 04        .byte $04   ; 
; stage 34
- D 3 - - - 0x00260C 00:E5FC: 04        .byte $04   ; 
- D 3 - - - 0x00260D 00:E5FD: 0A        .byte $0A   ; 
- D 3 - - - 0x00260E 00:E5FE: 00        .byte $00   ; 
- D 3 - - - 0x00260F 00:E5FF: 06        .byte $06   ; 
; stage 35
- D 3 - - - 0x002610 00:E600: 04        .byte $04   ; 
- D 3 - - - 0x002611 00:E601: 06        .byte $06   ; 
- D 3 - - - 0x002612 00:E602: 00        .byte $00   ; 
- D 3 - - - 0x002613 00:E603: 0A        .byte $0A   ; 
...
C - - - - - 0x002627 00:E617: 45 0B     EOR ram_frame_cnt_lo
...
bra_E62C:
C - - - - - 0x00263C 00:E62C: 85 54     STA ram_0054
C - - - - - 0x00263E 00:E62E: 0A        ASL
C - - - - - 0x00263F 00:E62F: 0A        ASL
C - - - - - 0x002640 00:E630: 85 64     STA ram_0064
...
bra_E63C:
C - - - - - 0x00264C 00:E63C: 85 55     STA ram_0055
C - - - - - 0x00264E 00:E63E: 0A        ASL
C - - - - - 0x00264F 00:E63F: 0A        ASL
C - - - - - 0x002650 00:E640: 85 65     STA ram_0065
...
C - - - - - 0x002663 00:E653: 85 48     STA ram_0048
C - - - - - 0x002665 00:E655: B5 B8     LDA ram_bullet_pos_X,X
C - - - - - 0x002667 00:E657: 18        CLC
C - - - - - 0x002668 00:E658: 65 65     ADC ram_0065
...
C - - - - - 0x00267A 00:E66A: E5 55     SBC ram_0055
...
C - - - - - 0x00268A 00:E67A: E5 54     SBC ram_0054
C - - - - - 0x00268C 00:E67C: 85 48     STA ram_0048
C - - - - - 0x00268E 00:E67E: B5 B8     LDA ram_bullet_pos_X,X
C - - - - - 0x002690 00:E680: 38        SEC
C - - - - - 0x002691 00:E681: E5 65     SBC ram_0065
C - - - - - 0x002693 00:E683: 38        SEC
C - - - - - 0x002694 00:E684: E5 55     SBC ram_0055
...
sub_E693:
C - - - - - 0x0026A3 00:E693: 86 47     STX ram_0047
C - - - - - 0x0026A5 00:E695: 84 48     STY ram_0048
C - - - - - 0x0026A7 00:E697: 20 06 D7  JSR sub_D706
sub_E69A:
C - - - - - 0x0026AA 00:E69A: 20 25 D7  JSR sub_D725
C - - - - - 0x0026AD 00:E69D: 20 3C D7  JSR sub_D73C
C - - - - - 0x0026B0 00:E6A0: F0 67     BEQ bra_E709
C - - - - - 0x0026B2 00:E6A2: B1 11     LDA (ram_0011),Y
...
C - - - - - 0x0026F0 00:E6E0: 20 84 D7  JSR sub_D784
...
C - - - - - 0x002712 00:E702: B0 05     BCS bra_E709
...
C - - - - - 0x002765 00:E755: F0 08     BEQ bra_E75F
C - - - - - 0x002767 00:E757: A9 00     LDA #$00
C - - - - - 0x002769 00:E759: 99 CC 00  STA ram_bullet_status,Y
C - - - - - 0x00276C 00:E75C: 4C 72 E7  JMP loc_E772    ; bzk optimize, BEQ
bra_E75F:
C - - - - - 0x00276F 00:E75F: A9 73     LDA #$73
C - - - - - 0x002771 00:E761: 95 A0     STA ram_tank_status,X
...
C - - - - - 0x0027A1 00:E791: 85 5B     STA ram_005B
loc_E793_loop:
C D 3 - - - 0x0027A3 00:E793: A5 5B     LDA ram_005B
C - - - - - 0x0027A5 00:E795: 29 06     AND #$06
C - - - - - 0x0027A7 00:E797: F0 03     BEQ bra_E79C
C - - - - - 0x0027A9 00:E799: 4C 2D E8  JMP loc_E82D
bra_E79C:
C - - - - - 0x0027AC 00:E79C: A4 5B     LDY ram_005B
...
C - - - - - 0x0027E7 00:E7D7: 20 BE E8  JSR sub_E8BE
...
bra_E7F2:
C - - - - - 0x002802 00:E7F2: A9 73     LDA #$73
C - - - - - 0x002804 00:E7F4: 95 A0     STA ram_tank_status,X
...
C - - - - - 0x002816 00:E806: A5 5B     LDA ram_005B
C - - - - - 0x002818 00:E808: 29 01     AND #$01
C - - - - - 0x00281A 00:E80A: 85 47     STA ram_0047
...
C - - - - - 0x00286A 00:E85A: A4 5B     LDY ram_005B
...
C - - - - - 0x0028A6 00:E896: F0 08     BEQ bra_E8A0
...
bra_E8A0:
C - - - - - 0x0028B0 00:E8A0: B5 6F     LDA ram_stun_timer,X
...
C - - - - - 0x0028BC 00:E8AC: 95 6F     STA ram_stun_timer,X
...
C - - - - - 0x0028DD 00:E8CD: 20 4D D4  JSR sub_D44D_roll_rng
C - - - - - 0x0028E0 00:E8D0: 29 03     AND #$03
C - - - - - 0x0028E2 00:E8D2: 20 02 E9  JSR sub_E902
...
sub_E902:
; triggers when bonus is dropped from tank
C - - - - - 0x002912 00:E902: 85 00     STA ram_0000
C - - - - - 0x002914 00:E904: 0A        ASL
C - - - - - 0x002915 00:E905: 18        CLC
C - - - - - 0x002916 00:E906: 65 00     ADC ram_0000
...
C - - - - - 0x002986 00:E976: A5 62     LDA ram_0062
C - - - - - 0x002988 00:E978: D0 67     BNE bra_E9E1_RTS
C - - - - - 0x00298A 00:E97A: A9 01     LDA #$01
C - - - - - 0x00298C 00:E97C: 85 49     STA ram_0049
bra_E97E_loop:
C - - - - - 0x00298E 00:E97E: A6 49     LDX ram_0049
C - - - - - 0x002990 00:E980: B5 A0     LDA ram_tank_status,X
...
C - - - - - 0x0029BA 00:E9AA: 85 62     STA ram_0062
...
C - - - - - 0x0029CB 00:E9BB: A6 49     LDX ram_0049
C - - - - - 0x0029CD 00:E9BD: 20 BE D9  JSR sub_D9BE
C - - - - - 0x0029D0 00:E9C0: 20 38 D1  JSR sub_D138_gain_extra_life_for_20000_pts
C - - - - - 0x0029D3 00:E9C3: A6 49     LDX ram_0049
...
C - - - - - 0x0029E1 00:E9D1: 85 11     STA ram_0011
C - - - - - 0x0029E3 00:E9D3: B9 E3 E9  LDA tbl_E9E2_bonus_pickup_handler + 1,Y
C - - - - - 0x0029E6 00:E9D6: 85 12     STA ram_0012
C - - - - - 0x0029E8 00:E9D8: 68        PLA
C - - - - - 0x0029E9 00:E9D9: 68        PLA
C - - - - - 0x0029EA 00:E9DA: 6C 11 00  JMP (ram_0011)
bra_E9DD:
C - - - - - 0x0029ED 00:E9DD: C6 49     DEC ram_0049
...
- D 3 - - - 0x0029F2 00:E9E2: F0 E9     .word ofs_E9F0_00_helmet
- D 3 - - - 0x0029F4 00:E9E4: F5 E9     .word ofs_E9F5_01_clock
- D 3 - - - 0x0029F6 00:E9E6: FB E9     .word ofs_E9FB_02_shovel
- D 3 - - - 0x0029F8 00:E9E8: 07 EA     .word ofs_EA07_03_star
- D 3 - - - 0x0029FA 00:E9EA: 17 EA     .word ofs_EA17_04_grenade
- D 3 - - - 0x0029FC 00:E9EC: 3E EA     .word ofs_EA3E_05_tank
- - - - - - 0x0029FE 00:E9EE: 48 EA     .word ofs_EA48_06_RTS   ; pistol
...
C - - - - - 0x002A3B 00:EA2B: A9 73     LDA #$73
C - - - - - 0x002A3D 00:EA2D: 99 A0 00  STA ram_tank_status,Y
...
C - - - - - 0x002A6B 00:EA5B: A9 1C     LDA #< ram_sfx_ind_data
C - - - - - 0x002A6D 00:EA5D: 85 F0     STA ram_00F0
C - - - - - 0x002A6F 00:EA5F: A9 03     LDA #> ram_sfx_ind_data
C - - - - - 0x002A71 00:EA61: 85 F1     STA ram_00F1
C - - - - - 0x002A73 00:EA63: A2 00     LDX #$00
C - - - - - 0x002A75 00:EA65: A0 00     LDY #$00
bra_EA67_loop:
C - - - - - 0x002A77 00:EA67: 98        TYA
C - - - - - 0x002A78 00:EA68: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002A7A 00:EA6A: 9D 00 03  STA ram_sounds,X
C - - - - - 0x002A7D 00:EA6D: 18        CLC
C - - - - - 0x002A7E 00:EA6E: A5 F0     LDA ram_00F0
C - - - - - 0x002A80 00:EA70: 69 08     ADC #$08
C - - - - - 0x002A82 00:EA72: 85 F0     STA ram_00F0
C - - - - - 0x002A84 00:EA74: 90 02     BCC bra_EA78_not_overflow
- - - - - - 0x002A86 00:EA76: E6 F1     INC ram_00F1
...
bra_EA90_loop:
C - - - - - 0x002AA0 00:EA90: 95 F9     STA ram_00F9,X
...
C - - - - - 0x002AA9 00:EA99: A9 1C     LDA #< ram_sfx_ind_data
C - - - - - 0x002AAB 00:EA9B: 85 F0     STA ram_00F0
C - - - - - 0x002AAD 00:EA9D: A9 03     LDA #> ram_sfx_ind_data
C - - - - - 0x002AAF 00:EA9F: 85 F1     STA ram_00F1
bra_EAA1_loop:
...
C - - - - - 0x002ABA 00:EAAA: B1 F0     LDA (ram_00F0),Y
...
C - - - - - 0x002ADE 00:EACE: 91 F0     STA (ram_00F0),Y
...
C - - - - - 0x002AF4 00:EAE4: A5 F0     LDA ram_00F0
C - - - - - 0x002AF6 00:EAE6: 69 08     ADC #$08
C - - - - - 0x002AF8 00:EAE8: 85 F0     STA ram_00F0
C - - - - - 0x002AFA 00:EAEA: 90 02     BCC bra_EAEE
- - - - - - 0x002AFC 00:EAEC: E6 F1     INC ram_00F1
bra_EAEE:
...
C - - - - - 0x002B27 00:EB17: 85 F0     STA ram_00F0
C - - - - - 0x002B29 00:EB19: A9 03     LDA #$03
C - - - - - 0x002B2B 00:EB1B: 85 F1     STA ram_00F1
bra_EB1D:
...
C - - - - - 0x002B3F 00:EB2F: A5 F0     LDA ram_00F0
C - - - - - 0x002B41 00:EB31: 69 08     ADC #$08
C - - - - - 0x002B43 00:EB33: 85 F0     STA ram_00F0
C - - - - - 0x002B45 00:EB35: 90 02     BCC bra_EB39
- - - - - - 0x002B47 00:EB37: E6 F1     INC ram_00F1
bra_EB39:
...
C - - - - - 0x002B4F 00:EB3F: 90 DC     BCC bra_EB1D
C - - - - - 0x002B51 00:EB41: 60        RTS
bra_EB42:
C - - - - - 0x002B52 00:EB42: A0 07     LDY #$07
C - - - - - 0x002B54 00:EB44: B1 F0     LDA (ram_00F0),Y
...
C - - - - - 0x002B63 00:EB53: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002B65 00:EB55: 20 AF EC  JSR sub_ECAF
C - - - - - 0x002B68 00:EB58: 20 BE EC  JSR sub_ECBE
C - - - - - 0x002B6B 00:EB5B: A0 00     LDY #$00
C - - - - - 0x002B6D 00:EB5D: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002B6F 00:EB5F: 20 BE EC  JSR sub_ECBE
C - - - - - 0x002B72 00:EB62: A0 01     LDY #$01
C - - - - - 0x002B74 00:EB64: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002B76 00:EB66: 20 BE EC  JSR sub_ECBE
C - - - - - 0x002B79 00:EB69: A0 02     LDY #$02
C - - - - - 0x002B7B 00:EB6B: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002B7D 00:EB6D: 20 BE EC  JSR sub_ECBE
C - - - - - 0x002B80 00:EB70: A0 04     LDY #$04
C - - - - - 0x002B82 00:EB72: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002B84 00:EB74: A0 00     LDY #$00
C - - - - - 0x002B86 00:EB76: B1 F0     LDA (ram_00F0),Y
...
C - - - - - 0x002BB7 00:EBA7: 85 FD     STA ram_00FD
C - - - - - 0x002BB9 00:EBA9: BD E7 EC  LDA tbl_ECE7,X
C - - - - - 0x002BBC 00:EBAC: 85 FE     STA ram_00FE
C - - - - - 0x002BBE 00:EBAE: 68        PLA
C - - - - - 0x002BBF 00:EBAF: 29 07     AND #$07
C - - - - - 0x002BC1 00:EBB1: F0 08     BEQ bra_EBBB
C - - - - - 0x002BC3 00:EBB3: AA        TAX
bra_EBB4_loop:
C - - - - - 0x002BC4 00:EBB4: 46 FD     LSR ram_00FD
C - - - - - 0x002BC6 00:EBB6: 66 FE     ROR ram_00FE
C - - - - - 0x002BC8 00:EBB8: CA        DEX
C - - - - - 0x002BC9 00:EBB9: D0 F9     BNE bra_EBB4_loop
bra_EBBB:
C - - - - - 0x002BCB 00:EBBB: A0 04     LDY #$04
C - - - - - 0x002BCD 00:EBBD: B1 F0     LDA (ram_00F0),Y
C - - - - - 0x002BCF 00:EBBF: 29 F8     AND #$F8
C - - - - - 0x002BD1 00:EBC1: 05 FD     ORA ram_00FD
C - - - - - 0x002BD3 00:EBC3: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002BD5 00:EBC5: A5 FE     LDA ram_00FE
C - - - - - 0x002BD7 00:EBC7: 88        DEY
C - - - - - 0x002BD8 00:EBC8: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002BDA 00:EBCA: A0 00     LDY #$00
C - - - - - 0x002BDC 00:EBCC: B1 F0     LDA (ram_00F0),Y
...
C - - - - - 0x002BE5 00:EBD5: 91 F0     STA (ram_00F0),Y
bra_EBD7:
C - - - - - 0x002BE7 00:EBD7: A0 06     LDY #$06
C - - - - - 0x002BE9 00:EBD9: B1 F0     LDA (ram_00F0),Y
C - - - - - 0x002BEB 00:EBDB: C8        INY
C - - - - - 0x002BEC 00:EBDC: 91 F0     STA (ram_00F0),Y
...
- D 3 - I - 0x002BF6 00:EBE6: 0A EC     .word ofs_EC0A_E8
- - - - - - 0x002BF8 00:EBE8: 21 EC     .word ofs_EC21_E9
- D 3 - I - 0x002BFA 00:EBEA: 33 EC     .word ofs_EC33_EA
- - - - - - 0x002BFC 00:EBEC: 45 EC     .word ofs_EC45_EB
- - - - - - 0x002BFE 00:EBEE: 57 EC     .word ofs_EC57_EC
- - - - - - 0x002C00 00:EBF0: 61 EC     .word ofs_EC61_ED
- D 3 - I - 0x002C02 00:EBF2: 6B EC     .word ofs_EC6B_EE
- D 3 - I - 0x002C04 00:EBF4: 75 EC     .word ofs_EC75_EF
- D 3 - I - 0x002C06 00:EBF6: 81 EC     .word ofs_EC81_F0
- D 3 - I - 0x002C08 00:EBF8: 85 EC     .word ofs_EC85_F1
- D 3 - I - 0x002C0A 00:EBFA: 88 EC     .word ofs_EC88_F2
- - - - - - 0x002C0C 00:EBFC: 99 EC     .word ofs_EC99_F3
- - - - - - 0x002C0E 00:EBFE: 99 EC     .word ofs_EC99_F4
- - - - - - 0x002C10 00:EC00: 99 EC     .word ofs_EC99_F5
- - - - - - 0x002C12 00:EC02: 99 EC     .word ofs_EC99_F6
- - - - - - 0x002C14 00:EC04: 99 EC     .word ofs_EC99_F7
- - - - - - 0x002C16 00:EC06: 99 EC     .word ofs_EC99_F8
- D 3 - I - 0x002C18 00:EC08: A5 EC     .word ofs_ECA5_F9
...
C - - - - - 0x002C23 00:EC13: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002C25 00:EC15: A0 05     LDY #$05
C - - - - - 0x002C27 00:EC17: B1 F0     LDA (ram_00F0),Y
C - - - - - 0x002C29 00:EC19: 38        SEC
C - - - - - 0x002C2A 00:EC1A: E9 01     SBC #$01
C - - - - - 0x002C2C 00:EC1C: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002C2E 00:EC1E: 4C 2E EB  JMP loc_EB2E



ofs_EC21_E9:
- - - - - - 0x002C31 00:EC21: 20 BE EC  JSR sub_ECBE
- - - - - - 0x002C34 00:EC24: 85 FD     STA ram_00FD
- - - - - - 0x002C36 00:EC26: A0 01     LDY #$01
- - - - - - 0x002C38 00:EC28: B1 F0     LDA (ram_00F0),Y
- - - - - - 0x002C3A 00:EC2A: 29 3F     AND #$3F
- - - - - - 0x002C3C 00:EC2C: 05 FD     ORA ram_00FD
- - - - - - 0x002C3E 00:EC2E: 91 F0     STA (ram_00F0),Y
- - - - - - 0x002C40 00:EC30: 4C 88 EB  JMP loc_EB88



ofs_EC33_EA:
C - - J - - 0x002C43 00:EC33: 20 BE EC  JSR sub_ECBE
C - - - - - 0x002C46 00:EC36: 85 FD     STA ram_00FD
C - - - - - 0x002C48 00:EC38: A0 01     LDY #$01
C - - - - - 0x002C4A 00:EC3A: B1 F0     LDA (ram_00F0),Y
C - - - - - 0x002C4C 00:EC3C: 29 C0     AND #$C0
C - - - - - 0x002C4E 00:EC3E: 05 FD     ORA ram_00FD
C - - - - - 0x002C50 00:EC40: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002C52 00:EC42: 4C 88 EB  JMP loc_EB88



ofs_EC45_EB:
- - - - - - 0x002C55 00:EC45: 20 BE EC  JSR sub_ECBE
- - - - - - 0x002C58 00:EC48: 85 FD     STA ram_00FD
- - - - - - 0x002C5A 00:EC4A: A0 01     LDY #$01
- - - - - - 0x002C5C 00:EC4C: B1 F0     LDA (ram_00F0),Y
- - - - - - 0x002C5E 00:EC4E: 29 F0     AND #$F0
- - - - - - 0x002C60 00:EC50: 05 FD     ORA ram_00FD
- - - - - - 0x002C62 00:EC52: 91 F0     STA (ram_00F0),Y
- - - - - - 0x002C64 00:EC54: 4C 88 EB  JMP loc_EB88



ofs_EC57_EC:
- - - - - - 0x002C67 00:EC57: 20 BE EC  JSR sub_ECBE
- - - - - - 0x002C6A 00:EC5A: A0 02     LDY #$02
- - - - - - 0x002C6C 00:EC5C: 91 F0     STA (ram_00F0),Y
- - - - - - 0x002C6E 00:EC5E: 4C 88 EB  JMP loc_EB88



ofs_EC61_ED:
- - - - - - 0x002C71 00:EC61: 20 BE EC  JSR sub_ECBE
- - - - - - 0x002C74 00:EC64: A0 04     LDY #$04
- - - - - - 0x002C76 00:EC66: 91 F0     STA (ram_00F0),Y
- - - - - - 0x002C78 00:EC68: 4C 88 EB  JMP loc_EB88



ofs_EC6B_EE:
C - - J - - 0x002C7B 00:EC6B: 20 BE EC  JSR sub_ECBE
C - - - - - 0x002C7E 00:EC6E: A0 01     LDY #$01
C - - - - - 0x002C80 00:EC70: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002C82 00:EC72: 4C 88 EB  JMP loc_EB88
...
bra_EC79_loop:
C - - - - - 0x002C89 00:EC79: 95 F6     STA ram_00F6,X
C - - - - - 0x002C8B 00:EC7B: CA        DEX
C - - - - - 0x002C8C 00:EC7C: 10 FB     BPL bra_EC79_loop
C - - - - - 0x002C8E 00:EC7E: 4C 88 EB  JMP loc_EB88
...
C - - - - - 0x002CAB 00:EC9B: B1 F0     LDA (ram_00F0),Y
C - - - - - 0x002CAD 00:EC9D: 18        CLC
C - - - - - 0x002CAE 00:EC9E: 69 01     ADC #$01
C - - - - - 0x002CB0 00:ECA0: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002CB2 00:ECA2: 4C 88 EB  JMP loc_EB88



bra_ECA5:
ofs_ECA5_F9:
C - - - - - 0x002CB5 00:ECA5: 20 BE EC  JSR sub_ECBE
C - - - - - 0x002CB8 00:ECA8: A0 05     LDY #$05
C - - - - - 0x002CBA 00:ECAA: 91 F0     STA (ram_00F0),Y
C - - - - - 0x002CBC 00:ECAC: 4C 88 EB  JMP loc_EB88
...
C - - - - - 0x002CC6 00:ECB6: 85 F2     STA ram_00F2
C - - - - - 0x002CC8 00:ECB8: BD FF EC  LDA tbl_ECFE + 1,X
C - - - - - 0x002CCB 00:ECBB: 85 F3     STA ram_00F3
...
C - - - - - 0x002CE4 00:ECD4: 85 FD     STA ram_00FD
C - - - - - 0x002CE6 00:ECD6: 68        PLA
C - - - - - 0x002CE7 00:ECD7: 85 FE     STA ram_00FE
C - - - - - 0x002CE9 00:ECD9: B1 FD     LDA (ram_00FD),Y
C - - - - - 0x002CEB 00:ECDB: AA        TAX
C - - - - - 0x002CEC 00:ECDC: C8        INY
C - - - - - 0x002CED 00:ECDD: B1 FD     LDA (ram_00FD),Y
C - - - - - 0x002CEF 00:ECDF: 85 FE     STA ram_00FE
C - - - - - 0x002CF1 00:ECE1: 86 FD     STX ram_00FD
C - - - - - 0x002CF3 00:ECE3: 6C FD 00  JMP (ram_00FD)



tbl_ECE6:
- D 3 - - - 0x002CF6 00:ECE6: 07        .byte $07   ; 
tbl_ECE7:
- D 3 - - - 0x002CF7 00:ECE7: F2        .byte $F2   ; 
- D 3 - - - 0x002CF8 00:ECE8: 07        .byte $07   ; 
- D 3 - - - 0x002CF9 00:ECE9: 80        .byte $80   ; 
- D 3 - - - 0x002CFA 00:ECEA: 07        .byte $07   ; 
- D 3 - - - 0x002CFB 00:ECEB: 14        .byte $14   ; 
- D 3 - - - 0x002CFC 00:ECEC: 06        .byte $06   ; 
- D 3 - - - 0x002CFD 00:ECED: AE        .byte $AE   ; 
- D 3 - - - 0x002CFE 00:ECEE: 06        .byte $06   ; 
- D 3 - - - 0x002CFF 00:ECEF: 43        .byte $43   ; 
- D 3 - - - 0x002D00 00:ECF0: 05        .byte $05   ; 
- D 3 - - - 0x002D01 00:ECF1: F4        .byte $F4   ; 
- D 3 - - - 0x002D02 00:ECF2: 05        .byte $05   ; 
- D 3 - - - 0x002D03 00:ECF3: 9E        .byte $9E   ; 
- D 3 - - - 0x002D04 00:ECF4: 05        .byte $05   ; 
- D 3 - - - 0x002D05 00:ECF5: 4E        .byte $4E   ; 
- D 3 - - - 0x002D06 00:ECF6: 05        .byte $05   ; 
- D 3 - - - 0x002D07 00:ECF7: 02        .byte $02   ; 
- D 3 - - - 0x002D08 00:ECF8: 04        .byte $04   ; 
- D 3 - - - 0x002D09 00:ECF9: BA        .byte $BA   ; 
- D 3 - - - 0x002D0A 00:ECFA: 04        .byte $04   ; 
- D 3 - - - 0x002D0B 00:ECFB: 76        .byte $76   ; 
- D 3 - - - 0x002D0C 00:ECFC: 04        .byte $04   ; 
- D 3 - - - 0x002D0D 00:ECFD: 36        .byte $36   ; 
...
; bzk garbage
- - - - - - 0x002F85 00:EF75: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002F8D 00:EF7D: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002F95 00:EF85: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002F9D 00:EF8D: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002FA5 00:EF95: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002FAD 00:EF9D: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002FB5 00:EFA5: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002FBD 00:EFAD: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002FC5 00:EFB5: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002FCD 00:EFBD: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002FD5 00:EFC5: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002FDD 00:EFCD: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002FE5 00:EFD5: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002FED 00:EFDD: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002FF5 00:EFE5: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x002FFD 00:EFED: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003005 00:EFF5: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x00300D 00:EFFD: FF        .byte $FF, $FF, $FF   ; 
...
C - - - - - 0x003016 00:F006: 4C 10 F0  JMP loc_F010    ; bzk optimize, BNE
bra_F009:
...
bra_F010:
loc_F010:
C D 3 - - - 0x003020 00:F010: 85 00     STA ram_0000
C - - - - - 0x003022 00:F012: A9 F0     LDA #> tbl_F07A_stage_data
C - - - - - 0x003024 00:F014: 85 12     STA ram_0012
C - - - - - 0x003026 00:F016: A9 7A     LDA #< tbl_F07A_stage_data
C - - - - - 0x003028 00:F018: 85 11     STA ram_0011
loc_F01A:
C D 3 - - - 0x00302A 00:F01A: C6 00     DEC ram_0000
C - - - - - 0x00302C 00:F01C: F0 08     BEQ bra_F026
C - - - - - 0x00302E 00:F01E: A9 5B     LDA #$5B
C - - - - - 0x003030 00:F020: 20 AA D7  JSR sub_D7AA
...
C - - - - - 0x003040 00:F030: 85 14     STA ram_0014
C - - - - - 0x003042 00:F032: A9 10     LDA #$10
C - - - - - 0x003044 00:F034: 85 57     STA ram_0057
bra_F036_loop:
C - - - - - 0x003046 00:F036: 20 F6 D8  JSR sub_D8F6_wait_1_frame_
...
bra_F04E:
C - - - - - 0x00305E 00:F04E: B1 13     LDA (ram_0013),Y
C - - - - - 0x003060 00:F050: 4A        LSR
C - - - - - 0x003061 00:F051: 4A        LSR
C - - - - - 0x003062 00:F052: 4A        LSR
C - - - - - 0x003063 00:F053: 4A        LSR
loc_F054:
C D 3 - - - 0x003064 00:F054: A6 56     LDX ram_0056
C - - - - - 0x003066 00:F056: A4 57     LDY ram_0057
...
C - - - - - 0x003083 00:F073: 85 57     STA ram_0057
...
tbl_F07A_stage_data:
    ...
    .incbin "stages/stage_FF.bin"   ; demo
...
; bzk garbage
- - - - - - 0x003F60 00:FF50: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003F68 00:FF58: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003F70 00:FF60: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003F78 00:FF68: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003F80 00:FF70: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003F88 00:FF78: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003F90 00:FF80: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003F98 00:FF88: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003FA0 00:FF90: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003FA8 00:FF98: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003FB0 00:FFA0: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003FB8 00:FFA8: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003FC0 00:FFB0: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003FC8 00:FFB8: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003FD0 00:FFC0: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003FD8 00:FFC8: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003FE0 00:FFD0: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003FE8 00:FFD8: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003FF0 00:FFE0: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x003FF8 00:FFE8: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x004000 00:FFF0: FF        .byte $FF, $FF, $FF, $FF, $FF, $FF, $FF, $FF   ; 
- - - - - - 0x004008 00:FFF8: FF        .byte $FF, $FF   ; 
...
- - - - - - 0x00400E 00:FFFE: 70 C0     .word vec_C070_IRQ
