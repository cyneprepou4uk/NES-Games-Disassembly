...
C - - - - - 0x01D029 07:D019: 85 00     STA ram_0000_t26_jmp
C - - - - - 0x01D02B 07:D01B: B9 24 D0  LDA tbl_D023 + $01,Y
C - - - - - 0x01D02E 07:D01E: 85 01     STA ram_0000_t26_jmp + $01
C - - - - - 0x01D030 07:D020: 6C 00 00  JMP (ram_0000_t26_jmp)
...
C - - - - - 0x01D141 07:D131: 85 00     STA ram_0000_temp
...
bra_D13E:
C - - - - - 0x01D14E 07:D13E: 05 00     ORA ram_0000_temp
C - - - - - 0x01D150 07:D140: 85 00     STA ram_0000_temp
C - - - - - 0x01D152 07:D142: 88        DEY
C - - - - - 0x01D153 07:D143: 10 F0     BPL bra_D135_loop
C - - - - - 0x01D155 07:D145: 85 00     STA ram_0000_temp
C - - - - - 0x01D157 07:D147: A0 01     LDY #$01
C - - - - - 0x01D159 07:D149: A9 20     LDA #$20
bra_D14B_loop:
C - - - - - 0x01D15B 07:D14B: AA        TAX
C - - - - - 0x01D15C 07:D14C: 25 00     AND ram_0000_temp
...
C - - - - - 0x01D181 07:D171: 85 00     STA ram_0000_temp
...
C - - - - - 0x01D1C3 07:D1B3: B1 00     LDA (ram_0000_t18_static_screen_data),Y
C - - - - - 0x01D1C5 07:D1B5: 8D 06 20  STA $2006
C - - - - - 0x01D1C8 07:D1B8: 88        DEY ; 00
C - - - - - 0x01D1C9 07:D1B9: B1 00     LDA (ram_0000_t18_static_screen_data),Y
...
C - - - - - 0x01D1D7 07:D1C7: B1 00     LDA (ram_0000_t18_static_screen_data),Y
...
C - - - - - 0x01D1E6 07:D1D6: 85 02     STA ram_0002_temp
C - - - - - 0x01D1E8 07:D1D8: A0 01     LDY #$01
bra_D1DA_loop:
C - - - - - 0x01D1EA 07:D1DA: B1 00     LDA (ram_0000_t18_static_screen_data),Y
C - - - - - 0x01D1EC 07:D1DC: 8D 07 20  STA $2007
C - - - - - 0x01D1EF 07:D1DF: C4 02     CPY ram_0002_temp
...
C - - - - - 0x01D1F9 07:D1E9: 65 02     ADC ram_0002_temp
bra_D1EB:
C - - - - - 0x01D1FB 07:D1EB: 4C C2 D1  JMP loc_D1C2_loop
bra_D1EE:
; 00-7E
C - - - - - 0x01D1FE 07:D1EE: A0 01     LDY #$01
C - - - - - 0x01D200 07:D1F0: 85 02     STA ram_0002_temp
C - - - - - 0x01D202 07:D1F2: B1 00     LDA (ram_0000_t18_static_screen_data),Y
C - - - - - 0x01D204 07:D1F4: A4 02     LDY ram_0002_temp
bra_D1F6_loop:
...
C - - - - - 0x01D21C 07:D20C: 75 00     ADC ram_0000_t18_static_screen_data,X
C - - - - - 0x01D21E 07:D20E: 95 00     STA ram_0000_t18_static_screen_data,X
C - - - - - 0x01D220 07:D210: 90 02     BCC bra_D214_RTS    ; if not overflow
C - - - - - 0x01D222 07:D212: F6 01     INC ram_0000_t18_static_screen_data + $01,X
bra_D214_RTS:
...
C - - - - - 0x01D228 07:D218: 85 00     STA ram_0000_t18_static_screen_data
C - - - - - 0x01D22A 07:D21A: BD 2B D2  LDA tbl_D22A_static_screens + $01,X
C - - - - - 0x01D22D 07:D21D: 85 01     STA ram_0000_t18_static_screen_data + $01
...
bra_D246:
C - - - - - 0x01D256 07:D246: 85 02     STA ram_0002_temp
...
C - - - - - 0x01D277 07:D267: A5 02     LDA ram_0002_temp
...
C - - - - - 0x01D2EB 07:D2DB: 85 01     STA ram_0001_temp
...
C - - - - - 0x01D2FD 07:D2ED: 85 11     STA ram_0011_temp
C - - - - - 0x01D2FF 07:D2EF: A9 00     LDA #$00
C - - - - - 0x01D301 07:D2F1: 85 08     STA ram_0008_temp
...
C - - - - - 0x01D30B 07:D2FB: 85 10     STA ram_0010_temp
...
C - - - - - 0x01D318 07:D308: 85 02     STA ram_0002_temp
C - - - - - 0x01D31A 07:D30A: B9 70 D5  LDA tbl_D56F + $01,Y
C - - - - - 0x01D31D 07:D30D: 85 03     STA ram_0003_temp
C - - - - - 0x01D31F 07:D30F: A9 00     LDA #$00
C - - - - - 0x01D321 07:D311: 85 12     STA ram_0012_temp
C - - - - - 0x01D323 07:D313: 85 13     STA ram_0013_temp
C - - - - - 0x01D325 07:D315: 85 14     STA ram_0014_temp
...
C - - - - - 0x01D330 07:D320: 85 0A     STA ram_000A_temp
...
C - - - - - 0x01D33A 07:D32A: 85 08     STA ram_0008_temp
...
bra_D335:
C - - - - - 0x01D345 07:D335: A5 01     LDA ram_0001_temp
C - - - - - 0x01D347 07:D337: F0 0F     BEQ bra_D348
C - - - - - 0x01D349 07:D339: A4 08     LDY ram_0008_temp
...
bra_D342:
C - - - - - 0x01D352 07:D342: 84 08     STY ram_0008_temp
C - - - - - 0x01D354 07:D344: C6 0A     DEC ram_000A_temp
C - - - - - 0x01D356 07:D346: D0 E5     BNE bra_D32D_loop
bra_D348:
loc_D348:
C D 2 - - - 0x01D358 07:D348: A5 01     LDA ram_0001_temp
...
C - - - - - 0x01D366 07:D356: C6 01     DEC ram_0001_temp
...
sub_D35B:
; A > 00
C - - - - - 0x01D36B 07:D35B: 85 10     STA ram_0010_temp
...
C - - - - - 0x01D379 07:D369: 85 13     STA ram_0013_temp
...
C - - - - - 0x01D382 07:D372: A4 08     LDY ram_0008_temp
...
C - - - - - 0x01D38E 07:D37E: A5 10     LDA ram_0010_temp
...
C - - - - - 0x01D397 07:D387: 85 10     STA ram_0010_temp
...
C - - - - - 0x01D3A4 07:D394: 85 10     STA ram_0010_temp
C - - - - - 0x01D3A6 07:D396: B9 02 80  LDA tbl_0x000011_spr_data + $01,Y
C - - - - - 0x01D3A9 07:D399: 69 00     ADC #$00
bra_D39B:
C - - - - - 0x01D3AB 07:D39B: 85 11     STA ram_0011_temp
C - - - - - 0x01D3AD 07:D39D: A0 00     LDY #$00
C - - - - - 0x01D3AF 07:D39F: B1 10     LDA (ram_0010_temp),Y
C - - - - - 0x01D3B1 07:D3A1: 85 02     STA ram_0002_temp
C - - - - - 0x01D3B3 07:D3A3: C8        INY
C - - - - - 0x01D3B4 07:D3A4: B1 10     LDA (ram_0010_temp),Y
C - - - - - 0x01D3B6 07:D3A6: 85 03     STA ram_0003_temp
C - - - - - 0x01D3B8 07:D3A8: A4 08     LDY ram_0008_temp
C - - - - - 0x01D3BA 07:D3AA: B9 4E 06  LDA ram_obj_pos_X,Y
C - - - - - 0x01D3BD 07:D3AD: 85 11     STA ram_0011_temp
C - - - - - 0x01D3BF 07:D3AF: B9 68 06  LDA ram_obj_pos_Y,Y
C - - - - - 0x01D3C2 07:D3B2: 85 10     STA ram_0010_temp
...
bra_D3C8:
C - - - - - 0x01D3D8 07:D3C8: 85 12     STA ram_0012_temp
...
bra_D3D2:
C - - - - - 0x01D3E2 07:D3D2: A5 08     LDA ram_0008_temp
...
C - - - - - 0x01D3EC 07:D3DC: 65 08     ADC ram_0008_temp
...
bra_D40D:
C - - - - - 0x01D41D 07:D40D: A5 19     LDA ram_0019_temp
C - - - - - 0x01D41F 07:D40F: 45 1C     EOR ram_001C_temp
C - - - - - 0x01D421 07:D411: 9D 02 02  STA ram_spr_A,X
C - - - - - 0x01D424 07:D414: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01D426 07:D416: 20 B0 D4  JSR sub_D4B0
C - - - - - 0x01D429 07:D419: F0 09     BEQ bra_D424_RTS
bra_D41B:
C - - - - - 0x01D42B 07:D41B: C8        INY
C - - - - - 0x01D42C 07:D41C: C6 00     DEC ram_0000_temp
C - - - - - 0x01D42E 07:D41E: D0 E5     BNE bra_D405_loop
C - - - - - 0x01D430 07:D420: A5 1A     LDA ram_001A_temp
...
bra_D433:
C - - - - - 0x01D443 07:D433: A5 19     LDA ram_0019_temp
C - - - - - 0x01D445 07:D435: 45 1C     EOR ram_001C_temp
C - - - - - 0x01D447 07:D437: 9D 02 02  STA ram_spr_A,X
C - - - - - 0x01D44A 07:D43A: B1 02     LDA (ram_0002_temp),Y
...
C - - - - - 0x01D45D 07:D44D: C6 00     DEC ram_0000_temp
C - - - - - 0x01D45F 07:D44F: D0 DA     BNE bra_D42B_loop
C - - - - - 0x01D461 07:D451: A5 1A     LDA ram_001A_temp
...
C - - - - - 0x01D46B 07:D45B: D1 02     CMP (ram_0002_temp),Y
...
C - - - - - 0x01D46F 07:D45F: 85 1B     STA ram_001B_temp
C - - - - - 0x01D471 07:D461: A9 08     LDA #$08
C - - - - - 0x01D473 07:D463: 85 1F     STA ram_001F_temp
C - - - - - 0x01D475 07:D465: A9 40     LDA #$40
C - - - - - 0x01D477 07:D467: 85 1C     STA ram_001C_temp
C - - - - - 0x01D479 07:D469: C8        INY
C - - - - - 0x01D47A 07:D46A: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01D47C 07:D46C: 48        PHA
C - - - - - 0x01D47D 07:D46D: C8        INY
C - - - - - 0x01D47E 07:D46E: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01D480 07:D470: 85 03     STA ram_0003_temp
C - - - - - 0x01D482 07:D472: 68        PLA
C - - - - - 0x01D483 07:D473: 85 02     STA ram_0002_temp
C - - - - - 0x01D485 07:D475: A0 00     LDY #$00
bra_D477:
C - - - - - 0x01D487 07:D477: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01D489 07:D479: 85 1A     STA ram_001A_temp
C - - - - - 0x01D48B 07:D47B: 29 7F     AND #$7F
C - - - - - 0x01D48D 07:D47D: 85 00     STA ram_0000_temp
C - - - - - 0x01D48F 07:D47F: C8        INY
C - - - - - 0x01D490 07:D480: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01D492 07:D482: 25 18     AND ram_0018_temp
C - - - - - 0x01D494 07:D484: 05 12     ORA ram_0012_temp
C - - - - - 0x01D496 07:D486: 85 19     STA ram_0019_temp
...
C - - - - - 0x01D49C 07:D48C: 85 0E     STA ram_000E_temp
C - - - - - 0x01D49E 07:D48E: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01D4A0 07:D490: 45 1B     EOR ram_001B_temp
C - - - - - 0x01D4A2 07:D492: 38        SEC
C - - - - - 0x01D4A3 07:D493: E5 1F     SBC ram_001F_temp
C - - - - - 0x01D4A5 07:D495: 10 02     BPL bra_D499
C - - - - - 0x01D4A7 07:D497: C6 0E     DEC ram_000E_temp    ; FF
bra_D499:
C - - - - - 0x01D4A9 07:D499: 18        CLC
C - - - - - 0x01D4AA 07:D49A: 65 11     ADC ram_0011_temp
C - - - - - 0x01D4AC 07:D49C: 9D 03 02  STA ram_spr_X,X
C - - - - - 0x01D4AF 07:D49F: A5 13     LDA ram_0013_temp
C - - - - - 0x01D4B1 07:D4A1: 65 0E     ADC ram_000E_temp    ; 00/FF
...
C - - - - - 0x01D4B9 07:D4A9: 84 1B     STY ram_001B_temp
C - - - - - 0x01D4BB 07:D4AB: 84 1C     STY ram_001C_temp
...
C - - - - - 0x01D4C4 07:D4B4: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01D4C6 07:D4B6: 18        CLC
C - - - - - 0x01D4C7 07:D4B7: 65 10     ADC ram_0010_temp
...
C - - - - - 0x01D4D1 07:D4C1: C6 01     DEC ram_0001_temp
...
C - - - - - 0x01D713 07:D703: 85 00     STA ram_0000_t28_jmp
...
C D 2 - - - 0x01D718 07:D708: 85 01     STA ram_0000_t28_jmp + $01
C - - - - - 0x01D71A 07:D70A: 6C 00 00  JMP (ram_0000_t28_jmp)
...
C - - - - - 0x01D76B 07:D75B: 84 08     STY ram_0008_temp
bra_D75D:
...
C - - - - - 0x01D78D 07:D77D: 85 00     STA ram_0000_temp
C - - - - - 0x01D78F 07:D77F: 8A        TXA
C - - - - - 0x01D790 07:D780: 49 01     EOR #$01
C - - - - - 0x01D792 07:D782: A8        TAY
C - - - - - 0x01D793 07:D783: A5 00     LDA ram_0000_temp
...
C - - - - - 0x01D7B7 07:D7A7: B9 7B D8  LDA tbl_D87A + $01,Y
...
C - - - - - 0x01D820 07:D810: A5 08     LDA ram_0008_temp
...
C - - - - - 0x01D82A 07:D81A: 85 06     STA ram_0006_temp
C - - - - - 0x01D82C 07:D81C: B9 8B D8  LDA tbl_D88C_nmt_attributes - $01,Y
C - - - - - 0x01D82F 07:D81F: 85 07     STA ram_0007_temp
...
C - - - - - 0x01D880 07:D870: 85 00     STA ram_0000_temp
C - - - - - 0x01D882 07:D872: B9 83 D8  LDA tbl_D883,Y
C - - - - - 0x01D885 07:D875: 85 01     STA ram_0001_temp
...
C - - - - - 0x01DA9E 07:DA8E: 85 00     STA ram_0000_t27_jmp
C - - - - - 0x01DAA0 07:DA90: B9 9E DA  LDA tbl_DA9D + $01,Y
C - - - - - 0x01DAA3 07:DA93: 85 01     STA ram_0000_t27_jmp + $01
...
C - - - - - 0x01DAAA 07:DA9A: 6C 00 00  JMP (ram_0000_t27_jmp)
...
- - - - - - 0x01DB04 07:DAF4: F1 02     SBC (ram_0002_temp),Y
...
- - - - - - 0x01DB1E 07:DB0E: B1 02     LDA (ram_0002_temp),Y
...
- - - - - - 0x01DB4E 07:DB3E: B1 02     LDA (ram_0002_temp),Y
...
C - - - - - 0x01DB82 07:DB72: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01DB84 07:DB74: 85 04     STA ram_0004_temp
C - - - - - 0x01DB86 07:DB76: C8        INY
C - - - - - 0x01DB87 07:DB77: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01DB89 07:DB79: 85 05     STA ram_0005_temp
C - - - - - 0x01DB8B 07:DB7B: C8        INY
C - - - - - 0x01DB8C 07:DB7C: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01DB8E 07:DB7E: 85 07     STA ram_0007_temp
bra_DB80:
bra_DB80_loop:
C - - - - - 0x01DB90 07:DB80: A5 04     LDA ram_0004_temp
C - - - - - 0x01DB92 07:DB82: 85 00     STA ram_0000_temp
C - - - - - 0x01DB94 07:DB84: A5 05     LDA ram_0005_temp
C - - - - - 0x01DB96 07:DB86: 85 01     STA ram_0001_temp
loc_DB88_loop:
...
C - - - - - 0x01DBA0 07:DB90: A5 00     LDA ram_0000_temp
C - - - - - 0x01DBA2 07:DB92: 20 C9 DA  JSR sub_DAC9_write_byte_to_ppu_buffer
C - - - - - 0x01DBA5 07:DB95: A5 01     LDA ram_0001_temp
C - - - - - 0x01DBA7 07:DB97: 20 C9 DA  JSR sub_DAC9_write_byte_to_ppu_buffer
C - - - - - 0x01DBAA 07:DB9A: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01DBAC 07:DB9C: 85 06     STA ram_0006_temp
...
C - - - - - 0x01DBB6 07:DBA6: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01DBB8 07:DBA8: 20 C9 DA  JSR sub_DAC9_write_byte_to_ppu_buffer
C - - - - - 0x01DBBB 07:DBAB: A5 06     LDA ram_0006_temp
C - - - - - 0x01DBBD 07:DBAD: 18        CLC
C - - - - - 0x01DBBE 07:DBAE: 65 00     ADC ram_0000_temp
C - - - - - 0x01DBC0 07:DBB0: 85 00     STA ram_0000_temp
C - - - - - 0x01DBC2 07:DBB2: 4C 88 DB  JMP loc_DB88_loop
bra_DBB5_FF:
C - - - - - 0x01DBC5 07:DBB5: 20 BD DB  JSR sub_DBBD
C - - - - - 0x01DBC8 07:DBB8: C6 07     DEC ram_0007_temp
...
sub_DC0C:
C - - - - - 0x01DC1C 07:DC0C: A5 06     LDA ram_0006_temp
C - - - - - 0x01DC1E 07:DC0E: 85 00     STA ram_0000_temp
C - - - - - 0x01DC20 07:DC10: A5 07     LDA ram_0007_temp
C - - - - - 0x01DC22 07:DC12: 85 01     STA ram_0001_temp
...
C - - - - - 0x01DC2A 07:DC1A: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01DC2C 07:DC1C: 85 00     STA ram_0000_temp
C - - - - - 0x01DC2E 07:DC1E: C8        INY
C - - - - - 0x01DC2F 07:DC1F: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01DC31 07:DC21: 85 01     STA ram_0001_temp
...
bra_DC2A:
sub_DC2A:
C - - - - - 0x01DC3A 07:DC2A: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01DC3C 07:DC2C: 85 04     STA ram_0004_temp
C - - - - - 0x01DC3E 07:DC2E: 85 07     STA ram_0007_temp
C - - - - - 0x01DC40 07:DC30: C8        INY
C - - - - - 0x01DC41 07:DC31: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01DC43 07:DC33: 85 05     STA ram_0005_temp
C - - - - - 0x01DC45 07:DC35: C8        INY
C - - - - - 0x01DC46 07:DC36: 84 08     STY ram_0008_temp
C - - - - - 0x01DC48 07:DC38: C5 04     CMP ram_0004_temp
...
C - - - - - 0x01DC51 07:DC41: A5 00     LDA ram_0000_temp
C - - - - - 0x01DC53 07:DC43: 20 C9 DA  JSR sub_DAC9_write_byte_to_ppu_buffer
C - - - - - 0x01DC56 07:DC46: A5 01     LDA ram_0001_temp
C - - - - - 0x01DC58 07:DC48: 20 C9 DA  JSR sub_DAC9_write_byte_to_ppu_buffer
C - - - - - 0x01DC5B 07:DC4B: A5 04     LDA ram_0004_temp
C - - - - - 0x01DC5D 07:DC4D: 85 06     STA ram_0006_temp
bra_DC4F_loop:
C - - - - - 0x01DC5F 07:DC4F: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01DC61 07:DC51: 20 C9 DA  JSR sub_DAC9_write_byte_to_ppu_buffer
C - - - - - 0x01DC64 07:DC54: C8        INY
C - - - - - 0x01DC65 07:DC55: C6 06     DEC ram_0006_temp
...
C - - - - - 0x01DC6E 07:DC5E: A5 00     LDA ram_0000_temp
C - - - - - 0x01DC70 07:DC60: 18        CLC
C - - - - - 0x01DC71 07:DC61: 69 20     ADC #< $0020
C - - - - - 0x01DC73 07:DC63: 85 00     STA ram_0000_temp
C - - - - - 0x01DC75 07:DC65: A5 01     LDA ram_0001_temp
C - - - - - 0x01DC77 07:DC67: 69 00     ADC #> $0020
C - - - - - 0x01DC79 07:DC69: 85 01     STA ram_0001_temp
C - - - - - 0x01DC7B 07:DC6B: 29 03     AND #$03
C - - - - - 0x01DC7D 07:DC6D: C9 03     CMP #$03
C - - - - - 0x01DC7F 07:DC6F: D0 0F     BNE bra_DC80
C - - - - - 0x01DC81 07:DC71: A5 00     LDA ram_0000_temp
C - - - - - 0x01DC83 07:DC73: 38        SEC
C - - - - - 0x01DC84 07:DC74: E9 C0     SBC #$C0
C - - - - - 0x01DC86 07:DC76: 90 08     BCC bra_DC80
- - - - - - 0x01DC88 07:DC78: 85 00     STA ram_0000_temp
- - - - - - 0x01DC8A 07:DC7A: A5 00     LDA ram_0000_temp
- - - - - - 0x01DC8C 07:DC7C: 49 0C     EOR #$0C
- - - - - - 0x01DC8E 07:DC7E: 85 00     STA ram_0000_temp
bra_DC80:
C - - - - - 0x01DC90 07:DC80: C6 05     DEC ram_0005_temp
...
C - - - - - 0x01DC9A 07:DC8A: A5 00     LDA ram_0000_temp
C - - - - - 0x01DC9C 07:DC8C: 20 C9 DA  JSR sub_DAC9_write_byte_to_ppu_buffer
C - - - - - 0x01DC9F 07:DC8F: A5 01     LDA ram_0001_temp
C - - - - - 0x01DCA1 07:DC91: 20 C9 DA  JSR sub_DAC9_write_byte_to_ppu_buffer
C - - - - - 0x01DCA4 07:DC94: A5 05     LDA ram_0005_temp
C - - - - - 0x01DCA6 07:DC96: 85 06     STA ram_0006_temp
C - - - - - 0x01DCA8 07:DC98: A4 08     LDY ram_0008_temp
bra_DC9A_loop:
C - - - - - 0x01DCAA 07:DC9A: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01DCAC 07:DC9C: 20 C9 DA  JSR sub_DAC9_write_byte_to_ppu_buffer
C - - - - - 0x01DCAF 07:DC9F: 98        TYA
C - - - - - 0x01DCB0 07:DCA0: 18        CLC
C - - - - - 0x01DCB1 07:DCA1: 65 07     ADC ram_0007_temp
C - - - - - 0x01DCB3 07:DCA3: A8        TAY
C - - - - - 0x01DCB4 07:DCA4: C6 06     DEC ram_0006_temp
C - - - - - 0x01DCB6 07:DCA6: D0 F2     BNE bra_DC9A_loop
C - - - - - 0x01DCB8 07:DCA8: E6 08     INC ram_0008_temp
C - - - - - 0x01DCBA 07:DCAA: A9 FF     LDA #$FF
C - - - - - 0x01DCBC 07:DCAC: 20 C9 DA  JSR sub_DAC9_write_byte_to_ppu_buffer
C - - - - - 0x01DCBF 07:DCAF: A5 00     LDA ram_0000_temp
C - - - - - 0x01DCC1 07:DCB1: 29 E0     AND #$E0
C - - - - - 0x01DCC3 07:DCB3: 48        PHA
C - - - - - 0x01DCC4 07:DCB4: A5 00     LDA ram_0000_temp
C - - - - - 0x01DCC6 07:DCB6: 18        CLC
C - - - - - 0x01DCC7 07:DCB7: 69 01     ADC #$01
C - - - - - 0x01DCC9 07:DCB9: 29 1F     AND #$1F
C - - - - - 0x01DCCB 07:DCBB: 85 00     STA ram_0000_temp
C - - - - - 0x01DCCD 07:DCBD: 68        PLA
C - - - - - 0x01DCCE 07:DCBE: 05 00     ORA ram_0000_temp
C - - - - - 0x01DCD0 07:DCC0: 85 00     STA ram_0000_temp
C - - - - - 0x01DCD2 07:DCC2: C6 04     DEC ram_0004_temp
...
ofs_002_DCC7_0F:
; con_DA9D_0F
C - - J - - 0x01DCD7 07:DCC7: A5 05     LDA ram_0005_temp
C - - - - - 0x01DCD9 07:DCC9: 85 00     STA ram_0000_temp
C - - - - - 0x01DCDB 07:DCCB: A5 06     LDA ram_0006_temp
C - - - - - 0x01DCDD 07:DCCD: 85 01     STA ram_0001_temp
...
C - - - - - 0x01DD86 07:DD76: 85 0A     STA ram_000A_temp
C - - - - - 0x01DD88 07:DD78: A5 63     LDA ram_0063
C - - - - - 0x01DD8A 07:DD7A: E5 B7     SBC ram_00B7
C - - - - - 0x01DD8C 07:DD7C: 85 0B     STA ram_000B_temp
C - - - - - 0x01DD8E 07:DD7E: 10 13     BPL bra_DD93
C - - - - - 0x01DD90 07:DD80: A5 0A     LDA ram_000A_temp
C - - - - - 0x01DD92 07:DD82: 49 FF     EOR #$FF
C - - - - - 0x01DD94 07:DD84: 18        CLC
C - - - - - 0x01DD95 07:DD85: 69 01     ADC #< $0001
C - - - - - 0x01DD97 07:DD87: 85 0A     STA ram_000A_temp
C - - - - - 0x01DD99 07:DD89: A5 0B     LDA ram_000B_temp
C - - - - - 0x01DD9B 07:DD8B: 49 FF     EOR #$FF
C - - - - - 0x01DD9D 07:DD8D: 69 00     ADC #> $0001
C - - - - - 0x01DD9F 07:DD8F: 85 0B     STA ram_000B_temp
C - - - - - 0x01DDA1 07:DD91: A0 18     LDY #$18
bra_DD93:
C - - - - - 0x01DDA3 07:DD93: A5 0B     LDA ram_000B_temp
C - - - - - 0x01DDA5 07:DD95: D0 03     BNE bra_DD9A
C - - - - - 0x01DDA7 07:DD97: C4 0A     CPY ram_000A_temp
...
sub_DD9C:
C - - - - - 0x01DDAC 07:DD9C: A5 00     LDA ram_0000_temp
C - - - - - 0x01DDAE 07:DD9E: 85 BA     STA ram_00BA
C - - - - - 0x01DDB0 07:DDA0: A5 01     LDA ram_0001_temp
...
C - - - - - 0x01DDB7 07:DDA7: 85 02     STA ram_0002_temp
C - - - - - 0x01DDB9 07:DDA9: A5 DD     LDA ram_00DD
C - - - - - 0x01DDBB 07:DDAB: 85 03     STA ram_0003_temp
sub_0x01DDBD:
C - - - - - 0x01DDBD 07:DDAD: A5 02     LDA ram_0002_temp
C - - - - - 0x01DDBF 07:DDAF: 29 01     AND #$01
C - - - - - 0x01DDC1 07:DDB1: 85 02     STA ram_0002_temp
C - - - - - 0x01DDC3 07:DDB3: F0 12     BEQ bra_DDC7
C - - - - - 0x01DDC5 07:DDB5: A5 03     LDA ram_0003_temp
...
bra_DDC7:
C - - - - - 0x01DDD7 07:DDC7: A5 03     LDA ram_0003_temp
bra_DDC9:
...
C - - - - - 0x01DDE9 07:DDD9: 85 00     STA ram_0000_temp
C - - - - - 0x01DDEB 07:DDDB: B9 E2 DD  LDA tbl_DDE2,Y
C - - - - - 0x01DDEE 07:DDDE: 85 01     STA ram_0001_temp
...
sub_DDFF:
C - - - - - 0x01DE0F 07:DDFF: 85 02     STA ram_0002_temp
C - - - - - 0x01DE11 07:DE01: 18        CLC
C - - - - - 0x01DE12 07:DE02: 65 00     ADC ram_0000_temp
C - - - - - 0x01DE14 07:DE04: 85 00     STA ram_0000_temp
C - - - - - 0x01DE16 07:DE06: A5 01     LDA ram_0001_temp
C - - - - - 0x01DE18 07:DE08: 69 00     ADC #$00
C - - - - - 0x01DE1A 07:DE0A: 85 01     STA ram_0001_temp
C - - - - - 0x01DE1C 07:DE0C: 29 23     AND #$23
C - - - - - 0x01DE1E 07:DE0E: C9 23     CMP #$23
C - - - - - 0x01DE20 07:DE10: D0 11     BNE bra_DE23_RTS
C - - - - - 0x01DE22 07:DE12: A5 00     LDA ram_0000_temp
C - - - - - 0x01DE24 07:DE14: 38        SEC
C - - - - - 0x01DE25 07:DE15: E9 C0     SBC #$C0
C - - - - - 0x01DE27 07:DE17: 90 0A     BCC bra_DE23_RTS
C - - - - - 0x01DE29 07:DE19: 85 00     STA ram_0000_temp
C - - - - - 0x01DE2B 07:DE1B: A5 01     LDA ram_0001_temp
C - - - - - 0x01DE2D 07:DE1D: 49 0C     EOR #$0C
C - - - - - 0x01DE2F 07:DE1F: 29 2C     AND #$2C
C - - - - - 0x01DE31 07:DE21: 85 01     STA ram_0001_temp
bra_DE23_RTS:
...
C - - - - - 0x01DE3B 07:DE2B: 85 04     STA ram_0004_temp
C - - - - - 0x01DE3D 07:DE2D: 84 05     STY ram_0005_temp
...
C - - - - - 0x01DE48 07:DE38: A5 00     LDA ram_0000_temp
C - - - - - 0x01DE4A 07:DE3A: 20 24 DE  JSR sub_DE24
C - - - - - 0x01DE4D 07:DE3D: A5 01     LDA ram_0001_temp
C - - - - - 0x01DE4F 07:DE3F: 20 24 DE  JSR sub_DE24
C - - - - - 0x01DE52 07:DE42: A5 05     LDA ram_0005_temp
...
bra_DE4F:
C - - - - - 0x01DE5F 07:DE4F: A5 00     LDA ram_0000_temp
C - - - - - 0x01DE61 07:DE51: 85 02     STA ram_0002_temp
C - - - - - 0x01DE63 07:DE53: A5 01     LDA ram_0001_temp
C - - - - - 0x01DE65 07:DE55: 85 03     STA ram_0003_temp
...
bra_DE6A:
C - - - - - 0x01DE7A 07:DE6A: E6 04     INC ram_0004_temp
...
bra_DE88:
C - - - - - 0x01DE98 07:DE88: E6 04     INC ram_0004_temp
...
bra_DEA3:
C - - - - - 0x01DEB3 07:DEA3: E6 04     INC ram_0004_temp
...
loc_DED4:
C D 2 - - - 0x01DEE4 07:DED4: A4 04     LDY ram_0004_temp
...
C - - - - - 0x01DEF1 07:DEE1: 84 0F     STY ram_000F_temp
...
sub_DEF1:
C - - - - - 0x01DF01 07:DEF1: A4 0F     LDY ram_000F_temp
...
C - - - - - 0x01DF29 07:DF19: 84 08     STY ram_0008_temp
C - - - - - 0x01DF2B 07:DF1B: 84 09     STY ram_0009_temp
C - - - - - 0x01DF2D 07:DF1D: A5 04     LDA ram_0004_temp
...
bra_DF37:
C - - - - - 0x01DF47 07:DF37: A5 09     LDA ram_0009_temp
C - - - - - 0x01DF49 07:DF39: F0 02     BEQ bra_DF3D
C - - - - - 0x01DF4B 07:DF3B: A9 0A     LDA #$0A
bra_DF3D:
C - - - - - 0x01DF4D 07:DF3D: 85 09     STA ram_0009_temp
C - - - - - 0x01DF4F 07:DF3F: 20 24 DE  JSR sub_DE24
C - - - - - 0x01DF52 07:DF42: E6 08     INC ram_0008_temp
C - - - - - 0x01DF54 07:DF44: A5 08     LDA ram_0008_temp
...
sub_DF5C:
C - - - - - 0x01DF6C 07:DF5C: A4 0F     LDY ram_000F_temp
C - - - - - 0x01DF6E 07:DF5E: B9 A2 E0  LDA tbl_E0A2,Y
C - - - - - 0x01DF71 07:DF61: 85 08     STA ram_0008_temp
C - - - - - 0x01DF73 07:DF63: A5 05     LDA ram_0005_temp
...
C - - - - - 0x01DF7C 07:DF6C: 65 08     ADC ram_0008_temp
C - - - - - 0x01DF7E 07:DF6E: A8        TAY
C - - - - - 0x01DF7F 07:DF6F: A9 03     LDA #$03
C - - - - - 0x01DF81 07:DF71: 85 08     STA ram_0008_temp
bra_DF73_loop:
C - - - - - 0x01DF83 07:DF73: B9 A9 E0  LDA tbl_E0A9,Y
C - - - - - 0x01DF86 07:DF76: 20 24 DE  JSR sub_DE24
C - - - - - 0x01DF89 07:DF79: C6 06     DEC ram_0006_temp
C - - - - - 0x01DF8B 07:DF7B: C8        INY
C - - - - - 0x01DF8C 07:DF7C: C6 08     DEC ram_0008_temp
...
bra_DF89:
C - - - - - 0x01DF99 07:DF89: A4 0F     LDY ram_000F_temp
...
bra_DF97:
C - - - - - 0x01DFA7 07:DF97: 85 0A     STA ram_000A_temp
C - - - - - 0x01DFA9 07:DF99: A4 04     LDY ram_0004_temp
...
C - - - - - 0x01DFB8 07:DFA8: 85 0B     STA ram_000B_temp
C - - - - - 0x01DFBA 07:DFAA: A9 0A     LDA #$0A
C - - - - - 0x01DFBC 07:DFAC: 85 08     STA ram_0008_temp
C - - - - - 0x01DFBE 07:DFAE: A4 04     LDY ram_0004_temp
...
C - - - - - 0x01DFCA 07:DFBA: 84 0C     STY ram_000C_temp
bra_DFBC_loop:
C - - - - - 0x01DFCC 07:DFBC: A5 0A     LDA ram_000A_temp
C - - - - - 0x01DFCE 07:DFBE: 29 01     AND #$01
C - - - - - 0x01DFD0 07:DFC0: F0 18     BEQ bra_DFDA
C - - - - - 0x01DFD2 07:DFC2: A4 08     LDY ram_0008_temp
C - - - - - 0x01DFD4 07:DFC4: 88        DEY
C - - - - - 0x01DFD5 07:DFC5: A5 0B     LDA ram_000B_temp
...
bra_DFDA:
C - - - - - 0x01DFEA 07:DFDA: A4 0C     LDY ram_000C_temp
C - - - - - 0x01DFEC 07:DFDC: A5 0B     LDA ram_000B_temp
...
C - - - - - 0x01E002 07:DFF2: E6 0C     INC ram_000C_temp
C - - - - - 0x01E004 07:DFF4: C6 0B     DEC ram_000B_temp
C - - - - - 0x01E006 07:DFF6: A5 08     LDA ram_0008_temp
C - - - - - 0x01E008 07:DFF8: 29 01     AND #$01
C - - - - - 0x01E00A 07:DFFA: F0 02     BEQ bra_DFFE
C - - - - - 0x01E00C 07:DFFC: 46 0A     LSR ram_000A_temp
bra_DFFE:
C - - - - - 0x01E00E 07:DFFE: C6 08     DEC ram_0008_temp
...
C - - - - - 0x01E03F 07:E02F: 85 08     STA ram_0008_temp
C - - - - - 0x01E041 07:E031: A4 0F     LDY ram_000F_temp
...
C - - - - - 0x01E04E 07:E03E: C6 08     DEC ram_0008_temp
...
C - - - - - 0x01E05C 07:E04C: A4 04     LDY ram_0004_temp
...
C - - - - - 0x01E067 07:E057: A5 0A     LDA ram_000A_temp
...
C - - - - - 0x01E076 07:E066: A5 0A     LDA ram_000A_temp
...
C - - - - - 0x01E138 07:E128: 85 00     STA ram_0000_temp
C - - - - - 0x01E13A 07:E12A: A5 B9     LDA ram_00B9
C - - - - - 0x01E13C 07:E12C: 85 01     STA ram_0001_temp
...
loc_E132:
C D 3 - - - 0x01E142 07:E132: A4 00     LDY ram_0000_temp
C - - - - - 0x01E144 07:E134: A5 01     LDA ram_0001_temp
C - - - - - 0x01E146 07:E136: 29 03     AND #$03
C - - - - - 0x01E148 07:E138: C9 03     CMP #$03
C - - - - - 0x01E14A 07:E13A: 85 02     STA ram_0002_temp
...
C - - - - - 0x01E15A 07:E14A: A5 02     LDA ram_0002_temp
C - - - - - 0x01E15C 07:E14C: 18        CLC
C - - - - - 0x01E15D 07:E14D: 69 08     ADC #$08
C - - - - - 0x01E15F 07:E14F: 85 02     STA ram_0002_temp
C - - - - - 0x01E161 07:E151: 90 24     BCC bra_E177
C - - - - - 0x01E163 07:E153: 09 C0     ORA #$C0
C - - - - - 0x01E165 07:E155: 85 02     STA ram_0002_temp
C - - - - - 0x01E167 07:E157: A5 03     LDA ram_0003_temp
C - - - - - 0x01E169 07:E159: 49 0C     EOR #$0C
C - - - - - 0x01E16B 07:E15B: 29 2F     AND #$2F
C - - - - - 0x01E16D 07:E15D: 85 03     STA ram_0003_temp
C - - - - - 0x01E16F 07:E15F: D0 16     BNE bra_E177
bra_E161:
sub_E161:
C - - - - - 0x01E171 07:E161: A5 00     LDA ram_0000_temp
C - - - - - 0x01E173 07:E163: 29 80     AND #$80
C - - - - - 0x01E175 07:E165: 46 02     LSR ram_0002_temp
C - - - - - 0x01E177 07:E167: 6A        ROR
C - - - - - 0x01E178 07:E168: 46 02     LSR ram_0002_temp
C - - - - - 0x01E17A 07:E16A: 6A        ROR
C - - - - - 0x01E17B 07:E16B: 4A        LSR
C - - - - - 0x01E17C 07:E16C: 4A        LSR
C - - - - - 0x01E17D 07:E16D: 09 C0     ORA #$C0
C - - - - - 0x01E17F 07:E16F: 85 02     STA ram_0002_temp
C - - - - - 0x01E181 07:E171: A5 01     LDA ram_0001_temp
C - - - - - 0x01E183 07:E173: 09 03     ORA #$03
C - - - - - 0x01E185 07:E175: 85 03     STA ram_0003_temp
bra_E177:
C - - - - - 0x01E187 07:E177: A9 08     LDA #$08
loc_E179:
C D 3 - - - 0x01E189 07:E179: 85 04     STA ram_0004_temp
C - - - - - 0x01E18B 07:E17B: A9 03     LDA #$03
C - - - - - 0x01E18D 07:E17D: 20 24 DE  JSR sub_DE24
C - - - - - 0x01E190 07:E180: A5 02     LDA ram_0002_temp
C - - - - - 0x01E192 07:E182: 20 24 DE  JSR sub_DE24
C - - - - - 0x01E195 07:E185: A5 03     LDA ram_0003_temp
C - - - - - 0x01E197 07:E187: 20 24 DE  JSR sub_DE24
C - - - - - 0x01E19A 07:E18A: A5 04     LDA ram_0004_temp
...
C - - - - - 0x01E1A9 07:E199: 85 16     STA ram_0016_temp
C - - - - - 0x01E1AB 07:E19B: A0 00     LDY #$00
C - - - - - 0x01E1AD 07:E19D: 84 0D     STY ram_000D_temp
C - - - - - 0x01E1AF 07:E19F: A5 1D     LDA ram_001D_temp
...
C - - - - - 0x01E1DB 07:E1CB: 85 05     STA ram_0005_temp
C - - - - - 0x01E1DD 07:E1CD: A9 00     LDA #$00
C - - - - - 0x01E1DF 07:E1CF: A4 69     LDY ram_0069
C - - - - - 0x01E1E1 07:E1D1: 10 04     BPL bra_E1D7
C - - - - - 0x01E1E3 07:E1D3: C6 05     DEC ram_0005_temp
C - - - - - 0x01E1E5 07:E1D5: A9 08     LDA #$08
bra_E1D7:
C - - - - - 0x01E1E7 07:E1D7: 85 03     STA ram_0003_temp
C - - - - - 0x01E1E9 07:E1D9: A5 61     LDA ram_0061
C - - - - - 0x01E1EB 07:E1DB: 29 F8     AND #$F8
C - - - - - 0x01E1ED 07:E1DD: 18        CLC
C - - - - - 0x01E1EE 07:E1DE: 65 03     ADC ram_0003_temp
C - - - - - 0x01E1F0 07:E1E0: 85 03     STA ram_0003_temp
C - - - - - 0x01E1F2 07:E1E2: A5 60     LDA ram_0060
C - - - - - 0x01E1F4 07:E1E4: 65 05     ADC ram_0005_temp
C - - - - - 0x01E1F6 07:E1E6: 85 05     STA ram_0005_temp
...
C - - - - - 0x01E210 07:E200: 84 07     STY ram_0007_temp
...
C - - - - - 0x01E21B 07:E20B: A5 06     LDA ram_0006_temp
C - - - - - 0x01E21D 07:E20D: F0 1A     BEQ bra_E229
C - - - - - 0x01E21F 07:E20F: 20 29 E2  JSR sub_E229
C - - - - - 0x01E222 07:E212: 20 54 E3  JSR sub_E354
C - - - - - 0x01E225 07:E215: A5 07     LDA ram_0007_temp
C - - - - - 0x01E227 07:E217: 18        CLC
C - - - - - 0x01E228 07:E218: 65 0B     ADC ram_000B_temp
C - - - - - 0x01E22A 07:E21A: 85 07     STA ram_0007_temp
...
C - - - - - 0x01E241 07:E231: 85 02     STA ram_0002_temp
C - - - - - 0x01E243 07:E233: A5 63     LDA ram_0063
C - - - - - 0x01E245 07:E235: E9 00     SBC #> $0028
C - - - - - 0x01E247 07:E237: 85 04     STA ram_0004_temp
C - - - - - 0x01E249 07:E239: 10 06     BPL bra_E241_RTS
C - - - - - 0x01E24B 07:E23B: A9 00     LDA #$00
C - - - - - 0x01E24D 07:E23D: 85 02     STA ram_0002_temp
C - - - - - 0x01E24F 07:E23F: 85 04     STA ram_0004_temp
bra_E241_RTS:
...
C - - - - - 0x01E256 07:E246: 85 16     STA ram_0016_temp
C - - - - - 0x01E258 07:E248: A9 01     LDA #$01
C - - - - - 0x01E25A 07:E24A: 85 0D     STA ram_000D_temp
C - - - - - 0x01E25C 07:E24C: A5 A4     LDA ram_00A4
C - - - - - 0x01E25E 07:E24E: 85 02     STA ram_0002_temp
C - - - - - 0x01E260 07:E250: A5 A3     LDA ram_00A3
C - - - - - 0x01E262 07:E252: 85 04     STA ram_0004_temp
C - - - - - 0x01E264 07:E254: A5 A1     LDA ram_00A1
C - - - - - 0x01E266 07:E256: 18        CLC
C - - - - - 0x01E267 07:E257: 65 16     ADC ram_0016_temp
C - - - - - 0x01E269 07:E259: 85 03     STA ram_0003_temp
C - - - - - 0x01E26B 07:E25B: A5 A0     LDA ram_00A0
C - - - - - 0x01E26D 07:E25D: 65 0D     ADC ram_000D_temp
C - - - - - 0x01E26F 07:E25F: 85 05     STA ram_0005_temp
...
C - - - - - 0x01E2EF 07:E2DF: 84 07     STY ram_0007_temp
...
C - - - - - 0x01E310 07:E300: A5 0A     LDA ram_000A_temp
...
C - - - - - 0x01E322 07:E312: C4 0A     CPY ram_000A_temp
...
C - - - - - 0x01E32E 07:E31E: A5 0E     LDA ram_000E_temp
C - - - - - 0x01E330 07:E320: 20 C9 DA  JSR sub_DAC9_write_byte_to_ppu_buffer
C - - - - - 0x01E333 07:E323: A5 0F     LDA ram_000F_temp
...
C - - - - - 0x01E354 07:E344: A5 07     LDA ram_0007_temp
C - - - - - 0x01E356 07:E346: 18        CLC
C - - - - - 0x01E357 07:E347: 65 0B     ADC ram_000B_temp
C - - - - - 0x01E359 07:E349: 85 07     STA ram_0007_temp
...
C - - - - - 0x01E366 07:E356: 85 0A     STA ram_000A_temp
C - - - - - 0x01E368 07:E358: A5 14     LDA ram_0014_temp
C - - - - - 0x01E36A 07:E35A: 29 C7     AND #$C7
C - - - - - 0x01E36C 07:E35C: 85 14     STA ram_0014_temp
C - - - - - 0x01E36E 07:E35E: A5 15     LDA ram_0015_temp
C - - - - - 0x01E370 07:E360: 49 0C     EOR #$0C
C - - - - - 0x01E372 07:E362: 29 2F     AND #$2F
C - - - - - 0x01E374 07:E364: 85 15     STA ram_0015_temp
C - - - - - 0x01E376 07:E366: A5 0E     LDA ram_000E_temp
C - - - - - 0x01E378 07:E368: 29 1F     AND #$1F
C - - - - - 0x01E37A 07:E36A: 85 0E     STA ram_000E_temp
C - - - - - 0x01E37C 07:E36C: A5 0F     LDA ram_000F_temp
C - - - - - 0x01E37E 07:E36E: 49 0C     EOR #$0C
C - - - - - 0x01E380 07:E370: 29 2C     AND #$2C
C - - - - - 0x01E382 07:E372: 85 0F     STA ram_000F_temp
...
C - - - - - 0x01E38C 07:E37C: A5 02     LDA ram_0002_temp
C - - - - - 0x01E38E 07:E37E: 29 07     AND #$07
C - - - - - 0x01E390 07:E380: 85 02     STA ram_0002_temp
C - - - - - 0x01E392 07:E382: E6 04     INC ram_0004_temp
...
C - - - - - 0x01E39A 07:E38A: 65 16     ADC ram_0016_temp
C - - - - - 0x01E39C 07:E38C: 85 03     STA ram_0003_temp
C - - - - - 0x01E39E 07:E38E: A5 60     LDA ram_0060
C - - - - - 0x01E3A0 07:E390: 65 0D     ADC ram_000D_temp
C - - - - - 0x01E3A2 07:E392: 85 05     STA ram_0005_temp
...
C - - - - - 0x01E3A9 07:E399: 85 0D     STA ram_000D_temp
C - - - - - 0x01E3AB 07:E39B: A9 70     LDA #$70
C - - - - - 0x01E3AD 07:E39D: 85 16     STA ram_0016_temp
C - - - - - 0x01E3AF 07:E39F: A5 02     LDA ram_0002_temp
C - - - - - 0x01E3B1 07:E3A1: 18        CLC
C - - - - - 0x01E3B2 07:E3A2: 65 16     ADC ram_0016_temp
C - - - - - 0x01E3B4 07:E3A4: 85 02     STA ram_0002_temp
C - - - - - 0x01E3B6 07:E3A6: A5 04     LDA ram_0004_temp
C - - - - - 0x01E3B8 07:E3A8: 65 0D     ADC ram_000D_temp
C - - - - - 0x01E3BA 07:E3AA: 85 04     STA ram_0004_temp
...
sub_E3B5:
C - - - - - 0x01E3C5 07:E3B5: A5 03     LDA ram_0003_temp
C - - - - - 0x01E3C7 07:E3B7: 18        CLC
C - - - - - 0x01E3C8 07:E3B8: 65 16     ADC ram_0016_temp
C - - - - - 0x01E3CA 07:E3BA: 85 03     STA ram_0003_temp
C - - - - - 0x01E3CC 07:E3BC: A5 05     LDA ram_0005_temp
C - - - - - 0x01E3CE 07:E3BE: 65 0D     ADC ram_000D_temp
C - - - - - 0x01E3D0 07:E3C0: 85 05     STA ram_0005_temp
...
C - - - - - 0x01E3D5 07:E3C5: 85 0D     STA ram_000D_temp
C - - - - - 0x01E3D7 07:E3C7: 85 16     STA ram_0016_temp
C - - - - - 0x01E3D9 07:E3C9: A5 69     LDA ram_0069
C - - - - - 0x01E3DB 07:E3CB: 30 04     BMI bra_E3D1_RTS
C - - - - - 0x01E3DD 07:E3CD: A9 08     LDA #$08
C - - - - - 0x01E3DF 07:E3CF: 85 16     STA ram_0016_temp
bra_E3D1_RTS:
...
C - - - - - 0x01E43B 07:E42B: 84 07     STY ram_0007_temp
...
C - - - - - 0x01E465 07:E455: A5 03     LDA ram_0003_temp
C - - - - - 0x01E467 07:E457: 29 07     AND #$07
C - - - - - 0x01E469 07:E459: 85 03     STA ram_0003_temp
C - - - - - 0x01E46B 07:E45B: E6 05     INC ram_0005_temp
C - - - - - 0x01E46D 07:E45D: 20 75 E4  JSR sub_E475
C - - - - - 0x01E470 07:E460: A4 07     LDY ram_0007_temp
C - - - - - 0x01E472 07:E462: C8        INY
C - - - - - 0x01E473 07:E463: D0 02     BNE bra_E467
- - - - - - 0x01E475 07:E465: E6 3B     INC ram_003B_temp
bra_E467:
C - - - - - 0x01E477 07:E467: 84 07     STY ram_0007_temp
...
C - - - - - 0x01E48A 07:E47A: A5 0E     LDA ram_000E_temp
C - - - - - 0x01E48C 07:E47C: 20 C9 DA  JSR sub_DAC9_write_byte_to_ppu_buffer
C - - - - - 0x01E48F 07:E47F: A5 0F     LDA ram_000F_temp
...
C - - - - - 0x01E4A0 07:E490: A5 15     LDA ram_0015_temp
C - - - - - 0x01E4A2 07:E492: 20 CE DA  JSR sub_DACE
C - - - - - 0x01E4A5 07:E495: A9 00     LDA #$00
C - - - - - 0x01E4A7 07:E497: 20 CE DA  JSR sub_DACE
C - - - - - 0x01E4AA 07:E49A: 84 0A     STY ram_000A_temp
C - - - - - 0x01E4AC 07:E49C: 60        RTS



sub_E49D:
C - - - - - 0x01E4AD 07:E49D: 85 06     STA ram_0006_temp
C - - - - - 0x01E4AF 07:E49F: A5 0E     LDA ram_000E_temp
C - - - - - 0x01E4B1 07:E4A1: 4A        LSR
C - - - - - 0x01E4B2 07:E4A2: 4A        LSR
C - - - - - 0x01E4B3 07:E4A3: 29 07     AND #$07
C - - - - - 0x01E4B5 07:E4A5: 85 15     STA ram_0015_temp
C - - - - - 0x01E4B7 07:E4A7: 85 0D     STA ram_000D_temp
C - - - - - 0x01E4B9 07:E4A9: A5 0F     LDA ram_000F_temp
C - - - - - 0x01E4BB 07:E4AB: 29 03     AND #$03
C - - - - - 0x01E4BD 07:E4AD: 85 14     STA ram_0014_temp
C - - - - - 0x01E4BF 07:E4AF: A5 0E     LDA ram_000E_temp
...
C - - - - - 0x01E506 07:E4F6: A5 05     LDA ram_0005_temp
...
C - - - - - 0x01E510 07:E500: 85 0F     STA ram_000F_temp
C - - - - - 0x01E512 07:E502: A5 03     LDA ram_0003_temp
C - - - - - 0x01E514 07:E504: 4A        LSR
C - - - - - 0x01E515 07:E505: 4A        LSR
C - - - - - 0x01E516 07:E506: 4A        LSR
C - - - - - 0x01E517 07:E507: 85 0E     STA ram_000E_temp
C - - - - - 0x01E519 07:E509: 60        RTS
bra_E50A:
C - - - - - 0x01E51A 07:E50A: A5 04     LDA ram_0004_temp
C - - - - - 0x01E51C 07:E50C: 0A        ASL
C - - - - - 0x01E51D 07:E50D: A8        TAY
C - - - - - 0x01E51E 07:E50E: B9 B6 F5  LDA tbl_F5B6,Y
C - - - - - 0x01E521 07:E511: 85 15     STA ram_0015_temp
C - - - - - 0x01E523 07:E513: A5 02     LDA ram_0002_temp
C - - - - - 0x01E525 07:E515: 85 0E     STA ram_000E_temp
C - - - - - 0x01E527 07:E517: 38        SEC
C - - - - - 0x01E528 07:E518: E9 F0     SBC #$F0
C - - - - - 0x01E52A 07:E51A: 90 04     BCC bra_E520
C - - - - - 0x01E52C 07:E51C: 85 0E     STA ram_000E_temp
C - - - - - 0x01E52E 07:E51E: E6 15     INC ram_0015_temp
bra_E520:
C - - - - - 0x01E530 07:E520: A5 0E     LDA ram_000E_temp
...
C - - - - - 0x01E53B 07:E52B: E6 15     INC ram_0015_temp
bra_E52D:
C - - - - - 0x01E53D 07:E52D: 85 0E     STA ram_000E_temp
C - - - - - 0x01E53F 07:E52F: 38        SEC
C - - - - - 0x01E540 07:E530: E9 F0     SBC #$F0
C - - - - - 0x01E542 07:E532: 90 04     BCC bra_E538
C - - - - - 0x01E544 07:E534: 85 0E     STA ram_000E_temp
C - - - - - 0x01E546 07:E536: E6 15     INC ram_0015_temp
bra_E538:
C - - - - - 0x01E548 07:E538: A5 0E     LDA ram_000E_temp
C - - - - - 0x01E54A 07:E53A: 85 02     STA ram_0002_temp
C - - - - - 0x01E54C 07:E53C: 29 F8     AND #$F8
C - - - - - 0x01E54E 07:E53E: 85 0E     STA ram_000E_temp
C - - - - - 0x01E550 07:E540: A9 00     LDA #$00
C - - - - - 0x01E552 07:E542: 06 0E     ASL ram_000E_temp
C - - - - - 0x01E554 07:E544: 2A        ROL
C - - - - - 0x01E555 07:E545: 06 0E     ASL ram_000E_temp
C - - - - - 0x01E557 07:E547: 2A        ROL
C - - - - - 0x01E558 07:E548: 85 0F     STA ram_000F_temp
C - - - - - 0x01E55A 07:E54A: A5 15     LDA ram_0015_temp
C - - - - - 0x01E55C 07:E54C: 85 04     STA ram_0004_temp
...
C - - - - - 0x01E566 07:E556: 05 0F     ORA ram_000F_temp
C - - - - - 0x01E568 07:E558: 85 0F     STA ram_000F_temp
C - - - - - 0x01E56A 07:E55A: A5 03     LDA ram_0003_temp
C - - - - - 0x01E56C 07:E55C: 4A        LSR
C - - - - - 0x01E56D 07:E55D: 4A        LSR
C - - - - - 0x01E56E 07:E55E: 4A        LSR
C - - - - - 0x01E56F 07:E55F: 05 0E     ORA ram_000E_temp
C - - - - - 0x01E571 07:E561: 85 0E     STA ram_000E_temp
...
C - - - - - 0x01E57B 07:E56B: B1 3A     LDA (ram_003A_temp),Y
C - - - - - 0x01E57D 07:E56D: 85 0B     STA ram_000B_temp
C - - - - - 0x01E57F 07:E56F: C8        INY
C - - - - - 0x01E580 07:E570: B1 3A     LDA (ram_003A_temp),Y
C - - - - - 0x01E582 07:E572: 85 0C     STA ram_000C_temp
...
C - - - - - 0x01E58C 07:E57C: A4 04     LDY ram_0004_temp
C - - - - - 0x01E58E 07:E57E: F0 0A     BEQ bra_E58A
C - - - - - 0x01E590 07:E580: 18        CLC
bra_E581_loop:
C - - - - - 0x01E591 07:E581: 65 0B     ADC ram_000B_temp
...
C - - - - - 0x01E59B 07:E58B: 65 05     ADC ram_0005_temp
...
C - - - - - 0x01E5AC 07:E59C: A4 04     LDY ram_0004_temp
C - - - - - 0x01E5AE 07:E59E: F0 EA     BEQ bra_E58A
C - - - - - 0x01E5B0 07:E5A0: 18        CLC
bra_E5A1_loop:
C - - - - - 0x01E5B1 07:E5A1: 65 0B     ADC ram_000B_temp
...
sub_E5AE:
C - - - - - 0x01E5BE 07:E5AE: A4 07     LDY ram_0007_temp
...
bra_E5C3:
C - - - - - 0x01E5D3 07:E5C3: A4 07     LDY ram_0007_temp
...
C - - - - - 0x01E5DB 07:E5CB: 85 3A     STA ram_003A_temp
C - - - - - 0x01E5DD 07:E5CD: B9 D4 E5  LDA tbl_E5D3 + $01,Y
C - - - - - 0x01E5E0 07:E5D0: 85 3B     STA ram_003B_temp
...
bra_E81C:
C - - - - - 0x01E82C 07:E81C: A4 05     LDY ram_0005_temp
C - - - - - 0x01E82E 07:E81E: 20 5E E9  JSR sub_E95E
C - - - - - 0x01E831 07:E821: A5 02     LDA ram_0002_temp
C - - - - - 0x01E833 07:E823: 4A        LSR
C - - - - - 0x01E834 07:E824: 4A        LSR
C - - - - - 0x01E835 07:E825: 4A        LSR
C - - - - - 0x01E836 07:E826: 85 11     STA ram_0011_temp
C - - - - - 0x01E838 07:E828: 29 1C     AND #$1C
C - - - - - 0x01E83A 07:E82A: 0A        ASL
C - - - - - 0x01E83B 07:E82B: 0A        ASL
C - - - - - 0x01E83C 07:E82C: 05 00     ORA ram_0000_temp
C - - - - - 0x01E83E 07:E82E: 85 00     STA ram_0000_t20_data
C - - - - - 0x01E840 07:E830: A9 04     LDA #$04
C - - - - - 0x01E842 07:E832: 85 01     STA ram_0001_temp
...
C - - - - - 0x01E859 07:E849: A5 02     LDA ram_0002_temp
...
bra_E85F:
C - - - - - 0x01E86F 07:E85F: A5 02     LDA ram_0002_temp
C - - - - - 0x01E871 07:E861: 29 18     AND #$18
C - - - - - 0x01E873 07:E863: D0 B7     BNE bra_E81C
bra_E865:
C - - - - - 0x01E875 07:E865: 20 0D EB  JSR sub_EB0D
C - - - - - 0x01E878 07:E868: A5 02     LDA ram_0002_temp
C - - - - - 0x01E87A 07:E86A: 4A        LSR
C - - - - - 0x01E87B 07:E86B: 4A        LSR
C - - - - - 0x01E87C 07:E86C: 4A        LSR
C - - - - - 0x01E87D 07:E86D: 85 11     STA ram_0011_temp
C - - - - - 0x01E87F 07:E86F: 29 1C     AND #$1C
C - - - - - 0x01E881 07:E871: 0A        ASL
C - - - - - 0x01E882 07:E872: 18        CLC
C - - - - - 0x01E883 07:E873: 65 00     ADC ram_0000_temp
C - - - - - 0x01E885 07:E875: 85 00     STA ram_0000_t20_data
C - - - - - 0x01E887 07:E877: A5 01     LDA ram_0001_temp
C - - - - - 0x01E889 07:E879: 69 00     ADC #$00
C - - - - - 0x01E88B 07:E87B: 85 01     STA ram_0001_temp
loc_E87D:
C D 3 - - - 0x01E88D 07:E87D: A5 03     LDA ram_0003_temp
C - - - - - 0x01E88F 07:E87F: 4A        LSR
C - - - - - 0x01E890 07:E880: 4A        LSR
C - - - - - 0x01E891 07:E881: 4A        LSR
C - - - - - 0x01E892 07:E882: 85 10     STA ram_0010_temp
...
C - - - - - 0x01E89B 07:E88B: 85 1C     STA ram_001C_temp
C - - - - - 0x01E89D 07:E88D: B9 A5 E8  LDA tbl_E8A4 + $01,Y
C - - - - - 0x01E8A0 07:E890: 85 1D     STA ram_001D_temp
C - - - - - 0x01E8A2 07:E892: A5 10     LDA ram_0010_temp
C - - - - - 0x01E8A4 07:E894: 29 03     AND #$03
C - - - - - 0x01E8A6 07:E896: 85 10     STA ram_0010_temp
C - - - - - 0x01E8A8 07:E898: A5 11     LDA ram_0011_temp
C - - - - - 0x01E8AA 07:E89A: 29 03     AND #$03
C - - - - - 0x01E8AC 07:E89C: 85 11     STA ram_0011_temp
C - - - - - 0x01E8AE 07:E89E: 20 B5 ED  JSR sub_EDB5
C - - - - - 0x01E8B1 07:E8A1: 6C 1C 00  JMP (ram_001C_temp)
...
loc_E8EB:
C D 3 - - - 0x01E8FB 07:E8EB: A4 05     LDY ram_0005_temp
C - - - - - 0x01E8FD 07:E8ED: 20 5E E9  JSR sub_E95E
C - - - - - 0x01E900 07:E8F0: 20 74 E9  JSR sub_E974
C - - - - - 0x01E903 07:E8F3: 05 00     ORA ram_0000_temp
C - - - - - 0x01E905 07:E8F5: 85 00     STA ram_0000_t01_data
C - - - - - 0x01E907 07:E8F7: A9 04     LDA #$04
C - - - - - 0x01E909 07:E8F9: 85 01     STA ram_0001_temp
; bzk optimize, all those calculations only to always come up with ram_0400
loc_E8FB:
C D 3 - - - 0x01E90B 07:E8FB: B9 17 E9  LDA tbl_E917,Y
C - - - - - 0x01E90E 07:E8FE: 85 1C     STA ram_001C_temp
C - - - - - 0x01E910 07:E900: B9 18 E9  LDA tbl_E917 + $01,Y
C - - - - - 0x01E913 07:E903: 85 1D     STA ram_001D_temp
C - - - - - 0x01E915 07:E905: A5 10     LDA ram_0010_temp
C - - - - - 0x01E917 07:E907: 29 03     AND #$03
C - - - - - 0x01E919 07:E909: 85 10     STA ram_0010_temp
C - - - - - 0x01E91B 07:E90B: A5 11     LDA ram_0011_temp
C - - - - - 0x01E91D 07:E90D: 29 03     AND #$03
C - - - - - 0x01E91F 07:E90F: 85 11     STA ram_0011_temp
C - - - - - 0x01E921 07:E911: 20 B5 ED  JSR sub_EDB5
C - - - - - 0x01E924 07:E914: 6C 1C 00  JMP (ram_001C_temp)
...
C - - - - - 0x01E9C4 07:E9B4: A5 03     LDA ram_0003_temp
...
bra_EA12:
C - - - - - 0x01EA22 07:EA12: A4 05     LDY ram_0005_temp
C - - - - - 0x01EA24 07:EA14: 88        DEY
C - - - - - 0x01EA25 07:EA15: 20 5E E9  JSR sub_E95E
loc_EA18:
C D 3 - - - 0x01EA28 07:EA18: A5 00     LDA ram_0000_temp
C - - - - - 0x01EA2A 07:EA1A: 85 1A     STA ram_001A_temp
C - - - - - 0x01EA2C 07:EA1C: A5 01     LDA ram_0001_temp
C - - - - - 0x01EA2E 07:EA1E: 85 1B     STA ram_001B_temp
C - - - - - 0x01EA30 07:EA20: A4 05     LDY ram_0005_temp
C - - - - - 0x01EA32 07:EA22: 20 5E E9  JSR sub_E95E
C - - - - - 0x01EA35 07:EA25: 20 74 E9  JSR sub_E974
C - - - - - 0x01EA38 07:EA28: 48        PHA
C - - - - - 0x01EA39 07:EA29: 05 00     ORA ram_0000_temp
C - - - - - 0x01EA3B 07:EA2B: 85 00     STA ram_0000_t01_data
C - - - - - 0x01EA3D 07:EA2D: 68        PLA
C - - - - - 0x01EA3E 07:EA2E: 05 1A     ORA ram_001A_temp
C - - - - - 0x01EA40 07:EA30: 85 1A     STA ram_001A_temp
C - - - - - 0x01EA42 07:EA32: A9 04     LDA #$04
C - - - - - 0x01EA44 07:EA34: 85 01     STA ram_0001_temp
C - - - - - 0x01EA46 07:EA36: 85 1B     STA ram_001B_temp
...
C - - - - - 0x01EA59 07:EA49: A5 03     LDA ram_0003_temp
...
bra_EA58:
C - - - - - 0x01EA68 07:EA58: A5 03     LDA ram_0003_temp
...
loc_EA62:
C D 3 - - - 0x01EA72 07:EA62: A5 00     LDA ram_0000_temp
C - - - - - 0x01EA74 07:EA64: 85 1A     STA ram_001A_temp
C - - - - - 0x01EA76 07:EA66: A5 01     LDA ram_0001_temp
C - - - - - 0x01EA78 07:EA68: 85 1B     STA ram_001B_temp
C - - - - - 0x01EA7A 07:EA6A: A4 07     LDY ram_0007_temp
C - - - - - 0x01EA7C 07:EA6C: 20 0D EB  JSR sub_EB0D
C - - - - - 0x01EA7F 07:EA6F: A5 02     LDA ram_0002_temp
C - - - - - 0x01EA81 07:EA71: 4A        LSR
C - - - - - 0x01EA82 07:EA72: 4A        LSR
C - - - - - 0x01EA83 07:EA73: 4A        LSR
C - - - - - 0x01EA84 07:EA74: 85 11     STA ram_0011_temp
C - - - - - 0x01EA86 07:EA76: 4A        LSR
C - - - - - 0x01EA87 07:EA77: 29 0E     AND #$0E
C - - - - - 0x01EA89 07:EA79: A8        TAY
C - - - - - 0x01EA8A 07:EA7A: A5 03     LDA ram_0003_temp
C - - - - - 0x01EA8C 07:EA7C: 4A        LSR
C - - - - - 0x01EA8D 07:EA7D: 4A        LSR
C - - - - - 0x01EA8E 07:EA7E: 4A        LSR
C - - - - - 0x01EA8F 07:EA7F: 85 10     STA ram_0010_temp
...
C - - - - - 0x01EA97 07:EA87: 65 00     ADC ram_0000_temp
C - - - - - 0x01EA99 07:EA89: 85 00     STA ram_0000_t19_data
C - - - - - 0x01EA9B 07:EA8B: A5 01     LDA ram_0001_temp
C - - - - - 0x01EA9D 07:EA8D: 69 00     ADC #$00
C - - - - - 0x01EA9F 07:EA8F: 85 01     STA ram_0000_t19_data + $01
C - - - - - 0x01EAA1 07:EA91: 68        PLA
C - - - - - 0x01EAA2 07:EA92: 18        CLC
C - - - - - 0x01EAA3 07:EA93: 65 1A     ADC ram_001A_temp
C - - - - - 0x01EAA5 07:EA95: 85 1A     STA ram_001A_temp
C - - - - - 0x01EAA7 07:EA97: A5 1B     LDA ram_001B_temp
C - - - - - 0x01EAA9 07:EA99: 69 00     ADC #$00
C - - - - - 0x01EAAB 07:EA9B: 85 1B     STA ram_001B_temp
C - - - - - 0x01EAAD 07:EA9D: B9 BE EA  LDA tbl_EABE,Y
C - - - - - 0x01EAB0 07:EAA0: 85 1C     STA ram_001C_temp
C - - - - - 0x01EAB2 07:EAA2: B9 BF EA  LDA tbl_EABE + $01,Y
C - - - - - 0x01EAB5 07:EAA5: 85 1D     STA ram_001D_temp
C - - - - - 0x01EAB7 07:EAA7: A5 10     LDA ram_0010_temp
C - - - - - 0x01EAB9 07:EAA9: 29 03     AND #$03
C - - - - - 0x01EABB 07:EAAB: 85 10     STA ram_0010_temp
C - - - - - 0x01EABD 07:EAAD: A5 11     LDA ram_0011_temp
C - - - - - 0x01EABF 07:EAAF: 29 03     AND #$03
C - - - - - 0x01EAC1 07:EAB1: 85 11     STA ram_0011_temp
C - - - - - 0x01EAC3 07:EAB3: 20 B5 ED  JSR sub_EDB5
C - - - - - 0x01EAC6 07:EAB6: A9 01     LDA #$01
C - - - - - 0x01EAC8 07:EAB8: 8D 53 03  STA ram_0353
C - - - - - 0x01EACB 07:EABB: 6C 1C 00  JMP (ram_001C_temp)
...
C - - - - - 0x01EB1F 07:EB0F: 85 00     STA ram_0000_temp
C - - - - - 0x01EB21 07:EB11: B1 3A     LDA (ram_003A_temp),Y
C - - - - - 0x01EB23 07:EB13: 4A        LSR
C - - - - - 0x01EB24 07:EB14: 66 00     ROR ram_0000_temp
C - - - - - 0x01EB26 07:EB16: 4A        LSR
C - - - - - 0x01EB27 07:EB17: 66 00     ROR ram_0000_temp
C - - - - - 0x01EB29 07:EB19: 85 01     STA ram_0001_temp
C - - - - - 0x01EB2B 07:EB1B: A4 88     LDY ram_x2_stage
C - - - - - 0x01EB2D 07:EB1D: B9 61 DA  LDA tbl_DA61,Y
C - - - - - 0x01EB30 07:EB20: 18        CLC
C - - - - - 0x01EB31 07:EB21: 65 00     ADC ram_0000_temp
C - - - - - 0x01EB33 07:EB23: 85 00     STA ram_0000_temp
C - - - - - 0x01EB35 07:EB25: B9 62 DA  LDA tbl_DA61 + $01,Y
C - - - - - 0x01EB38 07:EB28: 65 01     ADC ram_0001_temp
C - - - - - 0x01EB3A 07:EB2A: 85 01     STA ram_0001_temp
C - - - - - 0x01EB3C 07:EB2C: 60        RTS
bra_EB2D:
C - - - - - 0x01EB3D 07:EB2D: A4 0D     LDY ram_000D_temp
C - - - - - 0x01EB3F 07:EB2F: 46 0D     LSR ram_000D_temp
...
bra_EB34:
sub_EB34:
C - - - - - 0x01EB44 07:EB34: 84 0D     STY ram_000D_temp
C - - - - - 0x01EB46 07:EB36: B1 00     LDA (ram_0000_t19_data),Y
C - - - - - 0x01EB48 07:EB38: 85 13     STA ram_0013_temp
C - - - - - 0x01EB4A 07:EB3A: 20 78 ED  JSR sub_ED78
C - - - - - 0x01EB4D 07:EB3D: A4 0D     LDY ram_000D_temp
loc_EB3F:
C D 3 - - - 0x01EB4F 07:EB3F: B1 1A     LDA (ram_001A_temp),Y
C - - - - - 0x01EB51 07:EB41: 48        PHA
C - - - - - 0x01EB52 07:EB42: A4 10     LDY ram_0010_temp
C - - - - - 0x01EB54 07:EB44: A5 3C     LDA ram_003C
C - - - - - 0x01EB56 07:EB46: 10 0D     BPL bra_EB55
C - - - - - 0x01EB58 07:EB48: B9 7F EB  LDA tbl_EB7F,Y
C - - - - - 0x01EB5B 07:EB4B: 85 1C     STA ram_001C_temp
...
C - - - - - 0x01EB68 07:EB58: 85 1C     STA ram_001C_temp
...
C - - - - - 0x01EB71 07:EB61: B1 18     LDA (ram_0018_temp),Y
C - - - - - 0x01EB73 07:EB63: A4 0A     LDY ram_000A_temp
C - - - - - 0x01EB75 07:EB65: 25 1C     AND ram_001C_temp
C - - - - - 0x01EB77 07:EB67: 99 00 05  STA ram_0500,Y
C - - - - - 0x01EB7A 07:EB6A: 68        PLA
C - - - - - 0x01EB7B 07:EB6B: A8        TAY
C - - - - - 0x01EB7C 07:EB6C: B1 18     LDA (ram_0018_temp),Y
C - - - - - 0x01EB7E 07:EB6E: 25 1D     AND ram_001D_temp
C - - - - - 0x01EB80 07:EB70: A4 0A     LDY ram_000A_temp
...
sub_EB83:
loc_EB83:
C D 3 - - - 0x01EB93 07:EB83: 84 0D     STY ram_000D_temp
...
C - - - - - 0x01EBA0 07:EB90: 46 0D     LSR ram_000D_temp
...
sub_EB95:
loc_EB95:
C D 3 - - - 0x01EBA5 07:EB95: 84 0D     STY ram_000D_temp
C - - - - - 0x01EBA7 07:EB97: B1 00     LDA (ram_0000_t20_data),Y
...
C - - - - - 0x01EBB0 07:EBA0: B1 18     LDA (ram_0018_temp),Y
...
C - - - - - 0x01EBBC 07:EBAC: A5 02     LDA ram_0002_temp
...
bra_EBB9:
C - - - - - 0x01EBC9 07:EBB9: A5 02     LDA ram_0002_temp
...
C - - - - - 0x01EBD7 07:EBC7: A4 06     LDY ram_0006_temp
C - - - - - 0x01EBD9 07:EBC9: C0 04     CPY #$04
C - - - - - 0x01EBDB 07:EBCB: B0 23     BCS bra_EBF0
C - - - - - 0x01EBDD 07:EBCD: AD FF 03  LDA ram_03FF
C - - - - - 0x01EBE0 07:EBD0: 85 1C     STA ram_001C_temp
C - - - - - 0x01EBE2 07:EBD2: A4 06     LDY ram_0006_temp
C - - - - - 0x01EBE4 07:EBD4: 88        DEY
C - - - - - 0x01EBE5 07:EBD5: B9 7F EB  LDA tbl_EB7F,Y
C - - - - - 0x01EBE8 07:EBD8: 25 1C     AND ram_001C_temp
C - - - - - 0x01EBEA 07:EBDA: 85 1C     STA ram_001C_temp
C - - - - - 0x01EBEC 07:EBDC: B9 7B EB  LDA tbl_EB7B,Y
C - - - - - 0x01EBEF 07:EBDF: 25 1D     AND ram_001D_temp
C - - - - - 0x01EBF1 07:EBE1: 05 1C     ORA ram_001C_temp
C - - - - - 0x01EBF3 07:EBE3: 4C F0 EB  JMP loc_EBF0



loc_EBE6:
C D 3 - - - 0x01EBF6 07:EBE6: 84 0D     STY ram_000D_temp
C - - - - - 0x01EBF8 07:EBE8: B1 00     LDA (ram_0000_t19_data),Y
C - - - - - 0x01EBFA 07:EBEA: 85 13     STA ram_0013_temp
loc_EBEC:
C D 3 - - - 0x01EBFC 07:EBEC: A4 13     LDY ram_0013_temp
C - - - - - 0x01EBFE 07:EBEE: B1 18     LDA (ram_0018_temp),Y
bra_EBF0:
loc_EBF0:
C D 3 - - - 0x01EC00 07:EBF0: A4 0A     LDY ram_000A_temp
C - - - - - 0x01EC02 07:EBF2: 99 00 05  STA ram_0500,Y
C - - - - - 0x01EC05 07:EBF5: A4 06     LDY ram_0006_temp
...
C - - - - - 0x01EC1A 07:EC0A: 05 0D     ORA ram_000D_temp
...
C - - - - - 0x01EC2B 07:EC1B: A5 0D     LDA ram_000D_temp
...
loc_EC26:
C D 3 - - - 0x01EC36 07:EC26: E6 0A     INC ram_000A_temp
...
C - - - - - 0x01EC48 07:EC38: A5 08     LDA ram_0008_temp
C - - - - - 0x01EC4A 07:EC3A: 18        CLC
C - - - - - 0x01EC4B 07:EC3B: 65 12     ADC ram_0012_temp
C - - - - - 0x01EC4D 07:EC3D: 85 12     STA ram_0012_temp
C - - - - - 0x01EC4F 07:EC3F: A5 09     LDA ram_0009_temp
C - - - - - 0x01EC51 07:EC41: 65 13     ADC ram_0013_temp
C - - - - - 0x01EC53 07:EC43: 85 13     STA ram_0013_temp
...
C - - - - - 0x01EC62 07:EC52: A5 10     LDA ram_0010_temp
C - - - - - 0x01EC64 07:EC54: 18        CLC
C - - - - - 0x01EC65 07:EC55: 65 12     ADC ram_0012_temp
C - - - - - 0x01EC67 07:EC57: 85 12     STA ram_0012_temp
C - - - - - 0x01EC69 07:EC59: A9 00     LDA #$00
C - - - - - 0x01EC6B 07:EC5B: 65 13     ADC ram_0013_temp
C - - - - - 0x01EC6D 07:EC5D: 85 13     STA ram_0013_temp
C - - - - - 0x01EC6F 07:EC5F: A5 0D     LDA ram_000D_temp
C - - - - - 0x01EC71 07:EC61: C9 38     CMP #$38
C - - - - - 0x01EC73 07:EC63: 90 09     BCC bra_EC6E
C - - - - - 0x01EC75 07:EC65: A4 11     LDY ram_0011_temp
C - - - - - 0x01EC77 07:EC67: F0 16     BEQ bra_EC7F
C - - - - - 0x01EC79 07:EC69: C6 11     DEC ram_0011_temp
C - - - - - 0x01EC7B 07:EC6B: F0 17     BEQ bra_EC84
- - - - - - 0x01EC7D 07:EC6D: 60        RTS
bra_EC6E:
C - - - - - 0x01EC7E 07:EC6E: A4 11     LDY ram_0011_temp
C - - - - - 0x01EC80 07:EC70: F0 17     BEQ bra_EC89
C - - - - - 0x01EC82 07:EC72: C6 11     DEC ram_0011_temp
C - - - - - 0x01EC84 07:EC74: F0 18     BEQ bra_EC8E
C - - - - - 0x01EC86 07:EC76: C6 11     DEC ram_0011_temp
C - - - - - 0x01EC88 07:EC78: F0 1B     BEQ bra_EC95
C - - - - - 0x01EC8A 07:EC7A: C6 11     DEC ram_0011_temp
...
bra_ECA1:
C - - - - - 0x01ECB1 07:ECA1: A5 11     LDA ram_0011_temp
C - - - - - 0x01ECB3 07:ECA3: 0A        ASL
C - - - - - 0x01ECB4 07:ECA4: 0A        ASL
C - - - - - 0x01ECB5 07:ECA5: 18        CLC
C - - - - - 0x01ECB6 07:ECA6: 65 12     ADC ram_0012_temp
C - - - - - 0x01ECB8 07:ECA8: 85 12     STA ram_0012_temp
C - - - - - 0x01ECBA 07:ECAA: A9 00     LDA #$00
C - - - - - 0x01ECBC 07:ECAC: 65 13     ADC ram_0013_temp
C - - - - - 0x01ECBE 07:ECAE: 85 13     STA ram_0013_temp
C - - - - - 0x01ECC0 07:ECB0: A4 10     LDY ram_0010_temp
C - - - - - 0x01ECC2 07:ECB2: F0 0D     BEQ bra_ECC1
C - - - - - 0x01ECC4 07:ECB4: C6 10     DEC ram_0010_temp
C - - - - - 0x01ECC6 07:ECB6: F0 1A     BEQ bra_ECD2
C - - - - - 0x01ECC8 07:ECB8: C6 10     DEC ram_0010_temp
C - - - - - 0x01ECCA 07:ECBA: F0 1E     BEQ bra_ECDA
C - - - - - 0x01ECCC 07:ECBC: C6 10     DEC ram_0010_temp
...
sub_ECE7:
loc_ECE7:
C D 3 - - - 0x01ECF7 07:ECE7: B1 12     LDA (ram_0012_temp),Y
C - - - - - 0x01ECF9 07:ECE9: 9D 00 01  STA ram_ppu_buffer_1,X
C - - - - - 0x01ECFC 07:ECEC: E8        INX
C - - - - - 0x01ECFD 07:ECED: C6 06     DEC ram_0006_temp
bra_ECEF_RTS:
...
C - - - - - 0x01ED19 07:ED09: 85 10     STA ram_0010_temp
C - - - - - 0x01ED1B 07:ED0B: 85 11     STA ram_0011_temp
C - - - - - 0x01ED1D 07:ED0D: A9 10     LDA #$10
C - - - - - 0x01ED1F 07:ED0F: 85 06     STA ram_0006_temp
...
C - - - - - 0x01ED2A 07:ED1A: A5 04     LDA ram_0004_temp
C - - - - - 0x01ED2C 07:ED1C: 20 C9 DA  JSR sub_DAC9_write_byte_to_ppu_buffer
C - - - - - 0x01ED2F 07:ED1F: A5 05     LDA ram_0005_temp
...
C - - - - - 0x01ED3C 07:ED2C: A5 04     LDA ram_0004_temp
C - - - - - 0x01ED3E 07:ED2E: 18        CLC
C - - - - - 0x01ED3F 07:ED2F: 69 20     ADC #< $0020
C - - - - - 0x01ED41 07:ED31: 85 04     STA ram_0004_temp
C - - - - - 0x01ED43 07:ED33: A5 05     LDA ram_0005_temp
C - - - - - 0x01ED45 07:ED35: 69 00     ADC #> $0020
C - - - - - 0x01ED47 07:ED37: 85 05     STA ram_0005_temp
C - - - - - 0x01ED49 07:ED39: 29 03     AND #$03
C - - - - - 0x01ED4B 07:ED3B: C9 03     CMP #$03
C - - - - - 0x01ED4D 07:ED3D: D0 07     BNE bra_ED46
C - - - - - 0x01ED4F 07:ED3F: A5 04     LDA ram_0004_temp
...
C - - - - - 0x01ED58 07:ED48: 85 11     STA ram_0011_temp
...
C - - - - - 0x01ED7C 07:ED6C: A5 0D     LDA ram_000D_temp
...
C - - - - - 0x01ED8C 07:ED7C: A5 03     LDA ram_0003_temp
...
C - - - - - 0x01EDCA 07:EDBA: 85 08     STA ram_0008_temp
C - - - - - 0x01EDCC 07:EDBC: B9 58 DA  LDA tbl_DA57 + $01,Y
C - - - - - 0x01EDCF 07:EDBF: 85 09     STA ram_0009_temp
...
C - - - - - 0x01EDE7 07:EDD7: 85 10     STA ram_0010_temp
...
bra_EDE1:
C - - - - - 0x01EDF1 07:EDE1: 05 10     ORA ram_0010_temp
C - - - - - 0x01EDF3 07:EDE3: 85 10     STA ram_0010_temp
C - - - - - 0x01EDF5 07:EDE5: A9 00     LDA #$00
C - - - - - 0x01EDF7 07:EDE7: 85 13     STA ram_0013_temp
C - - - - - 0x01EDF9 07:EDE9: 29 F0     AND #$F0
C - - - - - 0x01EDFB 07:EDEB: 05 10     ORA ram_0010_temp
...
C - - - - - 0x01EE15 07:EE05: 85 11     STA ram_0011_temp
...
C - - - - - 0x01EE25 07:EE15: A4 02     LDY ram_0002_temp
...
C - - - - - 0x01EE30 07:EE20: 85 11     STA ram_0011_temp
...
loc_EE33:
C D 3 - - - 0x01EE43 07:EE33: A4 02     LDY ram_0002_temp
...
C - - - - - 0x01EE50 07:EE40: 85 11     STA ram_0011_temp
C - - - - - 0x01EE52 07:EE42: A5 17     LDA ram_0017_temp
C - - - - - 0x01EE54 07:EE44: 85 1C     STA ram_001C_temp
C - - - - - 0x01EE56 07:EE46: 29 01     AND #$01
C - - - - - 0x01EE58 07:EE48: F0 02     BEQ bra_EE4C
C - - - - - 0x01EE5A 07:EE4A: A9 80     LDA #$80
bra_EE4C:
C - - - - - 0x01EE5C 07:EE4C: 05 11     ORA ram_0011_temp
C - - - - - 0x01EE5E 07:EE4E: 05 10     ORA ram_0010_temp
sub_EE50:
C - - - - - 0x01EE60 07:EE50: A8        TAY
C - - - - - 0x01EE61 07:EE51: 84 02     STY ram_0002_temp
...
ofs_006_EE54_00:
; con_F3D6_00
C - - J - - 0x01EE64 07:EE54: A5 00     LDA ram_0000_temp
C - - - - - 0x01EE66 07:EE56: 85 1C     STA ram_001C_temp
C - - - - - 0x01EE68 07:EE58: A5 C5     LDA ram_00C5
C - - - - - 0x01EE6A 07:EE5A: F0 16     BEQ bra_EE72
C - - - - - 0x01EE6C 07:EE5C: C5 01     CMP ram_0001_temp
...
C - - - - - 0x01EE84 07:EE74: 85 02     STA ram_0002_temp
...
C - - - - - 0x01EE94 07:EE84: A5 01     LDA ram_0001_temp
...
bra_EE95:
C - - - - - 0x01EEA5 07:EE95: A5 01     LDA ram_0001_temp
C - - - - - 0x01EEA7 07:EE97: 18        CLC
C - - - - - 0x01EEA8 07:EE98: 65 AF     ADC ram_00AF
C - - - - - 0x01EEAA 07:EE9A: 69 07     ADC #$07
C - - - - - 0x01EEAC 07:EE9C: 85 01     STA ram_0001_temp
C - - - - - 0x01EEAE 07:EE9E: 90 02     BCC bra_EEA2
C - - - - - 0x01EEB0 07:EEA0: E6 02     INC ram_0002_temp
bra_EEA2:
C - - - - - 0x01EEB2 07:EEA2: 20 A4 F0  JSR sub_F0A4
C - - - - - 0x01EEB5 07:EEA5: 20 98 F0  JSR sub_F098
loc_EEA8:
C D 3 - - - 0x01EEB8 07:EEA8: A5 02     LDA ram_0002_temp
C - - - - - 0x01EEBA 07:EEAA: 85 1D     STA ram_001D_temp
C - - - - - 0x01EEBC 07:EEAC: A5 03     LDA ram_0003_temp
C - - - - - 0x01EEBE 07:EEAE: 38        SEC
C - - - - - 0x01EEBF 07:EEAF: E5 05     SBC ram_0005_temp
C - - - - - 0x01EEC1 07:EEB1: 85 03     STA ram_0003_temp
...
C - - - - - 0x01EECF 07:EEBF: A5 03     LDA ram_0003_temp
C - - - - - 0x01EED1 07:EEC1: 38        SEC
C - - - - - 0x01EED2 07:EEC2: E9 08     SBC #$08
C - - - - - 0x01EED4 07:EEC4: 85 03     STA ram_0003_temp
bra_EEC6:
C - - - - - 0x01EED6 07:EEC6: C6 02     DEC ram_0002_temp
bra_EEC8:
C - - - - - 0x01EED8 07:EEC8: A5 03     LDA ram_0003_temp
C - - - - - 0x01EEDA 07:EECA: 4A        LSR
C - - - - - 0x01EEDB 07:EECB: 85 13     STA ram_0013_temp
C - - - - - 0x01EEDD 07:EECD: 29 F0     AND #$F0
C - - - - - 0x01EEDF 07:EECF: 05 04     ORA ram_0004_temp
C - - - - - 0x01EEE1 07:EED1: 85 04     STA ram_0004_temp
C - - - - - 0x01EEE3 07:EED3: A5 14     LDA ram_0014_temp
C - - - - - 0x01EEE5 07:EED5: 29 F0     AND #$F0
C - - - - - 0x01EEE7 07:EED7: 18        CLC
C - - - - - 0x01EEE8 07:EED8: 65 04     ADC ram_0004_temp
C - - - - - 0x01EEEA 07:EEDA: 85 04     STA ram_0004_temp
C - - - - - 0x01EEEC 07:EEDC: A5 02     LDA ram_0002_temp
C - - - - - 0x01EEEE 07:EEDE: 29 01     AND #$01
C - - - - - 0x01EEF0 07:EEE0: F0 06     BEQ bra_EEE8
C - - - - - 0x01EEF2 07:EEE2: A5 04     LDA ram_0004_temp
C - - - - - 0x01EEF4 07:EEE4: 49 80     EOR #$80
C - - - - - 0x01EEF6 07:EEE6: 85 04     STA ram_0004_temp
bra_EEE8:
C - - - - - 0x01EEF8 07:EEE8: A4 04     LDY ram_0004_temp
C - - - - - 0x01EEFA 07:EEEA: 84 02     STY ram_0002_temp
ofs_006_EEEC_0F:
; con_F3D6_0F
C - - - - - 0x01EEFC 07:EEEC: A4 02     LDY ram_0002_temp
C - - - - - 0x01EEFE 07:EEEE: B9 00 04  LDA ram_0400,Y
C - - - - - 0x01EF01 07:EEF1: 85 00     STA ram_0000_temp
C - - - - - 0x01EF03 07:EEF3: A4 88     LDY ram_x2_stage
C - - - - - 0x01EF05 07:EEF5: B9 57 DA  LDA tbl_DA57,Y
C - - - - - 0x01EF08 07:EEF8: 85 10     STA ram_0010_temp
C - - - - - 0x01EF0A 07:EEFA: B9 58 DA  LDA tbl_DA57 + $01,Y
C - - - - - 0x01EF0D 07:EEFD: 85 11     STA ram_0011_temp
C - - - - - 0x01EF0F 07:EEFF: A9 00     LDA #$00
C - - - - - 0x01EF11 07:EF01: 85 14     STA ram_0014_temp
C - - - - - 0x01EF13 07:EF03: A5 00     LDA ram_0000_temp
...
C - - - - - 0x01EF1E 07:EF0E: 65 10     ADC ram_0010_temp
C - - - - - 0x01EF20 07:EF10: 85 10     STA ram_0010_temp
C - - - - - 0x01EF22 07:EF12: A5 11     LDA ram_0011_temp
C - - - - - 0x01EF24 07:EF14: 65 14     ADC ram_0014_temp
C - - - - - 0x01EF26 07:EF16: 85 11     STA ram_0011_temp
...
C - - - - - 0x01EF35 07:EF25: 84 0D     STY ram_000D_temp
C - - - - - 0x01EF37 07:EF27: B1 10     LDA (ram_0010_temp),Y
...
C - - - - - 0x01EF40 07:EF30: 85 01     STA ram_0001_temp
...
C - - - - - 0x01EF4A 07:EF3A: E6 01     INC ram_0001_temp
C - - - - - 0x01EF4C 07:EF3C: E6 01     INC ram_0001_temp
C - - - - - 0x01EF4E 07:EF3E: D9 90 EF  CMP tbl_EF8E + $02,Y
C - - - - - 0x01EF51 07:EF41: 90 1A     BCC bra_EF5D
C - - - - - 0x01EF53 07:EF43: E6 01     INC ram_0001_temp
C - - - - - 0x01EF55 07:EF45: E6 01     INC ram_0001_temp
C - - - - - 0x01EF57 07:EF47: D9 92 EF  CMP tbl_EF8E + $04,Y
C - - - - - 0x01EF5A 07:EF4A: 90 11     BCC bra_EF5D
C - - - - - 0x01EF5C 07:EF4C: E6 01     INC ram_0001_temp
C - - - - - 0x01EF5E 07:EF4E: E6 01     INC ram_0001_temp
...
sub_F068:
C - - - - - 0x01F078 07:F068: 85 02     STA ram_0002_temp
...
C - - - - - 0x01F085 07:F075: 85 05     STA ram_0005_temp
...
C - - - - - 0x01F089 07:F079: 65 03     ADC ram_0003_temp
C - - - - - 0x01F08B 07:F07B: 85 03     STA ram_0003_temp
C - - - - - 0x01F08D 07:F07D: 90 07     BCC bra_F086
C - - - - - 0x01F08F 07:F07F: E6 02     INC ram_0002_temp
C - - - - - 0x01F091 07:F081: 18        CLC
C - - - - - 0x01F092 07:F082: 69 10     ADC #$10
C - - - - - 0x01F094 07:F084: 85 03     STA ram_0003_temp
bra_F086:
C - - - - - 0x01F096 07:F086: A5 02     LDA ram_0002_temp
C - - - - - 0x01F098 07:F088: 69 00     ADC #$00
C - - - - - 0x01F09A 07:F08A: 85 02     STA ram_0002_temp
C - - - - - 0x01F09C 07:F08C: A5 03     LDA ram_0003_temp
C - - - - - 0x01F09E 07:F08E: 38        SEC
C - - - - - 0x01F09F 07:F08F: E9 F0     SBC #$F0
C - - - - - 0x01F0A1 07:F091: 90 04     BCC bra_F097_RTS
C - - - - - 0x01F0A3 07:F093: E6 02     INC ram_0002_temp
C - - - - - 0x01F0A5 07:F095: 85 03     STA ram_0003_temp
bra_F097_RTS:
...
C - - - - - 0x01F0B1 07:F0A1: 85 05     STA ram_0005_temp
...
C - - - - - 0x01F0D2 07:F0C2: 65 04     ADC ram_0004_temp
C - - - - - 0x01F0D4 07:F0C4: 29 0F     AND #$0F
C - - - - - 0x01F0D6 07:F0C6: 85 04     STA ram_0004_temp
C - - - - - 0x01F0D8 07:F0C8: A5 01     LDA ram_0001_temp
C - - - - - 0x01F0DA 07:F0CA: 85 03     STA ram_0003_temp
...
C - - - - - 0x01F0EE 07:F0DE: 85 10     STA ram_0010_temp
...
bra_F0E8:
C - - - - - 0x01F0F8 07:F0E8: 05 10     ORA ram_0010_temp
C - - - - - 0x01F0FA 07:F0EA: 85 10     STA ram_0010_temp
C - - - - - 0x01F0FC 07:F0EC: 60        RTS



sub_F0ED:
C - - - - - 0x01F0FD 07:F0ED: A5 11     LDA ram_0011_temp
...
C - - - - - 0x01F139 07:F129: A5 00     LDA ram_0000_temp
...
C - - - - - 0x01F148 07:F138: 65 1C     ADC ram_001C_temp
...
C - - - - - 0x01F178 07:F168: 85 04     STA ram_0004_temp
C - - - - - 0x01F17A 07:F16A: B9 82 F2  LDA tbl_F281 + $01,Y
C - - - - - 0x01F17D 07:F16D: 85 05     STA ram_0005_temp
C - - - - - 0x01F17F 07:F16F: A5 00     LDA ram_0000_temp
...
C - - - - - 0x01F18D 07:F17D: C5 00     CMP ram_0000_temp
...
bra_F1A2:
C - - - - - 0x01F1B2 07:F1A2: A5 00     LDA ram_0000_temp
C - - - - - 0x01F1B4 07:F1A4: 38        SEC
C - - - - - 0x01F1B5 07:F1A5: F9 73 F2  SBC tbl_F273,Y
C - - - - - 0x01F1B8 07:F1A8: A8        TAY
C - - - - - 0x01F1B9 07:F1A9: B1 04     LDA (ram_0004_temp),Y
sub_F1AB:
C - - - - - 0x01F1BB 07:F1AB: 85 12     STA ram_0012_temp
C - - - - - 0x01F1BD 07:F1AD: A4 02     LDY ram_0002_temp
C - - - - - 0x01F1BF 07:F1AF: 99 00 04  STA ram_0400,Y
C - - - - - 0x01F1C2 07:F1B2: 98        TYA
C - - - - - 0x01F1C3 07:F1B3: 29 07     AND #$07
C - - - - - 0x01F1C5 07:F1B5: 85 03     STA ram_0003_temp
C - - - - - 0x01F1C7 07:F1B7: A5 02     LDA ram_0002_temp
C - - - - - 0x01F1C9 07:F1B9: 29 70     AND #$70
C - - - - - 0x01F1CB 07:F1BB: 4A        LSR
C - - - - - 0x01F1CC 07:F1BC: 05 03     ORA ram_0003_temp
C - - - - - 0x01F1CE 07:F1BE: 85 03     STA ram_0003_temp
C - - - - - 0x01F1D0 07:F1C0: A5 03     LDA ram_0003_temp
C - - - - - 0x01F1D2 07:F1C2: 29 38     AND #$38
C - - - - - 0x01F1D4 07:F1C4: 4A        LSR
C - - - - - 0x01F1D5 07:F1C5: 4A        LSR
C - - - - - 0x01F1D6 07:F1C6: 4A        LSR
C - - - - - 0x01F1D7 07:F1C7: 85 05     STA ram_0005_temp
C - - - - - 0x01F1D9 07:F1C9: A9 00     LDA #$00
C - - - - - 0x01F1DB 07:F1CB: 46 05     LSR ram_0005_temp
C - - - - - 0x01F1DD 07:F1CD: 6A        ROR
C - - - - - 0x01F1DE 07:F1CE: 85 04     STA ram_0004_temp
C - - - - - 0x01F1E0 07:F1D0: A5 03     LDA ram_0003_temp
C - - - - - 0x01F1E2 07:F1D2: 29 07     AND #$07
C - - - - - 0x01F1E4 07:F1D4: 0A        ASL
C - - - - - 0x01F1E5 07:F1D5: 0A        ASL
C - - - - - 0x01F1E6 07:F1D6: 05 04     ORA ram_0004_temp
C - - - - - 0x01F1E8 07:F1D8: 85 04     STA ram_0004_temp
C - - - - - 0x01F1EA 07:F1DA: A5 34     LDA ram_mirroring
C - - - - - 0x01F1EC 07:F1DC: F0 08     BEQ bra_F1E6
C - - - - - 0x01F1EE 07:F1DE: A5 02     LDA ram_0002_temp
C - - - - - 0x01F1F0 07:F1E0: 29 80     AND #$80
C - - - - - 0x01F1F2 07:F1E2: F0 0A     BEQ bra_F1EE
C - - - - - 0x01F1F4 07:F1E4: D0 06     BNE bra_F1EC    ; jmp
bra_F1E6:
C - - - - - 0x01F1F6 07:F1E6: A5 02     LDA ram_0002_temp
...
C - - - - - 0x01F202 07:F1F2: 05 05     ORA ram_0005_temp
C - - - - - 0x01F204 07:F1F4: 85 05     STA ram_0005_temp
C - - - - - 0x01F206 07:F1F6: A9 04     LDA #$04
C - - - - - 0x01F208 07:F1F8: 20 5F F2  JSR sub_F25F
C - - - - - 0x01F20B 07:F1FB: A5 03     LDA ram_0003_temp
C - - - - - 0x01F20D 07:F1FD: 09 C0     ORA #$C0
C - - - - - 0x01F20F 07:F1FF: 20 5F F2  JSR sub_F25F
C - - - - - 0x01F212 07:F202: A5 05     LDA ram_0005_temp
...
C - - - - - 0x01F223 07:F213: 85 06     STA ram_0006_temp
C - - - - - 0x01F225 07:F215: B9 4E DA  LDA tbl_DA4D + $01,Y
C - - - - - 0x01F228 07:F218: 85 07     STA ram_0007_temp
C - - - - - 0x01F22A 07:F21A: A4 12     LDY ram_0012_temp
C - - - - - 0x01F22C 07:F21C: B1 06     LDA (ram_0006_temp),Y
...
bra_F228_loop:
C - - - - - 0x01F238 07:F228: 06 12     ASL ram_0012_temp
C - - - - - 0x01F23A 07:F22A: 2A        ROL
C - - - - - 0x01F23B 07:F22B: 88        DEY
C - - - - - 0x01F23C 07:F22C: 10 FA     BPL bra_F228_loop
C - - - - - 0x01F23E 07:F22E: 85 13     STA ram_0013_temp
C - - - - - 0x01F240 07:F230: 20 B5 ED  JSR sub_EDB5
C - - - - - 0x01F243 07:F233: A5 08     LDA ram_0008_temp
C - - - - - 0x01F245 07:F235: 18        CLC
C - - - - - 0x01F246 07:F236: 65 12     ADC ram_0012_temp
C - - - - - 0x01F248 07:F238: 85 12     STA ram_0012_temp
C - - - - - 0x01F24A 07:F23A: A5 09     LDA ram_0009_temp
C - - - - - 0x01F24C 07:F23C: 65 13     ADC ram_0013_temp
C - - - - - 0x01F24E 07:F23E: 85 13     STA ram_0013_temp
...
C - - - - - 0x01F2F2 07:F2E2: A5 00     LDA ram_0000_temp
...
C - - - - - 0x01F300 07:F2F0: C5 00     CMP ram_0000_temp
C - - - - - 0x01F302 07:F2F2: B0 04     BCS bra_F2F8_RTS
bra_F2F4:
C - - - - - 0x01F304 07:F2F4: A9 00     LDA #$00
C - - - - - 0x01F306 07:F2F6: 85 00     STA ram_0000_temp
bra_F2F8_RTS:
...
bra_F301_loop:
C - - - - - 0x01F311 07:F301: 95 00     STA ram_0000_temp,X
...
sub_0x01F4C1:
loc_0x01F4C1:
C D 3 - - - 0x01F4C1 07:F4B1: 84 02     STY ram_0002_temp
C - - - - - 0x01F4C3 07:F4B3: 85 00     STA ram_0000_temp
...
C - - - - - 0x01F4CE 07:F4BE: 85 03     STA ram_0003_temp
C - - - - - 0x01F4D0 07:F4C0: B9 17 F5  LDA tbl_F516 + $01,Y
C - - - - - 0x01F4D3 07:F4C3: 85 04     STA ram_0004_temp
C - - - - - 0x01F4D5 07:F4C5: A5 00     LDA ram_0000_temp
C - - - - - 0x01F4D7 07:F4C7: 29 0F     AND #$0F
C - - - - - 0x01F4D9 07:F4C9: A8        TAY
C - - - - - 0x01F4DA 07:F4CA: B1 03     LDA (ram_0003_temp),Y
C - - - - - 0x01F4DC 07:F4CC: 18        CLC
C - - - - - 0x01F4DD 07:F4CD: 65 03     ADC ram_0003_temp
C - - - - - 0x01F4DF 07:F4CF: 85 00     STA ram_0000_t21_data
C - - - - - 0x01F4E1 07:F4D1: A9 00     LDA #$00
C - - - - - 0x01F4E3 07:F4D3: A8        TAY
C - - - - - 0x01F4E4 07:F4D4: 65 04     ADC ram_0004_temp
C - - - - - 0x01F4E6 07:F4D6: 85 01     STA ram_0000_t21_data + $01
sub_0x01F4E8:
C - - - - - 0x01F4E8 07:F4D8: B1 00     LDA (ram_0000_t21_data),Y
C - - - - - 0x01F4EA 07:F4DA: 4A        LSR
C - - - - - 0x01F4EB 07:F4DB: 4A        LSR
C - - - - - 0x01F4EC 07:F4DC: 29 FC     AND #$FC
C - - - - - 0x01F4EE 07:F4DE: AA        TAX
C - - - - - 0x01F4EF 07:F4DF: B1 00     LDA (ram_0000_t21_data),Y
C - - - - - 0x01F4F1 07:F4E1: 29 0F     AND #$0F
C - - - - - 0x01F4F3 07:F4E3: 85 03     STA ram_0003_temp
...
C - - - - - 0x01F516 07:F506: A5 02     LDA ram_0002_temp
...
C - - - - - 0x01F520 07:F510: 85 03     STA ram_0003_temp
...
C - - - - - 0x01F541 07:F531: 85 00     STA ram_0000_temp
C - - - - - 0x01F543 07:F533: A2 00     LDX #$00
C - - - - - 0x01F545 07:F535: A0 00     LDY #$00
bra_F537_loop:
C - - - - - 0x01F547 07:F537: A5 00     LDA ram_0000_temp
C - - - - - 0x01F549 07:F539: C9 0F     CMP #$0F
C - - - - - 0x01F54B 07:F53B: F0 0A     BEQ bra_F547
C - - - - - 0x01F54D 07:F53D: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01F54F 07:F53F: C5 00     CMP ram_0000_temp
C - - - - - 0x01F551 07:F541: 90 04     BCC bra_F547
C - - - - - 0x01F553 07:F543: 29 0F     AND #$0F
C - - - - - 0x01F555 07:F545: 05 00     ORA ram_0000_temp
bra_F547:
loc_F547:
...
C - - - - - 0x01F590 07:F580: 85 00     STA ram_0000_temp
C - - - - - 0x01F592 07:F582: A2 00     LDX #$00
C - - - - - 0x01F594 07:F584: A0 00     LDY #$00
C - - - - - 0x01F596 07:F586: A5 00     LDA ram_0000_temp
C - - - - - 0x01F598 07:F588: C9 0F     CMP #$0F
C - - - - - 0x01F59A 07:F58A: F0 BB     BEQ bra_F547
C - - - - - 0x01F59C 07:F58C: B1 02     LDA (ram_0002_temp),Y
C - - - - - 0x01F59E 07:F58E: C5 00     CMP ram_0000_temp
C - - - - - 0x01F5A0 07:F590: 90 B5     BCC bra_F547
C - - - - - 0x01F5A2 07:F592: 29 0F     AND #$0F
C - - - - - 0x01F5A4 07:F594: 05 00     ORA ram_0000_temp
...
C - - - - - 0x01F5AB 07:F59B: 85 02     STA ram_0002_temp
C - - - - - 0x01F5AD 07:F59D: A9 03     LDA #> ram_palette_buffer
C - - - - - 0x01F5AF 07:F59F: 85 03     STA ram_0003_temp
...
C - - - - - 0x01F608 07:F5F8: 85 03     STA ram_0003_temp
C - - - - - 0x01F60A 07:F5FA: A5 63     LDA ram_0063
C - - - - - 0x01F60C 07:F5FC: 85 02     STA ram_0002_temp
...
C - - - - - 0x01F616 07:F606: A5 02     LDA ram_0002_temp
C - - - - - 0x01F618 07:F608: 85 DC     STA ram_00DC
C - - - - - 0x01F61A 07:F60A: A5 03     LDA ram_0003_temp
...
C - - - - - 0x01F621 07:F611: 85 02     STA ram_0002_temp
C - - - - - 0x01F623 07:F613: A5 DD     LDA ram_00DD
C - - - - - 0x01F625 07:F615: 18        CLC
C - - - - - 0x01F626 07:F616: 65 03     ADC ram_0003_temp
C - - - - - 0x01F628 07:F618: 85 03     STA ram_0003_temp
C - - - - - 0x01F62A 07:F61A: 90 07     BCC bra_F623
C - - - - - 0x01F62C 07:F61C: E6 02     INC ram_0002_temp
C - - - - - 0x01F62E 07:F61E: 18        CLC
C - - - - - 0x01F62F 07:F61F: 69 10     ADC #$10
C - - - - - 0x01F631 07:F621: 85 03     STA ram_0003_temp
bra_F623:
C - - - - - 0x01F633 07:F623: A5 02     LDA ram_0002_temp
C - - - - - 0x01F635 07:F625: 65 DC     ADC ram_00DC
C - - - - - 0x01F637 07:F627: 85 02     STA ram_0002_temp
C - - - - - 0x01F639 07:F629: A5 03     LDA ram_0003_temp
C - - - - - 0x01F63B 07:F62B: 38        SEC
C - - - - - 0x01F63C 07:F62C: E9 F0     SBC #$F0
C - - - - - 0x01F63E 07:F62E: 90 04     BCC bra_F634_RTS
C - - - - - 0x01F640 07:F630: E6 02     INC ram_0002_temp
C - - - - - 0x01F642 07:F632: 85 03     STA ram_0003_temp
bra_F634_RTS:
...
C - - - - - 0x01F6E7 07:F6D7: A5 1B     LDA ram_001B_temp
...
- - - - - - 0x01F733 07:F723: 25 00     AND ram_0000_temp
- - - - - - 0x01F735 07:F725: 85 00     STA ram_0000_temp
bra_F727_RTS:
...
; this CMP is for wasting 3 cycles
...
C - - - - - 0x01F90F 07:F8FF: 85 08     STA ram_0008_temp
C - - - - - 0x01F911 07:F901: B9 4B F9  LDA tbl_F94A + $01,Y
C - - - - - 0x01F914 07:F904: 85 09     STA ram_0009_temp
C - - - - - 0x01F916 07:F906: A9 00     LDA #$00
C - - - - - 0x01F918 07:F908: 85 18     STA ram_0018_temp
C - - - - - 0x01F91A 07:F90A: 85 19     STA ram_0019_temp
C - - - - - 0x01F91C 07:F90C: 85 1A     STA ram_001A_temp
C - - - - - 0x01F91E 07:F90E: 85 1B     STA ram_001B_temp
...
C - - - - - 0x01F92D 07:F91D: E6 18     INC ram_0018_temp
bra_F91F:
C - - - - - 0x01F92F 07:F91F: C5 09     CMP ram_0009_temp
C - - - - - 0x01F931 07:F921: 90 02     BCC bra_F925
C - - - - - 0x01F933 07:F923: E6 19     INC ram_0019_temp
bra_F925:
...
C - - - - - 0x01F940 07:F930: E6 1A     INC ram_001A_temp
bra_F932:
C - - - - - 0x01F942 07:F932: C5 08     CMP ram_0008_temp
C - - - - - 0x01F944 07:F934: 90 02     BCC bra_F938
C - - - - - 0x01F946 07:F936: E6 1B     INC ram_001B_temp
bra_F938:
C - - - - - 0x01F948 07:F938: A5 18     LDA ram_0018_temp
C - - - - - 0x01F94A 07:F93A: 0A        ASL
C - - - - - 0x01F94B 07:F93B: 05 19     ORA ram_0019_temp
C - - - - - 0x01F94D 07:F93D: 0A        ASL
C - - - - - 0x01F94E 07:F93E: 05 1A     ORA ram_001A_temp
C - - - - - 0x01F950 07:F940: 0A        ASL
C - - - - - 0x01F951 07:F941: 05 1B     ORA ram_001B_temp
C - - - - - 0x01F953 07:F943: A8        TAY
C - - - - - 0x01F954 07:F944: B9 84 F9  LDA tbl_F984,Y
C - - - - - 0x01F957 07:F947: 85 00     STA ram_0000_temp
...
C - - - - - 0x01F9B6 07:F9A6: 85 0F     STA ram_000F_temp
...
C - - - - - 0x01F9F7 07:F9E7: 85 0F     STA ram_000F_temp
...
C - - - - - 0x01FA30 07:FA20: 85 10     STA ram_0010_temp
C - - - - - 0x01FA32 07:FA22: BD 68 06  LDA ram_obj_pos_Y,X
C - - - - - 0x01FA35 07:FA25: 85 11     STA ram_0011_temp
...
C - - - - - 0x01FA4B 07:FA3B: 85 15     STA ram_0015_temp
...
C - - - - - 0x01FA51 07:FA41: 85 0E     STA ram_000E_temp
...
C - - - - - 0x01FA6E 07:FA5E: 85 0E     STA ram_000E_temp
...
C - - - - - 0x01FA7A 07:FA6A: 85 0E     STA ram_000E_temp
...
C - - - - - 0x01FA8F 07:FA7F: 85 0E     STA ram_000E_temp
...
C - - - - - 0x01FAAC 07:FA9C: 85 0E     STA ram_000E_temp
...
C - - - - - 0x01FAB8 07:FAA8: 85 0E     STA ram_000E_temp
...
C - - - - - 0x01FAD5 07:FAC5: 85 0E     STA ram_000E_temp
...
C - - - - - 0x01FB0C 07:FAFC: C5 15     CMP ram_0015_temp
...
bra_FB34:
C - - - - - 0x01FB44 07:FB34: C5 09     CMP ram_0009_temp
...
C - - - - - 0x01FB50 07:FB40: A4 0E     LDY ram_000E_temp
...
C - - - - - 0x01FB7D 07:FB6D: A4 0F     LDY ram_000F_temp
...
C - - - - - 0x01FFE6 07:FFD6: 85 04     STA ram_0004_temp
C - - - - - 0x01FFE8 07:FFD8: 4A        LSR
C - - - - - 0x01FFE9 07:FFD9: 05 04     ORA ram_0004_temp
C - - - - - 0x01FFEB 07:FFDB: 4A        LSR
C - - - - - 0x01FFEC 07:FFDC: 36 00     ROL ram_0000_t32,X
C - - - - - 0x01FFEE 07:FFDE: AD 17 40  LDA $4017
C - - - - - 0x01FFF1 07:FFE1: 85 05     STA ram_0005_temp
C - - - - - 0x01FFF3 07:FFE3: 4A        LSR
C - - - - - 0x01FFF4 07:FFE4: 05 05     ORA ram_0005_temp
