...
C - - - - - 0x01DDC1 07:DDB1: 85 02     STA ram_0002_t13_useless
...
; bzk warning, sometimes 0006 contains unrelevant value
...
; bzk bug? this can refer to RAM, like values
; from ram_0005_t05_hi and ram_0006_t03
