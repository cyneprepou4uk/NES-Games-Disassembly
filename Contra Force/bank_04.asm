...
C - - - - - 0x00804C 02:803C: 84 91     STY ram_0091_t04
bra_803E_loop:
C - - - - - 0x00804E 02:803E: 20 6F 80  JSR sub_806F
C - - - - - 0x008051 02:8041: B0 11     BCS bra_8054
C - - - - - 0x008053 02:8043: E6 91     INC ram_0091_t04
C - - - - - 0x008055 02:8045: A4 91     LDY ram_0091_t04
...
; in
    ; ram_0091_t04
C - - - - - 0x00807F 02:806F: A5 91     LDA ram_0091_t04
sub_8071:
; in
    ; A = 
; * 04
...
C - - - - - 0x008089 02:8079: 95 08     STA ram_0008_t04_array,X
...
C - - - - - 0x008091 02:8081: A6 53     LDX ram_obj_index
loc_0x008093:
sub_0x008093:
C D 0 - - - 0x008093 02:8083: A5 01     LDA ram_0001_t02_hi
C - - - - - 0x008095 02:8085: C5 09     CMP ram_0008_t04_array + $01
...
C - - - - - 0x00809E 02:808E: C5 08     CMP ram_0008_t04_array
C - - - - - 0x0080A0 02:8090: 90 0A     BCC bra_809C_RTS
bra_8092:
C - - - - - 0x0080A2 02:8092: A5 0B     LDA ram_0008_t04_array + $03
C - - - - - 0x0080A4 02:8094: C5 01     CMP ram_0001_t02_hi
C - - - - - 0x0080A6 02:8096: D0 04     BNE bra_809C_RTS
C - - - - - 0x0080A8 02:8098: A5 0A     LDA ram_0008_t04_array + $02
...
C - - - - - 0x0080D0 02:80C0: 86 53     STX ram_obj_index
...
C - - - - - 0x0080E9 02:80D9: A6 53     LDX ram_obj_index
bra_80DB:
...
C - - - - - 0x0080FB 02:80EB: 86 53     STX ram_obj_index
...
C - - - - - 0x00814E 02:813E: 86 53     STX ram_obj_index
...
C - - - - - 0x00816E 02:815E: A6 53     LDX ram_obj_index
...
loc_854B:
C D 0 - - - 0x00855B 02:854B: A6 53     LDX ram_obj_index
...
C - - - - - 0x00861E 02:860E: 84 0B     STY ram_000B_tFE_useless
...
C - - - - - 0x008677 02:8667: 85 0B     STA ram_000B_tFF_useless
...
C - - - - - 0x008762 02:8752: 85 06     STA ram_0006_tFF_useless
; bzk optimize, useless LDA + STA
C - - - - - 0x008764 02:8754: A5 0C     LDA ram_000C_t01_distance
C - - - - - 0x008766 02:8756: 85 07     STA ram_0007_tFE_useless
bra_8758:
...
C - - - - - 0x00878C 02:877C: 85 06     STA ram_0006_t05_ppu_lo
C - - - - - 0x00878E 02:877E: B9 B0 87  LDA tbl_87AD + $03,Y
C - - - - - 0x008791 02:8781: 85 07     STA ram_0007_t01_ppu_hi
...
C - - - - - 0x008DE5 02:8DD5: 84 91     STY ram_0091_t02
...
C - - - - - 0x008EA5 02:8E95: 84 91     STY ram_0091_t05
...
C - - - - - 0x008EB5 02:8EA5: A4 91     LDY ram_0091_t05
...
C - - - - - 0x008EC1 02:8EB1: A4 91     LDY ram_0091_t05
C - - - - - 0x008EC3 02:8EB3: 20 33 8F  JSR sub_8F33
bra_8EB6:
C - - - - - 0x008EC6 02:8EB6: BD 68 06  LDA ram_obj_pos_Y,X
C - - - - - 0x008EC9 02:8EB9: 85 91     STA ram_0091_t06_pos_Y
...
C - - - - - 0x008F0A 02:8EFA: 85 91     STA ram_0091_t06_pos_Y
bra_8EFC:
...
C - - - - - 0x008F21 02:8F11: 85 91     STA ram_0091_t06_pos_Y
bra_8F13:
C - - - - - 0x008F23 02:8F13: A5 91     LDA ram_0091_t06_pos_Y
...
C - - - - - 0x008F56 02:8F46: 85 06     STA ram_0006_t05_ppu_lo
C - - - - - 0x008F58 02:8F48: C8        INY
C - - - - - 0x008F59 02:8F49: B9 57 8F  LDA tbl_8F57,Y
C - - - - - 0x008F5C 02:8F4C: 85 07     STA ram_0007_t01_ppu_hi
...
C - - - - - 0x009086 02:9076: 65 26     ADC ram_buffer_index_1
...
; bzk optimize, useless STA
C - - - - - 0x0090F5 02:90E5: 85 0B     STA ram_000B_tFD_useless
...
C - - - - - 0x0091BE 02:91AE: A6 53     LDX ram_obj_index
bra_91B0_RTS:
...
C - - - - - 0x0091FE 02:91EE: 85 90     STA ram_0090_t01_pos_X
C - - - - - 0x009200 02:91F0: B9 68 06  LDA ram_obj_pos_Y,Y
C - - - - - 0x009203 02:91F3: 85 91     STA ram_0091_t01_pos_Y
sub_91F5:
sub_0x009205:
...
ofs_006_0x009219_1F:
; con_F3D6_1F
C - - J - - 0x009219 02:9209: A5 90     LDA ram_0090_t01_pos_X
C - - - - - 0x00921B 02:920B: 85 10     STA ram_0010_t04_pos_X
C - - - - - 0x00921D 02:920D: A5 91     LDA ram_0091_t01_pos_Y
...
C - - - - - 0x0093D0 02:93C0: A5 26     LDA ram_buffer_index_1
...
C - - - - - 0x0094E7 02:94D7: A6 53     LDX ram_obj_index
bra_94D9:
...
C - - - - - 0x0096F2 02:96E2: 85 01     STA ram_0001_tFF_useless_01
...
C - - - - - 0x0096FC 02:96EC: A5 01     LDA ram_0001_tFF_useless_01
...
bra_996F:
C - - - - - 0x00997F 02:996F: A5 90     LDA ram_0090_t01_pos_X
C - - - - - 0x009981 02:9971: 85 00     STA ram_0000_t67_lo
C - - - - - 0x009983 02:9973: A5 91     LDA ram_0091_t01_pos_Y
...
C - - - - - 0x0099F6 02:99E6: 85 02     STA ram_0002_tFC_useless_00
C - - - - - 0x0099F8 02:99E8: A5 00     LDA ram_0000_t67_lo
C - - - - - 0x0099FA 02:99EA: 38        SEC
; bzk optimize, always 00
C - - - - - 0x0099FB 02:99EB: E5 02     SBC ram_0002_tFC_useless_00
...
; bzk optimize, useless STA
C - - - - - 0x009B03 02:9AF3: 85 1E     STA ram_001E_tFD_useless
...
loc_9B29:
; bzk optimize, useless STA
C D 0 - - - 0x009B39 02:9B29: 85 1F     STA ram_001F_tFD_useless
...
C - - - - - 0x009B4B 02:9B3B: A6 53     LDX ram_obj_index
...
C - - - - - 0x009B6D 02:9B5D: A4 53     LDY ram_obj_index
...
loc_9B84:
C D 0 - - - 0x009B94 02:9B84: A6 53     LDX ram_obj_index
C - - - - - 0x009B96 02:9B86: 18        CLC
C - - - - - 0x009B97 02:9B87: 60        RTS
bra_9B88:
C - - - - - 0x009B98 02:9B88: A6 53     LDX ram_obj_index
...
; in
    ; A = 
C - - - - - 0x009E30 02:9E20: 25 00     AND ram_0000_t75_pos_Y
...
bra_9E29:
C - - - - - 0x009E39 02:9E29: A6 53     LDX ram_obj_index
C - - - - - 0x009E3B 02:9E2B: A5 6A     LDA ram_006A
C - - - - - 0x009E3D 02:9E2D: C5 90     CMP ram_0090_t01_pos_X
C - - - - - 0x009E3F 02:9E2F: D0 0E     BNE bra_9E3F
C - - - - - 0x009E41 02:9E31: A5 69     LDA ram_0069
C - - - - - 0x009E43 02:9E33: C5 91     CMP ram_0091_t01_pos_Y
...
C - - - - - 0x009E6A 02:9E5A: 85 00     STA ram_0000_t75_pos_Y
...
C - - - - - 0x009E7A 02:9E6A: 85 00     STA ram_0000_t75_pos_Y
...
; if no matches
- - - - - - 0x009EB5 02:9EA5: A6 53     LDX ram_obj_index
- - - - - - 0x009EB7 02:9EA7: 18        CLC
- - - - - - 0x009EB8 02:9EA8: 60        RTS
bra_9EA9_match:
C - - - - - 0x009EB9 02:9EA9: A6 53     LDX ram_obj_index
...
C - - - - - 0x009F64 02:9F54: 85 90     STA ram_0090_t01_pos_X
C - - - - - 0x009F66 02:9F56: 85 91     STA ram_0091_t01_pos_Y
...
C - - - - - 0x009F83 02:9F73: 85 90     STA ram_0090_t01_pos_X
C - - - - - 0x009F85 02:9F75: 84 91     STY ram_0091_t01_pos_Y
