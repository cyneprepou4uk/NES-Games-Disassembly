...
C - - - - - 0x00A5B9 02:A5A9: 85 1D     STA ram_001D_tFA_useless
C - - - - - 0x00A5BB 02:A5AB: F0 09     BEQ bra_A5B6
C - - - - - 0x00A5BD 02:A5AD: A0 02     LDY #$02
; bzk optimize, useless STY
C - - - - - 0x00A5BF 02:A5AF: 84 1C     STY ram_001C_tFD_useless
...
; bzk optimize, useless STA
C - - - - - 0x00A5D2 02:A5C2: 85 1D     STA ram_001D_tFB_useless
C - - - - - 0x00A5D4 02:A5C4: F0 07     BEQ bra_A5CD
C - - - - - 0x00A5D6 02:A5C6: A0 12     LDY #$12
; bzk optimize, useless STA
C - - - - - 0x00A5D8 02:A5C8: 85 1C     STA ram_001C_tFE_useless
...
C - - - - - 0x00AC27 02:AC17: 85 18     STA ram_0018_tFF_useless
C - - - - - 0x00AC29 02:AC19: 85 19     STA ram_0019_tFF_useless
...
C - - - - - 0x00AEDE 02:AECE: 85 D5     STA ram_00D5_hi
...
C - - - - - 0x00AEFB 02:AEEB: C6 D5     DEC ram_00D5_hi    ; -> FF
bra_AEED:
C - - - - - 0x00AEFD 02:AEED: 85 D4     STA ram_00D4_lo
bra_AEEF_RTS:
...
C - - - - - 0x00AF3C 02:AF2C: A5 DD     LDA ram_00DD_lo
...
C - - - - - 0x00B0CE 02:B0BE: 85 1C     STA ram_001C_tF5_useless
...
C - - - - - 0x00B0D9 02:B0C9: 85 1D     STA ram_001D_tFC_useless
...
C - - - - - 0x00B302 02:B2F2: 85 06     STA ram_0006_t05_ppu_lo
C - - - - - 0x00B304 02:B2F4: A9 2D     LDA #$2D
C - - - - - 0x00B306 02:B2F6: 85 07     STA ram_0007_t01_ppu_hi
...
C - - - - - 0x00B899 02:B889: A4 90     LDY ram_0090_t01_pos_X
...
C - - - - - 0x00B8BA 02:B8AA: A4 91     LDY ram_0091_t01_pos_Y
...
C - - - - - 0x00B8C2 02:B8B2: A4 91     LDY ram_0091_t01_pos_Y
...
C - - - - - 0x00B8CD 02:B8BD: 95 08     STA ram_0008_t04_array,X
...
C - - - - - 0x00B8D5 02:B8C5: A4 91     LDY ram_0091_t01_pos_Y
C - - - - - 0x00B8D7 02:B8C7: A6 90     LDX ram_0090_t01_pos_X
...
sub_B8F6:
C - - - - - 0x00B906 02:B8F6: A6 53     LDX ram_obj_index
...
sub_BAC9:
C - - - - - 0x00BAD9 02:BAC9: 84 91     STY ram_0091_t01_pos_Y
C - - - - - 0x00BADB 02:BACB: E6 91     INC ram_0091_t01_pos_Y
...
C - - - - - 0x00BB11 02:BB01: A5 91     LDA ram_0091_t01_pos_Y
C - - - - - 0x00BB13 02:BB03: 85 00     STA ram_0000_t75_pos_Y
C - - - - - 0x00BB15 02:BB05: A6 53     LDX ram_obj_index
...
C - - - - - 0x00BB75 02:BB65: A6 53     LDX ram_obj_index
