...
C - - - - - 0x018065 06:8055: 85 00     STA ram_0000_t09_copy_data_from
...
C - - - - - 0x018071 06:8061: 85 00     STA ram_0000_t09_copy_data_from
C - - - - - 0x018073 06:8063: E8        INX
C - - - - - 0x018074 06:8064: BD 2A 80  LDA tbl_802A_2nd_quest,X
loc_8067:
C D 0 - - - 0x018077 06:8067: 85 01     STA ram_0000_t09_copy_data_from + $01
...
C - - - - - 0x018087 06:8077: 85 00     STA ram_0000_t09_copy_data_from
C - - - - - 0x018089 06:8079: E8        INX
C - - - - - 0x01808A 06:807A: BD 14 80  LDA tbl_8014,X
C - - - - - 0x01808D 06:807D: 85 01     STA ram_0000_t09_copy_data_from + $01
...
C - - - - - 0x0180A1 06:8091: 85 00     STA ram_0000_t09_copy_data_from
C - - - - - 0x0180A3 06:8093: E8        INX ; 01
C - - - - - 0x0180A4 06:8094: BD 28 80  LDA tbl_8028_bat_table_location,X
C - - - - - 0x0180A7 06:8097: 85 01     STA ram_0000_t09_copy_data_from + $01
...
C - - - - - 0x0180D8 06:80C8: 85 02     STA ram_0002_t06_copy_data_into
C - - - - - 0x0180DA 06:80CA: A9 67     LDA #> ofs_bat_67F0_bank_s1_asm_import
C - - - - - 0x0180DC 06:80CC: 85 03     STA ram_0002_t06_copy_data_into + $01
C - - - - - 0x0180DE 06:80CE: A9 7D     LDA #< ram_687D
C - - - - - 0x0180E0 06:80D0: 85 04     STA ram_0004_t08_max_addr_lo
C - - - - - 0x0180E2 06:80D2: A9 68     LDA #> ram_687D
C - - - - - 0x0180E4 06:80D4: 85 05     STA ram_0005_t01_max_addr_hi
...
loc_80D9_loop:
C D 0 - - - 0x0180E9 06:80D9: B1 00     LDA (ram_0000_t09_copy_data_from),Y
C - - - - - 0x0180EB 06:80DB: 91 02     STA (ram_0002_t06_copy_data_into),Y
C - - - - - 0x0180ED 06:80DD: A5 02     LDA ram_0002_t06_copy_data_into
C - - - - - 0x0180EF 06:80DF: C5 04     CMP ram_0004_t08_max_addr_lo
C - - - - - 0x0180F1 06:80E1: D0 09     BNE bra_80EC_not_finished
C - - - - - 0x0180F3 06:80E3: A5 03     LDA ram_0002_t06_copy_data_into + $01
C - - - - - 0x0180F5 06:80E5: C5 05     CMP ram_0005_t01_max_addr_hi
...
C - - - - - 0x0180FC 06:80EC: A5 02     LDA ram_0002_t06_copy_data_into
C - - - - - 0x0180FE 06:80EE: 18        CLC
C - - - - - 0x0180FF 06:80EF: 69 01     ADC #< $0001
C - - - - - 0x018101 06:80F1: 85 02     STA ram_0002_t06_copy_data_into
C - - - - - 0x018103 06:80F3: A5 03     LDA ram_0002_t06_copy_data_into + $01
C - - - - - 0x018105 06:80F5: 69 00     ADC #> $0001
C - - - - - 0x018107 06:80F7: 85 03     STA ram_0002_t06_copy_data_into + $01
C - - - - - 0x018109 06:80F9: A5 00     LDA ram_0000_t09_copy_data_from
C - - - - - 0x01810B 06:80FB: 18        CLC
C - - - - - 0x01810C 06:80FC: 69 01     ADC #< $0001
C - - - - - 0x01810E 06:80FE: 85 00     STA ram_0000_t09_copy_data_from
C - - - - - 0x018110 06:8100: A5 01     LDA ram_0000_t09_copy_data_from + $01
C - - - - - 0x018112 06:8102: 69 00     ADC #> $0001
C - - - - - 0x018114 06:8104: 85 01     STA ram_0000_t09_copy_data_from + $01
...
C - - - - - 0x01812A 06:811A: 85 00     STA ram_0000_t08_data
C - - - - - 0x01812C 06:811C: B9 A3 83  LDA tbl_83A4 - $01,Y
C - - - - - 0x01812F 06:811F: 85 01     STA ram_0000_t08_data + $01
C - - - - - 0x018131 06:8121: BC B5 83  LDY tbl_83B6_data_size - $01,X
bra_8124_loop:
C - - - - - 0x018134 06:8124: B1 00     LDA (ram_0000_t08_data),Y
