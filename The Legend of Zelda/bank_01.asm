...
.export loc_0x0061C1
.export sub_0x006233
.export loc_0x0062F2_rhombus_rupees_spawn
.export loc_0x00632A
.export loc_0x00635A
.export loc_0x0063FE_rhombus_rupees_collect
...
tbl_85CA_offset:
- - - - - - 0x0045DA 01:85CA: 02        .byte off_85B8_02 - tbl__85B8 + $02   ; 00 
- D 0 - - - 0x0045DB 01:85CB: 05        .byte off_85BB_05 - tbl__85B8 + $02   ; 01 
- D 0 - - - 0x0045DC 01:85CC: 08        .byte off_85BE_08 - tbl__85B8 + $02   ; 02 
- D 0 - - - 0x0045DD 01:85CD: 0B        .byte off_85C1_0B - tbl__85B8 + $02   ; 03 
- D 0 - - - 0x0045DE 01:85CE: 0E        .byte off_85C4_0E - tbl__85B8 + $02   ; 04 
- D 0 - - - 0x0045DF 01:85CF: 11        .byte off_85C7_11 - tbl__85B8 + $02   ; 05 
...
C - - - - - 0x00461C 01:860C: 85 03     STA ram_0003_t02
...
; 
C - - - - - 0x00463F 01:862F: A5 03     LDA ram_0003_t02
...
loc_0x0046EB:
C D 0 - - - 0x0046EB 01:86DB: A5 AD     LDA ram_state_obj + $01
...
bra_871F:
C - - - - - 0x00472F 01:871F: A5 AD     LDA ram_state_obj + $01
...
C - - - - - 0x00474C 01:873C: C0 7B     CPY #$7B    ; con_obj_id
C - - - - - 0x00474E 01:873E: B0 03     BCS bra_8743_secret_to_everybody
C - - - - - 0x004750 01:8740: 4C DB 77  JMP loc_bat_77DB
bra_8743_secret_to_everybody:
...
sub_8797:
C - - - - - 0x0047A7 01:8797: 8D 05 03  STA ram_ppu_buffer + $03
...
C - - - - - 0x0047B9 01:87A9: 86 01     STX ram_0001_t04_decimal_array
C - - - - - 0x0047BB 01:87AB: 86 02     STX ram_0001_t04_decimal_array + $01
C - - - - - 0x0047BD 01:87AD: 86 03     STX ram_0001_t04_decimal_array + $02
C - - - - - 0x0047BF 01:87AF: 4C BF 87  JMP loc_87BF
bra_87B2:
C - - - - - 0x0047C2 01:87B2: 20 55 6E  JSR sub_bat_6E55_convert_to_decimal
...
C - - - - - 0x0047D4 01:87C4: A5 02     LDA ram_0001_t04_decimal_array + $01
C - - - - - 0x0047D6 01:87C6: 20 F7 87  JSR sub_87F7
C - - - - - 0x0047D9 01:87C9: 99 08 03  STA ram_ppu_buffer + $06,Y
C - - - - - 0x0047DC 01:87CC: A5 01     LDA ram_0001_t04_decimal_array
C - - - - - 0x0047DE 01:87CE: 20 F7 87  JSR sub_87F7
C - - - - - 0x0047E1 01:87D1: 99 07 03  STA ram_ppu_buffer + $05,Y
C - - - - - 0x0047E4 01:87D4: A5 03     LDA ram_0001_t04_decimal_array + $02
C - - - - - 0x0047E6 01:87D6: 99 09 03  STA ram_ppu_buffer + $07,Y
...
C - - - - - 0x004804 01:87F4: E6 AD     INC ram_state_obj + $01
...
C - - - - - 0x004816 01:8806: 99 02 03  STA ram_ppu_buffer,Y
...
C - - - - - 0x00484A 01:883A: 85 00     STA ram_0000_t02_text_messages_data
C - - - - - 0x00484C 01:883C: C8        INY
C - - - - - 0x00484D 01:883D: B9 00 80  LDA tbl_8000_text_messages,Y
C - - - - - 0x004850 01:8840: 85 01     STA ram_0000_t02_text_messages_data + $01
C - - - - - 0x004852 01:8842: AC 16 04  LDY ram_0416
C - - - - - 0x004855 01:8845: EE 16 04  INC ram_0416
C - - - - - 0x004858 01:8848: B1 00     LDA (ram_0000_t02_text_messages_data),Y
...
C - - - - - 0x004860 01:8850: 8D 05 03  STA ram_ppu_buffer + $03
C - - - - - 0x004863 01:8853: A9 10     LDA #con_sfx_4_rupee
C - - - - - 0x004865 01:8855: 8D 04 06  STA ram_sfx_4
C - - - - - 0x004868 01:8858: B1 00     LDA (ram_0000_t02_text_messages_data),Y
...
C - - - - - 0x004884 01:8874: E6 AD     INC ram_state_obj + $01
; bzk optimize, JMP
...
C - - - - - 0x004892 01:8882: 85 AD     STA ram_state_obj + $01
...
C - - - - - 0x0048ED 01:88DD: 85 AD     STA ram_state_obj + $01
...
bra_8907:
C - - - - - 0x004917 01:8907: CC 6F 06  CPY ram_item_hearts
...
C - - - - - 0x00499A 01:898A: 85 AD     STA ram_state_obj + $01
...
C - - - - - 0x0049BE 01:89AE: 85 AD     STA ram_state_obj + $01
...
C - - - - - 0x004A03 01:89F3: 99 06 03  STA ram_ppu_buffer + $04,Y
ofs_029_89F6_08_RTS:
...
C - - - - - 0x004ABA 01:8AAA: 8D CE 04  STA ram_04CE_flag
...
C - - - - - 0x004AFD 01:8AED: A5 AD     LDA ram_state_obj + $01
...
C - - - - - 0x004B0D 01:8AFD: E6 AD     INC ram_state_obj + $01
ofs_029_8AFF_02_RTS:
...
C - - - - - 0x004B18 01:8B08: 8D CC 04  STA ram_04CC_flag
...
loc_8B11:
C D 0 - - - 0x004B21 01:8B11: A5 AD     LDA ram_state_obj + $01
...
bra_8B36:
C - - - - - 0x004B46 01:8B36: A5 AD     LDA ram_state_obj + $01
...
C - - - - - 0x004B64 01:8B54: E6 AD     INC ram_state_obj + $01
...
loc_0x004BB6:
C D 0 - - - 0x004BB6 01:8BA6: A5 AD     LDA ram_state_obj + $01
...
bra_8BB8:
C - - - - - 0x004BC8 01:8BB8: A5 AD     LDA ram_state_obj + $01
...
bra_8C1F:
C - - - - - 0x004C2F 01:8C1F: AD 6F 06  LDA ram_item_hearts
C - - - - - 0x004C32 01:8C22: 29 F0     AND #$F0
C - - - - - 0x004C34 01:8C24: C9 30     CMP #$30
C - - - - - 0x004C36 01:8C26: B0 0B     BCS bra_8C33
- - - - - - 0x004C38 01:8C28: 8D 6F 06  STA ram_item_hearts
- - - - - - 0x004C3B 01:8C2B: A9 00     LDA #$00
- - - - - - 0x004C3D 01:8C2D: 8D 70 06  STA ram_item_hearts + $01
- - - - - - 0x004C40 01:8C30: 4C 4D 8C  JMP loc_8C4D
bra_8C33:
C - - - - - 0x004C43 01:8C33: AD 6F 06  LDA ram_item_hearts
...
C - - - - - 0x004C5A 01:8C4A: 8D 6F 06  STA ram_item_hearts
loc_8C4D:
...
C - - - - - 0x004C64 01:8C54: 8D CE 04  STA ram_04CE_flag
C - - - - - 0x004C67 01:8C57: 4C 8D 8C  JMP loc_8C8D



loc_0x004C6A:
C D 0 - - - 0x004C6A 01:8C5A: A5 AD     LDA ram_state_obj + $01
...
bra_8C6F:
C - - - - - 0x004C7F 01:8C6F: A5 AD     LDA ram_state_obj + $01
...
C - - - - - 0x004C8E 01:8C7E: B9 AC 00  LDA ram_state_obj,Y
...
C - - - - - 0x004CB2 01:8CA2: 99 AC 00  STA ram_state_obj,Y   ; con_obj_state_00
...
C - - - - - 0x004D12 01:8D02: 85 00     STA ram_0000_t04_asm_export_data_1
C - - - - - 0x004D14 01:8D04: A9 A5     LDA #> ofs_A500_bank_s2_asm_export
C - - - - - 0x004D16 01:8D06: 85 01     STA ram_0000_t04_asm_export_data_1 + $01
C - - - - - 0x004D18 01:8D08: A9 90     LDA #< ofs_bat_6C90_bank_s2_asm_import
C - - - - - 0x004D1A 01:8D0A: 85 02     STA ram_0002_t01_asm_export_data_2
C - - - - - 0x004D1C 01:8D0C: A9 6C     LDA #> ofs_bat_6C90_bank_s2_asm_import
C - - - - - 0x004D1E 01:8D0E: 85 03     STA ram_0002_t01_asm_export_data_2 + $01
C - - - - - 0x004D20 01:8D10: A0 00     LDY #$00
bra_8D12_loop:
C - - - - - 0x004D22 01:8D12: B1 00     LDA (ram_0000_t04_asm_export_data_1),Y
C - - - - - 0x004D24 01:8D14: 91 02     STA (ram_0002_t01_asm_export_data_2),Y
C - - - - - 0x004D26 01:8D16: A5 00     LDA ram_0000_t04_asm_export_data_1
C - - - - - 0x004D28 01:8D18: 18        CLC
C - - - - - 0x004D29 01:8D19: 69 01     ADC #< $0001
C - - - - - 0x004D2B 01:8D1B: 85 00     STA ram_0000_t04_asm_export_data_1
C - - - - - 0x004D2D 01:8D1D: A5 01     LDA ram_0000_t04_asm_export_data_1 + $01
C - - - - - 0x004D2F 01:8D1F: 69 00     ADC #> $0001
C - - - - - 0x004D31 01:8D21: 85 01     STA ram_0000_t04_asm_export_data_1 + $01
C - - - - - 0x004D33 01:8D23: A5 02     LDA ram_0002_t01_asm_export_data_2
C - - - - - 0x004D35 01:8D25: 18        CLC
C - - - - - 0x004D36 01:8D26: 69 01     ADC #< $0001
C - - - - - 0x004D38 01:8D28: 85 02     STA ram_0002_t01_asm_export_data_2
C - - - - - 0x004D3A 01:8D2A: A5 03     LDA ram_0002_t01_asm_export_data_2 + $01
C - - - - - 0x004D3C 01:8D2C: 69 00     ADC #> $0001
C - - - - - 0x004D3E 01:8D2E: 85 03     STA ram_0002_t01_asm_export_data_2 + $01
...
C - - - - - 0x00605C 01:A04C: A5 06     LDA ram_0006_t10_flag
...
C - - - - - 0x0060A8 01:A098: 95 AC     STA ram_state_obj,X
...
C - - - - - 0x0060BA 01:A0AA: C9 05     CMP #con_script_05_gameplay
...
C - - - - - 0x0060CA 01:A0BA: 85 00     STA ram_0000_t4A_triforce_piece
bra_A0BC_loop:
loc_A0BC_loop:
C - - - - - 0x0060CC 01:A0BC: AD 71 06  LDA ram_item_triforce_pieces
C - - - - - 0x0060CF 01:A0BF: F0 43     BEQ bra_A104_RTS
C - - - - - 0x0060D1 01:A0C1: 24 00     BIT ram_0000_t4A_triforce_piece
...
- - - - - - 0x0060DE 01:A0CE: 06 00     ASL ram_0000_t4A_triforce_piece
- - - - - - 0x0060E0 01:A0D0: 90 EA     BCC bra_A0BC_loop
- - - - - - 0x0060E2 01:A0D2: 26 00     ROL ram_0000_t4A_triforce_piece
- - - - - - 0x0060E4 01:A0D4: 4C BC A0  JMP loc_A0BC_loop
bra_A0D7:
- - - - - - 0x0060E7 01:A0D7: 46 00     LSR ram_0000_t4A_triforce_piece
- - - - - - 0x0060E9 01:A0D9: 90 E1     BCC bra_A0BC_loop
- - - - - - 0x0060EB 01:A0DB: 66 00     ROR ram_0000_t4A_triforce_piece
...
C - - - - - 0x00611E 01:A10E: 20 88 79  JSR sub_bat_7988_set_spr_A
...
bra_A153:
C - - - - - 0x006163 01:A153: B5 AC     LDA ram_state_obj,X
...
C - - - - - 0x006184 01:A174: A9 00     LDA #con_dir_00
C - - - - - 0x006186 01:A176: 85 0F     STA ram_000F_t01_direction
bra_A178:
...
C - - - - - 0x0061EA 01:A1DA: AE 01 03  LDX ram_buffer_index
C - - - - - 0x0061ED 01:A1DD: A0 00     LDY #$00
bra_A1DF_loop:
C - - - - - 0x0061EF 01:A1DF: B9 BD A1  LDA tbl_A1BD,Y
C - - - - - 0x0061F2 01:A1E2: 9D 02 03  STA ram_ppu_buffer,X
...
C - - - - - 0x0061FB 01:A1EB: 8E 01 03  STX ram_buffer_index
...
C - - - - - 0x006205 01:A1F5: 9D 06 03  STA ram_ppu_buffer + $04,X
...
C - - - - - 0x00627F 01:A26F: 85 01     STA ram_0001_t02_copy_pos_Y_link
bra_A271:
loc_A271:
...
C - - - - - 0x006295 01:A285: A5 01     LDA ram_0001_t02_copy_pos_Y_link
C - - - - - 0x006297 01:A287: 18        CLC
C - - - - - 0x006298 01:A288: 79 1F A2  ADC tbl_A21F_pos_Y,Y
...
C - - - - - 0x0062A4 01:A294: 86 03     STX ram_0003_t04
bra_A296_loop:
C - - - - - 0x0062A6 01:A296: C4 03     CPY ram_0003_t04
...
loc_0x0062F2_rhombus_rupees_spawn:
C D 1 - - - 0x0062F2 01:A2E2: BD BF 04  LDA ram_attr_enemy - $01,X
C - - - - - 0x0062F5 01:A2E5: 85 01     STA ram_0001_t20
C - - - - - 0x0062F7 01:A2E7: A9 35     LDA #con_obj_id_35
C - - - - - 0x0062F9 01:A2E9: 85 00     STA ram_0000_t39_obj_id
C - - - - - 0x0062FB 01:A2EB: A2 0A     LDX #$0A
bra_A2ED_loop:
C - - - - - 0x0062FD 01:A2ED: 20 FE A2  JSR sub_A2FE
C - - - - - 0x006300 01:A2F0: BD CD A2  LDA tbl_A2CE_pos_X_rupee - $01,X
C - - - - - 0x006303 01:A2F3: 95 70     STA ram_pos_X_enemy,X
C - - - - - 0x006305 01:A2F5: BD D7 A2  LDA tbl_A2D8_pos_Y_rupee - $01,X
...
sub_A2FE:
C - - - - - 0x00630E 01:A2FE: A5 00     LDA ram_0000_t39_obj_id
...
C - - - - - 0x006318 01:A308: A5 01     LDA ram_0001_t20
...
C - - - - - 0x00632D 01:A31D: 85 01     STA ram_0001_t20
C - - - - - 0x00632F 01:A31F: A0 05     LDY #$05
C - - - - - 0x006331 01:A321: A9 49     LDA #con_obj_id_49
C - - - - - 0x006333 01:A323: 85 00     STA ram_0000_t39_obj_id
...
loc_0x00635A:
C D 1 - - - 0x00635A 01:A34A: B5 AC     LDA ram_state_obj,X
...
C - - - - - 0x006383 01:A373: F6 AC     INC ram_state_obj,X
C - - - - - 0x006385 01:A375: A9 70     LDA #$70
C - - - - - 0x006387 01:A377: 9D BC 03  STA ram_03BC_obj,X
bra_A37A:
...
C - - - - - 0x0063AB 01:A39B: 85 0F     STA ram_000F_t01_direction
...
bra_A3BF:
C - - - - - 0x0063CF 01:A3BF: B5 AC     LDA ram_state_obj,X
...
C - - - - - 0x0063E2 01:A3D2: 20 13 70  JSR sub_bat_7013_get_Y_from_direction
C - - - - - 0x0063E5 01:A3D5: 95 98     STA ram_dir_enemy,X
C - - - - - 0x0063E7 01:A3D7: A9 20     LDA #$20
C - - - - - 0x0063E9 01:A3D9: 9D BC 03  STA ram_03BC_obj,X
C - - - - - 0x0063EC 01:A3DC: F6 AC     INC ram_state_obj,X
bra_A3DE:
...
C - - - - - 0x0063F9 01:A3E9: 95 AC     STA ram_state_obj,X
bra_A3EB:
loc_A3EB:
; bzk optimize, JMP into JMP
...
loc_0x0063FE_rhombus_rupees_collect:
...
; bzk optimize, BEQ
C - - - - - 0x006423 01:A413: 4C 20 A4  JMP loc_A420
bra_A416:
C - - - - - 0x006426 01:A416: 20 93 FA  JSR sub_0x01FAA3
C - - - - - 0x006429 01:A419: A2 16     LDX #con_item_1_rupee
