...
; data is read via 0x00C46F, bank is selected via 0x00C6B6
    ...
    .incbin "incbin/stages/stage_2A.bin"
    .incbin "incbin/stages/stage_2B.bin"
    .incbin "incbin/stages/stage_2C.bin"
    .incbin "incbin/stages/stage_2D.bin"
    .incbin "incbin/stages/stage_2E.bin"
    .incbin "incbin/stages/stage_2F.bin"
    ...
    .incbin "incbin/stages/stage_36.bin"
    .incbin "incbin/stages/stage_37.bin"
    .incbin "incbin/stages/stage_38.bin"
    .incbin "incbin/stages/stage_39.bin"
    .incbin "incbin/stages/stage_3A.bin"
    .incbin "incbin/stages/stage_3B.bin"
    .incbin "incbin/stages/stage_3C.bin"
    .incbin "incbin/stages/stage_3D.bin"
    .incbin "incbin/stages/stage_3E.bin"
    .incbin "incbin/stages/stage_3F.bin"
