...
; data is read via 0x00C46F, bank is selected via 0x00C6B6
    .incbin "incbin/stages/stage_00.bin"
    ...
    .incbin "incbin/stages/stage_0A.bin"
    .incbin "incbin/stages/stage_0B.bin"
    .incbin "incbin/stages/stage_0C.bin"
    .incbin "incbin/stages/stage_0D.bin"
    .incbin "incbin/stages/stage_0E.bin"
    .incbin "incbin/stages/stage_0F.bin"
    ...
    .incbin "incbin/stages/stage_1A.bin"
    .incbin "incbin/stages/stage_1B.bin"
    .incbin "incbin/stages/stage_1C.bin"
    .incbin "incbin/stages/stage_1D.bin"
    .incbin "incbin/stages/stage_1E.bin"
    .incbin "incbin/stages/stage_1F.bin"
