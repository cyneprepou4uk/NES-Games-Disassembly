...
C - - - - - 0x000030 00:8020: 85 00     STA ram_0000
...
C - - - - - 0x00003A 00:802A: 65 00     ADC ram_0000
...
C - - - - - 0x00008E 00:807E: 85 01     STA ram_0001
...
C - - - - - 0x0000CD 00:80BD: 85 01     STA ram_0001
...
C - - - - - 0x0000DC 00:80CC: 26 01     ROL ram_0001
C - - - - - 0x0000DE 00:80CE: 0A        ASL
C - - - - - 0x0000DF 00:80CF: 26 01     ROL ram_0001
C - - - - - 0x0000E1 00:80D1: 0A        ASL
C - - - - - 0x0000E2 00:80D2: 26 01     ROL ram_0001
C - - - - - 0x0000E4 00:80D4: 0A        ASL
C - - - - - 0x0000E5 00:80D5: 26 01     ROL ram_0001
C - - - - - 0x0000E7 00:80D7: 0A        ASL
C - - - - - 0x0000E8 00:80D8: 26 01     ROL ram_0001
C - - - - - 0x0000EA 00:80DA: 18        CLC
C - - - - - 0x0000EB 00:80DB: 69 68     ADC #< tbl_8268_round_data
C - - - - - 0x0000ED 00:80DD: 85 00     STA ram_0000
C - - - - - 0x0000EF 00:80DF: A9 82     LDA #> tbl_8268_round_data
C - - - - - 0x0000F1 00:80E1: 65 01     ADC ram_0001
C - - - - - 0x0000F3 00:80E3: 85 01     STA ram_0001
C - - - - - 0x0000F5 00:80E5: A0 00     LDY #$00
C - - - - - 0x0000F7 00:80E7: B1 00     LDA (ram_0000),Y
C - - - - - 0x0000F9 00:80E9: C8        INY ; 01
C - - - - - 0x0000FA 00:80EA: 85 1C     STA ram_chr_bank_spr_1
C - - - - - 0x0000FC 00:80EC: B1 00     LDA (ram_0000),Y
...
C - - - - - 0x00012C 00:811C: B1 00     LDA (ram_0000),Y
...
C - - - - - 0x000174 00:8164: B1 00     LDA (ram_0000),Y
C - - - - - 0x000176 00:8166: C8        INY ; 04
C - - - - - 0x000177 00:8167: 85 3A     STA ram_003A
C - - - - - 0x000179 00:8169: B1 00     LDA (ram_0000),Y
...
C - - - - - 0x000191 00:8181: B1 00     LDA (ram_0000),Y
C - - - - - 0x000193 00:8183: 65 E3     ADC ram_00E3
C - - - - - 0x000195 00:8185: 8D 05 03  STA ram_0304_round_data + $01
C - - - - - 0x000198 00:8188: C8        INY ; 08
C - - - - - 0x000199 00:8189: B1 00     LDA (ram_0000),Y
C - - - - - 0x00019B 00:818B: C8        INY ; 09
C - - - - - 0x00019C 00:818C: 85 CE     STA ram_00CE
C - - - - - 0x00019E 00:818E: B1 00     LDA (ram_0000),Y
C - - - - - 0x0001A0 00:8190: C8        INY ; 0A
C - - - - - 0x0001A1 00:8191: 85 CF     STA ram_00CF
C - - - - - 0x0001A3 00:8193: B1 00     LDA (ram_0000),Y
C - - - - - 0x0001A5 00:8195: C8        INY ; 0B
C - - - - - 0x0001A6 00:8196: 85 02     STA ram_0002
C - - - - - 0x0001A8 00:8198: 85 C8     STA ram_00C8
C - - - - - 0x0001AA 00:819A: B1 00     LDA (ram_0000),Y
C - - - - - 0x0001AC 00:819C: C8        INY ; 0C
C - - - - - 0x0001AD 00:819D: 85 03     STA ram_0003
C - - - - - 0x0001AF 00:819F: 85 C9     STA ram_00C9
C - - - - - 0x0001B1 00:81A1: B1 00     LDA (ram_0000),Y
C - - - - - 0x0001B3 00:81A3: C8        INY ; 0D
C - - - - - 0x0001B4 00:81A4: 85 DC     STA ram_00DC
C - - - - - 0x0001B6 00:81A6: B1 00     LDA (ram_0000),Y
C - - - - - 0x0001B8 00:81A8: C8        INY ; 0E
C - - - - - 0x0001B9 00:81A9: 85 DD     STA ram_00DD
C - - - - - 0x0001BB 00:81AB: B1 00     LDA (ram_0000),Y
C - - - - - 0x0001BD 00:81AD: C8        INY ; 0F
C - - - - - 0x0001BE 00:81AE: 85 DE     STA ram_00DE
C - - - - - 0x0001C0 00:81B0: B1 00     LDA (ram_0000),Y
C - - - - - 0x0001C2 00:81B2: C8        INY ; 10
C - - - - - 0x0001C3 00:81B3: 85 DF     STA ram_00DF
C - - - - - 0x0001C5 00:81B5: B1 00     LDA (ram_0000),Y
C - - - - - 0x0001C7 00:81B7: C8        INY ; 11
C - - - - - 0x0001C8 00:81B8: 85 E0     STA ram_00E0
C - - - - - 0x0001CA 00:81BA: B1 00     LDA (ram_0000),Y
C - - - - - 0x0001CC 00:81BC: C8        INY ; 12
C - - - - - 0x0001CD 00:81BD: 85 E1     STA ram_00E1
C - - - - - 0x0001CF 00:81BF: B1 00     LDA (ram_0000),Y
C - - - - - 0x0001D1 00:81C1: C8        INY ; 13
C - - - - - 0x0001D2 00:81C2: 85 BD     STA ram_00BD
C - - - - - 0x0001D4 00:81C4: B1 00     LDA (ram_0000),Y
...
C - - - - - 0x000226 00:8216: 85 01     STA ram_0001
C - - - - - 0x000228 00:8218: A5 33     LDA ram_round
C - - - - - 0x00022A 00:821A: 0A        ASL
C - - - - - 0x00022B 00:821B: 26 01     ROL ram_0001
C - - - - - 0x00022D 00:821D: 0A        ASL
C - - - - - 0x00022E 00:821E: 26 01     ROL ram_0001
C - - - - - 0x000230 00:8220: 0A        ASL
C - - - - - 0x000231 00:8221: 26 01     ROL ram_0001
C - - - - - 0x000233 00:8223: 0A        ASL
C - - - - - 0x000234 00:8224: 26 01     ROL ram_0001
C - - - - - 0x000236 00:8226: 0A        ASL
C - - - - - 0x000237 00:8227: 26 01     ROL ram_0001
C - - - - - 0x000239 00:8229: 18        CLC
C - - - - - 0x00023A 00:822A: 69 68     ADC #< tbl_8268_round_data
C - - - - - 0x00023C 00:822C: 85 00     STA ram_0000
C - - - - - 0x00023E 00:822E: A9 82     LDA #> tbl_8268_round_data
C - - - - - 0x000240 00:8230: 65 01     ADC ram_0001
C - - - - - 0x000242 00:8232: 85 01     STA ram_0001
C - - - - - 0x000244 00:8234: A0 1D     LDY #$1D
C - - - - - 0x000246 00:8236: B1 00     LDA (ram_0000),Y
