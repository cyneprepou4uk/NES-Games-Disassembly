...
C - - - - - 0x01801A 06:800A: 85 99     STA ram_0099_spd_Y_lo
...
C - - - - - 0x01802C 06:801C: 85 00     STA ram_0000_t06_jmp
C - - - - - 0x01802E 06:801E: B9 80 85  LDA tbl_8580_hi,Y
C - - - - - 0x018031 06:8021: 85 01     STA ram_0000_t06_jmp + $01
...
C - - - - - 0x018039 06:8029: 6C 00 00  JMP (ram_0000_t06_jmp)
bra_802C:
ofs_802C:
...
C - - - - - 0x01805B 06:804B: A5 3F     LDA ram_003F_timer_00_60
C - - - - - 0x01805D 06:804D: 05 2F     ORA ram_002F_timer
...
C - - - - - 0x018076 06:8066: 8C 60 04  STY ram_0460_t02_ariel_status
...
C - - - - - 0x018080 06:8070: C0 04     CPY #con_ariel_coming_to_ice
C - - - - - 0x018082 06:8072: F0 27     BEQ bra_809B
C - - - - - 0x018084 06:8074: C0 05     CPY #con_ariel_coming_to_surface
C - - - - - 0x018086 06:8076: F0 23     BEQ bra_809B
C - - - - - 0x018088 06:8078: A9 08     LDA #$08
C - - - - - 0x01808A 06:807A: 8D 30 04  STA ram_0430_obj_animation
...
C - - - - - 0x018092 06:8082: 8D 48 04  STA ram_0448_obj
                                       ;LDA #con_ariel_default
C - - - - - 0x018095 06:8085: 8D 60 04  STA ram_0460_t02_ariel_status
C - - - - - 0x018098 06:8088: C0 02     CPY #con_ariel_jumping_out_of_water
C - - - - - 0x01809A 06:808A: D0 0F     BNE bra_809B
C - - - - - 0x01809C 06:808C: 8C 60 04  STY ram_0460_t02_ariel_status
; 
...
C - - - - - 0x0180BE 06:80AE: 8D D0 03  STA ram_obj_direction
C - - - - - 0x0180C1 06:80B1: AD 00 04  LDA ram_0400_obj_flags
C - - - - - 0x0180C4 06:80B4: 29 40     AND #$40
C - - - - - 0x0180C6 06:80B6: F0 21     BEQ bra_80D9_RTS
C - - - - - 0x0180C8 06:80B8: A9 02     LDA #$02
C - - - - - 0x0180CA 06:80BA: 8D D0 03  STA ram_obj_direction
bra_80BD_RTS:
...
bra_80DA:
C - - - - - 0x0180EA 06:80DA: 86 01     STX ram_0001_t02_save_X
C - - - - - 0x0180EC 06:80DC: A6 00     LDX ram_0000_t11_obj_index
...
C - - - - - 0x018104 06:80F4: A6 01     LDX ram_0001_t02_save_X
...
C - - - - - 0x01811B 06:810B: 84 00     STY ram_0000_t11_obj_index
...
C - - - - - 0x01812D 06:811D: 85 01     STA ram_0001_t03_00_or_0C
...
C - - - - - 0x018190 06:8180: 85 01     STA ram_0001_t03_00_or_0C
bra_8182:
C - - - - - 0x018192 06:8182: B9 60 84  LDA tbl_8460,Y
C - - - - - 0x018195 06:8185: 38        SEC
C - - - - - 0x018196 06:8186: E5 01     SBC ram_0001_t03_00_or_0C
C - - - - - 0x018198 06:8188: 9D 30 04  STA ram_0430_obj_animation,X
...
C - - - - - 0x0181C9 06:81B9: A4 00     LDY ram_0000_t11_obj_index
...
C - - - - - 0x0181E0 06:81D0: 85 07     STA ram_0007_t01_pos_X_lo_offset
...
C - - - - - 0x0181F1 06:81E1: 85 07     STA ram_0007_t01_pos_X_lo_offset
bra_81E3:
...
bra_81F0:
C - - - - - 0x018200 06:81F0: 85 05     STA ram_0005_t06_pos_Y_lo
...
C - - - - - 0x018217 06:8207: B9 00 04  LDA ram_0400_obj_flags,Y
...
C - - - - - 0x01823A 06:822A: BD 80 FB  LDA tbl_0x01FB90_pos_X_lo,X
C - - - - - 0x01823D 06:822D: 18        CLC
C - - - - - 0x01823E 06:822E: 65 07     ADC ram_0007_t01_pos_X_lo_offset
C - - - - - 0x018240 06:8230: 85 02     STA ram_0002_t06_pos_X_lo
C - - - - - 0x018242 06:8232: C6 02     DEC ram_0002_t06_pos_X_lo
C - - - - - 0x018244 06:8234: BD 60 FB  LDA tbl_0x01FB70,X
C - - - - - 0x018247 06:8237: 18        CLC
C - - - - - 0x018248 06:8238: 65 07     ADC ram_0007_t01_pos_X_lo_offset
...
bra_8253:
C - - - - - 0x018263 06:8253: C5 02     CMP ram_0002_t06_pos_X_lo
...
bra_8262:
C - - - - - 0x018272 06:8262: 85 1F     STA ram_001F_t01_pos_Y_lo
...
C - - - - - 0x01827D 06:826D: A5 1F     LDA ram_001F_t01_pos_Y_lo
C - - - - - 0x01827F 06:826F: 38        SEC
C - - - - - 0x018280 06:8270: E5 05     SBC ram_0005_t06_pos_Y_lo
...
C - - - - - 0x0182A9 06:8299: B9 F0 03  LDA ram_obj_hp,Y
C - - - - - 0x0182AC 06:829C: 38        SEC
C - - - - - 0x0182AD 06:829D: E9 01     SBC #$01
C - - - - - 0x0182AF 06:829F: 99 F0 03  STA ram_obj_hp,Y
...
C - - - - - 0x0182C5 06:82B5: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x0182ED 06:82DD: 99 30 04  STA ram_0430_obj_animation,Y
...
C - - - - - 0x01832C 06:831C: 99 D0 03  STA ram_obj_direction,Y
C - - - - - 0x01832F 06:831F: B9 00 04  LDA ram_0400_obj_flags,Y
C - - - - - 0x018332 06:8322: 29 40     AND #$40
C - - - - - 0x018334 06:8324: D0 05     BNE bra_832B
C - - - - - 0x018336 06:8326: A9 0A     LDA #$0A
C - - - - - 0x018338 06:8328: 99 D0 03  STA ram_obj_direction,Y
bra_832B:
...
C - - - - - 0x018361 06:8351: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x018364 06:8354: 99 D0 03  STA ram_obj_direction,Y
...
loc_835F:
C D 0 - - - 0x01836F 06:835F: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x01839A 06:838A: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x01839D 06:838D: 49 03     EOR #$03
C - - - - - 0x01839F 06:838F: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x0183AE 06:839E: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x0183B9 06:83A9: BD 30 04  LDA ram_0430_obj_animation,X
...
bra_83B8:
C - - - - - 0x0183C8 06:83B8: BD 30 04  LDA ram_0430_obj_animation,X
...
loc_83D6:
C D 0 - - - 0x0183E6 06:83D6: B9 F0 03  LDA ram_obj_hp,Y
C - - - - - 0x0183E9 06:83D9: 38        SEC
C - - - - - 0x0183EA 06:83DA: E9 01     SBC #$01
C - - - - - 0x0183EC 06:83DC: 99 F0 03  STA ram_obj_hp,Y
C - - - - - 0x0183EF 06:83DF: F0 22     BEQ bra_8403
C - - - - - 0x0183F1 06:83E1: A9 7A     LDA #$7A
C - - - - - 0x0183F3 06:83E3: 99 30 04  STA ram_0430_obj_animation,Y
...
loc_841B:
C D 0 - - - 0x01842B 06:841B: B9 F0 03  LDA ram_obj_hp,Y
C - - - - - 0x01842E 06:841E: 38        SEC
C - - - - - 0x01842F 06:841F: E9 01     SBC #$01
C - - - - - 0x018431 06:8421: 99 F0 03  STA ram_obj_hp,Y
C - - - - - 0x018434 06:8424: F0 14     BEQ bra_843A
C - - - - - 0x018436 06:8426: A9 3C     LDA #$3C
C - - - - - 0x018438 06:8428: 85 7F     STA ram_007F_timer
...
C - - - - - 0x01844E 06:843E: A9 F2     LDA #con_se_cb__F2
...
C - - - - - 0x0185F6 06:85E6: BD 30 04  LDA ram_0430_obj_animation,X
...
bra_85FB:
C - - - - - 0x01860B 06:85FB: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x01861E 06:860E: A5 10     LDA ram_0010_t02
...
C - - - - - 0x018639 06:8629: A5 BE     LDA ram_00BE_flag
C - - - - - 0x01863B 06:862B: C9 30     CMP #$30
C - - - - - 0x01863D 06:862D: D0 18     BNE bra_8647
C - - - - - 0x01863F 06:862F: A5 1A     LDA ram_001A_chest_flag
C - - - - - 0x018641 06:8631: D0 46     BNE bra_8679_RTS
C - - - - - 0x018643 06:8633: 20 BA E7  JSR sub_0x01E7CA_draw_closed_chest
...
C - - - - - 0x018651 06:8641: A5 10     LDA ram_0010_t02
C - - - - - 0x018653 06:8643: F0 02     BEQ bra_8647
C - - - - - 0x018655 06:8645: 90 32     BCC bra_8679_RTS
bra_8647:
loc_8647:
C D 0 - - - 0x018657 06:8647: BD D0 03  LDA ram_obj_direction,X
...
C - - - - - 0x018674 06:8664: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x01869F 06:868F: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x0186A2 06:8692: 29 FB     AND #$04 ^ $FF
C - - - - - 0x0186A4 06:8694: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x0186B4 06:86A4: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x0186B7 06:86A7: 29 BF     AND #$40 ^ $FF
C - - - - - 0x0186B9 06:86A9: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x0186D8 06:86C8: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x0186DB 06:86CB: 29 BF     AND #$40 ^ $FF
C - - - - - 0x0186DD 06:86CD: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x018708 06:86F8: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01870B 06:86FB: 29 BF     AND #$40 ^ $FF
C - - - - - 0x01870D 06:86FD: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x018733 06:8723: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x018736 06:8726: 29 03     AND #$03
C - - - - - 0x018738 06:8728: 19 67 87  ORA tbl_8767,Y
C - - - - - 0x01873B 06:872B: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x01875A 06:874A: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01875D 06:874D: 29 BF     AND #$40 ^ $FF
C - - - - - 0x01875F 06:874F: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x01878F 06:877F: 85 99     STA ram_0099_spd_Y_lo
...
C - - - - - 0x0187EC 06:87DC: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x0187EF 06:87DF: 09 04     ORA #$04
C - - - - - 0x0187F1 06:87E1: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x018808 06:87F8: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01880B 06:87FB: 29 FB     AND #$04 ^ $FF
C - - - - - 0x01880D 06:87FD: 9D 00 04  STA ram_0400_obj_flags,X
bra_8800:
...
C - - - - - 0x01882E 06:881E: 85 2F     STA ram_002F_timer
bra_8820_RTS:
...
sub_8832:
C - - - - - 0x018842 06:8832: 84 02     STY ram_0002_t07_save_Y
...
C - - - - - 0x018878 06:8868: 99 F0 03  STA ram_obj_hp,Y
C - - - - - 0x01887B 06:886B: 8A        TXA
C - - - - - 0x01887C 06:886C: 99 60 04  STA ram_0460_obj,Y
bra_886F:
C - - - - - 0x01887F 06:886F: A4 02     LDY ram_0002_t07_save_Y
...
C - - J - - 0x018882 06:8872: A5 7E     LDA ram_007E_timer
...
C - - - - - 0x018895 06:8885: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x018898 06:8888: 29 FB     AND #$04 ^ $FF
C - - - - - 0x01889A 06:888A: 9D 00 04  STA ram_0400_obj_flags,X
bra_888D_RTS:
...
C - - - - - 0x0188BB 06:88AB: A9 E0     LDA #$E0    ; con_trapped_in_bubble_timer
C - - - - - 0x0188BD 06:88AD: 9D 60 04  STA ram_0460_t03_obj_bubble_trap_timer,X
C - - - - - 0x0188C0 06:88B0: A9 14     LDA #$14
C - - - - - 0x0188C2 06:88B2: 9D 70 04  STA ram_obj_timer,X
C - - - - - 0x0188C5 06:88B5: A9 04     LDA #$04
C - - - - - 0x0188C7 06:88B7: 9D D0 03  STA ram_obj_direction,X
C - - - - - 0x0188CA 06:88BA: FE 00 03  INC ram_obj_flags,X
C - - - - - 0x0188CD 06:88BD: 20 4E 98  JSR sub_984E
bra_88C0:
C - - - - - 0x0188D0 06:88C0: BD 60 04  LDA ram_0460_t03_obj_bubble_trap_timer,X
...
C - - - - - 0x0188E2 06:88D2: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x0188E5 06:88D5: 49 0C     EOR #$0C
C - - - - - 0x0188E7 06:88D7: 9D D0 03  STA ram_obj_direction,X
C - - - - - 0x0188EA 06:88DA: A9 0C     LDA #$0C
C - - - - - 0x0188EC 06:88DC: 9D 70 04  STA ram_obj_timer,X
bra_88DF:
C - - - - - 0x0188EF 06:88DF: DE 60 04  DEC ram_0460_t03_obj_bubble_trap_timer,X
C - - - - - 0x0188F2 06:88E2: D0 5A     BNE bra_893E_RTS
C - - - - - 0x0188F4 06:88E4: A9 09     LDA #$09
C - - - - - 0x0188F6 06:88E6: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x018906 06:88F6: BD 30 04  LDA ram_0430_obj_animation,X
C - - - - - 0x018909 06:88F9: C9 7B     CMP #$7B
C - - - - - 0x01890B 06:88FB: B0 0A     BCS bra_8907    ; if trapped in green bubble
; if trapped in purple bubble
C - - - - - 0x01890D 06:88FD: A9 05     LDA #$05
C - - - - - 0x01890F 06:88FF: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x018932 06:8922: A5 10     LDA ram_0010_t02
...
C - - - - - 0x018946 06:8936: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x018949 06:8939: 49 03     EOR #$03
C - - - - - 0x01894B 06:893B: 9D D0 03  STA ram_obj_direction,X
bra_893E_RTS:
C - - - - - 0x01894E 06:893E: 60        RTS
bra_893F:
C - - - - - 0x01894F 06:893F: BD D0 03  LDA ram_obj_direction,X
...
C - - - - - 0x018968 06:8958: AD 30 04  LDA ram_0430_obj_animation
...
bra_89BB:
loc_89BB:
C D 0 - - - 0x0189CB 06:89BB: AD 30 04  LDA ram_0430_obj_animation
...
bra_89D1:
C - - - - - 0x0189E1 06:89D1: AD 00 04  LDA ram_0400_obj_flags
loc_89D4:
...
C - - - - - 0x018A38 06:8A28: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x018A3B 06:8A2B: 09 04     ORA #$04
C - - - - - 0x018A3D 06:8A2D: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x018A6A 06:8A5A: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x018A6D 06:8A5D: 49 0C     EOR #$0C
C - - - - - 0x018A6F 06:8A5F: 9D D0 03  STA ram_obj_direction,X
bra_8A62:
...
; bzk oprimize, delete STA, BCC to 0x018AC1
C - - - - - 0x018ABB 06:8AAB: 85 00     STA ram_0000_t12
C - - - - - 0x018ABD 06:8AAD: B0 04     BCS bra_8AB3
; C = 0
- - - - - - 0x018ABF 06:8AAF: 69 0F     ADC #$0F
- - - - - - 0x018AC1 06:8AB1: 85 00     STA ram_0000_t12
bra_8AB3:
bra_8AB3_loop:
C - - - - - 0x018AC3 06:8AB3: B9 00 03  LDA ram_obj_flags,Y
C - - - - - 0x018AC6 06:8AB6: 10 5B     BPL bra_8B13
C - - - - - 0x018AC8 06:8AB8: B9 00 04  LDA ram_0400_obj_flags,Y
C - - - - - 0x018ACB 06:8ABB: 10 56     BPL bra_8B13
C - - - - - 0x018ACD 06:8ABD: B9 30 04  LDA ram_0430_obj_animation,Y
...
bra_8AF3:
C - - - - - 0x018B03 06:8AF3: E5 00     SBC ram_0000_t12
...
C - - - - - 0x018B0F 06:8AFF: B9 30 04  LDA ram_0430_obj_animation,Y
...
bra_8B1B:
C - - - - - 0x018B2B 06:8B1B: 86 00     STX ram_0000_t13_save_X
...
bra_8B27:
C - - - - - 0x018B37 06:8B27: A6 00     LDX ram_0000_t13_save_X
...
C - - - - - 0x018B58 06:8B48: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x018B5B 06:8B4B: 09 08     ORA #$08
C - - - - - 0x018B5D 06:8B4D: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x018B74 06:8B64: 86 0F     STX ram_000F_t01_save_X
...
C - - - - - 0x018BB3 06:8BA3: 99 F0 03  STA ram_obj_hp,Y
C - - - - - 0x018BB6 06:8BA6: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x018BB9 06:8BA9: 49 03     EOR #$03
C - - - - - 0x018BBB 06:8BAB: 09 04     ORA #$04
C - - - - - 0x018BBD 06:8BAD: 99 D0 03  STA ram_obj_direction,Y
C - - - - - 0x018BC0 06:8BB0: 98        TYA
C - - - - - 0x018BC1 06:8BB1: AA        TAX
C - - - - - 0x018BC2 06:8BB2: 20 89 FC  JSR sub_0x01FC99
C - - - - - 0x018BC5 06:8BB5: A6 0F     LDX ram_000F_t01_save_X
bra_8BB7_RTS:
...
C - - - - - 0x018BD9 06:8BC9: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x018BDC 06:8BCC: 09 04     ORA #$04
C - - - - - 0x018BDE 06:8BCE: 9D D0 03  STA ram_obj_direction,X
...
bra_8C0F:
C - - - - - 0x018C1F 06:8C0F: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x018C4E 06:8C3E: 86 0F     STX ram_000F_t02_save_X
...
C - - - - - 0x018C67 06:8C57: 99 F0 03  STA ram_obj_hp,Y
...
C - - - - - 0x018C90 06:8C80: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x018C93 06:8C83: 99 D0 03  STA ram_obj_direction,Y
...
C - - - - - 0x018CAC 06:8C9C: A6 0F     LDX ram_000F_t02_save_X
...
C - - J - - 0x018CB3 06:8CA3: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x018CE3 06:8CD3: 9D D0 03  STA ram_obj_direction,X
bra_8CD6:
C - - - - - 0x018CE6 06:8CD6: BD D0 03  LDA ram_obj_direction,X
...
C - - - - - 0x018CF3 06:8CE3: 1D D0 03  ORA ram_obj_direction,X
C - - - - - 0x018CF6 06:8CE6: 9D D0 03  STA ram_obj_direction,X
C - - - - - 0x018CF9 06:8CE9: 20 00 FD  JSR sub_0x01FD10_move_object_Y_axis
C - - - - - 0x018CFC 06:8CEC: BD D0 03  LDA ram_obj_direction,X
...
C - - - - - 0x018D0E 06:8CFE: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x018D11 06:8D01: 49 0C     EOR #$0C
C - - - - - 0x018D13 06:8D03: 9D D0 03  STA ram_obj_direction,X
...
bra_8D37:
C - - - - - 0x018D47 06:8D37: BD 00 04  LDA ram_0400_obj_flags,X
...
C - - - - - 0x018D75 06:8D65: 99 F0 03  STA ram_obj_hp,Y
C - - - - - 0x018D78 06:8D68: A9 0B     LDA #con_obj_id_projectile_octopus
C - - - - - 0x018D7A 06:8D6A: 99 10 03  STA ram_obj_id,Y
C - - - - - 0x018D7D 06:8D6D: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x018D80 06:8D70: 29 03     AND #$03
C - - - - - 0x018D82 06:8D72: 99 D0 03  STA ram_obj_direction,Y
C - - - - - 0x018D85 06:8D75: 86 00     STX ram_0000_t14_save_X
...
C - - - - - 0x018DA3 06:8D93: B9 D0 03  LDA ram_obj_direction,Y
...
C - - - - - 0x018DBC 06:8DAC: A6 00     LDX ram_0000_t14_save_X
...
C - - - - - 0x018DE6 06:8DD6: B9 30 04  LDA ram_0430_obj_animation,Y
...
C - - - - - 0x018E00 06:8DF0: A5 00     LDA ram_0000_t15_counter
...
C - - - - - 0x018E13 06:8E03: 85 0F     STA ram_000F_t05_loop_counter
...
C - - - - - 0x018E34 06:8E24: 99 F0 03  STA ram_obj_hp,Y
...
C - - - - - 0x018E61 06:8E51: A6 0F     LDX ram_000F_t05_loop_counter
C - - - - - 0x018E63 06:8E53: BD 7D 8E  LDA tbl_8E7D_direction,X
C - - - - - 0x018E66 06:8E56: 99 D0 03  STA ram_obj_direction,Y
...
C - - - - - 0x018E86 06:8E76: C6 0F     DEC ram_000F_t05_loop_counter
...
C - - J - - 0x018E9C 06:8E8C: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x018EB4 06:8EA4: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x018EE5 06:8ED5: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x018EE8 06:8ED8: 49 03     EOR #$03
C - - - - - 0x018EEA 06:8EDA: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x018F21 06:8F11: 85 0F     STA ram_000F_t06_loop_counter
...
C - - - - - 0x018F3B 06:8F2B: 99 F0 03  STA ram_obj_hp,Y
...
C - - - - - 0x018F6D 06:8F5D: A6 0F     LDX ram_000F_t06_loop_counter
C - - - - - 0x018F6F 06:8F5F: BD 6C 8F  LDA tbl_8F6C_direction,X
C - - - - - 0x018F72 06:8F62: 99 D0 03  STA ram_obj_direction,Y
C - - - - - 0x018F75 06:8F65: A6 0E     LDX ram_000E_t02_obj_index
C - - - - - 0x018F77 06:8F67: C6 0F     DEC ram_000F_t06_loop_counter
...
C - - - - - 0x018FA2 06:8F92: 9D D0 03  STA ram_obj_direction,X
...
bra_8FAD:
C - - - - - 0x018FBD 06:8FAD: BD D0 03  LDA ram_obj_direction,X
...
C - - - - - 0x018FCE 06:8FBE: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x018FD1 06:8FC1: 49 03     EOR #$03
C - - - - - 0x018FD3 06:8FC3: 9D D0 03  STA ram_obj_direction,X
bra_8FC6_RTS:
...
C - - - - - 0x018FF2 06:8FE2: A9 90     LDA #$10 + $80
C - - - - - 0x018FF4 06:8FE4: 99 00 04  STA ram_0400_obj_flags,Y
C - - - - - 0x018FF7 06:8FE7: A9 23     LDA #$23
C - - - - - 0x018FF9 06:8FE9: 99 30 04  STA ram_0430_obj_animation,Y
C - - - - - 0x018FFC 06:8FEC: A9 40     LDA #$40
C - - - - - 0x018FFE 06:8FEE: 99 C0 03  STA ram_03C0_obj,Y
C - - - - - 0x019001 06:8FF1: A9 01     LDA #$01
C - - - - - 0x019003 06:8FF3: 99 F0 03  STA ram_obj_hp,Y
...
C - - - - - 0x01903C 06:902C: 99 D0 03  STA ram_obj_direction,Y
...
C - - - - - 0x019072 06:9062: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x019075 06:9065: 49 03     EOR #$03
C - - - - - 0x019077 06:9067: 9D D0 03  STA ram_obj_direction,X
bra_906A:
...
C - - - - - 0x0190B0 06:90A0: 9D D0 03  STA ram_obj_direction,X
C - - - - - 0x0190B3 06:90A3: BD 30 04  LDA ram_0430_obj_animation,X
C - - - - - 0x0190B6 06:90A6: 09 01     ORA #$01
C - - - - - 0x0190B8 06:90A8: 4C 45 FC  JMP loc_0x01FC55
bra_90AB:
C - - - - - 0x0190BB 06:90AB: BD 30 04  LDA ram_0430_obj_animation,X
...
bra_90D0:
C - - - - - 0x0190E0 06:90D0: BD D0 03  LDA ram_obj_direction,X
...
C - - - - - 0x0190F5 06:90E5: 85 00     STA ram_0000_t16
C - - - - - 0x0190F7 06:90E7: BD 30 04  LDA ram_0430_obj_animation,X
C - - - - - 0x0190FA 06:90EA: 29 01     AND #$01
C - - - - - 0x0190FC 06:90EC: 0A        ASL
C - - - - - 0x0190FD 06:90ED: 05 00     ORA ram_0000_t16
C - - - - - 0x0190FF 06:90EF: A8        TAY
C - - - - - 0x019100 06:90F0: B9 3B 91  LDA tbl_913B,Y
C - - - - - 0x019103 06:90F3: 9D 60 04  STA ram_0460_obj,X
bra_90F6:
C - - - - - 0x019106 06:90F6: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x019114 06:9104: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x019117 06:9107: 49 03     EOR #$03
C - - - - - 0x019119 06:9109: 9D D0 03  STA ram_obj_direction,X
bra_910C:
C - - - - - 0x01911C 06:910C: DE 60 04  DEC ram_0460_obj,X
C - - - - - 0x01911F 06:910F: D0 29     BNE bra_913A_RTS
C - - - - - 0x019121 06:9111: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x01913B 06:912B: BD 30 04  LDA ram_0430_obj_animation,X
...
- - - - - - 0x019160 06:9150: 9D D0 03  STA ram_obj_direction,X
...
- - - - - - 0x019193 06:9183: BD D0 03  LDA ram_obj_direction,X
- - - - - - 0x019196 06:9186: 29 04     AND #$04
- - - - - - 0x019198 06:9188: D0 2A     BNE bra_91B4
- - - - - - 0x01919A 06:918A: 60        RTS
bra_918B:
- - - - - - 0x01919B 06:918B: BD D0 03  LDA ram_obj_direction,X
...
- - - - - - 0x0191A7 06:9197: BD 00 04  LDA ram_0400_obj_flags,X
- - - - - - 0x0191AA 06:919A: 49 40     EOR #$40
- - - - - - 0x0191AC 06:919C: 9D 00 04  STA ram_0400_obj_flags,X
...
- - - - - - 0x0191D4 06:91C4: BD D0 03  LDA ram_obj_direction,X
- - - - - - 0x0191D7 06:91C7: 49 0C     EOR #$0C
- - - - - - 0x0191D9 06:91C9: 9D D0 03  STA ram_obj_direction,X
- - - - - - 0x0191DC 06:91CC: 29 03     AND #$03
- - - - - - 0x0191DE 06:91CE: F0 08     BEQ bra_91D8_RTS
- - - - - - 0x0191E0 06:91D0: BD D0 03  LDA ram_obj_direction,X
- - - - - - 0x0191E3 06:91D3: 49 03     EOR #$03
- - - - - - 0x0191E5 06:91D5: 9D D0 03  STA ram_obj_direction,X
bra_91D8_RTS:
loc_91D8_RTS:
...
C - - - - - 0x019221 06:9211: BD 00 04  LDA ram_0400_obj_flags,X
...
C - - - - - 0x01923E 06:922E: BD D0 03  LDA ram_obj_direction,X
...
bra_9258:
C - - - - - 0x019268 06:9258: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x01926B 06:925B: 49 0F     EOR #$0F
C - - - - - 0x01926D 06:925D: 9D D0 03  STA ram_obj_direction,X
C - - - - - 0x019270 06:9260: A9 20     LDA #$20
C - - - - - 0x019272 06:9262: 9D 60 04  STA ram_0460_obj,X
bra_9265:
C - - - - - 0x019275 06:9265: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x019278 06:9268: 48        PHA
C - - - - - 0x019279 06:9269: 20 23 92  JSR sub_9223
C - - - - - 0x01927C 06:926C: 68        PLA
C - - - - - 0x01927D 06:926D: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x0192C8 06:92B8: B9 30 04  LDA ram_0430_obj_animation,Y
...
C - - - - - 0x0192EE 06:92DE: 85 01     STA ram_0001_t04_pos_X_lo
C - - - - - 0x0192F0 06:92E0: BD 40 03  LDA ram_pos_X_hi,X
C - - - - - 0x0192F3 06:92E3: 79 64 93  ADC tbl_9363_pos_X + $01,Y
C - - - - - 0x0192F6 06:92E6: 85 02     STA ram_0002_t08_pos_X_hi
...
C - - - - - 0x019311 06:9301: A9 90     LDA #$10 + $80
C - - - - - 0x019313 06:9303: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x019322 06:9312: 9D F0 03  STA ram_obj_hp,X
...
C - - - - - 0x01932E 06:931E: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x01933D 06:932D: A5 01     LDA ram_0001_t04_pos_X_lo
...
bra_935A:
C - - - - - 0x01936A 06:935A: A6 00     LDX ram_0000_t17_save_X
bra_935C_RTS:
...
C - - J - - 0x019377 06:9367: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x0193A1 06:9391: 86 00     STX ram_0000_t18_save_X
C - - - - - 0x0193A3 06:9393: BD 30 03  LDA ram_pos_X_lo,X
C - - - - - 0x0193A6 06:9396: 85 01     STA ram_0001_t05_pos_X_lo
...
C - - - - - 0x0193C3 06:93B3: A9 90     LDA #$10 + $80
C - - - - - 0x0193C5 06:93B5: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x0193EA 06:93DA: A5 01     LDA ram_0001_t05_pos_X_lo
...
bra_9405:
C - - - - - 0x019415 06:9405: A6 00     LDX ram_0000_t18_save_X
...
C - - - - - 0x019449 06:9439: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x0194AF 06:949F: 85 00     STA ram_0000_t20
C - - - - - 0x0194B1 06:94A1: 0A        ASL
C - - - - - 0x0194B2 06:94A2: 0A        ASL
C - - - - - 0x0194B3 06:94A3: 65 00     ADC ram_0000_t20
...
C - - - - - 0x0194C0 06:94B0: 85 00     STA ram_0000_t21
C - - - - - 0x0194C2 06:94B2: 0A        ASL
C - - - - - 0x0194C3 06:94B3: 0A        ASL
C - - - - - 0x0194C4 06:94B4: 65 00     ADC ram_0000_t21
...
C - - - - - 0x0194DF 06:94CF: 99 F0 03  STA ram_obj_hp,Y
...
C - - - - - 0x0194FE 06:94EE: 99 D0 03  STA ram_obj_direction,Y
...
C - - - - - 0x019517 06:9507: 86 00     STX ram_0000_t22_obj_index
...
C - - - - - 0x01952B 06:951B: A6 00     LDX ram_0000_t22_obj_index
...
C - - - - - 0x019545 06:9535: A6 00     LDX ram_0000_t22_obj_index
...
C - - J - - 0x01955F 06:954F: BD D0 03  LDA ram_obj_direction,X
...
C - - - - - 0x019572 06:9562: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x019575 06:9565: 09 04     ORA #$04
C - - - - - 0x019577 06:9567: 9D 00 04  STA ram_0400_obj_flags,X
C - - - - - 0x01957A 06:956A: DE 60 04  DEC ram_0460_obj,X
C - - - - - 0x01957D 06:956D: D0 DF     BNE bra_954E_RTS
C - - - - - 0x01957F 06:956F: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x019582 06:9572: 29 FB     AND #$04 ^ $FF
C - - - - - 0x019584 06:9574: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x01959C 06:958C: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x019622 06:9612: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x019625 06:9615: 29 FB     AND #$04 ^ $FF
C - - - - - 0x019627 06:9617: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x0196DB 06:96CB: DE 30 04  DEC ram_0430_obj_animation,X
...
bra_96FD:
loc_96FD:
C D 0 - - - 0x01970D 06:96FD: 86 0F     STX ram_000F_t03_save_X
...
C - - - - - 0x019725 06:9715: 99 F0 03  STA ram_obj_hp,Y
...
C - - - - - 0x019760 06:9750: A6 0F     LDX ram_000F_t03_save_X
...
C - - - - - 0x019782 06:9772: B9 D0 03  LDA ram_obj_direction,Y
C - - - - - 0x019785 06:9775: 9D D0 03  STA ram_obj_direction,X
...
bra_97A5:
C - - - - - 0x0197B5 06:97A5: A5 BE     LDA ram_00BE_flag
C - - - - - 0x0197B7 06:97A7: C9 30     CMP #$30
C - - - - - 0x0197B9 06:97A9: D0 07     BNE bra_97B2
- - - - - - 0x0197BB 06:97AB: A5 1A     LDA ram_001A_chest_flag
- - - - - - 0x0197BD 06:97AD: D0 03     BNE bra_97B2
- - - - - - 0x0197BF 06:97AF: 20 BA E7  JSR sub_0x01E7CA_draw_closed_chest
bra_97B2:
...
bra_97BD:
C - - - - - 0x0197CD 06:97BD: A5 BE     LDA ram_00BE_flag
C - - - - - 0x0197CF 06:97BF: C9 30     CMP #$30
C - - - - - 0x0197D1 06:97C1: D0 07     BNE bra_97CA
C - - - - - 0x0197D3 06:97C3: A5 1A     LDA ram_001A_chest_flag
C - - - - - 0x0197D5 06:97C5: D0 0D     BNE bra_97D4_RTS
C - - - - - 0x0197D7 06:97C7: 20 BA E7  JSR sub_0x01E7CA_draw_closed_chest
bra_97CA:
...
C - - - - - 0x019803 06:97F3: B9 D0 03  LDA ram_obj_direction,Y
C - - - - - 0x019806 06:97F6: 9D D0 03  STA ram_obj_direction,X
...
loc_984E:
sub_984E:
C D 0 - - - 0x01985E 06:984E: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x019861 06:9851: 29 BF     AND #$40 ^ $FF
C - - - - - 0x019863 06:9853: 9D 00 04  STA ram_0400_obj_flags,X
C - - - - - 0x019866 06:9856: 60        RTS



sub_9857:
C - - - - - 0x019867 06:9857: A5 BE     LDA ram_00BE_flag
C - - - - - 0x019869 06:9859: C9 30     CMP #$30
C - - - - - 0x01986B 06:985B: D0 09     BNE bra_9866_RTS
C - - - - - 0x01986D 06:985D: A5 1A     LDA ram_001A_chest_flag
C - - - - - 0x01986F 06:985F: D0 05     BNE bra_9866_RTS
C - - - - - 0x019871 06:9861: 20 BA E7  JSR sub_0x01E7CA_draw_closed_chest
...
C - - - - - 0x019882 06:9872: A5 10     LDA ram_0010_t02
C - - - - - 0x019884 06:9874: D0 04     BNE bra_987A
C - - - - - 0x019886 06:9876: A9 40     LDA #$40
C - - - - - 0x019888 06:9878: 85 99     STA ram_0099_spd_Y_lo
bra_987A:
...
bra_9889:
C - - - - - 0x019899 06:9889: A5 99     LDA ram_0099_spd_Y_lo
...
C - - - - - 0x0198B4 06:98A4: 9D D0 03  STA ram_obj_direction,X
bra_98A7:
...
bra_98BF:
C - - - - - 0x0198CF 06:98BF: A5 BE     LDA ram_00BE_flag
C - - - - - 0x0198D1 06:98C1: C9 30     CMP #$30
C - - - - - 0x0198D3 06:98C3: D0 07     BNE bra_98CC
C - - - - - 0x0198D5 06:98C5: A5 1A     LDA ram_001A_chest_flag
C - - - - - 0x0198D7 06:98C7: D0 03     BNE bra_98CC
C - - - - - 0x0198D9 06:98C9: 20 BA E7  JSR sub_0x01E7CA_draw_closed_chest
bra_98CC:
...
C - - - - - 0x0198E6 06:98D6: A5 BE     LDA ram_00BE_flag
C - - - - - 0x0198E8 06:98D8: C9 30     CMP #$30
C - - - - - 0x0198EA 06:98DA: D0 07     BNE bra_98E3
C - - - - - 0x0198EC 06:98DC: A5 1A     LDA ram_001A_chest_flag
C - - - - - 0x0198EE 06:98DE: D0 03     BNE bra_98E3
C - - - - - 0x0198F0 06:98E0: 20 BA E7  JSR sub_0x01E7CA_draw_closed_chest
bra_98E3:
C - - - - - 0x0198F3 06:98E3: 28        PLP
C - - - - - 0x0198F4 06:98E4: 90 05     BCC bra_98EB
C - - - - - 0x0198F6 06:98E6: A9 00     LDA #$00
C - - - - - 0x0198F8 06:98E8: 9D D0 03  STA ram_obj_direction,X
bra_98EB:
...
C - - - - - 0x01990F 06:98FF: B9 D0 03  LDA ram_obj_direction,Y
C - - - - - 0x019912 06:9902: 9D D0 03  STA ram_obj_direction,X
C - - - - - 0x019915 06:9905: 4C 23 99  JMP loc_9923
bra_9908:
C - - - - - 0x019918 06:9908: BD D0 03  LDA ram_obj_direction,X
...
C - - - - - 0x019924 06:9914: 9D D0 03  STA ram_obj_direction,X
C - - - - - 0x019927 06:9917: AD 00 04  LDA ram_0400_obj_flags
C - - - - - 0x01992A 06:991A: 29 40     AND #$40
C - - - - - 0x01992C 06:991C: D0 05     BNE bra_9923
C - - - - - 0x01992E 06:991E: A9 02     LDA #$02
C - - - - - 0x019930 06:9920: 9D D0 03  STA ram_obj_direction,X
bra_9923:
loc_9923:
C D 0 - - - 0x019933 06:9923: A9 00     LDA #$00
C - - - - - 0x019935 06:9925: 9D 60 04  STA ram_0460_obj,X
C - - - - - 0x019938 06:9928: A5 99     LDA ram_0099_spd_Y_lo
...
C - - - - - 0x0199A7 06:9997: A5 10     LDA ram_0010_t02
...
C - - - - - 0x0199B0 06:99A0: 29 FB     AND #$04 ^ $FF
C - - - - - 0x0199B2 06:99A2: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x0199CC 06:99BC: 9D D0 03  STA ram_obj_direction,X
bra_99BF:
...
C - - - - - 0x019ABF 06:9AAF: DD 30 04  CMP ram_0430_obj_animation,X
...
C - - - - - 0x019AF0 06:9AE0: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x019B28 06:9B18: DD 30 04  CMP ram_0430_obj_animation,X
...
C - - - - - 0x019B59 06:9B49: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x019B8F 06:9B7F: 85 00     STA ram_0000_t23_loop_counter
...
C - - - - - 0x019BA2 06:9B92: C6 00     DEC ram_0000_t23_loop_counter
...
C - - - - - 0x019BBE 06:9BAE: 20 09 A6  JSR sub_A609_wait_for_boss
...
C - - - - - 0x019C5B 06:9C4B: 86 0F     STX ram_000F_t07_obj_index
...
C - - - - - 0x019C74 06:9C64: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x019C77 06:9C67: 99 D0 03  STA ram_obj_direction,Y
...
C - - - - - 0x019C83 06:9C73: A6 0F     LDX ram_000F_t07_obj_index
...
C - - - - - 0x019C93 06:9C83: A6 0F     LDX ram_000F_t07_obj_index
...
C - - - - - 0x019CAE 06:9C9E: 99 F0 03  STA ram_obj_hp,Y
...
C - - - - - 0x019CE3 06:9CD3: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x019CE6 06:9CD6: 29 FB     AND #$04 ^ $FF
C - - - - - 0x019CE8 06:9CD8: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x019D1D 06:9D0D: BD D0 03  LDA ram_obj_direction,X
...
C - - - - - 0x019D37 06:9D27: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x019D3A 06:9D2A: 09 04     ORA #$04
C - - - - - 0x019D3C 06:9D2C: 9D 00 04  STA ram_0400_obj_flags,X
...
; A = 00
C - - - - - 0x019D51 06:9D41: 85 BC     STA ram_00BC_obj_index
C - - - - - 0x019D53 06:9D43: 20 09 A6  JSR sub_A609_wait_for_boss
...
C - - - - - 0x019D73 06:9D63: 85 00     STA ram_0000_t24
...
C - - - - - 0x019D7D 06:9D6D: A4 00     LDY ram_0000_t24
...
bra_9D90:
C - - - - - 0x019DA0 06:9D90: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x019DAC 06:9D9C: DE 30 04  DEC ram_0430_obj_animation,X
bra_9D9F:
C - - - - - 0x019DAF 06:9D9F: DE 60 04  DEC ram_0460_obj,X
C - - - - - 0x019DB2 06:9DA2: F0 14     BEQ bra_9DB8
C - - - - - 0x019DB4 06:9DA4: A4 BC     LDY ram_00BC_obj_index
...
C - - - - - 0x019DC1 06:9DB1: 85 BC     STA ram_00BC_obj_index
...
C - - - - - 0x019DF5 06:9DE5: A5 00     LDA ram_0000_t25_counter
...
C - - - - - 0x019E0C 06:9DFC: 86 0F     STX ram_000F_t08_obj_index
C - - - - - 0x019E0E 06:9DFE: 20 54 FE  JSR sub_0x01FE64
C - - - - - 0x019E11 06:9E01: B0 85     BCS bra_9D88_RTS
C - - - - - 0x019E13 06:9E03: 84 BC     STY ram_00BC_obj_index
...
C - - - - - 0x019E20 06:9E10: A6 0F     LDX ram_000F_t08_obj_index
...
C - - - - - 0x019E36 06:9E26: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x019E39 06:9E29: 99 D0 03  STA ram_obj_direction,Y
...
C - - - - - 0x019E59 06:9E49: 99 F0 03  STA ram_obj_hp,Y
...
loc_9E5A:
C D 0 - - - 0x019E6A 06:9E5A: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x019E6D 06:9E5D: 49 40     EOR #$40
C - - - - - 0x019E6F 06:9E5F: 9D 00 04  STA ram_0400_obj_flags,X
C - - - - - 0x019E72 06:9E62: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x019E75 06:9E65: 49 03     EOR #$03
C - - - - - 0x019E77 06:9E67: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x019E85 06:9E75: BD D0 03  LDA ram_obj_direction,X
...
C - - - - - 0x019E91 06:9E81: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x019E94 06:9E84: 29 FB     AND #$04 ^ $FF
C - - - - - 0x019E96 06:9E86: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x019EAF 06:9E9F: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x019EB2 06:9EA2: 09 04     ORA #$04
C - - - - - 0x019EB4 06:9EA4: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x019EE0 06:9ED0: BD 30 04  LDA ram_0430_obj_animation,X
...
bra_9EE6:
C - - - - - 0x019EF6 06:9EE6: BD 30 04  LDA ram_0430_obj_animation,X
C - - - - - 0x019EF9 06:9EE9: C9 40     CMP #$40
C - - - - - 0x019EFB 06:9EEB: D0 72     BNE bra_9F5F_RTS
C - - - - - 0x019EFD 06:9EED: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x019F00 06:9EF0: 29 BF     AND #$40 ^ $FF
C - - - - - 0x019F02 06:9EF2: 9D 00 04  STA ram_0400_obj_flags,X
C - - - - - 0x019F05 06:9EF5: 60        RTS
bra_9EF6:
C - - - - - 0x019F06 06:9EF6: 20 DF FC  JSR sub_0x01FCEF_move_object_X_axis
C - - - - - 0x019F09 06:9EF9: A0 00     LDY #$00
C - - - - - 0x019F0B 06:9EFB: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x019F20 06:9F10: 85 BC     STA ram_00BC_obj_index
bra_9F12:
C - - - - - 0x019F22 06:9F12: 20 2F F8  JSR sub_0x01F83F
C - - - - - 0x019F25 06:9F15: B0 CF     BCS bra_9EE6
C - - - - - 0x019F27 06:9F17: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x019F77 06:9F67: 20 09 A6  JSR sub_A609_wait_for_boss
...
C - - - - - 0x019F8D 06:9F7D: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x019F90 06:9F80: 29 FB     AND #$04 ^ $FF
C - - - - - 0x019F92 06:9F82: 9D 00 04  STA ram_0400_obj_flags,X
bra_9F85:
...
bra_9FBC:
C - - - - - 0x019FCC 06:9FBC: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x019FE9 06:9FD9: BD D0 03  LDA ram_obj_direction,X
loc_9FDC:
...
C - - - - - 0x01A02A 06:A01A: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x01A02D 06:A01D: 49 03     EOR #$03
C - - - - - 0x01A02F 06:A01F: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x01A045 06:A035: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01A048 06:A038: 29 FB     AND #$04 ^ $FF
C - - - - - 0x01A04A 06:A03A: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x01A060 06:A050: BD D0 03  LDA ram_obj_direction,X
...
bra_A067:
loc_A067:
C D 1 - - - 0x01A077 06:A067: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01A07A 06:A06A: 09 04     ORA #$04
C - - - - - 0x01A07C 06:A06C: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x01A08D 06:A07D: 85 00     STA ram_0000_t26
...
C - - - - - 0x01A099 06:A089: C5 00     CMP ram_0000_t26
...
C - - - - - 0x01A14F 06:A13F: 86 0F     STX ram_000F_t09_obj_index
...
C - - - - - 0x01A1A3 06:A193: 99 F0 03  STA ram_obj_hp,Y
C - - - - - 0x01A1A6 06:A196: A9 15     LDA #con_obj_id_crab_naked
C - - - - - 0x01A1A8 06:A198: 99 10 03  STA ram_obj_id,Y
C - - - - - 0x01A1AB 06:A19B: A6 0F     LDX ram_000F_t09_obj_index
...
C - - - - - 0x01A1E6 06:A1D6: 20 09 A6  JSR sub_A609_wait_for_boss
...
C - - - - - 0x01A1F2 06:A1E2: 9D D0 03  STA ram_obj_direction,X
...
bra_A205:
C - - - - - 0x01A215 06:A205: BD 30 04  LDA ram_0430_obj_animation,X
...
bra_A24F:
C - - - - - 0x01A25F 06:A24F: E6 00     INC ram_0000_t27_counter
bra_A251:
C - - - - - 0x01A261 06:A251: 88        DEY
C - - - - - 0x01A262 06:A252: C0 02     CPY #$02
C - - - - - 0x01A264 06:A254: D0 E1     BNE bra_A237_loop
C - - - - - 0x01A266 06:A256: A5 00     LDA ram_0000_t27_counter
...
C - - - - - 0x01A2AB 06:A29B: 99 F0 03  STA ram_obj_hp,Y
...
C - - - - - 0x01A2D9 06:A2C9: A6 0F     LDX ram_000F_t10_obj_index
...
C - - - - - 0x01A2EF 06:A2DF: 86 0F     STX ram_000F_t11_obj_index
bra_A2E1_loop:
...
C - - - - - 0x01A31A 06:A30A: A6 0F     LDX ram_000F_t11_obj_index
...
bra_A312_loop:
C - - - - - 0x01A322 06:A312: B9 30 04  LDA ram_0430_obj_animation,Y
...
C - - - - - 0x01A358 06:A348: 9D D0 03  STA ram_obj_direction,X
bra_A34B_RTS:
...
C - - - - - 0x01A369 06:A359: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x01A390 06:A380: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x01A3D7 06:A3C7: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x01A403 06:A3F3: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x01A42B 06:A41B: 20 09 A6  JSR sub_A609_wait_for_boss
...
C - - - - - 0x01A43D 06:A42D: DE 30 04  DEC ram_0430_obj_animation,X
bra_A430:
C - - - - - 0x01A440 06:A430: A9 00     LDA #$00
C - - - - - 0x01A442 06:A432: 85 00     STA ram_0000_t28_counter
C - - - - - 0x01A444 06:A434: A0 0F     LDY #$0F
bra_A436_loop:
C - - - - - 0x01A446 06:A436: B9 00 03  LDA ram_obj_flags,Y
C - - - - - 0x01A449 06:A439: 10 19     BPL bra_A454
C - - - - - 0x01A44B 06:A43B: B9 30 04  LDA ram_0430_obj_animation,Y
...
C - - - - - 0x01A4C7 06:A4B7: 99 F0 03  STA ram_obj_hp,Y
...
C - - - - - 0x01A502 06:A4F2: A6 0F     LDX ram_000F_t12_table_index
...
C - - - - - 0x01A50D 06:A4FD: 99 D0 03  STA ram_obj_direction,Y
...
C - - - - - 0x01A51E 06:A50E: E6 0F     INC ram_000F_t12_table_index
C - - - - - 0x01A520 06:A510: A5 0F     LDA ram_000F_t12_table_index
...
C - - - - - 0x01A623 06:A613: C9 04     CMP #con_ariel_coming_to_ice
C - - - - - 0x01A625 06:A615: D0 22     BNE bra_A639
bra_A617:
C - - - - - 0x01A627 06:A617: A5 30     LDA ram_ariel_status
C - - - - - 0x01A629 06:A619: 8D 70 04  STA ram_0470_t01_copy_ariel_status
C - - - - - 0x01A62C 06:A61C: A9 08     LDA #con_ariel_waiting_for_boss
C - - - - - 0x01A62E 06:A61E: 85 30     STA ram_ariel_status
                                       ;LDA #$08
C - - - - - 0x01A630 06:A620: 85 53     STA ram_0053_flag
                                       ;LDA #con_music_boss_fight
C - - - - - 0x01A632 06:A622: 20 9E FC  JSR sub_0x01FCAE_play_music
C - - - - - 0x01A635 06:A625: A9 60     LDA #$60
C - - - - - 0x01A637 06:A627: 85 5F     STA ram_005F_t01_counter
C - - - - - 0x01A639 06:A629: 8D 60 04  STA ram_0460_t01_boss_timer_wait
bra_A62C:
C - - - - - 0x01A63C 06:A62C: A5 5F     LDA ram_005F_t01_counter
C - - - - - 0x01A63E 06:A62E: F0 0B     BEQ bra_A63B
C - - - - - 0x01A640 06:A630: C6 5F     DEC ram_005F_t01_counter
...
bra_A672_loop:
C - - - - - 0x01A682 06:A672: B9 00 06  LDA ram_palette_buffer,Y
C - - - - - 0x01A685 06:A675: 38        SEC
C - - - - - 0x01A686 06:A676: E9 10     SBC #$10
C - - - - - 0x01A688 06:A678: B0 02     BCS bra_A67C_not_underflow
; if underflow, write black color
C - - - - - 0x01A68A 06:A67A: A9 0F     LDA #$0F
bra_A67C_not_underflow:
C - - - - - 0x01A68C 06:A67C: 99 00 06  STA ram_palette_buffer,Y
C - - - - - 0x01A68F 06:A67F: 99 20 06  STA ram_max_brightness_buffer,Y
C - - - - - 0x01A692 06:A682: 88        DEY
C - - - - - 0x01A693 06:A683: 10 ED     BPL bra_A672_loop
; Y = FF
C - - - - - 0x01A695 06:A685: 84 18     STY ram_0018_flag
...
C - - - - - 0x01A6BC 06:A6AC: A5 7F     LDA ram_007F_timer
C - - - - - 0x01A6BE 06:A6AE: F0 2B     BEQ bra_A6DB
C - - - - - 0x01A6C0 06:A6B0: C6 7F     DEC ram_007F_timer
...
bra_A6BE_loop:
C - - - - - 0x01A6CE 06:A6BE: B9 20 06  LDA ram_max_brightness_buffer,Y
C - - - - - 0x01A6D1 06:A6C1: 99 00 06  STA ram_palette_buffer,Y
C - - - - - 0x01A6D4 06:A6C4: 88        DEY
C - - - - - 0x01A6D5 06:A6C5: 10 F7     BPL bra_A6BE_loop
; 
C - - - - - 0x01A6D7 06:A6C7: A5 7F     LDA ram_007F_timer
C - - - - - 0x01A6D9 06:A6C9: 4A        LSR
C - - - - - 0x01A6DA 06:A6CA: 4A        LSR
; bzk optimize, use LSR + BCC/BCS instead of AND + BEQ
C - - - - - 0x01A6DB 06:A6CB: 29 01     AND #$01
C - - - - - 0x01A6DD 06:A6CD: F0 0A     BEQ bra_A6D9
; write 12 (00-0B) black background colors
C - - - - - 0x01A6DF 06:A6CF: A0 0B     LDY #$0B
C - - - - - 0x01A6E1 06:A6D1: A9 0F     LDA #$0F
bra_A6D3_loop:
C - - - - - 0x01A6E3 06:A6D3: 99 00 06  STA ram_palette_buffer,Y
C - - - - - 0x01A6E6 06:A6D6: 88        DEY
C - - - - - 0x01A6E7 06:A6D7: 10 FA     BPL bra_A6D3_loop
bra_A6D9:
C - - - - - 0x01A6E9 06:A6D9: E6 18     INC ram_0018_flag
bra_A6DB:
...
bra_A71C:
C - - - - - 0x01A72C 06:A71C: A5 7B     LDA ram_007B_t01_flag
C - - - - - 0x01A72E 06:A71E: 05 7C     ORA ram_007C_useless_00
...
C - - - - - 0x01A746 06:A736: 85 7E     STA ram_007E_timer
...
C - - - - - 0x01A754 06:A744: 85 7A     STA ram_007A_direction
C - - - - - 0x01A756 06:A746: A9 00     LDA #$00
C - - - - - 0x01A758 06:A748: 85 7D     STA ram_007D_spd_X_lo
C - - - - - 0x01A75A 06:A74A: 85 7B     STA ram_007B_t02_spd_X_lo
C - - - - - 0x01A75C 06:A74C: 85 7C     STA ram_007C_useless_00
C - - - - - 0x01A75E 06:A74E: 85 1C     STA ram_001C_counter_00_02
C - - - - - 0x01A760 06:A750: A0 0F     LDY #$0F
bra_A752_loop:
C - - - - - 0x01A762 06:A752: B9 00 03  LDA ram_obj_flags,Y
C - - - - - 0x01A765 06:A755: 10 0B     BPL bra_A762
C - - - - - 0x01A767 06:A757: B9 30 04  LDA ram_0430_obj_animation,Y
...
bra_A768:
C - - - - - 0x01A778 06:A768: B9 00 04  LDA ram_0400_obj_flags,Y
C - - - - - 0x01A77B 06:A76B: 29 FB     AND #$04 ^ $FF
C - - - - - 0x01A77D 06:A76D: 99 00 04  STA ram_0400_obj_flags,Y
C - - - - - 0x01A780 06:A770: 4C 8B A7  JMP loc_A78B
bra_A773:
C - - - - - 0x01A783 06:A773: A5 7A     LDA ram_007A_direction
C - - - - - 0x01A785 06:A775: 29 01     AND #$01
C - - - - - 0x01A787 06:A777: 4A        LSR
C - - - - - 0x01A788 06:A778: 6A        ROR
C - - - - - 0x01A789 06:A779: 4A        LSR
C - - - - - 0x01A78A 06:A77A: 85 00     STA ram_0000_t30
C - - - - - 0x01A78C 06:A77C: B9 00 04  LDA ram_0400_obj_flags,Y
C - - - - - 0x01A78F 06:A77F: 29 BF     AND #$40 ^ $FF
C - - - - - 0x01A791 06:A781: 05 00     ORA ram_0000_t30
C - - - - - 0x01A793 06:A783: 99 00 04  STA ram_0400_obj_flags,Y
C - - - - - 0x01A796 06:A786: A9 89     LDA #$89
C - - - - - 0x01A798 06:A788: 99 30 04  STA ram_0430_obj_animation,Y
loc_A78B:
...
bra_A7D0:
C - - - - - 0x01A7E0 06:A7D0: 86 0F     STX ram_000F_t04_obj_index
...
C - - - - - 0x01A7F8 06:A7E8: 99 F0 03  STA ram_obj_hp,Y
...
C - - - - - 0x01A81B 06:A80B: 99 D0 03  STA ram_obj_direction,Y
...
C - - - - - 0x01A827 06:A817: A6 0F     LDX ram_000F_t04_obj_index
...
C - - - - - 0x01A833 06:A823: A6 0F     LDX ram_000F_t04_obj_index
...
C - - - - - 0x01A858 06:A848: A5 7A     LDA ram_007A_direction
C - - - - - 0x01A85A 06:A84A: F0 2A     BEQ bra_A876
C - - - - - 0x01A85C 06:A84C: DD D0 03  CMP ram_obj_direction,X
C - - - - - 0x01A85F 06:A84F: F0 14     BEQ bra_A865
C - - - - - 0x01A861 06:A851: BD 80 03  LDA ram_spd_X_lo,X
C - - - - - 0x01A864 06:A854: 38        SEC
C - - - - - 0x01A865 06:A855: E5 7B     SBC ram_007B_t02_spd_X_lo
...
C - - - - - 0x01A879 06:A869: 65 7B     ADC ram_007B_t02_spd_X_lo
...
bra_A88E:
C - - - - - 0x01A89E 06:A88E: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01A8A1 06:A891: 29 04     AND #$04
C - - - - - 0x01A8A3 06:A893: D0 17     BNE bra_A8AC
C - - - - - 0x01A8A5 06:A895: 09 04     ORA #$04
C - - - - - 0x01A8A7 06:A897: 9D 00 04  STA ram_0400_obj_flags,X
C - - - - - 0x01A8AA 06:A89A: 86 00     STX ram_0000_t31_obj_index
C - - - - - 0x01A8AC 06:A89C: A0 0F     LDY #$0F
C - - - - - 0x01A8AE 06:A89E: A9 00     LDA #$00
bra_A8A0_loop:
C - - - - - 0x01A8B0 06:A8A0: C4 00     CPY ram_0000_t31_obj_index
...
bra_A8BB_loop:
C - - - - - 0x01A8CB 06:A8BB: B9 00 06  LDA ram_palette_buffer,Y
...
bra_A8C5:
C - - - - - 0x01A8D5 06:A8C5: 99 00 06  STA ram_palette_buffer,Y
C - - - - - 0x01A8D8 06:A8C8: 99 20 06  STA ram_max_brightness_buffer,Y
C - - - - - 0x01A8DB 06:A8CB: 88        DEY
C - - - - - 0x01A8DC 06:A8CC: 10 ED     BPL bra_A8BB_loop
; Y = FF
C - - - - - 0x01A8DE 06:A8CE: 84 18     STY ram_0018_flag
...
C - - - - - 0x01A8E9 06:A8D9: 85 2F     STA ram_002F_timer
bra_A8DB_RTS:
...
bra_AC0F:
; A != 00
C - - - - - 0x01AC1F 06:AC0F: 85 19     STA ram_buffer_ready_flag   ; ready
; 
...
C - - - - - 0x01AC35 06:AC25: 20 AD FF  JSR sub_0x01FFBD_wait_1_frm
...
bra_AC45:
C - - - - - 0x01AC55 06:AC45: 20 AD FF  JSR sub_0x01FFBD_wait_1_frm
...
C - - - - - 0x01B01C 06:B00C: 85 01     STA ram_0000_t02_data_static_screen + $01
...
C - - - - - 0x01B034 06:B024: 20 3D B0  JSR sub_B03D_adjust_index
C - - - - - 0x01B037 06:B027: B1 00     LDA (ram_0000_t02_data_static_screen),Y
C - - - - - 0x01B039 06:B029: 85 02     STA ram_0002_t10_tiles_counter
C - - - - - 0x01B03B 06:B02B: 20 3D B0  JSR sub_B03D_adjust_index
bra_B02E_loop:
C - - - - - 0x01B03E 06:B02E: B1 00     LDA (ram_0000_t02_data_static_screen),Y
C - - - - - 0x01B040 06:B030: 8D 07 20  STA $2007
C - - - - - 0x01B043 06:B033: 20 3D B0  JSR sub_B03D_adjust_index
C - - - - - 0x01B046 06:B036: C6 02     DEC ram_0002_t10_tiles_counter
...
sub_B03D_adjust_index:
C - - - - - 0x01B04D 06:B03D: C8        INY
C - - - - - 0x01B04E 06:B03E: D0 02     BNE bra_B042_RTS
C - - - - - 0x01B050 06:B040: E6 01     INC ram_0000_t02_data_static_screen + $01
bra_B042_RTS:
