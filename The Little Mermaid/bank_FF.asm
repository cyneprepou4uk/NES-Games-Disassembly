...
.export sub_0x01D545
.export sub_0x01E28F
.export sub_0x01E7CA_draw_closed_chest
.export sub_0x01F743
.export sub_0x01F83F
...
.export sub_0x01F921
.export loc_0x01F921
.export sub_0x01F9A9_set_spd_Y_FFC0
.export sub_0x01FB02
.export tbl_0x01FB70
.export tbl_0x01FB90_pos_X_lo
.export sub_0x01FBB0
.export sub_0x01FC55
.export loc_0x01FC55
.export sub_0x01FC61
...
.export sub_0x01FFBD_wait_1_frm
...
C - - - - - 0x01C016 07:C006: A5 EE     LDA ram_rendering_flag
C - - - - - 0x01C018 07:C008: 05 9A     ORA ram_009A_useless_00
...
C - - - - - 0x01C033 07:C023: A5 19     LDA ram_buffer_ready_flag
C - - - - - 0x01C035 07:C025: F0 03     BEQ bra_C02A_buffer_not_ready
C - - - - - 0x01C037 07:C027: 20 CB C0  JSR sub_C0CB_write_buffer_to_ppu
bra_C02A_buffer_not_ready:
C - - - - - 0x01C03A 07:C02A: A5 1A     LDA ram_001A_chest_flag
C - - - - - 0x01C03C 07:C02C: F0 09     BEQ bra_C037
C - - - - - 0x01C03E 07:C02E: A9 00     LDA #$00
C - - - - - 0x01C040 07:C030: 85 1A     STA ram_001A_chest_flag
C - - - - - 0x01C042 07:C032: A2 40     LDX #$40
C - - - - - 0x01C044 07:C034: 20 CF C0  JSR sub_C0CF_write_buffer_to_ppu
bra_C037:
C - - - - - 0x01C047 07:C037: A5 18     LDA ram_0018_flag
C - - - - - 0x01C049 07:C039: F0 29     BEQ bra_C064
C - - - - - 0x01C04B 07:C03B: A2 00     LDX #$00    ; > 3F00
C - - - - - 0x01C04D 07:C03D: 86 18     STX ram_0018_flag
...
bra_C04C_loop:
C - - - - - 0x01C05C 07:C04C: BD 00 06  LDA ram_palette_buffer,X
...
bra_C07F:
C - - - - - 0x01C08F 07:C07F: E6 92     INC ram_useless_nmi_counter
C - - - - - 0x01C091 07:C081: A2 FF     LDX #$FF
C - - - - - 0x01C093 07:C083: 86 90     STX ram_nmi_flag
...
C - - - - - 0x01C0AD 07:C09D: A9 05     LDA #con_prg_bank + $05
C - - - - - 0x01C0AF 07:C09F: 20 C8 FF  JSR sub_FFC8_nmi_prg_bankswitch
loc_C0A2_loop:
C D 2 - - - 0x01C0B2 07:C0A2: A6 DB     LDX ram_queue_index_2
C - - - - - 0x01C0B4 07:C0A4: B5 DC     LDA ram_sfx_queue,X
C - - - - - 0x01C0B6 07:C0A6: C9 88     CMP #con_se_cb_88
C - - - - - 0x01C0B8 07:C0A8: F0 12     BEQ bra_C0BC
C - - - - - 0x01C0BA 07:C0AA: 48        PHA
C - - - - - 0x01C0BB 07:C0AB: A9 88     LDA #con_se_cb_88
...
C - - - - - 0x01C0CF 07:C0BF: A5 BF     LDA ram_nmi_restore_prg_bank
C - - - - - 0x01C0D1 07:C0C1: 20 C8 FF  JSR sub_FFC8_nmi_prg_bankswitch
...
C - - - - - 0x01C0DD 07:C0CD: 86 19     STX ram_buffer_ready_flag   ; not ready
...
sub_C104_disable_rendering:
C - - - - - 0x01C114 07:C104: E6 EE     INC ram_rendering_flag  ; -> 01
...
sub_C10E_enable_rendering:
C - - - - - 0x01C11E 07:C10E: C6 EE     DEC ram_rendering_flag  ; -> 00
...
C - - - - - 0x01C13A 07:C12A: 26 00     ROL ram_0000_t32_btns_p1
...
sub_C170_fill_nametable:
; in
    ; A = ppu address hi
    ; X = fill tile
    ; Y = fill attribute
C - - - - - 0x01C180 07:C170: 85 00     STA ram_0000_t33_ppu_hi
C - - - - - 0x01C182 07:C172: 86 01     STX ram_0001_t07_fill_tile
C - - - - - 0x01C184 07:C174: 84 02     STY ram_0002_t11_fill_attribute
...
C - - - - - 0x01C190 07:C180: A5 00     LDA ram_0000_t33_ppu_hi
...
- - - - - - 0x01C1A0 07:C190: A6 02     LDX ram_0002_t11_fill_attribute
bra_C192:
C - - - - - 0x01C1A2 07:C192: A0 00     LDY #$00
C - - - - - 0x01C1A4 07:C194: A5 01     LDA ram_0001_t07_fill_tile
bra_C196_loop:
...
C - - - - - 0x01C1AF 07:C19F: A4 02     LDY ram_0002_t11_fill_attribute
C - - - - - 0x01C1B1 07:C1A1: A5 00     LDA ram_0000_t33_ppu_hi
; bzk optimize, useless check, no code writes < 20 into 0000
...
bra_C1B9:
C - - - - - 0x01C1C9 07:C1B9: A6 01     LDX ram_0001_t07_fill_tile
C - - - - - 0x01C1CB 07:C1BB: 60        RTS



sub_C1BC_hide_unused_sprites:
C - - - - - 0x01C1CC 07:C1BC: A6 97     LDX ram_oam_index
...
C - - - - - 0x01C1EF 07:C1DF: 9D E0 03  STA ram_03E0_obj_data_index,X
...
loc_C1E6_increase_brightness:
sub_C1E6_increase_brightness:
...
sub_C1EC_decrease_brightness:
C - - - - - 0x01C1FC 07:C1EC: A9 10     LDA #$10
C - - - - - 0x01C1FE 07:C1EE: AA        TAX ; 10
bra_C1EF:
C - - - - - 0x01C1FF 07:C1EF: 85 0F     STA ram_000F_t13_brightness_sub
C - - - - - 0x01C201 07:C1F1: 86 0D     STX ram_000D_t02_brightness_add
C - - - - - 0x01C203 07:C1F3: A0 04     LDY #$04
C - - - - - 0x01C205 07:C1F5: 84 0E     STY ram_000E_t07_loop_counter
sub_C1F7:
bra_C1F7_loop:
C - - - - - 0x01C207 07:C1F7: A0 1F     LDY #$1F
bra_C1F9_loop:
C - - - - - 0x01C209 07:C1F9: B9 20 06  LDA ram_max_brightness_buffer,Y
C - - - - - 0x01C20C 07:C1FC: 99 00 06  STA ram_palette_buffer,Y
C - - - - - 0x01C20F 07:C1FF: 88        DEY
C - - - - - 0x01C210 07:C200: 10 F7     BPL bra_C1F9_loop
C - - - - - 0x01C212 07:C202: A0 1F     LDY #$1F
bra_C204_loop:
C - - - - - 0x01C214 07:C204: B9 00 06  LDA ram_palette_buffer,Y
C - - - - - 0x01C217 07:C207: 38        SEC
C - - - - - 0x01C218 07:C208: E5 0F     SBC ram_000F_t13_brightness_sub
C - - - - - 0x01C21A 07:C20A: 10 02     BPL bra_C20E_not_underflow
; if underflow, write black color
C - - - - - 0x01C21C 07:C20C: A9 0F     LDA #$0F
bra_C20E_not_underflow:
C - - - - - 0x01C21E 07:C20E: 99 00 06  STA ram_palette_buffer,Y
C - - - - - 0x01C221 07:C211: 88        DEY
C - - - - - 0x01C222 07:C212: 10 F0     BPL bra_C204_loop
; Y = FF
C - - - - - 0x01C224 07:C214: 84 18     STY ram_0018_flag
C - - - - - 0x01C226 07:C216: A5 0E     LDA ram_000E_t07_loop_counter
bra_C218_loop:
C - - - - - 0x01C228 07:C218: 48        PHA
C - - - - - 0x01C229 07:C219: 20 AD FF  JSR sub_FFAD_wait_1_frm
...
; 
C - - - - - 0x01C232 07:C222: A5 0F     LDA ram_000F_t13_brightness_sub
C - - - - - 0x01C234 07:C224: 18        CLC
C - - - - - 0x01C235 07:C225: 65 0D     ADC ram_000D_t02_brightness_add
C - - - - - 0x01C237 07:C227: 85 0F     STA ram_000F_t13_brightness_sub
C - - - - - 0x01C239 07:C229: C9 50     CMP #$50
C - - - - - 0x01C23B 07:C22B: F0 04     BEQ bra_C231_RTS
C - - - - - 0x01C23D 07:C22D: A5 0F     LDA ram_000F_t13_brightness_sub
...
; bzk garbage
- - - - - - 0x01C242 07:C232: 86 0E     STX ram_000E_temp
- - - - - - 0x01C244 07:C234: 84 0F     STY ram_000F_temp
- - - - - - 0x01C246 07:C236: 0A        ASL
- - - - - - 0x01C247 07:C237: A8        TAY
- - - - - - 0x01C248 07:C238: C8        INY
- - - - - - 0x01C249 07:C239: 68        PLA
- - - - - - 0x01C24A 07:C23A: 85 0C     STA $0C ; ram_000C
- - - - - - 0x01C24C 07:C23C: 68        PLA
- - - - - - 0x01C24D 07:C23D: 85 0D     STA $0C + $01
- - - - - - 0x01C24F 07:C23F: B1 0C     LDA ($0C),Y ; ram_000C
- - - - - - 0x01C251 07:C241: AA        TAX
- - - - - - 0x01C252 07:C242: C8        INY
- - - - - - 0x01C253 07:C243: B1 0C     LDA ($0C),Y ; ram_000C
- - - - - - 0x01C255 07:C245: 85 0D     STA $0C + $01
- - - - - - 0x01C257 07:C247: 86 0C     STX $0C ; ram_000C
- - - - - - 0x01C259 07:C249: A6 0E     LDX ram_000E_temp
- - - - - - 0x01C25B 07:C24B: A4 0F     LDY ram_000F_temp
- - - - - - 0x01C25D 07:C24D: 6C 0C 00  JMP ($0C) ; ram_000C
...
C - - - - - 0x01C268 07:C258: 85 00     STA ram_0000_t34
C - - - - - 0x01C26A 07:C25A: B5 E5     LDA ram_random + $01,X
C - - - - - 0x01C26C 07:C25C: 29 02     AND #$02
C - - - - - 0x01C26E 07:C25E: 45 00     EOR ram_0000_t34
...
C - - - - - 0x01C282 07:C272: BD C4 C2  LDA tbl_C2C4_chr_data_lo,X
C - - - - - 0x01C285 07:C275: 85 02     STA ram_0002_t02_data_chr
C - - - - - 0x01C287 07:C277: BD E4 C2  LDA tbl_C2E4_chr_data_hi,X
C - - - - - 0x01C28A 07:C27A: 85 03     STA ram_0002_t02_data_chr + $01
C - - - - - 0x01C28C 07:C27C: A0 00     LDY #$00
bra_C27E_loop:
C - - - - - 0x01C28E 07:C27E: B1 02     LDA (ram_0002_t02_data_chr),Y
C - - - - - 0x01C290 07:C280: 30 41     BMI bra_C2C3_RTS
C - - - - - 0x01C292 07:C282: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01C295 07:C285: C8        INY
C - - - - - 0x01C296 07:C286: B1 02     LDA (ram_0002_t02_data_chr),Y
C - - - - - 0x01C298 07:C288: 85 04     STA ram_0004_t06_loop_counter
C - - - - - 0x01C29A 07:C28A: C8        INY
C - - - - - 0x01C29B 07:C28B: B1 02     LDA (ram_0002_t02_data_chr),Y
C - - - - - 0x01C29D 07:C28D: 85 06     STA ram_0005_t01_data + $01
C - - - - - 0x01C29F 07:C28F: A2 00     LDX #$00    ; > $00xx
C - - - - - 0x01C2A1 07:C291: 86 05     STX ram_0005_t01_data
C - - - - - 0x01C2A3 07:C293: C8        INY
C - - - - - 0x01C2A4 07:C294: AD 02 20  LDA $2002
C - - - - - 0x01C2A7 07:C297: B1 02     LDA (ram_0002_t02_data_chr),Y
C - - - - - 0x01C2A9 07:C299: 8D 06 20  STA $2006
C - - - - - 0x01C2AC 07:C29C: 8E 06 20  STX $2006
C - - - - - 0x01C2AF 07:C29F: 84 07     STY ram_0007_t02_data_index
bra_C2A1_loop:
C - - - - - 0x01C2B1 07:C2A1: A0 00     LDY #$00
bra_C2A3_loop:
C - - - - - 0x01C2B3 07:C2A3: B1 05     LDA (ram_0005_t01_data),Y
...
C - - - - - 0x01C2BD 07:C2AD: A5 05     LDA ram_0005_t01_data
C - - - - - 0x01C2BF 07:C2AF: 18        CLC
C - - - - - 0x01C2C0 07:C2B0: 69 10     ADC #< $0010
C - - - - - 0x01C2C2 07:C2B2: 85 05     STA ram_0005_t01_data
C - - - - - 0x01C2C4 07:C2B4: A5 06     LDA ram_0005_t01_data + $01
C - - - - - 0x01C2C6 07:C2B6: 69 00     ADC #> $0010
C - - - - - 0x01C2C8 07:C2B8: 85 06     STA ram_0005_t01_data + $01
C - - - - - 0x01C2CA 07:C2BA: C6 04     DEC ram_0004_t06_loop_counter
C - - - - - 0x01C2CC 07:C2BC: D0 E3     BNE bra_C2A1_loop
C - - - - - 0x01C2CE 07:C2BE: A4 07     LDY ram_0007_t02_data_index
C - - - - - 0x01C2D0 07:C2C0: C8        INY
C - - - - - 0x01C2D1 07:C2C1: D0 BB     BNE bra_C27E_loop   ; jmp
bra_C2C3_RTS:
C - - - - - 0x01C2D3 07:C2C3: 60        RTS



tbl_C2C4_chr_data_lo:
- D 2 - - - 0x01C2D4 07:C2C4: 04        .byte < _off011_chr_data_C304_00   ; 
- D 2 - - - 0x01C2D5 07:C2C5: 1D        .byte < _off011_chr_data_C31D_01   ; 
- D 2 - - - 0x01C2D6 07:C2C6: 36        .byte < _off011_chr_data_C336_02   ; 
- D 2 - - - 0x01C2D7 07:C2C7: 53        .byte < _off011_chr_data_C353_03   ; 
- D 2 - - - 0x01C2D8 07:C2C8: 68        .byte < _off011_chr_data_C368_04   ; 
- D 2 - - - 0x01C2D9 07:C2C9: 81        .byte < _off011_chr_data_C381_05   ; 
- - - - - - 0x01C2DA 07:C2CA: A2        .byte < _off011_chr_data_C3A2_06   ; unused, index doesn't exist
- D 2 - - - 0x01C2DB 07:C2CB: AF        .byte < _off011_chr_data_C3AF_07   ; 
- D 2 - - - 0x01C2DC 07:C2CC: B8        .byte < _off011_chr_data_C3B8_08   ; 
- D 2 - - - 0x01C2DD 07:C2CD: D5        .byte < _off011_chr_data_C3D5_09   ; 
- D 2 - - - 0x01C2DE 07:C2CE: E2        .byte < _off011_chr_data_C3E2_0A   ; 
- D 2 - - - 0x01C2DF 07:C2CF: E7        .byte < _off011_chr_data_C3E7_0B   ; 
- D 2 - - - 0x01C2E0 07:C2D0: FC        .byte < _off011_chr_data_C3FC_0C   ; 
- D 2 - - - 0x01C2E1 07:C2D1: 01        .byte < _off011_chr_data_C401_0D   ; 
- D 2 - - - 0x01C2E2 07:C2D2: 16        .byte < _off011_chr_data_C416_0E   ; 
- D 2 - - - 0x01C2E3 07:C2D3: 2B        .byte < _off011_chr_data_C42B_0F   ; 
- D 2 - - - 0x01C2E4 07:C2D4: 3C        .byte < _off011_chr_data_C43C_10   ; 
- D 2 - - - 0x01C2E5 07:C2D5: 41        .byte < _off011_chr_data_C441_11   ; 
- D 2 - - - 0x01C2E6 07:C2D6: 46        .byte < _off011_chr_data_C446_12   ; 
- D 2 - - - 0x01C2E7 07:C2D7: 4B        .byte < _off011_chr_data_C44B_13   ; 
- D 2 - - - 0x01C2E8 07:C2D8: 50        .byte < _off011_chr_data_C450_14   ; 
- D 2 - - - 0x01C2E9 07:C2D9: 55        .byte < _off011_chr_data_C455_15   ; 
- D 2 - - - 0x01C2EA 07:C2DA: 5E        .byte < _off011_chr_data_C45E_16   ; 
- D 2 - - - 0x01C2EB 07:C2DB: 7B        .byte < _off011_chr_data_C47B_17   ; 
- D 2 - - - 0x01C2EC 07:C2DC: 94        .byte < _off011_chr_data_C494_18   ; 
- D 2 - - - 0x01C2ED 07:C2DD: B5        .byte < _off011_chr_data_C4B5_19   ; 
- D 2 - - - 0x01C2EE 07:C2DE: CE        .byte < _off011_chr_data_C4CE_1A   ; 
- D 2 - - - 0x01C2EF 07:C2DF: 36        .byte < _off011_chr_data_C336_1B   ; 
- D 2 - - - 0x01C2F0 07:C2E0: E7        .byte < _off011_chr_data_C4E7_1C   ; 
- D 2 - - - 0x01C2F1 07:C2E1: 00        .byte < _off011_chr_data_C500_1D   ; 
- - - - - - 0x01C2F2 07:C2E2: 81        .byte < _off011_chr_data_C381_1E   ; unused?
- - - - - - 0x01C2F3 07:C2E3: 29        .byte < _off011_chr_data_C529_1F   ; unused, index doesn't exist



tbl_C2E4_chr_data_hi:
- D 2 - - - 0x01C2F4 07:C2E4: C3        .byte > _off011_chr_data_C304_00   ; 
- D 2 - - - 0x01C2F5 07:C2E5: C3        .byte > _off011_chr_data_C31D_01   ; 
- D 2 - - - 0x01C2F6 07:C2E6: C3        .byte > _off011_chr_data_C336_02   ; 
- D 2 - - - 0x01C2F7 07:C2E7: C3        .byte > _off011_chr_data_C353_03   ; 
- D 2 - - - 0x01C2F8 07:C2E8: C3        .byte > _off011_chr_data_C368_04   ; 
- D 2 - - - 0x01C2F9 07:C2E9: C3        .byte > _off011_chr_data_C381_05   ; 
- - - - - - 0x01C2FA 07:C2EA: C3        .byte > _off011_chr_data_C3A2_06   ; unused, index doesn't exist
- D 2 - - - 0x01C2FB 07:C2EB: C3        .byte > _off011_chr_data_C3AF_07   ; 
- D 2 - - - 0x01C2FC 07:C2EC: C3        .byte > _off011_chr_data_C3B8_08   ; 
- D 2 - - - 0x01C2FD 07:C2ED: C3        .byte > _off011_chr_data_C3D5_09   ; 
- D 2 - - - 0x01C2FE 07:C2EE: C3        .byte > _off011_chr_data_C3E2_0A   ; 
- D 2 - - - 0x01C2FF 07:C2EF: C3        .byte > _off011_chr_data_C3E7_0B   ; 
- D 2 - - - 0x01C300 07:C2F0: C3        .byte > _off011_chr_data_C3FC_0C   ; 
- D 2 - - - 0x01C301 07:C2F1: C4        .byte > _off011_chr_data_C401_0D   ; 
- D 2 - - - 0x01C302 07:C2F2: C4        .byte > _off011_chr_data_C416_0E   ; 
- D 2 - - - 0x01C303 07:C2F3: C4        .byte > _off011_chr_data_C42B_0F   ; 
- D 2 - - - 0x01C304 07:C2F4: C4        .byte > _off011_chr_data_C43C_10   ; 
- D 2 - - - 0x01C305 07:C2F5: C4        .byte > _off011_chr_data_C441_11   ; 
- D 2 - - - 0x01C306 07:C2F6: C4        .byte > _off011_chr_data_C446_12   ; 
- D 2 - - - 0x01C307 07:C2F7: C4        .byte > _off011_chr_data_C44B_13   ; 
- D 2 - - - 0x01C308 07:C2F8: C4        .byte > _off011_chr_data_C450_14   ; 
- D 2 - - - 0x01C309 07:C2F9: C4        .byte > _off011_chr_data_C455_15   ; 
- D 2 - - - 0x01C30A 07:C2FA: C4        .byte > _off011_chr_data_C45E_16   ; 
- D 2 - - - 0x01C30B 07:C2FB: C4        .byte > _off011_chr_data_C47B_17   ; 
- D 2 - - - 0x01C30C 07:C2FC: C4        .byte > _off011_chr_data_C494_18   ; 
- D 2 - - - 0x01C30D 07:C2FD: C4        .byte > _off011_chr_data_C4B5_19   ; 
- D 2 - - - 0x01C30E 07:C2FE: C4        .byte > _off011_chr_data_C4CE_1A   ; 
- D 2 - - - 0x01C30F 07:C2FF: C3        .byte > _off011_chr_data_C336_1B   ; 
- D 2 - - - 0x01C310 07:C300: C4        .byte > _off011_chr_data_C4E7_1C   ; 
- D 2 - - - 0x01C311 07:C301: C5        .byte > _off011_chr_data_C500_1D   ; 
- - - - - - 0x01C312 07:C302: C3        .byte > _off011_chr_data_C381_1E   ; unused?
- - - - - - 0x01C313 07:C303: C5        .byte > _off011_chr_data_C529_1F   ; unused, index doesn't exist



_off011_chr_data_C304_00:
; con_C2C4_00
...
_off011_chr_data_C336_02:
; con_C2C4_02
_off011_chr_data_C336_1B:
; con_C2C4_1B
...
_off011_chr_data_C381_05:
; con_C2C4_05
_off011_chr_data_C381_1E:
; con_C2C4_1E
...
_off011_chr_data_C529_1F:
; con_C2C4_1F
- - - - - - 0x01C539 07:C529: FF        .byte $FF   ; end token



sub_C52A_prepare_data_pointers:
C - - - - - 0x01C53A 07:C52A: 84 A0     STY ram_00A0_useless
C - - - - - 0x01C53C 07:C52C: B9 19 C6  LDA tbl_C619_lo,Y
C - - - - - 0x01C53F 07:C52F: 85 A2     STA ram_00A2_t01_chr_data
C - - - - - 0x01C541 07:C531: B9 29 C6  LDA tbl_C629_hi,Y
C - - - - - 0x01C544 07:C534: 85 A3     STA ram_00A2_t01_chr_data + $01
C - - - - - 0x01C546 07:C536: A9 00     LDA #$00
C - - - - - 0x01C548 07:C538: 85 A1     STA ram_00A1_data_index
C - - - - - 0x01C54A 07:C53A: 85 A5     STA ram_00A5_counter
C - - - - - 0x01C54C 07:C53C: 60        RTS



sub_C53D:
C - - - - - 0x01C54D 07:C53D: A5 A5     LDA ram_00A5_counter
C - - - - - 0x01C54F 07:C53F: D0 20     BNE bra_C561
C - - - - - 0x01C551 07:C541: A4 A1     LDY ram_00A1_data_index
C - - - - - 0x01C553 07:C543: B1 A2     LDA (ram_00A2_t01_chr_data),Y
C - - - - - 0x01C555 07:C545: 30 61     BMI bra_C5A8_RTS
C - - - - - 0x01C557 07:C547: 85 A4     STA ram_00A4_prg_bank
C - - - - - 0x01C559 07:C549: C8        INY
C - - - - - 0x01C55A 07:C54A: B1 A2     LDA (ram_00A2_t01_chr_data),Y
C - - - - - 0x01C55C 07:C54C: 85 A5     STA ram_00A5_counter
C - - - - - 0x01C55E 07:C54E: C8        INY
C - - - - - 0x01C55F 07:C54F: A9 00     LDA #$00
C - - - - - 0x01C561 07:C551: 85 A6     STA ram_00A6_t01_chr_data
C - - - - - 0x01C563 07:C553: 85 A8     STA ram_00A8_ppu_lo
C - - - - - 0x01C565 07:C555: B1 A2     LDA (ram_00A2_t01_chr_data),Y
C - - - - - 0x01C567 07:C557: 85 A7     STA ram_00A6_t01_chr_data + $01
C - - - - - 0x01C569 07:C559: C8        INY
C - - - - - 0x01C56A 07:C55A: B1 A2     LDA (ram_00A2_t01_chr_data),Y
C - - - - - 0x01C56C 07:C55C: 85 A9     STA ram_00A9_ppu_hi
C - - - - - 0x01C56E 07:C55E: C8        INY
C - - - - - 0x01C56F 07:C55F: 84 A1     STY ram_00A1_data_index
bra_C561:
C - - - - - 0x01C571 07:C561: A5 A9     LDA ram_00A9_ppu_hi
C - - - - - 0x01C573 07:C563: 8D C0 07  STA ram_ppu_buffer + $40
C - - - - - 0x01C576 07:C566: A5 A8     LDA ram_00A8_ppu_lo
C - - - - - 0x01C578 07:C568: 8D C1 07  STA ram_ppu_buffer + $41
; 
C - - - - - 0x01C57B 07:C56B: A5 A4     LDA ram_00A4_prg_bank
C - - - - - 0x01C57D 07:C56D: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01C580 07:C570: A0 00     LDY #$00
bra_C572_loop:
C - - - - - 0x01C582 07:C572: B1 A6     LDA (ram_00A6_t01_chr_data),Y
...
C - - - - - 0x01C58D 07:C57D: C6 A5     DEC ram_00A5_counter
...
C - - - - - 0x01C59C 07:C58C: 65 A6     ADC ram_00A6_t01_chr_data
C - - - - - 0x01C59E 07:C58E: 85 A6     STA ram_00A6_t01_chr_data
C - - - - - 0x01C5A0 07:C590: A5 A7     LDA ram_00A6_t01_chr_data + $01
C - - - - - 0x01C5A2 07:C592: 69 00     ADC #$00
C - - - - - 0x01C5A4 07:C594: 85 A7     STA ram_00A6_t01_chr_data + $01
C - - - - - 0x01C5A6 07:C596: 98        TYA
C - - - - - 0x01C5A7 07:C597: 18        CLC
C - - - - - 0x01C5A8 07:C598: 65 A8     ADC ram_00A8_ppu_lo
C - - - - - 0x01C5AA 07:C59A: 85 A8     STA ram_00A8_ppu_lo
C - - - - - 0x01C5AC 07:C59C: A5 A9     LDA ram_00A9_ppu_hi
C - - - - - 0x01C5AE 07:C59E: 69 00     ADC #$00
C - - - - - 0x01C5B0 07:C5A0: 85 A9     STA ram_00A9_ppu_hi
; Y = 20?
C - - - - - 0x01C5B2 07:C5A2: 88        DEY ; -> 1F ?
C - - - - - 0x01C5B3 07:C5A3: 8C C2 07  STY ram_ppu_buffer + $42
C - - - - - 0x01C5B6 07:C5A6: 84 1A     STY ram_001A_chest_flag
bra_C5A8_RTS:
...
C - - - - - 0x01C651 07:C641: 20 AD FF  JSR sub_FFAD_wait_1_frm
...
C - - - - - 0x01C65D 07:C64D: 85 E9     STA ram_stage_id
...
C - - - - - 0x01C669 07:C659: 85 BA     STA ram_useless_max_hearts_05
loc_C65B:
...
C - - - - - 0x01C67A 07:C66A: A9 F3     LDA #con_se_cb__pause
...
C - - - - - 0x01C684 07:C674: 20 A2 EA  JSR sub_EAA2_draw_pause_menu
C - - - - - 0x01C687 07:C677: A9 F4     LDA #con_se_cb__resume
...
C - - - - - 0x01C698 07:C688: 20 17 E7  JSR sub_E717_change_palette_for_background_effects
C - - - - - 0x01C69B 07:C68B: 20 16 E8  JSR sub_E816_try_to_draw_opened_chest
C - - - - - 0x01C69E 07:C68E: A5 E9     LDA ram_stage_id
...
C - - - - - 0x01C6B2 07:C6A2: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01C6B5 07:C6A5: 20 00 80  JSR sub_0x018010_objects_handler
C - - - - - 0x01C6B8 07:C6A8: A5 E9     LDA ram_stage_id
...
C - - - - - 0x01C6C6 07:C6B6: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01C6C9 07:C6B9: 20 00 B6  JSR sub_0x013610_spawn_objects
bra_C6BC:
C - - - - - 0x01C6CC 07:C6BC: AD 30 03  LDA ram_pos_X_lo
C - - - - - 0x01C6CF 07:C6BF: 85 32     STA ram_0032_copy_pos_X_lo
C - - - - - 0x01C6D1 07:C6C1: AD 40 03  LDA ram_pos_X_hi
C - - - - - 0x01C6D4 07:C6C4: 85 33     STA ram_0033_copy_pos_X_hi
...
C - - - - - 0x01C6DD 07:C6CD: 85 34     STA ram_0034_copy_pos_Y_lo
C - - - - - 0x01C6DF 07:C6CF: AD 70 03  LDA ram_pos_Y_hi
C - - - - - 0x01C6E2 07:C6D2: 85 35     STA ram_0035_copy_pos_Y_hi
C - - - - - 0x01C6E4 07:C6D4: A5 FA     LDA ram_scroll_Y_lo
C - - - - - 0x01C6E6 07:C6D6: 85 F8     STA ram_copy_scroll_Y
C - - - - - 0x01C6E8 07:C6D8: A9 04     LDA #$04
C - - - - - 0x01C6EA 07:C6DA: 85 97     STA ram_oam_index
                                       ;LDA #con_prg_bank + $04
C - - - - - 0x01C6EC 07:C6DC: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01C6EF 07:C6DF: 20 BC C1  JSR sub_C1BC_hide_unused_sprites
C - - - - - 0x01C6F2 07:C6E2: 20 03 80  JSR sub_0x010013_sprite_engine
; disable rendering
C - - - - - 0x01C6F5 07:C6E5: A9 00     LDA #$00
C - - - - - 0x01C6F7 07:C6E7: 85 EE     STA ram_rendering_flag
; 
C - - - - - 0x01C6F9 07:C6E9: 20 50 C2  JSR sub_C250_roll_rng
C - - - - - 0x01C6FC 07:C6EC: 20 AD FF  JSR sub_FFAD_wait_1_frm
; enable rendering
C - - - - - 0x01C6FF 07:C6EF: E6 EE     INC ram_rendering_flag  ; -> 01
; 
C - - - - - 0x01C701 07:C6F1: A5 2F     LDA ram_002F_timer
C - - - - - 0x01C703 07:C6F3: F0 10     BEQ bra_C705
C - - - - - 0x01C705 07:C6F5: C6 2F     DEC ram_002F_timer
C - - - - - 0x01C707 07:C6F7: D0 0C     BNE bra_C705
C - - - - - 0x01C709 07:C6F9: A5 E9     LDA ram_stage_id
...
C - - - - - 0x01C71A 07:C70A: 85 53     STA ram_0053_flag
C - - - - - 0x01C71C 07:C70C: E6 E9     INC ram_stage_id
C - - - - - 0x01C71E 07:C70E: A5 E9     LDA ram_stage_id
C - - - - - 0x01C720 07:C710: C9 06     CMP #$06
C - - - - - 0x01C722 07:C712: D0 02     BNE bra_C716
- - - - - - 0x01C724 07:C714: A9 00     LDA #$00
bra_C716:
C - - - - - 0x01C726 07:C716: 85 E9     STA ram_stage_id
...
; disable rendering
                                       ;LDA #$00
C - - - - - 0x01C737 07:C727: 85 EE     STA ram_rendering_flag
; 
                                       ;LDA #$00
...
tbl_C7A8_background_animation_config:
; 00 stage 1 - sea of coral
- D 2 - - - 0x01C7B8 07:C7A8: 00        .byte $00   ; 00 
- D 2 - - - 0x01C7B9 07:C7A9: 00        .byte $00   ; 01 
- D 2 - - - 0x01C7BA 07:C7AA: 80        .byte $80 + $00   ; 02 
- D 2 - - - 0x01C7BB 07:C7AB: 00        .byte $00   ; 03 
; 01 stage 2 - sunken ship
- D 2 - - - 0x01C7BC 07:C7AC: 00        .byte $00   ; 00 
- D 2 - - - 0x01C7BD 07:C7AD: 00        .byte $00   ; 01 
- D 2 - - - 0x01C7BE 07:C7AE: 00        .byte $00   ; 02 
- D 2 - - - 0x01C7BF 07:C7AF: 00        .byte $00   ; 03 
; 02 stage 3 - sea of ice
- D 2 - - - 0x01C7C0 07:C7B0: 00        .byte $00   ; 00 
- D 2 - - - 0x01C7C1 07:C7B1: 00        .byte $00   ; 01 
- D 2 - - - 0x01C7C2 07:C7B2: 00        .byte $00   ; 02 
- D 2 - - - 0x01C7C3 07:C7B3: 00        .byte $00   ; 03 
; 03 stage 4 - undersea volcano
- D 2 - - - 0x01C7C4 07:C7B4: 00        .byte $00   ; 00 
- D 2 - - - 0x01C7C5 07:C7B5: 00        .byte $00   ; 01 
- D 2 - - - 0x01C7C6 07:C7B6: 00        .byte $00   ; 02 
- D 2 - - - 0x01C7C7 07:C7B7: 81        .byte $80 + $01   ; 03 
; 04 stage 5 - ursula's castle
- D 2 - - - 0x01C7C8 07:C7B8: 00        .byte $00   ; 00 
- D 2 - - - 0x01C7C9 07:C7B9: 00        .byte $00   ; 01 
- D 2 - - - 0x01C7CA 07:C7BA: 00        .byte $00   ; 02 
- D 2 - - - 0x01C7CB 07:C7BB: 00        .byte $00   ; 03 
; 05 final battle
- D 2 - - - 0x01C7CC 07:C7BC: 00        .byte $00   ; 00 
- D 2 - - - 0x01C7CD 07:C7BD: 00        .byte $00   ; 01 
- D 2 - - - 0x01C7CE 07:C7BE: 00        .byte $00   ; 02 
- D 2 - - - 0x01C7CF 07:C7BF: 00        .byte $00   ; 03 
...
sub_C818:
C - - - - - 0x01C828 07:C818: 20 EC C1  JSR sub_C1EC_decrease_brightness
C - - - - - 0x01C82B 07:C81B: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01C82E 07:C81E: 20 D3 C1  JSR sub_C1D3_clear_all_objects
C - - - - - 0x01C831 07:C821: A9 04     LDA #$04
C - - - - - 0x01C833 07:C823: 85 97     STA ram_oam_index
C - - - - - 0x01C835 07:C825: 20 BC C1  JSR sub_C1BC_hide_unused_sprites
C - - - - - 0x01C838 07:C828: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01C83B 07:C82B: 20 04 C1  JSR sub_C104_disable_rendering
C - - - - - 0x01C83E 07:C82E: A4 53     LDY ram_0053_flag
C - - - - - 0x01C840 07:C830: 84 9E     STY ram_009E_data_index
C - - - - - 0x01C842 07:C832: 84 9F     STY ram_009F_data_index
C - - - - - 0x01C844 07:C834: 84 B8     STY ram_00B8
C - - - - - 0x01C846 07:C836: F0 18     BEQ bra_C850
C - - - - - 0x01C848 07:C838: A9 04     LDA #con_prg_bank + $04
C - - - - - 0x01C84A 07:C83A: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01C84D 07:C83D: A6 E9     LDX ram_stage_id
C - - - - - 0x01C84F 07:C83F: BD A0 BF  LDA tbl_0x013FB0,X
C - - - - - 0x01C852 07:C842: 85 9E     STA ram_009E_data_index
C - - - - - 0x01C854 07:C844: 85 9F     STA ram_009F_data_index
C - - - - - 0x01C856 07:C846: A5 E9     LDA ram_stage_id
...
C - - - - - 0x01C868 07:C858: 85 33     STA ram_0033_copy_pos_X_hi
...
C - - - - - 0x01C872 07:C862: 85 35     STA ram_0035_copy_pos_Y_hi
...
C - - - - - 0x01C890 07:C880: 85 0E     STA ram_000E_t08_loop_counter
bra_C882_loop:
C - - - - - 0x01C892 07:C882: A9 01     LDA #$01
C - - - - - 0x01C894 07:C884: 85 01     STA ram_0001_t08
                                       ;LDA #$01    ; right
C - - - - - 0x01C896 07:C886: 85 27     STA ram_0027_camera_movement_direction
C - - - - - 0x01C898 07:C888: 20 BD D6  JSR sub_D6BD
C - - - - - 0x01C89B 07:C88B: 20 CB C0  JSR sub_C0CB_write_buffer_to_ppu
C - - - - - 0x01C89E 07:C88E: C6 0E     DEC ram_000E_t08_loop_counter
C - - - - - 0x01C8A0 07:C890: D0 F0     BNE bra_C882_loop
; 
C - - - - - 0x01C8A2 07:C892: A5 53     LDA ram_0053_flag
C - - - - - 0x01C8A4 07:C894: F0 1B     BEQ bra_C8B1_skip
C - - - - - 0x01C8A6 07:C896: A5 E9     LDA ram_stage_id
C - - - - - 0x01C8A8 07:C898: C9 03     CMP #$03
C - - - - - 0x01C8AA 07:C89A: 90 15     BCC bra_C8B1_skip
; C = 1
; bzk optimize, delete SBC, at 0x01C8B5 add - $30 to label
...
bra_C8A5_loop:
C - - - - - 0x01C8B5 07:C8A5: B9 4D E0  LDA tbl_E04D_background_palette,Y
C - - - - - 0x01C8B8 07:C8A8: 9D 20 06  STA ram_max_brightness_buffer,X
...
C - - - - - 0x01C8C6 07:C8B6: 9D 30 06  STA ram_max_brightness_buffer + $10,X
C - - - - - 0x01C8C9 07:C8B9: CA        DEX
C - - - - - 0x01C8CA 07:C8BA: 10 F7     BPL bra_C8B3_loop
; copy main background color to transparent sprite color
C - - - - - 0x01C8CC 07:C8BC: AD 20 06  LDA ram_max_brightness_buffer
C - - - - - 0x01C8CF 07:C8BF: 8D 30 06  STA ram_max_brightness_buffer + $10
; 
C - - - - - 0x01C8D2 07:C8C2: A5 E9     LDA ram_stage_id
...
C - - - - - 0x01C8DD 07:C8CD: 9D 38 06  STA ram_max_brightness_buffer + $18,X
...
; 
C - - - - - 0x01C8E6 07:C8D6: A5 53     LDA ram_0053_flag
C - - - - - 0x01C8E8 07:C8D8: F0 23     BEQ bra_C8FD
C - - - - - 0x01C8EA 07:C8DA: A6 B8     LDX ram_00B8
C - - - - - 0x01C8EC 07:C8DC: A4 E9     LDY ram_stage_id
...
C - - - - - 0x01C904 07:C8F4: 9D 38 06  STA ram_max_brightness_buffer + $18,X
...
bra_C8FD:
C - - - - - 0x01C90D 07:C8FD: 20 0E C1  JSR sub_C10E_enable_rendering
C - - - - - 0x01C910 07:C900: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01C913 07:C903: 20 E6 C1  JSR sub_C1E6_increase_brightness
; con_music_stage_00
; con_music_stage_01
; con_music_stage_02
; con_music_stage_03
; con_music_stage_04
C - - - - - 0x01C916 07:C906: A5 E9     LDA ram_stage_id
...
bra_C91B_loop:
C - - - - - 0x01C92B 07:C91B: BD A8 C7  LDA tbl_C7A8_background_animation_config,X
C - - - - - 0x01C92E 07:C91E: 99 00 01  STA ram_0100_bg_anim_cfg,Y
C - - - - - 0x01C931 07:C921: F0 08     BEQ bra_C92B_next
C - - - - - 0x01C933 07:C923: A9 00     LDA #$00
C - - - - - 0x01C935 07:C925: 99 04 01  STA ram_0104_bg_anim_cnt_2,Y
C - - - - - 0x01C938 07:C928: 99 08 01  STA ram_0108_bg_anim_cnt_1,Y
bra_C92B_next:
...
C - - - - - 0x01C952 07:C942: 8D 30 04  STA ram_0430_obj_animation
C - - - - - 0x01C955 07:C945: A9 00     LDA #$00
C - - - - - 0x01C957 07:C947: 8D 48 04  STA ram_0448_obj
C - - - - - 0x01C95A 07:C94A: 8D 18 04  STA ram_obj_animation_cnt
...
C - - - - - 0x01C966 07:C956: 85 34     STA ram_0034_copy_pos_Y_lo
...
C - - - - - 0x01C99C 07:C98C: 84 00     STY ram_0000_t35
C - - - - - 0x01C99E 07:C98E: B1 70     LDA (ram_0070_t01_data),Y
...
C - - - - - 0x01C9A8 07:C998: 05 00     ORA ram_0000_t35
C - - - - - 0x01C9AA 07:C99A: 85 50     STA ram_stage_config
...
- - - - - - 0x01C9B4 07:C9A4: A9 08     LDA #$08    ; up
- - - - - - 0x01C9B6 07:C9A6: 85 27     STA ram_0027_camera_movement_direction
bra_C9A8_RTS:
...
;                                              |    |    |    +----- placeholder
;                                              |    |    |    |
- D 2 - - - 0x01C9B9 07:C9A9: 00        .byte $00, $00, $00, $00   ; 00 
- D 2 - - - 0x01C9BD 07:C9AD: 07        .byte $07, $02, $02, $00   ; 01 
- D 2 - - - 0x01C9C1 07:C9B1: 09        .byte $09, $04, $04, $00   ; 02 
- D 2 - - - 0x01C9C5 07:C9B5: 0D        .byte $0D, $02, $04, $00   ; 03 
- D 2 - - - 0x01C9C9 07:C9B9: 0A        .byte $0A, $04, $05, $00   ; 04 
- D 2 - - - 0x01C9CD 07:C9BD: 10        .byte $10, $04, $06, $00   ; 05 
- - - - - - 0x01C9D1 07:C9C1: 00        .byte $00, $00, $00, $00   ; 06 unused?



sub_C9C5:
C - - - - - 0x01C9D5 07:C9C5: A9 40     LDA #$40
C - - - - - 0x01C9D7 07:C9C7: 85 99     STA ram_0099_spd_Y_lo
C - - - - - 0x01C9D9 07:C9C9: A5 3B     LDA ram_003B_timer_00_1E
C - - - - - 0x01C9DB 07:C9CB: F0 02     BEQ bra_C9CF
C - - - - - 0x01C9DD 07:C9CD: C6 3B     DEC ram_003B_timer_00_1E
bra_C9CF:
C - - - - - 0x01C9DF 07:C9CF: A5 B1     LDA ram_hearts
C - - - - - 0x01C9E1 07:C9D1: F0 06     BEQ bra_C9D9
; if not dead
C - - - - - 0x01C9E3 07:C9D3: A5 3F     LDA ram_003F_timer_00_60
C - - - - - 0x01C9E5 07:C9D5: F0 02     BEQ bra_C9D9
C - - - - - 0x01C9E7 07:C9D7: C6 3F     DEC ram_003F_timer_00_60
bra_C9D9:
C - - - - - 0x01C9E9 07:C9D9: A2 00     LDX #$00
C - - - - - 0x01C9EB 07:C9DB: E6 38     INC ram_frm_cnt_1
C - - - - - 0x01C9ED 07:C9DD: A4 30     LDY ram_ariel_status
C - - - - - 0x01C9EF 07:C9DF: B9 EC C9  LDA tbl_C9EC_lo,Y
C - - - - - 0x01C9F2 07:C9E2: 85 00     STA ram_0000_t07_jmp
C - - - - - 0x01C9F4 07:C9E4: B9 F6 C9  LDA tbl_C9F6_hi,Y
C - - - - - 0x01C9F7 07:C9E7: 85 01     STA ram_0000_t07_jmp + $01
C - - - - - 0x01C9F9 07:C9E9: 6C 00 00  JMP (ram_0000_t07_jmp)
...
C - - - - - 0x01CA1E 07:CA0E: A5 10     LDA ram_0010_t02
...
C - - - - - 0x01CA28 07:CA18: BD 30 04  LDA ram_0430_obj_animation,X
...
C - - - - - 0x01CA7A 07:CA6A: 85 39     STA ram_0039_timer_00_08
C - - - - - 0x01CA7C 07:CA6C: A9 04     LDA #$04
C - - - - - 0x01CA7E 07:CA6E: 4C 45 FC  JMP loc_FC45
bra_CA71:
loc_CA71:
C D 2 - - - 0x01CA81 07:CA71: A5 3B     LDA ram_003B_timer_00_1E
...
C - - - - - 0x01CA97 07:CA87: 85 3B     STA ram_003B_timer_00_1E
...
C - - - - - 0x01CACC 07:CABC: 85 3C     STA ram_003C_flag
...
C - - - - - 0x01CAF8 07:CAE8: 05 00     ORA ram_0000_t36_btns_LR
...
C - - - - - 0x01CB5A 07:CB4A: 05 00     ORA ram_0000_t38_btns_LR
...
C - - - - - 0x01CB6E 07:CB5E: 65 36     ADC ram_0036_t01_spd_lo
...
C - - - - - 0x01CBC2 07:CBB2: CD 30 04  CMP ram_0430_obj_animation
...
C - - - - - 0x01CBCC 07:CBBC: 85 36     STA ram_0036_t01_spd_lo
...
bra_CBDE:
C - - - - - 0x01CBEE 07:CBDE: CD 30 04  CMP ram_0430_obj_animation
...
C - - - - - 0x01CC04 07:CBF4: CD 30 04  CMP ram_0430_obj_animation
...
C - - - - - 0x01CC11 07:CC01: CD 30 04  CMP ram_0430_obj_animation
...
C - - - - - 0x01CC28 07:CC18: A5 10     LDA ram_0010_t02
...
C - - - - - 0x01CC3A 07:CC2A: 85 11     STA ram_0011_t04_pos_Y_lo
...
; con_ariel_turning
; turning around
C - - J - - 0x01CCED 07:CCDD: AD 18 04  LDA ram_obj_animation_cnt
...
C - - - - - 0x01CCFD 07:CCED: AD 00 04  LDA ram_0400_obj_flags
C - - - - - 0x01CD00 07:CCF0: 48        PHA
C - - - - - 0x01CD01 07:CCF1: AD 30 04  LDA ram_0430_obj_animation
C - - - - - 0x01CD04 07:CCF4: C9 03     CMP #$03
C - - - - - 0x01CD06 07:CCF6: D0 08     BNE bra_CD00
C - - - - - 0x01CD08 07:CCF8: AD 00 04  LDA ram_0400_obj_flags
C - - - - - 0x01CD0B 07:CCFB: 49 40     EOR #$40
C - - - - - 0x01CD0D 07:CCFD: 8D 00 04  STA ram_0400_obj_flags
bra_CD00:
C - - - - - 0x01CD10 07:CD00: 20 20 CF  JSR sub_CF20
C - - - - - 0x01CD13 07:CD03: 85 00     STA ram_0000_t39
C - - - - - 0x01CD15 07:CD05: 68        PLA
C - - - - - 0x01CD16 07:CD06: 8D 00 04  STA ram_0400_obj_flags
C - - - - - 0x01CD19 07:CD09: A5 00     LDA ram_0000_t39
C - - - - - 0x01CD1B 07:CD0B: F0 26     BEQ bra_CD33
C - - - - - 0x01CD1D 07:CD0D: AD 30 04  LDA ram_0430_obj_animation
C - - - - - 0x01CD20 07:CD10: C9 03     CMP #$03
C - - - - - 0x01CD22 07:CD12: D0 08     BNE bra_CD1C
C - - - - - 0x01CD24 07:CD14: AD 00 04  LDA ram_0400_obj_flags
C - - - - - 0x01CD27 07:CD17: 49 40     EOR #$40
C - - - - - 0x01CD29 07:CD19: 8D 00 04  STA ram_0400_obj_flags
bra_CD1C:
...
C - - - - - 0x01CD33 07:CD23: 85 3B     STA ram_003B_timer_00_1E
...
bra_CD33:
C - - - - - 0x01CD43 07:CD33: AD 30 04  LDA ram_0430_obj_animation
C - - - - - 0x01CD46 07:CD36: C9 03     CMP #$03
C - - - - - 0x01CD48 07:CD38: D0 0A     BNE bra_CD44
C - - - - - 0x01CD4A 07:CD3A: A9 06     LDA #$06
C - - - - - 0x01CD4C 07:CD3C: CD 48 04  CMP ram_0448_obj
C - - - - - 0x01CD4F 07:CD3F: 90 03     BCC bra_CD44
C - - - - - 0x01CD51 07:CD41: 8D 48 04  STA ram_0448_obj
bra_CD44:
C - - - - - 0x01CD54 07:CD44: AD 48 04  LDA ram_0448_obj
C - - - - - 0x01CD57 07:CD47: C9 0A     CMP #$0A
C - - - - - 0x01CD59 07:CD49: D0 37     BNE bra_CD82
C - - - - - 0x01CD5B 07:CD4B: AD 30 04  LDA ram_0430_obj_animation
C - - - - - 0x01CD5E 07:CD4E: C9 03     CMP #$03
C - - - - - 0x01CD60 07:CD50: D0 08     BNE bra_CD5A
C - - - - - 0x01CD62 07:CD52: AD 00 04  LDA ram_0400_obj_flags
C - - - - - 0x01CD65 07:CD55: 49 40     EOR #$40
C - - - - - 0x01CD67 07:CD57: 8D 00 04  STA ram_0400_obj_flags
bra_CD5A:
C - - - - - 0x01CD6A 07:CD5A: A9 01     LDA #$01
C - - - - - 0x01CD6C 07:CD5C: 20 45 FC  JSR sub_FC45
C - - - - - 0x01CD6F 07:CD5F: A9 00     LDA #$00
C - - - - - 0x01CD71 07:CD61: 85 30     STA ram_ariel_status    ; con_ariel_default
...
C - - - - - 0x01CDE4 07:CDD4: 8D 00 04  STA ram_0400_obj_flags
...
C - - - - - 0x01CE0A 07:CDFA: 8D 00 04  STA ram_0400_obj_flags
bra_CDFD:
loc_CDFD:
...
C - - - - - 0x01CE1D 07:CE0D: 85 00     STA ram_0000_t43_btns_LR
C - - - - - 0x01CE1F 07:CE0F: A5 31     LDA ram_0031
C - - - - - 0x01CE21 07:CE11: 29 03     AND #$03
C - - - - - 0x01CE23 07:CE13: 05 00     ORA ram_0000_t43_btns_LR
...
C - - - - - 0x01CE2E 07:CE1E: A5 10     LDA ram_0010_t02
...
C - - - - - 0x01CE40 07:CE30: 85 11     STA ram_0011_t04_pos_Y_lo
...
; con_ariel_jumping_out_of_water
; jumping out of water
C - - J - - 0x01CE4E 07:CE3E: AD 30 04  LDA ram_0430_obj_animation
C - - - - - 0x01CE51 07:CE41: 29 03     AND #$03
C - - - - - 0x01CE53 07:CE43: D0 10     BNE bra_CE55
C - - - - - 0x01CE55 07:CE45: AD 18 04  LDA ram_obj_animation_cnt
C - - - - - 0x01CE58 07:CE48: F0 F3     BEQ bra_CE3D_RTS
C - - - - - 0x01CE5A 07:CE4A: EE 30 04  INC ram_0430_obj_animation
C - - - - - 0x01CE5D 07:CE4D: A9 00     LDA #$00
C - - - - - 0x01CE5F 07:CE4F: 8D 48 04  STA ram_0448_obj
C - - - - - 0x01CE62 07:CE52: 8D 18 04  STA ram_obj_animation_cnt
bra_CE55:
C - - - - - 0x01CE65 07:CE55: AD B0 03  LDA ram_spd_Y_hi
C - - - - - 0x01CE68 07:CE58: 30 2B     BMI bra_CE85
C - - - - - 0x01CE6A 07:CE5A: A5 39     LDA ram_0039_timer_00_08
C - - - - - 0x01CE6C 07:CE5C: F0 04     BEQ bra_CE62
C - - - - - 0x01CE6E 07:CE5E: C6 39     DEC ram_0039_timer_00_08
...
C - - - - - 0x01CE83 07:CE73: AD 30 04  LDA ram_0430_obj_animation
C - - - - - 0x01CE86 07:CE76: 29 02     AND #$02
C - - - - - 0x01CE88 07:CE78: D0 22     BNE bra_CE9C
C - - - - - 0x01CE8A 07:CE7A: 8D 48 04  STA ram_0448_obj
C - - - - - 0x01CE8D 07:CE7D: 8D 18 04  STA ram_obj_animation_cnt
C - - - - - 0x01CE90 07:CE80: EE 30 04  INC ram_0430_obj_animation
...
C - - - - - 0x01CE9C 07:CE8C: AD 30 04  LDA ram_0430_obj_animation
C - - - - - 0x01CE9F 07:CE8F: 29 01     AND #$01
C - - - - - 0x01CEA1 07:CE91: D0 09     BNE bra_CE9C
C - - - - - 0x01CEA3 07:CE93: 8D 48 04  STA ram_0448_obj
C - - - - - 0x01CEA6 07:CE96: 8D 18 04  STA ram_obj_animation_cnt
C - - - - - 0x01CEA9 07:CE99: EE 30 04  INC ram_0430_obj_animation
bra_CE9C:
...
C - - - - - 0x01CED4 07:CEC4: 85 5D     STA ram_005D_spd_X_lo
C - - - - - 0x01CED6 07:CEC6: A9 02     LDA #$02
C - - - - - 0x01CED8 07:CEC8: 85 5E     STA ram_005E_spd_X_hi
C - - - - - 0x01CEDA 07:CECA: A9 30     LDA #$30
C - - - - - 0x01CEDC 07:CECC: 85 36     STA ram_0036_t02
C - - - - - 0x01CEDE 07:CECE: A0 01     LDY #con_btn_Right
C - - - - - 0x01CEE0 07:CED0: AD 00 04  LDA ram_0400_obj_flags
C - - - - - 0x01CEE3 07:CED3: 29 40     AND #$40
C - - - - - 0x01CEE5 07:CED5: D0 02     BNE bra_CED9
C - - - - - 0x01CEE7 07:CED7: A0 02     LDY #con_btn_Left
bra_CED9:
C - - - - - 0x01CEE9 07:CED9: 84 5C     STY ram_005C_btns_LR
...
C - - - - - 0x01CF24 07:CF14: CD 18 04  CMP ram_obj_animation_cnt
...
C - - - - - 0x01CF43 07:CF33: 85 00     STA ram_0000_t44_direction
C - - - - - 0x01CF45 07:CF35: AD 00 04  LDA ram_0400_obj_flags
C - - - - - 0x01CF48 07:CF38: 29 40     AND #$40
C - - - - - 0x01CF4A 07:CF3A: D0 04     BNE bra_CF40
; bzk optimize, INC -> 02
C - - - - - 0x01CF4C 07:CF3C: A9 02     LDA #$02
C - - - - - 0x01CF4E 07:CF3E: 85 00     STA ram_0000_t44_direction
bra_CF40:
C - - - - - 0x01CF50 07:CF40: A5 00     LDA ram_0000_t44_direction
bra_CF42:
C - - - - - 0x01CF52 07:CF42: 99 D0 03  STA ram_obj_direction,Y
...
C - - - - - 0x01CF6A 07:CF5A: AD 00 04  LDA ram_0400_obj_flags
...
C - - - - - 0x01CFB8 07:CFA8: A9 94     LDA #$04 + $10 + $80
C - - - - - 0x01CFBA 07:CFAA: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x01CFD0 07:CFC0: AD 00 04  LDA ram_0400_obj_flags
...
loc_CFEE:
C D 2 - - - 0x01CFFE 07:CFEE: A5 11     LDA ram_0011_t04_pos_Y_lo
...
bra_D014:
C - - - - - 0x01D024 07:D014: 86 00     STX ram_0000_t45_obj_index
...
C - - - - - 0x01D039 07:D029: A6 00     LDX ram_0000_t45_obj_index
...
C - - - - - 0x01D04C 07:D03C: B9 00 04  LDA ram_0400_obj_flags,Y
C - - - - - 0x01D04F 07:D03F: 29 BF     AND #$40 ^ $FF
C - - - - - 0x01D051 07:D041: 99 00 04  STA ram_0400_obj_flags,Y
...
C - - - - - 0x01D060 07:D050: AD 00 04  LDA ram_0400_obj_flags
...
C - - - - - 0x01D06D 07:D05D: 99 D0 03  STA ram_obj_direction,Y
...
tbl_D085_pos_X:
- D 2 - - - 0x01D095 07:D085: F6 FF     .word $FFF6 ; 00 
- D 2 - - - 0x01D097 07:D087: 0A 00     .word $000A ; 01 
...
C - - - - - 0x01D0DC 07:D0CC: CD 30 04  CMP ram_0430_obj_animation
C - - - - - 0x01D0DF 07:D0CF: F0 18     BEQ bra_D0E9
C - - - - - 0x01D0E1 07:D0D1: 20 45 FC  JSR sub_FC45
C - - - - - 0x01D0E4 07:D0D4: A9 30     LDA #$30
C - - - - - 0x01D0E6 07:D0D6: 85 36     STA ram_0036_t02
C - - - - - 0x01D0E8 07:D0D8: A5 5C     LDA ram_005C_btns_LR
...
bra_D0E9:
loc_D0E9:
C D 2 - - - 0x01D0F9 07:D0E9: A5 5C     LDA ram_005C_btns_LR
...
C - - - - - 0x01D103 07:D0F3: C5 5C     CMP ram_005C_btns_LR
C - - - - - 0x01D105 07:D0F5: D0 06     BNE bra_D0FD
bra_D0F7:
C - - - - - 0x01D107 07:D0F7: A5 38     LDA ram_frm_cnt_1
C - - - - - 0x01D109 07:D0F9: 29 01     AND #$01
C - - - - - 0x01D10B 07:D0FB: D0 26     BNE bra_D123
bra_D0FD:
C - - - - - 0x01D10D 07:D0FD: A5 36     LDA ram_0036_t02
...
C - - - - - 0x01D116 07:D106: 85 36     STA ram_0036_t02
C - - - - - 0x01D118 07:D108: B0 04     BCS bra_D10E
- - - - - - 0x01D11A 07:D10A: A9 10     LDA #$10
- - - - - - 0x01D11C 07:D10C: 85 36     STA ram_0036_t02
bra_D10E:
C - - - - - 0x01D11E 07:D10E: A5 5D     LDA ram_005D_spd_X_lo
C - - - - - 0x01D120 07:D110: 38        SEC
C - - - - - 0x01D121 07:D111: E5 36     SBC ram_0036_t02
C - - - - - 0x01D123 07:D113: 85 5D     STA ram_005D_spd_X_lo
C - - - - - 0x01D125 07:D115: 8D 80 03  STA ram_spd_X_lo
C - - - - - 0x01D128 07:D118: A5 5E     LDA ram_005E_spd_X_hi
C - - - - - 0x01D12A 07:D11A: E9 00     SBC #$00
C - - - - - 0x01D12C 07:D11C: 85 5E     STA ram_005E_spd_X_hi
C - - - - - 0x01D12E 07:D11E: 8D 90 03  STA ram_spd_X_hi
C - - - - - 0x01D131 07:D121: 90 08     BCC bra_D12B
bra_D123:
C - - - - - 0x01D133 07:D123: A5 5C     LDA ram_005C_btns_LR
C - - - - - 0x01D135 07:D125: 20 E2 D1  JSR sub_D1E2
C - - - - - 0x01D138 07:D128: 4C BB D1  JMP loc_D1BB
bra_D12B:
C - - - - - 0x01D13B 07:D12B: A9 00     LDA #$00
C - - - - - 0x01D13D 07:D12D: 85 5C     STA ram_005C_btns_LR
C - - - - - 0x01D13F 07:D12F: 8D 80 03  STA ram_spd_X_lo
C - - - - - 0x01D142 07:D132: 8D 90 03  STA ram_spd_X_hi
C - - - - - 0x01D145 07:D135: 85 5D     STA ram_005D_spd_X_lo
C - - - - - 0x01D147 07:D137: 85 5E     STA ram_005E_spd_X_hi
bra_D139:
...
C - - - - - 0x01D16C 07:D15C: 85 5C     STA ram_005C_btns_LR
bra_D15E:
C - - - - - 0x01D16E 07:D15E: AD 30 04  LDA ram_0430_obj_animation
...
- - - - - - 0x01D190 07:D180: 85 5D     STA ram_005D_spd_X_lo
- - - - - - 0x01D192 07:D182: A9 02     LDA #$02
- - - - - - 0x01D194 07:D184: 85 5E     STA ram_005E_spd_X_hi
- - - - - - 0x01D196 07:D186: A9 30     LDA #$30
- - - - - - 0x01D198 07:D188: 85 36     STA ram_0036_t02
- - - - - - 0x01D19A 07:D18A: A0 01     LDY #con_btn_Right
- - - - - - 0x01D19C 07:D18C: AD 00 04  LDA ram_0400_obj_flags
- - - - - - 0x01D19F 07:D18F: 29 40     AND #$40
- - - - - - 0x01D1A1 07:D191: D0 02     BNE bra_D195
- - - - - - 0x01D1A3 07:D193: A0 02     LDY #con_btn_Left
bra_D195:
- - - - - - 0x01D1A5 07:D195: 84 5C     STY ram_005C_btns_LR
...
C - - - - - 0x01D1B9 07:D1A9: AD 18 04  LDA ram_obj_animation_cnt
...
C - - - - - 0x01D1C5 07:D1B5: 8D 48 04  STA ram_0448_obj
C - - - - - 0x01D1C8 07:D1B8: 8D 18 04  STA ram_obj_animation_cnt
loc_D1BB:
C D 2 - - - 0x01D1CB 07:D1BB: AD 00 04  LDA ram_0400_obj_flags
C - - - - - 0x01D1CE 07:D1BE: 29 BF     AND #$40 ^ $FF
C - - - - - 0x01D1D0 07:D1C0: 85 00     STA ram_0000_t46
...
C - - - - - 0x01D1DB 07:D1CB: 05 00     ORA ram_0000_t46
C - - - - - 0x01D1DD 07:D1CD: 8D 00 04  STA ram_0400_obj_flags
bra_D1D0_RTS:
...
sub_D1E2:
C - - - - - 0x01D1F2 07:D1E2: 29 01     AND #con_btn_Right
...
sub_D203:
loc_D203:
; !!! ref via ram_0024_t01_data
; walkthough movie, frame 118068
...
C - - - - - 0x01D21D 07:D20D: B9 00 04  LDA ram_0400_obj_flags,Y
C D 2 - I - 0x01D220 07:D210: 29 BF     AND #$40 ^ $FF
C D 2 - I - 0x01D222 07:D212: 99 00 04  STA ram_0400_obj_flags,Y
...
C - - - - - 0x01D27A 07:D26A: CD 30 04  CMP ram_0430_obj_animation
...
C - - - - - 0x01D285 07:D275: A5 10     LDA ram_0010_t02
...
C - - - - - 0x01D2A0 07:D290: CD 30 04  CMP ram_0430_obj_animation
...
C - - - - - 0x01D2BB 07:D2AB: 85 3F     STA ram_003F_timer_00_60
C - - - - - 0x01D2BD 07:D2AD: AD 60 04  LDA ram_0460_t02_ariel_status
C - - - - - 0x01D2C0 07:D2B0: C9 02     CMP #con_ariel_jumping_out_of_water
...
C - - - - - 0x01D2E8 07:D2D8: AD 00 04  LDA ram_0400_obj_flags
C - - - - - 0x01D2EB 07:D2DB: 48        PHA
C - - - - - 0x01D2EC 07:D2DC: 20 B9 FC  JSR sub_FCB9
C - - - - - 0x01D2EF 07:D2DF: 68        PLA
C - - - - - 0x01D2F0 07:D2E0: 8D 00 04  STA ram_0400_obj_flags
C - - - - - 0x01D2F3 07:D2E3: CE 70 04  DEC ram_obj_timer
C - - - - - 0x01D2F6 07:D2E6: D0 1C     BNE bra_D304_RTS
; bzk optimize, always 00 (con_ariel_default)
C - - - - - 0x01D2F8 07:D2E8: AD 60 04  LDA ram_0460_t02_ariel_status
...
bra_D310:
C - - - - - 0x01D320 07:D310: AD 00 04  LDA ram_0400_obj_flags
...
C - - - - - 0x01D32A 07:D31A: 8D 00 04  STA ram_0400_obj_flags
...
bra_D333_loop:
C - - - - - 0x01D343 07:D333: B9 00 06  LDA ram_palette_buffer,Y
...
bra_D33D:
C - - - - - 0x01D34D 07:D33D: 99 00 06  STA ram_palette_buffer,Y
C - - - - - 0x01D350 07:D340: 99 20 06  STA ram_max_brightness_buffer,Y
C - - - - - 0x01D353 07:D343: 88        DEY
C - - - - - 0x01D354 07:D344: 10 ED     BPL bra_D333_loop
; Y = FF
C - - - - - 0x01D356 07:D346: 84 18     STY ram_0018_flag
bra_D348:
...
; con_ariel_waiting_for_boss
; waiting for boss, can't move
C - - J - - 0x01D374 07:D364: A9 00     LDA #$00
C - - - - - 0x01D376 07:D366: 8D 48 04  STA ram_0448_obj
C - - - - - 0x01D379 07:D369: CE 60 04  DEC ram_0460_t01_boss_timer_wait
C - - - - - 0x01D37C 07:D36C: D0 05     BNE bra_D373_RTS
C - - - - - 0x01D37E 07:D36E: AD 70 04  LDA ram_0470_t01_copy_ariel_status
; con_ariel_default
; con_ariel_coming_to_ice
...
C - - - - - 0x01D387 07:D377: A4 E9     LDY ram_stage_id
...
C - - - - - 0x01D394 07:D384: A5 E9     LDA ram_stage_id
C - - - - - 0x01D396 07:D386: C9 05     CMP #$05
C - - - - - 0x01D398 07:D388: D0 25     BNE bra_D3AF
; if final battle
C - - - - - 0x01D39A 07:D38A: A2 5A     LDX #$5A
C - - - - - 0x01D39C 07:D38C: 20 A6 FF  JSR sub_FFA6_wait_X_frms
C - - - - - 0x01D39F 07:D38F: A0 0F     LDY #$0F
bra_D391_loop:
C - - - - - 0x01D3A1 07:D391: B9 BA D3  LDA tbl_D3BA,Y
C - - - - - 0x01D3A4 07:D394: 99 20 06  STA ram_max_brightness_buffer,Y
C - - - - - 0x01D3A7 07:D397: 88        DEY
C - - - - - 0x01D3A8 07:D398: 10 F7     BPL bra_D391_loop
; disable rendering
C - - - - - 0x01D3AA 07:D39A: A9 00     LDA #$00
C - - - - - 0x01D3AC 07:D39C: 85 EE     STA ram_rendering_flag
; prepare increasing brightness
C - - - - - 0x01D3AE 07:D39E: A9 30     LDA #$30
C - - - - - 0x01D3B0 07:D3A0: 85 0F     STA ram_000F_t13_brightness_sub
C - - - - - 0x01D3B2 07:D3A2: A9 F0     LDA #$F0
C - - - - - 0x01D3B4 07:D3A4: 85 0D     STA ram_000D_t02_brightness_add
; 
C - - - - - 0x01D3B6 07:D3A6: A9 10     LDA #$10
C - - - - - 0x01D3B8 07:D3A8: 85 0E     STA ram_000E_t07_loop_counter
C - - - - - 0x01D3BA 07:D3AA: 20 F7 C1  JSR sub_C1F7
; enable rendering
C - - - - - 0x01D3BD 07:D3AD: E6 EE     INC ram_rendering_flag   ; -> 01
bra_D3AF:
...
; out
    ; ram_0036_t01_spd_lo
C - - - - - 0x01D3DA 07:D3CA: A5 38     LDA ram_frm_cnt_1
C - - - - - 0x01D3DC 07:D3CC: 29 01     AND #$01
C - - - - - 0x01D3DE 07:D3CE: F0 11     BEQ bra_D3E1_RTS
C - - - - - 0x01D3E0 07:D3D0: A5 36     LDA ram_0036_t01_spd_lo
...
C - - - - - 0x01D3E9 07:D3D9: 85 36     STA ram_0036_t01_spd_lo
C - - - - - 0x01D3EB 07:D3DB: B0 04     BCS bra_D3E1_RTS
- - - - - - 0x01D3ED 07:D3DD: A9 10     LDA #$10
- - - - - - 0x01D3EF 07:D3DF: 85 36     STA ram_0036_t01_spd_lo
bra_D3E1_RTS:
...
C - - - - - 0x01D3F6 07:D3E6: E5 36     SBC ram_0036_t01_spd_lo
...
C - - - - - 0x01D412 07:D402: E5 36     SBC ram_0036_t01_spd_lo
...
; out
    ; ram_0036_t01_spd_lo
C - - - - - 0x01D42A 07:D41A: A5 38     LDA ram_frm_cnt_1
C - - - - - 0x01D42C 07:D41C: 29 01     AND #$01
C - - - - - 0x01D42E 07:D41E: F0 0B     BEQ bra_D42B_RTS
C - - - - - 0x01D430 07:D420: A5 36     LDA ram_0036_t01_spd_lo
...
C - - - - - 0x01D439 07:D429: 85 36     STA ram_0036_t01_spd_lo
bra_D42B_RTS:
...
C - - - - - 0x01D449 07:D439: 65 36     ADC ram_0036_t01_spd_lo
...
sub_D471:
C - - - - - 0x01D481 07:D471: BD 30 04  LDA ram_0430_obj_animation,X
C - - - - - 0x01D484 07:D474: C9 09     CMP #$09
C - - - - - 0x01D486 07:D476: D0 09     BNE bra_D481
C - - - - - 0x01D488 07:D478: A9 05     LDA #$05
C - - - - - 0x01D48A 07:D47A: DD 18 04  CMP ram_obj_animation_cnt,X
...
sub_D483:
C - - - - - 0x01D493 07:D483: A5 11     LDA ram_0011_t04_pos_Y_lo
...
bra_D490:
C - - - - - 0x01D4A0 07:D490: 85 00     STA ram_0000_t47
C - - - - - 0x01D4A2 07:D492: A2 00     LDX #$00    ; player?
C - - - - - 0x01D4A4 07:D494: 86 01     STX ram_0001_t10_obj_index
loc_D496:
; in
    ; ram_0000_t47
C D 2 - - - 0x01D4A6 07:D496: A0 0F     LDY #$0F
loc_D498_loop:
C D 2 - - - 0x01D4A8 07:D498: BD 00 04  LDA ram_0400_obj_flags,X
...
C - - - - - 0x01D4E6 07:D4D6: E5 00     SBC ram_0000_t47
...
C - - - - - 0x01D4F2 07:D4E2: B9 30 04  LDA ram_0430_obj_animation,Y
...
C - - - - - 0x01D50F 07:D4FF: B9 30 04  LDA ram_0430_obj_animation,Y
...
bra_D50A:
C - - - - - 0x01D51A 07:D50A: B9 00 04  LDA ram_0400_obj_flags,Y
C - - - - - 0x01D51D 07:D50D: 29 FB     AND #$04 ^ $FF
C - - - - - 0x01D51F 07:D50F: 99 00 04  STA ram_0400_obj_flags,Y
C - - - - - 0x01D522 07:D512: 86 02     STX ram_0002_t12_obj_index_1
C - - - - - 0x01D524 07:D514: 84 03     STY ram_0003_t01_obj_index_2
C - - - - - 0x01D526 07:D516: A6 03     LDX ram_0003_t01_obj_index_2
C - - - - - 0x01D528 07:D518: 20 64 FE  JSR sub_FE64
C - - - - - 0x01D52B 07:D51B: A6 02     LDX ram_0002_t12_obj_index_1
C - - - - - 0x01D52D 07:D51D: A4 03     LDY ram_0003_t01_obj_index_2
C - - - - - 0x01D52F 07:D51F: BD 30 04  LDA ram_0430_obj_animation,X
...
sub_0x01D545:
C - - - - - 0x01D545 07:D535: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01D548 07:D538: 10 F9     BPL bra_D533_loop
C - - - - - 0x01D54A 07:D53A: 86 01     STX ram_0001_t10_obj_index
...
bra_D547:
C - - - - - 0x01D557 07:D547: 85 00     STA ram_0000_t47
...
C - - - - - 0x01D56C 07:D55C: B9 30 04  LDA ram_0430_obj_animation,Y
C - - - - - 0x01D56F 07:D55F: C9 89     CMP #$89
C - - - - - 0x01D571 07:D561: D0 15     BNE bra_D578
C - - - - - 0x01D573 07:D563: B9 00 04  LDA ram_0400_obj_flags,Y
C - - - - - 0x01D576 07:D566: 29 BF     AND #$40 ^ $FF
C - - - - - 0x01D578 07:D568: 99 00 04  STA ram_0400_obj_flags,Y
C - - - - - 0x01D57B 07:D56B: A9 88     LDA #$88
C - - - - - 0x01D57D 07:D56D: 99 30 04  STA ram_0430_obj_animation,Y
C - - - - - 0x01D580 07:D570: A9 00     LDA #$00
C - - - - - 0x01D582 07:D572: 99 48 04  STA ram_0448_obj,Y
C - - - - - 0x01D585 07:D575: 99 18 04  STA ram_obj_animation_cnt,Y
bra_D578:
...
C - - - - - 0x01D595 07:D585: B9 30 04  LDA ram_0430_obj_animation,Y
C - - - - - 0x01D598 07:D588: C9 85     CMP #$85
C - - - - - 0x01D59A 07:D58A: D0 17     BNE bra_D5A3
C - - - - - 0x01D59C 07:D58C: B9 00 04  LDA ram_0400_obj_flags,Y
C - - - - - 0x01D59F 07:D58F: 29 04     AND #$04
C - - - - - 0x01D5A1 07:D591: D0 15     BNE bra_D5A8_RTS
C - - - - - 0x01D5A3 07:D593: B9 18 04  LDA ram_obj_animation_cnt,Y
C - - - - - 0x01D5A6 07:D596: C9 0B     CMP #$0B
C - - - - - 0x01D5A8 07:D598: D0 0E     BNE bra_D5A8_RTS
C - - - - - 0x01D5AA 07:D59A: B9 00 04  LDA ram_0400_obj_flags,Y
C - - - - - 0x01D5AD 07:D59D: 09 04     ORA #$04
C - - - - - 0x01D5AF 07:D59F: 99 00 04  STA ram_0400_obj_flags,Y
...
sub_D5A9:
C - - - - - 0x01D5B9 07:D5A9: A5 E9     LDA ram_stage_id
C - - - - - 0x01D5BB 07:D5AB: C9 05     CMP #$05
C - - - - - 0x01D5BD 07:D5AD: D0 3E     BNE bra_D5ED
; if final battle
C - - - - - 0x01D5BF 07:D5AF: 20 7E D5  JSR sub_D57E
C - - - - - 0x01D5C2 07:D5B2: A5 7A     LDA ram_007A_direction
C - - - - - 0x01D5C4 07:D5B4: F0 37     BEQ bra_D5ED
C - - - - - 0x01D5C6 07:D5B6: 20 69 D6  JSR sub_D669
C - - - - - 0x01D5C9 07:D5B9: A5 7E     LDA ram_007E_timer
C - - - - - 0x01D5CB 07:D5BB: F0 14     BEQ bra_D5D1
C - - - - - 0x01D5CD 07:D5BD: C6 7E     DEC ram_007E_timer
C - - - - - 0x01D5CF 07:D5BF: E6 7D     INC ram_007D_spd_X_lo
C - - - - - 0x01D5D1 07:D5C1: A5 7B     LDA ram_007B_t02_spd_X_lo
C - - - - - 0x01D5D3 07:D5C3: 18        CLC
C - - - - - 0x01D5D4 07:D5C4: 65 7D     ADC ram_007D_spd_X_lo
C - - - - - 0x01D5D6 07:D5C6: C9 B3     CMP #$B3
C - - - - - 0x01D5D8 07:D5C8: 90 02     BCC bra_D5CC
C - - - - - 0x01D5DA 07:D5CA: A9 B3     LDA #$B3
bra_D5CC:
C - - - - - 0x01D5DC 07:D5CC: 85 7B     STA ram_007B_t02_spd_X_lo
C - - - - - 0x01D5DE 07:D5CE: 4C EF D5  JMP loc_D5EF
bra_D5D1:
C - - - - - 0x01D5E1 07:D5D1: C6 7D     DEC ram_007D_spd_X_lo
C - - - - - 0x01D5E3 07:D5D3: A9 01     LDA #$01
C - - - - - 0x01D5E5 07:D5D5: C5 7D     CMP ram_007D_spd_X_lo
C - - - - - 0x01D5E7 07:D5D7: 90 02     BCC bra_D5DB
- - - - - - 0x01D5E9 07:D5D9: 85 7D     STA ram_007D_spd_X_lo
bra_D5DB:
C - - - - - 0x01D5EB 07:D5DB: A5 7B     LDA ram_007B_t02_spd_X_lo
C - - - - - 0x01D5ED 07:D5DD: 38        SEC
C - - - - - 0x01D5EE 07:D5DE: E5 7D     SBC ram_007D_spd_X_lo
C - - - - - 0x01D5F0 07:D5E0: B0 02     BCS bra_D5E4
C - - - - - 0x01D5F2 07:D5E2: A9 00     LDA #$00
bra_D5E4:
C - - - - - 0x01D5F4 07:D5E4: 85 7B     STA ram_007B_t01_flag
C - - - - - 0x01D5F6 07:D5E6: D0 07     BNE bra_D5EF
C - - - - - 0x01D5F8 07:D5E8: 85 7A     STA ram_007A_direction
...
bra_D5EF:
loc_D5EF:
C D 2 - - - 0x01D5FF 07:D5EF: A5 7A     LDA ram_007A_direction
C - - - - - 0x01D601 07:D5F1: 85 00     STA ram_0000_t48_direction
C - - - - - 0x01D603 07:D5F3: A5 7B     LDA ram_007B_t02_spd_X_lo
C - - - - - 0x01D605 07:D5F5: 85 01     STA ram_0001_t11_spd_X_lo
C - - - - - 0x01D607 07:D5F7: A9 00     LDA #$00
C - - - - - 0x01D609 07:D5F9: 85 02     STA ram_0002_t13_spd_X_hi
C - - - - - 0x01D60B 07:D5FB: A5 31     LDA ram_0031
C - - - - - 0x01D60D 07:D5FD: 29 03     AND #$03
C - - - - - 0x01D60F 07:D5FF: F0 3F     BEQ bra_D640
C - - - - - 0x01D611 07:D601: C5 7A     CMP ram_007A_direction
C - - - - - 0x01D613 07:D603: F0 2A     BEQ bra_D62F
C - - - - - 0x01D615 07:D605: 85 00     STA ram_0000_t48_direction
C - - - - - 0x01D617 07:D607: AD 80 03  LDA ram_spd_X_lo
C - - - - - 0x01D61A 07:D60A: 38        SEC
C - - - - - 0x01D61B 07:D60B: E5 7B     SBC ram_007B_t02_spd_X_lo
C - - - - - 0x01D61D 07:D60D: 85 01     STA ram_0001_t11_spd_X_lo
C - - - - - 0x01D61F 07:D60F: AD 90 03  LDA ram_spd_X_hi
C - - - - - 0x01D622 07:D612: E9 00     SBC #$00
C - - - - - 0x01D624 07:D614: 85 02     STA ram_0002_t13_spd_X_hi
C - - - - - 0x01D626 07:D616: B0 28     BCS bra_D640
C - - - - - 0x01D628 07:D618: A5 7A     LDA ram_007A_direction
C - - - - - 0x01D62A 07:D61A: 85 00     STA ram_0000_t48_direction
C - - - - - 0x01D62C 07:D61C: A5 01     LDA ram_0001_t11_spd_X_lo
C - - - - - 0x01D62E 07:D61E: 49 FF     EOR #$FF
C - - - - - 0x01D630 07:D620: 69 01     ADC #$01
C - - - - - 0x01D632 07:D622: 85 01     STA ram_0001_t11_spd_X_lo
C - - - - - 0x01D634 07:D624: A5 02     LDA ram_0002_t13_spd_X_hi
C - - - - - 0x01D636 07:D626: 49 FF     EOR #$FF
C - - - - - 0x01D638 07:D628: 69 00     ADC #$00
C - - - - - 0x01D63A 07:D62A: 85 02     STA ram_0002_t13_spd_X_hi
C - - - - - 0x01D63C 07:D62C: 4C 40 D6  JMP loc_D640
bra_D62F:
C - - - - - 0x01D63F 07:D62F: 85 00     STA ram_0000_t48_direction
C - - - - - 0x01D641 07:D631: AD 80 03  LDA ram_spd_X_lo
C - - - - - 0x01D644 07:D634: 18        CLC
C - - - - - 0x01D645 07:D635: 65 7B     ADC ram_007B_t02_spd_X_lo
C - - - - - 0x01D647 07:D637: 85 01     STA ram_0001_t11_spd_X_lo
C - - - - - 0x01D649 07:D639: AD 90 03  LDA ram_spd_X_hi
C - - - - - 0x01D64C 07:D63C: 69 00     ADC #$00
C - - - - - 0x01D64E 07:D63E: 85 02     STA ram_0002_t13_spd_X_hi
bra_D640:
loc_D640:
...
C - - - - - 0x01D658 07:D648: AD 00 04  LDA ram_0400_obj_flags
C - - - - - 0x01D65B 07:D64B: 48        PHA
C - - - - - 0x01D65C 07:D64C: A5 01     LDA ram_0001_t11_spd_X_lo
C - - - - - 0x01D65E 07:D64E: 8D 80 03  STA ram_spd_X_lo
C - - - - - 0x01D661 07:D651: A5 02     LDA ram_0002_t13_spd_X_hi
C - - - - - 0x01D663 07:D653: 8D 90 03  STA ram_spd_X_hi
C - - - - - 0x01D666 07:D656: A5 00     LDA ram_0000_t48_direction
C - - - - - 0x01D668 07:D658: 20 FF CE  JSR sub_CEFF
C - - - - - 0x01D66B 07:D65B: 68        PLA
C - - - - - 0x01D66C 07:D65C: 8D 00 04  STA ram_0400_obj_flags
...
sub_D669:
C - - - - - 0x01D679 07:D669: A5 7E     LDA ram_007E_timer
...
C - - - - - 0x01D6A6 07:D696: A5 7A     LDA ram_007A_direction
C - - - - - 0x01D6A8 07:D698: 99 D0 03  STA ram_obj_direction,Y
...
bra_D6A4:
C - - - - - 0x01D6B4 07:D6A4: 86 00     STX ram_0000_t49_save_X
C - - - - - 0x01D6B6 07:D6A6: A6 1C     LDX ram_001C_counter_00_02
...
bra_D6B5:
C - - - - - 0x01D6C5 07:D6B5: 86 1C     STX ram_001C_counter_00_02
C - - - - - 0x01D6C7 07:D6B7: A6 00     LDX ram_0000_t49_save_X
...
; in
    ; ram_0001_t08
C D 2 - - - 0x01D6CD 07:D6BD: A5 01     LDA ram_0001_t08
C - - - - - 0x01D6CF 07:D6BF: 85 26     STA ram_0026_counter
C - - - - - 0x01D6D1 07:D6C1: F0 3A     BEQ bra_D6FD_RTS
C - - - - - 0x01D6D3 07:D6C3: A9 00     LDA #$00
C - - - - - 0x01D6D5 07:D6C5: 85 04     STA ram_0004_t07_buffer_index_1
C - - - - - 0x01D6D7 07:D6C7: A9 1F     LDA #$1F
C - - - - - 0x01D6D9 07:D6C9: 85 05     STA ram_0005_t04_buffer_index_2
bra_D6CB_loop:
...
C - - - - - 0x01D6E3 07:D6D3: 85 00     STA ram_0000_t50
...
C - - - - - 0x01D6EB 07:D6DB: 05 00     ORA ram_0000_t50
C - - - - - 0x01D6ED 07:D6DD: 85 21     STA ram_0021
C - - - - - 0x01D6EF 07:D6DF: 20 C7 D8  JSR sub_D8C7
C - - - - - 0x01D6F2 07:D6E2: 20 FE D6  JSR sub_D6FE
C - - - - - 0x01D6F5 07:D6E5: C6 26     DEC ram_0026_counter
C - - - - - 0x01D6F7 07:D6E7: F0 0B     BEQ bra_D6F4
C - - - - - 0x01D6F9 07:D6E9: A5 05     LDA ram_0005_t04_buffer_index_2
C - - - - - 0x01D6FB 07:D6EB: 85 04     STA ram_0004_t07_buffer_index_1
C - - - - - 0x01D6FD 07:D6ED: 18        CLC
C - - - - - 0x01D6FE 07:D6EE: 69 1F     ADC #$1F
C - - - - - 0x01D700 07:D6F0: 85 05     STA ram_0005_t04_buffer_index_2
C - - - - - 0x01D702 07:D6F2: D0 D7     BNE bra_D6CB_loop
bra_D6F4:
C - - - - - 0x01D704 07:D6F4: A6 05     LDX ram_0005_t04_buffer_index_2
C - - - - - 0x01D706 07:D6F6: A9 FF     LDA #$FF
C - - - - - 0x01D708 07:D6F8: 9D 80 07  STA ram_ppu_buffer,X
C - - - - - 0x01D70B 07:D6FB: 85 19     STA ram_buffer_ready_flag   ; ready
bra_D6FD_RTS:
...
C - - - - - 0x01D718 07:D708: 85 00     STA ram_0000_t51
C - - - - - 0x01D71A 07:D70A: 09 03     ORA #$03
C - - - - - 0x01D71C 07:D70C: A6 04     LDX ram_0004_t07_buffer_index_1
...
C - - - - - 0x01D728 07:D718: 65 00     ADC ram_0000_t51
C - - - - - 0x01D72A 07:D71A: 85 00     STA ram_0000_t52_ppu_hi
...
bra_D723:
C - - - - - 0x01D733 07:D723: 85 01     STA ram_0001_t12_ppu_lo
C - - - - - 0x01D735 07:D725: A5 22     LDA ram_0022
C - - - - - 0x01D737 07:D727: 29 38     AND #$38
C - - - - - 0x01D739 07:D729: 4A        LSR
C - - - - - 0x01D73A 07:D72A: 05 01     ORA ram_0001_t12_ppu_lo
C - - - - - 0x01D73C 07:D72C: 85 01     STA ram_0001_t13_ppu_lo
...
C - - - - - 0x01D74A 07:D73A: A5 10     LDA ram_0010_t03_attribute
C - - - - - 0x01D74C 07:D73C: 9D 9F 07  STA ram_ppu_buffer + $1F,X
C - - - - - 0x01D74F 07:D73F: 99 40 06  STA ram_nmt_attr_buffer,Y
...
C - - - - - 0x01D75F 07:D74F: A4 05     LDY ram_0005_t04_buffer_index_2
C - - - - - 0x01D761 07:D751: A2 03     LDX #$03
bra_D753_loop:
C - - - - - 0x01D763 07:D753: B9 80 07  LDA ram_ppu_buffer,Y
C - - - - - 0x01D766 07:D756: 99 72 07  STA ram_ppu_buffer - $0E,Y
C - - - - - 0x01D769 07:D759: 88        DEY
C - - - - - 0x01D76A 07:D75A: CA        DEX
C - - - - - 0x01D76B 07:D75B: 10 F6     BPL bra_D753_loop
C - - - - - 0x01D76D 07:D75D: A5 04     LDA ram_0004_t07_buffer_index_1
C - - - - - 0x01D76F 07:D75F: 18        CLC
C - - - - - 0x01D770 07:D760: 69 11     ADC #$11
C - - - - - 0x01D772 07:D762: 85 05     STA ram_0005_t04_buffer_index_2
C - - - - - 0x01D774 07:D764: A2 01     LDX #$01
bra_D766:
C - - - - - 0x01D776 07:D766: 86 02     STX ram_0002_t14_loop_counter
C - - - - - 0x01D778 07:D768: A2 00     LDX #$00
C - - - - - 0x01D77A 07:D76A: A4 04     LDY ram_0004_t07_buffer_index_1
bra_D76C_loop:
C - - - - - 0x01D77C 07:D76C: A5 00     LDA ram_0000_t52_ppu_hi
C - - - - - 0x01D77E 07:D76E: 99 80 07  STA ram_ppu_buffer,Y
C - - - - - 0x01D781 07:D771: A5 01     LDA ram_0001_t13_ppu_lo
C - - - - - 0x01D783 07:D773: 99 81 07  STA ram_ppu_buffer + $01,Y
C - - - - - 0x01D786 07:D776: 18        CLC
C - - - - - 0x01D787 07:D777: 69 20     ADC #$20
C - - - - - 0x01D789 07:D779: 85 01     STA ram_0001_t13_ppu_lo
C - - - - - 0x01D78B 07:D77B: A9 03     LDA #$03
C - - - - - 0x01D78D 07:D77D: 99 82 07  STA ram_ppu_buffer + $02,Y
C - - - - - 0x01D790 07:D780: BD C0 06  LDA ram_06C0_ppu_buffer,X
C - - - - - 0x01D793 07:D783: 99 83 07  STA ram_ppu_buffer + $03,Y
C - - - - - 0x01D796 07:D786: BD C1 06  LDA ram_06C0_ppu_buffer + $01,X
C - - - - - 0x01D799 07:D789: 99 84 07  STA ram_ppu_buffer + $04,Y
C - - - - - 0x01D79C 07:D78C: BD C2 06  LDA ram_06C0_ppu_buffer + $02,X
C - - - - - 0x01D79F 07:D78F: 99 85 07  STA ram_ppu_buffer + $05,Y
C - - - - - 0x01D7A2 07:D792: BD C3 06  LDA ram_06C0_ppu_buffer + $03,X
...
C - - - - - 0x01D7B3 07:D7A3: C6 02     DEC ram_0002_t14_loop_counter
C - - - - - 0x01D7B5 07:D7A5: 10 C5     BPL bra_D76C_loop
C - - - - - 0x01D7B7 07:D7A7: E6 05     INC ram_0005_t04_buffer_index_2
C - - - - - 0x01D7B9 07:D7A9: A5 27     LDA ram_0027_camera_movement_direction
C - - - - - 0x01D7BB 07:D7AB: 29 01     AND #$01
C - - - - - 0x01D7BD 07:D7AD: D0 11     BNE bra_D7C0    ; if right
...
C - - - - - 0x01D7F2 07:D7E2: 85 00     STA ram_0000_t53_ppu_hi
...
C - - - - - 0x01D800 07:D7F0: 65 00     ADC ram_0000_t53_ppu_hi
...
C - - - - - 0x01D822 07:D812: 85 03     STA ram_0003_t08_buffer_index
loc_D814:
...
C - - - - - 0x01D83D 07:D82D: A5 10     LDA ram_0010_t03_attribute
C - - - - - 0x01D83F 07:D82F: 29 F0     AND #$F0
C - - - - - 0x01D841 07:D831: 85 10     STA ram_0010_t04_attribute
C - - - - - 0x01D843 07:D833: B9 40 06  LDA ram_nmt_attr_buffer,Y
C - - - - - 0x01D846 07:D836: 29 0F     AND #$0F
C - - - - - 0x01D848 07:D838: 05 10     ORA ram_0010_t04_attribute
C - - - - - 0x01D84A 07:D83A: 4C 4A D8  JMP loc_D84A
bra_D83D:
C - - - - - 0x01D84D 07:D83D: A5 10     LDA ram_0010_t03_attribute
C - - - - - 0x01D84F 07:D83F: 29 0F     AND #$0F
C - - - - - 0x01D851 07:D841: 85 10     STA ram_0010_t05_attribute
C - - - - - 0x01D853 07:D843: B9 40 06  LDA ram_nmt_attr_buffer,Y
C - - - - - 0x01D856 07:D846: 29 F0     AND #$F0
C - - - - - 0x01D858 07:D848: 05 10     ORA ram_0010_t05_attribute
loc_D84A:
C D 2 - - - 0x01D85A 07:D84A: 99 40 06  STA ram_nmt_attr_buffer,Y
C - - - - - 0x01D85D 07:D84D: A5 03     LDA ram_0003_t08_buffer_index
C - - - - - 0x01D85F 07:D84F: 4A        LSR
C - - - - - 0x01D860 07:D850: 4A        LSR
C - - - - - 0x01D861 07:D851: AA        TAX
C - - - - - 0x01D862 07:D852: B9 40 06  LDA ram_nmt_attr_buffer,Y
...
C - - - - - 0x01D86F 07:D85F: A6 03     LDX ram_0003_t08_buffer_index
C - - - - - 0x01D871 07:D861: B9 C0 06  LDA ram_06C0_ppu_buffer,Y
C - - - - - 0x01D874 07:D864: 9D 83 07  STA ram_ppu_buffer + $03,X
C - - - - - 0x01D877 07:D867: B9 C1 06  LDA ram_06C0_ppu_buffer + $01,Y
C - - - - - 0x01D87A 07:D86A: 9D 84 07  STA ram_ppu_buffer + $04,X
C - - - - - 0x01D87D 07:D86D: B9 C2 06  LDA ram_06C0_ppu_buffer + $02,Y
C - - - - - 0x01D880 07:D870: 9D 85 07  STA ram_ppu_buffer + $05,X
C - - - - - 0x01D883 07:D873: B9 C3 06  LDA ram_06C0_ppu_buffer + $03,Y
...
C - - - - - 0x01D891 07:D881: 86 03     STX ram_0003_t08_buffer_index
...
C - - - - - 0x01D8A7 07:D897: 85 19     STA ram_buffer_ready_flag   ; ready
C - - - - - 0x01D8A9 07:D899: A5 27     LDA ram_0027_camera_movement_direction
C - - - - - 0x01D8AB 07:D89B: 29 04     AND #$04
C - - - - - 0x01D8AD 07:D89D: D0 12     BNE bra_D8B1    ; if down
...
C - - - - - 0x01D8B7 07:D8A7: A5 50     LDA ram_stage_config
...
C - - - - - 0x01D8CD 07:D8BD: A5 50     LDA ram_stage_config
...
C - - - - - 0x01D8D9 07:D8C9: 20 59 D9  JSR sub_D959_prepare_pointers
C - - - - - 0x01D8DC 07:D8CC: 20 36 D9  JSR sub_D936_prepare_pointers_with_bankswitching
C - - - - - 0x01D8DF 07:D8CF: A9 00     LDA #con_prg_bank + $00
C - - - - - 0x01D8E1 07:D8D1: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01D8E4 07:D8D4: A0 03     LDY #$03
C - - - - - 0x01D8E6 07:D8D6: 84 02     STY ram_0002_t15_loop_counter
C - - - - - 0x01D8E8 07:D8D8: A9 00     LDA #$00
C - - - - - 0x01D8EA 07:D8DA: 85 10     STA ram_0010_t03_attribute
loc_D8DC_loop:
C D 2 - - - 0x01D8EC 07:D8DC: A4 02     LDY ram_0002_t15_loop_counter
C - - - - - 0x01D8EE 07:D8DE: BE 55 D9  LDX tbl_D955,Y
C - - - - - 0x01D8F1 07:D8E1: B1 00     LDA (ram_0000_t05_data),Y
C - - - - - 0x01D8F3 07:D8E3: A8        TAY
C - - - - - 0x01D8F4 07:D8E4: B1 64     LDA (ram_0064_t01_stage_data_1),Y
C - - - - - 0x01D8F6 07:D8E6: 9D C0 06  STA ram_06C0_ppu_buffer,X
C - - - - - 0x01D8F9 07:D8E9: B1 66     LDA (ram_0066_t01_stage_data_2),Y
C - - - - - 0x01D8FB 07:D8EB: 9D C1 06  STA ram_06C0_ppu_buffer + $01,X
C - - - - - 0x01D8FE 07:D8EE: B1 68     LDA (ram_0068_t01_stage_data_3),Y
C - - - - - 0x01D900 07:D8F0: 9D C4 06  STA ram_06C0_ppu_buffer + $04,X
C - - - - - 0x01D903 07:D8F3: B1 6A     LDA (ram_006A_t01_stage_data_4),Y
C - - - - - 0x01D905 07:D8F5: 9D C5 06  STA ram_06C0_ppu_buffer + $05,X
C - - - - - 0x01D908 07:D8F8: B1 6C     LDA (ram_006C_t01_stage_data_5),Y
C - - - - - 0x01D90A 07:D8FA: 29 03     AND #$03
C - - - - - 0x01D90C 07:D8FC: 05 10     ORA ram_0010_t03_attribute
C - - - - - 0x01D90E 07:D8FE: 85 10     STA ram_0010_t03_attribute
C - - - - - 0x01D910 07:D900: C6 02     DEC ram_0002_t15_loop_counter
C - - - - - 0x01D912 07:D902: 30 07     BMI bra_D90B
C - - - - - 0x01D914 07:D904: 06 10     ASL ram_0010_t03_attribute
C - - - - - 0x01D916 07:D906: 06 10     ASL ram_0010_t03_attribute
...
bra_D925_loop:
; draw opened chest
; only first 4x2 tiles, which is chest upper half
C - - - - - 0x01D935 07:D925: B9 66 E8  LDA tbl_E85E_chest_tiles + $08,Y
C - - - - - 0x01D938 07:D928: 99 C0 06  STA ram_06C0_ppu_buffer,Y
...
sub_D936_prepare_pointers_with_bankswitching:
; in
    ; ram_0062_t01_data_ptr_lo
    ; ram_0063_t01_data_ptr_hi
; out
    ; ram_0000_t05_data
C - - - - - 0x01D946 07:D936: A5 EA     LDA ram_00EA_useless_prg_bank_01
C - - - - - 0x01D948 07:D938: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
sub_D93B_prepare_pointers:
; in
    ; ram_0062_t01_data_ptr_lo
    ; ram_0063_t01_data_ptr_hi
; out
...
C - - - - - 0x01D94D 07:D93D: 85 01     STA ram_0001_t14_hi
C - - - - - 0x01D94F 07:D93F: A4 21     LDY ram_0021
; bzk bug, see 0x01D96B
C - - - - - 0x01D951 07:D941: B1 24     LDA (ram_0024_t01_data),Y
; * 04
C - - - - - 0x01D953 07:D943: 0A        ASL
C - - - - - 0x01D954 07:D944: 26 01     ROL ram_0001_t14_hi
C - - - - - 0x01D956 07:D946: 0A        ASL
C - - - - - 0x01D957 07:D947: 26 01     ROL ram_0001_t14_hi
C - - - - - 0x01D959 07:D949: 18        CLC
C - - - - - 0x01D95A 07:D94A: 65 62     ADC ram_0062_t01_data_ptr_lo
C - - - - - 0x01D95C 07:D94C: 85 00     STA ram_0000_t05_data
C - - - - - 0x01D95E 07:D94E: A5 01     LDA ram_0001_t14_hi
C - - - - - 0x01D960 07:D950: 65 63     ADC ram_0063_t01_data_ptr_hi
C - - - - - 0x01D962 07:D952: 85 01     STA ram_0000_t05_data + $01
...
sub_D959_prepare_pointers:
; in
    ; ram_0060_t01_data_ptr_lo
    ; ram_0061_t01_data_ptr_hi
...
; bzk optimize, write 00 to 0000 first, then LDA (),Y (delete PHA + PLA)
C - - - - - 0x01D969 07:D959: B1 6E     LDA (ram_006E_t01_data),Y
; bzk bug, supposedly if A = FF, then the script should quit,
; but instead it keeps going as intended, which
; results in reading stuff like 0x01D213 via 0x01D951
C - - - - - 0x01D96B 07:D95B: 48        PHA
C - - - - - 0x01D96C 07:D95C: A9 00     LDA #$00
C - - - - - 0x01D96E 07:D95E: 85 00     STA ram_0000_t54_hi
C - - - - - 0x01D970 07:D960: 68        PLA
; * 40
C - - - - - 0x01D971 07:D961: 0A        ASL
C - - - - - 0x01D972 07:D962: 26 00     ROL ram_0000_t54_hi
C - - - - - 0x01D974 07:D964: 0A        ASL
C - - - - - 0x01D975 07:D965: 26 00     ROL ram_0000_t54_hi
C - - - - - 0x01D977 07:D967: 0A        ASL
C - - - - - 0x01D978 07:D968: 26 00     ROL ram_0000_t54_hi
C - - - - - 0x01D97A 07:D96A: 0A        ASL
C - - - - - 0x01D97B 07:D96B: 26 00     ROL ram_0000_t54_hi
C - - - - - 0x01D97D 07:D96D: 0A        ASL
C - - - - - 0x01D97E 07:D96E: 26 00     ROL ram_0000_t54_hi
C - - - - - 0x01D980 07:D970: 0A        ASL
C - - - - - 0x01D981 07:D971: 26 00     ROL ram_0000_t54_hi
C - - - - - 0x01D983 07:D973: 18        CLC
C - - - - - 0x01D984 07:D974: 65 60     ADC ram_0060_t01_data_ptr_lo
C - - - - - 0x01D986 07:D976: 85 24     STA ram_0024_t01_data
C - - - - - 0x01D988 07:D978: A5 00     LDA ram_0000_t54_hi
C - - - - - 0x01D98A 07:D97A: 65 61     ADC ram_0061_t01_data_ptr_hi
C - - - - - 0x01D98C 07:D97C: 85 25     STA ram_0024_t01_data + $01
C - - - - - 0x01D98E 07:D97E: 60        RTS



sub_D97F:
C - - - - - 0x01D98F 07:D97F: A5 E9     LDA ram_stage_id
; * 0A
C - - - - - 0x01D991 07:D981: 0A        ASL
C - - - - - 0x01D992 07:D982: 85 00     STA ram_0000_t55_x02
C - - - - - 0x01D994 07:D984: 0A        ASL
C - - - - - 0x01D995 07:D985: 0A        ASL
C - - - - - 0x01D996 07:D986: 65 00     ADC ram_0000_t55_x02
C - - - - - 0x01D998 07:D988: A8        TAY
C - - - - - 0x01D999 07:D989: B9 2A DA  LDA tbl_DA2A_stage_data,Y
C - - - - - 0x01D99C 07:D98C: 85 64     STA ram_0064_t01_stage_data_1
C - - - - - 0x01D99E 07:D98E: 85 66     STA ram_0066_t01_stage_data_2
C - - - - - 0x01D9A0 07:D990: 85 68     STA ram_0068_t01_stage_data_3
C - - - - - 0x01D9A2 07:D992: 85 6A     STA ram_006A_t01_stage_data_4
C - - - - - 0x01D9A4 07:D994: 85 6C     STA ram_006C_t01_stage_data_5
C - - - - - 0x01D9A6 07:D996: BE 2B DA  LDX tbl_DA2A_stage_data + $01,Y
C - - - - - 0x01D9A9 07:D999: 86 65     STX ram_0064_t01_stage_data_1 + $01
C - - - - - 0x01D9AB 07:D99B: E8        INX
C - - - - - 0x01D9AC 07:D99C: 86 67     STX ram_0066_t01_stage_data_2 + $01
C - - - - - 0x01D9AE 07:D99E: E8        INX
C - - - - - 0x01D9AF 07:D99F: 86 69     STX ram_0068_t01_stage_data_3 + $01
C - - - - - 0x01D9B1 07:D9A1: E8        INX
C - - - - - 0x01D9B2 07:D9A2: 86 6B     STX ram_006A_t01_stage_data_4 + $01
C - - - - - 0x01D9B4 07:D9A4: E8        INX
C - - - - - 0x01D9B5 07:D9A5: 86 6D     STX ram_006C_t01_stage_data_5 + $01
C - - - - - 0x01D9B7 07:D9A7: B9 2C DA  LDA tbl_DA2A_stage_data + $02,Y
C - - - - - 0x01D9BA 07:D9AA: 85 62     STA ram_0062_t01_data_ptr_lo
C - - - - - 0x01D9BC 07:D9AC: B9 2D DA  LDA tbl_DA2A_stage_data + $03,Y
C - - - - - 0x01D9BF 07:D9AF: 85 63     STA ram_0063_t01_data_ptr_hi
C - - - - - 0x01D9C1 07:D9B1: B9 2E DA  LDA tbl_DA2A_stage_data + $04,Y
C - - - - - 0x01D9C4 07:D9B4: 85 60     STA ram_0060_t01_data_ptr_lo
C - - - - - 0x01D9C6 07:D9B6: B9 2F DA  LDA tbl_DA2A_stage_data + $05,Y
C - - - - - 0x01D9C9 07:D9B9: 85 61     STA ram_0061_t01_data_ptr_hi
C - - - - - 0x01D9CB 07:D9BB: B9 30 DA  LDA tbl_DA2A_stage_data + $06,Y
C - - - - - 0x01D9CE 07:D9BE: 85 6E     STA ram_006E_t01_data
C - - - - - 0x01D9D0 07:D9C0: B9 31 DA  LDA tbl_DA2A_stage_data + $07,Y
C - - - - - 0x01D9D3 07:D9C3: 85 6F     STA ram_006E_t01_data + $01
C - - - - - 0x01D9D5 07:D9C5: B9 32 DA  LDA tbl_DA2A_stage_data + $08,Y
C - - - - - 0x01D9D8 07:D9C8: 85 70     STA ram_0070_t01_data
C - - - - - 0x01D9DA 07:D9CA: B9 33 DA  LDA tbl_DA2A_stage_data + $09,Y
C - - - - - 0x01D9DD 07:D9CD: 85 71     STA ram_0070_t01_data + $01
C - - - - - 0x01D9DF 07:D9CF: A4 E9     LDY ram_stage_id
C - - - - - 0x01D9E1 07:D9D1: B9 66 DA  LDA tbl_DA66,Y
C - - - - - 0x01D9E4 07:D9D4: 85 EA     STA ram_00EA_useless_prg_bank_01
C - - - - - 0x01D9E6 07:D9D6: A5 E9     LDA ram_stage_id
...
C - - - - - 0x01D9F2 07:D9E2: 9D 00 06  STA ram_palette_buffer,X
C - - - - - 0x01D9F5 07:D9E5: 9D 20 06  STA ram_max_brightness_buffer,X
...
C - - - - - 0x01DA00 07:D9F0: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01DA03 07:D9F3: A6 E9     LDX ram_stage_id
C - - - - - 0x01DA05 07:D9F5: BD C0 BF  LDA tbl_0x013FD0_lo,X
C - - - - - 0x01DA08 07:D9F8: 85 72     STA ram_0072_t01_data
C - - - - - 0x01DA0A 07:D9FA: BD C8 BF  LDA tbl_0x013FD8_hi,X
C - - - - - 0x01DA0D 07:D9FD: 85 73     STA ram_0072_t01_data + $01
C - - - - - 0x01DA0F 07:D9FF: BD D0 BF  LDA tbl_0x013FE0_lo,X
C - - - - - 0x01DA12 07:DA02: 85 74     STA ram_0074_t01_data
C - - - - - 0x01DA14 07:DA04: BD D8 BF  LDA tbl_0x013FE8_hi,X
C - - - - - 0x01DA17 07:DA07: 85 75     STA ram_0074_t01_data + $01
C - - - - - 0x01DA19 07:DA09: BD E0 BF  LDA tbl_0x013FF0_lo,X
C - - - - - 0x01DA1C 07:DA0C: 85 76     STA ram_0076_t01_data
C - - - - - 0x01DA1E 07:DA0E: BD E8 BF  LDA tbl_0x013FF8_hi,X
C - - - - - 0x01DA21 07:DA11: 85 77     STA ram_0076_t01_data + $01
C - - - - - 0x01DA23 07:DA13: BD F0 BF  LDA tbl_0x014000_lo,X
C - - - - - 0x01DA26 07:DA16: 85 78     STA ram_0078_t01_data
C - - - - - 0x01DA28 07:DA18: BD F8 BF  LDA tbl_0x014008_hi,X
C - - - - - 0x01DA2B 07:DA1B: 85 79     STA ram_0078_t01_data + $01
C - - - - - 0x01DA2D 07:DA1D: A5 53     LDA ram_0053_flag
...
; con_C2C4_1D
; con_C2C4_1E
C - - - - - 0x01DA31 07:DA21: A5 E9     LDA ram_stage_id
...
- D 2 - - - 0x01DA76 07:DA66: 01        .byte con_prg_bank + $01   ; 00 
- D 2 - - - 0x01DA77 07:DA67: 01        .byte con_prg_bank + $01   ; 01 
- D 2 - - - 0x01DA78 07:DA68: 01        .byte con_prg_bank + $01   ; 02 
- D 2 - - - 0x01DA79 07:DA69: 01        .byte con_prg_bank + $01   ; 03 
- D 2 - - - 0x01DA7A 07:DA6A: 01        .byte con_prg_bank + $01   ; 04 
- D 2 - - - 0x01DA7B 07:DA6B: 01        .byte con_prg_bank + $01   ; 05 
...
_off017_DA98_00:
- D 2 - I - 0x01DAA8 07:DA98: 00        .byte $00   ; 00 
- D 2 - I - 0x01DAA9 07:DA99: 01        .byte $01   ; 01 
- D 2 - I - 0x01DAAA 07:DA9A: 02        .byte $02   ; 02 
- D 2 - I - 0x01DAAB 07:DA9B: 03        .byte $03   ; 03 
- D 2 - I - 0x01DAAC 07:DA9C: 04        .byte $04   ; 04 
- D 2 - I - 0x01DAAD 07:DA9D: 05        .byte $05   ; 05 
- D 2 - I - 0x01DAAE 07:DA9E: 06        .byte $06   ; 06 
- D 2 - I - 0x01DAAF 07:DA9F: 07        .byte $07   ; 07 
- D 2 - I - 0x01DAB0 07:DAA0: 08        .byte $08   ; 08 
- D 2 - I - 0x01DAB1 07:DAA1: 09        .byte $09   ; 09 
- D 2 - I - 0x01DAB2 07:DAA2: 0A        .byte $0A   ; 0A 
- D 2 - I - 0x01DAB3 07:DAA3: 0B        .byte $0B   ; 0B 
- D 2 - I - 0x01DAB4 07:DAA4: 0C        .byte $0C   ; 0C 
- D 2 - I - 0x01DAB5 07:DAA5: 0D        .byte $0D   ; 0D 
- D 2 - I - 0x01DAB6 07:DAA6: 0E        .byte $0E   ; 0E 
- D 2 - I - 0x01DAB7 07:DAA7: 0F        .byte $0F   ; 0F 
- - - - - - 0x01DAB8 07:DAA8: FF        .byte $FF   ; 10 
- D 2 - I - 0x01DAB9 07:DAA9: 10        .byte $10   ; 11 
- - - - - - 0x01DABA 07:DAAA: FF        .byte $FF   ; 12 



_off017_DAAB_01:
- D 2 - I - 0x01DABB 07:DAAB: 00        .byte $00   ; 00 
- D 2 - I - 0x01DABC 07:DAAC: 01        .byte $01   ; 01 
- D 2 - I - 0x01DABD 07:DAAD: 02        .byte $02   ; 02 
- D 2 - I - 0x01DABE 07:DAAE: 03        .byte $03   ; 03 
- D 2 - I - 0x01DABF 07:DAAF: 04        .byte $04   ; 04 
- D 2 - I - 0x01DAC0 07:DAB0: 05        .byte $05   ; 05 
- D 2 - I - 0x01DAC1 07:DAB1: 0F        .byte $0F   ; 06 
- D 2 - I - 0x01DAC2 07:DAB2: 06        .byte $06   ; 07 
- D 2 - I - 0x01DAC3 07:DAB3: 07        .byte $07   ; 08 
- D 2 - I - 0x01DAC4 07:DAB4: 08        .byte $08   ; 09 
- D 2 - I - 0x01DAC5 07:DAB5: 09        .byte $09   ; 0A 
- D 2 - I - 0x01DAC6 07:DAB6: 10        .byte $10   ; 0B 
- D 2 - I - 0x01DAC7 07:DAB7: 0A        .byte $0A   ; 0C 
- D 2 - I - 0x01DAC8 07:DAB8: 0B        .byte $0B   ; 0D 
- D 2 - I - 0x01DAC9 07:DAB9: 0C        .byte $0C   ; 0E 
- D 2 - I - 0x01DACA 07:DABA: 0D        .byte $0D   ; 0F 
- D 2 - I - 0x01DACB 07:DABB: 0E        .byte $0E   ; 10 
- D 2 - I - 0x01DACC 07:DABC: FF        .byte $FF   ; 11 



_off017_DABD_02:
- D 2 - I - 0x01DACD 07:DABD: 00        .byte $00   ; 00 
- D 2 - I - 0x01DACE 07:DABE: 01        .byte $01   ; 01 
- D 2 - I - 0x01DACF 07:DABF: 02        .byte $02   ; 02 
- D 2 - I - 0x01DAD0 07:DAC0: 03        .byte $03   ; 03 
- D 2 - I - 0x01DAD1 07:DAC1: 04        .byte $04   ; 04 
- D 2 - I - 0x01DAD2 07:DAC2: 05        .byte $05   ; 05 
- D 2 - I - 0x01DAD3 07:DAC3: 07        .byte $07   ; 06 
- D 2 - I - 0x01DAD4 07:DAC4: 08        .byte $08   ; 07 
- D 2 - I - 0x01DAD5 07:DAC5: 09        .byte $09   ; 08 
- D 2 - I - 0x01DAD6 07:DAC6: 0A        .byte $0A   ; 09 
- D 2 - I - 0x01DAD7 07:DAC7: 0B        .byte $0B   ; 0A 
- D 2 - I - 0x01DAD8 07:DAC8: 0C        .byte $0C   ; 0B 
- D 2 - I - 0x01DAD9 07:DAC9: 0D        .byte $0D   ; 0C 
- D 2 - I - 0x01DADA 07:DACA: 0E        .byte $0E   ; 0D 
- D 2 - I - 0x01DADB 07:DACB: 0F        .byte $0F   ; 0E 
- D 2 - I - 0x01DADC 07:DACC: 10        .byte $10   ; 0F 
- D 2 - I - 0x01DADD 07:DACD: 11        .byte $11   ; 10 
- D 2 - I - 0x01DADE 07:DACE: 12        .byte $12   ; 11 
- D 2 - I - 0x01DADF 07:DACF: 12        .byte $12   ; 12 
- D 2 - I - 0x01DAE0 07:DAD0: 06        .byte $06   ; 13 
- - - - - - 0x01DAE1 07:DAD1: FF        .byte $FF   ; 14 



_off017_DAD2_03:
- D 2 - I - 0x01DAE2 07:DAD2: 00        .byte $00   ; 00 
- D 2 - I - 0x01DAE3 07:DAD3: 01        .byte $01   ; 01 
- D 2 - I - 0x01DAE4 07:DAD4: 02        .byte $02   ; 02 
- D 2 - I - 0x01DAE5 07:DAD5: 03        .byte $03   ; 03 
- D 2 - I - 0x01DAE6 07:DAD6: 04        .byte $04   ; 04 
- D 2 - I - 0x01DAE7 07:DAD7: 05        .byte $05   ; 05 
- D 2 - I - 0x01DAE8 07:DAD8: 06        .byte $06   ; 06 
- D 2 - I - 0x01DAE9 07:DAD9: 07        .byte $07   ; 07 
- D 2 - I - 0x01DAEA 07:DADA: 08        .byte $08   ; 08 
- D 2 - I - 0x01DAEB 07:DADB: 09        .byte $09   ; 09 
- D 2 - I - 0x01DAEC 07:DADC: 0A        .byte $0A   ; 0A 
- D 2 - I - 0x01DAED 07:DADD: 0B        .byte $0B   ; 0B 
- D 2 - I - 0x01DAEE 07:DADE: 0C        .byte $0C   ; 0C 
- D 2 - I - 0x01DAEF 07:DADF: 0D        .byte $0D   ; 0D 
- D 2 - I - 0x01DAF0 07:DAE0: 0E        .byte $0E   ; 0E 
- D 2 - I - 0x01DAF1 07:DAE1: 0F        .byte $0F   ; 0F 
- D 2 - I - 0x01DAF2 07:DAE2: 0F        .byte $0F   ; 10 
- D 2 - I - 0x01DAF3 07:DAE3: 10        .byte $10   ; 11 
- - - - - - 0x01DAF4 07:DAE4: FF        .byte $FF   ; 12 



_off017_DAE5_04:
- D 2 - I - 0x01DAF5 07:DAE5: 00        .byte $00   ; 00 
- D 2 - I - 0x01DAF6 07:DAE6: 01        .byte $01   ; 01 
- D 2 - I - 0x01DAF7 07:DAE7: 02        .byte $02   ; 02 
- D 2 - I - 0x01DAF8 07:DAE8: 03        .byte $03   ; 03 
- D 2 - I - 0x01DAF9 07:DAE9: 04        .byte $04   ; 04 
- D 2 - I - 0x01DAFA 07:DAEA: 05        .byte $05   ; 05 
- D 2 - I - 0x01DAFB 07:DAEB: 06        .byte $06   ; 06 
- D 2 - I - 0x01DAFC 07:DAEC: 07        .byte $07   ; 07 
- D 2 - I - 0x01DAFD 07:DAED: 08        .byte $08   ; 08 
- D 2 - I - 0x01DAFE 07:DAEE: 09        .byte $09   ; 09 
- D 2 - I - 0x01DAFF 07:DAEF: 0A        .byte $0A   ; 0A 
- D 2 - I - 0x01DB00 07:DAF0: 0B        .byte $0B   ; 0B 
- D 2 - I - 0x01DB01 07:DAF1: 0C        .byte $0C   ; 0C 
- D 2 - I - 0x01DB02 07:DAF2: 0D        .byte $0D   ; 0D 
- D 2 - I - 0x01DB03 07:DAF3: 0E        .byte $0E   ; 0E 
- D 2 - I - 0x01DB04 07:DAF4: 0F        .byte $0F   ; 0F 
- D 2 - I - 0x01DB05 07:DAF5: 10        .byte $10   ; 10 
- D 2 - I - 0x01DB06 07:DAF6: 11        .byte $11   ; 11 
- D 2 - I - 0x01DB07 07:DAF7: 12        .byte $12   ; 12 
- D 2 - I - 0x01DB08 07:DAF8: 13        .byte $13   ; 13 
- D 2 - I - 0x01DB09 07:DAF9: 14        .byte $14   ; 14 
- D 2 - I - 0x01DB0A 07:DAFA: 15        .byte $15   ; 15 
- D 2 - I - 0x01DB0B 07:DAFB: FF        .byte $FF   ; 16 



_off017_DAFC_05:
- D 2 - I - 0x01DB0C 07:DAFC: 11        .byte $11   ; 00 
- D 2 - I - 0x01DB0D 07:DAFD: 11        .byte $11   ; 01 
- - - - - - 0x01DB0E 07:DAFE: FF        .byte $FF   ; 02 



tbl_DAFF:
- D 2 - - - 0x01DB0F 07:DAFF: 00        .byte off_DB05_00 - tbl__DB05   ; 
- D 2 - - - 0x01DB10 07:DB00: 04        .byte off_DB09_01 - tbl__DB05   ; 
- D 2 - - - 0x01DB11 07:DB01: 0A        .byte off_DB0F_02 - tbl__DB05   ; 
- D 2 - - - 0x01DB12 07:DB02: 10        .byte off_DB15_03 - tbl__DB05   ; 
- D 2 - - - 0x01DB13 07:DB03: 17        .byte off_DB1C_04 - tbl__DB05   ; 
- - - - - - 0x01DB14 07:DB04: 17        .byte off_DB1C_05 - tbl__DB05   ; 
...
- D 2 - I - 0x01DBA7 07:DB97: 0F        .byte $0F, $0F, $0F, $0F   ; bzk bug, see 0x01D969
...
sub_DBFB:
C D 2 - I - 0x01DC0B 07:DBFB: A5 E9     LDA ram_stage_id
C - - - - - 0x01DC0D 07:DBFD: C9 05     CMP #$05
C - - - - - 0x01DC0F 07:DBFF: F0 09     BEQ bra_DC0A    ; if final battle
C - - - - - 0x01DC11 07:DC01: A5 50     LDA ram_stage_config
...
C - - - - - 0x01DC71 07:DC61: 85 01     STA ram_0001_t15
C - - - - - 0x01DC73 07:DC63: A5 32     LDA ram_0032_copy_pos_X_lo
C - - - - - 0x01DC75 07:DC65: 38        SEC
C - - - - - 0x01DC76 07:DC66: ED 30 03  SBC ram_pos_X_lo
C - - - - - 0x01DC79 07:DC69: 85 00     STA ram_0000_t56
...
C - - - - - 0x01DC84 07:DC74: 85 00     STA ram_0000_t57
C - - - - - 0x01DC86 07:DC76: A5 01     LDA ram_0001_t15
C - - - - - 0x01DC88 07:DC78: C9 80     CMP #$80
C - - - - - 0x01DC8A 07:DC7A: B0 01     BCS bra_DC7D
bra_DC7C_RTS:
C - - - - - 0x01DC8C 07:DC7C: 60        RTS
bra_DC7D:
C - - - - - 0x01DC8D 07:DC7D: A5 00     LDA ram_0000_t57
...
C - - - - - 0x01DCB3 07:DCA3: 85 00     STA ram_0000_t57
...
C - - - - - 0x01DCC7 07:DCB7: 65 00     ADC ram_0000_t57
C - - - - - 0x01DCC9 07:DCB9: 4A        LSR
C - - - - - 0x01DCCA 07:DCBA: 4A        LSR
C - - - - - 0x01DCCB 07:DCBB: 85 01     STA ram_0001_t08
C - - - - - 0x01DCCD 07:DCBD: A5 27     LDA ram_0027_camera_movement_direction
C - - - - - 0x01DCCF 07:DCBF: 29 01     AND #$01
C - - - - - 0x01DCD1 07:DCC1: D0 12     BNE bra_DCD5    ; if right
...
bra_DCD9:
C - - - - - 0x01DCE9 07:DCD9: A5 01     LDA ram_0001_t15
...
C - - - - - 0x01DD17 07:DD07: A5 01     LDA ram_0001_t16_scroll_X_hi
C - - - - - 0x01DD19 07:DD09: 85 FD     STA ram_scroll_X_hi
C - - - - - 0x01DD1B 07:DD0B: A5 F7     LDA ram_copy_scroll_X
C - - - - - 0x01DD1D 07:DD0D: 85 00     STA ram_0000_t56
...
C - - - - - 0x01DD30 07:DD20: 65 00     ADC ram_0000_t56
C - - - - - 0x01DD32 07:DD22: 4A        LSR
C - - - - - 0x01DD33 07:DD23: 4A        LSR
C - - - - - 0x01DD34 07:DD24: 85 01     STA ram_0001_t08
C - - - - - 0x01DD36 07:DD26: A5 27     LDA ram_0027_camera_movement_direction
C - - - - - 0x01DD38 07:DD28: 29 02     AND #$02
C - - - - - 0x01DD3A 07:DD2A: D0 14     BNE bra_DD40    ; if left
...
bra_DD42:
C - - - - - 0x01DD52 07:DD42: 85 27     STA ram_0027_camera_movement_direction
...
C - - - - - 0x01DD75 07:DD65: A9 01     LDA #$01    ; right
C - - - - - 0x01DD77 07:DD67: 85 27     STA ram_0027_camera_movement_direction
...
bra_DDBD:
C - - - - - 0x01DDCD 07:DDBD: 85 00     STA ram_0000_t59
...
C - - - - - 0x01DDDC 07:DDCC: A5 50     LDA ram_stage_config
...
bra_DDD4:
C - - - - - 0x01DDE4 07:DDD4: A5 50     LDA ram_stage_config
...
C - - - - - 0x01DE03 07:DDF3: 85 00     STA ram_0000_t59
...
C - - - - - 0x01DE2A 07:DE1A: A5 27     LDA ram_0027_camera_movement_direction
C - - - - - 0x01DE2C 07:DE1C: 29 04     AND #$04
C - - - - - 0x01DE2E 07:DE1E: D0 22     BNE bra_DE42    ; if moving down
C - - - - - 0x01DE30 07:DE20: A5 50     LDA ram_stage_config
...
C - - - - - 0x01DE47 07:DE37: A5 50     LDA ram_stage_config
...
bra_DE42:
loc_DE42:
C D 2 - - - 0x01DE52 07:DE42: A9 04     LDA #$04    ; up
...
bra_DE4F:
C - - - - - 0x01DE5F 07:DE4F: 85 00     STA ram_0000_t60
C - - - - - 0x01DE61 07:DE51: A5 01     LDA ram_0001_t17
...
C - - - - - 0x01DE6B 07:DE5B: E5 00     SBC ram_0000_t60
...
C - - - - - 0x01DE75 07:DE65: A5 50     LDA ram_stage_config
...
bra_DE6D:
C - - - - - 0x01DE7D 07:DE6D: A5 50     LDA ram_stage_config
...
C - - - - - 0x01DEA0 07:DE90: 85 00     STA ram_0000_t60
...
C - - - - - 0x01DEB9 07:DEA9: 65 00     ADC ram_0000_t60
C - - - - - 0x01DEBB 07:DEAB: 4A        LSR
C - - - - - 0x01DEBC 07:DEAC: 4A        LSR
C - - - - - 0x01DEBD 07:DEAD: 4A        LSR
C - - - - - 0x01DEBE 07:DEAE: 85 01     STA ram_0001_t18
C - - - - - 0x01DEC0 07:DEB0: F0 32     BEQ bra_DEE4
C - - - - - 0x01DEC2 07:DEB2: A5 27     LDA ram_0027_camera_movement_direction
C - - - - - 0x01DEC4 07:DEB4: 29 08     AND #$08
C - - - - - 0x01DEC6 07:DEB6: D0 1E     BNE bra_DED6    ; if moving up
C - - - - - 0x01DEC8 07:DEB8: A5 50     LDA ram_stage_config
...
C - - - - - 0x01DEDB 07:DECB: A5 50     LDA ram_stage_config
...
C - - - - - 0x01DEE8 07:DED8: A5 50     LDA ram_stage_config
...
C - - - - - 0x01DEF0 07:DEE0: A9 08     LDA #$08    ; down
loc_DEE2:
C D 2 - - - 0x01DEF2 07:DEE2: 85 27     STA ram_0027_camera_movement_direction
bra_DEE4:
loc_DEE4:
C D 2 - - - 0x01DEF4 07:DEE4: A5 01     LDA ram_0001_t18
...
loc_DEEC:
C D 2 - - - 0x01DEFC 07:DEEC: A5 E9     LDA ram_stage_id
C - - - - - 0x01DEFE 07:DEEE: C9 04     CMP #$04
C - - - - - 0x01DF00 07:DEF0: D0 12     BNE bra_DF04
; if stage 5
C - - - - - 0x01DF02 07:DEF2: A5 50     LDA ram_stage_config
...
C - - - - - 0x01DF14 07:DF04: A5 50     LDA ram_stage_config
C - - - - - 0x01DF16 07:DF06: 29 0F     AND #$0F
C - - - - - 0x01DF18 07:DF08: A8        TAY
C - - - - - 0x01DF19 07:DF09: C8        INY
C - - - - - 0x01DF1A 07:DF0A: B1 70     LDA (ram_0070_t01_data),Y
C - - - - - 0x01DF1C 07:DF0C: 85 09     STA ram_0009_t01
...
C - - - - - 0x01DF25 07:DF15: 85 97     STA ram_oam_index
...
C - - - - - 0x01DF31 07:DF21: A5 09     LDA ram_0009_t01
C - - - - - 0x01DF33 07:DF23: 29 3F     AND #$3F
C - - - - - 0x01DF35 07:DF25: 38        SEC
C - - - - - 0x01DF36 07:DF26: 65 20     ADC ram_0020
C - - - - - 0x01DF38 07:DF28: 85 07     STA ram_0007_t03
C - - - - - 0x01DF3A 07:DF2A: 85 2E     STA ram_002E
C - - - - - 0x01DF3C 07:DF2C: A4 E9     LDY ram_stage_id
C - - - - - 0x01DF3E 07:DF2E: A5 50     LDA ram_stage_config
...
C - - - - - 0x01DF4B 07:DF3B: 20 2A C5  JSR sub_C52A_prepare_data_pointers
...
C - - - - - 0x01DF5E 07:DF4E: 9D 18 06  STA ram_palette_buffer + $18,X
C - - - - - 0x01DF61 07:DF51: 9D 38 06  STA ram_max_brightness_buffer + $18,X
...
; X = 08
C - - - - - 0x01DF6A 07:DF5A: 86 18     STX ram_0018_flag
bra_DF5C_loop:
...
C - - - - - 0x01DF94 07:DF84: 85 01     STA ram_0001_t08
C - - - - - 0x01DF96 07:DF86: 20 BD D6  JSR sub_D6BD
C - - - - - 0x01DF99 07:DF89: A5 09     LDA ram_0009_t01
...
C - - - - - 0x01DFA7 07:DF97: 85 08     STA ram_0008_t02
C - - - - - 0x01DFA9 07:DF99: A5 07     LDA ram_0007_t03
C - - - - - 0x01DFAB 07:DF9B: 85 20     STA ram_0020
bra_DF9D:
C - - - - - 0x01DFAD 07:DF9D: 20 3D C5  JSR sub_C53D
C - - - - - 0x01DFB0 07:DFA0: A9 04     LDA #$04
C - - - - - 0x01DFB2 07:DFA2: 85 97     STA ram_oam_index
                                       ;LDA #con_prg_bank + $04
C - - - - - 0x01DFB4 07:DFA4: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
...
C - - - - - 0x01DFC0 07:DFB0: 8D 48 04  STA ram_0448_obj
bra_DFB3:
C - - - - - 0x01DFC3 07:DFB3: 20 03 80  JSR sub_0x010013_sprite_engine
; disable rendering
C - - - - - 0x01DFC6 07:DFB6: A9 00     LDA #$00
C - - - - - 0x01DFC8 07:DFB8: 85 EE     STA ram_rendering_flag
; 
C - - - - - 0x01DFCA 07:DFBA: 20 AD FF  JSR sub_FFAD_wait_1_frm
; enable rendering
C - - - - - 0x01DFCD 07:DFBD: E6 EE     INC ram_rendering_flag   ; -> 01
; 
C - - - - - 0x01DFCF 07:DFBF: AD 30 03  LDA ram_pos_X_lo
C - - - - - 0x01DFD2 07:DFC2: 85 32     STA ram_0032_copy_pos_X_lo
C - - - - - 0x01DFD4 07:DFC4: AD 40 03  LDA ram_pos_X_hi
C - - - - - 0x01DFD7 07:DFC7: 85 33     STA ram_0033_copy_pos_X_hi
...
C - - - - - 0x01DFE1 07:DFD1: A5 09     LDA ram_0009_t01
C - - - - - 0x01DFE3 07:DFD3: 29 C0     AND #$C0
C - - - - - 0x01DFE5 07:DFD5: F0 04     BEQ bra_DFDB
C - - - - - 0x01DFE7 07:DFD7: A5 08     LDA ram_0008_t02
C - - - - - 0x01DFE9 07:DFD9: 85 20     STA ram_0020
bra_DFDB:
C - - - - - 0x01DFEB 07:DFDB: A9 00     LDA #$00
C - - - - - 0x01DFED 07:DFDD: 85 52     STA ram_0052
C - - - - - 0x01DFEF 07:DFDF: E6 50     INC ram_stage_config
C - - - - - 0x01DFF1 07:DFE1: A5 50     LDA ram_stage_config
C - - - - - 0x01DFF3 07:DFE3: 29 0F     AND #$0F
C - - - - - 0x01DFF5 07:DFE5: 85 50     STA ram_stage_config
C - - - - - 0x01DFF7 07:DFE7: A8        TAY
C - - - - - 0x01DFF8 07:DFE8: B1 70     LDA (ram_0070_t01_data),Y
...
C - - - - - 0x01E002 07:DFF2: 05 50     ORA ram_stage_config
C - - - - - 0x01E004 07:DFF4: 85 50     STA ram_stage_config
C - - - - - 0x01E006 07:DFF6: 29 C0     AND #$C0
C - - - - - 0x01E008 07:DFF8: D0 04     BNE bra_DFFE_vertical
; if horisontal
C - - - - - 0x01E00A 07:DFFA: A9 01     LDA #$01    ; right
...
C - - - - - 0x01E014 07:E004: A9 04     LDA #$04    ; down
...
C - - - - - 0x01E01C 07:E00C: A9 08     LDA #$08    ; up
bra_E00E:
C - - - - - 0x01E01E 07:E00E: 85 27     STA ram_0027_camera_movement_direction
C - - - - - 0x01E020 07:E010: A2 00     LDX #$00
C - - - - - 0x01E022 07:E012: A5 E9     LDA ram_stage_id
C - - - - - 0x01E024 07:E014: C9 03     CMP #$03
C - - - - - 0x01E026 07:E016: D0 20     BNE bra_E038
; if stage 4
C - - - - - 0x01E028 07:E018: A5 50     LDA ram_stage_config
...
C - - - - - 0x01E032 07:E022: 8C 03 01  STY ram_0100_bg_anim_cfg + $03
C - - - - - 0x01E035 07:E025: A2 00     LDX #$00
bra_E027_loop:
C - - - - - 0x01E037 07:E027: B9 4D E0  LDA tbl_E04D_background_palette,Y
C - - - - - 0x01E03A 07:E02A: 9D 00 06  STA ram_palette_buffer,X
C - - - - - 0x01E03D 07:E02D: 9D 20 06  STA ram_max_brightness_buffer,X
...
; X = 10
C - - - - - 0x01E046 07:E036: 86 18     STX ram_0018_flag
bra_E038:
C - - - - - 0x01E048 07:E038: A5 E9     LDA ram_stage_id
...
C - - - - - 0x01E059 07:E049: 20 2A C5  JSR sub_C52A_prepare_data_pointers
bra_E04C_RTS:
C - - - - - 0x01E05C 07:E04C: 60        RTS



tbl_E04D_background_palette:
; 03 stage 4 - undersea volcano
...
sub_E06D:
C - - - - - 0x01E07D 07:E06D: A4 E9     LDY ram_stage_id
...
C - - - - - 0x01E0C7 07:E0B7: 85 27     STA ram_0027_camera_movement_direction
...
C - - - - - 0x01E0D1 07:E0C1: 85 50     STA ram_stage_config
...
C - - - - - 0x01E0FA 07:E0EA: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01E0FD 07:E0ED: A4 E9     LDY ram_stage_id
C - - - - - 0x01E0FF 07:E0EF: B9 B8 BF  LDA tbl_0x013FC8,Y
C - - - - - 0x01E102 07:E0F2: 85 9E     STA ram_009E_data_index
C - - - - - 0x01E104 07:E0F4: 85 9F     STA ram_009F_data_index
...
C - - - - - 0x01E15E 07:E14E: A4 E9     LDY ram_stage_id
...
C - - - - - 0x01E16D 07:E15D: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01E170 07:E160: B9 B0 BF  LDA tbl_0x013FC0,Y
C - - - - - 0x01E173 07:E163: 85 9E     STA ram_009E_data_index
C - - - - - 0x01E175 07:E165: 85 9F     STA ram_009F_data_index
...
C - - - - - 0x01E17E 07:E16E: 85 50     STA ram_stage_config
...
; 
C - - - - - 0x01E193 07:E183: A9 04     LDA #$04    ; down
C - - - - - 0x01E195 07:E185: 85 27     STA ram_0027_camera_movement_direction
; 
C - - - - - 0x01E197 07:E187: A5 50     LDA ram_stage_config
C - - - - - 0x01E199 07:E189: 09 40     ORA #$40    ; during transition to a hidden area?
C - - - - - 0x01E19B 07:E18B: 85 50     STA ram_stage_config
...
bra_E1CA:
C - - - - - 0x01E1DA 07:E1CA: A9 04     LDA #$04
C - - - - - 0x01E1DC 07:E1CC: 85 97     STA ram_oam_index
                                       ;LDA #con_prg_bank + $04
C - - - - - 0x01E1DE 07:E1CE: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
...
- - - - - - 0x01E1EA 07:E1DA: 8D 48 04  STA ram_0448_obj
bra_E1DD:
C - - - - - 0x01E1ED 07:E1DD: 20 03 80  JSR sub_0x010013_sprite_engine
; disable rendering
C - - - - - 0x01E1F0 07:E1E0: A9 00     LDA #$00
C - - - - - 0x01E1F2 07:E1E2: 85 EE     STA ram_rendering_flag
; 
C - - - - - 0x01E1F4 07:E1E4: 20 AD FF  JSR sub_FFAD_wait_1_frm
; enable rendering
C - - - - - 0x01E1F7 07:E1E7: E6 EE     INC ram_rendering_flag   ; -> 01
; 
...
; 
C - - - - - 0x01E207 07:E1F7: A9 08     LDA #$08    ; up
C - - - - - 0x01E209 07:E1F9: 85 27     STA ram_0027_camera_movement_direction
; 
C - - - - - 0x01E20B 07:E1FB: A9 80     LDA #$80    ; during transition out of a hidden area?
C - - - - - 0x01E20D 07:E1FD: 85 50     STA ram_stage_config
...
bra_E238:
C - - - - - 0x01E248 07:E238: A9 04     LDA #$04
C - - - - - 0x01E24A 07:E23A: 85 97     STA ram_oam_index
                                       ;LDA #con_prg_bank + $04
C - - - - - 0x01E24C 07:E23C: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
...
C - - - - - 0x01E258 07:E248: 8D 48 04  STA ram_0448_obj
bra_E24B:
C - - - - - 0x01E25B 07:E24B: 20 03 80  JSR sub_0x010013_sprite_engine
; disable rendering
C - - - - - 0x01E25E 07:E24E: A9 00     LDA #$00
C - - - - - 0x01E260 07:E250: 85 EE     STA ram_rendering_flag
; 
C - - - - - 0x01E262 07:E252: 20 AD FF  JSR sub_FFAD_wait_1_frm
; enable rendering
C - - - - - 0x01E265 07:E255: E6 EE     INC ram_rendering_flag   ; -> 01
; 
...
C - - - - - 0x01E29B 07:E28B: 85 05     STA ram_0005_t03_array_index
C - - - - - 0x01E29D 07:E28D: A9 00     LDA #$00
C - - - - - 0x01E29F 07:E28F: 85 02     STA ram_0002_t16
C - - - - - 0x01E2A1 07:E291: B9 33 E6  LDA tbl_E633,Y
C - - - - - 0x01E2A4 07:E294: 48        PHA
C - - - - - 0x01E2A5 07:E295: 18        CLC
C - - - - - 0x01E2A6 07:E296: 65 07     ADC ram_0007_t04_pos_Y_lo
C - - - - - 0x01E2A8 07:E298: 85 11     STA ram_0011_t04_pos_Y_lo
C - - - - - 0x01E2AA 07:E29A: 68        PLA
C - - - - - 0x01E2AB 07:E29B: 30 39     BMI bra_E2D6
C - - - - - 0x01E2AD 07:E29D: B0 06     BCS bra_E2A5
C - - - - - 0x01E2AF 07:E29F: A5 11     LDA ram_0011_t04_pos_Y_lo
C - - - - - 0x01E2B1 07:E2A1: C9 F0     CMP #$F0
C - - - - - 0x01E2B3 07:E2A3: 90 6A     BCC bra_E30F
bra_E2A5:
C - - - - - 0x01E2B5 07:E2A5: A5 11     LDA ram_0011_t04_pos_Y_lo
C - - - - - 0x01E2B7 07:E2A7: 69 0F     ADC #$0F
C - - - - - 0x01E2B9 07:E2A9: 85 11     STA ram_0011_t04_pos_Y_lo
C - - - - - 0x01E2BB 07:E2AB: A5 50     LDA ram_stage_config
...
bra_E2C5:
C - - - - - 0x01E2D5 07:E2C5: A5 50     LDA ram_stage_config
C - - - - - 0x01E2D7 07:E2C7: 10 05     BPL bra_E2CE
C - - - - - 0x01E2D9 07:E2C9: C6 13     DEC ram_0013_t01
C - - - - - 0x01E2DB 07:E2CB: 4C 0F E3  JMP loc_E30F
bra_E2CE:
C - - - - - 0x01E2DE 07:E2CE: E6 13     INC ram_0013_t01
C - - - - - 0x01E2E0 07:E2D0: 4C 0F E3  JMP loc_E30F
bra_E2D3:
C - - - - - 0x01E2E3 07:E2D3: 4C 02 E3  JMP loc_E302
bra_E2D6:
C - - - - - 0x01E2E6 07:E2D6: B0 37     BCS bra_E30F
C - - - - - 0x01E2E8 07:E2D8: A5 11     LDA ram_0011_t04_pos_Y_lo
C - - - - - 0x01E2EA 07:E2DA: E9 0F     SBC #$0F
C - - - - - 0x01E2EC 07:E2DC: 85 11     STA ram_0011_t04_pos_Y_lo
C - - - - - 0x01E2EE 07:E2DE: A5 50     LDA ram_stage_config
...
bra_E2F0:
C - - - - - 0x01E300 07:E2F0: A5 50     LDA ram_stage_config
C - - - - - 0x01E302 07:E2F2: 10 05     BPL bra_E2F9_vertical_down
; if vertical up
C - - - - - 0x01E304 07:E2F4: E6 13     INC ram_0013_t01
C - - - - - 0x01E306 07:E2F6: 4C 0F E3  JMP loc_E30F
bra_E2F9_vertical_down:
C - - - - - 0x01E309 07:E2F9: C6 13     DEC ram_0013_t01
C - - - - - 0x01E30B 07:E2FB: 4C 0F E3  JMP loc_E30F
bra_E2FE:
; bzk optimize, useless LDA + STA
C - - - - - 0x01E30E 07:E2FE: A9 00     LDA #$00
C - - - - - 0x01E310 07:E300: 85 11     STA ram_0011_tFF_useless
loc_E302:
C D 3 - - - 0x01E312 07:E302: A4 05     LDY ram_0005_t03_array_index
...
C - - - - - 0x01E324 07:E314: A5 11     LDA ram_0011_t04_pos_Y_lo
; / 04
...
C - - - - - 0x01E331 07:E321: 85 03     STA ram_0003_t09
C - - - - - 0x01E333 07:E323: A9 00     LDA #$00
C - - - - - 0x01E335 07:E325: 85 04     STA ram_0004_t08_pos_X_hi
C - - - - - 0x01E337 07:E327: B9 34 E6  LDA tbl_E634,Y
C - - - - - 0x01E33A 07:E32A: 10 02     BPL bra_E32E
C - - - - - 0x01E33C 07:E32C: C6 04     DEC ram_0004_t08_pos_X_hi    ; -> FF
bra_E32E:
C - - - - - 0x01E33E 07:E32E: 18        CLC
C - - - - - 0x01E33F 07:E32F: 7D 30 03  ADC ram_pos_X_lo,X
C - - - - - 0x01E342 07:E332: 85 12     STA ram_0012_t01_pos_X_lo
C - - - - - 0x01E344 07:E334: A5 13     LDA ram_0013_t01
C - - - - - 0x01E346 07:E336: 65 04     ADC ram_0004_t08_pos_X_hi
C - - - - - 0x01E348 07:E338: 85 13     STA ram_0013_t03_data_index
; bzk optimize, write to 0006 after 0x01E342
C - - - - - 0x01E34A 07:E33A: A5 12     LDA ram_0012_t01_pos_X_lo
C - - - - - 0x01E34C 07:E33C: 85 06     STA ram_0006_t02_pos_X_lo
; / 10
...
C - - - - - 0x01E355 07:E345: 05 03     ORA ram_0003_t09
C - - - - - 0x01E357 07:E347: 85 03     STA ram_0003_t10_data_index
...
loc_E34F:
C D 3 - - - 0x01E35F 07:E34F: A5 EA     LDA ram_00EA_useless_prg_bank_01
C - - - - - 0x01E361 07:E351: 20 CF FF  JSR sub_FFCF_prg_bankswitch
C - - - - - 0x01E364 07:E354: A4 13     LDY ram_0013_t03_data_index
C - - - - - 0x01E366 07:E356: 20 59 D9  JSR sub_D959_prepare_pointers
bra_E359_loop:
C - - - - - 0x01E369 07:E359: A4 13     LDY ram_0013_t03_data_index
C - - - - - 0x01E36B 07:E35B: B1 6E     LDA (ram_006E_t01_data),Y
C - - - - - 0x01E36D 07:E35D: 10 04     BPL bra_E363
C - - - - - 0x01E36F 07:E35F: A9 00     LDA #$00
C - - - - - 0x01E371 07:E361: F0 2B     BEQ bra_E38E    ; jmp
bra_E363:
C - - - - - 0x01E373 07:E363: A5 EA     LDA ram_00EA_useless_prg_bank_01
C - - - - - 0x01E375 07:E365: 20 CF FF  JSR sub_FFCF_prg_bankswitch
C - - - - - 0x01E378 07:E368: 20 3B D9  JSR sub_D93B_prepare_pointers
...
C - - - - - 0x01E385 07:E375: A4 03     LDY ram_0003_t10_data_index
C - - - - - 0x01E387 07:E377: B1 00     LDA (ram_0000_t05_data),Y
C - - - - - 0x01E389 07:E379: A8        TAY
C - - - - - 0x01E38A 07:E37A: B1 6C     LDA (ram_006C_t01_stage_data_5),Y
C - - - - - 0x01E38C 07:E37C: 29 F0     AND #$F0
C - - - - - 0x01E38E 07:E37E: C9 30     CMP #$30
C - - - - - 0x01E390 07:E380: D0 0C     BNE bra_E38E
; A = 30
C - - - - - 0x01E392 07:E382: 85 BE     STA ram_00BE_flag
C - - - - - 0x01E394 07:E384: A5 13     LDA ram_0013_t03_data_index
...
bra_E38E:
C - - - - - 0x01E39E 07:E38E: A4 02     LDY ram_0002_t16
...
bra_E399:
C - - - - - 0x01E3A9 07:E399: 05 10     ORA ram_0010_t02
C - - - - - 0x01E3AB 07:E39B: 85 10     STA ram_0010_t02
C - - - - - 0x01E3AD 07:E39D: E6 02     INC ram_0002_t16
C - - - - - 0x01E3AF 07:E39F: A5 02     LDA ram_0002_t16
C - - - - - 0x01E3B1 07:E3A1: C5 05     CMP ram_0005_t03_array_index
C - - - - - 0x01E3B3 07:E3A3: F0 37     BEQ bra_E3DC
C - - - - - 0x01E3B5 07:E3A5: E6 40     INC ram_0040
C - - - - - 0x01E3B7 07:E3A7: A4 40     LDY ram_0040
C - - - - - 0x01E3B9 07:E3A9: A5 12     LDA ram_0012_t01_pos_X_lo
C - - - - - 0x01E3BB 07:E3AB: 48        PHA
C - - - - - 0x01E3BC 07:E3AC: 29 10     AND #$10
C - - - - - 0x01E3BE 07:E3AE: 85 04     STA ram_0004_t09
C - - - - - 0x01E3C0 07:E3B0: 68        PLA
C - - - - - 0x01E3C1 07:E3B1: 18        CLC
C - - - - - 0x01E3C2 07:E3B2: 79 34 E6  ADC tbl_E634,Y
C - - - - - 0x01E3C5 07:E3B5: 85 12     STA ram_0012_t01_pos_X_lo
C - - - - - 0x01E3C7 07:E3B7: 29 10     AND #$10
C - - - - - 0x01E3C9 07:E3B9: C5 04     CMP ram_0004_t09
C - - - - - 0x01E3CB 07:E3BB: F0 B3     BEQ bra_E370_loop
C - - - - - 0x01E3CD 07:E3BD: A5 03     LDA ram_0003_t10_data_index
C - - - - - 0x01E3CF 07:E3BF: 49 01     EOR #$01
C - - - - - 0x01E3D1 07:E3C1: 85 03     STA ram_0003_t10_data_index
...
C - - - - - 0x01E3DF 07:E3CF: E6 13     INC ram_0013_t03_data_index
...
C - - - - - 0x01E3FB 07:E3EB: 85 05     STA ram_0005_t08
C - - - - - 0x01E3FD 07:E3ED: A9 00     LDA #$00
C - - - - - 0x01E3FF 07:E3EF: 85 02     STA ram_0002_t17
; bzk optimize, loading the same A
C - - - - - 0x01E401 07:E3F1: A9 00     LDA #$00
C - - - - - 0x01E403 07:E3F3: 85 04     STA ram_0004_t10_pos_X_hi
C - - - - - 0x01E405 07:E3F5: B9 6C E6  LDA tbl_E66C,Y
C - - - - - 0x01E408 07:E3F8: 10 02     BPL bra_E3FC
C - - - - - 0x01E40A 07:E3FA: C6 04     DEC ram_0004_t10_pos_X_hi   ; -> FF
bra_E3FC:
C - - - - - 0x01E40C 07:E3FC: 18        CLC
C - - - - - 0x01E40D 07:E3FD: 7D 30 03  ADC ram_pos_X_lo,X
C - - - - - 0x01E410 07:E400: 85 12     STA ram_0012_t03_pos_X_lo
C - - - - - 0x01E412 07:E402: A5 13     LDA ram_0013_t01
C - - - - - 0x01E414 07:E404: 65 04     ADC ram_0004_t10_pos_X_hi
C - - - - - 0x01E416 07:E406: 85 13     STA ram_0013_t03_data_index
; 
C - - - - - 0x01E418 07:E408: A5 12     LDA ram_0012_t03_pos_X_lo
; / 10
...
C - - - - - 0x01E421 07:E411: 85 03     STA ram_0003_t11
...
C - - - - - 0x01E42C 07:E41C: A5 07     LDA ram_0007_t04_pos_Y_lo
C - - - - - 0x01E42E 07:E41E: 18        CLC
C - - - - - 0x01E42F 07:E41F: 79 6D E6  ADC tbl_E66D,Y
C - - - - - 0x01E432 07:E422: 85 11     STA ram_0011_t03_pos_X_lo
...
bra_E42F:
C - - - - - 0x01E43F 07:E42F: A5 11     LDA ram_0011_t03_pos_X_lo
C - - - - - 0x01E441 07:E431: C9 F0     CMP #$F0
C - - - - - 0x01E443 07:E433: 90 40     BCC bra_E475
bra_E435:
- - - - - - 0x01E445 07:E435: A5 11     LDA ram_0011_t03_pos_X_lo
- - - - - - 0x01E447 07:E437: 18        CLC
- - - - - - 0x01E448 07:E438: 69 10     ADC #$10
- - - - - - 0x01E44A 07:E43A: 85 11     STA ram_0011_t03_pos_X_lo
; 
- - - - - - 0x01E44C 07:E43C: A5 50     LDA ram_stage_config
- - - - - - 0x01E44E 07:E43E: 29 C0     AND #$C0
- - - - - - 0x01E450 07:E440: F0 0E     BEQ bra_E450_horisontal
; if vertical
- - - - - - 0x01E452 07:E442: A5 50     LDA ram_stage_config
- - - - - - 0x01E454 07:E444: 10 05     BPL bra_E44B_vertical_down
; if vertical up
- - - - - - 0x01E456 07:E446: C6 13     DEC ram_0013_t03_data_index
- - - - - - 0x01E458 07:E448: 4C 75 E4  JMP loc_E475
bra_E44B_vertical_down:
- - - - - - 0x01E45B 07:E44B: E6 13     INC ram_0013_t03_data_index
- - - - - - 0x01E45D 07:E44D: 4C 75 E4  JMP loc_E475
bra_E450_horisontal:
- - - - - - 0x01E460 07:E450: A9 EF     LDA #$EF
- - - - - - 0x01E462 07:E452: 85 11     STA ram_0011_t03_pos_X_lo
- - - - - - 0x01E464 07:E454: D0 1F     BNE bra_E475    ; jmp
bra_E456:
C - - - - - 0x01E466 07:E456: A5 11     LDA ram_0011_t03_pos_X_lo
C - - - - - 0x01E468 07:E458: 38        SEC
C - - - - - 0x01E469 07:E459: E9 10     SBC #$10
C - - - - - 0x01E46B 07:E45B: 85 11     STA ram_0011_t03_pos_X_lo
; 
C - - - - - 0x01E46D 07:E45D: A5 50     LDA ram_stage_config
C - - - - - 0x01E46F 07:E45F: 29 C0     AND #$C0
C - - - - - 0x01E471 07:E461: F0 0E     BEQ bra_E471_horisontal
; if vertical
C - - - - - 0x01E473 07:E463: A5 50     LDA ram_stage_config
C - - - - - 0x01E475 07:E465: 10 05     BPL bra_E46C_vertical_down
; if vertical up
C - - - - - 0x01E477 07:E467: E6 13     INC ram_0013_t03_data_index
C - - - - - 0x01E479 07:E469: 4C 75 E4  JMP loc_E475
bra_E46C_vertical_down:
C - - - - - 0x01E47C 07:E46C: C6 13     DEC ram_0013_t03_data_index
C - - - - - 0x01E47E 07:E46E: 4C 75 E4  JMP loc_E475
bra_E471_horisontal:
C - - - - - 0x01E481 07:E471: A9 00     LDA #$00
C - - - - - 0x01E483 07:E473: 85 11     STA ram_0011_t03_pos_X_lo
bra_E475:
loc_E475:
C D 3 - - - 0x01E485 07:E475: A5 11     LDA ram_0011_t03_pos_X_lo
C - - - - - 0x01E487 07:E477: 85 06     STA ram_0006_t03
...
C - - - - - 0x01E496 07:E486: 05 03     ORA ram_0003_t11
C - - - - - 0x01E498 07:E488: 85 03     STA ram_0003_t12_data_index
loc_E48A:
C D 3 - - - 0x01E49A 07:E48A: A5 EA     LDA ram_00EA_useless_prg_bank_01
C - - - - - 0x01E49C 07:E48C: 20 CF FF  JSR sub_FFCF_prg_bankswitch
C - - - - - 0x01E49F 07:E48F: A4 13     LDY ram_0013_t03_data_index
C - - - - - 0x01E4A1 07:E491: 20 59 D9  JSR sub_D959_prepare_pointers
loc_E494:
C D 3 - - - 0x01E4A4 07:E494: A4 13     LDY ram_0013_t03_data_index
C - - - - - 0x01E4A6 07:E496: B1 6E     LDA (ram_006E_t01_data),Y
C - - - - - 0x01E4A8 07:E498: 10 04     BPL bra_E49E
C - - - - - 0x01E4AA 07:E49A: A9 00     LDA #$00
C - - - - - 0x01E4AC 07:E49C: F0 2B     BEQ bra_E4C9
bra_E49E:
C - - - - - 0x01E4AE 07:E49E: A5 EA     LDA ram_00EA_useless_prg_bank_01
C - - - - - 0x01E4B0 07:E4A0: 20 CF FF  JSR sub_FFCF_prg_bankswitch
C - - - - - 0x01E4B3 07:E4A3: 20 3B D9  JSR sub_D93B_prepare_pointers
...
C - - - - - 0x01E4C0 07:E4B0: A4 03     LDY ram_0003_t12_data_index
C - - - - - 0x01E4C2 07:E4B2: B1 00     LDA (ram_0000_t05_data),Y
C - - - - - 0x01E4C4 07:E4B4: A8        TAY
C - - - - - 0x01E4C5 07:E4B5: B1 6C     LDA (ram_006C_t01_stage_data_5),Y
C - - - - - 0x01E4C7 07:E4B7: 29 F0     AND #$F0
C - - - - - 0x01E4C9 07:E4B9: C9 30     CMP #$30
C - - - - - 0x01E4CB 07:E4BB: D0 0C     BNE bra_E4C9
; A = 30
C - - - - - 0x01E4CD 07:E4BD: 85 BE     STA ram_00BE_flag
C - - - - - 0x01E4CF 07:E4BF: A5 13     LDA ram_0013_t03_data_index
...
bra_E4C9:
C - - - - - 0x01E4D9 07:E4C9: A4 02     LDY ram_0002_t17
...
bra_E4D4:
C - - - - - 0x01E4E4 07:E4D4: 05 10     ORA ram_0010_t02
C - - - - - 0x01E4E6 07:E4D6: 85 10     STA ram_0010_t02
C - - - - - 0x01E4E8 07:E4D8: E6 02     INC ram_0002_t17
C - - - - - 0x01E4EA 07:E4DA: A5 02     LDA ram_0002_t17
C - - - - - 0x01E4EC 07:E4DC: C5 05     CMP ram_0005_t08
C - - - - - 0x01E4EE 07:E4DE: F0 61     BEQ bra_E541
C - - - - - 0x01E4F0 07:E4E0: E6 40     INC ram_0040
C - - - - - 0x01E4F2 07:E4E2: A4 40     LDY ram_0040
C - - - - - 0x01E4F4 07:E4E4: A5 11     LDA ram_0011_t03_pos_X_lo
C - - - - - 0x01E4F6 07:E4E6: 48        PHA
C - - - - - 0x01E4F7 07:E4E7: 29 10     AND #$10
C - - - - - 0x01E4F9 07:E4E9: 85 04     STA ram_0004_t11
C - - - - - 0x01E4FB 07:E4EB: 68        PLA
C - - - - - 0x01E4FC 07:E4EC: 18        CLC
C - - - - - 0x01E4FD 07:E4ED: 79 6D E6  ADC tbl_E66D,Y
C - - - - - 0x01E500 07:E4F0: 85 11     STA ram_0011_t03_pos_X_lo
C - - - - - 0x01E502 07:E4F2: 29 10     AND #$10
C - - - - - 0x01E504 07:E4F4: C5 04     CMP ram_0004_t11
C - - - - - 0x01E506 07:E4F6: F0 B3     BEQ bra_E4AB_loop
C - - - - - 0x01E508 07:E4F8: A5 11     LDA ram_0011_t03_pos_X_lo
C - - - - - 0x01E50A 07:E4FA: C9 F0     CMP #$F0
C - - - - - 0x01E50C 07:E4FC: 90 2C     BCC bra_E52A
C - - - - - 0x01E50E 07:E4FE: 69 0F     ADC #$0F
C - - - - - 0x01E510 07:E500: 85 11     STA ram_0011_t03_pos_X_lo
C - - - - - 0x01E512 07:E502: A5 27     LDA ram_0027_camera_movement_direction
C - - - - - 0x01E514 07:E504: C9 04     CMP #$04
C - - - - - 0x01E516 07:E506: B0 08     BCS bra_E510_moving_vertically
; if moving horisontally
C - - - - - 0x01E518 07:E508: A9 EF     LDA #$EF
C - - - - - 0x01E51A 07:E50A: 85 11     STA ram_0011_t03_pos_X_lo
C - - - - - 0x01E51C 07:E50C: A9 00     LDA #$00
C - - - - - 0x01E51E 07:E50E: F0 B9     BEQ bra_E4C9    ; jmp
bra_E510_moving_vertically:
C - - - - - 0x01E520 07:E510: A5 03     LDA ram_0003_t12_data_index
C - - - - - 0x01E522 07:E512: 29 FD     AND #$FD
C - - - - - 0x01E524 07:E514: 85 03     STA ram_0003_t12_data_index
C - - - - - 0x01E526 07:E516: A5 21     LDA ram_0021
C - - - - - 0x01E528 07:E518: 29 07     AND #$07
C - - - - - 0x01E52A 07:E51A: 85 21     STA ram_0021
C - - - - - 0x01E52C 07:E51C: A5 50     LDA ram_stage_config
C - - - - - 0x01E52E 07:E51E: 10 05     BPL bra_E525
C - - - - - 0x01E530 07:E520: C6 13     DEC ram_0013_t03_data_index
C - - - - - 0x01E532 07:E522: 4C 8A E4  JMP loc_E48A
bra_E525:
C - - - - - 0x01E535 07:E525: E6 13     INC ram_0013_t03_data_index
C - - - - - 0x01E537 07:E527: 4C 8A E4  JMP loc_E48A
bra_E52A:
C - - - - - 0x01E53A 07:E52A: A5 03     LDA ram_0003_t12_data_index
C - - - - - 0x01E53C 07:E52C: 49 02     EOR #$02
C - - - - - 0x01E53E 07:E52E: 85 03     STA ram_0003_t12_data_index
...
sub_E544:
; in
    ; A = table index (not used in this subroutine)
; out
    ; A = the same A as in
C - - - - - 0x01E554 07:E544: 48        PHA
C - - - - - 0x01E555 07:E545: A5 50     LDA ram_stage_config
...
C - - - - - 0x01E562 07:E552: 85 13     STA ram_0013_t01
C - - - - - 0x01E564 07:E554: BD 60 03  LDA ram_pos_Y_lo,X
C - - - - - 0x01E567 07:E557: 85 07     STA ram_0007_t04_pos_Y_lo
...
- - - - - - 0x01E583 07:E573: 90 2F     BCC bra_E5A4    ; jmp
bra_E575:
...
- - - - - - 0x01E594 07:E584: 85 13     STA ram_0013_t01
- - - - - - 0x01E596 07:E586: A9 00     LDA #$00
; bzk optimize, delete STA, BEQ to 0x01E5B2
- - - - - - 0x01E598 07:E588: 85 07     STA ram_0007_t04_pos_Y_lo
- - - - - - 0x01E59A 07:E58A: F0 18     BEQ bra_E5A4    ; jmp
bra_E58C_horisontal:
C - - - - - 0x01E59C 07:E58C: BD 40 03  LDA ram_pos_X_hi,X
C - - - - - 0x01E59F 07:E58F: 18        CLC
C - - - - - 0x01E5A0 07:E590: 65 FB     ADC ram_scroll_Y_hi
C - - - - - 0x01E5A2 07:E592: 85 13     STA ram_0013_t01
C - - - - - 0x01E5A4 07:E594: BD 60 03  LDA ram_pos_Y_lo,X
C - - - - - 0x01E5A7 07:E597: 85 07     STA ram_0007_t04_pos_Y_lo
...
C - - - - - 0x01E5B2 07:E5A2: 85 07     STA ram_0007_t04_pos_Y_lo
bra_E5A4:
C - - - - - 0x01E5B4 07:E5A4: A9 00     LDA #$00
C - - - - - 0x01E5B6 07:E5A6: 85 10     STA ram_0010_t02
C - - - - - 0x01E5B8 07:E5A8: 85 41     STA ram_0041
C - - - - - 0x01E5BA 07:E5AA: 85 BE     STA ram_00BE_flag
...
loc_E5B3:
C D 3 - - - 0x01E5C3 07:E5B3: A5 10     LDA ram_0010_t02
C - - - - - 0x01E5C5 07:E5B5: 29 10     AND #$10
C - - - - - 0x01E5C7 07:E5B7: D0 16     BNE bra_E5CF
C - - - - - 0x01E5C9 07:E5B9: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01E5CC 07:E5BC: 29 DF     AND #$20 ^ $FF
C - - - - - 0x01E5CE 07:E5BE: 9D 00 04  STA ram_0400_obj_flags,X
C - - - - - 0x01E5D1 07:E5C1: A5 41     LDA ram_0041
C - - - - - 0x01E5D3 07:E5C3: C9 20     CMP #$20
C - - - - - 0x01E5D5 07:E5C5: D0 08     BNE bra_E5CF
C - - - - - 0x01E5D7 07:E5C7: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01E5DA 07:E5CA: 09 20     ORA #$20
C - - - - - 0x01E5DC 07:E5CC: 9D 00 04  STA ram_0400_obj_flags,X
bra_E5CF:
C - - - - - 0x01E5DF 07:E5CF: A5 9B     LDA ram_prg_bank
...
; out
    ; C
        ; 0 = 
        ; 1 = 
C - - - - - 0x01E5E4 07:E5D4: A5 E9     LDA ram_stage_id
...
C - - - - - 0x01E5F7 07:E5E7: C5 13     CMP ram_0013_t03_data_index
...
C - - - - - 0x01E602 07:E5F2: A5 E9     LDA ram_stage_id
...
bra_E600_stage_2:
C - - - - - 0x01E610 07:E600: A5 13     LDA ram_0013_t03_data_index
...
bra_E60C_stage_3:
C - - - - - 0x01E61C 07:E60C: A5 13     LDA ram_0013_t03_data_index
...
sub_E69B:
; bzk optimize, useless LDA + PHA,
; also delete PLA at 0x01E6C3
C - - - - - 0x01E6AB 07:E69B: A5 12     LDA ram_0012_t03_pos_X_lo
C - - - - - 0x01E6AD 07:E69D: 48        PHA
; 
C - - - - - 0x01E6AE 07:E69E: 29 0F     AND #$0F
C - - - - - 0x01E6B0 07:E6A0: 85 12     STA ram_0012_t04
C - - - - - 0x01E6B2 07:E6A2: BD 30 03  LDA ram_pos_X_lo,X
C - - - - - 0x01E6B5 07:E6A5: 38        SEC
C - - - - - 0x01E6B6 07:E6A6: E5 12     SBC ram_0012_t04
...
C - - - - - 0x01E6C4 07:E6B4: 85 12     STA ram_0012_tFF_useless
C - - - - - 0x01E6C6 07:E6B6: 60        RTS



sub_E6B7:
C - - - - - 0x01E6C7 07:E6B7: A5 12     LDA ram_0012_t03_pos_X_lo
...
sub_E6CD:
; in
    ; ram_0011_t04_pos_Y_lo
C - - - - - 0x01E6DD 07:E6CD: A5 11     LDA ram_0011_t04_pos_Y_lo
...
- - - - - - 0x01E6F3 07:E6E3: A5 50     LDA ram_stage_config
...
sub_E6EF:
; bzk optimize, useless LDA + PHA,
; also delete PLA at 0x01E723
C - - - - - 0x01E6FF 07:E6EF: A5 11     LDA ram_0011_t04_pos_Y_lo
C - - - - - 0x01E701 07:E6F1: 48        PHA
; 
C - - - - - 0x01E702 07:E6F2: 29 0F     AND #$0F
C - - - - - 0x01E704 07:E6F4: 85 11     STA ram_0011_t05
C - - - - - 0x01E706 07:E6F6: BD 60 03  LDA ram_pos_Y_lo,X
C - - - - - 0x01E709 07:E6F9: 38        SEC
C - - - - - 0x01E70A 07:E6FA: E5 11     SBC ram_0011_t05
...
- - - - - - 0x01E716 07:E706: A5 50     LDA ram_stage_config
...
; bzk optimize, useless STA
C - - - - - 0x01E724 07:E714: 85 11     STA ram_0011_tFE_useless
C - - - - - 0x01E726 07:E716: 60        RTS



sub_E717_change_palette_for_background_effects:
C - - - - - 0x01E727 07:E717: A5 B1     LDA ram_hearts
C - - - - - 0x01E729 07:E719: F0 29     BEQ bra_E744_RTS
; if not dead
C - - - - - 0x01E72B 07:E71B: A5 18     LDA ram_0018_flag
C - - - - - 0x01E72D 07:E71D: 05 19     ORA ram_buffer_ready_flag
C - - - - - 0x01E72F 07:E71F: D0 23     BNE bra_E744_RTS
C - - - - - 0x01E731 07:E721: A9 03     LDA #$03
C - - - - - 0x01E733 07:E723: 85 10     STA ram_0010_t06_loop_counter
C - - - - - 0x01E735 07:E725: A5 18     LDA ram_0018_flag
C - - - - - 0x01E737 07:E727: 29 01     AND #$01
C - - - - - 0x01E739 07:E729: 85 11     STA ram_0011_t06
C - - - - - 0x01E73B 07:E72B: A9 00     LDA #$00
C - - - - - 0x01E73D 07:E72D: 85 18     STA ram_0018_flag
bra_E72F_loop:
C - - - - - 0x01E73F 07:E72F: A6 10     LDX ram_0010_t06_loop_counter
C - - - - - 0x01E741 07:E731: BD 00 01  LDA ram_0100_bg_anim_cfg,X
C - - - - - 0x01E744 07:E734: 10 06     BPL bra_E73C_next
; A = 80 81 
C - - - - - 0x01E746 07:E736: 29 7F     AND #$7F
C - - - - - 0x01E748 07:E738: A8        TAY
C - - - - - 0x01E749 07:E739: 20 45 E7  JSR sub_E745_change_palette_for_background_effects
bra_E73C_next:
C - - - - - 0x01E74C 07:E73C: C6 10     DEC ram_0010_t06_loop_counter
C - - - - - 0x01E74E 07:E73E: 10 EF     BPL bra_E72F_loop
C - - - - - 0x01E750 07:E740: A5 11     LDA ram_0011_t06
C - - - - - 0x01E752 07:E742: 85 18     STA ram_0018_flag
bra_E744_RTS:
C - - - - - 0x01E754 07:E744: 60        RTS



sub_E745_change_palette_for_background_effects:
; in
    ; Y
        ; 00 = 
        ; 01 = 
    ; ram_0010_t06_loop_counter
    ; ram_0011_t06
; out
    ; ram_0011_t06
C - - - - - 0x01E755 07:E745: B9 A7 E7  LDA tbl_E7A7_table_index,Y
C - - - - - 0x01E758 07:E748: A8        TAY
C - - - - - 0x01E759 07:E749: BD 08 01  LDA ram_0108_bg_anim_cnt_1,X
C - - - - - 0x01E75C 07:E74C: FE 08 01  INC ram_0108_bg_anim_cnt_1,X
C - - - - - 0x01E75F 07:E74F: D9 B0 E7  CMP tbl_E7AF_bg_anim + $01,Y
C - - - - - 0x01E762 07:E752: D0 3D     BNE bra_E791_RTS
C - - - - - 0x01E764 07:E754: A9 00     LDA #$00
C - - - - - 0x01E766 07:E756: 9D 08 01  STA ram_0108_bg_anim_cnt_1,X
C - - - - - 0x01E769 07:E759: BD 04 01  LDA ram_0104_bg_anim_cnt_2,X
C - - - - - 0x01E76C 07:E75C: FE 04 01  INC ram_0104_bg_anim_cnt_2,X
C - - - - - 0x01E76F 07:E75F: D9 AF E7  CMP tbl_E7AF_bg_anim,Y
C - - - - - 0x01E772 07:E762: D0 05     BNE bra_E769
C - - - - - 0x01E774 07:E764: A9 00     LDA #$00
C - - - - - 0x01E776 07:E766: 9D 04 01  STA ram_0104_bg_anim_cnt_2,X
bra_E769:
C - - - - - 0x01E779 07:E769: 98        TYA
C - - - - - 0x01E77A 07:E76A: 18        CLC
C - - - - - 0x01E77B 07:E76B: 7D 04 01  ADC ram_0104_bg_anim_cnt_2,X
C - - - - - 0x01E77E 07:E76E: AA        TAX
C - - - - - 0x01E77F 07:E76F: BD B1 E7  LDA tbl_E7AF_bg_anim + $02,X
; * 03
C - - - - - 0x01E782 07:E772: 0A        ASL
C - - - - - 0x01E783 07:E773: 7D B1 E7  ADC tbl_E7AF_bg_anim + $02,X
C - - - - - 0x01E786 07:E776: AA        TAX
; 
C - - - - - 0x01E787 07:E777: A5 10     LDA ram_0010_t06_loop_counter
C - - - - - 0x01E789 07:E779: 0A        ASL
C - - - - - 0x01E78A 07:E77A: 0A        ASL
C - - - - - 0x01E78B 07:E77B: A8        TAY
; 
C - - - - - 0x01E78C 07:E77C: A9 03     LDA #$03
C - - - - - 0x01E78E 07:E77E: 85 00     STA ram_0000_t61_colors_counter
bra_E780_loop:
C - - - - - 0x01E790 07:E780: BD 92 E7  LDA tbl_E792_palette,X
C - - - - - 0x01E793 07:E783: 99 01 06  STA ram_palette_buffer + $01,Y
C - - - - - 0x01E796 07:E786: 99 21 06  STA ram_max_brightness_buffer + $01,Y
C - - - - - 0x01E799 07:E789: C8        INY
C - - - - - 0x01E79A 07:E78A: E8        INX
C - - - - - 0x01E79B 07:E78B: C6 00     DEC ram_0000_t61_colors_counter
C - - - - - 0x01E79D 07:E78D: D0 F1     BNE bra_E780_loop
C - - - - - 0x01E79F 07:E78F: E6 11     INC ram_0011_t06
bra_E791_RTS:
...
tbl_E792_palette:
- D 3 - - - 0x01E7A2 07:E792: 20        .byte $20, $0F, $10   ; 00 
- D 3 - - - 0x01E7A5 07:E795: 0F        .byte $0F, $10, $20   ; 01 
- D 3 - - - 0x01E7A8 07:E798: 10        .byte $10, $20, $0F   ; 02 
- D 3 - - - 0x01E7AB 07:E79B: 17        .byte $17, $07, $0F   ; 03 
- D 3 - - - 0x01E7AE 07:E79E: 17        .byte $17, $07, $06   ; 04 
- D 3 - - - 0x01E7B1 07:E7A1: 17        .byte $17, $07, $16   ; 05 


; bzk garbage, no such index 06
- - - - - - 0x01E7B4 07:E7A4: 17        .byte $17, $07, $26   ; 06 



tbl_E7A7_table_index:
- D 3 - - - 0x01E7B7 07:E7A7: 00        .byte off_E7AF_00 - tbl__E7AF   ; 00 
- D 3 - - - 0x01E7B8 07:E7A8: 05        .byte off_E7B4_05 - tbl__E7AF   ; 01 


; bzk garbage, no such indexes 02-07
- - - - - - 0x01E7B9 07:E7A9: 0B        .byte $0B   ; 02 
- - - - - - 0x01E7BA 07:E7AA: 0B        .byte $0B   ; 03 
- - - - - - 0x01E7BB 07:E7AB: 0B        .byte $0B   ; 04 
- - - - - - 0x01E7BC 07:E7AC: 0B        .byte $0B   ; 05 
- - - - - - 0x01E7BD 07:E7AD: 0B        .byte $0B   ; 06 
- - - - - - 0x01E7BE 07:E7AE: 0B        .byte $0B   ; 07 
...
tbl__E7AF:
off_E7AF_00:
- D 3 - - - 0x01E7BF 07:E7AF: 02        .byte $02   ; max index
- D 3 - - - 0x01E7C0 07:E7B0: 08        .byte $08   ; 
; palette table indexes
- D 3 - - - 0x01E7C1 07:E7B1: 00        .byte $00   ; 00 
- D 3 - - - 0x01E7C2 07:E7B2: 01        .byte $01   ; 01 
- D 3 - - - 0x01E7C3 07:E7B3: 02        .byte $02   ; 02 

off_E7B4_05:
- D 3 - - - 0x01E7C4 07:E7B4: 03        .byte $03   ; max index
- D 3 - - - 0x01E7C5 07:E7B5: 20        .byte $20   ; 
; palette table indexes
- D 3 - - - 0x01E7C6 07:E7B6: 03        .byte $03   ; 00 
- D 3 - - - 0x01E7C7 07:E7B7: 04        .byte $04   ; 01 
- D 3 - - - 0x01E7C8 07:E7B8: 05        .byte $05   ; 02 
- D 3 - - - 0x01E7C9 07:E7B9: 04        .byte $04   ; 03 



sub_0x01E7CA_draw_closed_chest:
...
C - - - - - 0x01E7E0 07:E7D0: B9 6E E8  LDA tbl_E86E_chest_ppu_lo,Y
C - - - - - 0x01E7E3 07:E7D3: 85 2A     STA ram_chest_ppu_lo
...
C - - - - - 0x01E7EF 07:E7DF: 19 76 E8  ORA tbl_E876_chest_ppu_lo,Y
C - - - - - 0x01E7F2 07:E7E2: 85 2B     STA ram_chest_ppu_hi
C - - - - - 0x01E7F4 07:E7E4: A5 2D     LDA ram_002D
C - - - - - 0x01E7F6 07:E7E6: 29 07     AND #$07
C - - - - - 0x01E7F8 07:E7E8: 0A        ASL
C - - - - - 0x01E7F9 07:E7E9: 0A        ASL
C - - - - - 0x01E7FA 07:E7EA: 05 2A     ORA ram_chest_ppu_lo
C - - - - - 0x01E7FC 07:E7EC: 85 2A     STA ram_chest_ppu_lo
C - - - - - 0x01E7FE 07:E7EE: A9 08     LDA #$08
C - - - - - 0x01E800 07:E7F0: 85 29     STA ram_chest_opening_delay
C - - - - - 0x01E802 07:E7F2: 20 64 FE  JSR sub_FE64
C - - - - - 0x01E805 07:E7F5: A0 00     LDY #$00    ; draw closed chest
...
C - - - - - 0x01E818 07:E808: F0 1A     BEQ bra_E824_draw_closed_chest   ; jmp
bra_E80A:
...
C - - - - - 0x01E824 07:E814: F0 0E     BEQ bra_E824_draw_closed_chest   ; jmp



sub_E816_try_to_draw_opened_chest:
C - - - - - 0x01E826 07:E816: A5 29     LDA ram_chest_opening_delay
C - - - - - 0x01E828 07:E818: F0 43     BEQ bra_E85D_RTS
C - - - - - 0x01E82A 07:E81A: A5 1A     LDA ram_001A_chest_flag
C - - - - - 0x01E82C 07:E81C: D0 3F     BNE bra_E85D_RTS
C - - - - - 0x01E82E 07:E81E: C6 29     DEC ram_chest_opening_delay
C - - - - - 0x01E830 07:E820: D0 3B     BNE bra_E85D_RTS
C - - - - - 0x01E832 07:E822: A0 08     LDY #$08    ; draw opened chest
bra_E824_draw_closed_chest:
C - - - - - 0x01E834 07:E824: A5 2B     LDA ram_chest_ppu_hi
C - - - - - 0x01E836 07:E826: 8D C0 07  STA ram_ppu_buffer + $40
C - - - - - 0x01E839 07:E829: 8D C7 07  STA ram_ppu_buffer + $47
; 1st row
C - - - - - 0x01E83C 07:E82C: A5 2A     LDA ram_chest_ppu_lo
...
; set tiles counter for each row
C - - - - - 0x01E846 07:E836: A9 03     LDA #$03   ; 4 tiles
C - - - - - 0x01E848 07:E838: 8D C2 07  STA ram_ppu_buffer + $42
C - - - - - 0x01E84B 07:E83B: 8D C9 07  STA ram_ppu_buffer + $49
; 
C - - - - - 0x01E84E 07:E83E: 86 00     STX ram_0000_t62_save_X
C - - - - - 0x01E850 07:E840: A2 00     LDX #$00
bra_E842_loop:
; draws only first 4x2 tiles, which is chest upper half
C - - - - - 0x01E852 07:E842: B9 5E E8  LDA tbl_E85E_chest_tiles,Y
C - - - - - 0x01E855 07:E845: 9D C3 07  STA ram_ppu_buffer + $43,X
C - - - - - 0x01E858 07:E848: B9 62 E8  LDA tbl_E85E_chest_tiles + $04,Y
...
C - - - - - 0x01E864 07:E854: A6 00     LDX ram_0000_t62_save_X
C - - - - - 0x01E866 07:E856: A9 FF     LDA #$FF
C - - - - - 0x01E868 07:E858: 8D CE 07  STA ram_ppu_buffer + $4E
C - - - - - 0x01E86B 07:E85B: 85 1A     STA ram_001A_chest_flag
bra_E85D_RTS:
C - - - - - 0x01E86D 07:E85D: 60        RTS



tbl_E85E_chest_tiles:
; 00 closed
- D 3 - - - 0x01E86E 07:E85E: 24        .byte $24, $25, $26, $27   ; 
- D 3 - - - 0x01E872 07:E862: 34        .byte $34, $35, $36, $37   ; 
; 08 opened
- D 3 - - - 0x01E876 07:E866: 2C        .byte $2C, $2D, $2E, $2F   ; 
- D 3 - - - 0x01E87A 07:E86A: 3C        .byte $3C, $3D, $3E, $3F   ; 



tbl_E86E_chest_ppu_lo:
- - - - - - 0x01E87E 07:E86E: 00        .byte < $2000   ; 00 
- D 3 - - - 0x01E87F 07:E86F: 80        .byte < $2080   ; 01 
- D 3 - - - 0x01E880 07:E870: 00        .byte < $2100   ; 02 
- D 3 - - - 0x01E881 07:E871: 80        .byte < $2180   ; 03 
- - - - - - 0x01E882 07:E872: 00        .byte < $2200   ; 04 
- D 3 - - - 0x01E883 07:E873: 80        .byte < $2280   ; 05 
- D 3 - - - 0x01E884 07:E874: 00        .byte < $2300   ; 06 
- - - - - - 0x01E885 07:E875: 80        .byte < $2380   ; 07 



tbl_E876_chest_ppu_lo:
- - - - - - 0x01E886 07:E876: 20        .byte > $2000   ; 00 
- D 3 - - - 0x01E887 07:E877: 20        .byte > $2080   ; 01 
- D 3 - - - 0x01E888 07:E878: 21        .byte > $2100   ; 02 
- D 3 - - - 0x01E889 07:E879: 21        .byte > $2180   ; 03 
- - - - - - 0x01E88A 07:E87A: 22        .byte > $2200   ; 04 
- D 3 - - - 0x01E88B 07:E87B: 22        .byte > $2280   ; 05 
- D 3 - - - 0x01E88C 07:E87C: 23        .byte > $2300   ; 06 
- - - - - - 0x01E88D 07:E87D: 23        .byte > $2380   ; 07 



sub_E87E:
C - - - - - 0x01E88E 07:E87E: A5 E9     LDA ram_stage_id
...
C - - - - - 0x01E8E0 07:E8D0: 48        PHA ; 1
; disable rendering
C - - - - - 0x01E8E1 07:E8D1: A9 00     LDA #$00
C - - - - - 0x01E8E3 07:E8D3: 85 EE     STA ram_rendering_flag
; 
C - - - - - 0x01E8E5 07:E8D5: 20 EC C1  JSR sub_C1EC_decrease_brightness
C - - - - - 0x01E8E8 07:E8D8: 20 D3 C1  JSR sub_C1D3_clear_all_objects
C - - - - - 0x01E8EB 07:E8DB: A9 04     LDA #$04
C - - - - - 0x01E8ED 07:E8DD: 85 97     STA ram_oam_index
C - - - - - 0x01E8EF 07:E8DF: 20 BC C1  JSR sub_C1BC_hide_unused_sprites
C - - - - - 0x01E8F2 07:E8E2: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01E8F5 07:E8E5: 20 04 C1  JSR sub_C104_disable_rendering
C - - - - - 0x01E8F8 07:E8E8: 68        PLA ; 1
C - - - - - 0x01E8F9 07:E8E9: A8        TAY
C - - - - - 0x01E8FA 07:E8EA: 85 0A     STA ram_000A_t02
C - - - - - 0x01E8FC 07:E8EC: B9 8C EA  LDA tbl_EA8C_positions_lo,Y
C - - - - - 0x01E8FF 07:E8EF: 85 08     STA ram_0008_t01_positions_data
C - - - - - 0x01E901 07:E8F1: B9 97 EA  LDA tbl_EA97_positions_hi,Y
C - - - - - 0x01E904 07:E8F4: 85 09     STA ram_0008_t01_positions_data + $01
...
C - - - - - 0x01E910 07:E900: A5 0A     LDA ram_000A_t02
...
bra_E912:
C - - - - - 0x01E922 07:E912: A5 0A     LDA ram_000A_t02
C - - - - - 0x01E924 07:E914: 85 28     STA ram_0028
C - - - - - 0x01E926 07:E916: B1 08     LDA (ram_0008_t01_positions_data),Y
C - - - - - 0x01E928 07:E918: 85 0F     STA ram_000F_t14_table_index
C - - - - - 0x01E92A 07:E91A: 85 20     STA ram_0020
C - - - - - 0x01E92C 07:E91C: C8        INY
C - - - - - 0x01E92D 07:E91D: B1 08     LDA (ram_0008_t01_positions_data),Y
C - - - - - 0x01E92F 07:E91F: 85 FD     STA ram_scroll_X_hi
C - - - - - 0x01E931 07:E921: 8D 40 03  STA ram_pos_X_hi
C - - - - - 0x01E934 07:E924: 85 33     STA ram_0033_copy_pos_X_hi
C - - - - - 0x01E936 07:E926: C8        INY
C - - - - - 0x01E937 07:E927: B1 08     LDA (ram_0008_t01_positions_data),Y
C - - - - - 0x01E939 07:E929: 8D 30 03  STA ram_pos_X_lo
C - - - - - 0x01E93C 07:E92C: 85 32     STA ram_0032_copy_pos_X_lo
C - - - - - 0x01E93E 07:E92E: C8        INY
C - - - - - 0x01E93F 07:E92F: B1 08     LDA (ram_0008_t01_positions_data),Y
C - - - - - 0x01E941 07:E931: 85 FB     STA ram_scroll_Y_hi
C - - - - - 0x01E943 07:E933: 8D 70 03  STA ram_pos_Y_hi
C - - - - - 0x01E946 07:E936: 85 35     STA ram_0035_copy_pos_Y_hi
C - - - - - 0x01E948 07:E938: C8        INY
C - - - - - 0x01E949 07:E939: B1 08     LDA (ram_0008_t01_positions_data),Y
C - - - - - 0x01E94B 07:E93B: 8D 60 03  STA ram_pos_Y_lo
C - - - - - 0x01E94E 07:E93E: 85 34     STA ram_0034_copy_pos_Y_lo
C - - - - - 0x01E950 07:E940: C8        INY
C - - - - - 0x01E951 07:E941: 84 0A     STY ram_000A_t01_data_index
...
C - - - - - 0x01E963 07:E953: 85 0B     STA ram_000B_t01_loop_counter
bra_E955_loop:
C - - - - - 0x01E965 07:E955: A9 01     LDA #$01
C - - - - - 0x01E967 07:E957: 85 01     STA ram_0001_t08
                                       ;LDA #$01 right
C - - - - - 0x01E969 07:E959: 85 27     STA ram_0027_camera_movement_direction
C - - - - - 0x01E96B 07:E95B: 20 BD D6  JSR sub_D6BD
C - - - - - 0x01E96E 07:E95E: 20 CB C0  JSR sub_C0CB_write_buffer_to_ppu
C - - - - - 0x01E971 07:E961: C6 0B     DEC ram_000B_t01_loop_counter
C - - - - - 0x01E973 07:E963: D0 F0     BNE bra_E955_loop
C - - - - - 0x01E975 07:E965: A4 0A     LDY ram_000A_t01_data_index
C - - - - - 0x01E977 07:E967: B1 08     LDA (ram_0008_t01_positions_data),Y
C - - - - - 0x01E979 07:E969: 85 52     STA ram_0052
C - - - - - 0x01E97B 07:E96B: C8        INY
C - - - - - 0x01E97C 07:E96C: B1 08     LDA (ram_0008_t01_positions_data),Y
C - - - - - 0x01E97E 07:E96E: 85 0A     STA ram_000A_t03
C - - - - - 0x01E980 07:E970: A8        TAY
C - - - - - 0x01E981 07:E971: B1 70     LDA (ram_0070_t01_data),Y
...
C - - - - - 0x01E98B 07:E97B: 05 0A     ORA ram_000A_t03
C - - - - - 0x01E98D 07:E97D: 85 50     STA ram_stage_config
...
C - - - - - 0x01E997 07:E987: A9 08     LDA #$08    ; up
C - - - - - 0x01E999 07:E989: 85 27     STA ram_0027_camera_movement_direction
bra_E98B_horisontal:
C - - - - - 0x01E99B 07:E98B: A2 09     LDX #con_C2C4_09
C - - - - - 0x01E99D 07:E98D: A5 0A     LDA ram_000A_t03
C - - - - - 0x01E99F 07:E98F: C9 03     CMP #$03
C - - - - - 0x01E9A1 07:E991: 90 01     BCC bra_E994
C - - - - - 0x01E9A3 07:E993: E8        INX ; -> 0A con_C2C4_0A
bra_E994:
C - - - - - 0x01E9A4 07:E994: 20 6B C2  JSR sub_C26B_write_chr_to_ppu
C - - - - - 0x01E9A7 07:E997: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01E9AA 07:E99A: A0 00     LDY #$00
C - - - - - 0x01E9AC 07:E99C: A2 07     LDX #con_C2C4_07
C - - - - - 0x01E9AE 07:E99E: A5 0A     LDA ram_000A_t03
...
bra_E9A9:
C - - - - - 0x01E9B9 07:E9A9: 86 0A     STX ram_000A_t04
C - - - - - 0x01E9BB 07:E9AB: A2 00     LDX #$00
bra_E9AD_loop:
C - - - - - 0x01E9BD 07:E9AD: B9 FC E9  LDA tbl_E9FC_palette,Y
C - - - - - 0x01E9C0 07:E9B0: 9D 20 06  STA ram_max_brightness_buffer,X
...
C - - - - - 0x01E9C9 07:E9B9: A6 0A     LDX ram_000A_t04
C - - - - - 0x01E9CB 07:E9BB: 20 6B C2  JSR sub_C26B_write_chr_to_ppu
C - - - - - 0x01E9CE 07:E9BE: A5 50     LDA ram_stage_config
...
C - - - - - 0x01E9E1 07:E9D1: 9D 38 06  STA ram_max_brightness_buffer + $18,X
...
C - - - - - 0x01E9EC 07:E9DC: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01E9EF 07:E9DF: A4 0F     LDY ram_000F_t14_table_index
C - - - - - 0x01E9F1 07:E9E1: B9 80 BF  LDA tbl_0x013F90,Y
C - - - - - 0x01E9F4 07:E9E4: 85 9E     STA ram_009E_data_index
C - - - - - 0x01E9F6 07:E9E6: 85 9F     STA ram_009F_data_index
C - - - - - 0x01E9F8 07:E9E8: A9 01     LDA #$01
C - - - - - 0x01E9FA 07:E9EA: 85 F9     STA ram_camera_direction
C - - - - - 0x01E9FC 07:E9EC: 20 0E C1  JSR sub_C10E_enable_rendering
C - - - - - 0x01E9FF 07:E9EF: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01EA02 07:E9F2: A9 00     LDA #$00
C - - - - - 0x01EA04 07:E9F4: 85 3A     STA ram_003A
C - - - - - 0x01EA06 07:E9F6: 20 BA CB  JSR sub_CBBA
C - - - - - 0x01EA09 07:E9F9: 4C E6 C1  JMP loc_C1E6_increase_brightness
...
sub_EAA2_draw_pause_menu:
; disable rendering
C - - - - - 0x01EAB2 07:EAA2: A9 00     LDA #$00
C - - - - - 0x01EAB4 07:EAA4: 85 EE     STA ram_rendering_flag
; save values
C - - - - - 0x01EAB6 07:EAA6: 20 EC C1  JSR sub_C1EC_decrease_brightness
C - - - - - 0x01EAB9 07:EAA9: A9 04     LDA #$04
C - - - - - 0x01EABB 07:EAAB: 85 97     STA ram_oam_index
C - - - - - 0x01EABD 07:EAAD: 20 BC C1  JSR sub_C1BC_hide_unused_sprites
C - - - - - 0x01EAC0 07:EAB0: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01EAC3 07:EAB3: 20 04 C1  JSR sub_C104_disable_rendering
; 
C - - - - - 0x01EAC6 07:EAB6: A5 22     LDA ram_0022
C - - - - - 0x01EAC8 07:EAB8: 48        PHA
C - - - - - 0x01EAC9 07:EAB9: A5 27     LDA ram_0027_camera_movement_direction
...
; 
C - - - - - 0x01EAD8 07:EAC8: A5 50     LDA ram_stage_config
...
C - - - - - 0x01EAEF 07:EADF: 85 03     STA ram_0003_t06_ppu_hi_offset
; 
C - - - - - 0x01EAF1 07:EAE1: 09 20     ORA #$20    ; ppu hi
C - - - - - 0x01EAF3 07:EAE3: A2 00     LDX #$00    ; fill tile
C - - - - - 0x01EAF5 07:EAE5: A0 00     LDY #$00    ; fill attribute
C - - - - - 0x01EAF7 07:EAE7: 20 70 C1  JSR sub_C170_fill_nametable
; 
C - - - - - 0x01EAFA 07:EAEA: A9 06     LDA #con_prg_bank + $06
C - - - - - 0x01EAFC 07:EAEC: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01EAFF 07:EAEF: A2 01     LDX #con_screen_pause
...
C - - - - - 0x01EB45 07:EB35: 05 03     ORA ram_0003_t06_ppu_hi_offset
...
bra_EB44_loop:
C - - - - - 0x01EB54 07:EB44: BD 20 06  LDA ram_max_brightness_buffer,X
C - - - - - 0x01EB57 07:EB47: 9D E8 07  STA ram_07E8_unk,X
C - - - - - 0x01EB5A 07:EB4A: BD 94 EC  LDA tbl_EC94_palette,X
C - - - - - 0x01EB5D 07:EB4D: 9D 20 06  STA ram_max_brightness_buffer,X
...
; 
C - - - - - 0x01EB77 07:EB67: 20 0E C1  JSR sub_C10E_enable_rendering
C - - - - - 0x01EB7A 07:EB6A: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01EB7D 07:EB6D: 20 E6 C1  JSR sub_C1E6_increase_brightness
loc_EB70_loop:
C D 3 - - - 0x01EB80 07:EB70: A5 14     LDA ram_btn_press
C - - - - - 0x01EB82 07:EB72: 29 10     AND #con_btn_Start
C - - - - - 0x01EB84 07:EB74: D0 09     BNE bra_EB7F_pressed_Start
C - - - - - 0x01EB86 07:EB76: 20 02 EC  JSR sub_EC02_pause_menu_sprites
C - - - - - 0x01EB89 07:EB79: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01EB8C 07:EB7C: 4C 70 EB  JMP loc_EB70_loop
bra_EB7F_pressed_Start:
C - - - - - 0x01EB8F 07:EB7F: A9 1C     LDA #con_sfx_pause_menu
C - - - - - 0x01EB91 07:EB81: 20 A0 FC  JSR sub_FCA0_play_sfx
C - - - - - 0x01EB94 07:EB84: 20 EC C1  JSR sub_C1EC_decrease_brightness
C - - - - - 0x01EB97 07:EB87: A9 04     LDA #$04
C - - - - - 0x01EB99 07:EB89: 85 97     STA ram_oam_index
C - - - - - 0x01EB9B 07:EB8B: 20 BC C1  JSR sub_C1BC_hide_unused_sprites
C - - - - - 0x01EB9E 07:EB8E: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01EBA1 07:EB91: 20 04 C1  JSR sub_C104_disable_rendering
C - - - - - 0x01EBA4 07:EB94: A5 50     LDA ram_stage_config
...
C - - - - - 0x01EBCB 07:EBBB: A9 01     LDA #$01    ; right
C - - - - - 0x01EBCD 07:EBBD: 85 27     STA ram_0027_camera_movement_direction
bra_EBBF_loop:
C - - - - - 0x01EBCF 07:EBBF: A9 01     LDA #$01
C - - - - - 0x01EBD1 07:EBC1: 85 01     STA ram_0001_t08
...
C - - - - - 0x01EBE4 07:EBD4: A5 E9     LDA ram_stage_id
...
C - - - - - 0x01EBF1 07:EBE1: 9D 20 06  STA ram_max_brightness_buffer,X
...
C - - - - - 0x01EC04 07:EBF4: 85 27     STA ram_0027_camera_movement_direction
C - - - - - 0x01EC06 07:EBF6: 68        PLA
C - - - - - 0x01EC07 07:EBF7: 85 22     STA ram_0022
; 
C - - - - - 0x01EC09 07:EBF9: 20 0E C1  JSR sub_C10E_enable_rendering
C - - - - - 0x01EC0C 07:EBFC: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01EC0F 07:EBFF: 4C E6 C1  JMP loc_C1E6_increase_brightness



sub_EC02_pause_menu_sprites:
...
bra_EC36:
C - - - - - 0x01EC46 07:EC36: A9 04     LDA #$04
C - - - - - 0x01EC48 07:EC38: 85 97     STA ram_oam_index
                                       ;LDA #con_prg_bank + $04
C - - - - - 0x01EC4A 07:EC3A: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01EC4D 07:EC3D: 20 BC C1  JSR sub_C1BC_hide_unused_sprites
C - - - - - 0x01EC50 07:EC40: A2 10     LDX #$10
C - - - - - 0x01EC52 07:EC42: 86 96     STX ram_0096_t05_obj_index
bra_EC44_loop:
C - - - - - 0x01EC54 07:EC44: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01EC57 07:EC47: 10 13     BPL bra_EC5C_next
C - - - - - 0x01EC59 07:EC49: A9 00     LDA #$00
C - - - - - 0x01EC5B 07:EC4B: 85 10     STA ram_0010_t01_spr_A
C - - - - - 0x01EC5D 07:EC4D: 85 11     STA ram_0011_t01_00_or_01
C - - - - - 0x01EC5F 07:EC4F: BD 70 EC  LDA tbl_EC80_spr_Y - $10,X
C - - - - - 0x01EC62 07:EC52: 85 12     STA ram_0012_t02_spr_Y
C - - - - - 0x01EC64 07:EC54: BD 78 EC  LDA tbl_EC88_spr_X - $10,X
C - - - - - 0x01EC67 07:EC57: 85 13     STA ram_0013_t02_spr_X
C - - - - - 0x01EC69 07:EC59: 20 00 80  JSR sub_0x010010
bra_EC5C_next:
C - - - - - 0x01EC6C 07:EC5C: E6 96     INC ram_0096_t05_obj_index
C - - - - - 0x01EC6E 07:EC5E: A6 96     LDX ram_0096_t05_obj_index
...
C - - - - - 0x01ECAE 07:EC9E: 85 EE     STA ram_rendering_flag
; 
C - - - - - 0x01ECB0 07:ECA0: 20 EC C1  JSR sub_C1EC_decrease_brightness
C - - - - - 0x01ECB3 07:ECA3: A9 04     LDA #$04
C - - - - - 0x01ECB5 07:ECA5: 85 97     STA ram_oam_index
C - - - - - 0x01ECB7 07:ECA7: 20 BC C1  JSR sub_C1BC_hide_unused_sprites
C - - - - - 0x01ECBA 07:ECAA: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01ECBD 07:ECAD: 20 04 C1  JSR sub_C104_disable_rendering
; 
C - - - - - 0x01ECC0 07:ECB0: A9 20     LDA #$20    ; ppu hi
C - - - - - 0x01ECC2 07:ECB2: A2 00     LDX #$00    ; fill tile
C - - - - - 0x01ECC4 07:ECB4: A0 00     LDY #$00    ; fill attribute
C - - - - - 0x01ECC6 07:ECB6: 20 70 C1  JSR sub_C170_fill_nametable
; 
C - - - - - 0x01ECC9 07:ECB9: A9 06     LDA #con_prg_bank + $06
C - - - - - 0x01ECCB 07:ECBB: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01ECCE 07:ECBE: A2 02     LDX #con_screen_stage_clear
...
bra_ED0D:
C - - - - - 0x01ED1D 07:ED0D: A5 E9     LDA ram_stage_id
...
C - - - - - 0x01ED69 07:ED59: A5 00     LDA ram_0000_t63_counter
...
C - - - - - 0x01ED78 07:ED68: 85 00     STA ram_0000_t63_counter
...
C - - - - - 0x01ED80 07:ED70: D0 CC     BNE bra_ED3E_loop   ; jmp
bra_ED72:
...
C - - - - - 0x01ED8C 07:ED7C: 8D 30 06  STA ram_max_brightness_buffer + $10
C - - - - - 0x01ED8F 07:ED7F: A9 20     LDA #$20
C - - - - - 0x01ED91 07:ED81: 8D 21 06  STA ram_max_brightness_buffer + $01
C - - - - - 0x01ED94 07:ED84: 20 0E C1  JSR sub_C10E_enable_rendering
C - - - - - 0x01ED97 07:ED87: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01ED9A 07:ED8A: 20 E6 C1  JSR sub_C1E6_increase_brightness
C - - - - - 0x01ED9D 07:ED8D: A9 F0     LDA #con_se_cb__F0
C - - - - - 0x01ED9F 07:ED8F: 20 A0 FC  JSR sub_FCA0_play_sfx
; enable rendering
C - - - - - 0x01EDA2 07:ED92: E6 EE     INC ram_rendering_flag   ; -> 01
C - - - - - 0x01EDA4 07:ED94: 20 29 EF  JSR sub_EF29
; disable rendering
C - - - - - 0x01EDA7 07:ED97: A9 00     LDA #$00
C - - - - - 0x01EDA9 07:ED99: 85 EE     STA ram_rendering_flag
; 
C - - - - - 0x01EDAB 07:ED9B: A2 B4     LDX #$B4
C - - - - - 0x01EDAD 07:ED9D: 20 A6 FF  JSR sub_FFA6_wait_X_frms
...
C - - - - - 0x01EDD4 07:EDC4: 84 10     STY ram_0010_t07_counter
bra_EDC6_loop:
...
C - - - - - 0x01EDE0 07:EDD0: E6 10     INC ram_0010_t07_counter
...
C - - - - - 0x01EE3A 07:EE2A: 85 02     STA ram_0002_t18
bra_EE2C_loop:
C - - - - - 0x01EE3C 07:EE2C: A5 02     LDA ram_0002_t18
C - - - - - 0x01EE3E 07:EE2E: 0A        ASL
C - - - - - 0x01EE3F 07:EE2F: 0A        ASL
C - - - - - 0x01EE40 07:EE30: 85 03     STA ram_0003_t07_obj_index
...
C - - - - - 0x01EE51 07:EE41: E6 10     INC ram_0010_t07_counter
C - - - - - 0x01EE53 07:EE43: D0 4E     BNE bra_EE93    ; jmp
bra_EE45:
C - - - - - 0x01EE55 07:EE45: A9 01     LDA #$01
C - - - - - 0x01EE57 07:EE47: 85 04     STA ram_0004_t12_loop_counter
...
C - - - - - 0x01EE68 07:EE58: C6 04     DEC ram_0004_t12_loop_counter
C - - - - - 0x01EE6A 07:EE5A: 10 EF     BPL bra_EE4B_loop
C - - - - - 0x01EE6C 07:EE5C: B0 00     BCS bra_EE5E    ; bzk optimize, useless
bra_EE5E:
C - - - - - 0x01EE6E 07:EE5E: A6 02     LDX ram_0002_t18
C - - - - - 0x01EE70 07:EE60: BC C7 EF  LDY tbl_EFC7,X
C - - - - - 0x01EE73 07:EE63: A6 03     LDX ram_0003_t07_obj_index
bra_EE65_loop:
...
C - - - - - 0x01EE86 07:EE76: 99 7F 07  STA ram_ppu_buffer - $01,Y
...
bra_EE93:
C - - - - - 0x01EEA3 07:EE93: E6 02     INC ram_0002_t18
C - - - - - 0x01EEA5 07:EE95: A5 02     LDA ram_0002_t18
C - - - - - 0x01EEA7 07:EE97: C9 04     CMP #$04
C - - - - - 0x01EEA9 07:EE99: D0 91     BNE bra_EE2C_loop
; A = 04
C - - - - - 0x01EEAB 07:EE9B: 85 19     STA ram_buffer_ready_flag   ; ready
; 
C - - - - - 0x01EEAD 07:EE9D: A9 1A     LDA #con_sfx_1A
C - - - - - 0x01EEAF 07:EE9F: 20 A0 FC  JSR sub_FCA0_play_sfx
; 
C - - - - - 0x01EEB2 07:EEA2: A2 04     LDX #$04    ; wait 4 frames
C - - - - - 0x01EEB4 07:EEA4: A5 16     LDA ram_btn_hold
C - - - - - 0x01EEB6 07:EEA6: 29 80     AND #con_btn_A
C - - - - - 0x01EEB8 07:EEA8: F0 02     BEQ bra_EEAC
C - - - - - 0x01EEBA 07:EEAA: A2 01     LDX #$01    ; wait 1 frame
bra_EEAC:
C - - - - - 0x01EEBC 07:EEAC: 20 A6 FF  JSR sub_FFA6_wait_X_frms
C - - - - - 0x01EEBF 07:EEAF: A5 10     LDA ram_0010_t07_counter
C - - - - - 0x01EEC1 07:EEB1: C9 05     CMP #$05
C - - - - - 0x01EEC3 07:EEB3: F0 03     BEQ bra_EEB8_RTS
C - - - - - 0x01EEC5 07:EEB5: 4C C2 ED  JMP loc_EDC2_loop
bra_EEB8_RTS:
...
C - - - - - 0x01EF51 07:EF41: A9 04     LDA #$04
C - - - - - 0x01EF53 07:EF43: 85 97     STA ram_oam_index
                                       ;LDA #con_prg_bank + $04
C - - - - - 0x01EF55 07:EF45: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
...
C - - - - - 0x01EF5D 07:EF4D: 86 96     STX ram_0096_t06_obj_index
bra_EF4F_loop:
C - - - - - 0x01EF5F 07:EF4F: A9 00     LDA #$00
C - - - - - 0x01EF61 07:EF51: 85 10     STA ram_0010_t01_spr_A
C - - - - - 0x01EF63 07:EF53: 85 11     STA ram_0011_t01_00_or_01
C - - - - - 0x01EF65 07:EF55: BD A3 EF  LDA tbl_EFB3_spr_Y - $10,X
C - - - - - 0x01EF68 07:EF58: 85 12     STA ram_0012_t02_spr_Y
C - - - - - 0x01EF6A 07:EF5A: BD A8 EF  LDA tbl_EFB8_spr_X - $10,X
C - - - - - 0x01EF6D 07:EF5D: 85 13     STA ram_0013_t02_spr_X
C - - - - - 0x01EF6F 07:EF5F: 20 00 80  JSR sub_0x010010
C - - - - - 0x01EF72 07:EF62: E6 96     INC ram_0096_t06_obj_index
C - - - - - 0x01EF74 07:EF64: A6 96     LDX ram_0096_t06_obj_index
...
; in
    ; A = 
C - - - - - 0x01EFDB 07:EFCB: 85 54     STA ram_0054_t01_table_index
; disable rendering
C - - - - - 0x01EFDD 07:EFCD: A9 00     LDA #$00
C - - - - - 0x01EFDF 07:EFCF: 85 EE     STA ram_rendering_flag
; 
C - - - - - 0x01EFE1 07:EFD1: 20 EC C1  JSR sub_C1EC_decrease_brightness
C - - - - - 0x01EFE4 07:EFD4: A9 04     LDA #$04
C - - - - - 0x01EFE6 07:EFD6: 85 97     STA ram_oam_index
C - - - - - 0x01EFE8 07:EFD8: 20 BC C1  JSR sub_C1BC_hide_unused_sprites
C - - - - - 0x01EFEB 07:EFDB: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01EFEE 07:EFDE: 20 04 C1  JSR sub_C104_disable_rendering
; 
C - - - - - 0x01EFF1 07:EFE1: A9 20     LDA #$20    ; ppu hi
C - - - - - 0x01EFF3 07:EFE3: A2 00     LDX #$00    ; fill tile
C - - - - - 0x01EFF5 07:EFE5: A0 00     LDY #$00    ; fill attribute
C - - - - - 0x01EFF7 07:EFE7: 20 70 C1  JSR sub_C170_fill_nametable
; 
C - - - - - 0x01EFFA 07:EFEA: A9 06     LDA #con_prg_bank + $06
C - - - - - 0x01EFFC 07:EFEC: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01EFFF 07:EFEF: A5 54     LDA ram_0054_t01_table_index
C - - - - - 0x01F001 07:EFF1: 18        CLC
C - - - - - 0x01F002 07:EFF2: 69 03     ADC #con_screen___cutscene
...
C - - - - - 0x01F00A 07:EFFA: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01F00D 07:EFFD: A6 54     LDX ram_0054_t01_table_index
...
C - - - - - 0x01F01C 07:F00C: 85 01     STA ram_0000_t03_data_palette + $01
C - - - - - 0x01F01E 07:F00E: A9 00     LDA #< tbl_0x013010_palette
C - - - - - 0x01F020 07:F010: 85 00     STA ram_0000_t03_data_palette
...
C - - - - - 0x01F02C 07:F01C: 86 5A     STX ram_005A_t01_counter
bra_F01E_loop:
C - - - - - 0x01F02E 07:F01E: B1 00     LDA (ram_0000_t03_data_palette),Y
C - - - - - 0x01F030 07:F020: 9D 20 06  STA ram_max_brightness_buffer,X
...
C - - - - - 0x01F039 07:F029: A6 54     LDX ram_0054_t01_table_index
C - - - - - 0x01F03B 07:F02B: BC 96 F2  LDY tbl_F296_spr_data_index,X
; bzk optimize, useless BMI, no 80+ bytes in the table
C - - - - - 0x01F03E 07:F02E: 30 21     BMI bra_F051
C - - - - - 0x01F040 07:F030: 20 20 B1  JSR sub_0x013130_prepare_sprite_data_pointers
C - - - - - 0x01F043 07:F033: A0 00     LDY #$00
bra_F035_loop:
C - - - - - 0x01F045 07:F035: B1 00     LDA (ram_0000_t04_data_spr),Y
C - - - - - 0x01F047 07:F037: F0 18     BEQ bra_F051    ; if end token
C - - - - - 0x01F049 07:F039: 99 00 02  STA ram_spr_Y,Y
C - - - - - 0x01F04C 07:F03C: C8        INY
C - - - - - 0x01F04D 07:F03D: B1 00     LDA (ram_0000_t04_data_spr),Y
C - - - - - 0x01F04F 07:F03F: 99 00 02  STA ram_spr_T - $01,Y
C - - - - - 0x01F052 07:F042: C8        INY
C - - - - - 0x01F053 07:F043: B1 00     LDA (ram_0000_t04_data_spr),Y
C - - - - - 0x01F055 07:F045: 99 00 02  STA ram_spr_A - $02,Y
C - - - - - 0x01F058 07:F048: C8        INY
C - - - - - 0x01F059 07:F049: B1 00     LDA (ram_0000_t04_data_spr),Y
C - - - - - 0x01F05B 07:F04B: 99 00 02  STA ram_spr_X - $03,Y
C - - - - - 0x01F05E 07:F04E: C8        INY
C - - - - - 0x01F05F 07:F04F: D0 E4     BNE bra_F035_loop   ; jmp
bra_F051:
C - - - - - 0x01F061 07:F051: 84 55     STY ram_0055_t01_oam_index
C - - - - - 0x01F063 07:F053: 84 97     STY ram_oam_index
C - - - - - 0x01F065 07:F055: A4 54     LDY ram_0054_t01_table_index
C - - - - - 0x01F067 07:F057: BE 7C F2  LDX tbl_F27C,Y
C - - - - - 0x01F06A 07:F05A: 20 6B C2  JSR sub_C26B_write_chr_to_ppu
C - - - - - 0x01F06D 07:F05D: 20 0E C1  JSR sub_C10E_enable_rendering
C - - - - - 0x01F070 07:F060: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01F073 07:F063: A9 00     LDA #$00
C - - - - - 0x01F075 07:F065: AA        TAX ; 00
bra_F066_loop:
C - - - - - 0x01F076 07:F066: 9D 28 04  STA ram_0428_unk,X  ; including ram_0430_obj_animation
; including ram_0460_obj
    ; bzk optimize, useless judging by logs
C - - - - - 0x01F079 07:F069: 9D 58 04  STA ram_0458_unk,X
...
C - - - - - 0x01F0A7 07:F097: C6 0D     DEC ram_000D_t03_loop_counter
...
sub_F09C:
C - - - - - 0x01F0AC 07:F09C: 86 0E     STX ram_000E_t09_save_X
C - - - - - 0x01F0AE 07:F09E: 84 0F     STY ram_000F_t15_save_Y
C - - - - - 0x01F0B0 07:F0A0: A6 54     LDX ram_0054_t01_table_index
C - - - - - 0x01F0B2 07:F0A2: BD A3 F2  LDA tbl_F2A3_init_obj_index,X
C - - - - - 0x01F0B5 07:F0A5: F0 7C     BEQ bra_F123_skip
C - - - - - 0x01F0B7 07:F0A7: 85 08     STA ram_0008_t03_obj_index
C - - - - - 0x01F0B9 07:F0A9: BC B0 F2  LDY tbl_F2B0_table_index,X
C - - - - - 0x01F0BC 07:F0AC: 84 09     STY ram_0009_t02_table_index
...
C - - - - - 0x01F0D0 07:F0C0: E6 08     INC ram_0008_t03_obj_index
bra_F0C2:
...
C - - - - - 0x01F0E1 07:F0D1: E4 08     CPX ram_0008_t03_obj_index
C - - - - - 0x01F0E3 07:F0D3: D0 EF     BNE bra_F0C4_loop
C - - - - - 0x01F0E5 07:F0D5: A5 08     LDA ram_0008_t03_obj_index
C - - - - - 0x01F0E7 07:F0D7: 09 10     ORA #$10
C - - - - - 0x01F0E9 07:F0D9: 85 08     STA ram_0008_t04_max_obj_index
C - - - - - 0x01F0EB 07:F0DB: A9 04     LDA #con_prg_bank + $04
C - - - - - 0x01F0ED 07:F0DD: 20 CF FF  JSR sub_FFCF_prg_bankswitch
C - - - - - 0x01F0F0 07:F0E0: A5 55     LDA ram_0055_t01_oam_index
C - - - - - 0x01F0F2 07:F0E2: 85 97     STA ram_oam_index
C - - - - - 0x01F0F4 07:F0E4: 20 BC C1  JSR sub_C1BC_hide_unused_sprites
C - - - - - 0x01F0F7 07:F0E7: A2 10     LDX #$10
C - - - - - 0x01F0F9 07:F0E9: 86 96     STX ram_0096_t01_obj_index
bra_F0EB_loop:
C - - - - - 0x01F0FB 07:F0EB: A4 09     LDY ram_0009_t02_table_index
C - - - - - 0x01F0FD 07:F0ED: A9 00     LDA #$00
C - - - - - 0x01F0FF 07:F0EF: 85 10     STA ram_0010_t01_spr_A
C - - - - - 0x01F101 07:F0F1: 85 11     STA ram_0011_t01_00_or_01
C - - - - - 0x01F103 07:F0F3: B9 C7 F2  LDA tbl_F2C7_spr_Y,Y
C - - - - - 0x01F106 07:F0F6: 85 12     STA ram_0012_t02_spr_Y
C - - - - - 0x01F108 07:F0F8: B9 D1 F2  LDA tbl_F2D1_spr_X,Y
C - - - - - 0x01F10B 07:F0FB: 85 13     STA ram_0013_t02_spr_X
C - - - - - 0x01F10D 07:F0FD: 20 00 80  JSR sub_0x010010
C - - - - - 0x01F110 07:F100: A6 96     LDX ram_0096_t01_obj_index
C - - - - - 0x01F112 07:F102: BD 30 04  LDA ram_0430_obj_animation,X
C - - - - - 0x01F115 07:F105: C9 1B     CMP #$1B
C - - - - - 0x01F117 07:F107: D0 10     BNE bra_F119
C - - - - - 0x01F119 07:F109: A5 5A     LDA ram_005A_t01_counter
C - - - - - 0x01F11B 07:F10B: F0 07     BEQ bra_F114
C - - - - - 0x01F11D 07:F10D: BD 18 04  LDA ram_obj_animation_cnt,X
C - - - - - 0x01F120 07:F110: C9 09     CMP #$09
C - - - - - 0x01F122 07:F112: D0 05     BNE bra_F119
bra_F114:
C - - - - - 0x01F124 07:F114: A9 00     LDA #$00
C - - - - - 0x01F126 07:F116: 9D 48 04  STA ram_0448_obj,X
bra_F119:
C - - - - - 0x01F129 07:F119: E6 96     INC ram_0096_t01_obj_index
C - - - - - 0x01F12B 07:F11B: E6 09     INC ram_0009_t02_table_index
C - - - - - 0x01F12D 07:F11D: A6 96     LDX ram_0096_t01_obj_index
C - - - - - 0x01F12F 07:F11F: E4 08     CPX ram_0008_t04_max_obj_index
C - - - - - 0x01F131 07:F121: D0 C8     BNE bra_F0EB_loop
bra_F123_skip:
C - - - - - 0x01F133 07:F123: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01F136 07:F126: A5 9B     LDA ram_prg_bank
; A = 
    ; con_prg_bank + $00
    ; con_prg_bank + $01
    ; con_prg_bank + $02
C - - - - - 0x01F138 07:F128: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01F13B 07:F12B: A6 0E     LDX ram_000E_t09_save_X
C - - - - - 0x01F13D 07:F12D: A4 0F     LDY ram_000F_t15_save_Y
C - - - - - 0x01F13F 07:F12F: 60        RTS



sub_F130:
C - - - - - 0x01F140 07:F130: A9 00     LDA #$00
C - - - - - 0x01F142 07:F132: 85 56     STA ram_0056_t01_data_index
C - - - - - 0x01F144 07:F134: 85 57     STA ram_0057_t01_table_index
                                       ;LDA #con_prg_bank + $00
C - - - - - 0x01F146 07:F136: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01F149 07:F139: A6 54     LDX ram_0054_t01_table_index
C - - - - - 0x01F14B 07:F13B: BD 00 B5  LDA tbl_0x003510_cutscene_text_lo,X
C - - - - - 0x01F14E 07:F13E: 85 58     STA ram_0058_t01_cutscene_text_data
C - - - - - 0x01F150 07:F140: BD 0E B5  LDA tbl_0x00351E_cutscene_text_hi,X
C - - - - - 0x01F153 07:F143: 85 59     STA ram_0058_t01_cutscene_text_data + $01
; bzk optimize, useless STA after 0x01F167 optimization
C - - - - - 0x01F155 07:F145: 85 5B     STA ram_005B_t01_data_ptr_hi
loc_F147_loop:
C D 3 - - - 0x01F157 07:F147: A6 57     LDX ram_0057_t01_table_index
...
loc_F155_loop:
C D 3 - - - 0x01F165 07:F155: A2 00     LDX #$00        ; buffer index
bra_F157_loop:
; bzk optimize, delete this code up to 0x01F173,
; uncomment suggeted code below instead
C - - - - - 0x01F167 07:F157: A5 5B     LDA ram_005B_t01_data_ptr_hi
C - - - - - 0x01F169 07:F159: 85 59     STA ram_0058_t01_cutscene_text_data + $01
C - - - - - 0x01F16B 07:F15B: A4 56     LDY ram_0056_t01_data_index
C - - - - - 0x01F16D 07:F15D: E6 56     INC ram_0056_t01_data_index
C - - - - - 0x01F16F 07:F15F: D0 02     BNE bra_F163_not_overflow
; if overflow
C - - - - - 0x01F171 07:F161: E6 5B     INC ram_005B_t01_data_ptr_hi
bra_F163_not_overflow:
C - - - - - 0x01F173 07:F163: B1 58     LDA (ram_0058_t01_cutscene_text_data),Y
                                       ;LDY ram_0056_t01_data_index
                                       ;LDA (ram_0058_t01_cutscene_text_data),Y
                                       ;INC ram_0056_t01_data_index
                                       ;BNE bra_F165_not_overflow
; if overflow
                                       ;INC ram_0058_t01_cutscene_text_data + $01
;bra_F165_not_overflow:
; bzk optimize, useless check, no such byte in data
C - - - - - 0x01F175 07:F165: C9 0F     CMP #$0F
C - - - - - 0x01F177 07:F167: F0 0A     BEQ bra_F173_0F
; see con_ct_cb
C - - - - - 0x01F179 07:F169: C9 FD     CMP #con_ct_cb_control_bytes
C - - - - - 0x01F17B 07:F16B: B0 5F     BCS bra_F1CC_FD_FF
; bzk optimize, useless checks, no remaining bytes are 3F+.
; delete leftover japanese garbage code from 0x01F17D up to 0x01F193
C - - - - - 0x01F17D 07:F16D: C9 80     CMP #$80
C - - - - - 0x01F17F 07:F16F: 90 14     BCC bra_F185_00_7F
- - - - - - 0x01F181 07:F171: B0 0A     BCS bra_F17D_80_FC    ; jmp
...
; bzk optimize, useless BNE after deleting garbage below
C - - - - - 0x01F198 07:F188: D0 03     BNE bra_F18D    ; jmp


; bzk garbage
- - - - - - 0x01F19A 07:F18A: E8        INX
- - - - - - 0x01F19B 07:F18B: D0 CA     BNE bra_F157_loop   ; jmp
...
C - - - - - 0x01F1A5 07:F195: 85 19     STA ram_buffer_ready_flag   ; ready
; 
C - - - - - 0x01F1A7 07:F197: A9 04     LDA #$04
C - - - - - 0x01F1A9 07:F199: 85 0D     STA ram_000D_t04_loop_counter
bra_F19B_loop:
C - - - - - 0x01F1AB 07:F19B: 20 9C F0  JSR sub_F09C
C - - - - - 0x01F1AE 07:F19E: A5 54     LDA ram_0054_t01_table_index
...
C - - - - - 0x01F1C8 07:F1B8: C6 0D     DEC ram_000D_t04_loop_counter
...
C - - - - - 0x01F1D6 07:F1C6: 4C 55 F1  JMP loc_F155_loop
bra_F1C9_exit_cutscene:
bra_F1C9_FF:
C - - - - - 0x01F1D9 07:F1C9: E6 5A     INC ram_005A_t01_counter
C - - - - - 0x01F1DB 07:F1CB: 60        RTS
bra_F1CC_FD_FF:
C - - - - - 0x01F1DC 07:F1CC: C9 FF     CMP #con_ct_cb_end_of_cutscene
C - - - - - 0x01F1DE 07:F1CE: F0 F9     BEQ bra_F1C9_FF
C - - - - - 0x01F1E0 07:F1D0: E6 57     INC ram_0057_t01_table_index
C - - - - - 0x01F1E2 07:F1D2: C9 FD     CMP #con_ct_cb_new_line
C - - - - - 0x01F1E4 07:F1D4: D0 03     BNE bra_F1D9
C - - - - - 0x01F1E6 07:F1D6: 4C 47 F1  JMP loc_F147_loop
bra_F1D9:
; con_ct_cb_wait_for_input
; draw/hide cursor
...
C - - - - - 0x01F204 07:F1F4: 85 0D     STA ram_000D_t05_blinging_cursor_frm_cnt
loc_F1F6_loop:
...
C - - - - - 0x01F20C 07:F1FC: A5 0D     LDA ram_000D_t05_blinging_cursor_frm_cnt
C - - - - - 0x01F20E 07:F1FE: E6 0D     INC ram_000D_t05_blinging_cursor_frm_cnt
...
C - - - - - 0x01F21D 07:F20D: E6 19     INC ram_buffer_ready_flag   ; -> 01 (ready)
C - - - - - 0x01F21F 07:F20F: 20 9C F0  JSR sub_F09C
C - - - - - 0x01F222 07:F212: 4C F6 F1  JMP loc_F1F6_loop
bra_F215_continue_cutscene:
C - - - - - 0x01F225 07:F215: A4 56     LDY ram_0056_t01_data_index
C - - - - - 0x01F227 07:F217: B1 58     LDA (ram_0058_t01_cutscene_text_data),Y
C - - - - - 0x01F229 07:F219: 30 AE     BMI bra_F1C9_FF
C - - - - - 0x01F22B 07:F21B: A9 00     LDA #$00
C - - - - - 0x01F22D 07:F21D: 85 57     STA ram_0057_t01_table_index
...
C - - - - - 0x01F25D 07:F24D: 86 19     STX ram_buffer_ready_flag   ; ready
...
C - - - - - 0x01F27A 07:F26A: E6 19     INC ram_buffer_ready_flag   ; -> 00 (not ready)
C - - - - - 0x01F27C 07:F26C: 20 9C F0  JSR sub_F09C
C - - - - - 0x01F27F 07:F26F: 4C 47 F1  JMP loc_F147_loop
...
tbl_F2B0_table_index:
; indexes for 0x01F2D7 and 0x01F2E1
...
C - - - - - 0x01F2ED 07:F2DD: 85 EE     STA ram_rendering_flag
; 
C - - - - - 0x01F2EF 07:F2DF: A9 04     LDA #$04
C - - - - - 0x01F2F1 07:F2E1: 85 97     STA ram_oam_index
...
C - - - - - 0x01F2FB 07:F2EB: 20 EC C1  JSR sub_C1EC_decrease_brightness
C - - - - - 0x01F2FE 07:F2EE: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01F301 07:F2F1: 20 04 C1  JSR sub_C104_disable_rendering
; 
C - - - - - 0x01F304 07:F2F4: A9 20     LDA #$20    ; ppu hi
C - - - - - 0x01F306 07:F2F6: A2 00     LDX #$00    ; fill tile
C - - - - - 0x01F308 07:F2F8: A0 00     LDY #$00    ; fill attribute
C - - - - - 0x01F30A 07:F2FA: 20 70 C1  JSR sub_C170_fill_nametable
; 
...
C - - - - - 0x01F314 07:F304: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01F317 07:F307: A2 10     LDX #con_screen_copyrights
...
C - - - - - 0x01F321 07:F311: 9D 20 06  STA ram_max_brightness_buffer,X
C - - - - - 0x01F324 07:F314: 9D 30 06  STA ram_max_brightness_buffer + $10,X
C - - - - - 0x01F327 07:F317: CA        DEX
C - - - - - 0x01F328 07:F318: 10 F4     BPL bra_F30E_loop
C - - - - - 0x01F32A 07:F31A: 20 0E C1  JSR sub_C10E_enable_rendering
C - - - - - 0x01F32D 07:F31D: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01F330 07:F320: 20 E6 C1  JSR sub_C1E6_increase_brightness
C - - - - - 0x01F333 07:F323: A2 5A     LDX #$5A
C - - - - - 0x01F335 07:F325: 20 A6 FF  JSR sub_FFA6_wait_X_frms
C - - - - - 0x01F338 07:F328: 20 EC C1  JSR sub_C1EC_decrease_brightness
C - - - - - 0x01F33B 07:F32B: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01F33E 07:F32E: 20 04 C1  JSR sub_C104_disable_rendering
; 
C - - - - - 0x01F341 07:F331: A9 20     LDA #$20    ; ppu hi
C - - - - - 0x01F343 07:F333: A2 00     LDX #$00    ; fill tile
C - - - - - 0x01F345 07:F335: A0 FF     LDY #$FF    ; fill attribute
C - - - - - 0x01F347 07:F337: 20 70 C1  JSR sub_C170_fill_nametable
; 
...
C - - - - - 0x01F351 07:F341: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01F354 07:F344: A2 00     LDX #con_screen_title
...
C - - - - - 0x01F35E 07:F34E: 99 20 06  STA ram_max_brightness_buffer,Y
...
C - - - - - 0x01F386 07:F376: 85 54     STA ram_0054_tFF_useless_5C
C - - - - - 0x01F388 07:F378: 85 97     STA ram_oam_index
C - - - - - 0x01F38A 07:F37A: 20 0E C1  JSR sub_C10E_enable_rendering
C - - - - - 0x01F38D 07:F37D: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01F390 07:F380: 20 E6 C1  JSR sub_C1E6_increase_brightness
C - - - - - 0x01F393 07:F383: 20 D1 F3  JSR sub_F3D1
C - - - - - 0x01F396 07:F386: A9 00     LDA #$00
; bzk optimize, useless STA
C - - - - - 0x01F398 07:F388: 85 0E     STA ram_000E_tFF_useless
                                       ;LDA #con_music_title_screen
C - - - - - 0x01F39A 07:F38A: 20 9E FC  JSR sub_FC9E_play_music
bra_F38D_loop:
C - - - - - 0x01F39D 07:F38D: 20 EB F3  JSR sub_F3EB
C - - - - - 0x01F3A0 07:F390: 20 AD FF  JSR sub_FFAD_wait_1_frm
...
C - - - - - 0x01F3B1 07:F3A1: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
...
C - - - - - 0x01F3BE 07:F3AE: 20 A6 FF  JSR sub_FFA6_wait_X_frms
...
C - - - - - 0x01F3C8 07:F3B8: 85 54     STA ram_0054_t01_table_index
bra_F3BA_loop:
C - - - - - 0x01F3CA 07:F3BA: A5 54     LDA ram_0054_t01_table_index
...
C - - - - - 0x01F3D5 07:F3C5: E6 54     INC ram_0054_t01_table_index
C - - - - - 0x01F3D7 07:F3C7: A5 54     LDA ram_0054_t01_table_index
...
sub_F3EB:
; bzk optimize, always 5C
C - - - - - 0x01F3FB 07:F3EB: A5 54     LDA ram_0054_tFF_useless_5C
C - - - - - 0x01F3FD 07:F3ED: 85 97     STA ram_oam_index
C - - - - - 0x01F3FF 07:F3EF: 20 BC C1  JSR sub_C1BC_hide_unused_sprites
C - - - - - 0x01F402 07:F3F2: A9 04     LDA #con_prg_bank + $04
C - - - - - 0x01F404 07:F3F4: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01F407 07:F3F7: A2 10     LDX #$10
C - - - - - 0x01F409 07:F3F9: 86 96     STX ram_0096_t04_obj_index
bra_F3FB_loop:
C - - - - - 0x01F40B 07:F3FB: A6 96     LDX ram_0096_t04_obj_index
C - - - - - 0x01F40D 07:F3FD: A9 00     LDA #$00
C - - - - - 0x01F40F 07:F3FF: 85 10     STA ram_0010_t01_spr_A
C - - - - - 0x01F411 07:F401: 85 11     STA ram_0011_t01_00_or_01
C - - - - - 0x01F413 07:F403: BD 88 F4  LDA tbl_F498_spr_Y - $10,X
C - - - - - 0x01F416 07:F406: 85 12     STA ram_0012_t02_spr_Y
C - - - - - 0x01F418 07:F408: BD 8E F4  LDA tbl_F49E_spr_X - $10,X
C - - - - - 0x01F41B 07:F40B: 85 13     STA ram_0013_t02_spr_X
C - - - - - 0x01F41D 07:F40D: 20 00 80  JSR sub_0x010010
C - - - - - 0x01F420 07:F410: E6 96     INC ram_0096_t04_obj_index
C - - - - - 0x01F422 07:F412: A6 96     LDX ram_0096_t04_obj_index
...
C - - - - - 0x01F42B 07:F41B: 85 EE     STA ram_rendering_flag
; 
C - - - - - 0x01F42D 07:F41D: 20 EC C1  JSR sub_C1EC_decrease_brightness
C - - - - - 0x01F430 07:F420: A9 04     LDA #$04
C - - - - - 0x01F432 07:F422: 85 97     STA ram_oam_index
C - - - - - 0x01F434 07:F424: 20 BC C1  JSR sub_C1BC_hide_unused_sprites
C - - - - - 0x01F437 07:F427: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01F43A 07:F42A: 20 04 C1  JSR sub_C104_disable_rendering
; 
C - - - - - 0x01F43D 07:F42D: A9 20     LDA #$20    ; ppu hi
C - - - - - 0x01F43F 07:F42F: A2 00     LDX #$00    ; fill tile
C - - - - - 0x01F441 07:F431: A0 00     LDY #$00    ; fill attribute
...
C - - - - - 0x01F44B 07:F43B: 20 70 C1  JSR sub_C170_fill_nametable
; 
...
C - - - - - 0x01F455 07:F445: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01F458 07:F448: A5 E9     LDA ram_stage_id
C - - - - - 0x01F45A 07:F44A: 18        CLC
C - - - - - 0x01F45B 07:F44B: 69 12     ADC #con_screen___stage
...
C - - - - - 0x01F466 07:F456: 99 20 06  STA ram_max_brightness_buffer,Y
C - - - - - 0x01F469 07:F459: 99 30 06  STA ram_max_brightness_buffer + $10,Y
C - - - - - 0x01F46C 07:F45C: 88        DEY
C - - - - - 0x01F46D 07:F45D: 10 F4     BPL bra_F453_loop
C - - - - - 0x01F46F 07:F45F: 20 0E C1  JSR sub_C10E_enable_rendering
C - - - - - 0x01F472 07:F462: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01F475 07:F465: 20 E6 C1  JSR sub_C1E6_increase_brightness
...
C - - - - - 0x01F47F 07:F46F: 4C A6 FF  JMP loc_FFA6_wait_X_frms
...
loc_F4A4:
C D 3 - - - 0x01F4B4 07:F4A4: A9 F0     LDA #con_se_cb__F0
C - - - - - 0x01F4B6 07:F4A6: 20 A0 FC  JSR sub_FCA0_play_sfx
C - - - - - 0x01F4B9 07:F4A9: A9 05     LDA #$05
C - - - - - 0x01F4BB 07:F4AB: 85 54     STA ram_0054_t01_table_index
bra_F4AD_loop:
C - - - - - 0x01F4BD 07:F4AD: A5 54     LDA ram_0054_t01_table_index
C - - - - - 0x01F4BF 07:F4AF: 20 CB EF  JSR sub_EFCB
C - - - - - 0x01F4C2 07:F4B2: E6 54     INC ram_0054_t01_table_index
C - - - - - 0x01F4C4 07:F4B4: A5 54     LDA ram_0054_t01_table_index
C - - - - - 0x01F4C6 07:F4B6: C9 08     CMP #$08
C - - - - - 0x01F4C8 07:F4B8: D0 F3     BNE bra_F4AD_loop
loc_F4BA:
C D 3 - - - 0x01F4CA 07:F4BA: 20 AD FF  JSR sub_FFAD_wait_1_frm
...
C - - - - - 0x01F4D2 07:F4C2: 85 EE     STA ram_rendering_flag
; 
C - - - - - 0x01F4D4 07:F4C4: A9 04     LDA #$04
C - - - - - 0x01F4D6 07:F4C6: 85 97     STA ram_oam_index
C - - - - - 0x01F4D8 07:F4C8: 20 BC C1  JSR sub_C1BC_hide_unused_sprites
C - - - - - 0x01F4DB 07:F4CB: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01F4DE 07:F4CE: 20 04 C1  JSR sub_C104_disable_rendering
; 
C - - - - - 0x01F4E1 07:F4D1: A9 20     LDA #$20    ; ppu hi
C - - - - - 0x01F4E3 07:F4D3: A2 00     LDX #$00    ; fill tile
C - - - - - 0x01F4E5 07:F4D5: A0 00     LDY #$00    ; fill attribute
C - - - - - 0x01F4E7 07:F4D7: 20 70 C1  JSR sub_C170_fill_nametable
; 
...
C - - - - - 0x01F4F1 07:F4E1: 20 CD FF  JSR sub_FFCD_prg_bankswitch_with_backup
C - - - - - 0x01F4F4 07:F4E4: A2 11     LDX #con_screen_game_over
...
C - - - - - 0x01F4FE 07:F4EE: 9D 20 06  STA ram_max_brightness_buffer,X
...
C - - - - - 0x01F522 07:F512: 20 0E C1  JSR sub_C10E_enable_rendering
C - - - - - 0x01F525 07:F515: 20 AD FF  JSR sub_FFAD_wait_1_frm
C - - - - - 0x01F528 07:F518: 20 E6 C1  JSR sub_C1E6_increase_brightness
...
C - - - - - 0x01F532 07:F522: 85 10     STA ram_0010_t08_cursor_position
loc_F524_loop:
...
C - - - - - 0x01F540 07:F530: A5 10     LDA ram_0010_t08_cursor_position
C - - - - - 0x01F542 07:F532: 49 01     EOR #$01
C - - - - - 0x01F544 07:F534: 85 10     STA ram_0010_t08_cursor_position
...
C - - - - - 0x01F57A 07:F56A: A5 10     LDA ram_0010_t08_cursor_position
C - - - - - 0x01F57C 07:F56C: D0 02     BNE bra_F570
; 00
C - - - - - 0x01F57E 07:F56E: 85 E9     STA ram_stage_id
bra_F570:
C - - - - - 0x01F580 07:F570: A9 00     LDA #$00
C - - - - - 0x01F582 07:F572: 85 53     STA ram_0053_flag
; clear score
...
C - - - - - 0x01F58C 07:F57C: A5 10     LDA ram_0010_t08_cursor_position
...
; bzk garbage
- - - - - - 0x01F598 07:F588: A5 10     LDA ram_0010_temp
...
C - - - - - 0x01F613 07:F603: 85 02     STA ram_0002_t19_pos_X_lo
C - - - - - 0x01F615 07:F605: AD 40 03  LDA ram_pos_X_hi
C - - - - - 0x01F618 07:F608: 85 03     STA ram_0003_t13_pos_X_hi
C - - - - - 0x01F61A 07:F60A: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01F61D 07:F60D: 09 40     ORA #$40
C - - - - - 0x01F61F 07:F60F: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x01F635 07:F625: E5 02     SBC ram_0002_t19_pos_X_lo
C - - - - - 0x01F637 07:F627: 85 02     STA ram_0002_t20_pos_X_lo
C - - - - - 0x01F639 07:F629: AD 40 03  LDA ram_pos_X_hi
C - - - - - 0x01F63C 07:F62C: E5 03     SBC ram_0003_t13_pos_X_hi
C - - - - - 0x01F63E 07:F62E: 05 02     ORA ram_0002_t20_pos_X_lo
...
C - - - - - 0x01F64A 07:F63A: A5 10     LDA ram_0010_t02
...
C - - - - - 0x01F677 07:F667: 85 11     STA ram_0011_t04_pos_Y_lo
...
C - - - - - 0x01F688 07:F678: 85 02     STA ram_0002_t21_pos_X_lo
C - - - - - 0x01F68A 07:F67A: AD 40 03  LDA ram_pos_X_hi
C - - - - - 0x01F68D 07:F67D: 85 03     STA ram_0003_t14_pos_X_hi
C - - - - - 0x01F68F 07:F67F: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01F692 07:F682: 29 BF     AND #$40 ^ $FF
C - - - - - 0x01F694 07:F684: 9D 00 04  STA ram_0400_obj_flags,X
...
C - - - - - 0x01F6A3 07:F693: A5 12     LDA ram_0012_t03_pos_X_lo
...
C - - - - - 0x01F6AD 07:F69D: E5 02     SBC ram_0002_t21_pos_X_lo
C - - - - - 0x01F6AF 07:F69F: 85 02     STA ram_0002_t22_pos_X_lo
C - - - - - 0x01F6B1 07:F6A1: AD 40 03  LDA ram_pos_X_hi
C - - - - - 0x01F6B4 07:F6A4: E5 03     SBC ram_0003_t14_pos_X_hi
C - - - - - 0x01F6B6 07:F6A6: 05 02     ORA ram_0002_t22_pos_X_lo
...
C - - - - - 0x01F6C4 07:F6B4: A5 10     LDA ram_0010_t02
...
bra_F6DD:
C - - - - - 0x01F6ED 07:F6DD: A5 06     LDA ram_0006_t03
C - - - - - 0x01F6EF 07:F6DF: 29 0F     AND #$0F
C - - - - - 0x01F6F1 07:F6E1: 85 00     STA ram_0000_t64
C - - - - - 0x01F6F3 07:F6E3: A5 12     LDA ram_0012_t03_pos_X_lo
C - - - - - 0x01F6F5 07:F6E5: 49 0F     EOR #$0F
C - - - - - 0x01F6F7 07:F6E7: 29 0F     AND #$0F
C - - - - - 0x01F6F9 07:F6E9: 38        SEC
C - - - - - 0x01F6FA 07:F6EA: E5 00     SBC ram_0000_t64
C - - - - - 0x01F6FC 07:F6EC: 90 ED     BCC bra_F6DB
C - - - - - 0x01F6FE 07:F6EE: B0 0F     BCS bra_F6FF   ; jmp
bra_F6F0:
C - - - - - 0x01F700 07:F6F0: A5 06     LDA ram_0006_t03
C - - - - - 0x01F702 07:F6F2: 29 0F     AND #$0F
C - - - - - 0x01F704 07:F6F4: 85 00     STA ram_0000_t65
C - - - - - 0x01F706 07:F6F6: A5 12     LDA ram_0012_t03_pos_X_lo
C - - - - - 0x01F708 07:F6F8: 29 0F     AND #$0F
C - - - - - 0x01F70A 07:F6FA: 38        SEC
C - - - - - 0x01F70B 07:F6FB: E5 00     SBC ram_0000_t65
C - - - - - 0x01F70D 07:F6FD: 90 DC     BCC bra_F6DB
; C = 1
bra_F6FF:   ; C = 1
; bzk optimize, useless STA
C - - - - - 0x01F70F 07:F6FF: 85 11     STA ram_0011_tFD_useless
; bzk optimize, JSR to 0x01E6E4
C - - - - - 0x01F711 07:F701: 20 D3 E6  JSR sub_E6D3
C - - - - - 0x01F714 07:F704: 38        SEC
C - - - - - 0x01F715 07:F705: 60        RTS
bra_F706:
C - - - - - 0x01F716 07:F706: A5 11     LDA ram_0011_t03_pos_X_lo
C - - - - - 0x01F718 07:F708: 29 0F     AND #$0F
C - - - - - 0x01F71A 07:F70A: 85 00     STA ram_0000_t66
; 
C - - - - - 0x01F71C 07:F70C: A5 12     LDA ram_0012_t03_pos_X_lo
C - - - - - 0x01F71E 07:F70E: 29 0F     AND #$0F
C - - - - - 0x01F720 07:F710: 38        SEC
C - - - - - 0x01F721 07:F711: E5 00     SBC ram_0000_t66
C - - - - - 0x01F723 07:F713: B0 C6     BCS bra_F6DB
C - - - - - 0x01F725 07:F715: 90 11     BCC bra_F728
bra_F717:
C - - - - - 0x01F727 07:F717: A5 11     LDA ram_0011_t03_pos_X_lo
C - - - - - 0x01F729 07:F719: 29 0F     AND #$0F
C - - - - - 0x01F72B 07:F71B: 85 00     STA ram_0000_t67
; 
C - - - - - 0x01F72D 07:F71D: A5 12     LDA ram_0012_t03_pos_X_lo
C - - - - - 0x01F72F 07:F71F: 49 0F     EOR #$0F
C - - - - - 0x01F731 07:F721: 29 0F     AND #$0F
C - - - - - 0x01F733 07:F723: 38        SEC
C - - - - - 0x01F734 07:F724: E5 00     SBC ram_0000_t67
C - - - - - 0x01F736 07:F726: B0 B3     BCS bra_F6DB
bra_F728:
C - - - - - 0x01F738 07:F728: 49 FF     EOR #$FF
C - - - - - 0x01F73A 07:F72A: 69 01     ADC #$01
C - - - - - 0x01F73C 07:F72C: 85 11     STA ram_0011_t04_pos_Y_lo
...
C - - - - - 0x01F749 07:F739: 85 02     STA ram_0002_t23
C - - - - - 0x01F74B 07:F73B: B0 04     BCS bra_F741
C - - - - - 0x01F74D 07:F73D: E9 0F     SBC #$0F
C - - - - - 0x01F74F 07:F73F: 85 02     STA ram_0002_t23
bra_F741:
...
C - - - - - 0x01F75D 07:F74D: A5 11     LDA ram_0011_t04_pos_Y_lo
...
C - - - - - 0x01F76E 07:F75E: E5 02     SBC ram_0002_t23
...
C - - - - - 0x01F77C 07:F76C: A5 10     LDA ram_0010_t02
...
bra_F777:
C - - - - - 0x01F787 07:F777: A4 05     LDY ram_0005_t03_array_index
...
C - - - - - 0x01F796 07:F786: A5 11     LDA ram_0011_t04_pos_Y_lo
C - - - - - 0x01F798 07:F788: 29 0F     AND #$0F
C - - - - - 0x01F79A 07:F78A: 85 00     STA ram_0000_t68
C - - - - - 0x01F79C 07:F78C: A5 06     LDA ram_0006_t02_pos_X_lo
C - - - - - 0x01F79E 07:F78E: 49 0F     EOR #$0F
C - - - - - 0x01F7A0 07:F790: 29 0F     AND #$0F
C - - - - - 0x01F7A2 07:F792: 38        SEC
C - - - - - 0x01F7A3 07:F793: E5 00     SBC ram_0000_t68
C - - - - - 0x01F7A5 07:F795: 90 18     BCC bra_F7AF
C - - - - - 0x01F7A7 07:F797: B0 0F     BCS bra_F7A8   ; jmp
bra_F799:
C - - - - - 0x01F7A9 07:F799: A5 11     LDA ram_0011_t04_pos_Y_lo
C - - - - - 0x01F7AB 07:F79B: 29 0F     AND #$0F
C - - - - - 0x01F7AD 07:F79D: 85 00     STA ram_0000_t69
C - - - - - 0x01F7AF 07:F79F: A5 12     LDA ram_0012_t01_pos_X_lo
C - - - - - 0x01F7B1 07:F7A1: 29 0F     AND #$0F
C - - - - - 0x01F7B3 07:F7A3: 38        SEC
C - - - - - 0x01F7B4 07:F7A4: E5 00     SBC ram_0000_t69
C - - - - - 0x01F7B6 07:F7A6: 90 07     BCC bra_F7AF
; C = 1
bra_F7A8:   ; C = 1
; bzk optimize, useless STA
C - - - - - 0x01F7B8 07:F7A8: 85 11     STA ram_0011_tFC_useless
; bzk optimize, JSR to 0x01E6E4
...
C - - - - - 0x01F7C7 07:F7B7: 85 02     STA ram_0002_t24
C - - - - - 0x01F7C9 07:F7B9: B0 04     BCS bra_F7BF
C - - - - - 0x01F7CB 07:F7BB: E9 0F     SBC #$0F
C - - - - - 0x01F7CD 07:F7BD: 85 02     STA ram_0002_t24
bra_F7BF:
...
C - - - - - 0x01F7E9 07:F7D9: E5 02     SBC ram_0002_t24
...
C - - - - - 0x01F7F7 07:F7E7: A5 10     LDA ram_0010_t02
...
bra_F7F2:
C - - - - - 0x01F802 07:F7F2: A4 05     LDY ram_0005_t03_array_index
...
C - - - - - 0x01F811 07:F801: A5 11     LDA ram_0011_t04_pos_Y_lo
C - - - - - 0x01F813 07:F803: 29 0F     AND #$0F
C - - - - - 0x01F815 07:F805: 85 00     STA ram_0000_t70
C - - - - - 0x01F817 07:F807: A5 12     LDA ram_0012_t01_pos_X_lo
C - - - - - 0x01F819 07:F809: 29 0F     AND #$0F
C - - - - - 0x01F81B 07:F80B: 38        SEC
C - - - - - 0x01F81C 07:F80C: E5 00     SBC ram_0000_t70
C - - - - - 0x01F81E 07:F80E: 90 13     BCC bra_F823
C - - - - - 0x01F820 07:F810: B0 1C     BCS bra_F82E_RTS   ; jmp
bra_F812:
C - - - - - 0x01F822 07:F812: A5 11     LDA ram_0011_t04_pos_Y_lo
C - - - - - 0x01F824 07:F814: 29 0F     AND #$0F
C - - - - - 0x01F826 07:F816: 85 00     STA ram_0000_t71
C - - - - - 0x01F828 07:F818: A5 06     LDA ram_0006_t02_pos_X_lo
C - - - - - 0x01F82A 07:F81A: 49 0F     EOR #$0F
C - - - - - 0x01F82C 07:F81C: 29 0F     AND #$0F
C - - - - - 0x01F82E 07:F81E: 38        SEC
C - - - - - 0x01F82F 07:F81F: E5 00     SBC ram_0000_t71
C - - - - - 0x01F831 07:F821: B0 0B     BCS bra_F82E_RTS
bra_F823:
C - - - - - 0x01F833 07:F823: 49 FF     EOR #$FF
C - - - - - 0x01F835 07:F825: 69 01     ADC #$01
C - - - - - 0x01F837 07:F827: 85 11     STA ram_0011_t04_pos_Y_lo
...
C - - - - - 0x01F8EF 07:F8DF: A5 50     LDA ram_stage_config
...
C - - - - - 0x01F915 07:F905: A5 50     LDA ram_stage_config
...
C - - - - - 0x01F94E 07:F93E: A5 50     LDA ram_stage_config
...
C - - - - - 0x01F974 07:F964: A5 50     LDA ram_stage_config
...
C - - - - - 0x01F984 07:F974: E5 99     SBC ram_0099_spd_Y_lo
...
C - - - - - 0x01F997 07:F987: BD 30 04  LDA ram_0430_obj_animation,X
...
sub_F999_set_spd_Y_FFC0:
sub_0x01F9A9_set_spd_Y_FFC0:
...
- - - - - - 0x01F9B8 07:F9A8: E5 10     SBC ram_0010_temp
...
- - - - - - 0x01F9CC 07:F9BC: 65 10     ADC ram_0010_temp
...
- - - - - - 0x01F9DA 07:F9CA: A5 02     LDA ram_0002_temp
- - - - - - 0x01F9DC 07:F9CC: FD 30 03  SBC ram_pos_X_lo,X
- - - - - - 0x01F9DF 07:F9CF: A5 03     LDA ram_0003_temp
...
- - - - - - 0x01F9E9 07:F9D9: E5 11     SBC ram_0011_temp
...
- - - - - - 0x01F9FA 07:F9EA: 65 11     ADC ram_0011_temp
...
- - - - - - 0x01FA0E 07:F9FE: A5 02     LDA ram_0002_temp
- - - - - - 0x01FA10 07:FA00: FD 60 03  SBC ram_pos_Y_lo,X
- - - - - - 0x01FA13 07:FA03: A5 03     LDA ram_0003_temp
...
C - - - - - 0x01FA46 07:FA36: A5 12     LDA ram_0012_t05_pos_X_lo_distance
C - - - - - 0x01FA48 07:FA38: D9 80 FB  CMP tbl_FB80_pos_X_lo,Y
C - - - - - 0x01FA4B 07:FA3B: B0 18     BCS bra_FA55
C - - - - - 0x01FA4D 07:FA3D: 38        SEC
C - - - - - 0x01FA4E 07:FA3E: B9 60 FB  LDA tbl_FB60,Y
C - - - - - 0x01FA51 07:FA41: E5 11     SBC ram_0011_t07
C - - - - - 0x01FA53 07:FA43: F0 10     BEQ bra_FA55
C - - - - - 0x01FA55 07:FA45: 90 0E     BCC bra_FA55
C - - - - - 0x01FA57 07:FA47: 85 11     STA ram_0011_t04_pos_Y_lo
C - - - - - 0x01FA59 07:FA49: C9 08     CMP #$08
C - - - - - 0x01FA5B 07:FA4B: 90 04     BCC bra_FA51
C - - - - - 0x01FA5D 07:FA4D: A9 08     LDA #$08
C - - - - - 0x01FA5F 07:FA4F: 85 11     STA ram_0011_t04_pos_Y_lo
bra_FA51:
C - - - - - 0x01FA61 07:FA51: A4 00     LDY ram_0000_t72_save_Y
C - - - - - 0x01FA63 07:FA53: 38        SEC
C - - - - - 0x01FA64 07:FA54: 60        RTS
bra_FA55:
C - - - - - 0x01FA65 07:FA55: C6 01     DEC ram_0001_t19_obj_index
C - - - - - 0x01FA67 07:FA57: A4 01     LDY ram_0001_t19_obj_index
C - - - - - 0x01FA69 07:FA59: C0 02     CPY #$02
C - - - - - 0x01FA6B 07:FA5B: D0 B7     BNE bra_FA14_loop
C - - - - - 0x01FA6D 07:FA5D: A4 00     LDY ram_0000_t72_save_Y
bra_FA5F:
...
; out
    ; C
        ; 0 = 
        ; 1 = 
    ; ram_0012_t03_pos_X_lo
C - - - - - 0x01FA71 07:FA61: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01FA74 07:FA64: 10 4E     BPL bra_FAB4
C - - - - - 0x01FA76 07:FA66: 84 00     STY ram_0000_t73_save_Y
C - - - - - 0x01FA78 07:FA68: A0 0F     LDY #$0F
C - - - - - 0x01FA7A 07:FA6A: 84 01     STY ram_0001_t20_obj_index
bra_FA6C_loop:
C - - - - - 0x01FA7C 07:FA6C: B9 00 03  LDA ram_obj_flags,Y
C - - - - - 0x01FA7F 07:FA6F: 10 39     BPL bra_FAAA
C - - - - - 0x01FA81 07:FA71: B9 00 04  LDA ram_0400_obj_flags,Y
...
C - - - - - 0x01FA9B 07:FA8B: A5 11     LDA ram_0011_t07
C - - - - - 0x01FA9D 07:FA8D: D9 60 FB  CMP tbl_FB60,Y
C - - - - - 0x01FAA0 07:FA90: B0 18     BCS bra_FAAA
C - - - - - 0x01FAA2 07:FA92: 38        SEC
C - - - - - 0x01FAA3 07:FA93: B9 80 FB  LDA tbl_FB80_pos_X_lo,Y
C - - - - - 0x01FAA6 07:FA96: E5 12     SBC ram_0012_t05_pos_X_lo_distance
C - - - - - 0x01FAA8 07:FA98: F0 10     BEQ bra_FAAA
C - - - - - 0x01FAAA 07:FA9A: 90 0E     BCC bra_FAAA
C - - - - - 0x01FAAC 07:FA9C: 85 12     STA ram_0012_t03_pos_X_lo
C - - - - - 0x01FAAE 07:FA9E: C9 08     CMP #$08
C - - - - - 0x01FAB0 07:FAA0: 90 04     BCC bra_FAA6
C - - - - - 0x01FAB2 07:FAA2: A9 08     LDA #$08
C - - - - - 0x01FAB4 07:FAA4: 85 12     STA ram_0012_t03_pos_X_lo
bra_FAA6:
C - - - - - 0x01FAB6 07:FAA6: A4 00     LDY ram_0000_t73_save_Y
C - - - - - 0x01FAB8 07:FAA8: 38        SEC
C - - - - - 0x01FAB9 07:FAA9: 60        RTS
bra_FAAA:
C - - - - - 0x01FABA 07:FAAA: C6 01     DEC ram_0001_t20_obj_index
C - - - - - 0x01FABC 07:FAAC: A4 01     LDY ram_0001_t20_obj_index
C - - - - - 0x01FABE 07:FAAE: C0 02     CPY #$02
C - - - - - 0x01FAC0 07:FAB0: D0 BA     BNE bra_FA6C_loop
C - - - - - 0x01FAC2 07:FAB2: A4 00     LDY ram_0000_t73_save_Y
bra_FAB4:
...
sub_FAB6:
; out
    ; ram_0012_t05_pos_X_lo_distance
...
bra_FACC:
C - - - - - 0x01FADC 07:FACC: 85 12     STA ram_0012_t05_pos_X_lo_distance
...
bra_FAD9:
C - - - - - 0x01FAE9 07:FAD9: 85 11     STA ram_0011_t08
...
C - - - - - 0x01FAF6 07:FAE6: E5 11     SBC ram_0011_t08
...
bra_FAEF:
C - - - - - 0x01FAFF 07:FAEF: 85 11     STA ram_0011_t07
...
; con_ariel_waiting_for_boss
; con_ariel_spawning
C - - - - - 0x01FB08 07:FAF8: BD 00 04  LDA ram_0400_obj_flags,X
...
bra_FB1C:
C - - - - - 0x01FB2C 07:FB1C: D9 80 FB  CMP tbl_FB80_pos_X_lo,Y
...
bra_FB2C:
C - - - - - 0x01FB3C 07:FB2C: 85 00     STA ram_0000_t74_pos_Y_lo
...
bra_FB42:
C - - - - - 0x01FB52 07:FB42: 85 1F     STA ram_001F_t02_pos_Y_lo
...
C - - - - - 0x01FB5D 07:FB4D: A5 1F     LDA ram_001F_t02_pos_Y_lo
C - - - - - 0x01FB5F 07:FB4F: 38        SEC
C - - - - - 0x01FB60 07:FB50: E5 00     SBC ram_0000_t74_pos_Y_lo
...
bra_FBAF:
C - - - - - 0x01FBBF 07:FBAF: B9 00 04  LDA ram_0400_obj_flags,Y
C - - - - - 0x01FBC2 07:FBB2: 10 F8     BPL bra_FBAC
C - - - - - 0x01FBC4 07:FBB4: BD 00 04  LDA ram_0400_obj_flags,X
...
C - - - - - 0x01FBE3 07:FBD3: 84 00     STY ram_0000_t75_obj_index
C - - - - - 0x01FBE5 07:FBD5: BD C0 03  LDA ram_03C0_obj,X
C - - - - - 0x01FBE8 07:FBD8: 29 1F     AND #$1F
C - - - - - 0x01FBEA 07:FBDA: A8        TAY
C - - - - - 0x01FBEB 07:FBDB: B9 80 FB  LDA tbl_FB80_pos_X_lo,Y
C - - - - - 0x01FBEE 07:FBDE: 85 01     STA ram_0001_t21_pos_X_lo
C - - - - - 0x01FBF0 07:FBE0: B9 60 FB  LDA tbl_FB60,Y
C - - - - - 0x01FBF3 07:FBE3: 85 02     STA ram_0002_t25
C - - - - - 0x01FBF5 07:FBE5: C6 02     DEC ram_0002_t25
C - - - - - 0x01FBF7 07:FBE7: A4 00     LDY ram_0000_t75_obj_index
...
bra_FBFE:
C - - - - - 0x01FC0E 07:FBFE: C5 01     CMP ram_0001_t21_pos_X_lo
...
bra_FC0D:
C - - - - - 0x01FC1D 07:FC0D: 85 03     STA ram_0003_t15_pos_Y_lo
...
bra_FC23:
C - - - - - 0x01FC33 07:FC23: 85 1F     STA ram_001F_t03_pos_Y_lo
...
C - - - - - 0x01FC3E 07:FC2E: A5 1F     LDA ram_001F_t03_pos_Y_lo
C - - - - - 0x01FC40 07:FC30: 38        SEC
C - - - - - 0x01FC41 07:FC31: E5 03     SBC ram_0003_t15_pos_Y_lo
C - - - - - 0x01FC43 07:FC33: B0 04     BCS bra_FC39
C - - - - - 0x01FC45 07:FC35: 49 FF     EOR #$FF
C - - - - - 0x01FC47 07:FC37: 69 01     ADC #$01
bra_FC39:
C - - - - - 0x01FC49 07:FC39: C5 02     CMP ram_0002_t25
...
; in
    ; A = 
C D 3 - - - 0x01FC55 07:FC45: 9D 30 04  STA ram_0430_obj_animation,X
C - - - - - 0x01FC58 07:FC48: A9 00     LDA #$00
C - - - - - 0x01FC5A 07:FC4A: 9D 18 04  STA ram_obj_animation_cnt,X
C - - - - - 0x01FC5D 07:FC4D: 9D 48 04  STA ram_0448_obj,X
...
; in
    ; A = 
C - - - - - 0x01FC61 07:FC51: 99 30 04  STA ram_0430_obj_animation,Y
C - - - - - 0x01FC64 07:FC54: A9 00     LDA #$00
C - - - - - 0x01FC66 07:FC56: 99 18 04  STA ram_obj_animation_cnt,Y
C - - - - - 0x01FC69 07:FC59: 99 48 04  STA ram_0448_obj,Y
C - - - - - 0x01FC6C 07:FC5C: 99 70 03  STA ram_pos_Y_hi,Y
C - - - - - 0x01FC6F 07:FC5F: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01FC72 07:FC62: 29 40     AND #$40
C - - - - - 0x01FC74 07:FC64: 09 90     ORA #$10 + $80
C - - - - - 0x01FC76 07:FC66: 99 00 04  STA ram_0400_obj_flags,Y
...
C - - - - - 0x01FC81 07:FC71: 9D D0 03  STA ram_obj_direction,X
...
C - - - - - 0x01FC95 07:FC85: 9D D0 03  STA ram_obj_direction,X
bra_FC88_RTS:
...
sub_0x01FC99:
loc_0x01FC99:
C D 3 - - - 0x01FC99 07:FC89: BD D0 03  LDA ram_obj_direction,X
C - - - - - 0x01FC9C 07:FC8C: 6A        ROR
C - - - - - 0x01FC9D 07:FC8D: 6A        ROR
C - - - - - 0x01FC9E 07:FC8E: 6A        ROR
C - - - - - 0x01FC9F 07:FC8F: 29 40     AND #$40
; A = 00/40
C - - - - - 0x01FCA1 07:FC91: 85 00     STA ram_0000_t76_flag
C - - - - - 0x01FCA3 07:FC93: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01FCA6 07:FC96: 29 BF     AND #$40 ^ $FF
C - - - - - 0x01FCA8 07:FC98: 05 00     ORA ram_0000_t76_flag
C - - - - - 0x01FCAA 07:FC9A: 9D 00 04  STA ram_0400_obj_flags,X
...
C D 3 - - - 0x01FCB0 07:FCA0: 86 00     STX ram_0000_t77_save_X
C - - - - - 0x01FCB2 07:FCA2: A6 DA     LDX ram_queue_index_1
C - - - - - 0x01FCB4 07:FCA4: 85 01     STA ram_0001_t22_sound
C - - - - - 0x01FCB6 07:FCA6: B5 DC     LDA ram_sfx_queue,X
C - - - - - 0x01FCB8 07:FCA8: C9 88     CMP #con_se_cb_88
C - - - - - 0x01FCBA 07:FCAA: D0 0A     BNE bra_FCB6
C - - - - - 0x01FCBC 07:FCAC: A5 01     LDA ram_0001_t22_sound
...
bra_FCB6:
C - - - - - 0x01FCC6 07:FCB6: A6 00     LDX ram_0000_t77_save_X
...
C - - - - - 0x01FCCA 07:FCBA: BD D0 03  LDA ram_obj_direction,X
...
C - - - - - 0x01FCDD 07:FCCD: BD D0 03  LDA ram_obj_direction,X
...
C D 3 - - - 0x01FCEF 07:FCDF: BD D0 03  LDA ram_obj_direction,X
...
; move right
C - - - - - 0x01FCFA 07:FCEA: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01FCFD 07:FCED: 09 40     ORA #$40
C - - - - - 0x01FCFF 07:FCEF: 9D 00 04  STA ram_0400_obj_flags,X
C - - - - - 0x01FD02 07:FCF2: 4C 87 F8  JMP loc_F887_move_object_right
bra_FCF5_move_left:
C - - - - - 0x01FD05 07:FCF5: BD 00 04  LDA ram_0400_obj_flags,X
C - - - - - 0x01FD08 07:FCF8: 29 BF     AND #$40 ^ $FF
C - - - - - 0x01FD0A 07:FCFA: 9D 00 04  STA ram_0400_obj_flags,X
...
C D 3 - - - 0x01FD10 07:FD00: BD D0 03  LDA ram_obj_direction,X
...
bra_FD1C:
C - - - - - 0x01FD2C 07:FD1C: 85 00     STA ram_0000_t78
...
C - - - - - 0x01FD39 07:FD29: E5 00     SBC ram_0000_t78
...
bra_FD53:
C - - - - - 0x01FD63 07:FD53: 85 00     STA ram_0000_t79
C - - - - - 0x01FD65 07:FD55: 20 33 FD  JSR sub_FD33
C - - - - - 0x01FD68 07:FD58: B0 02     BCS bra_FD5C
C - - - - - 0x01FD6A 07:FD5A: C8        INY
C - - - - - 0x01FD6B 07:FD5B: C8        INY ; 02/06
bra_FD5C:
C - - - - - 0x01FD6C 07:FD5C: 85 01     STA ram_0001_t23
C - - - - - 0x01FD6E 07:FD5E: C5 00     CMP ram_0000_t79
C - - - - - 0x01FD70 07:FD60: B0 09     BCS bra_FD6B
C - - - - - 0x01FD72 07:FD62: 48        PHA
C - - - - - 0x01FD73 07:FD63: A5 00     LDA ram_0000_t79
C - - - - - 0x01FD75 07:FD65: 85 01     STA ram_0001_t23
C - - - - - 0x01FD77 07:FD67: 68        PLA
C - - - - - 0x01FD78 07:FD68: 85 00     STA ram_0000_t79
C - - - - - 0x01FD7A 07:FD6A: C8        INY
bra_FD6B:
C - - - - - 0x01FD7B 07:FD6B: A9 00     LDA #$00
C - - - - - 0x01FD7D 07:FD6D: 85 02     STA ram_0002_t26
C - - - - - 0x01FD7F 07:FD6F: A5 01     LDA ram_0001_t23
C - - - - - 0x01FD81 07:FD71: 4A        LSR
C - - - - - 0x01FD82 07:FD72: 4A        LSR
C - - - - - 0x01FD83 07:FD73: C5 00     CMP ram_0000_t79
C - - - - - 0x01FD85 07:FD75: B0 09     BCS bra_FD80
C - - - - - 0x01FD87 07:FD77: E6 02     INC ram_0002_t26    ; -> 01
C - - - - - 0x01FD89 07:FD79: 0A        ASL
C - - - - - 0x01FD8A 07:FD7A: C5 00     CMP ram_0000_t79
C - - - - - 0x01FD8C 07:FD7C: B0 02     BCS bra_FD80
C - - - - - 0x01FD8E 07:FD7E: E6 02     INC ram_0002_t26    ; -> 02
bra_FD80:
C - - - - - 0x01FD90 07:FD80: 98        TYA
C - - - - - 0x01FD91 07:FD81: 0A        ASL
C - - - - - 0x01FD92 07:FD82: 0A        ASL
C - - - - - 0x01FD93 07:FD83: 18        CLC
C - - - - - 0x01FD94 07:FD84: 65 02     ADC ram_0002_t26
...
- - - - - - 0x01FDCE 07:FDBE: 85 00     STA ram_0000_temp
- - - - - - 0x01FDD0 07:FDC0: BD D0 03  LDA ram_obj_direction,X
- - - - - - 0x01FDD3 07:FDC3: 18        CLC
- - - - - - 0x01FDD4 07:FDC4: 69 08     ADC #$08
- - - - - - 0x01FDD6 07:FDC6: 29 0F     AND #$0F
- - - - - - 0x01FDD8 07:FDC8: 38        SEC
- - - - - - 0x01FDD9 07:FDC9: E5 00     SBC ram_0000_temp
...
- - - - - - 0x01FDE4 07:FDD4: FE D0 03  INC ram_obj_direction,X
- - - - - - 0x01FDE7 07:FDD7: D0 03     BNE bra_FDDC
bra_FDD9:
- - - - - - 0x01FDE9 07:FDD9: DE D0 03  DEC ram_obj_direction,X
bra_FDDC:
- - - - - - 0x01FDEC 07:FDDC: BD D0 03  LDA ram_obj_direction,X
- - - - - - 0x01FDEF 07:FDDF: 29 0F     AND #$0F
- - - - - - 0x01FDF1 07:FDE1: 9D D0 03  STA ram_obj_direction,X
bra_FDE4_RTS:
...
; in
    ; A = 00-0F
    ; Y = 00 08 10
C - - - - - 0x01FDF5 07:FDE5: 85 00     STA ram_0000_t80
C - - - - - 0x01FDF7 07:FDE7: 84 01     STY ram_0001_t24
C - - - - - 0x01FDF9 07:FDE9: A8        TAY
C - - - - - 0x01FDFA 07:FDEA: B9 AB FD  LDA tbl_FDAB_direction,Y
C - - - - - 0x01FDFD 07:FDED: 9D D0 03  STA ram_obj_direction,X
C - - - - - 0x01FE00 07:FDF0: A5 00     LDA ram_0000_t80
C - - - - - 0x01FE02 07:FDF2: 29 07     AND #$07
C - - - - - 0x01FE04 07:FDF4: 05 01     ORA ram_0001_t24
...
sub_0x01FE74:
loc_0x01FE74:
C D 3 - - - 0x01FE74 07:FE64: BD E0 03  LDA ram_03E0_obj_data_index,X
C - - - - - 0x01FE77 07:FE67: 29 07     AND #$07
C - - - - - 0x01FE79 07:FE69: A8        TAY
C - - - - - 0x01FE7A 07:FE6A: B9 85 FE  LDA tbl_FE85_bits,Y
C - - - - - 0x01FE7D 07:FE6D: 85 00     STA ram_0000_t81
C - - - - - 0x01FE7F 07:FE6F: 49 FF     EOR #$FF
C - - - - - 0x01FE81 07:FE71: 85 01     STA ram_0001_t25
C - - - - - 0x01FE83 07:FE73: BD E0 03  LDA ram_03E0_obj_data_index,X
...
C - - - - - 0x01FE8D 07:FE7D: 25 01     AND ram_0001_t25
C - - - - - 0x01FE8F 07:FE7F: 05 00     ORA ram_0000_t81
...
C - - - - - 0x01FF14 07:FF04: A9 88     LDA #con_se_cb_88
bra_FF06_loop:
...
C - - - - - 0x01FF25 07:FF15: A2 FF     LDX #$FF    ; fill tile
C - - - - - 0x01FF27 07:FF17: A0 00     LDY #$00    ; fill attribute
C - - - - - 0x01FF29 07:FF19: 20 70 C1  JSR sub_C170_fill_nametable
; 
C - - - - - 0x01FF2C 07:FF1C: A9 24     LDA #$24    ; ppu hi
C - - - - - 0x01FF2E 07:FF1E: A2 FF     LDX #$FF    ; fill tile
C - - - - - 0x01FF30 07:FF20: A0 00     LDY #$00    ; fill attribute
C - - - - - 0x01FF32 07:FF22: 20 70 C1  JSR sub_C170_fill_nametable
; 
C - - - - - 0x01FF35 07:FF25: A9 C6     LDA #> ofs_C639
C - - - - - 0x01FF37 07:FF27: 85 94     STA ram_0094_tFF_useless_C6
C - - - - - 0x01FF39 07:FF29: A9 39     LDA #< ofs_C639
C - - - - - 0x01FF3B 07:FF2B: 85 93     STA ram_0093_tFE_useless_39
...
C - - - - - 0x01FF4B 07:FF3B: 86 90     STX ram_nmi_flag
...
bra_FF4F:
C - - - - - 0x01FF5F 07:FF4F: A5 90     LDA ram_nmi_flag
; A = 00/FF
...
; !!! A = 00?
C - - - - - 0x01FF67 07:FF57: 85 91     STA ram_0091_useless_00
...
C - - - - - 0x01FF73 07:FF63: B5 82     LDA ram_0082_ptr_lo,X
C - - - - - 0x01FF75 07:FF65: 85 93     STA ram_0093_t01_jmp
C - - - - - 0x01FF77 07:FF67: B5 83     LDA ram_0083_ptr_hi,X
C - - - - - 0x01FF79 07:FF69: 85 94     STA ram_0093_t01_jmp + $01
C - - - - - 0x01FF7B 07:FF6B: 6C 93 00  JMP (ram_0093_t01_jmp)
bra_FF6E:
C - - - - - 0x01FF7E 07:FF6E: B5 82     LDA ram_0082_ptr_lo,X
C - - - - - 0x01FF80 07:FF70: AA        TAX
C - - - - - 0x01FF81 07:FF71: 9A        TXS
C - - - - - 0x01FF82 07:FF72: A5 91     LDA ram_0091_useless_00
...
C - - - - - 0x01FF8E 07:FF7E: 20 A2 FF  JSR sub_FFA2_multiply_A_by_04___TAX
; bzk optimize, always 39 (originally)
C - - - - - 0x01FF91 07:FF81: A5 93     LDA ram_0093_tFE_useless_39
C - - - - - 0x01FF93 07:FF83: 95 82     STA ram_0082_ptr_lo,X
; bzk optimize, always C6 (originally)
C - - - - - 0x01FF95 07:FF85: A5 94     LDA ram_0094_tFF_useless_C6
C - - - - - 0x01FF97 07:FF87: 95 83     STA ram_0083_ptr_hi,X
...
; bzk garbage
- - - - - - 0x01FF9E 07:FF8E: 20 A2 FF  JSR sub_FFA2_multiply_A_by_04___TAX
...
- - - - - - 0x01FFAD 07:FF9D: 4C 36 FF  JMP loc_FF36_game_loop



sub_FFA0:
C - - - - - 0x01FFB0 07:FFA0: A5 91     LDA ram_0091_useless_00
sub_FFA2_multiply_A_by_04___TAX:
; * 04
...
loc_FFA6_wait_X_frms:
sub_FFA6_wait_X_frms:
bra_FFA6_loop:
C D 3 - - - 0x01FFB6 07:FFA6: 20 AD FF  JSR sub_FFAD_wait_1_frm
...
sub_FFAD_wait_1_frm:
sub_0x01FFBD_wait_1_frm:
; wait i frame
C - - - - - 0x01FFBD 07:FFAD: A9 01     LDA #$01
C - - - - - 0x01FFBF 07:FFAF: 85 93     STA ram_0093_tFF_useless_01
...
C - - - - - 0x01FFC8 07:FFB8: A5 93     LDA ram_0093_tFF_useless_01
...
C - - - - - 0x01FFD3 07:FFC3: 96 82     STX ram_0082_ptr_lo,Y
C - - - - - 0x01FFD5 07:FFC5: 4C 36 FF  JMP loc_FF36_game_loop



sub_FFC8_nmi_prg_bankswitch:
...
sub_FFCD_prg_bankswitch_with_backup:
; in
    ; A = con_prg_bank
C - - - - - 0x01FFDD 07:FFCD: 85 9B     STA ram_prg_bank
sub_FFCF_prg_bankswitch:
loc_FFCF_prg_bankswitch:
; in
    ; A = con_prg_bank
C D 3 - - - 0x01FFDF 07:FFCF: 85 BF     STA ram_nmi_restore_prg_bank
C - - - - - 0x01FFE1 07:FFD1: 86 9C     STX ram_009C_t01_save_X
C - - - - - 0x01FFE3 07:FFD3: 84 9D     STY ram_009D_t01_save_Y
C - - - - - 0x01FFE5 07:FFD5: AA        TAX
C - - - - - 0x01FFE6 07:FFD6: 9D DE FF  STA tbl_FFDE_prg_bank,X
C - - - - - 0x01FFE9 07:FFD9: A6 9C     LDX ram_009C_t01_save_X
C - - - - - 0x01FFEB 07:FFDB: A4 9D     LDY ram_009D_t01_save_Y
