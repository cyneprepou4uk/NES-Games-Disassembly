...
set "file_name=_double_dragon_2"
...
set "sha1_original=84E9953AEFEF23EC33766314AF01C4B3C0E84B66"
...
echo.
echo Executing additional Lua script for this game.
start /wait lua53 split.lua

:: join header, PRG and CHR (if exists) into a single ROM file
copy /B header.bin + PRG_ROM.bin + CHR_ROM.chr + CHR_screens.chr %file_name%.nes > nul
