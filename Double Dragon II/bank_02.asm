...
C - - - - - 0x008027 02:8017: A5 3E     LDA ram_003C_obj_flags + $02
C - - - - - 0x008029 02:8019: 10 3D     BPL bra_8058    ; if not con_003C_flag_exist
C - - - - - 0x00802B 02:801B: A5 4C     LDA ram_004A_obj_flags + $02
C - - - - - 0x00802D 02:801D: 29 C0     AND #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x00802F 02:801F: C9 C0     CMP #con_004A_flag_stunned + con_004A_flag_knocked_down
...
bra_805A_loop:
C - - - - - 0x00806A 02:805A: B9 3C 00  LDA a: ram_003C_obj_flags,Y ; 003C 003D 003E 003F 0040 0041 0042
C - - - - - 0x00806D 02:805D: 10 0B     BPL bra_806A    ; if not con_003C_flag_exist
C - - - - - 0x00806F 02:805F: 29 20     AND #con_003C_flag_20
...
bra_8071_loop:
C - - - - - 0x008081 02:8071: B5 3C     LDA ram_003C_obj_flags,X ; 003C 003D
C - - - - - 0x008083 02:8073: 10 2F     BPL bra_80A4    ; if not con_003C_flag_exist
C - - - - - 0x008085 02:8075: BD CC 03  LDA ram_plr_invincibility_timer,X
...
C - - - - - 0x008090 02:8080: C9 7F     CMP #con_anim_id + $7F
C - - - - - 0x008092 02:8082: D0 0D     BNE bra_8091
C - - - - - 0x008094 02:8084: B5 43     LDA ram_obj_state,X
C - - - - - 0x008096 02:8086: 29 7F     AND #$7F
C - - - - - 0x008098 02:8088: C9 7F     CMP #con_state_hair_grabbed
C - - - - - 0x00809A 02:808A: F0 15     BEQ bra_80A1
C - - - - - 0x00809C 02:808C: BD CE 03  LDA ram_copy_animation_id,X
C - - - - - 0x00809F 02:808F: 95 C7     STA ram_animation_id,X
bra_8091:
C - - - - - 0x0080A1 02:8091: BD CC 03  LDA ram_plr_invincibility_timer,X
C - - - - - 0x0080A4 02:8094: 29 01     AND #$01
C - - - - - 0x0080A6 02:8096: F0 09     BEQ bra_80A1
; hide player sprite during invincibility
C - - - - - 0x0080A8 02:8098: B5 C7     LDA ram_animation_id,X
C - - - - - 0x0080AA 02:809A: 9D CE 03  STA ram_copy_animation_id,X
C - - - - - 0x0080AD 02:809D: A9 7F     LDA #con_anim_id + $7F
C - - - - - 0x0080AF 02:809F: 95 C7     STA ram_animation_id,X
bra_80A1:
C - - - - - 0x0080B1 02:80A1: FE CC 03  INC ram_plr_invincibility_timer,X
bra_80A4:
...
; in
    ; A = object index
C - - - - - 0x0080BD 02:80AD: 85 19     STA ram_0019_t03_obj_index
C - - - - - 0x0080BF 02:80AF: AA        TAX
C - - - - - 0x0080C0 02:80B0: B5 43     LDA ram_obj_state,X
C - - - - - 0x0080C2 02:80B2: 30 03     BMI bra_80B7
C - - - - - 0x0080C4 02:80B4: FE C1 03  INC ram_03C1_obj,X
bra_80B7:
C - - - - - 0x0080C7 02:80B7: B5 43     LDA ram_obj_state,X
C - - - - - 0x0080C9 02:80B9: 0A        ASL
C - - - - - 0x0080CA 02:80BA: A8        TAY
C - - - - - 0x0080CB 02:80BB: B9 CA 80  LDA tbl_80CA_state_handler,Y
C - - - - - 0x0080CE 02:80BE: 85 29     STA ram_0029_t23_jmp
C - - - - - 0x0080D0 02:80C0: B9 CB 80  LDA tbl_80CA_state_handler + $01,Y
C - - - - - 0x0080D3 02:80C3: 85 2A     STA ram_0029_t23_jmp + $01
C - - - - - 0x0080D5 02:80C5: A6 19     LDX ram_0019_t03_obj_index
C - - - - - 0x0080D7 02:80C7: 6C 29 00  JMP (ram_0029_t23_jmp)
...
- D 0 - - - 0x0080DC 02:80CC: F2 81     .word ofs_000_81F2_01_walking
- D 0 - - - 0x0080DE 02:80CE: 5C 82     .word ofs_000_825C_02_running
- D 0 - - - 0x0080E0 02:80D0: 87 82     .word ofs_000_8287_03_ladder_climb_up
- D 0 - - - 0x0080E2 02:80D2: DB 82     .word ofs_000_82DB_04_ladder_climb_idle
- D 0 - - - 0x0080E4 02:80D4: F3 82     .word ofs_000_82F3_05_ladder_climb_down
- D 0 - - - 0x0080E6 02:80D6: 43 83     .word ofs_000_8343_06_jump_up
...
- D 0 - - - 0x0080F6 02:80E6: AE 85     .word ofs_000_85AE_0E_doppelganger_despawn
- D 0 - - - 0x0080F8 02:80E8: D0 85     .word ofs_000_85D0_0F_doppelganger_invisible
- D 0 - - - 0x0080FA 02:80EA: 07 86     .word ofs_000_8607_10_doppelganger_spawn
- D 0 - - - 0x0080FC 02:80EC: 2D 86     .word ofs_000_862D_11_pick_up_weapon
- D 0 - - - 0x0080FE 02:80EE: 79 86     .word ofs_000_8679_12_land_after_jump
- D 0 - - - 0x008100 02:80F0: A1 86     .word ofs_000_86A1_13_fall_after_action
...
- D 0 - - - 0x00810C 02:80FC: 79 87     .word ofs_000_8779_19_lie_on_the_ground
...
- D 0 - - - 0x008116 02:8106: AB 88     .word ofs_000_88AB_1E_thrown_by_hair_throw
...
- D 0 - - - 0x008124 02:8114: 5F 8A     .word ofs_000_8A5F_25_player_respawn
- D 0 - - - 0x008126 02:8116: 6B 8A     .word ofs_000_8A6B_26_death_normal
- D 0 - - - 0x008128 02:8118: 3F 8B     .word ofs_000_8B3F_27_death_water
- D 0 - - - 0x00812A 02:811A: 97 8B     .word ofs_000_8B97_28_death_burnov
- D 0 - - - 0x00812C 02:811C: ED 8B     .word ofs_000_8BED_29_burnov_helmet
- D 0 - - - 0x00812E 02:811E: 0C 8C     .word ofs_000_8C0C_2A_burnov_revives
- D 0 - - - 0x008130 02:8120: 57 8C     .word ofs_000_8C57_2B_hit_by_spikes_on_the_ceiling
- D 0 - - - 0x008132 02:8122: 71 8C     .word ofs_000_8C71_2C_shadow_warrior_appears
- D 0 - - - 0x008134 02:8124: 94 8C     .word ofs_000_8C94_2D_punch_normal
- D 0 - - - 0x008136 02:8126: 08 8D     .word ofs_000_8D08_2E_ninja_knife
- D 0 - - - 0x008138 02:8128: 1C 8D     .word ofs_000_8D1C_2F_uppercut_normal
...
- D 0 - - - 0x00814C 02:813C: 7B 8E     .word ofs_000_8E7B_39_cyclone_kick
- D 0 - - - 0x00814E 02:813E: 9E 8E     .word ofs_000_8E9E_3A_high_jump_kick
- D 0 - - - 0x008150 02:8140: E3 8E     .word ofs_000_8EE3_3B_uppercut_sudden
- D 0 - - - 0x008152 02:8142: E6 8E     .word ofs_000_8EE6_3C_elbow
- D 0 - - - 0x008154 02:8144: 13 8F     .word ofs_000_8F13_3D_punch_strong
- D 0 - - - 0x008156 02:8146: 5F 8F     .word ofs_000_8F5F_3E_chin_taimei_sword
...
C - - - - - 0x0081E1 02:81D1: B5 43     LDA ram_obj_state,X
C - - - - - 0x0081E3 02:81D3: 30 16     BMI bra_81EB
C - - - - - 0x0081E5 02:81D5: 09 80     ORA #$80
C - - - - - 0x0081E7 02:81D7: 95 43     STA ram_obj_state,X
C - - - - - 0x0081E9 02:81D9: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x0081EB 02:81DB: 29 3C     AND #(con_004A_flag_stunned + con_004A_flag_knocked_down + con_004A_flag_01 + con_004A_flag_hair_grabbed) ^ $FF
C - - - - - 0x0081ED 02:81DD: 95 4A     STA ram_004A_obj_flags,X
...
C - - - - - 0x0081F7 02:81E7: A9 02     LDA #con_anim_id + $02
C - - - - - 0x0081F9 02:81E9: 95 C7     STA ram_animation_id,X
bra_81EB:
C - - - - - 0x0081FB 02:81EB: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
C - - - - - 0x0081FE 02:81EE: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x008209 02:81F9: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x00820B 02:81FB: 29 3E     AND #(con_004A_flag_stunned + con_004A_flag_knocked_down + con_004A_flag_01) ^ $FF
C - - - - - 0x00820D 02:81FD: 95 4A     STA ram_004A_obj_flags,X
...
C - - - - - 0x008219 02:8209: 95 55     STA ram_obj_amim_dur,X
...
C - - - - - 0x008224 02:8214: B9 54 82  LDA tbl_8254_animation_counter,Y
C - - - - - 0x008227 02:8217: 95 5C     STA ram_obj_amim_cnt,X
bra_8219:
C - - - - - 0x008229 02:8219: F6 55     INC ram_obj_amim_dur,X
C - - - - - 0x00822B 02:821B: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x00822D 02:821D: C9 05     CMP #$05
C - - - - - 0x00822F 02:821F: 90 18     BCC bra_8239
C - - - - - 0x008231 02:8221: A9 00     LDA #$00
C - - - - - 0x008233 02:8223: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x008235 02:8225: B5 5C     LDA ram_obj_amim_cnt,X
C - - - - - 0x008237 02:8227: A8        TAY
C - - - - - 0x008238 02:8228: B9 58 82  LDA tbl_8258_animation_id,Y
C - - - - - 0x00823B 02:822B: 95 C7     STA ram_animation_id,X
C - - - - - 0x00823D 02:822D: F6 5C     INC ram_obj_amim_cnt,X
C - - - - - 0x00823F 02:822F: A9 03     LDA #$03
C - - - - - 0x008241 02:8231: D5 5C     CMP ram_obj_amim_cnt,X
C - - - - - 0x008243 02:8233: B0 04     BCS bra_8239
C - - - - - 0x008245 02:8235: A9 00     LDA #$00
C - - - - - 0x008247 02:8237: 95 5C     STA ram_obj_amim_cnt,X
bra_8239:
C - - - - - 0x008249 02:8239: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
C - - - - - 0x00824C 02:823C: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
tbl_8258_animation_id:
- D 0 - - - 0x008268 02:8258: 00        .byte con_anim_id + $00   ; 00 
- D 0 - - - 0x008269 02:8259: 01        .byte con_anim_id + $01   ; 01 
- D 0 - - - 0x00826A 02:825A: 02        .byte con_anim_id + $02   ; 02 
- D 0 - - - 0x00826B 02:825B: 01        .byte con_anim_id + $01   ; 03 
...
bra_8271:
C - - - - - 0x008281 02:8271: A9 00     LDA #con_A48A_anim_00
C - - - - - 0x008283 02:8273: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
; bzk optimize, JMP
C - - - - - 0x008286 02:8276: 20 4B 9E  JSR sub_9E4B_move_object
C - - - - - 0x008289 02:8279: 60        RTS



_off000_827A_00:
- D 0 - I - 0x00828A 02:827A: 1A        .byte con_anim_id + $1A   ; 
- D 0 - I - 0x00828B 02:827B: 1B        .byte con_anim_id + $1B   ; 
- D 0 - I - 0x00828C 02:827C: 1C        .byte con_anim_id + $1C   ; 
- D 0 - I - 0x00828D 02:827D: 1D        .byte con_anim_id + $1D   ; 
- D 0 - I - 0x00828E 02:827E: 1E        .byte con_anim_id + $1E   ; 
- D 0 - I - 0x00828F 02:827F: 1F        .byte con_anim_id + $1F   ; 
- D 0 - I - 0x008290 02:8280: FE        .byte $FE   ; control byte
...
C - - - - - 0x0082A5 02:8295: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x0082A7 02:8297: A9 04     LDA #con_anim_id + $04
...
C - - - - - 0x0082B3 02:82A3: 95 5C     STA ram_obj_amim_cnt,X
bra_82A5:
C - - - - - 0x0082B5 02:82A5: F6 55     INC ram_obj_amim_dur,X
C - - - - - 0x0082B7 02:82A7: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x0082B9 02:82A9: C9 06     CMP #$06
C - - - - - 0x0082BB 02:82AB: 90 18     BCC bra_82C5
C - - - - - 0x0082BD 02:82AD: A9 00     LDA #$00
C - - - - - 0x0082BF 02:82AF: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x0082C1 02:82B1: B5 5C     LDA ram_obj_amim_cnt,X
C - - - - - 0x0082C3 02:82B3: A8        TAY
C - - - - - 0x0082C4 02:82B4: B9 D9 82  LDA tbl_82D9_animation_id,Y
C - - - - - 0x0082C7 02:82B7: 95 C7     STA ram_animation_id,X
C - - - - - 0x0082C9 02:82B9: F6 5C     INC ram_obj_amim_cnt,X
C - - - - - 0x0082CB 02:82BB: A9 01     LDA #$01
C - - - - - 0x0082CD 02:82BD: D5 5C     CMP ram_obj_amim_cnt,X
...
C - - - - - 0x0082E2 02:82D2: B5 B6     LDA ram_obj_pos_Z_hi,X
C - - - - - 0x0082E4 02:82D4: 69 00     ADC #$00
C - - - - - 0x0082E6 02:82D6: 95 B6     STA ram_obj_pos_Z_hi,X
C - - - - - 0x0082E8 02:82D8: 60        RTS



tbl_82D9_animation_id:
- D 0 - - - 0x0082E9 02:82D9: 03        .byte con_anim_id + $03   ; 
- D 0 - - - 0x0082EA 02:82DA: 04        .byte con_anim_id + $04   ; 
...
C - - - - - 0x00830C 02:82FC: 95 55     STA ram_obj_amim_dur,X
...
C - - - - - 0x008317 02:8307: C9 04     CMP #con_anim_id + $04
C - - - - - 0x008319 02:8309: F0 04     BEQ bra_830F
C - - - - - 0x00831B 02:830B: A9 01     LDA #$01
C - - - - - 0x00831D 02:830D: 95 5C     STA ram_obj_amim_cnt,X
bra_830F:
C - - - - - 0x00831F 02:830F: F6 55     INC ram_obj_amim_dur,X
C - - - - - 0x008321 02:8311: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x008323 02:8313: C9 06     CMP #$06
C - - - - - 0x008325 02:8315: 90 18     BCC bra_832F
C - - - - - 0x008327 02:8317: A9 00     LDA #$00
C - - - - - 0x008329 02:8319: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x00832B 02:831B: B5 5C     LDA ram_obj_amim_cnt,X
C - - - - - 0x00832D 02:831D: A8        TAY
C - - - - - 0x00832E 02:831E: B9 D9 82  LDA tbl_82D9_animation_id,Y
C - - - - - 0x008331 02:8321: 95 C7     STA ram_animation_id,X
C - - - - - 0x008333 02:8323: F6 5C     INC ram_obj_amim_cnt,X
C - - - - - 0x008335 02:8325: A9 01     LDA #$01
C - - - - - 0x008337 02:8327: D5 5C     CMP ram_obj_amim_cnt,X
...
C - - - - - 0x00834C 02:833C: B5 B6     LDA ram_obj_pos_Z_hi,X
C - - - - - 0x00834E 02:833E: E9 00     SBC #$00
C - - - - - 0x008350 02:8340: 95 B6     STA ram_obj_pos_Z_hi,X
...
C - - - - - 0x008364 02:8354: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x008367 02:8357: A9 05     LDA #con_anim_id + $05
C - - - - - 0x008369 02:8359: 95 C7     STA ram_animation_id,X
C - - - - - 0x00836B 02:835B: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x00836D 02:835D: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x00836F 02:835F: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x008371 02:8361: A9 1D     LDA #con_sfx_jump
C - - - - - 0x008373 02:8363: 20 06 C0  JSR sub_0x01C016_play_sound
bra_8366:
C - - - - - 0x008376 02:8366: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x008379 02:8369: 20 73 A0  JSR sub_A073_check_for_max_gravity
; bzk optimize, JMP
...
C - - - - - 0x008391 02:8381: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x008394 02:8384: A9 05     LDA #con_anim_id + $05
C - - - - - 0x008396 02:8386: 95 C7     STA ram_animation_id,X
C - - - - - 0x008398 02:8388: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x00839A 02:838A: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x00839C 02:838C: 95 4A     STA ram_004A_obj_flags,X
...
C - - - - - 0x0083A5 02:8395: 95 55     STA ram_obj_amim_dur,X
...
- - - - - - 0x0083B2 02:83A2: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
bra_83A5:
C - - - - - 0x0083B5 02:83A5: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x0083B7 02:83A7: D0 05     BNE bra_83AE
C - - - - - 0x0083B9 02:83A9: A9 00     LDA #$00
C - - - - - 0x0083BB 02:83AB: 9D 16 03  STA ram_0316_obj,X
bra_83AE:
C - - - - - 0x0083BE 02:83AE: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x0083C1 02:83B1: 20 73 A0  JSR sub_A073_check_for_max_gravity
C - - - - - 0x0083C4 02:83B4: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
C - - - - - 0x0083DC 02:83CC: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x0083DF 02:83CF: A9 05     LDA #con_anim_id + $05
C - - - - - 0x0083E1 02:83D1: 95 C7     STA ram_animation_id,X
C - - - - - 0x0083E3 02:83D3: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x0083E5 02:83D5: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x0083E7 02:83D7: 95 4A     STA ram_004A_obj_flags,X
...
C - - - - - 0x0083F0 02:83E0: B0 0A     BCS bra_83EC    ; if enemy
; if 1p or 2p
C - - - - - 0x0083F2 02:83E2: BD 0F 03  LDA ram_obj_direction,X
C - - - - - 0x0083F5 02:83E5: D0 05     BNE bra_83EC
- - - - - - 0x0083F7 02:83E7: A9 00     LDA #$00
- - - - - - 0x0083F9 02:83E9: 9D 16 03  STA ram_0316_obj,X
bra_83EC:
C - - - - - 0x0083FC 02:83EC: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x0083FF 02:83EF: 20 73 A0  JSR sub_A073_check_for_max_gravity
C - - - - - 0x008402 02:83F2: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
C - - - - - 0x00841A 02:840A: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x00841D 02:840D: A9 05     LDA #con_anim_id + $05
C - - - - - 0x00841F 02:840F: 95 C7     STA ram_animation_id,X
C - - - - - 0x008421 02:8411: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x008423 02:8413: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x008425 02:8415: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x008427 02:8417: A9 1D     LDA #con_sfx_jump
C - - - - - 0x008429 02:8419: 20 06 C0  JSR sub_0x01C016_play_sound
bra_841C:
C - - - - - 0x00842C 02:841C: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x00842F 02:841F: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
- - - - - - 0x008447 02:8437: 9D 25 03  STA ram_obj_gravity_hi,X
- - - - - - 0x00844A 02:843A: A9 05     LDA #con_anim_id + $05
- - - - - - 0x00844C 02:843C: 95 C7     STA ram_animation_id,X
- - - - - - 0x00844E 02:843E: B5 4A     LDA ram_004A_obj_flags,X
- - - - - - 0x008450 02:8440: 09 80     ORA #con_004A_flag_knocked_down
- - - - - - 0x008452 02:8442: 95 4A     STA ram_004A_obj_flags,X
- - - - - - 0x008454 02:8444: A9 1D     LDA #con_sfx_jump
- - - - - - 0x008456 02:8446: 20 06 C0  JSR sub_0x01C016_play_sound
bra_8449:
- - - - - - 0x008459 02:8449: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
- - - - - - 0x00845C 02:844C: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
C - - - - - 0x00846F 02:845F: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x008472 02:8462: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x008474 02:8464: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x008476 02:8466: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x008478 02:8468: A9 03     LDA #$03
C - - - - - 0x00847A 02:846A: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x00847D 02:846D: A0 80     LDY #$80
C - - - - - 0x00847F 02:846F: BD 0F 03  LDA ram_obj_direction,X
...
C - - - - - 0x008489 02:8479: 95 63     STA ram_0063_obj_facing,X
C - - - - - 0x00848B 02:847B: B5 AD     LDA ram_obj_pos_Z_lo,X
C - - - - - 0x00848D 02:847D: 18        CLC
C - - - - - 0x00848E 02:847E: 69 0C     ADC #< $000C
C - - - - - 0x008490 02:8480: 95 AD     STA ram_obj_pos_Z_lo,X
C - - - - - 0x008492 02:8482: B5 B6     LDA ram_obj_pos_Z_hi,X
C - - - - - 0x008494 02:8484: 69 00     ADC #> $000C
C - - - - - 0x008496 02:8486: 95 B6     STA ram_obj_pos_Z_hi,X
C - - - - - 0x008498 02:8488: A9 1D     LDA #con_sfx_jump
C - - - - - 0x00849A 02:848A: 20 06 C0  JSR sub_0x01C016_play_sound
bra_848D:
C - - - - - 0x00849D 02:848D: A9 01     LDA #con_A48A_anim_01
...
- D 0 - I - 0x0084A6 02:8496: 93        .byte con_state_fall_after_action + $80   ; 
...
C - - - - - 0x0084B7 02:84A7: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x0084BA 02:84AA: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x0084BC 02:84AC: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x0084BE 02:84AE: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x0084C0 02:84B0: A9 0A     LDA #$0A
C - - - - - 0x0084C2 02:84B2: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x0084C5 02:84B5: A0 80     LDY #$80
C - - - - - 0x0084C7 02:84B7: BD 0F 03  LDA ram_obj_direction,X
...
C - - - - - 0x0084D1 02:84C1: 95 63     STA ram_0063_obj_facing,X
C - - - - - 0x0084D3 02:84C3: B5 AD     LDA ram_obj_pos_Z_lo,X
C - - - - - 0x0084D5 02:84C5: 18        CLC
C - - - - - 0x0084D6 02:84C6: 69 0C     ADC #< $000C
C - - - - - 0x0084D8 02:84C8: 95 AD     STA ram_obj_pos_Z_lo,X
C - - - - - 0x0084DA 02:84CA: B5 B6     LDA ram_obj_pos_Z_hi,X
C - - - - - 0x0084DC 02:84CC: 69 00     ADC #> $000C
C - - - - - 0x0084DE 02:84CE: 95 B6     STA ram_obj_pos_Z_hi,X
C - - - - - 0x0084E0 02:84D0: A9 1D     LDA #con_sfx_jump
C - - - - - 0x0084E2 02:84D2: 20 06 C0  JSR sub_0x01C016_play_sound
bra_84D5:
C - - - - - 0x0084E5 02:84D5: A9 02     LDA #con_A48A_anim_02
C - - - - - 0x0084E7 02:84D7: 20 D2 9F  JSR sub_9FD2
C - - - - - 0x0084EA 02:84DA: A6 19     LDX ram_0019_t03_obj_index
...
C - - - - - 0x0084F5 02:84E5: C9 21     CMP #con_anim_id + $21
C - - - - - 0x0084F7 02:84E7: D0 62     BNE bra_854B_RTS
C - - - - - 0x0084F9 02:84E9: B5 55     LDA ram_obj_amim_dur,X
...
C - - - - - 0x008506 02:84F6: 20 66 A4  JSR sub_A466_copy_data_between_two_objects
C - - - - - 0x008509 02:84F9: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x00850C 02:84FC: 29 DF     AND #con_004A_flag_20 ^ $FF
C - - - - - 0x00850E 02:84FE: 99 4A 00  STA a: ram_004A_obj_flags,Y
...
C - - - - - 0x008523 02:8513: 99 43 00  STA a: ram_obj_state,Y
C - - - - - 0x008526 02:8516: A9 40     LDA #$40
C - - - - - 0x008528 02:8518: 99 0F 03  STA ram_obj_direction,Y
C - - - - - 0x00852B 02:851B: BD 54 04  LDA ram_0454_obj_aim,X
C - - - - - 0x00852E 02:851E: A8        TAY
C - - - - - 0x00852F 02:851F: B9 77 00  LDA a: ram_obj_pos_X_lo,Y
C - - - - - 0x008532 02:8522: 38        SEC
C - - - - - 0x008533 02:8523: F5 77     SBC ram_obj_pos_X_lo,X
C - - - - - 0x008535 02:8525: 85 29     STA ram_0029_t2E_pos_X_lo
C - - - - - 0x008537 02:8527: B9 80 00  LDA a: ram_obj_pos_X_hi,Y
C - - - - - 0x00853A 02:852A: F5 80     SBC ram_obj_pos_X_hi,X
C - - - - - 0x00853C 02:852C: B0 11     BCS bra_853F
C - - - - - 0x00853E 02:852E: BC 4A 04  LDY ram_044A_obj,X
C - - - - - 0x008541 02:8531: A9 C0     LDA #$C0
C - - - - - 0x008543 02:8533: 99 0F 03  STA ram_obj_direction,Y
C - - - - - 0x008546 02:8536: A5 29     LDA ram_0029_t2E_pos_X_lo
C - - - - - 0x008548 02:8538: 49 FF     EOR #$FF
C - - - - - 0x00854A 02:853A: 18        CLC
C - - - - - 0x00854B 02:853B: 69 01     ADC #$01
C - - - - - 0x00854D 02:853D: 85 29     STA ram_0029_t2E_pos_X_lo
bra_853F:
C - - - - - 0x00854F 02:853F: A5 29     LDA ram_0029_t2E_pos_X_lo
; / 10
...
C - - - - - 0x00857A 02:856A: 85 29     STA ram_0029_t2D_pos_X_lo
C - - - - - 0x00857C 02:856C: B5 63     LDA ram_0063_obj_facing,X
C - - - - - 0x00857E 02:856E: 10 09     BPL bra_8579
C - - - - - 0x008580 02:8570: A5 29     LDA ram_0029_t2D_pos_X_lo
C - - - - - 0x008582 02:8572: 49 FF     EOR #$FF
C - - - - - 0x008584 02:8574: 18        CLC
C - - - - - 0x008585 02:8575: 69 01     ADC #$01
C - - - - - 0x008587 02:8577: 85 29     STA ram_0029_t2D_pos_X_lo
bra_8579:
C - - - - - 0x008589 02:8579: 8A        TXA
C - - - - - 0x00858A 02:857A: A8        TAY
C - - - - - 0x00858B 02:857B: 20 EC 9F  JSR sub_9FEC
bra_857E:
C - - - - - 0x00858E 02:857E: A9 03     LDA #con_A48A_anim_03
C - - - - - 0x008590 02:8580: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x008593 02:8583: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x008595 02:8585: 29 01     AND #con_004A_flag_01
C - - - - - 0x008597 02:8587: F0 10     BEQ bra_8599_RTS
C - - - - - 0x008599 02:8589: B5 5C     LDA ram_obj_amim_cnt,X
C - - - - - 0x00859B 02:858B: C9 04     CMP #$04
C - - - - - 0x00859D 02:858D: 90 0A     BCC bra_8599_RTS
C - - - - - 0x00859F 02:858F: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x0085A1 02:8591: 29 FE     AND #con_004A_flag_01 ^ $FF
C - - - - - 0x0085A3 02:8593: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x0085A5 02:8595: A9 00     LDA #con_state_idle
C - - - - - 0x0085A7 02:8597: 95 43     STA ram_obj_state,X
bra_8599_RTS:
...
- D 0 - I - 0x0085B0 02:85A0: FE        .byte $FE   ; control byte
...
C - - - - - 0x0085C5 02:85B5: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x0085C7 02:85B7: 09 02     ORA #con_004A_flag_hair_grabbed
C - - - - - 0x0085C9 02:85B9: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x0085CB 02:85BB: A9 03     LDA #$03
C - - - - - 0x0085CD 02:85BD: 9D 16 03  STA ram_0316_obj,X
bra_85C0:
C - - - - - 0x0085D0 02:85C0: A9 04     LDA #con_A48A_anim_04
C - - - - - 0x0085D2 02:85C2: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
; bzk optimize, JMP
C - - - - - 0x0085D5 02:85C5: 20 4B 9E  JSR sub_9E4B_move_object
...
- D 0 - I - 0x0085DC 02:85CC: 8F        .byte con_state_doppelganger_invisible + $80   ; 
...
C - - - - - 0x0085E7 02:85D7: A9 7F     LDA #con_anim_id + $7F
C - - - - - 0x0085E9 02:85D9: 95 C7     STA ram_animation_id,X
C - - - - - 0x0085EB 02:85DB: A9 50     LDA #$50
C - - - - - 0x0085ED 02:85DD: 95 55     STA ram_obj_amim_dur,X
bra_85DF:
C - - - - - 0x0085EF 02:85DF: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x0085F1 02:85E1: D0 23     BNE bra_8606_RTS
C - - - - - 0x0085F3 02:85E3: BD 54 04  LDA ram_0454_obj_aim,X
C - - - - - 0x0085F6 02:85E6: A8        TAY
C - - - - - 0x0085F7 02:85E7: B9 43 00  LDA a: ram_obj_state,Y
C - - - - - 0x0085FA 02:85EA: 10 16     BPL bra_8602
C - - - - - 0x0085FC 02:85EC: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x0085FF 02:85EF: 29 C0     AND #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x008601 02:85F1: D0 0F     BNE bra_8602
C - - - - - 0x008603 02:85F3: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x008606 02:85F6: 09 02     ORA #con_004A_flag_hair_grabbed
C - - - - - 0x008608 02:85F8: 99 4A 00  STA a: ram_004A_obj_flags,Y
C - - - - - 0x00860B 02:85FB: A9 40     LDA #con_state_40
C - - - - - 0x00860D 02:85FD: 95 43     STA ram_obj_state,X
C - - - - - 0x00860F 02:85FF: 4C 06 86  JMP loc_8606_RTS
bra_8602:
C - - - - - 0x008612 02:8602: A9 10     LDA #con_state_doppelganger_spawn
C - - - - - 0x008614 02:8604: 95 43     STA ram_obj_state,X
bra_8606_RTS:
loc_8606_RTS:   ; bzk optimize
...
bra_8613:
C - - - - - 0x008623 02:8613: A9 05     LDA #con_A48A_anim_05
C - - - - - 0x008625 02:8615: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x008628 02:8618: B5 43     LDA ram_obj_state,X
C - - - - - 0x00862A 02:861A: D0 06     BNE bra_8622
C - - - - - 0x00862C 02:861C: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x00862E 02:861E: 29 FD     AND #con_004A_flag_hair_grabbed ^ $FF
C - - - - - 0x008630 02:8620: 95 4A     STA ram_004A_obj_flags,X
bra_8622:
; bzk optimize, JMP
C - - - - - 0x008632 02:8622: 20 4B 9E  JSR sub_9E4B_move_object
...
- D 0 - I - 0x008639 02:8629: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x00864B 02:863B: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x00864D 02:863D: A9 06     LDA #con_anim_id + $06
C - - - - - 0x00864F 02:863F: 95 C7     STA ram_animation_id,X
C - - - - - 0x008651 02:8641: BD 4A 04  LDA ram_044A_obj,X
C - - - - - 0x008654 02:8644: A8        TAY
C - - - - - 0x008655 02:8645: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x008658 02:8648: 29 A0     AND #con_004A_flag_knocked_down + con_004A_flag_20
C - - - - - 0x00865A 02:864A: D0 21     BNE bra_866D
C - - - - - 0x00865C 02:864C: C0 04     CPY #$04
C - - - - - 0x00865E 02:864E: 90 1D     BCC bra_866D
C - - - - - 0x008660 02:8650: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x008663 02:8653: 09 20     ORA #con_004A_flag_20
C - - - - - 0x008665 02:8655: 99 4A 00  STA a: ram_004A_obj_flags,Y
C - - - - - 0x008668 02:8658: A9 7F     LDA #con_state_hair_grabbed
C - - - - - 0x00866A 02:865A: 99 43 00  STA a: ram_obj_state,Y
...
bra_866D:
C - - - - - 0x00867D 02:866D: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x00867F 02:866F: D0 04     BNE bra_8675
C - - - - - 0x008681 02:8671: A9 00     LDA #con_state_idle
C - - - - - 0x008683 02:8673: 95 43     STA ram_obj_state,X
bra_8675:
; bzk optimize, JMP
C - - - - - 0x008685 02:8675: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x008695 02:8685: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x008697 02:8687: A9 06     LDA #con_anim_id + $06
C - - - - - 0x008699 02:8689: 95 C7     STA ram_animation_id,X
C - - - - - 0x00869B 02:868B: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x00869D 02:868D: 29 3F     AND #(con_004A_flag_stunned + con_004A_flag_knocked_down) ^ $FF
C - - - - - 0x00869F 02:868F: 95 4A     STA ram_004A_obj_flags,X
bra_8691:
C - - - - - 0x0086A1 02:8691: F6 55     INC ram_obj_amim_dur,X
C - - - - - 0x0086A3 02:8693: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x0086A5 02:8695: C9 08     CMP #$08
C - - - - - 0x0086A7 02:8697: 90 04     BCC bra_869D
C - - - - - 0x0086A9 02:8699: A9 00     LDA #con_state_idle
C - - - - - 0x0086AB 02:869B: 95 43     STA ram_obj_state,X
bra_869D:
; bzk optimize, JMP
C - - - - - 0x0086AD 02:869D: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x0086B7 02:86A7: 95 43     STA ram_obj_state,X
C - - - - - 0x0086B9 02:86A9: A9 05     LDA #con_anim_id + $05
C - - - - - 0x0086BB 02:86AB: 95 C7     STA ram_animation_id,X
C - - - - - 0x0086BD 02:86AD: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x0086BF 02:86AF: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x0086C1 02:86B1: 95 4A     STA ram_004A_obj_flags,X
bra_86B3:
C - - - - - 0x0086C3 02:86B3: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x0086C6 02:86B6: 20 73 A0  JSR sub_A073_check_for_max_gravity
C - - - - - 0x0086C9 02:86B9: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
C - - - - - 0x0086DC 02:86CC: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x0086DE 02:86CE: A9 07     LDA #con_anim_id + $07
C - - - - - 0x0086E0 02:86D0: 95 C7     STA ram_animation_id,X
C - - - - - 0x0086E2 02:86D2: 20 43 A4  JSR sub_A443
bra_86D5:
C - - - - - 0x0086E5 02:86D5: F6 55     INC ram_obj_amim_dur,X
C - - - - - 0x0086E7 02:86D7: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x0086E9 02:86D9: C9 06     CMP #$06
C - - - - - 0x0086EB 02:86DB: 90 04     BCC bra_86E1
C - - - - - 0x0086ED 02:86DD: A9 00     LDA #con_state_idle
C - - - - - 0x0086EF 02:86DF: 95 43     STA ram_obj_state,X
bra_86E1:
; bzk optimize, JMP
C - - - - - 0x0086F1 02:86E1: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x008701 02:86F1: A9 08     LDA #con_anim_id + $08
C - - - - - 0x008703 02:86F3: 95 C7     STA ram_animation_id,X
C - - - - - 0x008705 02:86F5: 20 43 A4  JSR sub_A443
bra_86F8:
C - - - - - 0x008708 02:86F8: F6 55     INC ram_obj_amim_dur,X
C - - - - - 0x00870A 02:86FA: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x00870C 02:86FC: C9 06     CMP #$06
C - - - - - 0x00870E 02:86FE: 90 04     BCC bra_8704
C - - - - - 0x008710 02:8700: A9 00     LDA #con_state_idle
C - - - - - 0x008712 02:8702: 95 43     STA ram_obj_state,X
bra_8704:
; bzk optimize, JMP
C - - - - - 0x008714 02:8704: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x008724 02:8714: A9 07     LDA #con_anim_id + $07
C - - - - - 0x008726 02:8716: 95 C7     STA ram_animation_id,X
C - - - - - 0x008728 02:8718: 20 43 A4  JSR sub_A443
bra_871B:
C - - - - - 0x00872B 02:871B: F6 55     INC ram_obj_amim_dur,X
C - - - - - 0x00872D 02:871D: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x00872F 02:871F: C9 06     CMP #$06
C - - - - - 0x008731 02:8721: 90 04     BCC bra_8727
C - - - - - 0x008733 02:8723: A9 18     LDA #con_state_18
C - - - - - 0x008735 02:8725: 95 43     STA ram_obj_state,X
bra_8727:
; bzk optimize, JMP
C - - - - - 0x008737 02:8727: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x008747 02:8737: A9 08     LDA #con_anim_id + $08
C - - - - - 0x008749 02:8739: 95 C7     STA ram_animation_id,X
C - - - - - 0x00874B 02:873B: 20 43 A4  JSR sub_A443
bra_873E:
C - - - - - 0x00874E 02:873E: F6 55     INC ram_obj_amim_dur,X
C - - - - - 0x008750 02:8740: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x008752 02:8742: C9 06     CMP #$06
C - - - - - 0x008754 02:8744: 90 04     BCC bra_874A
C - - - - - 0x008756 02:8746: A9 18     LDA #con_state_18
C - - - - - 0x008758 02:8748: 95 43     STA ram_obj_state,X
bra_874A:
; bzk optimize, JMP
C - - - - - 0x00875A 02:874A: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x00876A 02:875A: A9 09     LDA #con_anim_id + $09
C - - - - - 0x00876C 02:875C: 95 C7     STA ram_animation_id,X
C - - - - - 0x00876E 02:875E: 20 43 A4  JSR sub_A443
C - - - - - 0x008771 02:8761: A9 12     LDA #$12
C - - - - - 0x008773 02:8763: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x008775 02:8765: E0 02     CPX #$02
C - - - - - 0x008777 02:8767: B0 04     BCS bra_876D    ; if enemy
; if 1p or 2p
C - - - - - 0x008779 02:8769: A9 0A     LDA #$0A
C - - - - - 0x00877B 02:876B: 95 55     STA ram_obj_amim_dur,X
bra_876D:
C - - - - - 0x00877D 02:876D: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x00877F 02:876F: D0 04     BNE bra_8775
C - - - - - 0x008781 02:8771: A9 00     LDA #con_state_idle
C - - - - - 0x008783 02:8773: 95 43     STA ram_obj_state,X
bra_8775:
; bzk optimize, JMP
C - - - - - 0x008785 02:8775: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x008798 02:8788: A9 0A     LDA #con_anim_id + $0A
C - - - - - 0x00879A 02:878A: 95 C7     STA ram_animation_id,X
C - - - - - 0x00879C 02:878C: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x00879E 02:878E: 29 7F     AND #con_004A_flag_knocked_down ^ $FF
C - - - - - 0x0087A0 02:8790: 95 4A     STA ram_004A_obj_flags,X
...
C - - - - - 0x0087BE 02:87AE: A9 28     LDA #con_state_death_burnov
C - - - - - 0x0087C0 02:87B0: 95 43     STA ram_obj_state,X
C - - - - - 0x0087C2 02:87B2: 60        RTS
bra_87B3:
C - - - - - 0x0087C3 02:87B3: A9 26     LDA #con_state_death_normal
C - - - - - 0x0087C5 02:87B5: 95 43     STA ram_obj_state,X
; bzk optimize, JMP
C - - - - - 0x0087C7 02:87B7: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x0087CA 02:87BA: 60        RTS
bra_87BB_still_alive:
C - - - - - 0x0087CB 02:87BB: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x0087CD 02:87BD: D0 0A     BNE bra_87C9_still_lying_down
C - - - - - 0x0087CF 02:87BF: A9 12     LDA #con_state_land_after_jump
C - - - - - 0x0087D1 02:87C1: 95 43     STA ram_obj_state,X
C - - - - - 0x0087D3 02:87C3: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x0087D5 02:87C5: 29 3F     AND #(con_004A_flag_stunned + con_004A_flag_knocked_down) ^ $FF
C - - - - - 0x0087D7 02:87C7: 95 4A     STA ram_004A_obj_flags,X
bra_87C9_still_lying_down:
; bzk optimize, JMP
C - - - - - 0x0087D9 02:87C9: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x0087E4 02:87D4: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
C - - - - - 0x0087E7 02:87D7: 20 69 A0  JSR sub_A069
C - - - - - 0x0087EA 02:87DA: A9 02     LDA #$02
C - - - - - 0x0087EC 02:87DC: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x0087EF 02:87DF: A9 07     LDA #con_anim_id + $07
C - - - - - 0x0087F1 02:87E1: 95 C7     STA ram_animation_id,X
C - - - - - 0x0087F3 02:87E3: A9 03     LDA #$03
C - - - - - 0x0087F5 02:87E5: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x0087F8 02:87E8: A9 C0     LDA #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x0087FA 02:87EA: 15 4A     ORA ram_004A_obj_flags,X
C - - - - - 0x0087FC 02:87EC: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x0087FE 02:87EE: A9 04     LDA #$04
C - - - - - 0x008800 02:87F0: 20 D9 9D  JSR sub_9DD9_increase_Z_pos
C - - - - - 0x008803 02:87F3: A9 04     LDA #$04
C - - - - - 0x008805 02:87F5: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x008807 02:87F7: 20 51 A0  JSR sub_A051
C - - - - - 0x00880A 02:87FA: A9 C0     LDA #$C0
C - - - - - 0x00880C 02:87FC: 9D 2D 03  STA ram_032D_obj,X
bra_87FF:
loc_87FF:
C D 0 - - - 0x00880F 02:87FF: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x008811 02:8801: D0 04     BNE bra_8807
C - - - - - 0x008813 02:8803: A9 0B     LDA #con_anim_id + $0B
C - - - - - 0x008815 02:8805: 95 C7     STA ram_animation_id,X
bra_8807:
C - - - - - 0x008817 02:8807: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
loc_880A:
C D 0 - - - 0x00881A 02:880A: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
C - - - - - 0x008828 02:8818: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
C - - - - - 0x00882B 02:881B: 20 69 A0  JSR sub_A069
C - - - - - 0x00882E 02:881E: A9 03     LDA #$03
C - - - - - 0x008830 02:8820: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x008833 02:8823: A9 07     LDA #con_anim_id + $07
C - - - - - 0x008835 02:8825: 95 C7     STA ram_animation_id,X
C - - - - - 0x008837 02:8827: A9 05     LDA #$05
C - - - - - 0x008839 02:8829: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x00883C 02:882C: A9 C0     LDA #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x00883E 02:882E: 15 4A     ORA ram_004A_obj_flags,X
C - - - - - 0x008840 02:8830: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x008842 02:8832: A9 06     LDA #$06
C - - - - - 0x008844 02:8834: 20 D9 9D  JSR sub_9DD9_increase_Z_pos
...
C - - - - - 0x008851 02:8841: 95 55     STA ram_obj_amim_dur,X
bra_8843:
...
C - - - - - 0x00885D 02:884D: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
C - - - - - 0x008860 02:8850: 20 69 A0  JSR sub_A069
C - - - - - 0x008863 02:8853: A9 04     LDA #$04
C - - - - - 0x008865 02:8855: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x008868 02:8858: A9 07     LDA #con_anim_id + $07
C - - - - - 0x00886A 02:885A: 95 C7     STA ram_animation_id,X
C - - - - - 0x00886C 02:885C: A9 06     LDA #$06
C - - - - - 0x00886E 02:885E: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x008871 02:8861: A9 C0     LDA #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x008873 02:8863: 15 4A     ORA ram_004A_obj_flags,X
C - - - - - 0x008875 02:8865: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x008877 02:8867: A9 08     LDA #$08
C - - - - - 0x008879 02:8869: 20 D9 9D  JSR sub_9DD9_increase_Z_pos
...
C - - - - - 0x008886 02:8876: 95 55     STA ram_obj_amim_dur,X
bra_8878:
...
C - - - - - 0x008892 02:8882: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
C - - - - - 0x008895 02:8885: 20 69 A0  JSR sub_A069
C - - - - - 0x008898 02:8888: A9 06     LDA #$06
C - - - - - 0x00889A 02:888A: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x00889D 02:888D: A9 07     LDA #con_anim_id + $07
C - - - - - 0x00889F 02:888F: 95 C7     STA ram_animation_id,X
C - - - - - 0x0088A1 02:8891: A9 08     LDA #$08
C - - - - - 0x0088A3 02:8893: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x0088A6 02:8896: A9 C0     LDA #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x0088A8 02:8898: 15 4A     ORA ram_004A_obj_flags,X
C - - - - - 0x0088AA 02:889A: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x0088AC 02:889C: A9 0C     LDA #$0C
C - - - - - 0x0088AE 02:889E: 20 D9 9D  JSR sub_9DD9_increase_Z_pos
C - - - - - 0x0088B1 02:88A1: 20 51 A0  JSR sub_A051
C - - - - - 0x0088B4 02:88A4: A9 04     LDA #$04
C - - - - - 0x0088B6 02:88A6: 95 55     STA ram_obj_amim_dur,X
bra_88A8:
...
C - - - - - 0x0088C2 02:88B2: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
...
C - - - - - 0x0088CF 02:88BF: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x0088D2 02:88C2: A9 C0     LDA #$C0    ; con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x0088D4 02:88C4: 9D 2D 03  STA ram_032D_obj,X
C - - - - - 0x0088D7 02:88C7: 15 4A     ORA ram_004A_obj_flags,X
C - - - - - 0x0088D9 02:88C9: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x0088DB 02:88CB: A9 0C     LDA #$0C
C - - - - - 0x0088DD 02:88CD: 20 D9 9D  JSR sub_9DD9_increase_Z_pos
...
C - - - - - 0x0088E9 02:88D9: A9 0B     LDA #con_anim_id + $0B
C - - - - - 0x0088EB 02:88DB: 95 C7     STA ram_animation_id,X
C - - - - - 0x0088ED 02:88DD: 20 5F A0  JSR sub_A05F
C - - - - - 0x0088F0 02:88E0: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
bra_88E3:
...
C - - - - - 0x0088F9 02:88E9: A0 07     LDY #con_A48A_anim_07
C - - - - - 0x0088FB 02:88EB: C9 0C     CMP #$0C
C - - - - - 0x0088FD 02:88ED: F0 02     BEQ bra_88F1
C - - - - - 0x0088FF 02:88EF: A0 06     LDY #con_A48A_anim_06
bra_88F1:
C - - - - - 0x008901 02:88F1: 98        TYA
C - - - - - 0x008902 02:88F2: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x008905 02:88F5: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x008907 02:88F7: C9 7F     CMP #$7F
C - - - - - 0x008909 02:88F9: D0 06     BNE bra_8901
C - - - - - 0x00890B 02:88FB: 20 5F A0  JSR sub_A05F
C - - - - - 0x00890E 02:88FE: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
bra_8901:
...
C - - - - - 0x008924 02:8914: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
C - - - - - 0x008927 02:8917: 20 69 A0  JSR sub_A069
C - - - - - 0x00892A 02:891A: A9 02     LDA #$02
C - - - - - 0x00892C 02:891C: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x00892F 02:891F: A9 07     LDA #con_anim_id + $07
C - - - - - 0x008931 02:8921: 95 C7     STA ram_animation_id,X
C - - - - - 0x008933 02:8923: A9 09     LDA #$09
C - - - - - 0x008935 02:8925: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x008938 02:8928: A9 C0     LDA #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x00893A 02:892A: 15 4A     ORA ram_004A_obj_flags,X
C - - - - - 0x00893C 02:892C: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x00893E 02:892E: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x008941 02:8931: A9 04     LDA #$04
C - - - - - 0x008943 02:8933: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x008945 02:8935: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x008957 02:8947: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
C - - - - - 0x00895A 02:894A: 20 69 A0  JSR sub_A069
C - - - - - 0x00895D 02:894D: A9 10     LDA #$10
C - - - - - 0x00895F 02:894F: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x008962 02:8952: A9 07     LDA #con_anim_id + $07
C - - - - - 0x008964 02:8954: 95 C7     STA ram_animation_id,X
C - - - - - 0x008966 02:8956: A9 06     LDA #$06
C - - - - - 0x008968 02:8958: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x00896B 02:895B: A9 C0     LDA #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x00896D 02:895D: 15 4A     ORA ram_004A_obj_flags,X
C - - - - - 0x00896F 02:895F: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x008971 02:8961: 20 51 A0  JSR sub_A051
C - - - - - 0x008974 02:8964: A9 04     LDA #$04
C - - - - - 0x008976 02:8966: 95 55     STA ram_obj_amim_dur,X
bra_8968:
C - - - - - 0x008978 02:8968: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x00897A 02:896A: D0 04     BNE bra_8970
C - - - - - 0x00897C 02:896C: A9 0B     LDA #con_anim_id + $0B
C - - - - - 0x00897E 02:896E: 95 C7     STA ram_animation_id,X
bra_8970:
C - - - - - 0x008980 02:8970: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x008983 02:8973: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
C - - - - - 0x008991 02:8981: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
C - - - - - 0x008994 02:8984: 20 69 A0  JSR sub_A069
C - - - - - 0x008997 02:8987: A9 02     LDA #$02
C - - - - - 0x008999 02:8989: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x00899C 02:898C: A9 07     LDA #con_anim_id + $07
C - - - - - 0x00899E 02:898E: 95 C7     STA ram_animation_id,X
C - - - - - 0x0089A0 02:8990: A9 0B     LDA #$0B
C - - - - - 0x0089A2 02:8992: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x0089A5 02:8995: A9 C0     LDA #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x0089A7 02:8997: 15 4A     ORA ram_004A_obj_flags,X
C - - - - - 0x0089A9 02:8999: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x0089AB 02:899B: 20 51 A0  JSR sub_A051
C - - - - - 0x0089AE 02:899E: A9 08     LDA #$08
C - - - - - 0x0089B0 02:89A0: 95 55     STA ram_obj_amim_dur,X
bra_89A2:
C - - - - - 0x0089B2 02:89A2: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x0089B4 02:89A4: D0 04     BNE bra_89AA
C - - - - - 0x0089B6 02:89A6: A9 0B     LDA #con_anim_id + $0B
C - - - - - 0x0089B8 02:89A8: 95 C7     STA ram_animation_id,X
bra_89AA:
C - - - - - 0x0089BA 02:89AA: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x0089BD 02:89AD: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
C - - - - - 0x0089CB 02:89BB: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
C - - - - - 0x0089CE 02:89BE: 20 69 A0  JSR sub_A069
C - - - - - 0x0089D1 02:89C1: A9 05     LDA #$05
C - - - - - 0x0089D3 02:89C3: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x0089D6 02:89C6: A9 07     LDA #con_anim_id + $07
C - - - - - 0x0089D8 02:89C8: 95 C7     STA ram_animation_id,X
C - - - - - 0x0089DA 02:89CA: A9 0A     LDA #$0A
C - - - - - 0x0089DC 02:89CC: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x0089DF 02:89CF: A9 C0     LDA #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x0089E1 02:89D1: 15 4A     ORA ram_004A_obj_flags,X
C - - - - - 0x0089E3 02:89D3: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x0089E5 02:89D5: A9 04     LDA #$04
C - - - - - 0x0089E7 02:89D7: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x0089E9 02:89D9: 20 51 A0  JSR sub_A051
bra_89DC:
C - - - - - 0x0089EC 02:89DC: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x0089EE 02:89DE: D0 04     BNE bra_89E4
C - - - - - 0x0089F0 02:89E0: A9 0B     LDA #con_anim_id + $0B
C - - - - - 0x0089F2 02:89E2: 95 C7     STA ram_animation_id,X
bra_89E4:
C - - - - - 0x0089F4 02:89E4: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x0089F7 02:89E7: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
C - - - - - 0x008A05 02:89F5: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
C - - - - - 0x008A08 02:89F8: 20 69 A0  JSR sub_A069
C - - - - - 0x008A0B 02:89FB: A9 00     LDA #$00
C - - - - - 0x008A0D 02:89FD: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x008A10 02:8A00: A9 07     LDA #con_anim_id + $07
C - - - - - 0x008A12 02:8A02: 95 C7     STA ram_animation_id,X
C - - - - - 0x008A14 02:8A04: A9 C0     LDA #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x008A16 02:8A06: 15 4A     ORA ram_004A_obj_flags,X
C - - - - - 0x008A18 02:8A08: 95 4A     STA ram_004A_obj_flags,X
bra_8A0A:
C - - - - - 0x008A1A 02:8A0A: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x008A1D 02:8A0D: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
C - - - - - 0x008A2B 02:8A1B: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x008A2D 02:8A1D: 09 40     ORA #con_004A_flag_stunned
C - - - - - 0x008A2F 02:8A1F: 95 4A     STA ram_004A_obj_flags,X
bra_8A21:
C - - - - - 0x008A31 02:8A21: A9 08     LDA #con_A48A_anim_08
C - - - - - 0x008A33 02:8A23: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x008A36 02:8A26: B5 C7     LDA ram_animation_id,X
C - - - - - 0x008A38 02:8A28: 29 7F     AND #$7F
C - - - - - 0x008A3A 02:8A2A: C9 39     CMP #con_anim_id + $39
C - - - - - 0x008A3C 02:8A2C: D0 0B     BNE bra_8A39_RTS
C - - - - - 0x008A3E 02:8A2E: B5 55     LDA ram_obj_amim_dur,X
...
- D 0 - I - 0x008A5C 02:8A4C: 9A        .byte con_state_1A + $80   ; 
...
C - - - - - 0x008A76 02:8A66: A9 00     LDA #con_state_idle
C - - - - - 0x008A78 02:8A68: 95 43     STA ram_obj_state,X
...
C - - - - - 0x008A8D 02:8A7D: A9 03     LDA #con_063F_01 + con_063F_02
C - - - - - 0x008A8F 02:8A7F: 8D 3F 06  STA ram_063F_flags
bra_8A82:
C - - - - - 0x008A92 02:8A82: E0 02     CPX #$02
C - - - - - 0x008A94 02:8A84: B0 29     BCS bra_8AAF    ; if enemy
; if 1p or 2p
...
C - - - - - 0x008AA0 02:8A90: C9 06     CMP #con_0361_06
C - - - - - 0x008AA2 02:8A92: F0 11     BEQ bra_8AA5
C - - - - - 0x008AA4 02:8A94: BD E0 03  LDA ram_03E0_obj,X
C - - - - - 0x008AA7 02:8A97: C9 02     CMP #$02
C - - - - - 0x008AA9 02:8A99: B0 0A     BCS bra_8AA5    ; if enemy
; if player was killed by another player, increase his lives
...
; bzk bug? should be LDA #$00 ?
; 00 is written to 0000 at 0x014692
- - - - - - 0x008ABA 02:8AAA: A5 00     LDA ram_0000_se_temp
...
bra_8AC3:
C - - - - - 0x008AD3 02:8AC3: F6 55     INC ram_obj_amim_dur,X
C - - - - - 0x008AD5 02:8AC5: B5 5C     LDA ram_obj_amim_cnt,X
C - - - - - 0x008AD7 02:8AC7: C9 0A     CMP #$0A
C - - - - - 0x008AD9 02:8AC9: 90 0B     BCC bra_8AD6
C - - - - - 0x008ADB 02:8ACB: A9 7F     LDA #con_003C_flag_exist ^ $FF
C - - - - - 0x008ADD 02:8ACD: 35 3C     AND ram_003C_obj_flags,X ; 003C 003D 003E 003F 0040
C - - - - - 0x008ADF 02:8ACF: 95 3C     STA ram_003C_obj_flags,X ; 003C 003D 003E 003F 0040
...
C - - - - - 0x008AEA 02:8ADA: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x008AEC 02:8ADC: C9 05     CMP #$05
C - - - - - 0x008AEE 02:8ADE: 90 1E     BCC bra_8AFE
C - - - - - 0x008AF0 02:8AE0: A9 0A     LDA #con_anim_id + $0A
C - - - - - 0x008AF2 02:8AE2: 95 C7     STA ram_animation_id,X
C - - - - - 0x008AF4 02:8AE4: A9 00     LDA #$00
C - - - - - 0x008AF6 02:8AE6: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x008AF8 02:8AE8: F6 5C     INC ram_obj_amim_cnt,X
; bzk optimize, JMP
C - - - - - 0x008AFA 02:8AEA: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x008AFD 02:8AED: 60        RTS
bra_8AEE:
C - - - - - 0x008AFE 02:8AEE: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x008B00 02:8AF0: C9 03     CMP #$03
C - - - - - 0x008B02 02:8AF2: 90 0A     BCC bra_8AFE
C - - - - - 0x008B04 02:8AF4: A9 7F     LDA #con_anim_id + $7F
C - - - - - 0x008B06 02:8AF6: 95 C7     STA ram_animation_id,X
C - - - - - 0x008B08 02:8AF8: A9 00     LDA #$00
C - - - - - 0x008B0A 02:8AFA: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x008B0C 02:8AFC: F6 5C     INC ram_obj_amim_cnt,X
bra_8AFE:
; bzk optimize, JMP
C - - - - - 0x008B0E 02:8AFE: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x008B11 02:8B01: 60        RTS
bra_8B02:
C - - - - - 0x008B12 02:8B02: A9 09     LDA #con_A48A_anim_09
C - - - - - 0x008B14 02:8B04: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
loc_8B07:
C D 0 - - - 0x008B17 02:8B07: B5 43     LDA ram_obj_state,X
C - - - - - 0x008B19 02:8B09: 29 7F     AND #$7F
C - - - - - 0x008B1B 02:8B0B: C9 7F     CMP #con_state_hair_grabbed
C - - - - - 0x008B1D 02:8B0D: D0 0A     BNE bra_8B19_RTS
C - - - - - 0x008B1F 02:8B0F: B5 3C     LDA ram_003C_obj_flags,X ; 003E
C - - - - - 0x008B21 02:8B11: 29 7F     AND #con_003C_flag_exist ^ $FF
C - - - - - 0x008B23 02:8B13: 95 3C     STA ram_003C_obj_flags,X ; 003E
C - - - - - 0x008B25 02:8B15: A9 7F     LDA #con_anim_id + $7F
...
- D 0 - I - 0x008B2B 02:8B1B: FF        .byte con_state_hair_grabbed + $80   ; 
...
loc_8B1D:
C D 0 - - - 0x008B2D 02:8B1D: A9 0A     LDA #con_A48A_anim_0A
C - - - - - 0x008B2F 02:8B1F: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x008B3C 02:8B2C: FF        .byte con_state_hair_grabbed + $80   ; 
...
loc_8B34:
C D 0 - - - 0x008B44 02:8B34: A9 3E     LDA #con_A48A_anim_3E
C - - - - - 0x008B46 02:8B36: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x008B4D 02:8B3D: FF        .byte con_state_hair_grabbed + $80   ; 
...
; if enemy
C - - - - - 0x008B5A 02:8B4A: A9 00     LDA #$00
C - - - - - 0x008B5C 02:8B4C: 95 BF     STA ram_obj_id,X
bra_8B4E:
C - - - - - 0x008B5E 02:8B4E: A9 30     LDA #con_anim_id + $30
C - - - - - 0x008B60 02:8B50: 95 C7     STA ram_animation_id,X
C - - - - - 0x008B62 02:8B52: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x008B64 02:8B54: 29 7F     AND #con_004A_flag_knocked_down ^ $FF
C - - - - - 0x008B66 02:8B56: 09 40     ORA #con_004A_flag_stunned
C - - - - - 0x008B68 02:8B58: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x008B6A 02:8B5A: A9 43     LDA #con_sfx_fall_in_water
C - - - - - 0x008B6C 02:8B5C: 20 06 C0  JSR sub_0x01C016_play_sound
bra_8B5F:
C - - - - - 0x008B6F 02:8B5F: A9 0B     LDA #con_A48A_anim_0B
C - - - - - 0x008B71 02:8B61: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x008B74 02:8B64: B5 43     LDA ram_obj_state,X
C - - - - - 0x008B76 02:8B66: C9 7F     CMP #con_state_hair_grabbed
C - - - - - 0x008B78 02:8B68: D0 1B     BNE bra_8B85_RTS
C - - - - - 0x008B7A 02:8B6A: A9 7F     LDA #con_anim_id + $7F
C - - - - - 0x008B7C 02:8B6C: 95 C7     STA ram_animation_id,X
C - - - - - 0x008B7E 02:8B6E: A9 00     LDA #$00    ; con_003C_flag_00
C - - - - - 0x008B80 02:8B70: 95 3C     STA ram_003C_obj_flags,X ; 003C 003E 003F
C - - - - - 0x008B82 02:8B72: 9D 1E 04  STA ram_hp,X
C - - - - - 0x008B85 02:8B75: B5 BF     LDA ram_obj_id,X
C - - - - - 0x008B87 02:8B77: E0 02     CPX #$02
C - - - - - 0x008B89 02:8B79: B0 0A     BCS bra_8B85_RTS    ; if enemy
; if 1p or 2p
...
- D 0 - I - 0x008B9E 02:8B8E: FF        .byte con_state_hair_grabbed + $80   ; 
...
C - - - - - 0x008BAE 02:8B9E: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x008BB0 02:8BA0: 09 02     ORA #con_004A_flag_hair_grabbed
C - - - - - 0x008BB2 02:8BA2: 95 4A     STA ram_004A_obj_flags,X
bra_8BA4:
C - - - - - 0x008BB4 02:8BA4: B5 C7     LDA ram_animation_id,X
C - - - - - 0x008BB6 02:8BA6: 29 7F     AND #$7F
C - - - - - 0x008BB8 02:8BA8: C9 02     CMP #con_anim_id + $02
C - - - - - 0x008BBA 02:8BAA: D0 11     BNE bra_8BBD
C - - - - - 0x008BBC 02:8BAC: B5 55     LDA ram_obj_amim_dur,X
...
C - - - - - 0x008BD1 02:8BC1: C9 17     CMP #con_anim_id + $17
...
bra_8BCA:
C - - - - - 0x008BDA 02:8BCA: A9 0C     LDA #con_A48A_anim_0C
; bzk optimize, JMP
C - - - - - 0x008BDC 02:8BCC: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x008BEE 02:8BDE: A9        .byte con_state_burnov_helmet + $80   ; 
...
C - - - - - 0x008C03 02:8BF3: 95 43     STA ram_obj_state,X
C - - - - - 0x008C05 02:8BF5: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x008C07 02:8BF7: B5 4A     LDA ram_004A_obj_flags,X  ; bzk optimize, the same LDA
C - - - - - 0x008C09 02:8BF9: 29 FD     AND #con_004A_flag_hair_grabbed ^ $FF
C - - - - - 0x008C0B 02:8BFB: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x008C0D 02:8BFD: A9 20     LDA #$20
C - - - - - 0x008C0F 02:8BFF: 95 55     STA ram_obj_amim_dur,X
bra_8C01:
C - - - - - 0x008C11 02:8C01: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x008C13 02:8C03: D0 06     BNE bra_8C0B_RTS
C - - - - - 0x008C15 02:8C05: B5 3C     LDA ram_003C_obj_flags,X ; 003E
C - - - - - 0x008C17 02:8C07: 09 40     ORA #con_003C_flag_40
C - - - - - 0x008C19 02:8C09: 95 3C     STA ram_003C_obj_flags,X ; 003E
bra_8C0B_RTS:
...
C - - - - - 0x008C23 02:8C13: B5 3C     LDA ram_003C_obj_flags,X ; 003E
C - - - - - 0x008C25 02:8C15: 29 BF     AND #con_003C_flag_40 ^ $FF
C - - - - - 0x008C27 02:8C17: 95 3C     STA ram_003C_obj_flags,X ; 003E
C - - - - - 0x008C29 02:8C19: A9 4B     LDA #con_sfx_reappear
C - - - - - 0x008C2B 02:8C1B: 20 06 C0  JSR sub_0x01C016_play_sound
bra_8C1E:
C - - - - - 0x008C2E 02:8C1E: A9 0D     LDA #con_A48A_anim_0D
C - - - - - 0x008C30 02:8C20: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x008C33 02:8C23: B5 C7     LDA ram_animation_id,X
C - - - - - 0x008C35 02:8C25: 29 7F     AND #$7F
C - - - - - 0x008C37 02:8C27: C9 02     CMP #con_anim_id + $02
C - - - - - 0x008C39 02:8C29: D0 0C     BNE bra_8C37
C - - - - - 0x008C3B 02:8C2B: B5 55     LDA ram_obj_amim_dur,X
...
bra_8C37:
C - - - - - 0x008C47 02:8C37: B5 43     LDA ram_obj_state,X
C - - - - - 0x008C49 02:8C39: 29 7F     AND #$7F
C - - - - - 0x008C4B 02:8C3B: C9 00     CMP #con_state_idle
C - - - - - 0x008C4D 02:8C3D: D0 04     BNE bra_8C43_RTS
C - - - - - 0x008C4F 02:8C3F: A9 00     LDA #con_004A_flag_00
C - - - - - 0x008C51 02:8C41: 95 4A     STA ram_004A_obj_flags,X
bra_8C43_RTS:
...
- D 0 - I - 0x008C5D 02:8C4D: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x008C70 02:8C60: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x008C73 02:8C63: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x008C75 02:8C65: 09 C0     ORA #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x008C77 02:8C67: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x008C79 02:8C69: A9 0B     LDA #con_anim_id + $0B
...
bra_8C7D:
C - - - - - 0x008C8D 02:8C7D: A9 0E     LDA #con_A48A_anim_0E
; bzk optimize, JMP
C - - - - - 0x008C8F 02:8C7F: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x008C9B 02:8C8B: FF        .byte con_state_hair_grabbed + $80   ; 
...
bra_8CA5:
C - - - - - 0x008CB5 02:8CA5: A9 F1     LDA #< tbl_8CF1_animation_data
C - - - - - 0x008CB7 02:8CA7: 85 29     STA ram_0029_t08_animation_data
C - - - - - 0x008CB9 02:8CA9: A9 8C     LDA #> tbl_8CF1_animation_data
C - - - - - 0x008CBB 02:8CAB: 85 2A     STA ram_0029_t08_animation_data + $01
C - - - - - 0x008CBD 02:8CAD: BD C1 03  LDA ram_03C1_obj,X
C - - - - - 0x008CC0 02:8CB0: 29 02     AND #$02
C - - - - - 0x008CC2 02:8CB2: F0 08     BEQ bra_8CBC
C - - - - - 0x008CC4 02:8CB4: A9 F5     LDA #< tbl_8CF5_animation_data
C - - - - - 0x008CC6 02:8CB6: 85 29     STA ram_0029_t08_animation_data
C - - - - - 0x008CC8 02:8CB8: A9 8C     LDA #> tbl_8CF5_animation_data
C - - - - - 0x008CCA 02:8CBA: 85 2A     STA ram_0029_t08_animation_data + $01
bra_8CBC:
C - - - - - 0x008CCC 02:8CBC: A9 E5     LDA #< tbl_8CE5_animation_duration
C - - - - - 0x008CCE 02:8CBE: 85 2B     STA ram_002B_t01_anim_dur_data
C - - - - - 0x008CD0 02:8CC0: A9 8C     LDA #> tbl_8CE5_animation_duration
C - - - - - 0x008CD2 02:8CC2: 85 2C     STA ram_002B_t01_anim_dur_data + $01
C - - - - - 0x008CD4 02:8CC4: E0 02     CPX #$02
C - - - - - 0x008CD6 02:8CC6: 90 16     BCC bra_8CDE
; if enemy
C - - - - - 0x008CD8 02:8CC8: AD 34 00  LDA a: ram_game_mode
C - - - - - 0x008CDB 02:8CCB: 30 11     BMI bra_8CDE
; if not con_gm_2_players
C - - - - - 0x008CDD 02:8CCD: AC 22 04  LDY ram_mission_id_hi
C - - - - - 0x008CE0 02:8CD0: B9 F9 8C  LDA tbl_8CF9,Y
C - - - - - 0x008CE3 02:8CD3: 18        CLC
C - - - - - 0x008CE4 02:8CD4: 65 2B     ADC ram_002B_t01_anim_dur_data
C - - - - - 0x008CE6 02:8CD6: 85 2B     STA ram_002B_t01_anim_dur_data
C - - - - - 0x008CE8 02:8CD8: A5 2C     LDA ram_002B_t01_anim_dur_data + $01
C - - - - - 0x008CEA 02:8CDA: 69 00     ADC #$00
C - - - - - 0x008CEC 02:8CDC: 85 2C     STA ram_002B_t01_anim_dur_data + $01
bra_8CDE:
C - - - - - 0x008CEE 02:8CDE: 20 AB 9F  JSR sub_9FAB_set_next_animation
; bzk optimize, JMP
C - - - - - 0x008CF1 02:8CE1: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
_off000_8CF1_0F:
tbl_8CF1_animation_data:
- D 0 - I - 0x008D01 02:8CF1: 0C        .byte $0C   ; 
- D 0 - I - 0x008D02 02:8CF2: 0D        .byte $0D   ; 
- D 0 - I - 0x008D03 02:8CF3: 02        .byte $02   ; 
- D 0 - I - 0x008D04 02:8CF4: 80        .byte con_state_idle + $80   ; 



_off000_8CF5_10:
tbl_8CF5_animation_data:
- D 0 - I - 0x008D05 02:8CF5: 0E        .byte $0E   ; 
- D 0 - I - 0x008D06 02:8CF6: 0F        .byte $0F   ; 
- D 0 - I - 0x008D07 02:8CF7: 02        .byte $02   ; 
- D 0 - I - 0x008D08 02:8CF8: 80        .byte con_state_idle + $80   ; 



tbl_8CF9:
- D 0 - - - 0x008D09 02:8CF9: 09        .byte $09   ; 00 Into the Turf
- D 0 - - - 0x008D0A 02:8CFA: 09        .byte $09   ; 01 At the Heliport
- D 0 - - - 0x008D0B 02:8CFB: 09        .byte $09   ; 02 Battle in the Chopper
- D 0 - - - 0x008D0C 02:8CFC: 09        .byte $09   ; 03 Undersea Base, part 1
- - - - - - 0x008D0D 02:8CFD: 06        .byte $06   ; 04 Undersea Base, part 2
- D 0 - - - 0x008D0E 02:8CFE: 06        .byte $06   ; 05 Forest of Death
- D 0 - - - 0x008D0F 02:8CFF: 06        .byte $06   ; 06 Mansion of Terror
- - - - - - 0x008D10 02:8D00: 06        .byte $06   ; 07 Trap Room, part 1
- D 0 - - - 0x008D11 02:8D01: 03        .byte $03   ; 08 Trap Room, part 2
- - - - - - 0x008D12 02:8D02: 03        .byte $03   ; 09 Trap Room, part 3
- D 0 - - - 0x008D13 02:8D03: 03        .byte $03   ; 0A Trap Room, part 4
- D 0 - - - 0x008D14 02:8D04: 03        .byte $03   ; 0B Trap Room, part 5
- D 0 - - - 0x008D15 02:8D05: 00        .byte $00   ; 0C The Double Illusion
- - - - - - 0x008D16 02:8D06: 00        .byte $00   ; 0D Final Confrontation, part 1
- D 0 - - - 0x008D17 02:8D07: 00        .byte $00   ; 0E Final Confrontation, part 2
...
bra_8D0F:
C - - - - - 0x008D1F 02:8D0F: A9 11     LDA #con_A48A_anim_11
; bzk optimize, JMP
C - - - - - 0x008D21 02:8D11: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x008D28 02:8D18: 80        .byte con_state_idle + $80   ; 
...
bra_8D23:
C - - - - - 0x008D33 02:8D23: A9 12     LDA #con_A48A_anim_12
; bzk optimize, JMP
C - - - - - 0x008D35 02:8D25: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x008D41 02:8D31: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x008D4E 02:8D3E: A9 18     LDA #con_anim_id + $18
...
bra_8D47:
C - - - - - 0x008D57 02:8D47: F6 55     INC ram_obj_amim_dur,X
C - - - - - 0x008D59 02:8D49: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x008D5B 02:8D4B: C9 06     CMP #$06
C - - - - - 0x008D5D 02:8D4D: 90 04     BCC bra_8D53
C - - - - - 0x008D5F 02:8D4F: A9 00     LDA #con_state_idle
C - - - - - 0x008D61 02:8D51: 95 43     STA ram_obj_state,X
bra_8D53:
; bzk optimize, JMP
C - - - - - 0x008D63 02:8D53: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x008D79 02:8D69: B5 63     LDA ram_0063_obj_facing,X
C - - - - - 0x008D7B 02:8D6B: 49 80     EOR #$80
C - - - - - 0x008D7D 02:8D6D: 95 63     STA ram_0063_obj_facing,X
bra_8D6F:
C - - - - - 0x008D7F 02:8D6F: A9 13     LDA #con_A48A_anim_13
C - - - - - 0x008D81 02:8D71: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x008D84 02:8D74: B5 5C     LDA ram_obj_amim_cnt,X
C - - - - - 0x008D86 02:8D76: C9 04     CMP #$04
C - - - - - 0x008D88 02:8D78: D0 0A     BNE bra_8D84_RTS
C - - - - - 0x008D8A 02:8D7A: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x008D8C 02:8D7C: D0 06     BNE bra_8D84_RTS
C - - - - - 0x008D8E 02:8D7E: B5 63     LDA ram_0063_obj_facing,X
C - - - - - 0x008D90 02:8D80: 49 80     EOR #$80
C - - - - - 0x008D92 02:8D82: 95 63     STA ram_0063_obj_facing,X
bra_8D84_RTS:
...
- D 0 - I - 0x008D9D 02:8D8D: 80        .byte con_state_idle + $80   ; 
...
bra_8D95:
C - - - - - 0x008DA5 02:8D95: A9 14     LDA #con_A48A_anim_14
; bzk optimize, JMP
C - - - - - 0x008DA7 02:8D97: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x008DAE 02:8D9E: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x008DB7 02:8DA7: 95 43     STA ram_obj_state,X
C - - - - - 0x008DB9 02:8DA9: A9 00     LDA #$00
C - - - - - 0x008DBB 02:8DAB: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x008DBE 02:8DAE: 95 5C     STA ram_obj_amim_cnt,X
C - - - - - 0x008DC0 02:8DB0: 95 55     STA ram_obj_amim_dur,X
...
C - - - - - 0x008DCD 02:8DBD: B5 63     LDA ram_0063_obj_facing,X
C - - - - - 0x008DCF 02:8DBF: 49 80     EOR #$80
C - - - - - 0x008DD1 02:8DC1: 95 63     STA ram_0063_obj_facing,X
bra_8DC3:
C - - - - - 0x008DD3 02:8DC3: A9 15     LDA #con_A48A_anim_15
; bzk optimize, JMP
C - - - - - 0x008DD5 02:8DC5: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x008DDC 02:8DCC: 80        .byte con_state_idle + $80   ; 
...
bra_8DD7:
C - - - - - 0x008DE7 02:8DD7: A9 16     LDA #con_A48A_anim_16
C - - - - - 0x008DE9 02:8DD9: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x008DEC 02:8DDC: B5 C7     LDA ram_animation_id,X
C - - - - - 0x008DEE 02:8DDE: 29 7F     AND #$7F
C - - - - - 0x008DF0 02:8DE0: C9 04     CMP #con_anim_id + $04
C - - - - - 0x008DF2 02:8DE2: D0 0C     BNE bra_8DF0_RTS
C - - - - - 0x008DF4 02:8DE4: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x008DF6 02:8DE6: D0 08     BNE bra_8DF0_RTS
C - - - - - 0x008DF8 02:8DE8: BD 63 00  LDA a: ram_0063_obj_facing,X
C - - - - - 0x008DFB 02:8DEB: 49 80     EOR #$80
C - - - - - 0x008DFD 02:8DED: 9D 63 00  STA a: ram_0063_obj_facing,X
bra_8DF0_RTS:
...
- D 0 - I - 0x008E06 02:8DF6: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x008E13 02:8E03: A9 19     LDA #con_anim_id + $19
...
bra_8E0C:
C - - - - - 0x008E1C 02:8E0C: F6 55     INC ram_obj_amim_dur,X
C - - - - - 0x008E1E 02:8E0E: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x008E20 02:8E10: C9 08     CMP #$08
C - - - - - 0x008E22 02:8E12: 90 04     BCC bra_8E18
C - - - - - 0x008E24 02:8E14: A9 13     LDA #con_state_fall_after_action
C - - - - - 0x008E26 02:8E16: 95 43     STA ram_obj_state,X
bra_8E18:
C - - - - - 0x008E28 02:8E18: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x008E2B 02:8E1B: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
bra_8E29:
C - - - - - 0x008E39 02:8E29: A9 17     LDA #con_A48A_anim_17
; bzk optimize, JMP
C - - - - - 0x008E3B 02:8E2B: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x008E47 02:8E37: 80        .byte con_state_idle + $80   ; 
...
bra_8E47:
- - - - - - 0x008E57 02:8E47: A9 18     LDA #con_A48A_anim_18
- - - - - - 0x008E59 02:8E49: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
- - - - - - 0x008E5C 02:8E4C: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
- - - - - - 0x008E66 02:8E56: 93        .byte con_state_fall_after_action + $80   ; 
...
C - - - - - 0x008E73 02:8E63: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x008E76 02:8E66: A9 03     LDA #$03
C - - - - - 0x008E78 02:8E68: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x008E7B 02:8E6B: A9 80     LDA #con_004A_flag_knocked_down
C - - - - - 0x008E7D 02:8E6D: 15 4A     ORA ram_004A_obj_flags,X
C - - - - - 0x008E7F 02:8E6F: 95 4A     STA ram_004A_obj_flags,X
bra_8E71:
C - - - - - 0x008E81 02:8E71: A9 19     LDA #con_A48A_anim_19
...
- - - - - - 0x008E8A 02:8E7A: 93        .byte con_state_fall_after_action + $80   ; 
...
bra_8E87:
C - - - - - 0x008E97 02:8E87: A9 1A     LDA #con_A48A_anim_1A
; bzk optimize, JMP
C - - - - - 0x008E99 02:8E89: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x008EA5 02:8E95: 93        .byte con_state_fall_after_action + $80   ; 
...
C - - - - - 0x008EB5 02:8EA5: A9 18     LDA #con_anim_id + $18
C - - - - - 0x008EB7 02:8EA7: 95 C7     STA ram_animation_id,X
C - - - - - 0x008EB9 02:8EA9: A9 08     LDA #$08
C - - - - - 0x008EBB 02:8EAB: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x008EBD 02:8EAD: A9 04     LDA #$04
C - - - - - 0x008EBF 02:8EAF: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x008EC2 02:8EB2: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x008EC4 02:8EB4: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x008EC6 02:8EB6: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x008EC8 02:8EB8: A9 00     LDA #$00
C - - - - - 0x008ECA 02:8EBA: 9D 2D 03  STA ram_032D_obj,X
C - - - - - 0x008ECD 02:8EBD: A9 05     LDA #$05
C - - - - - 0x008ECF 02:8EBF: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x008ED2 02:8EC2: A9 1E     LDA #con_sfx_high_jump_kick
C - - - - - 0x008ED4 02:8EC4: 20 06 C0  JSR sub_0x01C016_play_sound
bra_8EC7:
C - - - - - 0x008ED7 02:8EC7: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x008ED9 02:8EC9: D0 0E     BNE bra_8ED9
C - - - - - 0x008EDB 02:8ECB: A9 80     LDA #$80
C - - - - - 0x008EDD 02:8ECD: 9D 2D 03  STA ram_032D_obj,X
C - - - - - 0x008EE0 02:8ED0: A9 13     LDA #con_state_fall_after_action
C - - - - - 0x008EE2 02:8ED2: 95 43     STA ram_obj_state,X
C - - - - - 0x008EE4 02:8ED4: A9 01     LDA #$01
C - - - - - 0x008EE6 02:8ED6: 9D 25 03  STA ram_obj_gravity_hi,X
bra_8ED9:
C - - - - - 0x008EE9 02:8ED9: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x008EEC 02:8EDC: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
bra_8EED:
C - - - - - 0x008EFD 02:8EED: A9 1B     LDA #con_A48A_anim_1B
C - - - - - 0x008EFF 02:8EEF: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x008F02 02:8EF2: B5 C7     LDA ram_animation_id,X
C - - - - - 0x008F04 02:8EF4: 29 7F     AND #$7F
C - - - - - 0x008F06 02:8EF6: C9 02     CMP #con_anim_id + $02
C - - - - - 0x008F08 02:8EF8: D0 0E     BNE bra_8F08
C - - - - - 0x008F0A 02:8EFA: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x008F0C 02:8EFC: C9 02     CMP #$02
C - - - - - 0x008F0E 02:8EFE: D0 08     BNE bra_8F08
C - - - - - 0x008F10 02:8F00: BD 63 00  LDA a: ram_0063_obj_facing,X
C - - - - - 0x008F13 02:8F03: 49 80     EOR #$80
C - - - - - 0x008F15 02:8F05: 9D 63 00  STA a: ram_0063_obj_facing,X
bra_8F08:
; bzk optimize, JMP
C - - - - - 0x008F18 02:8F08: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
- D 0 - I - 0x008F1F 02:8F0F: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x008F2E 02:8F1E: B9 35 8F  LDA tbl_8F39_animation_data - $04,Y
C - - - - - 0x008F31 02:8F21: 85 29     STA ram_0029_t08_animation_data
C - - - - - 0x008F33 02:8F23: B9 36 8F  LDA tbl_8F39_animation_data - $03,Y
C - - - - - 0x008F36 02:8F26: 85 2A     STA ram_0029_t08_animation_data + $01
C - - - - - 0x008F38 02:8F28: B9 43 8F  LDA tbl_8F47_animation_duration - $04,Y
C - - - - - 0x008F3B 02:8F2B: 85 2B     STA ram_002B_t01_anim_dur_data
C - - - - - 0x008F3D 02:8F2D: B9 44 8F  LDA tbl_8F47_animation_duration - $03,Y
C - - - - - 0x008F40 02:8F30: 85 2C     STA ram_002B_t01_anim_dur_data + $01
C - - - - - 0x008F42 02:8F32: 20 AB 9F  JSR sub_9FAB_set_next_animation
; bzk optimize, JMP
C - - - - - 0x008F45 02:8F35: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x008F48 02:8F38: 60        RTS


tbl_8F39_animation_data:
...
bra_8F66:
C - - - - - 0x008F76 02:8F66: A0 1C     LDY #con_A48A_anim_1C
C - - - - - 0x008F78 02:8F68: BD C1 03  LDA ram_03C1_obj,X
C - - - - - 0x008F7B 02:8F6B: 29 02     AND #$02
C - - - - - 0x008F7D 02:8F6D: D0 02     BNE bra_8F71
C - - - - - 0x008F7F 02:8F6F: A0 1D     LDY #con_A48A_anim_1D
bra_8F71:
C - - - - - 0x008F81 02:8F71: 98        TYA
C - - - - - 0x008F82 02:8F72: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x008F88 02:8F78: 80        .byte con_state_idle + $80   ; 
...
- D 0 - I - 0x008F8C 02:8F7C: 80        .byte con_state_idle + $80   ; 
...
bra_8F8C:
C - - - - - 0x008F9C 02:8F8C: A9 1E     LDA #con_A48A_anim_1E
C - - - - - 0x008F9E 02:8F8E: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x008FA1 02:8F91: B5 C7     LDA ram_animation_id,X
C - - - - - 0x008FA3 02:8F93: 29 7F     AND #$7F
C - - - - - 0x008FA5 02:8F95: C9 3F     CMP #con_anim_id + $3F
C - - - - - 0x008FA7 02:8F97: D0 3D     BNE bra_8FD6_RTS
C - - - - - 0x008FA9 02:8F99: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x008FAB 02:8F9B: C9 04     CMP #$04
C - - - - - 0x008FAD 02:8F9D: D0 37     BNE bra_8FD6_RTS
C - - - - - 0x008FAF 02:8F9F: A9 3A     LDA #con_sfx_doppelganger_fireball
...
C - - - - - 0x008FBD 02:8FAD: 20 66 A4  JSR sub_A466_copy_data_between_two_objects
C - - - - - 0x008FC0 02:8FB0: A9 70     LDA #con_state_70
C - - - - - 0x008FC2 02:8FB2: 99 43 00  STA a: ram_obj_state,Y
...
C - - - - - 0x008FD8 02:8FC8: 85 29     STA ram_0029_t2D_pos_X_lo
bra_8FCA:
C - - - - - 0x008FDA 02:8FCA: 20 EC 9F  JSR sub_9FEC
C - - - - - 0x008FDD 02:8FCD: B9 0F 03  LDA ram_obj_direction,Y
C - - - - - 0x008FE0 02:8FD0: 18        CLC
C - - - - - 0x008FE1 02:8FD1: 69 80     ADC #$80
C - - - - - 0x008FE3 02:8FD3: 99 0F 03  STA ram_obj_direction,Y
bra_8FD6_RTS:
...
- D 0 - I - 0x008FED 02:8FDD: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x008FFB 02:8FEB: BD 54 04  LDA ram_0454_obj_aim,X
C - - - - - 0x008FFE 02:8FEE: A8        TAY
C - - - - - 0x008FFF 02:8FEF: A9 24     LDA #con_state_24
C - - - - - 0x009001 02:8FF1: 99 43 00  STA a: ram_obj_state,Y
C - - - - - 0x009004 02:8FF4: A9 41     LDA #con_state_41
C - - - - - 0x009006 02:8FF6: 95 43     STA ram_obj_state,X
bra_8FF8_RTS:
...
bra_9000:
C - - - - - 0x009010 02:9000: BD 54 04  LDA ram_0454_obj_aim,X
C - - - - - 0x009013 02:9003: A8        TAY
C - - - - - 0x009014 02:9004: B9 43 00  LDA a: ram_obj_state,Y
C - - - - - 0x009017 02:9007: 29 7F     AND #$7F
C - - - - - 0x009019 02:9009: C9 24     CMP #con_state_24
C - - - - - 0x00901B 02:900B: F0 04     BEQ bra_9011_RTS
C - - - - - 0x00901D 02:900D: A9 10     LDA #con_state_doppelganger_spawn
C - - - - - 0x00901F 02:900F: 95 43     STA ram_obj_state,X
bra_9011_RTS:
...
C - - - - - 0x00905D 02:904D: A9 11     LDA #con_anim_id + $11
...
C - - - - - 0x00906D 02:905D: 20 66 A4  JSR sub_A466_copy_data_between_two_objects
C - - - - - 0x009070 02:9060: B9 BF 00  LDA a: ram_obj_id,Y
C - - - - - 0x009073 02:9063: A8        TAY
C - - - - - 0x009074 02:9064: B9 9D 90  LDA tbl_90AF_weapons_throw - $12,Y
C - - - - - 0x009077 02:9067: 85 1A     STA ram_001A_t07
C - - - - - 0x009079 02:9069: 68        PLA
C - - - - - 0x00907A 02:906A: A8        TAY
C - - - - - 0x00907B 02:906B: A5 1A     LDA ram_001A_t07
C - - - - - 0x00907D 02:906D: 99 43 00  STA a: ram_obj_state,Y
C - - - - - 0x009080 02:9070: 8A        TXA
C - - - - - 0x009081 02:9071: 99 4A 04  STA ram_044A_obj,Y
C - - - - - 0x009084 02:9074: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x009087 02:9077: 29 DF     AND #con_004A_flag_20 ^ $FF
C - - - - - 0x009089 02:9079: 99 4A 00  STA a: ram_004A_obj_flags,Y
C - - - - - 0x00908C 02:907C: A9 10     LDA #$10
C - - - - - 0x00908E 02:907E: 85 29     STA ram_0029_t2D_pos_X_lo
C - - - - - 0x009090 02:9080: BD 63 00  LDA a: ram_0063_obj_facing,X
...
C - - - - - 0x0090B1 02:90A1: 99 0F 03  STA ram_obj_direction,Y
C - - - - - 0x0090B4 02:90A4: 4C AB 90  JMP loc_90AB
bra_90A7:
C - - - - - 0x0090B7 02:90A7: A9 00     LDA #con_state_idle
C - - - - - 0x0090B9 02:90A9: 95 43     STA ram_obj_state,X
bra_90AB:
loc_90AB:
; bzk optimize, JMP
C D 0 - - - 0x0090BB 02:90AB: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x0090BE 02:90AE: 60        RTS



tbl_90AF_weapons_throw:
- D 0 - - - 0x0090BF 02:90AF: 6D        .byte con_state_6D   ; 12 con_obj_knife
- - - - - - 0x0090C0 02:90B0: 00        .byte con_state_idle   ; 13 con_obj_13
- D 0 - - - 0x0090C1 02:90B1: 6E        .byte con_state_6E   ; 14 con_obj_grenade
- - - - - - 0x0090C2 02:90B2: 00        .byte con_state_idle   ; 15 con_obj_chain_whip
...
- - - - - - 0x0090C5 02:90B5: 00        .byte con_state_idle   ; 18 con_obj_18
- - - - - - 0x0090C6 02:90B6: 00        .byte con_state_idle   ; 19 con_obj_19
- D 0 - - - 0x0090C7 02:90B7: 74        .byte con_state_74   ; 1A con_obj_boomerang
...
bra_90BF:
C - - - - - 0x0090CF 02:90BF: A9 1F     LDA #con_A48A_anim_1F
; bzk optimize, JMP
C - - - - - 0x0090D1 02:90C1: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x0090D8 02:90C8: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x0090E6 02:90D6: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x0090E8 02:90D8: 09 02     ORA #con_004A_flag_hair_grabbed
C - - - - - 0x0090EA 02:90DA: 95 4A     STA ram_004A_obj_flags,X
bra_90DC:
...
C - - - - - 0x009120 02:9110: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x009123 02:9113: 20 4B 9E  JSR sub_9E4B_move_object
C - - - - - 0x009126 02:9116: B5 43     LDA ram_obj_state,X
C - - - - - 0x009128 02:9118: C9 00     CMP #con_state_idle
C - - - - - 0x00912A 02:911A: D0 06     BNE bra_9122_RTS    ; bzk optimize, BEQ
C - - - - - 0x00912C 02:911C: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x00912E 02:911E: 29 FD     AND #con_004A_flag_hair_grabbed ^ $FF
C - - - - - 0x009130 02:9120: 95 4A     STA ram_004A_obj_flags,X
bra_9122_RTS:
...
- D 0 - I - 0x009139 02:9129: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x009152 02:9142: B9 5D 91  LDA tbl_915D_animation_data,Y
C - - - - - 0x009155 02:9145: 85 29     STA ram_0029_t08_animation_data
C - - - - - 0x009157 02:9147: B9 5E 91  LDA tbl_915D_animation_data + $01,Y
C - - - - - 0x00915A 02:914A: 85 2A     STA ram_0029_t08_animation_data + $01
C - - - - - 0x00915C 02:914C: B9 67 91  LDA tbl_9167_animation_duration,Y
C - - - - - 0x00915F 02:914F: 85 2B     STA ram_002B_t01_anim_dur_data
C - - - - - 0x009161 02:9151: B9 68 91  LDA tbl_9167_animation_duration + $01,Y
C - - - - - 0x009164 02:9154: 85 2C     STA ram_002B_t01_anim_dur_data + $01
C - - - - - 0x009166 02:9156: 20 AB 9F  JSR sub_9FAB_set_next_animation
; bzk optimize, JMP
C - - - - - 0x009169 02:9159: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x00916C 02:915C: 60        RTS



tbl_915D_animation_data:
...
bra_9185:
- - - - - - 0x009195 02:9185: A9 21     LDA #con_A48A_anim_21
; bzk optimize, JMP
- - - - - - 0x009197 02:9187: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- - - - - - 0x00919D 02:918D: 80        .byte con_state_idle + $80   ; 
...
bra_9197:
C - - - - - 0x0091A7 02:9197: A9 22     LDA #con_A48A_anim_22
C - - - - - 0x0091A9 02:9199: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x0091AC 02:919C: B5 C7     LDA ram_animation_id,X
C - - - - - 0x0091AE 02:919E: 29 7F     AND #$7F
C - - - - - 0x0091B0 02:91A0: C9 10     CMP #con_anim_id + $10
C - - - - - 0x0091B2 02:91A2: D0 28     BNE bra_91CC_RTS
C - - - - - 0x0091B4 02:91A4: B5 55     LDA ram_obj_amim_dur,X
C - - - - - 0x0091B6 02:91A6: C9 08     CMP #$08
C - - - - - 0x0091B8 02:91A8: D0 22     BNE bra_91CC_RTS
C - - - - - 0x0091BA 02:91AA: BD 63 00  LDA a: ram_0063_obj_facing,X
C - - - - - 0x0091BD 02:91AD: 10 10     BPL bra_91BF
C - - - - - 0x0091BF 02:91AF: B5 77     LDA ram_obj_pos_X_lo,X
C - - - - - 0x0091C1 02:91B1: 38        SEC
C - - - - - 0x0091C2 02:91B2: E9 14     SBC #< $0014
C - - - - - 0x0091C4 02:91B4: 95 77     STA ram_obj_pos_X_lo,X
C - - - - - 0x0091C6 02:91B6: B5 80     LDA ram_obj_pos_X_hi,X
C - - - - - 0x0091C8 02:91B8: E9 00     SBC #> $0014
C - - - - - 0x0091CA 02:91BA: 95 80     STA ram_obj_pos_X_hi,X
C - - - - - 0x0091CC 02:91BC: 4C CC 91  JMP loc_91CC_RTS
bra_91BF:
C - - - - - 0x0091CF 02:91BF: B5 77     LDA ram_obj_pos_X_lo,X
C - - - - - 0x0091D1 02:91C1: 18        CLC
C - - - - - 0x0091D2 02:91C2: 69 14     ADC #< $0014
C - - - - - 0x0091D4 02:91C4: 95 77     STA ram_obj_pos_X_lo,X
C - - - - - 0x0091D6 02:91C6: B5 80     LDA ram_obj_pos_X_hi,X
C - - - - - 0x0091D8 02:91C8: 69 00     ADC #> $0014
C - - - - - 0x0091DA 02:91CA: 95 80     STA ram_obj_pos_X_hi,X
bra_91CC_RTS:
loc_91CC_RTS:   ; bzk optimize
...
- D 0 - I - 0x0091DF 02:91CF: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x0091F0 02:91E0: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x0091F3 02:91E3: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x0091F5 02:91E5: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x0091F7 02:91E7: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x0091F9 02:91E9: A9 37     LDA #con_sfx_somersault
C - - - - - 0x0091FB 02:91EB: 20 06 C0  JSR sub_0x01C016_play_sound
bra_91EE:
C - - - - - 0x0091FE 02:91EE: A9 23     LDA #con_A48A_anim_23
C - - - - - 0x009200 02:91F0: 20 D2 9F  JSR sub_9FD2
C - - - - - 0x009203 02:91F3: A6 19     LDX ram_0019_t03_obj_index
C - - - - - 0x009205 02:91F5: BD 54 04  LDA ram_0454_obj_aim,X
...
- - - - - - 0x009212 02:9202: 93        .byte con_state_fall_after_action + $80   ; 
...
C - - - - - 0x009224 02:9214: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x009227 02:9217: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x009229 02:9219: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x00922B 02:921B: 95 4A     STA ram_004A_obj_flags,X
bra_921D:
C - - - - - 0x00922D 02:921D: A9 24     LDA #con_A48A_anim_24
...
- - - - - - 0x009237 02:9227: 93        .byte con_state_fall_after_action + $80   ; 
...
bra_9239:
C - - - - - 0x009249 02:9239: A9 25     LDA #con_A48A_anim_25
C - - - - - 0x00924B 02:923B: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x00924E 02:923E: 20 4B 9E  JSR sub_9E4B_move_object
C - - - - - 0x009251 02:9241: A6 19     LDX ram_0019_t03_obj_index
C - - - - - 0x009253 02:9243: B5 5C     LDA ram_obj_amim_cnt,X
C - - - - - 0x009255 02:9245: C9 06     CMP #$06
C - - - - - 0x009257 02:9247: 90 04     BCC bra_924D_RTS
- - - - - - 0x009259 02:9249: A9 04     LDA #$04
- - - - - - 0x00925B 02:924B: 95 5C     STA ram_obj_amim_cnt,X
bra_924D_RTS:
...
- D 0 - I - 0x009261 02:9251: FE        .byte $FE   ; control byte
...
C - - - - - 0x009271 02:9261: A9 06     LDA #con_anim_id + $06
C - - - - - 0x009273 02:9263: 95 C7     STA ram_animation_id,X
bra_9265:
; bzk optimize, JMP
C - - - - - 0x009275 02:9265: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
bra_9270:
C - - - - - 0x009280 02:9270: B5 55     LDA ram_obj_amim_dur,X
...
; bzk optimize, JMP
C - - - - - 0x0092B7 02:92A7: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x0092C4 02:92B4: 80        .byte con_state_idle + $80   ; 
...
bra_92D9:
C - - - - - 0x0092E9 02:92D9: B5 55     LDA ram_obj_amim_dur,X
...
C - - - - - 0x0092F3 02:92E3: C9 11     CMP #con_anim_id + $11
...
C - - - - - 0x009300 02:92F0: 20 66 A4  JSR sub_A466_copy_data_between_two_objects
C - - - - - 0x009303 02:92F3: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x009306 02:92F6: 29 DF     AND #con_004A_flag_20 ^ $FF
C - - - - - 0x009308 02:92F8: 99 4A 00  STA a: ram_004A_obj_flags,Y
C - - - - - 0x00930B 02:92FB: A9 02     LDA #$02
C - - - - - 0x00930D 02:92FD: 99 4A 04  STA ram_044A_obj,Y
C - - - - - 0x009310 02:9300: A9 68     LDA #con_state_68
C - - - - - 0x009312 02:9302: 99 43 00  STA a: ram_obj_state,Y
...
C - - - - - 0x009322 02:9312: 85 29     STA ram_0029_t2D_pos_X_lo
bra_9314:
C - - - - - 0x009324 02:9314: 20 EC 9F  JSR sub_9FEC
C - - - - - 0x009327 02:9317: B9 0F 03  LDA ram_obj_direction,Y
C - - - - - 0x00932A 02:931A: 18        CLC
C - - - - - 0x00932B 02:931B: 69 80     ADC #$80
C - - - - - 0x00932D 02:931D: 99 0F 03  STA ram_obj_direction,Y
bra_9320:
C - - - - - 0x009330 02:9320: A9 27     LDA #con_A48A_anim_27
; bzk optimize, JMP
C - - - - - 0x009332 02:9322: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x00933A 02:932A: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x009349 02:9339: B9 43 00  LDA a: ram_obj_state,Y
...
C - - - - - 0x009368 02:9358: A9 7F     LDA #$7F    ; con_state_hair_grabbed    con_anim_id + $7F
C - - - - - 0x00936A 02:935A: 99 43 00  STA a: ram_obj_state,Y
C - - - - - 0x00936D 02:935D: 99 C7 00  STA a: ram_animation_id,Y
C - - - - - 0x009370 02:9360: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x009373 02:9363: 09 02     ORA #con_004A_flag_hair_grabbed
C - - - - - 0x009375 02:9365: 99 4A 00  STA a: ram_004A_obj_flags,Y
C - - - - - 0x009378 02:9368: A9 23     LDA #con_anim_id + $23
C - - - - - 0x00937A 02:936A: 95 C7     STA ram_animation_id,X
C - - - - - 0x00937C 02:936C: A9 04     LDA #$04
C - - - - - 0x00937E 02:936E: 95 55     STA ram_obj_amim_dur,X
...
bra_9381:
C - - - - - 0x009391 02:9381: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x009393 02:9383: D0 08     BNE bra_938D
C - - - - - 0x009395 02:9385: A9 57     LDA #con_state_57
C - - - - - 0x009397 02:9387: 95 43     STA ram_obj_state,X
C - - - - - 0x009399 02:9389: A9 24     LDA #con_anim_id + $24
C - - - - - 0x00939B 02:938B: 95 C7     STA ram_animation_id,X
bra_938D:
; bzk optimize, JMP
C - - - - - 0x00939D 02:938D: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x0093AA 02:939A: A9 25     LDA #con_anim_id + $25
C - - - - - 0x0093AC 02:939C: 95 C7     STA ram_animation_id,X
C - - - - - 0x0093AE 02:939E: A9 05     LDA #$05
C - - - - - 0x0093B0 02:93A0: 95 55     STA ram_obj_amim_dur,X
...
bra_93C4:
C - - - - - 0x0093D4 02:93C4: D6 55     DEC ram_obj_amim_dur,X
...
C - - - - - 0x0093E1 02:93D1: C9 03     CMP #con_hair_grab_max_hit_counter
C - - - - - 0x0093E3 02:93D3: 90 50     BCC bra_9425
C - - - - - 0x0093E5 02:93D5: A9 00     LDA #con_state_idle
C - - - - - 0x0093E7 02:93D7: 95 43     STA ram_obj_state,X
C - - - - - 0x0093E9 02:93D9: A9 1B     LDA #con_state_1B
C - - - - - 0x0093EB 02:93DB: 99 43 00  STA a: ram_obj_state,Y
...
C - - - - - 0x0093F6 02:93E6: 20 66 A4  JSR sub_A466_copy_data_between_two_objects
C - - - - - 0x0093F9 02:93E9: A9 40     LDA #con_004A_flag_stunned
C - - - - - 0x0093FB 02:93EB: 99 4A 00  STA a: ram_004A_obj_flags,Y
C - - - - - 0x0093FE 02:93EE: A9 10     LDA #< $0010
C - - - - - 0x009400 02:93F0: 85 1B     STA ram_001B_t06_pos_X_lo
C - - - - - 0x009402 02:93F2: A9 00     LDA #> $0010
C - - - - - 0x009404 02:93F4: 85 1C     STA ram_001C_t03_pos_X_hi
C - - - - - 0x009406 02:93F6: B5 63     LDA ram_0063_obj_facing,X
C - - - - - 0x009408 02:93F8: 10 08     BPL bra_9402
C - - - - - 0x00940A 02:93FA: A9 F0     LDA #< $FFF0
C - - - - - 0x00940C 02:93FC: 85 1B     STA ram_001B_t06_pos_X_lo
C - - - - - 0x00940E 02:93FE: A9 FF     LDA #> $FFF0
C - - - - - 0x009410 02:9400: 85 1C     STA ram_001C_t03_pos_X_hi
bra_9402:
C - - - - - 0x009412 02:9402: B5 77     LDA ram_obj_pos_X_lo,X
C - - - - - 0x009414 02:9404: 18        CLC
C - - - - - 0x009415 02:9405: 65 1B     ADC ram_001B_t06_pos_X_lo
C - - - - - 0x009417 02:9407: 99 77 00  STA a: ram_obj_pos_X_lo,Y
C - - - - - 0x00941A 02:940A: B5 80     LDA ram_obj_pos_X_hi,X
C - - - - - 0x00941C 02:940C: 65 1C     ADC ram_001C_t03_pos_X_hi
C - - - - - 0x00941E 02:940E: 99 80 00  STA a: ram_obj_pos_X_hi,Y
C - - - - - 0x009421 02:9411: A9 08     LDA #< $0008
C - - - - - 0x009423 02:9413: 18        CLC
C - - - - - 0x009424 02:9414: 79 AD 00  ADC a: ram_obj_pos_Z_lo,Y
C - - - - - 0x009427 02:9417: 99 AD 00  STA a: ram_obj_pos_Z_lo,Y
C - - - - - 0x00942A 02:941A: B9 B6 00  LDA a: ram_obj_pos_Z_hi,Y
C - - - - - 0x00942D 02:941D: 69 00     ADC #> $0008
C - - - - - 0x00942F 02:941F: 99 B6 00  STA a: ram_obj_pos_Z_hi,Y
C - - - - - 0x009432 02:9422: 4C 2D 94  JMP loc_942D
bra_9425:
C - - - - - 0x009435 02:9425: A9 57     LDA #con_state_57
C - - - - - 0x009437 02:9427: 95 43     STA ram_obj_state,X
C - - - - - 0x009439 02:9429: A9 24     LDA #con_anim_id + $24
C - - - - - 0x00943B 02:942B: 95 C7     STA ram_animation_id,X
bra_942D:
loc_942D:   ; bzk optimize
; bzk optimize, JMP
C D 0 - - - 0x00943D 02:942D: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
bra_944C:
C - - - - - 0x00945C 02:944C: A9 28     LDA #con_A48A_anim_28
C - - - - - 0x00945E 02:944E: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x009461 02:9451: B5 5C     LDA ram_obj_amim_cnt,X
C - - - - - 0x009463 02:9453: C9 03     CMP #$03
C - - - - - 0x009465 02:9455: D0 53     BNE bra_94AA
C - - - - - 0x009467 02:9457: B5 55     LDA ram_obj_amim_dur,X
...
C - - - - - 0x009476 02:9466: 20 66 A4  JSR sub_A466_copy_data_between_two_objects
C - - - - - 0x009479 02:9469: B5 77     LDA ram_obj_pos_X_lo,X
C - - - - - 0x00947B 02:946B: 99 77 00  STA a: ram_obj_pos_X_lo,Y
C - - - - - 0x00947E 02:946E: B5 80     LDA ram_obj_pos_X_hi,X
C - - - - - 0x009480 02:9470: 99 80 00  STA a: ram_obj_pos_X_hi,Y
C - - - - - 0x009483 02:9473: B5 92     LDA ram_obj_pos_Y_lo,X
C - - - - - 0x009485 02:9475: 99 92 00  STA a: ram_obj_pos_Y_lo,Y
C - - - - - 0x009488 02:9478: B5 9B     LDA ram_obj_pos_Y_hi,X
C - - - - - 0x00948A 02:947A: 99 9B 00  STA a: ram_obj_pos_Y_hi,Y
C - - - - - 0x00948D 02:947D: B5 AD     LDA ram_obj_pos_Z_lo,X
C - - - - - 0x00948F 02:947F: 18        CLC
C - - - - - 0x009490 02:9480: 69 28     ADC #< $0028
C - - - - - 0x009492 02:9482: 99 AD 00  STA a: ram_obj_pos_Z_lo,Y
C - - - - - 0x009495 02:9485: B5 B6     LDA ram_obj_pos_Z_hi,X
C - - - - - 0x009497 02:9487: 69 00     ADC #> $0028
C - - - - - 0x009499 02:9489: 99 B6 00  STA a: ram_obj_pos_Z_hi,Y
C - - - - - 0x00949C 02:948C: A9 1E     LDA #con_state_thrown_by_hair_throw
C - - - - - 0x00949E 02:948E: 99 43 00  STA a: ram_obj_state,Y
C - - - - - 0x0094A1 02:9491: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x0094A4 02:9494: 29 DD     AND #(con_004A_flag_20 + con_004A_flag_hair_grabbed) ^ $FF
C - - - - - 0x0094A6 02:9496: 99 4A 00  STA a: ram_004A_obj_flags,Y
C - - - - - 0x0094A9 02:9499: B5 63     LDA ram_0063_obj_facing,X
C - - - - - 0x0094AB 02:949B: 10 08     BPL bra_94A5
C - - - - - 0x0094AD 02:949D: A9 40     LDA #$40
C - - - - - 0x0094AF 02:949F: 99 0F 03  STA ram_obj_direction,Y
C - - - - - 0x0094B2 02:94A2: 4C AA 94  JMP loc_94AA
bra_94A5:
C - - - - - 0x0094B5 02:94A5: A9 C0     LDA #$C0
C - - - - - 0x0094B7 02:94A7: 99 0F 03  STA ram_obj_direction,Y
bra_94AA:
loc_94AA:
; bzk optimize, JMP
C D 0 - - - 0x0094BA 02:94AA: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
- D 0 - I - 0x0094C1 02:94B1: 80        .byte con_state_idle + $80   ; 
...
bra_94D0:
C - - - - - 0x0094E0 02:94D0: A9 29     LDA #con_A48A_anim_29
C - - - - - 0x0094E2 02:94D2: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x0094E5 02:94D5: B5 C7     LDA ram_animation_id,X
C - - - - - 0x0094E7 02:94D7: 29 7F     AND #$7F
C - - - - - 0x0094E9 02:94D9: C9 2C     CMP #con_anim_id + $2C
C - - - - - 0x0094EB 02:94DB: D0 40     BNE bra_951D
C - - - - - 0x0094ED 02:94DD: B5 55     LDA ram_obj_amim_dur,X
...
C - - - - - 0x0094FC 02:94EC: 20 66 A4  JSR sub_A466_copy_data_between_two_objects
C - - - - - 0x0094FF 02:94EF: A9 1F     LDA #con_state_1F
C - - - - - 0x009501 02:94F1: 99 43 00  STA a: ram_obj_state,Y
C - - - - - 0x009504 02:94F4: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x009507 02:94F7: 29 FD     AND #con_004A_flag_hair_grabbed ^ $FF
C - - - - - 0x009509 02:94F9: 99 4A 00  STA a: ram_004A_obj_flags,Y
...
C - - - - - 0x00951F 02:950F: 85 29     STA ram_0029_t2D_pos_X_lo
bra_9511:
C - - - - - 0x009521 02:9511: 20 EC 9F  JSR sub_9FEC
C - - - - - 0x009524 02:9514: B9 0F 03  LDA ram_obj_direction,Y
C - - - - - 0x009527 02:9517: 18        CLC
C - - - - - 0x009528 02:9518: 69 80     ADC #$80
C - - - - - 0x00952A 02:951A: 99 0F 03  STA ram_obj_direction,Y
bra_951D:
; bzk optimize, JMP
C - - - - - 0x00952D 02:951D: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
- D 0 - I - 0x009533 02:9523: 80        .byte con_state_idle + $80   ; 
...
bra_954A:
C - - - - - 0x00955A 02:954A: A9 2A     LDA #con_A48A_anim_2A
C - - - - - 0x00955C 02:954C: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x00955F 02:954F: B5 C7     LDA ram_animation_id,X
C - - - - - 0x009561 02:9551: 29 7F     AND #$7F
C - - - - - 0x009563 02:9553: C9 2E     CMP #con_anim_id + $2E
C - - - - - 0x009565 02:9555: D0 52     BNE bra_95A9_RTS
C - - - - - 0x009567 02:9557: B5 55     LDA ram_obj_amim_dur,X
...
C - - - - - 0x00957B 02:956B: C9 03     CMP #con_hair_grab_max_hit_counter
...
C - - - - - 0x009588 02:9578: 20 66 A4  JSR sub_A466_copy_data_between_two_objects
C - - - - - 0x00958B 02:957B: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x00958E 02:957E: 29 DF     AND #con_004A_flag_20 ^ $FF
C - - - - - 0x009590 02:9580: 99 4A 00  STA a: ram_004A_obj_flags,Y
C - - - - - 0x009593 02:9583: A9 1B     LDA #con_state_1B
C - - - - - 0x009595 02:9585: 99 43 00  STA a: ram_obj_state,Y
...
C - - - - - 0x0095A7 02:9597: 85 29     STA ram_0029_t2D_pos_X_lo
bra_9599:
C - - - - - 0x0095A9 02:9599: 20 EC 9F  JSR sub_9FEC
C - - - - - 0x0095AC 02:959C: B9 0F 03  LDA ram_obj_direction,Y
C - - - - - 0x0095AF 02:959F: 18        CLC
C - - - - - 0x0095B0 02:95A0: 69 80     ADC #$80
C - - - - - 0x0095B2 02:95A2: 99 0F 03  STA ram_obj_direction,Y
C - - - - - 0x0095B5 02:95A5: A9 00     LDA #con_state_idle
C - - - - - 0x0095B7 02:95A7: 95 43     STA ram_obj_state,X
bra_95A9_RTS:
...
- D 0 - I - 0x0095BC 02:95AC: D7        .byte con_state_57 + $80   ; 
...
C - - - - - 0x0095C9 02:95B9: B9 43 00  LDA a: ram_obj_state,Y
...
C - - - - - 0x0095DA 02:95CA: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x0095DD 02:95CD: 09 02     ORA #con_004A_flag_hair_grabbed
C - - - - - 0x0095DF 02:95CF: 99 4A 00  STA a: ram_004A_obj_flags,Y
C - - - - - 0x0095E2 02:95D2: A9 7F     LDA #con_state_hair_grabbed
C - - - - - 0x0095E4 02:95D4: 99 43 00  STA a: ram_obj_state,Y
C - - - - - 0x0095E7 02:95D7: A9 08     LDA #con_damage + $08
C - - - - - 0x0095E9 02:95D9: 20 DC 9F  JSR sub_9FDC_damage_to_player
bra_95DC:
C - - - - - 0x0095EC 02:95DC: A9 2B     LDA #con_A48A_anim_2B
C - - - - - 0x0095EE 02:95DE: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x0095F1 02:95E1: B5 5C     LDA ram_obj_amim_cnt,X
C - - - - - 0x0095F3 02:95E3: C9 03     CMP #$03
C - - - - - 0x0095F5 02:95E5: 90 33     BCC bra_961A
C - - - - - 0x0095F7 02:95E7: B5 55     LDA ram_obj_amim_dur,X
...
C - - - - - 0x009606 02:95F6: 20 66 A4  JSR sub_A466_copy_data_between_two_objects
C - - - - - 0x009609 02:95F9: A9 1E     LDA #con_state_thrown_by_hair_throw
C - - - - - 0x00960B 02:95FB: 99 43 00  STA a: ram_obj_state,Y
C - - - - - 0x00960E 02:95FE: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x009611 02:9601: 29 FD     AND #con_004A_flag_hair_grabbed ^ $FF
C - - - - - 0x009613 02:9603: 99 4A 00  STA a: ram_004A_obj_flags,Y
...
C - - - - - 0x009625 02:9615: 85 29     STA ram_0029_t2D_pos_X_lo
bra_9617:
C - - - - - 0x009627 02:9617: 20 EC 9F  JSR sub_9FEC
bra_961A:
; bzk optimize, JMP
C - - - - - 0x00962A 02:961A: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
- D 0 - I - 0x009631 02:9621: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x00963F 02:962F: B9 43 00  LDA a: ram_obj_state,Y
...
C - - - - - 0x009657 02:9647: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x009659 02:9649: A9 7F     LDA #con_state_hair_grabbed
C - - - - - 0x00965B 02:964B: 99 43 00  STA a: ram_obj_state,Y
C - - - - - 0x00965E 02:964E: A9 62     LDA #con_004A_flag_hair_grabbed + con_004A_flag_20 + con_004A_flag_stunned
C - - - - - 0x009660 02:9650: 99 4A 00  STA a: ram_004A_obj_flags,Y
C - - - - - 0x009663 02:9653: A9 02     LDA #con_004A_flag_hair_grabbed
C - - - - - 0x009665 02:9655: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x009667 02:9657: A9 03     LDA #con_anim_id + $03
...
bra_9663:
; bzk optimize, JMP
C - - - - - 0x009673 02:9663: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
bra_966E:
C - - - - - 0x00967E 02:966E: A9 2C     LDA #con_A48A_anim_2C
C - - - - - 0x009680 02:9670: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x009683 02:9673: B5 5C     LDA ram_obj_amim_cnt,X
C - - - - - 0x009685 02:9675: A8        TAY
C - - - - - 0x009686 02:9676: B9 E7 96  LDA tbl_96E7,Y
C - - - - - 0x009689 02:9679: F0 5D     BEQ bra_96D8
C - - - - - 0x00968B 02:967B: B5 55     LDA ram_obj_amim_dur,X
...
C - - - - - 0x0096A1 02:9691: 20 66 A4  JSR sub_A466_copy_data_between_two_objects
C - - - - - 0x0096A4 02:9694: A9 40     LDA #con_004A_flag_stunned
C - - - - - 0x0096A6 02:9696: 99 4A 00  STA a: ram_004A_obj_flags,Y
C - - - - - 0x0096A9 02:9699: A9 07     LDA #con_anim_id + $07
C - - - - - 0x0096AB 02:969B: 99 C7 00  STA a: ram_animation_id,Y
C - - - - - 0x0096AE 02:969E: A9 1C     LDA #con_state_1C
C - - - - - 0x0096B0 02:96A0: 99 43 00  STA a: ram_obj_state,Y
...
C - - - - - 0x0096C7 02:96B7: 85 29     STA ram_0029_t2D_pos_X_lo
bra_96B9:
C - - - - - 0x0096C9 02:96B9: 20 EC 9F  JSR sub_9FEC
C - - - - - 0x0096CC 02:96BC: B9 0F 03  LDA ram_obj_direction,Y
C - - - - - 0x0096CF 02:96BF: 18        CLC
C - - - - - 0x0096D0 02:96C0: 69 80     ADC #$80
C - - - - - 0x0096D2 02:96C2: 99 0F 03  STA ram_obj_direction,Y
...
loc_96D8:
; bzk optimize, JMP
C D 0 - - - 0x0096E8 02:96D8: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
- D 0 - I - 0x0096F1 02:96E1: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x009704 02:96F4: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
C - - - - - 0x009707 02:96F7: A9 3F     LDA #con_sfx_elevator
C - - - - - 0x009709 02:96F9: 20 06 C0  JSR sub_0x01C016_play_sound
C - - - - - 0x00970C 02:96FC: A9 1E     LDA #con_obj_symbol_II
C - - - - - 0x00970E 02:96FE: 85 C3     STA ram_obj_id + $04
C - - - - - 0x009710 02:9700: A9 A2     LDA #con_003C_flag_exist + con_003C_flag_20 + con_003C_flag_02
C - - - - - 0x009712 02:9702: 85 40     STA ram_003C_obj_flags + $04
C - - - - - 0x009714 02:9704: A9 D5     LDA #< $01D5
C - - - - - 0x009716 02:9706: 85 7B     STA ram_obj_pos_X_lo + $04
C - - - - - 0x009718 02:9708: A9 01     LDA #> $01D5
C - - - - - 0x00971A 02:970A: 85 84     STA ram_obj_pos_X_hi + $04
C - - - - - 0x00971C 02:970C: B5 92     LDA ram_obj_pos_Y_lo,X
C - - - - - 0x00971E 02:970E: 85 96     STA ram_obj_pos_Y_lo + $04
C - - - - - 0x009720 02:9710: B5 9B     LDA ram_obj_pos_Y_hi,X
C - - - - - 0x009722 02:9712: 85 9F     STA ram_obj_pos_Y_hi + $04
C - - - - - 0x009724 02:9714: A9 20     LDA #con_004A_flag_20
C - - - - - 0x009726 02:9716: 85 4E     STA ram_004A_obj_flags + $04
C - - - - - 0x009728 02:9718: A9 01     LDA #$01
C - - - - - 0x00972A 02:971A: 95 B6     STA ram_obj_pos_Z_hi,X
C - - - - - 0x00972C 02:971C: A9 F0     LDA #$F0
C - - - - - 0x00972E 02:971E: 95 AD     STA ram_obj_pos_Z_lo,X
C - - - - - 0x009730 02:9720: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x009732 02:9722: 29 3F     AND #(con_004A_flag_stunned + con_004A_flag_knocked_down) ^ $FF
C - - - - - 0x009734 02:9724: 95 4A     STA ram_004A_obj_flags,X
bra_9726:
C - - - - - 0x009736 02:9726: A6 19     LDX ram_0019_t03_obj_index
C - - - - - 0x009738 02:9728: B5 B6     LDA ram_obj_pos_Z_hi,X
C - - - - - 0x00973A 02:972A: D0 20     BNE bra_974C
C - - - - - 0x00973C 02:972C: B5 AD     LDA ram_obj_pos_Z_lo,X
C - - - - - 0x00973E 02:972E: C9 12     CMP #$12
C - - - - - 0x009740 02:9730: B0 1A     BCS bra_974C
C - - - - - 0x009742 02:9732: A5 D2     LDA ram_cam_pos_Y_lo
C - - - - - 0x009744 02:9734: 38        SEC
C - - - - - 0x009745 02:9735: E9 01     SBC #< $0001
C - - - - - 0x009747 02:9737: 85 D2     STA ram_cam_pos_Y_lo
C - - - - - 0x009749 02:9739: A5 D3     LDA ram_cam_pos_Y_hi
C - - - - - 0x00974B 02:973B: E9 00     SBC #> $0001
C - - - - - 0x00974D 02:973D: 85 D3     STA ram_cam_pos_Y_hi
C - - - - - 0x00974F 02:973F: 25 D2     AND ram_cam_pos_Y_lo
C - - - - - 0x009751 02:9741: 10 25     BPL bra_9768
C - - - - - 0x009753 02:9743: A9 00     LDA #$00
C - - - - - 0x009755 02:9745: 85 D2     STA ram_cam_pos_Y_lo
C - - - - - 0x009757 02:9747: 85 D3     STA ram_cam_pos_Y_hi
C - - - - - 0x009759 02:9749: 4C 68 97  JMP loc_9768
bra_974C:
C - - - - - 0x00975C 02:974C: B5 AD     LDA ram_obj_pos_Z_lo,X
C - - - - - 0x00975E 02:974E: 38        SEC
C - - - - - 0x00975F 02:974F: E9 02     SBC #< $0002
C - - - - - 0x009761 02:9751: 95 AD     STA ram_obj_pos_Z_lo,X
C - - - - - 0x009763 02:9753: B5 B6     LDA ram_obj_pos_Z_hi,X
C - - - - - 0x009765 02:9755: E9 00     SBC #> $0002
C - - - - - 0x009767 02:9757: 95 B6     STA ram_obj_pos_Z_hi,X
C - - - - - 0x009769 02:9759: B5 AD     LDA ram_obj_pos_Z_lo,X
C - - - - - 0x00976B 02:975B: 38        SEC
C - - - - - 0x00976C 02:975C: E9 10     SBC #< $0010
C - - - - - 0x00976E 02:975E: B5 B6     LDA ram_obj_pos_Z_hi,X
C - - - - - 0x009770 02:9760: E9 00     SBC #> $0010
C - - - - - 0x009772 02:9762: B0 04     BCS bra_9768
- - - - - - 0x009774 02:9764: A9 7F     LDA #con_state_hair_grabbed
- - - - - - 0x009776 02:9766: 95 43     STA ram_obj_state,X
bra_9768:
loc_9768:
C D 0 - - - 0x009778 02:9768: A9 7F     LDA #con_anim_id + $7F
C - - - - - 0x00977A 02:976A: 95 C7     STA ram_animation_id,X
C - - - - - 0x00977C 02:976C: 85 CB     STA ram_animation_id + $04
C - - - - - 0x00977E 02:976E: B5 AD     LDA ram_obj_pos_Z_lo,X
C - - - - - 0x009780 02:9770: 38        SEC
C - - - - - 0x009781 02:9771: E9 58     SBC #< $0158
C - - - - - 0x009783 02:9773: B5 B6     LDA ram_obj_pos_Z_hi,X
C - - - - - 0x009785 02:9775: E9 01     SBC #> $0158
C - - - - - 0x009787 02:9777: B0 1B     BCS bra_9794
C - - - - - 0x009789 02:9779: B5 AD     LDA ram_obj_pos_Z_lo,X
C - - - - - 0x00978B 02:977B: 38        SEC
C - - - - - 0x00978C 02:977C: E9 C0     SBC #< $00C0
C - - - - - 0x00978E 02:977E: B5 B6     LDA ram_obj_pos_Z_hi,X
C - - - - - 0x009790 02:9780: E9 00     SBC #> $00C0
C - - - - - 0x009792 02:9782: 90 10     BCC bra_9794
C - - - - - 0x009794 02:9784: A9 08     LDA #con_anim_id + $08
C - - - - - 0x009796 02:9786: 85 CB     STA ram_animation_id + $04
C - - - - - 0x009798 02:9788: A9 30     LDA #con_anim_id + $30
C - - - - - 0x00979A 02:978A: 95 C7     STA ram_animation_id,X
C - - - - - 0x00979C 02:978C: B5 AD     LDA ram_obj_pos_Z_lo,X
C - - - - - 0x00979E 02:978E: 85 B1     STA ram_obj_pos_Z_lo + $04
C - - - - - 0x0097A0 02:9790: B5 B6     LDA ram_obj_pos_Z_hi,X
C - - - - - 0x0097A2 02:9792: 85 BA     STA ram_obj_pos_Z_hi + $04
bra_9794:
; bzk optimize, JMP
C - - - - - 0x0097A4 02:9794: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x0097C6 02:97B6: A4 1B     LDY ram_001B_t07_obj_index
...
C - - - - - 0x0097D1 02:97C1: 95 43     STA ram_obj_state,X
bra_97C3:
; bzk optimize, JMP
C - - - - - 0x0097D3 02:97C3: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
C - - - - - 0x0097F0 02:97E0: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
C - - - - - 0x0097F3 02:97E3: A9 00     LDA #$00
C - - - - - 0x0097F5 02:97E5: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x0097F8 02:97E8: A9 60     LDA #$60
C - - - - - 0x0097FA 02:97EA: 9D 2D 03  STA ram_032D_obj,X
C - - - - - 0x0097FD 02:97ED: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x0097FF 02:97EF: 09 C0     ORA #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x009801 02:97F1: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x009803 02:97F3: A9 07     LDA #con_anim_id + $07
C - - - - - 0x009805 02:97F5: 95 C7     STA ram_animation_id,X
C - - - - - 0x009807 02:97F7: A9 05     LDA #$05
C - - - - - 0x009809 02:97F9: 95 55     STA ram_obj_amim_dur,X
bra_97FB:
C - - - - - 0x00980B 02:97FB: 20 10 9E  JSR sub_9E10
C - - - - - 0x00980E 02:97FE: A6 19     LDX ram_0019_t03_obj_index
C - - - - - 0x009810 02:9800: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x009812 02:9802: 10 04     BPL bra_9808_RTS
C - - - - - 0x009814 02:9804: A9 7F     LDA #con_anim_id + $7F
...
C - - - - - 0x009820 02:9810: A9 1E     LDA #con_obj_symbol_II
C - - - - - 0x009822 02:9812: 95 BF     STA ram_obj_id,X
bra_9814:
C - - - - - 0x009824 02:9814: A9 2D     LDA #con_A48A_anim_2D
; bzk optimize, JMP
C - - - - - 0x009826 02:9816: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
...
- D 0 - I - 0x009835 02:9825: FF        .byte con_state_hair_grabbed + $80   ; 
...
C - - - - - 0x009848 02:9838: B5 3C     LDA ram_003C_obj_flags,X ; 003E
C - - - - - 0x00984A 02:983A: 09 01     ORA #con_003C_flag_01
C - - - - - 0x00984C 02:983C: 95 3C     STA ram_003C_obj_flags,X ; 003E
bra_983E:
C - - - - - 0x00984E 02:983E: A9 2E     LDA #con_A48A_anim_2E
C - - - - - 0x009850 02:9840: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x009853 02:9843: A6 19     LDX ram_0019_t03_obj_index
C - - - - - 0x009855 02:9845: B5 43     LDA ram_obj_state,X
C - - - - - 0x009857 02:9847: 29 7F     AND #$7F
C - - - - - 0x009859 02:9849: C9 00     CMP #con_state_idle
C - - - - - 0x00985B 02:984B: D0 08     BNE bra_9855_RTS
C - - - - - 0x00985D 02:984D: A9 10     LDA #con_003C_flag_invisible
C - - - - - 0x00985F 02:984F: 15 3C     ORA ram_003C_obj_flags,X ; 003E
C - - - - - 0x009861 02:9851: 29 FE     AND #con_003C_flag_01 ^ $FF
C - - - - - 0x009863 02:9853: 95 3C     STA ram_003C_obj_flags,X ; 003E
bra_9855_RTS:
...
- D 0 - I - 0x009870 02:9860: 80        .byte con_state_idle + $80   ; 
...
C - - - - - 0x009882 02:9872: A9 1A     LDA #con_anim_id + $1A
C - - - - - 0x009884 02:9874: 95 C7     STA ram_animation_id,X
C - - - - - 0x009886 02:9876: A9 05     LDA #$05
C - - - - - 0x009888 02:9878: 95 55     STA ram_obj_amim_dur,X
bra_987A:
C - - - - - 0x00988A 02:987A: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x00988C 02:987C: D0 04     BNE bra_9882
C - - - - - 0x00988E 02:987E: A9 00     LDA #con_state_idle
C - - - - - 0x009890 02:9880: 95 43     STA ram_obj_state,X
bra_9882:
; bzk optimize, JMP
C - - - - - 0x009892 02:9882: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
...
bra_988D:
C - - - - - 0x00989D 02:988D: A9 2F     LDA #con_A48A_anim_2F
C - - - - - 0x00989F 02:988F: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x0098A2 02:9892: A6 19     LDX ram_0019_t03_obj_index
C - - - - - 0x0098A4 02:9894: B5 C7     LDA ram_animation_id,X
C - - - - - 0x0098A6 02:9896: 29 7F     AND #$7F
C - - - - - 0x0098A8 02:9898: C9 13     CMP #con_anim_id + $13
C - - - - - 0x0098AA 02:989A: D0 07     BNE bra_98A3_RTS
C - - - - - 0x0098AC 02:989C: B5 55     LDA ram_obj_amim_dur,X
...
C - - - - - 0x0098C2 02:98B2: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x0098C5 02:98B5: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x0098C7 02:98B7: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x0098C9 02:98B9: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x0098CB 02:98BB: A9 07     LDA #$07
C - - - - - 0x0098CD 02:98BD: 9D 16 03  STA ram_0316_obj,X
bra_98C0:
C - - - - - 0x0098D0 02:98C0: A9 3B     LDA #con_A48A_anim_3B
...
- D 0 - I - 0x0098D9 02:98C9: FE        .byte $FE   ; control byte
...
bra_98D5:
C - - - - - 0x0098E5 02:98D5: A9 3C     LDA #con_A48A_anim_3C
C - - - - - 0x0098E7 02:98D7: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x0098EA 02:98DA: B5 C7     LDA ram_animation_id,X
C - - - - - 0x0098EC 02:98DC: 29 7F     AND #$7F
C - - - - - 0x0098EE 02:98DE: C9 02     CMP #con_anim_id + $02
C - - - - - 0x0098F0 02:98E0: D0 07     BNE bra_98E9_RTS
C - - - - - 0x0098F2 02:98E2: B5 55     LDA ram_obj_amim_dur,X
...
- D 0 - I - 0x009905 02:98F5: 80        .byte con_state_idle + $80   ; 
...
bra_9908:
C - - - - - 0x009918 02:9908: A9 3D     LDA #con_A48A_anim_3D
C - - - - - 0x00991A 02:990A: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x00991D 02:990D: B5 43     LDA ram_obj_state,X
...
C - - - - - 0x00992C 02:991C: 20 66 A4  JSR sub_A466_copy_data_between_two_objects
C - - - - - 0x00992F 02:991F: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x009932 02:9922: 29 DF     AND #con_004A_flag_20 ^ $FF
C - - - - - 0x009934 02:9924: 99 4A 00  STA a: ram_004A_obj_flags,Y
C - - - - - 0x009937 02:9927: A9 00     LDA #con_state_idle
C - - - - - 0x009939 02:9929: 99 43 00  STA a: ram_obj_state,Y
C - - - - - 0x00993C 02:992C: A9 40     LDA #$40
C - - - - - 0x00993E 02:992E: 9D 0F 03  STA ram_obj_direction,X
C - - - - - 0x009941 02:9931: BD 63 00  LDA a: ram_0063_obj_facing,X
C - - - - - 0x009944 02:9934: 30 05     BMI bra_993B_RTS
C - - - - - 0x009946 02:9936: A9 C0     LDA #$C0
C - - - - - 0x009948 02:9938: 9D 0F 03  STA ram_obj_direction,X
bra_993B_RTS:
...
- D 0 - I - 0x00994E 02:993E: 9B        .byte con_state_1B + $80   ; 
...
C - - - - - 0x009958 02:9948: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x00995A 02:994A: 29 3F     AND #(con_004A_flag_stunned + con_004A_flag_knocked_down) ^ $FF
C - - - - - 0x00995C 02:994C: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x00995E 02:994E: A9 20     LDA #$20
C - - - - - 0x009960 02:9950: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x009962 02:9952: A9 00     LDA #con_anim_id + $00
C - - - - - 0x009964 02:9954: 95 C7     STA ram_animation_id,X
bra_9956:
C - - - - - 0x009966 02:9956: D6 55     DEC ram_obj_amim_dur,X
...
C - - - - - 0x009975 02:9965: 95 43     STA ram_obj_state,X
bra_9967:
C - - - - - 0x009977 02:9967: 5E 16 03  LSR ram_0316_obj,X
C - - - - - 0x00997A 02:996A: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
; bzk optimize, JMP
C - - - - - 0x00997D 02:996D: 20 4B 9E  JSR sub_9E4B_move_object
...
- - - - - - 0x009989 02:9979: 00        .byte $00   ; 1A con_obj_boomerang
...
- - - - - - 0x00998D 02:997D: 00        .byte $00   ; 1E con_obj_symbol_II
...
bra_9985:
C - - - - - 0x009995 02:9985: A9 30     LDA #con_A48A_anim_30
C - - - - - 0x009997 02:9987: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x00999A 02:998A: B5 43     LDA ram_obj_state,X
C - - - - - 0x00999C 02:998C: 29 7F     AND #$7F
C - - - - - 0x00999E 02:998E: C9 7F     CMP #con_state_hair_grabbed
C - - - - - 0x0099A0 02:9990: D0 04     BNE bra_9996
C - - - - - 0x0099A2 02:9992: A9 00     LDA #con_003C_flag_00
C - - - - - 0x0099A4 02:9994: 95 3C     STA ram_003C_obj_flags,X ; 0040 0041 0042
bra_9996:
C - - - - - 0x0099A6 02:9996: B5 C7     LDA ram_animation_id,X
C - - - - - 0x0099A8 02:9998: 29 7F     AND #$7F
C - - - - - 0x0099AA 02:999A: C9 05     CMP #con_anim_id + $05
...
- D 0 - I - 0x0099CA 02:99BA: FF        .byte con_state_hair_grabbed + $80   ; 
...
C - - - - - 0x0099E8 02:99D8: A9 00     LDA #con_004A_flag_00
C - - - - - 0x0099EA 02:99DA: 95 4A     STA ram_004A_obj_flags,X
bra_99DC:
C - - - - - 0x0099EC 02:99DC: A9 31     LDA #con_A48A_anim_31
C - - - - - 0x0099EE 02:99DE: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x0099F1 02:99E1: A6 19     LDX ram_0019_t03_obj_index
C - - - - - 0x0099F3 02:99E3: B5 43     LDA ram_obj_state,X
C - - - - - 0x0099F5 02:99E5: 29 7F     AND #$7F
C - - - - - 0x0099F7 02:99E7: C9 65     CMP #con_state_weapon_on_the_ground
C - - - - - 0x0099F9 02:99E9: D0 04     BNE bra_99EF_RTS
C - - - - - 0x0099FB 02:99EB: A9 7E     LDA #con_state_7E
C - - - - - 0x0099FD 02:99ED: 95 43     STA ram_obj_state,X
bra_99EF_RTS:
...
- D 0 - I - 0x009A04 02:99F4: E5        .byte con_state_weapon_on_the_ground + $80   ; 
...
C - - - - - 0x009A18 02:9A08: A9 01     LDA #con_anim_id + $01
C - - - - - 0x009A1A 02:9A0A: 95 C7     STA ram_animation_id,X
bra_9A0C:
; bzk optimize, JMP
C - - - - - 0x009A1C 02:9A0C: 20 4B 9E  JSR sub_9E4B_move_object
...
C - - - - - 0x009A29 02:9A19: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x009A2C 02:9A1C: A9 80     LDA #$80
C - - - - - 0x009A2E 02:9A1E: 9D 2D 03  STA ram_032D_obj,X
C - - - - - 0x009A31 02:9A21: A9 00     LDA #con_004A_flag_00
C - - - - - 0x009A33 02:9A23: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x009A35 02:9A25: A9 02     LDA #$02
C - - - - - 0x009A37 02:9A27: 9D 4A 04  STA ram_044A_obj,X
bra_9A2A:
C - - - - - 0x009A3A 02:9A2A: A9 32     LDA #con_A48A_anim_32
C - - - - - 0x009A3C 02:9A2C: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
; bzk optimize, JMP
...
C - - - - - 0x009A64 02:9A54: 95 43     STA ram_obj_state,X
...
C - - - - - 0x009A6C 02:9A5C: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x009A6F 02:9A5F: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x009A71 02:9A61: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x009A73 02:9A63: 95 4A     STA ram_004A_obj_flags,X
bra_9A65:
loc_9A65:
C D 0 - - - 0x009A75 02:9A65: A9 33     LDA #con_A48A_anim_33
...
- D 0 - I - 0x009A7E 02:9A6E: FE        .byte $FE   ; control byte
...
- - - - - - 0x009A8B 02:9A7B: 23        .byte con_sfx_23   ; 1A con_obj_boomerang
...
- D 0 - - - 0x009A92 02:9A82: 65        .byte con_state_weapon_on_the_ground   ; 15 con_obj_chain_whip
...
- - - - - - 0x009A97 02:9A87: 00        .byte $00   ; 1A con_obj_boomerang
...
C - - - - - 0x009AA4 02:9A94: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x009AA7 02:9A97: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x009AA9 02:9A99: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x009AAB 02:9A9B: 95 4A     STA ram_004A_obj_flags,X
...
C - - - - - 0x009ACB 02:9ABB: 95 43     STA ram_obj_state,X
...
C - - - - - 0x009AE9 02:9AD9: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x009AEC 02:9ADC: A9 80     LDA #con_004A_flag_knocked_down
C - - - - - 0x009AEE 02:9ADE: 95 4A     STA ram_004A_obj_flags,X
bra_9AE0:
...
- - - - - - 0x009AFB 02:9AEB: 23        .byte con_sfx_23   ; 1A con_obj_boomerang
...
- D 0 - - - 0x009B07 02:9AF7: 75        .byte con_state_75   ; 1A con_obj_boomerang
...
C - - - - - 0x009B17 02:9B07: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x009B1A 02:9B0A: A9 0A     LDA #$0A
C - - - - - 0x009B1C 02:9B0C: 9D 16 03  STA ram_0316_obj,X
C - - - - - 0x009B1F 02:9B0F: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x009B21 02:9B11: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x009B23 02:9B13: 95 4A     STA ram_004A_obj_flags,X
...
C - - - - - 0x009B3E 02:9B2E: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x009B41 02:9B31: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x009B43 02:9B33: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x009B45 02:9B35: 95 4A     STA ram_004A_obj_flags,X
...
C - - - - - 0x009B59 02:9B49: 95 43     STA ram_obj_state,X
...
bra_9B54:
C - - - - - 0x009B64 02:9B54: A9 34     LDA #con_A48A_anim_34
C - - - - - 0x009B66 02:9B56: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x009B69 02:9B59: B5 43     LDA ram_obj_state,X
C - - - - - 0x009B6B 02:9B5B: 29 7F     AND #$7F
C - - - - - 0x009B6D 02:9B5D: C9 7F     CMP #con_state_hair_grabbed
C - - - - - 0x009B6F 02:9B5F: D0 04     BNE bra_9B65_RTS
C - - - - - 0x009B71 02:9B61: A9 00     LDA #con_003C_flag_00
C - - - - - 0x009B73 02:9B63: 95 3C     STA ram_003C_obj_flags,X ; 0040 0041
bra_9B65_RTS:
...
- D 0 - I - 0x009B7F 02:9B6F: FF        .byte con_state_hair_grabbed + $80   ; 
...
C - - - - - 0x009B95 02:9B85: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x009B97 02:9B87: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x009B99 02:9B89: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x009B9B 02:9B8B: 20 5F A0  JSR sub_A05F
bra_9B8E:
C - - - - - 0x009B9E 02:9B8E: A9 35     LDA #con_A48A_anim_35
C - - - - - 0x009BA0 02:9B90: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x009BA3 02:9B93: 20 4B 9E  JSR sub_9E4B_move_object
C - - - - - 0x009BA6 02:9B96: A6 19     LDX ram_0019_t03_obj_index
C - - - - - 0x009BA8 02:9B98: BD 4A 04  LDA ram_044A_obj,X
C - - - - - 0x009BAB 02:9B9B: A8        TAY
C - - - - - 0x009BAC 02:9B9C: B9 54 04  LDA ram_0454_obj_aim,Y
...
- D 0 - I - 0x009BB6 02:9BA6: FE        .byte $FE   ; control byte
...
C - - - - - 0x009BBF 02:9BAF: 95 43     STA ram_obj_state,X
C - - - - - 0x009BC1 02:9BB1: A9 00     LDA #$00
C - - - - - 0x009BC3 02:9BB3: 9D 1D 03  STA ram_obj_gravity_lo,X
C - - - - - 0x009BC6 02:9BB6: 9D 35 03  STA ram_0335_obj,X
C - - - - - 0x009BC9 02:9BB9: 9D 2D 03  STA ram_032D_obj,X
C - - - - - 0x009BCC 02:9BBC: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x009BCE 02:9BBE: 95 5C     STA ram_obj_amim_cnt,X
C - - - - - 0x009BD0 02:9BC0: 95 92     STA ram_obj_pos_Y_lo,X
C - - - - - 0x009BD2 02:9BC2: 95 9B     STA ram_obj_pos_Y_hi,X
C - - - - - 0x009BD4 02:9BC4: A9 C0     LDA #$C0
C - - - - - 0x009BD6 02:9BC6: 9D 0F 03  STA ram_obj_direction,X
...
C - - - - - 0x009BE4 02:9BD4: ED F5 00  SBC a: ram_00F5_t01_cam_pos_X_lo
C - - - - - 0x009BE7 02:9BD7: 95 77     STA ram_obj_pos_X_lo,X
C - - - - - 0x009BE9 02:9BD9: A9 02     LDA #$02
C - - - - - 0x009BEB 02:9BDB: E9 00     SBC #> $003C
C - - - - - 0x009BED 02:9BDD: 95 80     STA ram_obj_pos_X_hi,X
C - - - - - 0x009BEF 02:9BDF: A9 A8     LDA #< $01A8
C - - - - - 0x009BF1 02:9BE1: 95 AD     STA ram_obj_pos_Z_lo,X
C - - - - - 0x009BF3 02:9BE3: A9 01     LDA #> $01A8
C - - - - - 0x009BF5 02:9BE5: 95 B6     STA ram_obj_pos_Z_hi,X
C - - - - - 0x009BF7 02:9BE7: A9 80     LDA #$80
C - - - - - 0x009BF9 02:9BE9: 9D 63 00  STA a: ram_0063_obj_facing,X
...
C - - - - - 0x009C06 02:9BF6: A9 00     LDA #con_004A_flag_00
C - - - - - 0x009C08 02:9BF8: 9D 4A 00  STA a: ram_004A_obj_flags,X
bra_9BFB:
C - - - - - 0x009C0B 02:9BFB: A9 36     LDA #con_A48A_anim_36
...
- D 0 - I - 0x009C12 02:9C02: FE        .byte $FE   ; control byte
...
C - - - - - 0x009C1C 02:9C0C: A9 00     LDA #con_004A_flag_00
C - - - - - 0x009C1E 02:9C0E: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x009C20 02:9C10: A9 A0     LDA #$A0
C - - - - - 0x009C22 02:9C12: 9D 2D 03  STA ram_032D_obj,X
C - - - - - 0x009C25 02:9C15: A9 00     LDA #$00
C - - - - - 0x009C27 02:9C17: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x009C2A 02:9C1A: A9 02     LDA #$02
C - - - - - 0x009C2C 02:9C1C: 9D 4A 04  STA ram_044A_obj,X
C - - - - - 0x009C2F 02:9C1F: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x009C31 02:9C21: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x009C33 02:9C23: 95 4A     STA ram_004A_obj_flags,X
bra_9C25:
C - - - - - 0x009C35 02:9C25: A9 37     LDA #con_A48A_anim_37
C - - - - - 0x009C37 02:9C27: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
; bzk optimize, JMP
...
- D 0 - I - 0x009C40 02:9C30: FE        .byte $FE   ; control byte
...
C - - - - - 0x009C4F 02:9C3F: A9 70     LDA #< $0070
C - - - - - 0x009C51 02:9C41: 95 92     STA ram_obj_pos_Y_lo,X
C - - - - - 0x009C53 02:9C43: A9 00     LDA #> $0070
C - - - - - 0x009C55 02:9C45: 95 9B     STA ram_obj_pos_Y_hi,X
...
C - - - - - 0x009C5F 02:9C4F: B9 6C 9C  LDA tbl_9C74_pos_Z - $08,Y
C - - - - - 0x009C62 02:9C52: 95 AD     STA ram_obj_pos_Z_lo,X
C - - - - - 0x009C64 02:9C54: B9 6D 9C  LDA tbl_9C74_pos_Z - $07,Y
C - - - - - 0x009C67 02:9C57: 95 B6     STA ram_obj_pos_Z_hi,X
C - - - - - 0x009C69 02:9C59: BD 76 9C  LDA tbl_9C7A_pos_X_lo - $04,X
C - - - - - 0x009C6C 02:9C5C: 38        SEC
C - - - - - 0x009C6D 02:9C5D: ED F5 00  SBC a: ram_00F5_t01_cam_pos_X_lo
C - - - - - 0x009C70 02:9C60: 95 77     STA ram_obj_pos_X_lo,X
C - - - - - 0x009C72 02:9C62: A9 04     LDA #$04
C - - - - - 0x009C74 02:9C64: E9 00     SBC #$00
C - - - - - 0x009C76 02:9C66: 95 80     STA ram_obj_pos_X_hi,X
C - - - - - 0x009C78 02:9C68: A9 38     LDA #con_A48A_anim_38
C - - - - - 0x009C7A 02:9C6A: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
; clear mirrored animation
...
tbl_9C74_pos_Z:
- D 0 - - - 0x009C84 02:9C74: F8 00     .word $00F8 ; 04
- D 0 - - - 0x009C86 02:9C76: 08 01     .word $0108 ; 05
- D 0 - - - 0x009C88 02:9C78: 18 01     .word $0118 ; 06
...
- D 0 - I - 0x009C97 02:9C87: FF        .byte con_state_hair_grabbed + $80   ; 
...
C - - - - - 0x009CAB 02:9C9B: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x009CAE 02:9C9E: A9 80     LDA #$80
C - - - - - 0x009CB0 02:9CA0: 9D 2D 03  STA ram_032D_obj,X
C - - - - - 0x009CB3 02:9CA3: A9 00     LDA #$00
C - - - - - 0x009CB5 02:9CA5: 9D 63 00  STA a: ram_0063_obj_facing,X
C - - - - - 0x009CB8 02:9CA8: BD 0F 03  LDA ram_obj_direction,X
C - - - - - 0x009CBB 02:9CAB: C9 80     CMP #$80
C - - - - - 0x009CBD 02:9CAD: 90 10     BCC bra_9CBF
C - - - - - 0x009CBF 02:9CAF: A9 80     LDA #$80
C - - - - - 0x009CC1 02:9CB1: 9D 63 00  STA a: ram_0063_obj_facing,X
C - - - - - 0x009CC4 02:9CB4: A9 2E     LDA #con_sfx_2E
C - - - - - 0x009CC6 02:9CB6: 20 06 C0  JSR sub_0x01C016_play_sound
C - - - - - 0x009CC9 02:9CB9: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x009CCB 02:9CBB: 09 80     ORA #con_004A_flag_knocked_down
C - - - - - 0x009CCD 02:9CBD: 95 4A     STA ram_004A_obj_flags,X
bra_9CBF:
C - - - - - 0x009CCF 02:9CBF: A9 39     LDA #con_A48A_anim_39
C - - - - - 0x009CD1 02:9CC1: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x009CD4 02:9CC4: BD 1D 03  LDA ram_obj_gravity_lo,X
C - - - - - 0x009CD7 02:9CC7: 38        SEC
C - - - - - 0x009CD8 02:9CC8: FD 2D 03  SBC ram_032D_obj,X
C - - - - - 0x009CDB 02:9CCB: 9D 1D 03  STA ram_obj_gravity_lo,X
C - - - - - 0x009CDE 02:9CCE: BD 25 03  LDA ram_obj_gravity_hi,X
C - - - - - 0x009CE1 02:9CD1: FD 35 03  SBC ram_0335_obj,X
C - - - - - 0x009CE4 02:9CD4: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x009CE7 02:9CD7: 10 16     BPL bra_9CEF
C - - - - - 0x009CE9 02:9CD9: 48        PHA
C - - - - - 0x009CEA 02:9CDA: A9 40     LDA #$40
C - - - - - 0x009CEC 02:9CDC: 9D 0F 03  STA ram_obj_direction,X
C - - - - - 0x009CEF 02:9CDF: BD 63 00  LDA a: ram_0063_obj_facing,X
C - - - - - 0x009CF2 02:9CE2: 30 05     BMI bra_9CE9
C - - - - - 0x009CF4 02:9CE4: A9 C0     LDA #$C0
C - - - - - 0x009CF6 02:9CE6: 9D 0F 03  STA ram_obj_direction,X
bra_9CE9:
...
; bzk optimize, JMP
C - - - - - 0x009D02 02:9CF2: 20 4B 9E  JSR sub_9E4B_move_object
...
- D 0 - I - 0x009D0A 02:9CFA: FE        .byte $FE   ; control byte
...
bra_9D0B:
C - - - - - 0x009D1B 02:9D0B: A9 3A     LDA #con_A48A_anim_3A
C - - - - - 0x009D1D 02:9D0D: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x009D20 02:9D10: B5 43     LDA ram_obj_state,X
C - - - - - 0x009D22 02:9D12: 29 7F     AND #$7F
C - - - - - 0x009D24 02:9D14: D0 04     BNE bra_9D1A_RTS    ; if not con_state_idle
- - - - - - 0x009D26 02:9D16: A9 00     LDA #con_004A_flag_00
- - - - - - 0x009D28 02:9D18: 95 4A     STA ram_004A_obj_flags,X
bra_9D1A_RTS:
...
- D 0 - I - 0x009D2D 02:9D1D: FF        .byte con_state_hair_grabbed + $80   ; 
...
C - - - - - 0x009D37 02:9D27: A9 08     LDA #con_anim_id + $08
C - - - - - 0x009D39 02:9D29: 95 C7     STA ram_animation_id,X
C - - - - - 0x009D3B 02:9D2B: A9 04     LDA #$04
C - - - - - 0x009D3D 02:9D2D: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x009D3F 02:9D2F: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x009D41 02:9D31: 29 7F     AND #con_004A_flag_knocked_down ^ $FF
C - - - - - 0x009D43 02:9D33: 95 4A     STA ram_004A_obj_flags,X
bra_9D35:
C - - - - - 0x009D45 02:9D35: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x009D47 02:9D37: D0 04     BNE bra_9D3D_RTS
C - - - - - 0x009D49 02:9D39: A9 7E     LDA #con_state_7E
C - - - - - 0x009D4B 02:9D3B: 95 43     STA ram_obj_state,X
bra_9D3D_RTS:
...
C - - - - - 0x009D5A 02:9D4A: A9 04     LDA #con_anim_id + $04
C - - - - - 0x009D5C 02:9D4C: 95 C7     STA ram_animation_id,X
C - - - - - 0x009D5E 02:9D4E: A9 80     LDA #con_004A_flag_knocked_down
C - - - - - 0x009D60 02:9D50: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x009D62 02:9D52: 20 5F A0  JSR sub_A05F
bra_9D55:
; bzk optimize, JMP
C - - - - - 0x009D65 02:9D55: 20 4B 9E  JSR sub_9E4B_move_object
...
C - - - - - 0x009D77 02:9D67: 9D 25 03  STA ram_obj_gravity_hi,X
C - - - - - 0x009D7A 02:9D6A: A9 80     LDA #con_004A_flag_knocked_down
C - - - - - 0x009D7C 02:9D6C: 95 4A     STA ram_004A_obj_flags,X
bra_9D6E:
C - - - - - 0x009D7E 02:9D6E: BD 4A 04  LDA ram_044A_obj,X
C - - - - - 0x009D81 02:9D71: A8        TAY
C - - - - - 0x009D82 02:9D72: B9 54 04  LDA ram_0454_obj_aim,Y
C - - - - - 0x009D85 02:9D75: A8        TAY
C - - - - - 0x009D86 02:9D76: B9 77 00  LDA a: ram_obj_pos_X_lo,Y
C - - - - - 0x009D89 02:9D79: F5 77     SBC ram_obj_pos_X_lo,X
C - - - - - 0x009D8B 02:9D7B: B9 80 00  LDA a: ram_obj_pos_X_hi,Y
C - - - - - 0x009D8E 02:9D7E: F5 80     SBC ram_obj_pos_X_hi,X
C - - - - - 0x009D90 02:9D80: F0 1F     BEQ bra_9DA1
C - - - - - 0x009D92 02:9D82: 90 10     BCC bra_9D94
- - - - - - 0x009D94 02:9D84: 18        CLC
- - - - - - 0x009D95 02:9D85: A9 04     LDA #< $0004
- - - - - - 0x009D97 02:9D87: 75 77     ADC ram_obj_pos_X_lo,X
- - - - - - 0x009D99 02:9D89: 95 77     STA ram_obj_pos_X_lo,X
- - - - - - 0x009D9B 02:9D8B: A9 00     LDA #> $0004
- - - - - - 0x009D9D 02:9D8D: 75 80     ADC ram_obj_pos_X_hi,X
- - - - - - 0x009D9F 02:9D8F: 95 80     STA ram_obj_pos_X_hi,X
- - - - - - 0x009DA1 02:9D91: 4C A1 9D  JMP loc_9DA1
bra_9D94:
C - - - - - 0x009DA4 02:9D94: 38        SEC
C - - - - - 0x009DA5 02:9D95: B5 77     LDA ram_obj_pos_X_lo,X
C - - - - - 0x009DA7 02:9D97: E9 04     SBC #< $0004
C - - - - - 0x009DA9 02:9D99: 95 77     STA ram_obj_pos_X_lo,X
C - - - - - 0x009DAB 02:9D9B: B5 80     LDA ram_obj_pos_X_hi,X
C - - - - - 0x009DAD 02:9D9D: E9 00     SBC #> $0004
C - - - - - 0x009DAF 02:9D9F: 95 80     STA ram_obj_pos_X_hi,X
bra_9DA1:
loc_9DA1:
C - - - - - 0x009DB1 02:9DA1: 20 73 A4  JSR sub_A473
C - - - - - 0x009DB4 02:9DA4: A9 3F     LDA #con_A48A_anim_3F
...
- D 0 - I - 0x009DBB 02:9DAB: FE        .byte $FE   ; control byte
...
- - - - - - 0x009DCB 02:9DBB: B5 4A     LDA ram_004A_obj_flags,X
- - - - - - 0x009DCD 02:9DBD: 09 80     ORA #con_004A_flag_knocked_down
- - - - - - 0x009DCF 02:9DBF: 95 4A     STA ram_004A_obj_flags,X
bra_9DC1:
- - - - - - 0x009DD1 02:9DC1: 20 4B 9E  JSR sub_9E4B_move_object
; bzk optimize, JMP
...
sub_9DD9_increase_Z_pos:
; A = how much to add
C - - - - - 0x009DE9 02:9DD9: 18        CLC
C - - - - - 0x009DEA 02:9DDA: 75 AD     ADC ram_obj_pos_Z_lo,X
C - - - - - 0x009DEC 02:9DDC: 95 AD     STA ram_obj_pos_Z_lo,X
C - - - - - 0x009DEE 02:9DDE: B5 B6     LDA ram_obj_pos_Z_hi,X
C - - - - - 0x009DF0 02:9DE0: 69 00     ADC #$00
C - - - - - 0x009DF2 02:9DE2: 95 B6     STA ram_obj_pos_Z_hi,X
C - - - - - 0x009DF4 02:9DE4: 60        RTS



sub_9DE5:
C - - - - - 0x009DF5 02:9DE5: A4 19     LDY ram_0019_t03_obj_index
C - - - - - 0x009DF7 02:9DE7: A9 00     LDA #$00
C - - - - - 0x009DF9 02:9DE9: 99 63 00  STA a: ram_0063_obj_facing,Y
C - - - - - 0x009DFC 02:9DEC: B9 0F 03  LDA ram_obj_direction,Y
C - - - - - 0x009DFF 02:9DEF: C9 80     CMP #$80
C - - - - - 0x009E01 02:9DF1: 90 05     BCC bra_9DF8
C - - - - - 0x009E03 02:9DF3: A9 80     LDA #$80
C - - - - - 0x009E05 02:9DF5: 99 63 00  STA a: ram_0063_obj_facing,Y
bra_9DF8:
sub_9DF8_set_mirrored_amination:
C - - - - - 0x009E08 02:9DF8: A4 19     LDY ram_0019_t03_obj_index
...
C - - - - - 0x009E12 02:9E02: B9 63 00  LDA a: ram_0063_obj_facing,Y
...
C - - - - - 0x009E33 02:9E23: 99 AD 00  STA a: ram_obj_pos_Z_lo,Y
C - - - - - 0x009E36 02:9E26: B9 B6 00  LDA a: ram_obj_pos_Z_hi,Y
C - - - - - 0x009E39 02:9E29: 69 00     ADC #$00
C - - - - - 0x009E3B 02:9E2B: 99 B6 00  STA a: ram_obj_pos_Z_hi,Y
C - - - - - 0x009E3E 02:9E2E: 28        PLP
C - - - - - 0x009E3F 02:9E2F: 10 06     BPL bra_9E37
C - - - - - 0x009E41 02:9E31: 18        CLC
C - - - - - 0x009E42 02:9E32: 69 FF     ADC #$FF
C - - - - - 0x009E44 02:9E34: 99 B6 00  STA a: ram_obj_pos_Z_hi,Y
bra_9E37:
C - - - - - 0x009E47 02:9E37: B9 1D 03  LDA ram_obj_gravity_lo,Y
C - - - - - 0x009E4A 02:9E3A: 38        SEC
C - - - - - 0x009E4B 02:9E3B: F9 2D 03  SBC ram_032D_obj,Y
C - - - - - 0x009E4E 02:9E3E: 99 1D 03  STA ram_obj_gravity_lo,Y
C - - - - - 0x009E51 02:9E41: B9 25 03  LDA ram_obj_gravity_hi,Y
C - - - - - 0x009E54 02:9E44: F9 35 03  SBC ram_0335_obj,Y
C - - - - - 0x009E57 02:9E47: 99 25 03  STA ram_obj_gravity_hi,Y
C - - - - - 0x009E5A 02:9E4A: 60        RTS



sub_9E4B_move_object:
C - - - - - 0x009E5B 02:9E4B: A4 19     LDY ram_0019_t03_obj_index
C - - - - - 0x009E5D 02:9E4D: B9 16 03  LDA ram_0316_obj,Y
C - - - - - 0x009E60 02:9E50: D0 01     BNE bra_9E53
C - - - - - 0x009E62 02:9E52: 60        RTS
bra_9E53:
C - - - - - 0x009E63 02:9E53: B9 0F 03  LDA ram_obj_direction,Y
C - - - - - 0x009E66 02:9E56: 29 3F     AND #$3F
C - - - - - 0x009E68 02:9E58: AA        TAX
C - - - - - 0x009E69 02:9E59: 86 1B     STX ram_001B_t08
C - - - - - 0x009E6B 02:9E5B: BD 02 9F  LDA tbl_9F02,X
C - - - - - 0x009E6E 02:9E5E: 85 1A     STA ram_001A_t08
C - - - - - 0x009E70 02:9E60: A9 40     LDA #$40
C - - - - - 0x009E72 02:9E62: 38        SEC
C - - - - - 0x009E73 02:9E63: E5 1B     SBC ram_001B_t08
C - - - - - 0x009E75 02:9E65: AA        TAX
C - - - - - 0x009E76 02:9E66: BD 02 9F  LDA tbl_9F02,X
C - - - - - 0x009E79 02:9E69: 85 1B     STA ram_001B_t09
C - - - - - 0x009E7B 02:9E6B: B9 0F 03  LDA ram_obj_direction,Y
C - - - - - 0x009E7E 02:9E6E: 29 40     AND #$40
C - - - - - 0x009E80 02:9E70: D0 08     BNE bra_9E7A
; swap
C - - - - - 0x009E82 02:9E72: A5 1A     LDA ram_001A_t08
C - - - - - 0x009E84 02:9E74: A6 1B     LDX ram_001B_t09
C - - - - - 0x009E86 02:9E76: 85 1B     STA ram_001B_t09
C - - - - - 0x009E88 02:9E78: 86 1A     STX ram_001A_t08
bra_9E7A:
...
C - - - - - 0x009EE4 02:9ED4: 85 29     STA ram_0029_t22_jmp
C - - - - - 0x009EE6 02:9ED6: BD FB 9E  LDA tbl_9EFA + $01,X
C - - - - - 0x009EE9 02:9ED9: 85 2A     STA ram_0029_t22_jmp + $01
C - - - - - 0x009EEB 02:9EDB: 6C 29 00  JMP (ram_0029_t22_jmp)



ofs_001_9EDE_00_moving_up:
C - - J - - 0x009EEE 02:9EDE: 20 43 9F  JSR sub_9F43_increase_X_pos
; bzk optimize, JMP
C - - - - - 0x009EF1 02:9EE1: 20 5D 9F  JSR sub_9F5D_increase_Y_pos
C - - - - - 0x009EF4 02:9EE4: 60        RTS



ofs_001_9EE5_20_moving_right:
C - - J - - 0x009EF5 02:9EE5: 20 43 9F  JSR sub_9F43_increase_X_pos
; bzk optimize, JMP
C - - - - - 0x009EF8 02:9EE8: 20 91 9F  JSR sub_9F91_decrease_Y_pos
C - - - - - 0x009EFB 02:9EEB: 60        RTS



ofs_001_9EEC_40_moving_down:
C - - J - - 0x009EFC 02:9EEC: 20 77 9F  JSR sub_9F77_decrease_X_pos
; bzk optimize, JMP
C - - - - - 0x009EFF 02:9EEF: 20 91 9F  JSR sub_9F91_decrease_Y_pos
C - - - - - 0x009F02 02:9EF2: 60        RTS



ofs_001_9EF3_60_moving_left:
C - - J - - 0x009F03 02:9EF3: 20 77 9F  JSR sub_9F77_decrease_X_pos
; bzk optimize, JMP
C - - - - - 0x009F06 02:9EF6: 20 5D 9F  JSR sub_9F5D_increase_Y_pos
C - - - - - 0x009F09 02:9EF9: 60        RTS



tbl_9EFA:
- D 0 - - - 0x009F0A 02:9EFA: DE 9E     .word ofs_001_9EDE_00_moving_up
- D 0 - - - 0x009F0C 02:9EFC: E5 9E     .word ofs_001_9EE5_20_moving_right
- D 0 - - - 0x009F0E 02:9EFE: EC 9E     .word ofs_001_9EEC_40_moving_down
- D 0 - - - 0x009F10 02:9F00: F3 9E     .word ofs_001_9EF3_60_moving_left
...
C - - - - - 0x009F69 02:9F59: 99 80 00  STA a: ram_obj_pos_X_hi,Y
...
C - - - - - 0x009F83 02:9F73: 99 9B 00  STA a: ram_obj_pos_Y_hi,Y
...
C - - - - - 0x009F9D 02:9F8D: 99 80 00  STA a: ram_obj_pos_X_hi,Y
...
C - - - - - 0x009FB7 02:9FA7: 99 9B 00  STA a: ram_obj_pos_Y_hi,Y
C - - - - - 0x009FBA 02:9FAA: 60        RTS



sub_9FAB_set_next_animation:
; in
    ; ram_0029_t08_animation_data
    ; ram_002B_t01_anim_dur_data
C - - - - - 0x009FBB 02:9FAB: D6 55     DEC ram_obj_amim_dur,X
C - - - - - 0x009FBD 02:9FAD: 10 22     BPL bra_9FD1_RTS
; bzk optimize, LDY,X
C - - - - - 0x009FBF 02:9FAF: B5 5C     LDA ram_obj_amim_cnt,X
C - - - - - 0x009FC1 02:9FB1: A8        TAY
C - - - - - 0x009FC2 02:9FB2: B1 29     LDA (ram_0029_t08_animation_data),Y
...
C - - - - - 0x009FCC 02:9FBC: A8        TAY ; 00
C - - - - - 0x009FCD 02:9FBD: 95 5C     STA ram_obj_amim_cnt,X
C - - - - - 0x009FCF 02:9FBF: B1 29     LDA (ram_0029_t08_animation_data),Y
C - - - - - 0x009FD1 02:9FC1: 4C C9 9F  JMP loc_9FC9
bra_9FC4:
; 80-FD, FF
C - - - - - 0x009FD4 02:9FC4: 29 7F     AND #$7F
C - - - - - 0x009FD6 02:9FC6: 95 43     STA ram_obj_state,X
C - - - - - 0x009FD8 02:9FC8: 60        RTS
bra_9FC9:
; 00-7F
loc_9FC9:   ; A = 00
C D 0 - - - 0x009FD9 02:9FC9: 95 C7     STA ram_animation_id,X
C - - - - - 0x009FDB 02:9FCB: B1 2B     LDA (ram_002B_t01_anim_dur_data),Y
C - - - - - 0x009FDD 02:9FCD: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x009FDF 02:9FCF: F6 5C     INC ram_obj_amim_cnt,X
bra_9FD1_RTS:
...
loc_9FD2:
sub_9FD2:
C D 0 - - - 0x009FE2 02:9FD2: 20 8A A4  JSR sub_A48A_set_pointers_for_2_animation_tables
C - - - - - 0x009FE5 02:9FD5: 20 10 9E  JSR sub_9E10
; bzk optimize, JMP
C - - - - - 0x009FE8 02:9FD8: 20 4B 9E  JSR sub_9E4B_move_object
...
; in
    ; A = damage
C - - - - - 0x009FEC 02:9FDC: 85 1D     STA ram_001D_t02_damage
C - - - - - 0x009FEE 02:9FDE: B9 1E 04  LDA ram_hp,Y
C - - - - - 0x009FF1 02:9FE1: 38        SEC
C - - - - - 0x009FF2 02:9FE2: E5 1D     SBC ram_001D_t02_damage
...
sub_9FEC:
; in
    ; ram_0029_t2D_pos_X_lo
C - - - - - 0x009FFC 02:9FEC: B5 77     LDA ram_obj_pos_X_lo,X
C - - - - - 0x009FFE 02:9FEE: 18        CLC
C - - - - - 0x009FFF 02:9FEF: 65 29     ADC ram_0029_t2D_pos_X_lo
C - - - - - 0x00A001 02:9FF1: 99 77 00  STA a: ram_obj_pos_X_lo,Y
C - - - - - 0x00A004 02:9FF4: B5 80     LDA ram_obj_pos_X_hi,X
C - - - - - 0x00A006 02:9FF6: 69 00     ADC #$00
C - - - - - 0x00A008 02:9FF8: 99 80 00  STA a: ram_obj_pos_X_hi,Y
C - - - - - 0x00A00B 02:9FFB: A5 29     LDA ram_0029_t2D_pos_X_lo
C - - - - - 0x00A00D 02:9FFD: 10 09     BPL bra_A008
C - - - - - 0x00A00F 02:9FFF: B9 80 00  LDA a: ram_obj_pos_X_hi,Y
C - - - - - 0x00A012 02:A002: 18        CLC
C - - - - - 0x00A013 02:A003: 69 FF     ADC #$FF
C - - - - - 0x00A015 02:A005: 99 80 00  STA a: ram_obj_pos_X_hi,Y
bra_A008:
C - - - - - 0x00A018 02:A008: B5 92     LDA ram_obj_pos_Y_lo,X
C - - - - - 0x00A01A 02:A00A: 99 92 00  STA a: ram_obj_pos_Y_lo,Y
C - - - - - 0x00A01D 02:A00D: B5 9B     LDA ram_obj_pos_Y_hi,X
...
C - - - - - 0x00A02E 02:A01E: 99 B6 00  STA a: ram_obj_pos_Z_hi,Y
C - - - - - 0x00A031 02:A021: A9 C0     LDA #$C0
C - - - - - 0x00A033 02:A023: 85 29     STA ram_0029_t32_direction
C - - - - - 0x00A035 02:A025: B5 63     LDA ram_0063_obj_facing,X
C - - - - - 0x00A037 02:A027: 10 04     BPL bra_A02D
C - - - - - 0x00A039 02:A029: A9 40     LDA #$40
C - - - - - 0x00A03B 02:A02B: 85 29     STA ram_0029_t32_direction
bra_A02D:
C - - - - - 0x00A03D 02:A02D: A5 29     LDA ram_0029_t32_direction
C - - - - - 0x00A03F 02:A02F: 99 0F 03  STA ram_obj_direction,Y
...
C - - - - - 0x00A049 02:A039: B5 43     LDA ram_obj_state,X
C - - - - - 0x00A04B 02:A03B: 09 80     ORA #$80
C - - - - - 0x00A04D 02:A03D: 95 43     STA ram_obj_state,X
C - - - - - 0x00A04F 02:A03F: A9 00     LDA #$00
C - - - - - 0x00A051 02:A041: 95 55     STA ram_obj_amim_dur,X
C - - - - - 0x00A053 02:A043: 95 5C     STA ram_obj_amim_cnt,X
C - - - - - 0x00A055 02:A045: 9D 1D 03  STA ram_obj_gravity_lo,X
...
C - - - - - 0x00A063 02:A053: BD 0F 03  LDA ram_obj_direction,X
C - - - - - 0x00A066 02:A056: C9 80     CMP #$80
C - - - - - 0x00A068 02:A058: B0 02     BCS bra_A05C
C - - - - - 0x00A06A 02:A05A: A0 80     LDY #$80
bra_A05C:
C - - - - - 0x00A06C 02:A05C: 94 63     STY ram_0063_obj_facing,X
...
C - - - - - 0x00A072 02:A062: B5 63     LDA ram_0063_obj_facing,X
C - - - - - 0x00A074 02:A064: 49 80     EOR #$80
C - - - - - 0x00A076 02:A066: 95 63     STA ram_0063_obj_facing,X
...
C - - - - - 0x00A07B 02:A06B: B0 05     BCS bra_A072_RTS    ; if enemy
; if 1p or 2p
C - - - - - 0x00A07D 02:A06D: B5 92     LDA ram_obj_pos_Y_lo,X
...
sub_A073_check_for_max_gravity:
C - - - - - 0x00A083 02:A073: E0 02     CPX #$02
C - - - - - 0x00A085 02:A075: B0 0E     BCS bra_A085_RTS    ; if enemy
; if 1p or 2p
C - - - - - 0x00A087 02:A077: BD 25 03  LDA ram_obj_gravity_hi,X
...
C - - - - - 0x00A092 02:A082: 9D 25 03  STA ram_obj_gravity_hi,X
bra_A085_RTS:
...
sub_A086:
C - - - - - 0x00A096 02:A086: AD 22 04  LDA ram_mission_id_hi
C - - - - - 0x00A099 02:A089: C9 09     CMP #con_mission_Trap_Room_pt3
...
bra_A0C4:
; 00-7E
C - - - - - 0x00A0D4 02:A0C4: 85 19     STA ram_0019_t10
...
C - - - - - 0x00A132 02:A122: AD 22 04  LDA ram_mission_id_hi
C - - - - - 0x00A135 02:A125: C9 06     CMP #con_mission_Mansion_of_Terror
...
C - - - - - 0x00A140 02:A130: 85 29     STA ram_0029_t11_data
C - - - - - 0x00A142 02:A132: A9 A1     LDA #> tbl_A1A0
C - - - - - 0x00A144 02:A134: 85 2A     STA ram_0029_t11_data + $01
C - - - - - 0x00A146 02:A136: A5 D1     LDA ram_cam_pos_X_hi
C - - - - - 0x00A148 02:A138: D0 08     BNE bra_A142
C - - - - - 0x00A14A 02:A13A: A9 BB     LDA #< tbl_A1BB
C - - - - - 0x00A14C 02:A13C: 85 29     STA ram_0029_t11_data
C - - - - - 0x00A14E 02:A13E: A9 A1     LDA #> tbl_A1BB
C - - - - - 0x00A150 02:A140: 85 2A     STA ram_0029_t11_data + $01
bra_A142:
C - - - - - 0x00A152 02:A142: AC 5D 06  LDY ram_065D
C - - - - - 0x00A155 02:A145: B1 29     LDA (ram_0029_t11_data),Y
...
bra_A16A:
C - - - - - 0x00A17A 02:A16A: 85 19     STA ram_0019_t04
C - - - - - 0x00A17C 02:A16C: 20 E4 A1  JSR sub_A1E4
C - - - - - 0x00A17F 02:A16F: B0 26     BCS bra_A197
C - - - - - 0x00A181 02:A171: A5 19     LDA ram_0019_t04
; / 10
...
C - - - - - 0x00A188 02:A178: A5 19     LDA ram_0019_t04
...
C - - - - - 0x00A192 02:A182: A5 19     LDA ram_0019_t04
C - - - - - 0x00A194 02:A184: 29 10     AND #$10
C - - - - - 0x00A196 02:A186: F0 0B     BEQ bra_A193
C - - - - - 0x00A198 02:A188: A5 19     LDA ram_0019_t04
...
; out
    ; C
        ; 0 = 
        ; 1 = 
C - - - - - 0x00A1F4 02:A1E4: A5 19     LDA ram_0019_t04
C - - - - - 0x00A1F6 02:A1E6: 29 0F     AND #$0F
; * 04
C - - - - - 0x00A1F8 02:A1E8: 0A        ASL
C - - - - - 0x00A1F9 02:A1E9: 0A        ASL
C - - - - - 0x00A1FA 02:A1EA: A8        TAY
C - - - - - 0x00A1FB 02:A1EB: A5 D0     LDA ram_cam_pos_X_lo
C - - - - - 0x00A1FD 02:A1ED: 38        SEC
C - - - - - 0x00A1FE 02:A1EE: F9 08 A2  SBC tbl_A208_pos_X,Y
C - - - - - 0x00A201 02:A1F1: A5 D1     LDA ram_cam_pos_X_hi
C - - - - - 0x00A203 02:A1F3: F9 09 A2  SBC tbl_A208_pos_X + $01,Y
C - - - - - 0x00A206 02:A1F6: 90 0E     BCC bra_A206
C - - - - - 0x00A208 02:A1F8: A5 D0     LDA ram_cam_pos_X_lo
C - - - - - 0x00A20A 02:A1FA: F9 0A A2  SBC tbl_A208_pos_X + $02,Y
C - - - - - 0x00A20D 02:A1FD: A5 D1     LDA ram_cam_pos_X_hi
C - - - - - 0x00A20F 02:A1FF: F9 0B A2  SBC tbl_A208_pos_X + $03,Y
...
tbl_A208_pos_X:
; 00 
- D 1 - - - 0x00A218 02:A208: 70 01     .word $0170 ; 
- D 1 - - - 0x00A21A 02:A20A: 10 02     .word $0210 ; 
; 01 
- D 1 - - - 0x00A21C 02:A20C: 50 01     .word $0150 ; 
- D 1 - - - 0x00A21E 02:A20E: 10 02     .word $0210 ; 
; 02 
- D 1 - - - 0x00A220 02:A210: 50 01     .word $0150 ; 
- D 1 - - - 0x00A222 02:A212: 10 02     .word $0210 ; ; 03 
- - - - - - 0x00A224 02:A214: 00 00     .word $0000 ; 
- - - - - - 0x00A226 02:A216: C0 00     .word $00C0 ; ; 04 
- - - - - - 0x00A228 02:A218: 00 00     .word $0000 ; 
- - - - - - 0x00A22A 02:A21A: 90 00     .word $0090 ; ; 05 
- D 1 - - - 0x00A22C 02:A21C: 00 00     .word $0000 ; 
- D 1 - - - 0x00A22E 02:A21E: 70 00     .word $0070 ; ; 06 
- D 1 - - - 0x00A230 02:A220: 00 00     .word $0000 ; 
- D 1 - - - 0x00A232 02:A222: 50 00     .word $0050 ; ; 07 
- D 1 - - - 0x00A234 02:A224: 00 00     .word $0000 ; 
- D 1 - - - 0x00A236 02:A226: 30 00     .word $0030 ; 
; 08 
- D 1 - - - 0x00A238 02:A228: 00 00     .word $0000 ; 
- D 1 - - - 0x00A23A 02:A22A: 08 00     .word $0008 ; 
; 09 
- D 1 - - - 0x00A23C 02:A22C: 00 00     .word $0000 ; 
- D 1 - - - 0x00A23E 02:A22E: 30 00     .word $0030 ; 
...
loc_A23A:
C D 1 - - - 0x00A24A 02:A23A: AD 22 04  LDA ram_mission_id_hi
C - - - - - 0x00A24D 02:A23D: C9 06     CMP #con_mission_Mansion_of_Terror
...
C - - - - - 0x00A258 02:A248: 85 29     STA ram_0029_t12_data
C - - - - - 0x00A25A 02:A24A: A9 A2     LDA #> tbl_A2D2
C - - - - - 0x00A25C 02:A24C: 85 2A     STA ram_0029_t12_data + $01
C - - - - - 0x00A25E 02:A24E: A5 D1     LDA ram_cam_pos_X_hi
C - - - - - 0x00A260 02:A250: D0 08     BNE bra_A25A
C - - - - - 0x00A262 02:A252: A9 E1     LDA #< tbl_A2E1
C - - - - - 0x00A264 02:A254: 85 29     STA ram_0029_t12_data
C - - - - - 0x00A266 02:A256: A9 A2     LDA #> tbl_A2E1
C - - - - - 0x00A268 02:A258: 85 2A     STA ram_0029_t12_data + $01
bra_A25A:
C - - - - - 0x00A26A 02:A25A: AC 5D 06  LDY ram_065D
C - - - - - 0x00A26D 02:A25D: B1 29     LDA (ram_0029_t12_data),Y
...
bra_A282:
C - - - - - 0x00A292 02:A282: 85 19     STA ram_0019_t04
C - - - - - 0x00A294 02:A284: 20 E4 A1  JSR sub_A1E4
C - - - - - 0x00A297 02:A287: B0 34     BCS bra_A2BD
C - - - - - 0x00A299 02:A289: A5 19     LDA ram_0019_t04
; / 10
...
C - - - - - 0x00A2A0 02:A290: A5 19     LDA ram_0019_t04
...
C - - - - - 0x00A2AA 02:A29A: A5 19     LDA ram_0019_t04
C - - - - - 0x00A2AC 02:A29C: 29 10     AND #$10
C - - - - - 0x00A2AE 02:A29E: F0 0E     BEQ bra_A2AE
C - - - - - 0x00A2B0 02:A2A0: A5 19     LDA ram_0019_t04
...
loc_A2F8:
C D 1 - - - 0x00A308 02:A2F8: AD 22 04  LDA ram_mission_id_hi
C - - - - - 0x00A30B 02:A2FB: C9 06     CMP #con_mission_Mansion_of_Terror
C - - - - - 0x00A30D 02:A2FD: D0 29     BNE bra_A328_RTS
C - - - - - 0x00A30F 02:A2FF: AD 5D 06  LDA ram_065D
C - - - - - 0x00A312 02:A302: 85 19     STA ram_0019_t04
...
sub_A329:
C - - - - - 0x00A339 02:A329: A5 D0     LDA ram_cam_pos_X_lo
C - - - - - 0x00A33B 02:A32B: 38        SEC
C - - - - - 0x00A33C 02:A32C: E9 A0     SBC #< $00A0
C - - - - - 0x00A33E 02:A32E: A5 D1     LDA ram_cam_pos_X_hi
C - - - - - 0x00A340 02:A330: E9 00     SBC #> $00A0
C - - - - - 0x00A342 02:A332: 90 10     BCC bra_A344_RTS
C - - - - - 0x00A344 02:A334: A9 70     LDA #< $0170
C - - - - - 0x00A346 02:A336: 38        SEC
C - - - - - 0x00A347 02:A337: E5 D0     SBC ram_cam_pos_X_lo
C - - - - - 0x00A349 02:A339: A9 01     LDA #> $0170
C - - - - - 0x00A34B 02:A33B: E5 D1     SBC ram_cam_pos_X_hi
...
sub_A345_drop_weapon_when_knocked_down:
...
C - - - - - 0x00A36F 02:A35F: B5 43     LDA ram_obj_state,X
C - - - - - 0x00A371 02:A361: 29 7F     AND #$7F
C - - - - - 0x00A373 02:A363: C9 58     CMP #con_state_58
C - - - - - 0x00A375 02:A365: F0 03     BEQ bra_A36A
C - - - - - 0x00A377 02:A367: 20 66 A4  JSR sub_A466_copy_data_between_two_objects
bra_A36A:
C - - - - - 0x00A37A 02:A36A: A9 00     LDA #$00
C - - - - - 0x00A37C 02:A36C: 9D 46 04  STA ram_0446_obj,X
C - - - - - 0x00A37F 02:A36F: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x00A382 02:A372: 29 DF     AND #con_004A_flag_20 ^ $FF
...
C - - - - - 0x00A394 02:A384: 85 29     STA ram_0029_t2D_pos_X_lo
bra_A386:
C - - - - - 0x00A396 02:A386: 20 EC 9F  JSR sub_9FEC
C - - - - - 0x00A399 02:A389: B9 0F 03  LDA ram_obj_direction,Y
C - - - - - 0x00A39C 02:A38C: 18        CLC
C - - - - - 0x00A39D 02:A38D: 69 80     ADC #$80
C - - - - - 0x00A39F 02:A38F: 99 0F 03  STA ram_obj_direction,Y
C - - - - - 0x00A3A2 02:A392: A9 1A     LDA #con_state_1A
C - - - - - 0x00A3A4 02:A394: 99 43 00  STA a: ram_obj_state,Y
...
C - - - - - 0x00A3B0 02:A3A0: 99 43 00  STA a: ram_obj_state,Y
bra_A3A3_RTS:
...
- D 1 - - - 0x00A3CE 02:A3BE: 00        .byte $00   ; 1A con_obj_boomerang
...
- - - - - - 0x00A3D2 02:A3C2: 00        .byte $00   ; 1E con_obj_symbol_II
...
loc_A3C5_loop:
C D 1 - - - 0x00A3D5 02:A3C5: B5 3C     LDA ram_003C_obj_flags,X ; 0040 0041 0042
C - - - - - 0x00A3D7 02:A3C7: 10 61     BPL bra_A42A    ; if not con_003C_flag_exist
C - - - - - 0x00A3D9 02:A3C9: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x00A3DB 02:A3CB: 29 20     AND #con_004A_flag_20
C - - - - - 0x00A3DD 02:A3CD: D0 5B     BNE bra_A42A
C - - - - - 0x00A3DF 02:A3CF: B5 92     LDA ram_obj_pos_Y_lo,X
C - - - - - 0x00A3E1 02:A3D1: 18        CLC
C - - - - - 0x00A3E2 02:A3D2: 75 AD     ADC ram_obj_pos_Z_lo,X
...
bra_A3EE:
C - - - - - 0x00A3FE 02:A3EE: B5 77     LDA ram_obj_pos_X_lo,X
C - - - - - 0x00A400 02:A3F0: 38        SEC
C - - - - - 0x00A401 02:A3F1: E5 D0     SBC ram_cam_pos_X_lo
...
bra_A416:
C - - - - - 0x00A426 02:A416: A5 2B     LDA ram_002B_t24_lo
...
C - - - - - 0x00A450 02:A440: 95 3C     STA ram_003C_obj_flags,X ; 0040 0041 0042
bra_A442_RTS:
...
; bzk optimize, JMP
C - - - - - 0x00A45E 02:A44E: 20 45 A3  JSR sub_A345_drop_weapon_when_knocked_down
bra_A451_RTS:
...
C - - - - - 0x00A462 02:A452: 84 1B     STY ram_001B_tFF_uselesss
C - - - - - 0x00A464 02:A454: 85 1C     STA ram_001C_t04
C - - - - - 0x00A466 02:A456: A5 19     LDA ram_0019_t03_obj_index
C - - - - - 0x00A468 02:A458: 48        PHA
C - - - - - 0x00A469 02:A459: A5 1C     LDA ram_001C_t04
C - - - - - 0x00A46B 02:A45B: 20 FB BD  JSR sub_BDFB
C - - - - - 0x00A46E 02:A45E: 68        PLA
C - - - - - 0x00A46F 02:A45F: 85 19     STA ram_0019_t03_obj_index
C - - - - - 0x00A471 02:A461: A4 1C     LDY ram_001C_t04
C - - - - - 0x00A473 02:A463: A6 19     LDX ram_0019_t03_obj_index
C - - - - - 0x00A475 02:A465: 60        RTS



sub_A466_copy_data_between_two_objects:
...
sub_A473:
C - - - - - 0x00A483 02:A473: B5 92     LDA ram_obj_pos_Y_lo,X
C - - - - - 0x00A485 02:A475: 38        SEC
C - - - - - 0x00A486 02:A476: F9 92 00  SBC a: ram_obj_pos_Y_lo,Y
C - - - - - 0x00A489 02:A479: F0 0E     BEQ bra_A489_RTS
C - - - - - 0x00A48B 02:A47B: F6 92     INC ram_obj_pos_Y_lo,X
C - - - - - 0x00A48D 02:A47D: F6 92     INC ram_obj_pos_Y_lo,X
C - - - - - 0x00A48F 02:A47F: 90 08     BCC bra_A489_RTS
C - - - - - 0x00A491 02:A481: D6 92     DEC ram_obj_pos_Y_lo,X
C - - - - - 0x00A493 02:A483: D6 92     DEC ram_obj_pos_Y_lo,X
C - - - - - 0x00A495 02:A485: D6 92     DEC ram_obj_pos_Y_lo,X
C - - - - - 0x00A497 02:A487: D6 92     DEC ram_obj_pos_Y_lo,X
bra_A489_RTS:
C - - - - - 0x00A499 02:A489: 60        RTS



sub_A48A_set_pointers_for_2_animation_tables:
; see con_A48A_anim
; * 04
...
C - - - - - 0x00A4A0 02:A490: 85 29     STA ram_0029_t08_animation_data
C - - - - - 0x00A4A2 02:A492: B9 AB A4  LDA tbl_A4AA + $01,Y
C - - - - - 0x00A4A5 02:A495: 85 2A     STA ram_0029_t08_animation_data + $01
C - - - - - 0x00A4A7 02:A497: B9 AC A4  LDA tbl_A4AA + $02,Y
C - - - - - 0x00A4AA 02:A49A: 85 2B     STA ram_002B_t01_anim_dur_data
C - - - - - 0x00A4AC 02:A49C: B9 AD A4  LDA tbl_A4AA + $03,Y
C - - - - - 0x00A4AF 02:A49F: 85 2C     STA ram_002B_t01_anim_dur_data + $01
C - - - - - 0x00A4B1 02:A4A1: 20 AB 9F  JSR sub_9FAB_set_next_animation
C - - - - - 0x00A4B4 02:A4A4: 20 F8 9D  JSR sub_9DF8_set_mirrored_amination
C - - - - - 0x00A4B7 02:A4A7: A6 19     LDX ram_0019_t03_obj_index
...
; 0F 
- - - - - - 0x00A4F6 02:A4E6: F1 8C     .word _off000_8CF1_0F ; unused, index doesn't exist
- - - - - - 0x00A4F8 02:A4E8: E5 8C     .word _off001_8CE5_0F ; unused, index doesn't exist
; 10 
- - - - - - 0x00A4FA 02:A4EA: F5 8C     .word _off000_8CF5_10 ; unused, index doesn't exist
- - - - - - 0x00A4FC 02:A4EC: E5 8C     .word _off001_8CE5_10 ; unused, index doesn't exist
; 11 
...
C - - - - - 0x00A819 02:A809: A5 3A     LDA ram_copy_base_nmt
...
C - - - - - 0x00A823 02:A813: AD 22 04  LDA ram_mission_id_hi
C - - - - - 0x00A826 02:A816: 0A        ASL
C - - - - - 0x00A827 02:A817: A8        TAY
C - - - - - 0x00A828 02:A818: B9 91 AC  LDA tbl_AC91_background_attributes,Y
C - - - - - 0x00A82B 02:A81B: 85 29     STA ram_0029_t06_bg_attr_data
C - - - - - 0x00A82D 02:A81D: B9 92 AC  LDA tbl_AC91_background_attributes + $01,Y
C - - - - - 0x00A830 02:A820: 85 2A     STA ram_0029_t06_bg_attr_data + $01
C - - - - - 0x00A832 02:A822: A2 30     LDX #$30
C - - - - - 0x00A834 02:A824: A5 3A     LDA ram_copy_base_nmt
...
bra_A82E_loop:
C - - - - - 0x00A83E 02:A82E: B1 29     LDA (ram_0029_t06_bg_attr_data),Y
C - - - - - 0x00A840 02:A830: 9D BD 05  STA ram_bg_attr_buffer,X
...
C - - - - - 0x00A84B 02:A83B: 8D 85 04  STA ram_0485_hud_draw_script
...
C - - - - - 0x00A859 02:A849: 8D 85 04  STA ram_0485_hud_draw_script
bra_A84C:
...
C - - - - - 0x00A875 02:A865: AD 85 04  LDA ram_0485_hud_draw_script
C - - - - - 0x00A878 02:A868: C9 0C     CMP #$0C
C - - - - - 0x00A87A 02:A86A: 90 05     BCC bra_A871_not_overflow
C - - - - - 0x00A87C 02:A86C: A9 00     LDA #$00
C - - - - - 0x00A87E 02:A86E: 8D 85 04  STA ram_0485_hud_draw_script
bra_A871_not_overflow:
C - - - - - 0x00A881 02:A871: 0A        ASL
C - - - - - 0x00A882 02:A872: A8        TAY
C - - - - - 0x00A883 02:A873: B9 81 A8  LDA tbl_A881_draw_hud_handlers,Y
C - - - - - 0x00A886 02:A876: 85 29     STA ram_0029_t27_jmp
C - - - - - 0x00A888 02:A878: B9 82 A8  LDA tbl_A881_draw_hud_handlers + $01,Y
C - - - - - 0x00A88B 02:A87B: 85 2A     STA ram_0029_t27_jmp + $01
C - - - - - 0x00A88D 02:A87D: 6C 29 00  JMP (ram_0029_t27_jmp)
bra_A880_RTS:
C - - - - - 0x00A890 02:A880: 60        RTS



tbl_A881_draw_hud_handlers:
; 2300-23BF
- D 1 - - - 0x00A891 02:A881: 99 A8     .word ofs_002_A899_00_empty_line
- D 1 - - - 0x00A893 02:A883: BA A8     .word ofs_002_A8BA_01_above_hp_line
- D 1 - - - 0x00A895 02:A885: 31 A9     .word ofs_002_A931_02_hp_line
- D 1 - - - 0x00A897 02:A887: DF A9     .word ofs_002_A9DF_03_below_hp_line
- D 1 - - - 0x00A899 02:A889: 55 AA     .word ofs_002_AA55_04_lives_and_score_line
- D 1 - - - 0x00A89B 02:A88B: 1E AB     .word ofs_002_AB1E_05_below_score_line
; 2B00-2BBF
- D 1 - - - 0x00A89D 02:A88D: 63 AB     .word ofs_002_AB63_06_empty_line
- D 1 - - - 0x00A89F 02:A88F: 7A AB     .word ofs_002_AB7A_07_above_hp_line
- D 1 - - - 0x00A8A1 02:A891: 95 AB     .word ofs_002_AB95_08_hp_line
- D 1 - - - 0x00A8A3 02:A893: B0 AB     .word ofs_002_ABB0_09_below_hp_line
- D 1 - - - 0x00A8A5 02:A895: CB AB     .word ofs_002_ABCB_0A_lives_and_score_line
- D 1 - - - 0x00A8A7 02:A897: E6 AB     .word ofs_002_ABE6_0B_below_score_line



ofs_002_A899_00_empty_line:
C - - J - - 0x00A8A9 02:A899: A5 3A     LDA ram_copy_base_nmt
C - - - - - 0x00A8AB 02:A89B: 29 02     AND #$02
C - - - - - 0x00A8AD 02:A89D: D0 06     BNE bra_A8A5
C - - - - - 0x00A8AF 02:A89F: A5 E6     LDA ram_scroll_Y_3
C - - - - - 0x00A8B1 02:A8A1: C9 C8     CMP #$C8
C - - - - - 0x00A8B3 02:A8A3: 90 11     BCC bra_A8B6_exit
bra_A8A5:
C - - - - - 0x00A8B5 02:A8A5: A9 23     LDA #> $2300
C - - - - - 0x00A8B7 02:A8A7: A0 00     LDY #< $2300
loc_A8A9:
C D 1 - - - 0x00A8B9 02:A8A9: 20 FE AB  JSR sub_ABFE_allocate_20h_memory_in_ppu_buffer
C - - - - - 0x00A8BC 02:A8AC: A9 00     LDA #$00    ; tile
C - - - - - 0x00A8BE 02:A8AE: A0 20     LDY #$20    ; counter
C - - - - - 0x00A8C0 02:A8B0: 20 7B AC  JSR sub_AC7B_write_A_to_buffer_Y_times
C - - - - - 0x00A8C3 02:A8B3: 8E BC 05  STX ram_buffer_index_2
bra_A8B6_exit:
C - - - - - 0x00A8C6 02:A8B6: EE 85 04  INC ram_0485_hud_draw_script
C - - - - - 0x00A8C9 02:A8B9: 60        RTS



ofs_002_A8BA_01_above_hp_line:
C - - J - - 0x00A8CA 02:A8BA: AD 3A 00  LDA a: ram_copy_base_nmt
C - - - - - 0x00A8CD 02:A8BD: 29 02     AND #$02
C - - - - - 0x00A8CF 02:A8BF: D0 0A     BNE bra_A8CB
C - - - - - 0x00A8D1 02:A8C1: A5 E6     LDA ram_scroll_Y_3
C - - - - - 0x00A8D3 02:A8C3: C9 08     CMP #$08
C - - - - - 0x00A8D5 02:A8C5: 90 04     BCC bra_A8CB
C - - - - - 0x00A8D7 02:A8C7: C9 D0     CMP #$D0
C - - - - - 0x00A8D9 02:A8C9: 90 22     BCC bra_A8ED_exit
bra_A8CB:
C - - - - - 0x00A8DB 02:A8CB: A9 23     LDA #> $2320
C - - - - - 0x00A8DD 02:A8CD: A0 20     LDY #< $2320
loc_A8CF:
C D 1 - - - 0x00A8DF 02:A8CF: 20 FE AB  JSR sub_ABFE_allocate_20h_memory_in_ppu_buffer
C - - - - - 0x00A8E2 02:A8D2: A9 F1     LDA #< tbl_A8F1_top_hud_line_tiles
C - - - - - 0x00A8E4 02:A8D4: 85 29     STA ram_0029_t05_ppu_data
C - - - - - 0x00A8E6 02:A8D6: A9 A8     LDA #> tbl_A8F1_top_hud_line_tiles
C - - - - - 0x00A8E8 02:A8D8: 85 2A     STA ram_0029_t05_ppu_data + $01
C - - - - - 0x00A8EA 02:A8DA: AD 34 00  LDA a: ram_game_mode
C - - - - - 0x00A8ED 02:A8DD: 10 08     BPL bra_A8E7
; if con_gm_2_players
C - - - - - 0x00A8EF 02:A8DF: A9 11     LDA #< tbl_A911_top_hud_line_tiles
C - - - - - 0x00A8F1 02:A8E1: 85 29     STA ram_0029_t05_ppu_data
C - - - - - 0x00A8F3 02:A8E3: A9 A9     LDA #> tbl_A911_top_hud_line_tiles
C - - - - - 0x00A8F5 02:A8E5: 85 2A     STA ram_0029_t05_ppu_data + $01
bra_A8E7:
C - - - - - 0x00A8F7 02:A8E7: 20 83 AC  JSR sub_AC83_write_20h_bytes_from_table_to_buffer
C - - - - - 0x00A8FA 02:A8EA: 8E BC 05  STX ram_buffer_index_2
bra_A8ED_exit:
C - - - - - 0x00A8FD 02:A8ED: EE 85 04  INC ram_0485_hud_draw_script
C - - - - - 0x00A900 02:A8F0: 60        RTS



tbl_A8F1_top_hud_line_tiles:
- D 1 - I - 0x00A901 02:A8F1: 00        .byte $00, $00, $D2, $D0, $00, $00, $00, $00, $00, $00, $00, $00, $D8, $D9, $D9, $D9   ; 
- D 1 - I - 0x00A911 02:A901: D9        .byte $D9, $D9, $D9, $DA, $D2, $D1, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00   ; 



tbl_A911_top_hud_line_tiles:
; bzk optimize, same bytes as 0x00A901
- D 1 - I - 0x00A921 02:A911: 00        .byte $00, $00, $D2, $D0, $00, $00, $00, $00, $00, $00, $00, $00, $D8, $D9, $D9, $D9   ; 
- D 1 - I - 0x00A931 02:A921: D9        .byte $D9, $D9, $D9, $DA, $D2, $D1, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00   ; 



ofs_002_A931_02_hp_line:
C - - J - - 0x00A941 02:A931: A5 3A     LDA ram_copy_base_nmt
C - - - - - 0x00A943 02:A933: 29 02     AND #$02
C - - - - - 0x00A945 02:A935: D0 0C     BNE bra_A943
C - - - - - 0x00A947 02:A937: A5 E6     LDA ram_scroll_Y_3
C - - - - - 0x00A949 02:A939: C9 10     CMP #$10
C - - - - - 0x00A94B 02:A93B: 90 06     BCC bra_A943
C - - - - - 0x00A94D 02:A93D: A5 E6     LDA ram_scroll_Y_3
C - - - - - 0x00A94F 02:A93F: C9 D8     CMP #$D8
C - - - - - 0x00A951 02:A941: 90 4F     BCC bra_A992_exit
bra_A943:
C - - - - - 0x00A953 02:A943: A9 23     LDA #> $2340
C - - - - - 0x00A955 02:A945: A0 40     LDY #< $2340
loc_A947:
C D 1 - - - 0x00A957 02:A947: 20 FE AB  JSR sub_ABFE_allocate_20h_memory_in_ppu_buffer
C - - - - - 0x00A95A 02:A94A: A0 00     LDY #$00
bra_A94C_loop:
C - - - - - 0x00A95C 02:A94C: B9 96 A9  LDA tbl_A996_lower_tiles_for_P1,Y
...
C - - - - - 0x00A96B 02:A95B: 20 A4 A9  JSR sub_A9A4_write_hp_to_buffer
C - - - - - 0x00A96E 02:A95E: A0 00     LDY #$00
bra_A960_loop:
C - - - - - 0x00A970 02:A960: B9 9A A9  LDA tbl_A99A_tiles_hi_score,Y
...
C - - - - - 0x00A97F 02:A96F: 30 11     BMI bra_A982
; if not con_gm_2_players
C - - - - - 0x00A981 02:A971: A9 FE     LDA #$FE    ; tile
C - - - - - 0x00A983 02:A973: A0 08     LDY #$08    ; counter
C - - - - - 0x00A985 02:A975: 20 7B AC  JSR sub_AC7B_write_A_to_buffer_Y_times
C - - - - - 0x00A988 02:A978: A9 00     LDA #$00    ; tile
C - - - - - 0x00A98A 02:A97A: A0 02     LDY #$02    ; counter
C - - - - - 0x00A98C 02:A97C: 20 7B AC  JSR sub_AC7B_write_A_to_buffer_Y_times
C - - - - - 0x00A98F 02:A97F: 4C 8F A9  JMP loc_A98F
bra_A982:
C - - - - - 0x00A992 02:A982: AD 1F 04  LDA ram_hp + $01
C - - - - - 0x00A995 02:A985: 20 A4 A9  JSR sub_A9A4_write_hp_to_buffer
C - - - - - 0x00A998 02:A988: A9 00     LDA #$00    ; tile
C - - - - - 0x00A99A 02:A98A: A0 02     LDY #$02    ; counter
C - - - - - 0x00A99C 02:A98C: 20 7B AC  JSR sub_AC7B_write_A_to_buffer_Y_times
loc_A98F:
C D 1 - - - 0x00A99F 02:A98F: 8E BC 05  STX ram_buffer_index_2
bra_A992_exit:
C - - - - - 0x00A9A2 02:A992: EE 85 04  INC ram_0485_hud_draw_script
C - - - - - 0x00A9A5 02:A995: 60        RTS



tbl_A996_lower_tiles_for_P1:
- D 1 - - - 0x00A9A6 02:A996: 00        .byte $00, $00, $E2, $E0   ; 



tbl_A99A_tiles_hi_score:
- D 1 - - - 0x00A9AA 02:A99A: F5        .byte $F5, $F6, $F7, $F8, $F9, $FA, $FB, $FC, $E2, $E1   ; 



sub_A9A4_write_hp_to_buffer:
; in
    ; A = 
C - - - - - 0x00A9B4 02:A9A4: 85 19     STA ram_0019_t05
C - - - - - 0x00A9B6 02:A9A6: A9 08     LDA #$08
C - - - - - 0x00A9B8 02:A9A8: 85 1A     STA ram_001A_t01_loop_counter
...
C - - - - - 0x00A9C4 02:A9B4: 65 19     ADC ram_0019_t05
C - - - - - 0x00A9C6 02:A9B6: 38        SEC
C - - - - - 0x00A9C7 02:A9B7: E9 01     SBC #$01
C - - - - - 0x00A9C9 02:A9B9: 85 19     STA ram_0019_t05
bra_A9BB_loop:
C - - - - - 0x00A9CB 02:A9BB: A9 FD     LDA #$FD    ; tile for full hp
C - - - - - 0x00A9CD 02:A9BD: 85 1B     STA ram_001B_t04_tile
C - - - - - 0x00A9CF 02:A9BF: A5 19     LDA ram_0019_t05
C - - - - - 0x00A9D1 02:A9C1: 38        SEC
C - - - - - 0x00A9D2 02:A9C2: F9 DC A9  SBC tbl_A9DC,Y
C - - - - - 0x00A9D5 02:A9C5: 85 19     STA ram_0019_t05
C - - - - - 0x00A9D7 02:A9C7: B0 08     BCS bra_A9D1_not_underflow
C - - - - - 0x00A9D9 02:A9C9: A9 00     LDA #$00
C - - - - - 0x00A9DB 02:A9CB: 85 19     STA ram_0019_t05
C - - - - - 0x00A9DD 02:A9CD: A9 FE     LDA #$FE    ; tile for empty hp
C - - - - - 0x00A9DF 02:A9CF: 85 1B     STA ram_001B_t04_tile
bra_A9D1_not_underflow:
C - - - - - 0x00A9E1 02:A9D1: A5 1B     LDA ram_001B_t04_tile
C - - - - - 0x00A9E3 02:A9D3: 9D B1 04  STA ram_ppu_buffer,X
C - - - - - 0x00A9E6 02:A9D6: E8        INX
C - - - - - 0x00A9E7 02:A9D7: C6 1A     DEC ram_001A_t01_loop_counter
...
ofs_002_A9DF_03_below_hp_line:
C - - J - - 0x00A9EF 02:A9DF: A5 3A     LDA ram_copy_base_nmt
C - - - - - 0x00A9F1 02:A9E1: 29 02     AND #$02
C - - - - - 0x00A9F3 02:A9E3: D0 0A     BNE bra_A9EF
C - - - - - 0x00A9F5 02:A9E5: A5 E6     LDA ram_scroll_Y_3
C - - - - - 0x00A9F7 02:A9E7: C9 18     CMP #$18
C - - - - - 0x00A9F9 02:A9E9: 90 04     BCC bra_A9EF
C - - - - - 0x00A9FB 02:A9EB: C9 E0     CMP #$E0
C - - - - - 0x00A9FD 02:A9ED: 90 22     BCC bra_AA11_exit
bra_A9EF:
C - - - - - 0x00A9FF 02:A9EF: A9 23     LDA #> $2360
C - - - - - 0x00AA01 02:A9F1: A0 60     LDY #< $2360
loc_A9F3:
C D 1 - - - 0x00AA03 02:A9F3: 20 FE AB  JSR sub_ABFE_allocate_20h_memory_in_ppu_buffer
C - - - - - 0x00AA06 02:A9F6: A9 15     LDA #< tbl_AA15_tiles_1_player
C - - - - - 0x00AA08 02:A9F8: 85 29     STA ram_0029_t05_ppu_data
C - - - - - 0x00AA0A 02:A9FA: A9 AA     LDA #> tbl_AA15_tiles_1_player
C - - - - - 0x00AA0C 02:A9FC: 85 2A     STA ram_0029_t05_ppu_data + $01
C - - - - - 0x00AA0E 02:A9FE: AD 34 00  LDA a: ram_game_mode
C - - - - - 0x00AA11 02:AA01: 10 08     BPL bra_AA0B
; if con_gm_2_players
C - - - - - 0x00AA13 02:AA03: A9 35     LDA #< tbl_AA35_tiles_2_players
C - - - - - 0x00AA15 02:AA05: 85 29     STA ram_0029_t05_ppu_data
C - - - - - 0x00AA17 02:AA07: A9 AA     LDA #> tbl_AA35_tiles_2_players
C - - - - - 0x00AA19 02:AA09: 85 2A     STA ram_0029_t05_ppu_data + $01
bra_AA0B:
C - - - - - 0x00AA1B 02:AA0B: 20 83 AC  JSR sub_AC83_write_20h_bytes_from_table_to_buffer
C - - - - - 0x00AA1E 02:AA0E: 8E BC 05  STX ram_buffer_index_2
bra_AA11_exit:
C - - - - - 0x00AA21 02:AA11: EE 85 04  INC ram_0485_hud_draw_script
C - - - - - 0x00AA24 02:AA14: 60        RTS



tbl_AA15_tiles_1_player:
- D 1 - I - 0x00AA25 02:AA15: 00        .byte $00, $00, $00, $00, $E9, $E9, $E9, $E9, $E9, $E9, $E9, $E9, $D8, $D9, $D9, $D9   ; 
- D 1 - I - 0x00AA35 02:AA25: D9        .byte $D9, $D9, $D9, $DA, $00, $00, $E9, $E9, $E9, $E9, $E9, $E9, $E9, $E9, $00, $00   ; 



tbl_AA35_tiles_2_players:
- D 1 - I - 0x00AA45 02:AA35: 00        .byte $00, $00, $00, $00, $E9, $E9, $E9, $E9, $E9, $E9, $E9, $E9, $D8, $D9, $D9, $D9   ; 
- D 1 - I - 0x00AA55 02:AA45: D9        .byte $D9, $D9, $D9, $DA, $E9, $E9, $E9, $E9, $E9, $E9, $E9, $E9, $E9, $E9, $00, $00   ; 



ofs_002_AA55_04_lives_and_score_line:
C - - J - - 0x00AA65 02:AA55: A5 3A     LDA ram_copy_base_nmt
C - - - - - 0x00AA67 02:AA57: 29 02     AND #$02
C - - - - - 0x00AA69 02:AA59: D0 0B     BNE bra_AA66
C - - - - - 0x00AA6B 02:AA5B: AD E6 00  LDA a: ram_scroll_Y_3
C - - - - - 0x00AA6E 02:AA5E: C9 20     CMP #$20
C - - - - - 0x00AA70 02:AA60: 90 04     BCC bra_AA66
C - - - - - 0x00AA72 02:AA62: C9 E8     CMP #$E8
C - - - - - 0x00AA74 02:AA64: 90 77     BCC bra_AADD_exit
bra_AA66:
C - - - - - 0x00AA76 02:AA66: A9 23     LDA #> $2380
C - - - - - 0x00AA78 02:AA68: A0 80     LDY #< $2380
loc_AA6A:
C D 1 - - - 0x00AA7A 02:AA6A: 20 FE AB  JSR sub_ABFE_allocate_20h_memory_in_ppu_buffer
C - - - - - 0x00AA7D 02:AA6D: A9 00     LDA #$00    ; tile
C - - - - - 0x00AA7F 02:AA6F: A0 02     LDY #$02    ; counter
C - - - - - 0x00AA81 02:AA71: 20 7B AC  JSR sub_AC7B_write_A_to_buffer_Y_times
C - - - - - 0x00AA84 02:AA74: A9 F2     LDA #$F2    ; tile for X symbol
C - - - - - 0x00AA86 02:AA76: 9D B1 04  STA ram_ppu_buffer,X
C - - - - - 0x00AA89 02:AA79: E8        INX
C - - - - - 0x00AA8A 02:AA7A: AC 32 04  LDY ram_lives
C - - - - - 0x00AA8D 02:AA7D: B9 70 AC  LDA tbl_AC70_tiles_for_lives,Y
C - - - - - 0x00AA90 02:AA80: 9D B1 04  STA ram_ppu_buffer,X
C - - - - - 0x00AA93 02:AA83: E8        INX
C - - - - - 0x00AA94 02:AA84: A9 00     LDA #$00    ; tile
C - - - - - 0x00AA96 02:AA86: A0 02     LDY #$02    ; counter
C - - - - - 0x00AA98 02:AA88: 20 7B AC  JSR sub_AC7B_write_A_to_buffer_Y_times
C - - - - - 0x00AA9B 02:AA8B: A0 00     LDY #$00    ; score 1p
C - - - - - 0x00AA9D 02:AA8D: 20 EC AA  JSR sub_AAEC_write_score_to_buffer
C - - - - - 0x00AAA0 02:AA90: A9 00     LDA #$00
C - - - - - 0x00AAA2 02:AA92: 9D B1 04  STA ram_ppu_buffer,X
C - - - - - 0x00AAA5 02:AA95: E8        INX
C - - - - - 0x00AAA6 02:AA96: A0 06     LDY #$06    ; score 2p
C - - - - - 0x00AAA8 02:AA98: 20 EC AA  JSR sub_AAEC_write_score_to_buffer
C - - - - - 0x00AAAB 02:AA9B: A9 00     LDA #$00
C - - - - - 0x00AAAD 02:AA9D: 9D B1 04  STA ram_ppu_buffer,X
C - - - - - 0x00AAB0 02:AAA0: E8        INX
C - - - - - 0x00AAB1 02:AAA1: A9 F2     LDA #$F2    ; tile for X symbol
C - - - - - 0x00AAB3 02:AAA3: 9D B1 04  STA ram_ppu_buffer,X
C - - - - - 0x00AAB6 02:AAA6: E8        INX
C - - - - - 0x00AAB7 02:AAA7: AD 34 00  LDA a: ram_game_mode
C - - - - - 0x00AABA 02:AAAA: 30 11     BMI bra_AABD
; if not con_gm_2_players
...
C - - - - - 0x00AAD0 02:AAC0: B9 70 AC  LDA tbl_AC70_tiles_for_lives,Y
C - - - - - 0x00AAD3 02:AAC3: 9D B1 04  STA ram_ppu_buffer,X
C - - - - - 0x00AAD6 02:AAC6: E8        INX
C - - - - - 0x00AAD7 02:AAC7: A9 00     LDA #$00    ; tile
C - - - - - 0x00AAD9 02:AAC9: A0 02     LDY #$02    ; counter
C - - - - - 0x00AADB 02:AACB: 20 7B AC  JSR sub_AC7B_write_A_to_buffer_Y_times
C - - - - - 0x00AADE 02:AACE: A0 03     LDY #$03    ; hi-score
C - - - - - 0x00AAE0 02:AAD0: 20 EC AA  JSR sub_AAEC_write_score_to_buffer
C - - - - - 0x00AAE3 02:AAD3: A9 00     LDA #$00    ; tile
C - - - - - 0x00AAE5 02:AAD5: A0 02     LDY #$02    ; counter
C - - - - - 0x00AAE7 02:AAD7: 20 7B AC  JSR sub_AC7B_write_A_to_buffer_Y_times
loc_AADA:
C D 1 - - - 0x00AAEA 02:AADA: 8E BC 05  STX ram_buffer_index_2
bra_AADD_exit:
C - - - - - 0x00AAED 02:AADD: EE 85 04  INC ram_0485_hud_draw_script
...
sub_AAEC_write_score_to_buffer:
C - - - - - 0x00AAFC 02:AAEC: B9 86 04  LDA ram_score_player,Y
C - - - - - 0x00AAFF 02:AAEF: 85 19     STA ram_0019_t06_score
C - - - - - 0x00AB01 02:AAF1: B9 87 04  LDA ram_score_player + $01,Y
C - - - - - 0x00AB04 02:AAF4: 85 1A     STA ram_0019_t06_score + $01
C - - - - - 0x00AB06 02:AAF6: B9 88 04  LDA ram_score_player + $02,Y
C - - - - - 0x00AB09 02:AAF9: 85 1B     STA ram_0019_t06_score + $02
C - - - - - 0x00AB0B 02:AAFB: A9 07     LDA #$07
C - - - - - 0x00AB0D 02:AAFD: 85 1C     STA ram_001C_t01_loop_counter
loc_AAFF_loop:
C D 1 - - - 0x00AB0F 02:AAFF: C6 1C     DEC ram_001C_t01_loop_counter
C - - - - - 0x00AB11 02:AB01: D0 01     BNE bra_AB04
C - - - - - 0x00AB13 02:AB03: 60        RTS
bra_AB04:
C - - - - - 0x00AB14 02:AB04: A5 1B     LDA ram_0019_t06_score + $02
C - - - - - 0x00AB16 02:AB06: 29 0F     AND #$0F
C - - - - - 0x00AB18 02:AB08: A8        TAY
C - - - - - 0x00AB19 02:AB09: B9 71 AC  LDA tbl_AC70_tiles_for_score + $01,Y
C - - - - - 0x00AB1C 02:AB0C: 9D B1 04  STA ram_ppu_buffer,X
C - - - - - 0x00AB1F 02:AB0F: E8        INX
C - - - - - 0x00AB20 02:AB10: A0 04     LDY #$04
bra_AB12_loop:
C - - - - - 0x00AB22 02:AB12: 06 19     ASL ram_0019_t06_score
C - - - - - 0x00AB24 02:AB14: 26 1A     ROL ram_0019_t06_score + $01
C - - - - - 0x00AB26 02:AB16: 26 1B     ROL ram_0019_t06_score + $02
C - - - - - 0x00AB28 02:AB18: 88        DEY
C - - - - - 0x00AB29 02:AB19: D0 F7     BNE bra_AB12_loop
C - - - - - 0x00AB2B 02:AB1B: 4C FF AA  JMP loc_AAFF_loop



ofs_002_AB1E_05_below_score_line:
C - - J - - 0x00AB2E 02:AB1E: A5 3A     LDA ram_copy_base_nmt
C - - - - - 0x00AB30 02:AB20: 29 02     AND #$02
C - - - - - 0x00AB32 02:AB22: D0 06     BNE bra_AB2A
C - - - - - 0x00AB34 02:AB24: A5 E6     LDA ram_scroll_Y_3
C - - - - - 0x00AB36 02:AB26: C9 28     CMP #$28
C - - - - - 0x00AB38 02:AB28: B0 15     BCS bra_AB3F_exit
bra_AB2A:
C - - - - - 0x00AB3A 02:AB2A: A9 23     LDA #> $23A0
C - - - - - 0x00AB3C 02:AB2C: A0 A0     LDY #< $23A0
loc_AB2E:
C D 1 - - - 0x00AB3E 02:AB2E: 20 FE AB  JSR sub_ABFE_allocate_20h_memory_in_ppu_buffer
C - - - - - 0x00AB41 02:AB31: A9 43     LDA #< tbl_AB43_tiles
C - - - - - 0x00AB43 02:AB33: 85 29     STA ram_0029_t05_ppu_data
C - - - - - 0x00AB45 02:AB35: A9 AB     LDA #> tbl_AB43_tiles
C - - - - - 0x00AB47 02:AB37: 85 2A     STA ram_0029_t05_ppu_data + $01
C - - - - - 0x00AB49 02:AB39: 20 83 AC  JSR sub_AC83_write_20h_bytes_from_table_to_buffer
C - - - - - 0x00AB4C 02:AB3C: 8E BC 05  STX ram_buffer_index_2
bra_AB3F_exit:
C - - - - - 0x00AB4F 02:AB3F: EE 85 04  INC ram_0485_hud_draw_script
C - - - - - 0x00AB52 02:AB42: 60        RTS



tbl_AB43_tiles:
- D 1 - I - 0x00AB53 02:AB43: 00        .byte $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $E9, $E9, $E9   ; 
- D 1 - I - 0x00AB63 02:AB53: E9        .byte $E9, $E9, $E9, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00, $00   ; 



ofs_002_AB63_06_empty_line:
C - - J - - 0x00AB73 02:AB63: A5 3A     LDA ram_copy_base_nmt
C - - - - - 0x00AB75 02:AB65: 29 02     AND #$02
C - - - - - 0x00AB77 02:AB67: F0 06     BEQ bra_AB6F
C - - - - - 0x00AB79 02:AB69: A5 E6     LDA ram_scroll_Y_3
C - - - - - 0x00AB7B 02:AB6B: C9 C8     CMP #$C8
C - - - - - 0x00AB7D 02:AB6D: 90 07     BCC bra_AB76_tiles
bra_AB6F:
C - - - - - 0x00AB7F 02:AB6F: A9 2B     LDA #> $2B00
C - - - - - 0x00AB81 02:AB71: A0 00     LDY #< $2B00
C - - - - - 0x00AB83 02:AB73: 4C A9 A8  JMP loc_A8A9
bra_AB76_tiles:
C - - - - - 0x00AB86 02:AB76: EE 85 04  INC ram_0485_hud_draw_script
C - - - - - 0x00AB89 02:AB79: 60        RTS



ofs_002_AB7A_07_above_hp_line:
C - - J - - 0x00AB8A 02:AB7A: A5 3A     LDA ram_copy_base_nmt
C - - - - - 0x00AB8C 02:AB7C: 29 02     AND #$02
C - - - - - 0x00AB8E 02:AB7E: F0 0A     BEQ bra_AB8A
C - - - - - 0x00AB90 02:AB80: A5 E6     LDA ram_scroll_Y_3
C - - - - - 0x00AB92 02:AB82: C9 08     CMP #$08
C - - - - - 0x00AB94 02:AB84: 90 04     BCC bra_AB8A
C - - - - - 0x00AB96 02:AB86: C9 D0     CMP #$D0
C - - - - - 0x00AB98 02:AB88: 90 07     BCC bra_AB91_exit
bra_AB8A:
C - - - - - 0x00AB9A 02:AB8A: A9 2B     LDA #> $2B20
C - - - - - 0x00AB9C 02:AB8C: A0 20     LDY #< $2B20
C - - - - - 0x00AB9E 02:AB8E: 4C CF A8  JMP loc_A8CF
bra_AB91_exit:
C - - - - - 0x00ABA1 02:AB91: EE 85 04  INC ram_0485_hud_draw_script
C - - - - - 0x00ABA4 02:AB94: 60        RTS



ofs_002_AB95_08_hp_line:
C - - J - - 0x00ABA5 02:AB95: A5 3A     LDA ram_copy_base_nmt
C - - - - - 0x00ABA7 02:AB97: 29 02     AND #$02
C - - - - - 0x00ABA9 02:AB99: F0 0A     BEQ bra_ABA5
C - - - - - 0x00ABAB 02:AB9B: A5 E6     LDA ram_scroll_Y_3
...
bra_ABA5:
C - - - - - 0x00ABB5 02:ABA5: A9 2B     LDA #> $2B40
C - - - - - 0x00ABB7 02:ABA7: A0 40     LDY #< $2B40
C - - - - - 0x00ABB9 02:ABA9: 4C 47 A9  JMP loc_A947
bra_ABAC:
C - - - - - 0x00ABBC 02:ABAC: EE 85 04  INC ram_0485_hud_draw_script
C - - - - - 0x00ABBF 02:ABAF: 60        RTS



ofs_002_ABB0_09_below_hp_line:
C - - J - - 0x00ABC0 02:ABB0: A5 3A     LDA ram_copy_base_nmt
C - - - - - 0x00ABC2 02:ABB2: 29 02     AND #$02
C - - - - - 0x00ABC4 02:ABB4: F0 0A     BEQ bra_ABC0
C - - - - - 0x00ABC6 02:ABB6: A5 E6     LDA ram_scroll_Y_3
C - - - - - 0x00ABC8 02:ABB8: C9 18     CMP #$18
C - - - - - 0x00ABCA 02:ABBA: 90 04     BCC bra_ABC0
C - - - - - 0x00ABCC 02:ABBC: C9 E0     CMP #$E0
C - - - - - 0x00ABCE 02:ABBE: 90 07     BCC bra_ABC7_exit
bra_ABC0:
C - - - - - 0x00ABD0 02:ABC0: A9 2B     LDA #> $2B60
C - - - - - 0x00ABD2 02:ABC2: A0 60     LDY #< $2B60
C - - - - - 0x00ABD4 02:ABC4: 4C F3 A9  JMP loc_A9F3
bra_ABC7_exit:
C - - - - - 0x00ABD7 02:ABC7: EE 85 04  INC ram_0485_hud_draw_script
C - - - - - 0x00ABDA 02:ABCA: 60        RTS



ofs_002_ABCB_0A_lives_and_score_line:
C - - J - - 0x00ABDB 02:ABCB: A5 3A     LDA ram_copy_base_nmt
C - - - - - 0x00ABDD 02:ABCD: 29 02     AND #$02
C - - - - - 0x00ABDF 02:ABCF: F0 0A     BEQ bra_ABDB
C - - - - - 0x00ABE1 02:ABD1: A5 E6     LDA ram_scroll_Y_3
C - - - - - 0x00ABE3 02:ABD3: C9 20     CMP #$20
C - - - - - 0x00ABE5 02:ABD5: 90 04     BCC bra_ABDB
C - - - - - 0x00ABE7 02:ABD7: C9 E8     CMP #$E8
C - - - - - 0x00ABE9 02:ABD9: 90 07     BCC bra_ABE2_exit
bra_ABDB:
C - - - - - 0x00ABEB 02:ABDB: A9 2B     LDA #> $2B80
C - - - - - 0x00ABED 02:ABDD: A0 80     LDY #< $2B80
C - - - - - 0x00ABEF 02:ABDF: 4C 6A AA  JMP loc_AA6A
bra_ABE2_exit:
C - - - - - 0x00ABF2 02:ABE2: EE 85 04  INC ram_0485_hud_draw_script
C - - - - - 0x00ABF5 02:ABE5: 60        RTS



ofs_002_ABE6_0B_below_score_line:
C - - J - - 0x00ABF6 02:ABE6: A5 3A     LDA ram_copy_base_nmt
C - - - - - 0x00ABF8 02:ABE8: 29 02     AND #$02
C - - - - - 0x00ABFA 02:ABEA: F0 06     BEQ bra_ABF2
C - - - - - 0x00ABFC 02:ABEC: A5 E6     LDA ram_scroll_Y_3
C - - - - - 0x00ABFE 02:ABEE: C9 28     CMP #$28
C - - - - - 0x00AC00 02:ABF0: B0 07     BCS bra_ABF9_exit
bra_ABF2:
C - - - - - 0x00AC02 02:ABF2: A9 2B     LDA #> $2BA0
C - - - - - 0x00AC04 02:ABF4: A0 A0     LDY #< $2BA0
C - - - - - 0x00AC06 02:ABF6: 4C 2E AB  JMP loc_AB2E
bra_ABF9_exit:
C - - - - - 0x00AC09 02:ABF9: EE 85 04  INC ram_0485_hud_draw_script
...
sub_ABFE_allocate_20h_memory_in_ppu_buffer:
C - - - - - 0x00AC0E 02:ABFE: AE BC 05  LDX ram_buffer_index_2
...
C - - - - - 0x00AC1A 02:AC0A: A9 00     LDA #$00    ; 2007 +1
C - - - - - 0x00AC1C 02:AC0C: 9D B1 04  STA ram_ppu_buffer,X
C - - - - - 0x00AC1F 02:AC0F: E8        INX
C - - - - - 0x00AC20 02:AC10: A9 20     LDA #$20    ; counter
...
tbl_AC70_tiles_for_lives:
tbl_AC70_tiles_for_score:
- D 1 - - - 0x00AC80 02:AC70: DB        .byte $DB   ; 00 0
- D 1 - - - 0x00AC81 02:AC71: DB        .byte $DB   ; 01 0 
- D 1 - - - 0x00AC82 02:AC72: DC        .byte $DC   ; 02 1 
- D 1 - - - 0x00AC83 02:AC73: DD        .byte $DD   ; 03 2 
- D 1 - - - 0x00AC84 02:AC74: DE        .byte $DE   ; 04 3 
- D 1 - - - 0x00AC85 02:AC75: DF        .byte $DF   ; 05 4 
- D 1 - - - 0x00AC86 02:AC76: EB        .byte $EB   ; 06 5 
- D 1 - - - 0x00AC87 02:AC77: EC        .byte $EC   ; 07 6 
- D 1 - - - 0x00AC88 02:AC78: ED        .byte $ED   ; 08 7 
- D 1 - - - 0x00AC89 02:AC79: EE        .byte $EE   ; 09 8 
- D 1 - - - 0x00AC8A 02:AC7A: EF        .byte $EF   ; 0A 9 



sub_AC7B_write_A_to_buffer_Y_times:
; in
    ; A = tile
    ; Y = counter
bra_AC7B_loop:
...
sub_AC83_write_20h_bytes_from_table_to_buffer:
; in
    ; ram_0029_t05_ppu_data
C - - - - - 0x00AC93 02:AC83: A0 00     LDY #$00
bra_AC85_loop:
C - - - - - 0x00AC95 02:AC85: B1 29     LDA (ram_0029_t05_ppu_data),Y
...
tbl_AC91_background_attributes:
- D 1 - - - 0x00ACA1 02:AC91: AF AC     .word off_ACAF_00_Into_the_Turf
- D 1 - - - 0x00ACA3 02:AC93: AF AC     .word off_ACAF_01_At_the_Heliport
- D 1 - - - 0x00ACA5 02:AC95: AF AC     .word off_ACAF_02_Battle_in_the_Chopper
- D 1 - - - 0x00ACA7 02:AC97: AF AC     .word off_ACAF_03_Undersea_Base_pt1
- D 1 - - - 0x00ACA9 02:AC99: AF AC     .word off_ACAF_04_Undersea_Base_pt2
- D 1 - - - 0x00ACAB 02:AC9B: BF AC     .word off_ACBF_05_Forest_of_Death
- D 1 - - - 0x00ACAD 02:AC9D: AF AC     .word off_ACAF_06_Mansion_of_Terror
- D 1 - - - 0x00ACAF 02:AC9F: AF AC     .word off_ACAF_07_Trap_Room_pt1
- D 1 - - - 0x00ACB1 02:ACA1: AF AC     .word off_ACAF_08_Trap_Room_pt2
- D 1 - - - 0x00ACB3 02:ACA3: AF AC     .word off_ACAF_09_Trap_Room_pt3
- D 1 - - - 0x00ACB5 02:ACA5: AF AC     .word off_ACAF_0A_Trap_Room_pt4
- D 1 - - - 0x00ACB7 02:ACA7: AF AC     .word off_ACAF_0B_Trap_Room_pt5
- D 1 - - - 0x00ACB9 02:ACA9: AF AC     .word off_ACAF_0C_The_Double_Illusion
- D 1 - - - 0x00ACBB 02:ACAB: AF AC     .word off_ACAF_0D_Final_Confrontation_pt1
- D 1 - - - 0x00ACBD 02:ACAD: AF AC     .word off_ACAF_0E_Final_Confrontation_pt2



off_ACAF_00_Into_the_Turf:
; con_mission_Into_the_Turf
off_ACAF_01_At_the_Heliport:
; con_mission_At_the_Heliport
off_ACAF_02_Battle_in_the_Chopper:
; con_mission_Battle_in_the_Chopper
off_ACAF_03_Undersea_Base_pt1:
; con_mission_Undersea_Base_pt1
off_ACAF_04_Undersea_Base_pt2:
; con_mission_Undersea_Base_pt2
off_ACAF_06_Mansion_of_Terror:
; con_mission_Mansion_of_Terror
off_ACAF_07_Trap_Room_pt1:
; con_mission_Trap_Room_pt1
off_ACAF_08_Trap_Room_pt2:
; con_mission_Trap_Room_pt2
off_ACAF_09_Trap_Room_pt3:
; con_mission_Trap_Room_pt3
off_ACAF_0A_Trap_Room_pt4:
; con_mission_Trap_Room_pt4
off_ACAF_0B_Trap_Room_pt5:
; con_mission_Trap_Room_pt5
off_ACAF_0C_The_Double_Illusion:
; con_mission_The_Double_Illusion
off_ACAF_0D_Final_Confrontation_pt1:
; con_mission_Final_Confrontation_pt1
off_ACAF_0E_Final_Confrontation_pt2:
; con_mission_Final_Confrontation_pt2
- D 1 - I - 0x00ACBF 02:ACAF: 74        .byte $74, $50, $50, $AA, $AA, $51, $50, $10, $00, $00, $00, $0A, $0A, $00, $00, $00   ; 



off_ACBF_05_Forest_of_Death:
; con_mission_Forest_of_Death
- D 1 - I - 0x00ACCF 02:ACBF: CC        .byte $CC, $A0, $A0, $FF, $FF, $B3, $A0, $20, $0C, $0F, $0F, $0F, $0F, $0F, $0F, $0F   ; 
...
C - - - - - 0x00ACE9 02:ACD9: 85 29     STA ram_0029_t48_ppu_lo
C - - - - - 0x00ACEB 02:ACDB: A9 00     LDA #$00
C - - - - - 0x00ACED 02:ACDD: 85 2A     STA ram_002A_t01_ppu_hi
C - - - - - 0x00ACEF 02:ACDF: A0 05     LDY #$05
bra_ACE1_loop:
C - - - - - 0x00ACF1 02:ACE1: 06 29     ASL ram_0029_t48_ppu_lo
C - - - - - 0x00ACF3 02:ACE3: 26 2A     ROL ram_002A_t01_ppu_hi
C - - - - - 0x00ACF5 02:ACE5: 88        DEY
C - - - - - 0x00ACF6 02:ACE6: D0 F9     BNE bra_ACE1_loop
C - - - - - 0x00ACF8 02:ACE8: A5 2A     LDA ram_002A_t01_ppu_hi
C - - - - - 0x00ACFA 02:ACEA: 18        CLC
C - - - - - 0x00ACFB 02:ACEB: 69 20     ADC #$20
C - - - - - 0x00ACFD 02:ACED: A4 29     LDY ram_0029_t48_ppu_lo
C - - - - - 0x00ACFF 02:ACEF: 20 FE AB  JSR sub_ABFE_allocate_20h_memory_in_ppu_buffer
C - - - - - 0x00AD02 02:ACF2: A9 00     LDA #$00    ; tile
C - - - - - 0x00AD04 02:ACF4: A0 20     LDY #$20    ; counter
C - - - - - 0x00AD06 02:ACF6: 20 7B AC  JSR sub_AC7B_write_A_to_buffer_Y_times
C - - - - - 0x00AD09 02:ACF9: 8E BC 05  STX ram_buffer_index_2
...
C - - - - - 0x00AD32 02:AD22: 85 19     STA ram_0019_t09_obj_index
bra_AD24_loop:
C - - - - - 0x00AD34 02:AD24: A6 19     LDX ram_0019_t09_obj_index
C - - - - - 0x00AD36 02:AD26: 86 1B     STX ram_001B_t11_obj_index
C - - - - - 0x00AD38 02:AD28: E8        INX
C - - - - - 0x00AD39 02:AD29: 86 1A     STX ram_001A_t09_obj_index
C - - - - - 0x00AD3B 02:AD2B: 20 94 B3  JSR sub_B394
C - - - - - 0x00AD3E 02:AD2E: B0 5A     BCS bra_AD8A
C - - - - - 0x00AD40 02:AD30: A9 00     LDA #$00
C - - - - - 0x00AD42 02:AD32: 85 1C     STA ram_001C_t06
C - - - - - 0x00AD44 02:AD34: A5 19     LDA ram_0019_t09_obj_index
C - - - - - 0x00AD46 02:AD36: 85 1B     STA ram_001B_t11_obj_index
C - - - - - 0x00AD48 02:AD38: 20 D8 B3  JSR sub_B3D8_hurtboxes_result
C - - - - - 0x00AD4B 02:AD3B: B0 4D     BCS bra_AD8A
bra_AD3D_loop:
C - - - - - 0x00AD4D 02:AD3D: 2C 34 00  BIT a: ram_game_mode
C - - - - - 0x00AD50 02:AD40: 70 06     BVS bra_AD48    ; if con_gm_friendly_fire
C - - - - - 0x00AD52 02:AD42: A5 1A     LDA ram_001A_t09_obj_index
C - - - - - 0x00AD54 02:AD44: C9 01     CMP #$01
C - - - - - 0x00AD56 02:AD46: F0 3A     BEQ bra_AD82
bra_AD48:
C - - - - - 0x00AD58 02:AD48: A4 19     LDY ram_0019_t09_obj_index
C - - - - - 0x00AD5A 02:AD4A: A6 1A     LDX ram_001A_t09_obj_index
...
C - - - - - 0x00AD64 02:AD54: A5 1A     LDA ram_001A_t09_obj_index
C - - - - - 0x00AD66 02:AD56: 85 1B     STA ram_001B_t11_obj_index
...
C - - - - - 0x00AD74 02:AD64: 85 1C     STA ram_001C_t06
C - - - - - 0x00AD76 02:AD66: 20 D8 B3  JSR sub_B3D8_hurtboxes_result
...
C - - - - - 0x00AD8B 02:AD7B: A4 19     LDY ram_0019_t09_obj_index
C - - - - - 0x00AD8D 02:AD7D: B9 43 00  LDA a: ram_obj_state,Y
C - - - - - 0x00AD90 02:AD80: 10 08     BPL bra_AD8A
bra_AD82:
C - - - - - 0x00AD92 02:AD82: E6 1A     INC ram_001A_t09_obj_index
C - - - - - 0x00AD94 02:AD84: A5 1A     LDA ram_001A_t09_obj_index
C - - - - - 0x00AD96 02:AD86: C9 08     CMP #$08
C - - - - - 0x00AD98 02:AD88: 90 B3     BCC bra_AD3D_loop
bra_AD8A:
C - - - - - 0x00AD9A 02:AD8A: E6 19     INC ram_0019_t09_obj_index
C - - - - - 0x00AD9C 02:AD8C: A5 19     LDA ram_0019_t09_obj_index
...
sub_AD9B:
; in
    ; ram_0019_t09_obj_index
C - - - - - 0x00ADAB 02:AD9B: A9 01     LDA #$01
C - - - - - 0x00ADAD 02:AD9D: C5 19     CMP ram_0019_t09_obj_index
C - - - - - 0x00ADAF 02:AD9F: 90 0F     BCC bra_ADB0
C - - - - - 0x00ADB1 02:ADA1: A6 19     LDX ram_0019_t09_obj_index
C - - - - - 0x00ADB3 02:ADA3: BD CC 03  LDA ram_plr_invincibility_timer,X
C - - - - - 0x00ADB6 02:ADA6: C9 FF     CMP #$FF
C - - - - - 0x00ADB8 02:ADA8: F0 06     BEQ bra_ADB0
C - - - - - 0x00ADBA 02:ADAA: A5 04     LDA ram_0004_t03_lo
C - - - - - 0x00ADBC 02:ADAC: 29 94     AND #$94
C - - - - - 0x00ADBE 02:ADAE: 85 04     STA ram_0004_t03_lo
bra_ADB0:
C - - - - - 0x00ADC0 02:ADB0: A9 01     LDA #$01
C - - - - - 0x00ADC2 02:ADB2: C5 1A     CMP ram_001A_t09_obj_index
C - - - - - 0x00ADC4 02:ADB4: 90 0F     BCC bra_ADC5_RTS
C - - - - - 0x00ADC6 02:ADB6: A6 1A     LDX ram_001A_t09_obj_index
C - - - - - 0x00ADC8 02:ADB8: BD CC 03  LDA ram_plr_invincibility_timer,X
C - - - - - 0x00ADCB 02:ADBB: C9 FF     CMP #$FF
C - - - - - 0x00ADCD 02:ADBD: F0 06     BEQ bra_ADC5_RTS
C - - - - - 0x00ADCF 02:ADBF: A5 04     LDA ram_0004_t03_lo
C - - - - - 0x00ADD1 02:ADC1: 29 62     AND #$62
C - - - - - 0x00ADD3 02:ADC3: 85 04     STA ram_0004_t03_lo
bra_ADC5_RTS:
...
; in
    ; ram_0019_t09_obj_index
C - - - - - 0x00ADD6 02:ADC6: A6 19     LDX ram_0019_t09_obj_index
C - - - - - 0x00ADD8 02:ADC8: B5 43     LDA ram_obj_state,X
C - - - - - 0x00ADDA 02:ADCA: 85 23     STA ram_001D_t05_array + $06
C - - - - - 0x00ADDC 02:ADCC: BD 63 00  LDA a: ram_0063_obj_facing,X
C - - - - - 0x00ADDF 02:ADCF: 85 24     STA ram_0024_t03_obj_facing
C - - - - - 0x00ADE1 02:ADD1: BD 0F 03  LDA ram_obj_direction,X
C - - - - - 0x00ADE4 02:ADD4: 85 25     STA ram_001F_t01_array + $06
C - - - - - 0x00ADE6 02:ADD6: A6 1A     LDX ram_001A_t09_obj_index
C - - - - - 0x00ADE8 02:ADD8: B5 43     LDA ram_obj_state,X
C - - - - - 0x00ADEA 02:ADDA: 85 26     STA ram_0020_t01_array + $06
C - - - - - 0x00ADEC 02:ADDC: BD 63 00  LDA a: ram_0063_obj_facing,X
C - - - - - 0x00ADEF 02:ADDF: 85 27     STA ram_0027_t01_obj_facing
C - - - - - 0x00ADF1 02:ADE1: BD 0F 03  LDA ram_obj_direction,X
C - - - - - 0x00ADF4 02:ADE4: 85 28     STA ram_0028_t02_obj_direction
...
C - - - - - 0x00AE00 02:ADF0: A5 27     LDA ram_0027_t01_obj_facing
C - - - - - 0x00AE02 02:ADF2: 85 0F     STA ram_000F_t02_obj_facing
C - - - - - 0x00AE04 02:ADF4: A5 28     LDA ram_0028_t02_obj_direction
C - - - - - 0x00AE06 02:ADF6: 85 10     STA ram_000A_t01_array + $06
C - - - - - 0x00AE08 02:ADF8: A5 19     LDA ram_0019_t09_obj_index
C - - - - - 0x00AE0A 02:ADFA: 85 11     STA ram_0011_t02_obj_index_1
C - - - - - 0x00AE0C 02:ADFC: A5 1A     LDA ram_001A_t09_obj_index
C - - - - - 0x00AE0E 02:ADFE: 85 12     STA ram_0012_t01_obj_index_2
C - - - - - 0x00AE10 02:AE00: 20 21 AE  JSR sub_AE21_being_hit_by_obj_states
bra_AE03:
C - - - - - 0x00AE13 02:AE03: A5 05     LDA ram_0005_t02_flags
C - - - - - 0x00AE15 02:AE05: 29 04     AND #$04
C - - - - - 0x00AE17 02:AE07: F0 17     BEQ bra_AE20_RTS
C - - - - - 0x00AE19 02:AE09: A5 23     LDA ram_001D_t05_array + $06
C - - - - - 0x00AE1B 02:AE0B: 85 0E     STA ram_0008_t02_array + $06
C - - - - - 0x00AE1D 02:AE0D: A5 24     LDA ram_0024_t03_obj_facing
C - - - - - 0x00AE1F 02:AE0F: 85 0F     STA ram_000F_t02_obj_facing
C - - - - - 0x00AE21 02:AE11: A5 25     LDA ram_001F_t01_array + $06
C - - - - - 0x00AE23 02:AE13: 85 10     STA ram_000A_t01_array + $06
C - - - - - 0x00AE25 02:AE15: A5 1A     LDA ram_001A_t09_obj_index
C - - - - - 0x00AE27 02:AE17: 85 11     STA ram_0011_t02_obj_index_1
C - - - - - 0x00AE29 02:AE19: A5 19     LDA ram_0019_t09_obj_index
C - - - - - 0x00AE2B 02:AE1B: 85 12     STA ram_0012_t01_obj_index_2
; bzk optimize, JMP
C - - - - - 0x00AE2D 02:AE1D: 20 21 AE  JSR sub_AE21_being_hit_by_obj_states
bra_AE20_RTS:
C - - - - - 0x00AE30 02:AE20: 60        RTS



sub_AE21_being_hit_by_obj_states:
; in
    ; ram_0012_t01_obj_index_2
C - - - - - 0x00AE31 02:AE21: A6 12     LDX ram_0012_t01_obj_index_2
C - - - - - 0x00AE33 02:AE23: A5 0E     LDA ram_0008_t02_array + $06
C - - - - - 0x00AE35 02:AE25: 29 7F     AND #$7F
C - - - - - 0x00AE37 02:AE27: 0A        ASL
C - - - - - 0x00AE38 02:AE28: A8        TAY
C - - - - - 0x00AE39 02:AE29: B9 32 BA  LDA tbl_BA32_state_outcome,Y
C - - - - - 0x00AE3C 02:AE2C: 85 29     STA ram_0029_t13_data_state_outcome
C - - - - - 0x00AE3E 02:AE2E: B9 33 BA  LDA tbl_BA32_state_outcome + $01,Y
C - - - - - 0x00AE41 02:AE31: 85 2A     STA ram_0029_t13_data_state_outcome + $01
C - - - - - 0x00AE43 02:AE33: A6 11     LDX ram_0011_t02_obj_index_1
C - - - - - 0x00AE45 02:AE35: 20 66 AE  JSR sub_AE66_read_next_0029_byte
C - - - - - 0x00AE48 02:AE38: A6 11     LDX ram_0011_t02_obj_index_1
C - - - - - 0x00AE4A 02:AE3A: B5 43     LDA ram_obj_state,X
C - - - - - 0x00AE4C 02:AE3C: 30 27     BMI bra_AE65_RTS
C - - - - - 0x00AE4E 02:AE3E: A6 11     LDX ram_0011_t02_obj_index_1
C - - - - - 0x00AE50 02:AE40: FE E7 03  INC ram_hit_counter,X
C - - - - - 0x00AE53 02:AE43: B5 4A     LDA ram_004A_obj_flags,X
C - - - - - 0x00AE55 02:AE45: 29 FE     AND #con_004A_flag_01 ^ $FF
C - - - - - 0x00AE57 02:AE47: 09 40     ORA #con_004A_flag_stunned
C - - - - - 0x00AE59 02:AE49: 95 4A     STA ram_004A_obj_flags,X
C - - - - - 0x00AE5B 02:AE4B: A9 60     LDA #$60
C - - - - - 0x00AE5D 02:AE4D: 9D C8 03  STA ram_clear_hit_counter_timer,X
C - - - - - 0x00AE60 02:AE50: B5 43     LDA ram_obj_state,X
...
C - - - - - 0x00AE78 02:AE68: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
C - - - - - 0x00AE7A 02:AE6A: 0A        ASL
C - - - - - 0x00AE7B 02:AE6B: A8        TAY
C - - - - - 0x00AE7C 02:AE6C: B9 79 AE  LDA tbl_AE79,Y
C - - - - - 0x00AE7F 02:AE6F: 85 2B     STA ram_002B_t15_jmp
C - - - - - 0x00AE81 02:AE71: B9 7A AE  LDA tbl_AE79 + $01,Y
C - - - - - 0x00AE84 02:AE74: 85 2C     STA ram_002B_t15_jmp + $01
C - - - - - 0x00AE86 02:AE76: 6C 2B 00  JMP (ram_002B_t15_jmp)
...
- - - - - - 0x00AECB 02:AEBB: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
...
C - - - - - 0x00AEF2 02:AEE2: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
C - - - - - 0x00AEF4 02:AEE4: 95 43     STA ram_obj_state,X
C - - - - - 0x00AEF6 02:AEE6: A9 06     LDA #$06
C - - - - - 0x00AEF8 02:AEE8: 4C 39 B1  JMP loc_B139_increase_0029_pointer
bra_AEEB:
C - - - - - 0x00AEFB 02:AEEB: B5 43     LDA ram_obj_state,X
...
C - - - - - 0x00AF0B 02:AEFB: C9 0D     CMP #con_state_somersault_run
...
C - - - - - 0x00AF19 02:AF09: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
C - - - - - 0x00AF1B 02:AF0B: 95 43     STA ram_obj_state,X
...
C - - - - - 0x00AF32 02:AF22: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
C - - - - - 0x00AF34 02:AF24: 95 43     STA ram_obj_state,X
...
C - - - - - 0x00AF43 02:AF33: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
C - - - - - 0x00AF45 02:AF35: 95 43     STA ram_obj_state,X
C - - - - - 0x00AF47 02:AF37: A9 08     LDA #$08
C - - - - - 0x00AF49 02:AF39: 4C 39 B1  JMP loc_B139_increase_0029_pointer
bra_AF3C:
C - - - - - 0x00AF4C 02:AF3C: B5 43     LDA ram_obj_state,X
...
C - - - - - 0x00AF5C 02:AF4C: C9 0D     CMP #con_state_somersault_run
...
C - - - - - 0x00AF6A 02:AF5A: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
C - - - - - 0x00AF6C 02:AF5C: 95 43     STA ram_obj_state,X
...
C - - - - - 0x00AFA0 02:AF90: 95 43     STA ram_obj_state,X
...
C - - - - - 0x00AFAD 02:AF9D: A6 11     LDX ram_0011_t02_obj_index_1
C - - - - - 0x00AFAF 02:AF9F: 5D 63 00  EOR a: ram_0063_obj_facing,X
C - - - - - 0x00AFB2 02:AFA2: A6 12     LDX ram_0012_t01_obj_index_2
C - - - - - 0x00AFB4 02:AFA4: 5D 63 00  EOR a: ram_0063_obj_facing,X
C - - - - - 0x00AFB7 02:AFA7: 30 01     BMI bra_AFAA
C - - - - - 0x00AFB9 02:AFA9: C8        INY ; 02
bra_AFAA:
C - - - - - 0x00AFBA 02:AFAA: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
C - - - - - 0x00AFBC 02:AFAC: A6 11     LDX ram_0011_t02_obj_index_1
C - - - - - 0x00AFBE 02:AFAE: 95 43     STA ram_obj_state,X
...
C - - - - - 0x00AFCB 02:AFBB: 95 43     STA ram_obj_state,X
...
C - - - - - 0x00AFE6 02:AFD6: A5 29     LDA ram_0029_t13_data_state_outcome
C - - - - - 0x00AFE8 02:AFD8: 48        PHA
C - - - - - 0x00AFE9 02:AFD9: A5 2A     LDA ram_0029_t13_data_state_outcome + $01
C - - - - - 0x00AFEB 02:AFDB: 48        PHA
C - - - - - 0x00AFEC 02:AFDC: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
C - - - - - 0x00AFEE 02:AFDE: 48        PHA
C - - - - - 0x00AFEF 02:AFDF: C8        INY
C - - - - - 0x00AFF0 02:AFE0: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
C - - - - - 0x00AFF2 02:AFE2: 85 2A     STA ram_0029_t13_data_state_outcome + $01
C - - - - - 0x00AFF4 02:AFE4: 68        PLA
C - - - - - 0x00AFF5 02:AFE5: 85 29     STA ram_0029_t13_data_state_outcome
C - - - - - 0x00AFF7 02:AFE7: 20 66 AE  JSR sub_AE66_read_next_0029_byte
C - - - - - 0x00AFFA 02:AFEA: 68        PLA
C - - - - - 0x00AFFB 02:AFEB: 85 2A     STA ram_0029_t13_data_state_outcome + $01
C - - - - - 0x00AFFD 02:AFED: 68        PLA
C - - - - - 0x00AFFE 02:AFEE: 85 29     STA ram_0029_t13_data_state_outcome
...
- - - - - - 0x00B031 02:B021: 90 06     BCC bra_B029_player
; if not player
...
- - - - - - 0x00B03D 02:B02D: A5 29     LDA ram_0029_t13_data_state_outcome
- - - - - - 0x00B03F 02:B02F: 48        PHA
- - - - - - 0x00B040 02:B030: A5 2A     LDA ram_0029_t13_data_state_outcome + $01
- - - - - - 0x00B042 02:B032: 48        PHA
- - - - - - 0x00B043 02:B033: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
- - - - - - 0x00B045 02:B035: 18        CLC
- - - - - - 0x00B046 02:B036: 65 29     ADC ram_0029_t13_data_state_outcome
- - - - - - 0x00B048 02:B038: 85 29     STA ram_0029_t13_data_state_outcome
- - - - - - 0x00B04A 02:B03A: A5 2A     LDA ram_0029_t13_data_state_outcome + $01
- - - - - - 0x00B04C 02:B03C: 69 00     ADC #$00
- - - - - - 0x00B04E 02:B03E: 85 2A     STA ram_0029_t13_data_state_outcome + $01
- - - - - - 0x00B050 02:B040: 20 66 AE  JSR sub_AE66_read_next_0029_byte
- - - - - - 0x00B053 02:B043: 68        PLA
- - - - - - 0x00B054 02:B044: 85 2A     STA ram_0029_t13_data_state_outcome + $01
- - - - - - 0x00B056 02:B046: 68        PLA
- - - - - - 0x00B057 02:B047: 85 29     STA ram_0029_t13_data_state_outcome
...
C - - - - - 0x00B08A 02:B07A: 65 12     ADC ram_0012_t01_obj_index_2
C - - - - - 0x00B08C 02:B07C: 0A        ASL
C - - - - - 0x00B08D 02:B07D: AA        TAX
C - - - - - 0x00B08E 02:B07E: A0 01     LDY #$01
C - - - - - 0x00B090 02:B080: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
...
- - - - - - 0x00B0AF 02:B09F: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
- - - - - - 0x00B0B1 02:B0A1: 20 06 C0  JSR sub_0x01C016_play_sound
- - - - - - 0x00B0B4 02:B0A4: A0 01     LDY #$01
- - - - - - 0x00B0B6 02:B0A6: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
...
C - - - - - 0x00B0BD 02:B0AD: A5 0F     LDA ram_000F_t02_obj_facing
C - - - - - 0x00B0BF 02:B0AF: 10 02     BPL bra_B0B3
C - - - - - 0x00B0C1 02:B0B1: A0 C0     LDY #$C0
bra_B0B3:
loc_B0B3:
C D 1 - - - 0x00B0C3 02:B0B3: 98        TYA
C - - - - - 0x00B0C4 02:B0B4: A6 11     LDX ram_0011_t02_obj_index_1
C - - - - - 0x00B0C6 02:B0B6: 9D 0F 03  STA ram_obj_direction,X
...
C - - - - - 0x00B0D0 02:B0C0: A5 0F     LDA ram_000F_t02_obj_facing
...
C - - - - - 0x00B0E8 02:B0D8: BD 80 00  LDA a: ram_obj_pos_X_hi,X
...
C - - - - - 0x00B100 02:B0F0: B5 43     LDA ram_obj_state,X
C - - - - - 0x00B102 02:B0F2: 10 06     BPL bra_B0FA
C - - - - - 0x00B104 02:B0F4: A0 01     LDY #$01
C - - - - - 0x00B106 02:B0F6: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
C - - - - - 0x00B108 02:B0F8: 95 43     STA ram_obj_state,X
bra_B0FA:
...
C - - - - - 0x00B117 02:B107: 9D 0F 03  STA ram_obj_direction,X
...
C - - - - - 0x00B12E 02:B11E: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
C - - - - - 0x00B130 02:B120: 48        PHA
C - - - - - 0x00B131 02:B121: C8        INY
C - - - - - 0x00B132 02:B122: B1 29     LDA (ram_0029_t13_data_state_outcome),Y
C - - - - - 0x00B134 02:B124: 85 2A     STA ram_0029_t13_data_state_outcome + $01
...
; in
    ; A = how much to add
    ; ram_0029_t13_data_state_outcome
C D 1 - - - 0x00B149 02:B139: 18        CLC
C - - - - - 0x00B14A 02:B13A: 65 29     ADC ram_0029_t13_data_state_outcome
C - - - - - 0x00B14C 02:B13C: 85 29     STA ram_0029_t13_data_state_outcome
C - - - - - 0x00B14E 02:B13E: A5 2A     LDA ram_0029_t13_data_state_outcome + $01
C - - - - - 0x00B150 02:B140: 69 00     ADC #$00
C - - - - - 0x00B152 02:B142: 85 2A     STA ram_0029_t13_data_state_outcome + $01
...
; in
    ; ram_0019_t09_obj_index
C - - - - - 0x00B15B 02:B14B: A5 04     LDA ram_0004_t03_lo
C - - - - - 0x00B15D 02:B14D: 29 F8     AND #$F8
C - - - - - 0x00B15F 02:B14F: 85 04     STA ram_0004_t03_lo
C - - - - - 0x00B161 02:B151: A6 1A     LDX ram_001A_t09_obj_index
C - - - - - 0x00B163 02:B153: E0 04     CPX #$04
C - - - - - 0x00B165 02:B155: 90 6D     BCC bra_B1C4
C - - - - - 0x00B167 02:B157: A6 1A     LDX ram_001A_t09_obj_index
C - - - - - 0x00B169 02:B159: B5 43     LDA ram_obj_state,X
...
C - - - - - 0x00B190 02:B180: 10 1D     BPL bra_B19F    ; if not con_gm_2_players
- - - - - - 0x00B192 02:B182: 70 1B     BVS bra_B19F    ; if con_gm_friendly_fire
- - - - - - 0x00B194 02:B184: E0 02     CPX #$02
- - - - - - 0x00B196 02:B186: B0 04     BCS bra_B18C    ; if enemy
; if 1p or 2p
- - - - - - 0x00B198 02:B188: C0 02     CPY #$02
- - - - - - 0x00B19A 02:B18A: 90 BD     BCC bra_B149
bra_B18C:
- - - - - - 0x00B19C 02:B18C: A4 19     LDY ram_0019_t09_obj_index
- - - - - - 0x00B19E 02:B18E: B9 E0 03  LDA ram_03E0_obj,Y
- - - - - - 0x00B1A1 02:B191: C5 1A     CMP ram_001A_t09_obj_index
- - - - - - 0x00B1A3 02:B193: D0 0A     BNE bra_B19F
- - - - - - 0x00B1A5 02:B195: B9 EE 03  LDA ram_03EE_obj,Y
- - - - - - 0x00B1A8 02:B198: A6 1A     LDX ram_001A_t09_obj_index
- - - - - - 0x00B1AA 02:B19A: DD C1 03  CMP ram_03C1_obj,X
- - - - - - 0x00B1AD 02:B19D: F0 6F     BEQ bra_B20E
bra_B19F:
C - - - - - 0x00B1AF 02:B19F: A5 04     LDA ram_0004_t03_lo
...
; in
    ; ram_0019_t09_obj_index
    ; ram_001A_t09_obj_index
; out
    ; C
        ; 0 = 
        ; 1 = 
C - - - - - 0x00B220 02:B210: A9 00     LDA #$00
C - - - - - 0x00B222 02:B212: 85 05     STA ram_0005_t02_flags
C - - - - - 0x00B224 02:B214: A5 04     LDA ram_0004_t03_lo
C - - - - - 0x00B226 02:B216: 29 01     AND #$01
C - - - - - 0x00B228 02:B218: F0 5C     BEQ bra_B276
C - - - - - 0x00B22A 02:B21A: A5 0A     LDA ram_000A_t01_array
C - - - - - 0x00B22C 02:B21C: 85 1B     STA ram_001B_t12
C - - - - - 0x00B22E 02:B21E: A5 0E     LDA ram_0008_t02_array + $06
C - - - - - 0x00B230 02:B220: 38        SEC
C - - - - - 0x00B231 02:B221: E5 08     SBC ram_0008_t02_array
...
C - - - - - 0x00B24E 02:B23E: A5 0D     LDA ram_000D_t02_array
C - - - - - 0x00B250 02:B240: 85 1B     STA ram_001B_t12
C - - - - - 0x00B252 02:B242: A5 11     LDA ram_000B_t02_array + $06
C - - - - - 0x00B254 02:B244: 38        SEC
C - - - - - 0x00B255 02:B245: E5 0B     SBC ram_000B_t02_array
...
C - - - - - 0x00B274 02:B264: 05 05     ORA ram_0005_t02_flags
C - - - - - 0x00B276 02:B266: 85 05     STA ram_0005_t02_flags
C - - - - - 0x00B278 02:B268: A4 1A     LDY ram_001A_t09_obj_index
C - - - - - 0x00B27A 02:B26A: B9 C1 03  LDA ram_03C1_obj,Y
C - - - - - 0x00B27D 02:B26D: A6 19     LDX ram_0019_t09_obj_index
C - - - - - 0x00B27F 02:B26F: 9D EE 03  STA ram_03EE_obj,X
C - - - - - 0x00B282 02:B272: 98        TYA
C - - - - - 0x00B283 02:B273: 9D E0 03  STA ram_03E0_obj,X
bra_B276:
C - - - - - 0x00B286 02:B276: A5 04     LDA ram_0004_t03_lo
C - - - - - 0x00B288 02:B278: 29 02     AND #$02
C - - - - - 0x00B28A 02:B27A: F0 5C     BEQ bra_B2D8
C - - - - - 0x00B28C 02:B27C: A5 1F     LDA ram_001F_t01_array
C - - - - - 0x00B28E 02:B27E: 85 1B     STA ram_001B_t13
C - - - - - 0x00B290 02:B280: A5 0E     LDA ram_0008_t02_array + $06
C - - - - - 0x00B292 02:B282: 38        SEC
C - - - - - 0x00B293 02:B283: E5 1D     SBC ram_001D_t05_array
...
C - - - - - 0x00B2B0 02:B2A0: A5 22     LDA ram_0022_t01_array
...
C - - - - - 0x00B2BD 02:B2AD: E5 21     SBC ram_0021_t01_array
...
C - - - - - 0x00B2D6 02:B2C6: 05 05     ORA ram_0005_t02_flags
C - - - - - 0x00B2D8 02:B2C8: 85 05     STA ram_0005_t02_flags
C - - - - - 0x00B2DA 02:B2CA: A4 1A     LDY ram_001A_t09_obj_index
C - - - - - 0x00B2DC 02:B2CC: B9 C1 03  LDA ram_03C1_obj,Y
C - - - - - 0x00B2DF 02:B2CF: A6 19     LDX ram_0019_t09_obj_index
C - - - - - 0x00B2E1 02:B2D1: 9D EE 03  STA ram_03EE_obj,X
C - - - - - 0x00B2E4 02:B2D4: 98        TYA
C - - - - - 0x00B2E5 02:B2D5: 9D E0 03  STA ram_03E0_obj,X
bra_B2D8:
C - - - - - 0x00B2E8 02:B2D8: A5 04     LDA ram_0004_t03_lo
C - - - - - 0x00B2EA 02:B2DA: 29 04     AND #$04
C - - - - - 0x00B2EC 02:B2DC: F0 5C     BEQ bra_B33A
C - - - - - 0x00B2EE 02:B2DE: A5 0A     LDA ram_000A_t01_array
C - - - - - 0x00B2F0 02:B2E0: 85 1B     STA ram_001B_t15
C - - - - - 0x00B2F2 02:B2E2: A5 23     LDA ram_001D_t05_array + $06
C - - - - - 0x00B2F4 02:B2E4: 38        SEC
C - - - - - 0x00B2F5 02:B2E5: E5 08     SBC ram_0008_t02_array
...
C - - - - - 0x00B31D 02:B30D: A5 27     LDA ram_0021_t01_array + $06
...
C - - - - - 0x00B328 02:B318: A5 28     LDA ram_0022_t01_array + $06
...
C - - - - - 0x00B338 02:B328: 05 05     ORA ram_0005_t02_flags
C - - - - - 0x00B33A 02:B32A: 85 05     STA ram_0005_t02_flags
C - - - - - 0x00B33C 02:B32C: A4 19     LDY ram_0019_t09_obj_index
C - - - - - 0x00B33E 02:B32E: B9 C1 03  LDA ram_03C1_obj,Y
C - - - - - 0x00B341 02:B331: A6 1A     LDX ram_001A_t09_obj_index
C - - - - - 0x00B343 02:B333: 9D EE 03  STA ram_03EE_obj,X
C - - - - - 0x00B346 02:B336: 98        TYA
C - - - - - 0x00B347 02:B337: 9D E0 03  STA ram_03E0_obj,X
bra_B33A:
C - - - - - 0x00B34A 02:B33A: A5 05     LDA ram_0005_t02_flags
...
; out
    ; C
        ; 0 = 
        ; 1 = 
C - - - - - 0x00B36A 02:B35A: A4 19     LDY ram_0019_t09_obj_index
C - - - - - 0x00B36C 02:B35C: A6 1A     LDX ram_001A_t09_obj_index
C - - - - - 0x00B36E 02:B35E: B9 92 00  LDA a: ram_obj_pos_Y_lo,Y
C - - - - - 0x00B371 02:B361: 38        SEC
C - - - - - 0x00B372 02:B362: FD 92 00  SBC a: ram_obj_pos_Y_lo,X
...
; out
    ; C
        ; 0 = 
        ; 1 = 
C - - - - - 0x00B3A4 02:B394: A4 1B     LDY ram_001B_t11_obj_index
; bzk bug? it should not be referring to 0043 (ram_obj_state)
C - - - - - 0x00B3A6 02:B396: B9 3C 00  LDA a: ram_003C_obj_flags,Y ; 003C 003D 003E 003F 0040 0041 0042 0043
C - - - - - 0x00B3A9 02:B399: 10 3B     BPL bra_B3D6    ; if not con_003C_flag_exist
C - - - - - 0x00B3AB 02:B39B: B9 F5 03  LDA ram_03F5_obj,Y
C - - - - - 0x00B3AE 02:B39E: 30 36     BMI bra_B3D6
C - - - - - 0x00B3B0 02:B3A0: B9 43 00  LDA a: ram_obj_state,Y
C - - - - - 0x00B3B3 02:B3A3: 10 31     BPL bra_B3D6
C - - - - - 0x00B3B5 02:B3A5: 29 7F     AND #$7F
C - - - - - 0x00B3B7 02:B3A7: C9 27     CMP #con_state_death_water
C - - - - - 0x00B3B9 02:B3A9: F0 2B     BEQ bra_B3D6
C - - - - - 0x00B3BB 02:B3AB: C9 28     CMP #con_state_death_burnov
C - - - - - 0x00B3BD 02:B3AD: F0 27     BEQ bra_B3D6
C - - - - - 0x00B3BF 02:B3AF: C9 2A     CMP #con_state_burnov_revives
...
bra_B3BB:
C - - - - - 0x00B3CB 02:B3BB: B9 4A 00  LDA a: ram_004A_obj_flags,Y
C - - - - - 0x00B3CE 02:B3BE: 29 C0     AND #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x00B3D0 02:B3C0: C9 C0     CMP #con_004A_flag_stunned + con_004A_flag_knocked_down
C - - - - - 0x00B3D2 02:B3C2: F0 12     BEQ bra_B3D6
C - - - - - 0x00B3D4 02:B3C4: B9 C7 00  LDA a: ram_animation_id,Y
C - - - - - 0x00B3D7 02:B3C7: 29 7F     AND #$7F
C - - - - - 0x00B3D9 02:B3C9: C9 7F     CMP #con_anim_id + $7F
C - - - - - 0x00B3DB 02:B3CB: F0 09     BEQ bra_B3D6
C - - - - - 0x00B3DD 02:B3CD: B9 BF 00  LDA a: ram_obj_id,Y
C - - - - - 0x00B3E0 02:B3D0: C9 1E     CMP #con_obj_symbol_II
...
sub_B3D8_hurtboxes_result:
; in:
    ; 001B = who is attacking
    ; ??? = who is being attacked
; out:
    ; C
        ; 0 = if an object hits another object
        ; 1 = if no hit
C - - - - - 0x00B3E8 02:B3D8: A6 1C     LDX ram_001C_t06
...
bra_B3E2:
C - - - - - 0x00B3F2 02:B3E2: 25 04     AND ram_0004_t03_lo
C - - - - - 0x00B3F4 02:B3E4: 85 04     STA ram_0004_t03_lo
C - - - - - 0x00B3F6 02:B3E6: A6 1B     LDX ram_001B_t11_obj_index
C - - - - - 0x00B3F8 02:B3E8: BD BF 00  LDA a: ram_obj_id,X
C - - - - - 0x00B3FB 02:B3EB: 0A        ASL
C - - - - - 0x00B3FC 02:B3EC: A8        TAY
C - - - - - 0x00B3FD 02:B3ED: B9 D2 B4  LDA tbl_B4D2_hurtboxes,Y
C - - - - - 0x00B400 02:B3F0: 85 29     STA ram_0029_t14_data_hurtboxes
C - - - - - 0x00B402 02:B3F2: B9 D3 B4  LDA tbl_B4D2_hurtboxes + $01,Y
C - - - - - 0x00B405 02:B3F5: 85 2A     STA ram_0029_t14_data_hurtboxes + $01
C - - - - - 0x00B407 02:B3F7: BD C7 00  LDA a: ram_animation_id,X
C - - - - - 0x00B40A 02:B3FA: 0A        ASL
C - - - - - 0x00B40B 02:B3FB: A8        TAY
C - - - - - 0x00B40C 02:B3FC: B1 29     LDA (ram_0029_t14_data_hurtboxes),Y
C - - - - - 0x00B40E 02:B3FE: 85 2B     STA ram_002B_t02_data
C - - - - - 0x00B410 02:B400: C8        INY
C - - - - - 0x00B411 02:B401: B1 29     LDA (ram_0029_t14_data_hurtboxes),Y
C - - - - - 0x00B413 02:B403: 85 2C     STA ram_002B_t02_data + $01
C - - - - - 0x00B415 02:B405: 05 2B     ORA ram_002B_t02_data
C - - - - - 0x00B417 02:B407: D0 03     BNE bra_B40C_able_to_hurt
; if pointer is 0000
C - - - - - 0x00B419 02:B409: 4C D0 B4  JMP loc_B4D0_no_hit
bra_B40C_able_to_hurt:
C - - - - - 0x00B41C 02:B40C: A6 1C     LDX ram_001C_t06
C - - - - - 0x00B41E 02:B40E: A0 00     LDY #$00
; bzk bug? these 8 indirect addresses can refer to 10F8-10FF (same as 00F8-00FF)
C - - - - - 0x00B420 02:B410: B1 2B     LDA (ram_002B_t02_data),Y
C - - - - - 0x00B422 02:B412: C8        INY ; 01
C - - - - - 0x00B423 02:B413: C9 7F     CMP #$7F
C - - - - - 0x00B425 02:B415: F0 1D     BEQ bra_B434_7F
C - - - - - 0x00B427 02:B417: 95 1D     STA ram_001D_t05_array,X
C - - - - - 0x00B429 02:B419: B1 2B     LDA (ram_002B_t02_data),Y
...
C - - - - - 0x00B435 02:B425: 95 22     STA ram_0022_t01_array,X
C - - - - - 0x00B437 02:B427: C8        INY ; 04
C - - - - - 0x00B438 02:B428: A9 40     LDA #$40    ; if this changed to 10, enemies won't be able to hit you
C - - - - - 0x00B43A 02:B42A: E0 00     CPX #$00
C - - - - - 0x00B43C 02:B42C: F0 02     BEQ bra_B430
C - - - - - 0x00B43E 02:B42E: A9 10     LDA #$10    ; if this changed to 40, you won't be able to hit enemies
bra_B430:
C - - - - - 0x00B440 02:B430: 05 04     ORA ram_0004_t03_lo
C - - - - - 0x00B442 02:B432: 85 04     STA ram_0004_t03_lo
bra_B434_7F:
C - - - - - 0x00B444 02:B434: B1 2B     LDA (ram_002B_t02_data),Y
C - - - - - 0x00B446 02:B436: C9 7F     CMP #$7F
C - - - - - 0x00B448 02:B438: F0 1D     BEQ bra_B457_7F
C - - - - - 0x00B44A 02:B43A: 95 08     STA ram_0008_t02_array,X
C - - - - - 0x00B44C 02:B43C: C8        INY ; 05
C - - - - - 0x00B44D 02:B43D: B1 2B     LDA (ram_002B_t02_data),Y
C - - - - - 0x00B44F 02:B43F: 95 0A     STA ram_000A_t01_array,X
C - - - - - 0x00B451 02:B441: C8        INY ; 06
C - - - - - 0x00B452 02:B442: B1 2B     LDA (ram_002B_t02_data),Y
C - - - - - 0x00B454 02:B444: 95 0B     STA ram_000B_t02_array,X
C - - - - - 0x00B456 02:B446: C8        INY ; 07
C - - - - - 0x00B457 02:B447: B1 2B     LDA (ram_002B_t02_data),Y
C - - - - - 0x00B459 02:B449: 95 0D     STA ram_000D_t02_array,X
...
bra_B453:
C - - - - - 0x00B463 02:B453: 05 04     ORA ram_0004_t03_lo
C - - - - - 0x00B465 02:B455: 85 04     STA ram_0004_t03_lo
bra_B457_7F:
C - - - - - 0x00B467 02:B457: A4 1B     LDY ram_001B_t11_obj_index
; bzk bug? value can be from ram_0026_t01 / ram_0026_tFE_useless
...
bra_B46D:
C - - - - - 0x00B47D 02:B46D: 95 21     STA ram_0021_t01_array,X
; bzk bug? value can be from
; ram_000B_t01_pos_X_hi
; ram_000B_t04_nametable_attribute
; ram_000B_t07
; ram_000B_t08_data_index
; ram_0011_t01_cam_pos_X_hi
; ram_0011_t02_obj_index_1
; ram_0011_t03
C - - - - - 0x00B47F 02:B46F: B5 0B     LDA ram_000B_t02_array,X
C - - - - - 0x00B481 02:B471: 08        PHP
C - - - - - 0x00B482 02:B472: 18        CLC
C - - - - - 0x00B483 02:B473: 79 AD 00  ADC a: ram_obj_pos_Z_lo,Y
C - - - - - 0x00B486 02:B476: 95 0B     STA ram_000B_t02_array,X
C - - - - - 0x00B488 02:B478: B9 B6 00  LDA a: ram_obj_pos_Z_hi,Y
...
bra_B483:
C - - - - - 0x00B493 02:B483: 95 0C     STA ram_000C_t01_array,X
C - - - - - 0x00B495 02:B485: B9 C7 00  LDA a: ram_animation_id,Y
C - - - - - 0x00B498 02:B488: 10 18     BPL bra_B4A2
; if mirrored
; bzk bug? value can be from ram_0023_t03_cam_pos_Y_lo
C - - - - - 0x00B49A 02:B48A: B5 1D     LDA ram_001D_t05_array,X
C - - - - - 0x00B49C 02:B48C: 18        CLC
; bzk bug? valie can be from ram_0025_t02_pos_X_lo
C - - - - - 0x00B49D 02:B48D: 75 1F     ADC ram_001F_t01_array,X
C - - - - - 0x00B49F 02:B48F: 49 FF     EOR #$FF
C - - - - - 0x00B4A1 02:B491: 18        CLC
C - - - - - 0x00B4A2 02:B492: 69 01     ADC #$01
C - - - - - 0x00B4A4 02:B494: 95 1D     STA ram_001D_t05_array,X
; bzk bug? value can be from
; ram_0008_t01_data
; ram_000E_t03
C - - - - - 0x00B4A6 02:B496: B5 08     LDA ram_0008_t02_array,X
C - - - - - 0x00B4A8 02:B498: 18        CLC
; bzk bug? value can be from
; ram_000A_t03_data_index
; ram_000A_t04_pos_X_lo
; ram_0010_t01_cam_pos_X_lo
C - - - - - 0x00B4A9 02:B499: 75 0A     ADC ram_000A_t01_array,X
C - - - - - 0x00B4AB 02:B49B: 49 FF     EOR #$FF
C - - - - - 0x00B4AD 02:B49D: 18        CLC
C - - - - - 0x00B4AE 02:B49E: 69 01     ADC #$01
C - - - - - 0x00B4B0 02:B4A0: 95 08     STA ram_0008_t02_array,X
bra_B4A2:
C - - - - - 0x00B4B2 02:B4A2: B5 1D     LDA ram_001D_t05_array,X
C - - - - - 0x00B4B4 02:B4A4: 08        PHP
C - - - - - 0x00B4B5 02:B4A5: 18        CLC
C - - - - - 0x00B4B6 02:B4A6: 79 77 00  ADC a: ram_obj_pos_X_lo,Y
C - - - - - 0x00B4B9 02:B4A9: 95 1D     STA ram_001D_t05_array,X
C - - - - - 0x00B4BB 02:B4AB: B9 80 00  LDA a: ram_obj_pos_X_hi,Y
...
bra_B4B6:
C - - - - - 0x00B4C6 02:B4B6: 95 1E     STA ram_001E_t04_array,X
; bzk bug? value can be from ram_000E_t01
C - - - - - 0x00B4C8 02:B4B8: B5 08     LDA ram_0008_t02_array,X
C - - - - - 0x00B4CA 02:B4BA: 08        PHP
C - - - - - 0x00B4CB 02:B4BB: 18        CLC
C - - - - - 0x00B4CC 02:B4BC: 79 77 00  ADC a: ram_obj_pos_X_lo,Y
C - - - - - 0x00B4CF 02:B4BF: 95 08     STA ram_0008_t02_array,X
C - - - - - 0x00B4D1 02:B4C1: B9 80 00  LDA a: ram_obj_pos_X_hi,Y
...
bra_B4CC:
C - - - - - 0x00B4DC 02:B4CC: 95 09     STA ram_0009_t01_array,X
...
; con_obj_williams
- D 1 - I - 0x00B51E 02:B50E: DA B8     .word off_B8DA  ; 00 
- D 1 - I - 0x00B520 02:B510: DA B8     .word off_B8DA  ; 01 
- D 1 - I - 0x00B522 02:B512: DA B8     .word off_B8DA  ; 02 
- D 1 - I - 0x00B524 02:B514: DA B8     .word off_B8DA  ; 03 
- D 1 - I - 0x00B526 02:B516: DA B8     .word off_B8DA  ; 04 
- D 1 - I - 0x00B528 02:B518: DA B8     .word off_B8DA  ; 05 
- D 1 - I - 0x00B52A 02:B51A: 00 00     .word $0000     ; 06 
- D 1 - I - 0x00B52C 02:B51C: 00 00     .word $0000     ; 07 
- D 1 - I - 0x00B52E 02:B51E: 00 00     .word $0000     ; 08 
- D 1 - I - 0x00B530 02:B520: DA B8     .word off_B8DA  ; 09 
- D 1 - I - 0x00B532 02:B522: 00 00     .word $0000     ; 0A 
- - - - - - 0x00B534 02:B524: 00 00     .word $0000     ; 0B 
- D 1 - I - 0x00B536 02:B526: DA B8     .word off_B8DA  ; 0C 
- D 1 - I - 0x00B538 02:B528: E4 B8     .word off_B8E4  ; 0D 
- D 1 - I - 0x00B53A 02:B52A: DA B8     .word off_B8DA  ; 0E 
- D 1 - I - 0x00B53C 02:B52C: E4 B8     .word off_B8E4  ; 0F 
- D 1 - I - 0x00B53E 02:B52E: DA B8     .word off_B8DA  ; 10 
- D 1 - I - 0x00B540 02:B530: DA B8     .word off_B8DA  ; 11 
- D 1 - I - 0x00B542 02:B532: DA B8     .word off_B8DA  ; 12 
- D 1 - I - 0x00B544 02:B534: 1D BA     .word off_BA1D  ; 13 
- D 1 - I - 0x00B546 02:B536: DA B8     .word off_B8DA  ; 14 
- D 1 - I - 0x00B548 02:B538: DA B8     .word off_B8DA  ; 15 
- D 1 - I - 0x00B54A 02:B53A: 38 B9     .word off_B938  ; 16 
- - - - - - 0x00B54C 02:B53C: 00 00     .word $0000     ; 17 
- - - - - - 0x00B54E 02:B53E: 00 00     .word $0000     ; 18 
- - - - - - 0x00B550 02:B540: 00 00     .word $0000     ; 19 
- D 1 - I - 0x00B552 02:B542: DA B8     .word off_B8DA  ; 1A 
- D 1 - I - 0x00B554 02:B544: DA B8     .word off_B8DA  ; 1B 
- D 1 - I - 0x00B556 02:B546: DA B8     .word off_B8DA  ; 1C 
- D 1 - I - 0x00B558 02:B548: DA B8     .word off_B8DA  ; 1D 
- D 1 - I - 0x00B55A 02:B54A: DA B8     .word off_B8DA  ; 1E 
- D 1 - I - 0x00B55C 02:B54C: DA B8     .word off_B8DA  ; 1F 
- D 1 - I - 0x00B55E 02:B54E: DA B8     .word off_B8DA  ; 20 
- D 1 - I - 0x00B560 02:B550: DA B8     .word off_B8DA  ; 21 
- D 1 - I - 0x00B562 02:B552: DA B8     .word off_B8DA  ; 22 
- D 1 - I - 0x00B564 02:B554: DA B8     .word off_B8DA  ; 23 
- D 1 - I - 0x00B566 02:B556: DA B8     .word off_B8DA  ; 24 
- D 1 - I - 0x00B568 02:B558: FE B8     .word off_B8FE  ; 25 



_off003_B55A_03_roper:
; con_obj_roper
- D 1 - I - 0x00B56A 02:B55A: DA B8     .word off_B8DA  ; 00 
- D 1 - I - 0x00B56C 02:B55C: DA B8     .word off_B8DA  ; 01 
- D 1 - I - 0x00B56E 02:B55E: DA B8     .word off_B8DA  ; 02 
- D 1 - I - 0x00B570 02:B560: DA B8     .word off_B8DA  ; 03 
- D 1 - I - 0x00B572 02:B562: DA B8     .word off_B8DA  ; 04 
- D 1 - I - 0x00B574 02:B564: DA B8     .word off_B8DA  ; 05 
- D 1 - I - 0x00B576 02:B566: 00 00     .word $0000     ; 06 
- D 1 - I - 0x00B578 02:B568: 00 00     .word $0000     ; 07 
- D 1 - I - 0x00B57A 02:B56A: 00 00     .word $0000     ; 08 
- D 1 - I - 0x00B57C 02:B56C: DA B8     .word off_B8DA  ; 09 
- D 1 - I - 0x00B57E 02:B56E: 00 00     .word $0000     ; 0A 
- - - - - - 0x00B580 02:B570: 00 00     .word $0000     ; 0B 
- D 1 - I - 0x00B582 02:B572: DA B8     .word off_B8DA  ; 0C 
- D 1 - I - 0x00B584 02:B574: E4 B8     .word off_B8E4  ; 0D 
- D 1 - I - 0x00B586 02:B576: DA B8     .word off_B8DA  ; 0E 
- D 1 - I - 0x00B588 02:B578: E4 B8     .word off_B8E4  ; 0F 
- D 1 - I - 0x00B58A 02:B57A: DA B8     .word off_B8DA  ; 10 
- D 1 - I - 0x00B58C 02:B57C: DA B8     .word off_B8DA  ; 11 
- - - - - - 0x00B58E 02:B57E: DA B8     .word off_B8DA  ; 12 
- - - - - - 0x00B590 02:B580: DA B8     .word off_B8DA  ; 13 
- - - - - - 0x00B592 02:B582: DA B8     .word off_B8DA  ; 14 
- - - - - - 0x00B594 02:B584: DA B8     .word off_B8DA  ; 15 
- - - - - - 0x00B596 02:B586: 26 B9     .word off_B926  ; 16 
- - - - - - 0x00B598 02:B588: 00 00     .word $0000     ; 17 
- - - - - - 0x00B59A 02:B58A: 00 00     .word $0000     ; 18 
- - - - - - 0x00B59C 02:B58C: 00 00     .word $0000     ; 19 
- - - - - - 0x00B59E 02:B58E: DA B8     .word off_B8DA  ; 1A 
- - - - - - 0x00B5A0 02:B590: DA B8     .word off_B8DA  ; 1B 
- - - - - - 0x00B5A2 02:B592: DA B8     .word off_B8DA  ; 1C 
- - - - - - 0x00B5A4 02:B594: DA B8     .word off_B8DA  ; 1D 
- - - - - - 0x00B5A6 02:B596: DA B8     .word off_B8DA  ; 1E 
- - - - - - 0x00B5A8 02:B598: DA B8     .word off_B8DA  ; 1F 
- - - - - - 0x00B5AA 02:B59A: 00 00     .word $0000     ; 20 
- - - - - - 0x00B5AC 02:B59C: 00 00     .word $0000     ; 21 
- - - - - - 0x00B5AE 02:B59E: 00 00     .word $0000     ; 22 
- - - - - - 0x00B5B0 02:B5A0: 00 00     .word $0000     ; 23 
- - - - - - 0x00B5B2 02:B5A2: 00 00     .word $0000     ; 24 
- D 1 - I - 0x00B5B4 02:B5A4: FE B8     .word off_B8FE  ; 25 



_off003_B5A6_04_linda:
; con_obj_linda
- D 1 - I - 0x00B5B6 02:B5A6: DA B8     .word off_B8DA  ; 00 
- D 1 - I - 0x00B5B8 02:B5A8: DA B8     .word off_B8DA  ; 01 
- D 1 - I - 0x00B5BA 02:B5AA: DA B8     .word off_B8DA  ; 02 
- D 1 - I - 0x00B5BC 02:B5AC: DA B8     .word off_B8DA  ; 03 
- D 1 - I - 0x00B5BE 02:B5AE: DA B8     .word off_B8DA  ; 04 
- D 1 - I - 0x00B5C0 02:B5B0: DA B8     .word off_B8DA  ; 05 
- D 1 - I - 0x00B5C2 02:B5B2: 00 00     .word $0000     ; 06 
- D 1 - I - 0x00B5C4 02:B5B4: 00 00     .word $0000     ; 07 
- D 1 - I - 0x00B5C6 02:B5B6: 00 00     .word $0000     ; 08 
- D 1 - I - 0x00B5C8 02:B5B8: DA B8     .word off_B8DA  ; 09 
- D 1 - I - 0x00B5CA 02:B5BA: 00 00     .word $0000     ; 0A 
- - - - - - 0x00B5CC 02:B5BC: 00 00     .word $0000     ; 0B 
- D 1 - I - 0x00B5CE 02:B5BE: DA B8     .word off_B8DA  ; 0C 
- D 1 - I - 0x00B5D0 02:B5C0: E4 B8     .word off_B8E4  ; 0D 
- D 1 - I - 0x00B5D2 02:B5C2: DA B8     .word off_B8DA  ; 0E 
- D 1 - I - 0x00B5D4 02:B5C4: E4 B8     .word off_B8E4  ; 0F 
- D 1 - I - 0x00B5D6 02:B5C6: DA B8     .word off_B8DA  ; 10 
- D 1 - I - 0x00B5D8 02:B5C8: DA B8     .word off_B8DA  ; 11 
- D 1 - I - 0x00B5DA 02:B5CA: DA B8     .word off_B8DA  ; 12 
- D 1 - I - 0x00B5DC 02:B5CC: 15 BA     .word off_BA15  ; 13 
- - - - - - 0x00B5DE 02:B5CE: DA B8     .word off_B8DA  ; 14 
- D 1 - I - 0x00B5E0 02:B5D0: DA B8     .word off_B8DA  ; 15 
- D 1 - I - 0x00B5E2 02:B5D2: 26 B9     .word off_B926  ; 16 
- D 1 - I - 0x00B5E4 02:B5D4: DA B8     .word off_B8DA  ; 17 
- - - - - - 0x00B5E6 02:B5D6: 00 00     .word $0000     ; 18 
- - - - - - 0x00B5E8 02:B5D8: 00 00     .word $0000     ; 19 
- D 1 - I - 0x00B5EA 02:B5DA: 40 B9     .word off_B940  ; 1A 



_off003_B5DC_00_billy:
; con_obj_billy
_off003_B5DC_01_jimmy:
; con_obj_jimmy
_off003_B5DC_05:
; con_obj_05
_off003_B5DC_0B:
; con_obj_0B
_off003_B5DC_0C_doppelganger:
...
_off003_B5DC_10:
; con_obj_10
_off003_B5DC_15_chain_wip:
; con_obj_chain_whip
- D 1 - I - 0x00B5EC 02:B5DC: DA B8     .word off_B8DA  ; 00 
- D 1 - I - 0x00B5EE 02:B5DE: DA B8     .word off_B8DA  ; 01 
- D 1 - I - 0x00B5F0 02:B5E0: DA B8     .word off_B8DA  ; 02 
- D 1 - I - 0x00B5F2 02:B5E2: DA B8     .word off_B8DA  ; 03 
- D 1 - I - 0x00B5F4 02:B5E4: DA B8     .word off_B8DA  ; 04 
- D 1 - I - 0x00B5F6 02:B5E6: DA B8     .word off_B8DA  ; 05 
- D 1 - I - 0x00B5F8 02:B5E8: 00 00     .word $0000     ; 06 
- D 1 - I - 0x00B5FA 02:B5EA: 00 00     .word $0000     ; 07 
- D 1 - I - 0x00B5FC 02:B5EC: 00 00     .word $0000     ; 08 
- D 1 - I - 0x00B5FE 02:B5EE: DA B8     .word off_B8DA  ; 09 
- D 1 - I - 0x00B600 02:B5F0: 00 00     .word $0000     ; 0A 
- - - - - - 0x00B602 02:B5F2: 00 00     .word $0000     ; 0B 
- D 1 - I - 0x00B604 02:B5F4: DA B8     .word off_B8DA  ; 0C 
- D 1 - I - 0x00B606 02:B5F6: E4 B8     .word off_B8E4  ; 0D 
- D 1 - I - 0x00B608 02:B5F8: DA B8     .word off_B8DA  ; 0E 
- D 1 - I - 0x00B60A 02:B5FA: E4 B8     .word off_B8E4  ; 0F 
- D 1 - I - 0x00B60C 02:B5FC: DA B8     .word off_B8DA  ; 10 
- D 1 - I - 0x00B60E 02:B5FE: DA B8     .word off_B8DA  ; 11 
- D 1 - I - 0x00B610 02:B600: DA B8     .word off_B8DA  ; 12 
- D 1 - I - 0x00B612 02:B602: 1D BA     .word off_BA1D  ; 13 
- D 1 - I - 0x00B614 02:B604: DA B8     .word off_B8DA  ; 14 
- D 1 - I - 0x00B616 02:B606: EC B8     .word off_B8EC  ; 15 
- D 1 - I - 0x00B618 02:B608: F1 B8     .word off_B8F1  ; 16 
- D 1 - I - 0x00B61A 02:B60A: F9 B8     .word off_B8F9  ; 17 
- D 1 - I - 0x00B61C 02:B60C: 26 B9     .word off_B926  ; 18 
- D 1 - I - 0x00B61E 02:B60E: FE B8     .word off_B8FE  ; 19 
- D 1 - I - 0x00B620 02:B610: DA B8     .word off_B8DA  ; 1A 
- D 1 - I - 0x00B622 02:B612: 06 B9     .word off_B906  ; 1B 
- D 1 - I - 0x00B624 02:B614: DA B8     .word off_B8DA  ; 1C 
- D 1 - I - 0x00B626 02:B616: 0E B9     .word off_B90E  ; 1D 
- D 1 - I - 0x00B628 02:B618: DA B8     .word off_B8DA  ; 1E 
- D 1 - I - 0x00B62A 02:B61A: 16 B9     .word off_B916  ; 1F 
- D 1 - I - 0x00B62C 02:B61C: 16 B9     .word off_B916  ; 20 
- D 1 - I - 0x00B62E 02:B61E: 1E B9     .word off_B91E  ; 21 
- D 1 - I - 0x00B630 02:B620: 1E B9     .word off_B91E  ; 22 
- D 1 - I - 0x00B632 02:B622: DA B8     .word off_B8DA  ; 23 
- D 1 - I - 0x00B634 02:B624: DA B8     .word off_B8DA  ; 24 
- D 1 - I - 0x00B636 02:B626: 2E B9     .word off_B92E  ; 25 
- D 1 - I - 0x00B638 02:B628: DA B8     .word off_B8DA  ; 26 
- D 1 - I - 0x00B63A 02:B62A: DA B8     .word off_B8DA  ; 27 
- D 1 - I - 0x00B63C 02:B62C: 33 B9     .word off_B933  ; 28 
- - - - - - 0x00B63E 02:B62E: 00 00     .word $0000     ; 29 
- - - - - - 0x00B640 02:B630: 00 00     .word $0000     ; 2A 
- D 1 - I - 0x00B642 02:B632: 2E B9     .word off_B92E  ; 2B 
- D 1 - I - 0x00B644 02:B634: 2E B9     .word off_B92E  ; 2C 
- D 1 - I - 0x00B646 02:B636: DA B8     .word off_B8DA  ; 2D 
- D 1 - I - 0x00B648 02:B638: DA B8     .word off_B8DA  ; 2E 
- - - - - - 0x00B64A 02:B63A: DA B8     .word off_B8DA  ; 2F 
- D 1 - I - 0x00B64C 02:B63C: DA B8     .word off_B8DA  ; 30 
- - - - - - 0x00B64E 02:B63E: 00 00     .word $0000     ; 31 
- - - - - - 0x00B650 02:B640: 00 00     .word $0000     ; 32 
- - - - - - 0x00B652 02:B642: 00 00     .word $0000     ; 33 
- - - - - - 0x00B654 02:B644: 00 00     .word $0000     ; 34 
- - - - - - 0x00B656 02:B646: 00 00     .word $0000     ; 35 
- - - - - - 0x00B658 02:B648: 00 00     .word $0000     ; 36 
- - - - - - 0x00B65A 02:B64A: 00 00     .word $0000     ; 37 
- - - - - - 0x00B65C 02:B64C: 00 00     .word $0000     ; 38 
- D 1 - I - 0x00B65E 02:B64E: 00 00     .word $0000     ; 39 
- D 1 - I - 0x00B660 02:B650: DA B8     .word off_B8DA  ; 3A 
- D 1 - I - 0x00B662 02:B652: 2D BA     .word off_BA2D  ; 3B 
- D 1 - I - 0x00B664 02:B654: 2D BA     .word off_BA2D  ; 3C 
- D 1 - I - 0x00B666 02:B656: 2D BA     .word off_BA2D  ; 3D 
- D 1 - I - 0x00B668 02:B658: DA B8     .word off_B8DA  ; 3E 
- D 1 - I - 0x00B66A 02:B65A: DA B8     .word off_B8DA  ; 3F 
- D 1 - I - 0x00B66C 02:B65C: 00 00     .word $0000     ; 40 
- D 1 - I - 0x00B66E 02:B65E: 00 00     .word $0000     ; 41 
- D 1 - I - 0x00B670 02:B660: 00 00     .word $0000     ; 42 
- D 1 - I - 0x00B672 02:B662: 00 00     .word $0000     ; 43 
- D 1 - I - 0x00B674 02:B664: 00 00     .word $0000     ; 44 
- D 1 - I - 0x00B676 02:B666: 00 00     .word $0000     ; 45 
- D 1 - I - 0x00B678 02:B668: 00 00     .word $0000     ; 46 
- D 1 - I - 0x00B67A 02:B66A: 00 00     .word $0000     ; 47 
- D 1 - I - 0x00B67C 02:B66C: 00 00     .word $0000     ; 48 
- D 1 - I - 0x00B67E 02:B66E: 00 00     .word $0000     ; 49 
- D 1 - I - 0x00B680 02:B670: 00 00     .word $0000     ; 4A 
- D 1 - I - 0x00B682 02:B672: 00 00     .word $0000     ; 4B 
- D 1 - I - 0x00B684 02:B674: 00 00     .word $0000     ; 4C 
- - - - - - 0x00B686 02:B676: 00 00     .word $0000     ; 4D 
- - - - - - 0x00B688 02:B678: 00 00     .word $0000     ; 4E 
- - - - - - 0x00B68A 02:B67A: 00 00     .word $0000     ; 4F 
- D 1 - I - 0x00B68C 02:B67C: 00 00     .word $0000     ; 50 
- D 1 - I - 0x00B68E 02:B67E: 00 00     .word $0000     ; 51 
- D 1 - I - 0x00B690 02:B680: 00 00     .word $0000     ; 52 
- D 1 - I - 0x00B692 02:B682: 00 00     .word $0000     ; 53 
- D 1 - I - 0x00B694 02:B684: 00 00     .word $0000     ; 54 
- D 1 - I - 0x00B696 02:B686: 00 00     .word $0000     ; 55 
- D 1 - I - 0x00B698 02:B688: 00 00     .word $0000     ; 56 
- - - - - - 0x00B69A 02:B68A: 00 00     .word $0000     ; 57 
- - - - - - 0x00B69C 02:B68C: 00 00     .word $0000     ; 58 
- - - - - - 0x00B69E 02:B68E: 00 00     .word $0000     ; 59 
- - - - - - 0x00B6A0 02:B690: 00 00     .word $0000     ; 5A 
- - - - - - 0x00B6A2 02:B692: 00 00     .word $0000     ; 5B 
- - - - - - 0x00B6A4 02:B694: 00 00     .word $0000     ; 5C 
- - - - - - 0x00B6A6 02:B696: 00 00     .word $0000     ; 5D 
- D 1 - I - 0x00B6A8 02:B698: DA B8     .word off_B8DA  ; 5E 
- D 1 - I - 0x00B6AA 02:B69A: 15 BA     .word off_BA15  ; 5F 



_off003_B69C_09_chin_taimei:
; con_obj_chin_taimei
- D 1 - I - 0x00B6AC 02:B69C: DA B8     .word off_B8DA  ; 00 
- D 1 - I - 0x00B6AE 02:B69E: DA B8     .word off_B8DA  ; 01 
- D 1 - I - 0x00B6B0 02:B6A0: DA B8     .word off_B8DA  ; 02 
- D 1 - I - 0x00B6B2 02:B6A2: DA B8     .word off_B8DA  ; 03 
- D 1 - I - 0x00B6B4 02:B6A4: 48 B9     .word off_B948  ; 04 
- D 1 - I - 0x00B6B6 02:B6A6: DA B8     .word off_B8DA  ; 05 
- D 1 - I - 0x00B6B8 02:B6A8: 00 00     .word $0000     ; 06 
- D 1 - I - 0x00B6BA 02:B6AA: 00 00     .word $0000     ; 07 
- D 1 - I - 0x00B6BC 02:B6AC: 00 00     .word $0000     ; 08 
- D 1 - I - 0x00B6BE 02:B6AE: DA B8     .word off_B8DA  ; 09 
- D 1 - I - 0x00B6C0 02:B6B0: 00 00     .word $0000     ; 0A 
- - - - - - 0x00B6C2 02:B6B2: 00 00     .word $0000     ; 0B 
- - - - - - 0x00B6C4 02:B6B4: DA B8     .word off_B8DA  ; 0C 
- D 1 - I - 0x00B6C6 02:B6B6: 50 B9     .word off_B950  ; 0D 
- D 1 - I - 0x00B6C8 02:B6B8: 50 B9     .word off_B950  ; 0E 
- D 1 - I - 0x00B6CA 02:B6BA: DA B8     .word off_B8DA  ; 0F 
- D 1 - I - 0x00B6CC 02:B6BC: 58 B9     .word off_B958  ; 10 
- D 1 - I - 0x00B6CE 02:B6BE: 58 B9     .word off_B958  ; 11 
- D 1 - I - 0x00B6D0 02:B6C0: 58 B9     .word off_B958  ; 12 
- D 1 - I - 0x00B6D2 02:B6C2: 5D B9     .word off_B95D  ; 13 



_off003_B6C4_08_abore:
; con_obj_abore
- D 1 - I - 0x00B6D4 02:B6C4: 65 B9     .word off_B965  ; 00 
- D 1 - I - 0x00B6D6 02:B6C6: 65 B9     .word off_B965  ; 01 
- D 1 - I - 0x00B6D8 02:B6C8: 65 B9     .word off_B965  ; 02 
- - - - - - 0x00B6DA 02:B6CA: 00 00     .word $0000     ; 03 
- - - - - - 0x00B6DC 02:B6CC: 00 00     .word $0000     ; 04 
- D 1 - I - 0x00B6DE 02:B6CE: 65 B9     .word off_B965  ; 05 
- D 1 - I - 0x00B6E0 02:B6D0: 00 00     .word $0000     ; 06 
- D 1 - I - 0x00B6E2 02:B6D2: 00 00     .word $0000     ; 07 
- D 1 - I - 0x00B6E4 02:B6D4: 00 00     .word $0000     ; 08 
- D 1 - I - 0x00B6E6 02:B6D6: 65 B9     .word off_B965  ; 09 
- D 1 - I - 0x00B6E8 02:B6D8: 00 00     .word $0000     ; 0A 
- - - - - - 0x00B6EA 02:B6DA: 00 00     .word $0000     ; 0B 
- D 1 - I - 0x00B6EC 02:B6DC: 65 B9     .word off_B965  ; 0C 
- D 1 - I - 0x00B6EE 02:B6DE: 6A B9     .word off_B96A  ; 0D 
- D 1 - I - 0x00B6F0 02:B6E0: 65 B9     .word off_B965  ; 0E 
- D 1 - I - 0x00B6F2 02:B6E2: 6A B9     .word off_B96A  ; 0F 
- D 1 - I - 0x00B6F4 02:B6E4: 72 B9     .word off_B972  ; 10 



_off003_B6E6_07_burnov:
; con_obj_burnov
- D 1 - I - 0x00B6F6 02:B6E6: 65 B9     .word off_B965  ; 00 
- D 1 - I - 0x00B6F8 02:B6E8: 65 B9     .word off_B965  ; 01 
- D 1 - I - 0x00B6FA 02:B6EA: 65 B9     .word off_B965  ; 02 
- D 1 - I - 0x00B6FC 02:B6EC: 65 B9     .word off_B965  ; 03 
- D 1 - I - 0x00B6FE 02:B6EE: 65 B9     .word off_B965  ; 04 
- - - - - - 0x00B700 02:B6F0: 65 B9     .word off_B965  ; 05 
- D 1 - I - 0x00B702 02:B6F2: 00 00     .word $0000     ; 06 
- D 1 - I - 0x00B704 02:B6F4: 00 00     .word $0000     ; 07 
- D 1 - I - 0x00B706 02:B6F6: 00 00     .word $0000     ; 08 
- D 1 - I - 0x00B708 02:B6F8: 65 B9     .word off_B965  ; 09 
- D 1 - I - 0x00B70A 02:B6FA: 00 00     .word $0000     ; 0A 
- - - - - - 0x00B70C 02:B6FC: 00 00     .word $0000     ; 0B 
- D 1 - I - 0x00B70E 02:B6FE: 65 B9     .word off_B965  ; 0C 
- D 1 - I - 0x00B710 02:B700: 7A B9     .word off_B97A  ; 0D 
- D 1 - I - 0x00B712 02:B702: 65 B9     .word off_B965  ; 0E 
- D 1 - I - 0x00B714 02:B704: 7A B9     .word off_B97A  ; 0F 
- D 1 - I - 0x00B716 02:B706: 65 B9     .word off_B965  ; 10 
- - - - - - 0x00B718 02:B708: 00 00     .word $0000     ; 11 
- - - - - - 0x00B71A 02:B70A: 00 00     .word $0000     ; 12 
- - - - - - 0x00B71C 02:B70C: 00 00     .word $0000     ; 13 
- - - - - - 0x00B71E 02:B70E: 00 00     .word $0000     ; 14 
- - - - - - 0x00B720 02:B710: 00 00     .word $0000     ; 15 
- - - - - - 0x00B722 02:B712: 00 00     .word $0000     ; 16 
- - - - - - 0x00B724 02:B714: 00 00     .word $0000     ; 17 
- D 1 - I - 0x00B726 02:B716: 00 00     .word $0000     ; 18 
- D 1 - I - 0x00B728 02:B718: 00 00     .word $0000     ; 19 
- - - - - - 0x00B72A 02:B71A: 00 00     .word $0000     ; 1A 
- - - - - - 0x00B72C 02:B71C: 00 00     .word $0000     ; 1B 



_off003_B71E_06_bolo:
; con_obj_bolo
- D 1 - I - 0x00B72E 02:B71E: 65 B9     .word off_B965  ; 00 
- D 1 - I - 0x00B730 02:B720: 65 B9     .word off_B965  ; 01 
- D 1 - I - 0x00B732 02:B722: 65 B9     .word off_B965  ; 02 
- D 1 - I - 0x00B734 02:B724: 65 B9     .word off_B965  ; 03 
- D 1 - I - 0x00B736 02:B726: 65 B9     .word off_B965  ; 04 
- D 1 - I - 0x00B738 02:B728: 65 B9     .word off_B965  ; 05 
- D 1 - I - 0x00B73A 02:B72A: 00 00     .word $0000     ; 06 
- D 1 - I - 0x00B73C 02:B72C: 00 00     .word $0000     ; 07 
- D 1 - I - 0x00B73E 02:B72E: 00 00     .word $0000     ; 08 
- D 1 - I - 0x00B740 02:B730: 65 B9     .word off_B965  ; 09 
- D 1 - I - 0x00B742 02:B732: 00 00     .word $0000     ; 0A 
- - - - - - 0x00B744 02:B734: 00 00     .word $0000     ; 0B 
- D 1 - I - 0x00B746 02:B736: 65 B9     .word off_B965  ; 0C 
- D 1 - I - 0x00B748 02:B738: 82 B9     .word off_B982  ; 0D 
- D 1 - I - 0x00B74A 02:B73A: 65 B9     .word off_B965  ; 0E 
- D 1 - I - 0x00B74C 02:B73C: 82 B9     .word off_B982  ; 0F 
- - - - - - 0x00B74E 02:B73E: 00 00     .word $0000     ; 10 
- - - - - - 0x00B750 02:B740: 00 00     .word $0000     ; 11 
- - - - - - 0x00B752 02:B742: 00 00     .word $0000     ; 12 
- - - - - - 0x00B754 02:B744: 00 00     .word $0000     ; 13 
- - - - - - 0x00B756 02:B746: 00 00     .word $0000     ; 14 
- - - - - - 0x00B758 02:B748: 8A B9     .word off_B98A  ; 15 
- - - - - - 0x00B75A 02:B74A: 8A B9     .word off_B98A  ; 16 
- - - - - - 0x00B75C 02:B74C: 8A B9     .word off_B98A  ; 17 
- D 1 - I - 0x00B75E 02:B74E: 8A B9     .word off_B98A  ; 18 



_off003_B750_0F_nina:
; con_obj_ninja
- - - - - - 0x00B760 02:B750: 92 B9     .word off_B992  ; 00 
- - - - - - 0x00B762 02:B752: 92 B9     .word off_B992  ; 01 
- D 1 - I - 0x00B764 02:B754: DA B8     .word off_B8DA  ; 02 
- - - - - - 0x00B766 02:B756: 00 00     .word $0000     ; 03 
- D 1 - I - 0x00B768 02:B758: 92 B9     .word off_B992  ; 04 
- D 1 - I - 0x00B76A 02:B75A: 92 B9     .word off_B992  ; 05 
- D 1 - I - 0x00B76C 02:B75C: 00 00     .word $0000     ; 06 
- D 1 - I - 0x00B76E 02:B75E: 00 00     .word $0000     ; 07 
- D 1 - I - 0x00B770 02:B760: 00 00     .word $0000     ; 08 
- D 1 - I - 0x00B772 02:B762: DA B8     .word off_B8DA  ; 09 
- D 1 - I - 0x00B774 02:B764: 00 00     .word $0000     ; 0A 
- - - - - - 0x00B776 02:B766: 00 00     .word $0000     ; 0B 
- D 1 - I - 0x00B778 02:B768: DA B8     .word off_B8DA  ; 0C 
- D 1 - I - 0x00B77A 02:B76A: E4 B8     .word off_B8E4  ; 0D 
- D 1 - I - 0x00B77C 02:B76C: DA B8     .word off_B8DA  ; 0E 
- D 1 - I - 0x00B77E 02:B76E: E4 B8     .word off_B8E4  ; 0F 
- - - - - - 0x00B780 02:B770: 92 B9     .word off_B992  ; 10 
- D 1 - I - 0x00B782 02:B772: 92 B9     .word off_B992  ; 11 
- - - - - - 0x00B784 02:B774: 92 B9     .word off_B992  ; 12 
- - - - - - 0x00B786 02:B776: 92 B9     .word off_B992  ; 13 
- D 1 - I - 0x00B788 02:B778: 97 B9     .word off_B997  ; 14 
- - - - - - 0x00B78A 02:B77A: 92 B9     .word off_B992  ; 15 
- D 1 - I - 0x00B78C 02:B77C: DA B8     .word off_B8DA  ; 16 
- D 1 - I - 0x00B78E 02:B77E: 9F B9     .word off_B99F  ; 17 
- D 1 - I - 0x00B790 02:B780: DA B8     .word off_B8DA  ; 18 
- - - - - - 0x00B792 02:B782: 00 00     .word $0000     ; 19 
- D 1 - I - 0x00B794 02:B784: 92 B9     .word off_B992  ; 1A 
- D 1 - I - 0x00B796 02:B786: 92 B9     .word off_B992  ; 1B 
- D 1 - I - 0x00B798 02:B788: 92 B9     .word off_B992  ; 1C 
- D 1 - I - 0x00B79A 02:B78A: 92 B9     .word off_B992  ; 1D 
- D 1 - I - 0x00B79C 02:B78C: 92 B9     .word off_B992  ; 1E 
- D 1 - I - 0x00B79E 02:B78E: 92 B9     .word off_B992  ; 1F 
- D 1 - I - 0x00B7A0 02:B790: A7 B9     .word off_B9A7  ; 20 
- D 1 - I - 0x00B7A2 02:B792: AC B9     .word off_B9AC  ; 21 
- D 1 - I - 0x00B7A4 02:B794: B1 B9     .word off_B9B1  ; 22 



_off003_B796_11_shadow_warrior:
; con_obj_shadow_warrior
- D 1 - I - 0x00B7A6 02:B796: DA B8     .word off_B8DA  ; 00 
- D 1 - I - 0x00B7A8 02:B798: DA B8     .word off_B8DA  ; 01 
- D 1 - I - 0x00B7AA 02:B79A: DA B8     .word off_B8DA  ; 02 
- - - - - - 0x00B7AC 02:B79C: 00 00     .word $0000     ; 03 
- - - - - - 0x00B7AE 02:B79E: 00 00     .word $0000     ; 04 
- - - - - - 0x00B7B0 02:B7A0: DA B8     .word off_B8DA  ; 05 
- D 1 - I - 0x00B7B2 02:B7A2: 00 00     .word $0000     ; 06 
- D 1 - I - 0x00B7B4 02:B7A4: 00 00     .word $0000     ; 07 
- D 1 - I - 0x00B7B6 02:B7A6: 00 00     .word $0000     ; 08 
- D 1 - I - 0x00B7B8 02:B7A8: DA B8     .word off_B8DA  ; 09 
- D 1 - I - 0x00B7BA 02:B7AA: 00 00     .word $0000     ; 0A 
- - - - - - 0x00B7BC 02:B7AC: 00 00     .word $0000     ; 0B 
- D 1 - I - 0x00B7BE 02:B7AE: DA B8     .word off_B8DA  ; 0C 
- D 1 - I - 0x00B7C0 02:B7B0: BE B9     .word off_B9BE  ; 0D 
- D 1 - I - 0x00B7C2 02:B7B2: DA B8     .word off_B8DA  ; 0E 
- D 1 - I - 0x00B7C4 02:B7B4: BE B9     .word off_B9BE  ; 0F 
- D 1 - I - 0x00B7C6 02:B7B6: 00 00     .word $0000     ; 10 
- - - - - - 0x00B7C8 02:B7B8: 00 00     .word $0000     ; 11 
- D 1 - I - 0x00B7CA 02:B7BA: 00 00     .word $0000     ; 12 
- D 1 - I - 0x00B7CC 02:B7BC: 00 00     .word $0000     ; 13 
- D 1 - I - 0x00B7CE 02:B7BE: 00 00     .word $0000     ; 14 
- D 1 - I - 0x00B7D0 02:B7C0: DA B8     .word off_B8DA  ; 15 
- D 1 - I - 0x00B7D2 02:B7C2: C6 B9     .word off_B9C6  ; 16 
- D 1 - I - 0x00B7D4 02:B7C4: 00 00     .word $0000     ; 17 
- D 1 - I - 0x00B7D6 02:B7C6: 00 00     .word $0000     ; 18 
- D 1 - I - 0x00B7D8 02:B7C8: 00 00     .word $0000     ; 19 
- D 1 - I - 0x00B7DA 02:B7CA: 00 00     .word $0000     ; 1A 
- D 1 - I - 0x00B7DC 02:B7CC: CE B9     .word off_B9CE  ; 1B 
- D 1 - I - 0x00B7DE 02:B7CE: DA B8     .word off_B8DA  ; 1C 
- D 1 - I - 0x00B7E0 02:B7D0: D3 B9     .word off_B9D3  ; 1D 
- D 1 - I - 0x00B7E2 02:B7D2: D8 B9     .word off_B9D8  ; 1E 
- D 1 - I - 0x00B7E4 02:B7D4: DA B8     .word off_B8DA  ; 1F 
- D 1 - I - 0x00B7E6 02:B7D6: DD B9     .word off_B9DD  ; 20 
- D 1 - I - 0x00B7E8 02:B7D8: E2 B9     .word off_B9E2  ; 21 
- D 1 - I - 0x00B7EA 02:B7DA: EA B9     .word off_B9EA  ; 22 
- - - - - - 0x00B7EC 02:B7DC: 00 00     .word $0000     ; 23 
- D 1 - I - 0x00B7EE 02:B7DE: DA B8     .word off_B8DA  ; 24 
- D 1 - I - 0x00B7F0 02:B7E0: B6 B9     .word off_B9B6  ; 25 
- D 1 - I - 0x00B7F2 02:B7E2: DA B8     .word off_B8DA  ; 26 
- D 1 - I - 0x00B7F4 02:B7E4: B6 B9     .word off_B9B6  ; 27 



_off003_B7E6_1C_fireball:
; con_obj_fireball
- D 1 - I - 0x00B7F6 02:B7E6: EF B9     .word off_B9EF  ; 00 
- D 1 - I - 0x00B7F8 02:B7E8: EF B9     .word off_B9EF  ; 01 
- - - - - - 0x00B7FA 02:B7EA: F4 B9     .word off_B9F4  ; 02 
- - - - - - 0x00B7FC 02:B7EC: F4 B9     .word off_B9F4  ; 03 



_off003_B7EE_19:
; con_obj_19
- - - - - - 0x00B7FE 02:B7EE: F7 B9     .word off_B9F7  ; 00 
- D 1 - I - 0x00B800 02:B7F0: F7 B9     .word off_B9F7  ; 01 
- - - - - - 0x00B802 02:B7F2: F7 B9     .word off_B9F7  ; 02 
- D 1 - I - 0x00B804 02:B7F4: F7 B9     .word off_B9F7  ; 03 
- D 1 - I - 0x00B806 02:B7F6: F7 B9     .word off_B9F7  ; 04 
- - - - - - 0x00B808 02:B7F8: F7 B9     .word off_B9F7  ; 05 
- - - - - - 0x00B80A 02:B7FA: F7 B9     .word off_B9F7  ; 06 
- - - - - - 0x00B80C 02:B7FC: F7 B9     .word off_B9F7  ; 07 
- D 1 - I - 0x00B80E 02:B7FE: 00 00     .word $0000     ; 08 



_off003_B800_1D:
; con_obj_1D
- D 1 - I - 0x00B810 02:B800: F7 B9     .word off_B9F7  ; 00 
- D 1 - I - 0x00B812 02:B802: F7 B9     .word off_B9F7  ; 01 



_off003_B804_13:
; con_obj_13
- D 1 - I - 0x00B814 02:B804: F4 B9     .word off_B9F4  ; 00 
- D 1 - I - 0x00B816 02:B806: F4 B9     .word off_B9F4  ; 01 
- D 1 - I - 0x00B818 02:B808: F4 B9     .word off_B9F4  ; 02 
- D 1 - I - 0x00B81A 02:B80A: FC B9     .word off_B9FC  ; 03 
- D 1 - I - 0x00B81C 02:B80C: FC B9     .word off_B9FC  ; 04 
- D 1 - I - 0x00B81E 02:B80E: FC B9     .word off_B9FC  ; 05 
- D 1 - I - 0x00B820 02:B810: FC B9     .word off_B9FC  ; 06 
- D 1 - I - 0x00B822 02:B812: F4 B9     .word off_B9F4  ; 07 
- D 1 - I - 0x00B824 02:B814: F4 B9     .word off_B9F4  ; 08 
- D 1 - I - 0x00B826 02:B816: F4 B9     .word off_B9F4  ; 09 



_off003_B818_12_knife:
; con_obj_knife
- D 1 - I - 0x00B828 02:B818: F4 B9     .word off_B9F4  ; 00 
- D 1 - I - 0x00B82A 02:B81A: F7 B9     .word off_B9F7  ; 01 
- D 1 - I - 0x00B82C 02:B81C: F7 B9     .word off_B9F7  ; 02 
- D 1 - I - 0x00B82E 02:B81E: F7 B9     .word off_B9F7  ; 03 
- - - - - - 0x00B830 02:B820: F7 B9     .word off_B9F7  ; 04 
- - - - - - 0x00B832 02:B822: F4 B9     .word off_B9F4  ; 05 
- - - - - - 0x00B834 02:B824: F4 B9     .word off_B9F4  ; 06 
- - - - - - 0x00B836 02:B826: F4 B9     .word off_B9F4  ; 07 
- D 1 - I - 0x00B838 02:B828: 00 00     .word $0000     ; 08 



_off003_B82A_18:
; con_obj_18
- D 1 - I - 0x00B83A 02:B82A: 01 BA     .word off_BA01  ; 00 
- D 1 - I - 0x00B83C 02:B82C: 01 BA     .word off_BA01  ; 01 
- D 1 - I - 0x00B83E 02:B82E: 01 BA     .word off_BA01  ; 02 
- D 1 - I - 0x00B840 02:B830: 01 BA     .word off_BA01  ; 03 
- D 1 - I - 0x00B842 02:B832: F4 B9     .word off_B9F4  ; 04 
- D 1 - I - 0x00B844 02:B834: F4 B9     .word off_B9F4  ; 05 



_off003_B836_1A:
; con_obj_boomerang
- D 1 - I - 0x00B846 02:B836: 06 BA     .word off_BA06  ; 00 
- D 1 - I - 0x00B848 02:B838: 06 BA     .word off_BA06  ; 01 
- D 1 - I - 0x00B84A 02:B83A: 06 BA     .word off_BA06  ; 02 
- D 1 - I - 0x00B84C 02:B83C: 06 BA     .word off_BA06  ; 03 
- D 1 - I - 0x00B84E 02:B83E: F4 B9     .word off_B9F4  ; 04 
- D 1 - I - 0x00B850 02:B840: F4 B9     .word off_B9F4  ; 05 



_off003_B842_14_grenade:
; con_obj_grenade
_off003_B842_16_flame_grenades:
; con_obj_flame_grenades
- D 1 - I - 0x00B852 02:B842: F4 B9     .word off_B9F4  ; 00 
- D 1 - I - 0x00B854 02:B844: F7 B9     .word off_B9F7  ; 01 
- D 1 - I - 0x00B856 02:B846: F7 B9     .word off_B9F7  ; 02 
- D 1 - I - 0x00B858 02:B848: F7 B9     .word off_B9F7  ; 03 
- D 1 - I - 0x00B85A 02:B84A: F4 B9     .word off_B9F4  ; 04 
- D 1 - I - 0x00B85C 02:B84C: F4 B9     .word off_B9F4  ; 05 
- D 1 - I - 0x00B85E 02:B84E: F4 B9     .word off_B9F4  ; 06 
- D 1 - I - 0x00B860 02:B850: 0B BA     .word off_BA0B  ; 07 
- D 1 - I - 0x00B862 02:B852: 0B BA     .word off_BA0B  ; 08 
- D 1 - I - 0x00B864 02:B854: 0B BA     .word off_BA0B  ; 09 
- D 1 - I - 0x00B866 02:B856: 0B BA     .word off_BA0B  ; 0A 
- D 1 - I - 0x00B868 02:B858: 0B BA     .word off_BA0B  ; 0B 
- D 1 - I - 0x00B86A 02:B85A: 0B BA     .word off_BA0B  ; 0C 
- D 1 - I - 0x00B86C 02:B85C: 0B BA     .word off_BA0B  ; 0D 
- D 1 - I - 0x00B86E 02:B85E: 0B BA     .word off_BA0B  ; 0E 
- D 1 - I - 0x00B870 02:B860: F4 B9     .word off_B9F4  ; 0F 
- D 1 - I - 0x00B872 02:B862: F4 B9     .word off_B9F4  ; 10 
- D 1 - I - 0x00B874 02:B864: F4 B9     .word off_B9F4  ; 11 
- D 1 - I - 0x00B876 02:B866: F4 B9     .word off_B9F4  ; 12 
- D 1 - I - 0x00B878 02:B868: F4 B9     .word off_B9F4  ; 13 
- D 1 - I - 0x00B87A 02:B86A: 10 BA     .word off_BA10  ; 14 
- D 1 - I - 0x00B87C 02:B86C: 10 BA     .word off_BA10  ; 15 
- D 1 - I - 0x00B87E 02:B86E: 10 BA     .word off_BA10  ; 16 
- D 1 - I - 0x00B880 02:B870: 10 BA     .word off_BA10  ; 17 
- D 1 - I - 0x00B882 02:B872: 10 BA     .word off_BA10  ; 18 
- D 1 - I - 0x00B884 02:B874: 10 BA     .word off_BA10  ; 19 
- D 1 - I - 0x00B886 02:B876: F4 B9     .word off_B9F4  ; 1A 



_off003_B878_1B_jumping_spike:
; con_obj_jumping_spike
- D 1 - I - 0x00B888 02:B878: F7 B9     .word off_B9F7  ; 00 
- D 1 - I - 0x00B88A 02:B87A: F7 B9     .word off_B9F7  ; 01 
- D 1 - I - 0x00B88C 02:B87C: F7 B9     .word off_B9F7  ; 02 
- D 1 - I - 0x00B88E 02:B87E: F7 B9     .word off_B9F7  ; 03 
- D 1 - I - 0x00B890 02:B880: F7 B9     .word off_B9F7  ; 04 
- - - - - - 0x00B892 02:B882: F7 B9     .word off_B9F7  ; 05 



_off003_B884_0A_right_arm:
; con_obj_right_arm
- D 1 - I - 0x00B894 02:B884: DA B8     .word off_B8DA  ; 00 
- D 1 - I - 0x00B896 02:B886: DA B8     .word off_B8DA  ; 01 
- D 1 - I - 0x00B898 02:B888: DA B8     .word off_B8DA  ; 02 
- D 1 - I - 0x00B89A 02:B88A: DA B8     .word off_B8DA  ; 03 
- D 1 - I - 0x00B89C 02:B88C: DA B8     .word off_B8DA  ; 04 
- D 1 - I - 0x00B89E 02:B88E: DA B8     .word off_B8DA  ; 05 
- D 1 - I - 0x00B8A0 02:B890: 00 00     .word $0000     ; 06 
- D 1 - I - 0x00B8A2 02:B892: 00 00     .word $0000     ; 07 
- D 1 - I - 0x00B8A4 02:B894: 00 00     .word $0000     ; 08 
- D 1 - I - 0x00B8A6 02:B896: DA B8     .word off_B8DA  ; 09 
- D 1 - I - 0x00B8A8 02:B898: 00 00     .word $0000     ; 0A 
- - - - - - 0x00B8AA 02:B89A: 00 00     .word $0000     ; 0B 
- D 1 - I - 0x00B8AC 02:B89C: DA B8     .word off_B8DA  ; 0C 
- D 1 - I - 0x00B8AE 02:B89E: E4 B8     .word off_B8E4  ; 0D 
- D 1 - I - 0x00B8B0 02:B8A0: DA B8     .word off_B8DA  ; 0E 
- D 1 - I - 0x00B8B2 02:B8A2: E4 B8     .word off_B8E4  ; 0F 
- D 1 - I - 0x00B8B4 02:B8A4: DA B8     .word off_B8DA  ; 10 
- D 1 - I - 0x00B8B6 02:B8A6: 25 BA     .word off_BA25  ; 11 
- - - - - - 0x00B8B8 02:B8A8: 00 00     .word $0000     ; 12 
- - - - - - 0x00B8BA 02:B8AA: 00 00     .word $0000     ; 13 
- - - - - - 0x00B8BC 02:B8AC: 00 00     .word $0000     ; 14 
- D 1 - I - 0x00B8BE 02:B8AE: DA B8     .word off_B8DA  ; 15 
- D 1 - I - 0x00B8C0 02:B8B0: 25 BA     .word off_BA25  ; 16 
- - - - - - 0x00B8C2 02:B8B2: 00 00     .word $0000     ; 17 
- - - - - - 0x00B8C4 02:B8B4: 00 00     .word $0000     ; 18 
- - - - - - 0x00B8C6 02:B8B6: 00 00     .word $0000     ; 19 
- D 1 - I - 0x00B8C8 02:B8B8: E4 B8     .word off_B8E4  ; 1A 
- - - - - - 0x00B8CA 02:B8BA: 00 00     .word $0000     ; 1B 
- - - - - - 0x00B8CC 02:B8BC: 00 00     .word $0000     ; 1C 
- - - - - - 0x00B8CE 02:B8BE: 00 00     .word $0000     ; 1D 
- - - - - - 0x00B8D0 02:B8C0: 00 00     .word $0000     ; 1E 
- - - - - - 0x00B8D2 02:B8C2: 00 00     .word $0000     ; 1F 
- - - - - - 0x00B8D4 02:B8C4: 00 00     .word $0000     ; 20 
- - - - - - 0x00B8D6 02:B8C6: 00 00     .word $0000     ; 21 
- - - - - - 0x00B8D8 02:B8C8: 00 00     .word $0000     ; 22 
- - - - - - 0x00B8DA 02:B8CA: 00 00     .word $0000     ; 23 
- - - - - - 0x00B8DC 02:B8CC: 00 00     .word $0000     ; 24 
- D 1 - I - 0x00B8DE 02:B8CE: FE B8     .word off_B8FE  ; 25 



_off003_B8D0_17_baton:
; con_obj_baton
- D 1 - I - 0x00B8E0 02:B8D0: 00 00     .word $0000     ; 00 
- - - - - - 0x00B8E2 02:B8D2: 00 00     .word $0000     ; 01 
- - - - - - 0x00B8E4 02:B8D4: 00 00     .word $0000     ; 02 
- - - - - - 0x00B8E6 02:B8D6: 00 00     .word $0000     ; 03 
- D 1 - I - 0x00B8E8 02:B8D8: EF B9     .word off_B9EF  ; 04 
...
tbl_BA32_state_outcome:
- D 1 - - - 0x00BA42 02:BA32: 2A BB     .word _off004_BB2A_do_nothing   ; 00 con_state_idle
- - - - - - 0x00BA44 02:BA34: 2A BB     .word _off004_BB2A_do_nothing   ; 01 con_state_walk
- - - - - - 0x00BA46 02:BA36: 2A BB     .word _off004_BB2A_do_nothing   ; 02 con_state_run
- - - - - - 0x00BA48 02:BA38: 2A BB     .word _off004_BB2A_do_nothing   ; 03 con_state_ladder_climb_up
- - - - - - 0x00BA4A 02:BA3A: 2A BB     .word _off004_BB2A_do_nothing   ; 04 con_state_ladder_climb_idle
- - - - - - 0x00BA4C 02:BA3C: 2A BB     .word _off004_BB2A_do_nothing   ; 05 con_state_ladder_climb_down
- - - - - - 0x00BA4E 02:BA3E: 2A BB     .word _off004_BB2A_do_nothing   ; 06 con_state_jump_up
- - - - - - 0x00BA50 02:BA40: 2A BB     .word _off004_BB2A_do_nothing   ; 07 con_state_fall_from_platform
- - - - - - 0x00BA52 02:BA42: 2A BB     .word _off004_BB2A_do_nothing   ; 08 con_state_jump_foward_player
- - - - - - 0x00BA54 02:BA44: 2A BB     .word _off004_BB2A_do_nothing   ; 09 con_state_jump_foward_enemy
- - - - - - 0x00BA56 02:BA46: 2A BB     .word _off004_BB2A_do_nothing   ; 0A con_state_0A
- - - - - - 0x00BA58 02:BA48: 2A BB     .word _off004_BB2A_do_nothing   ; 0B con_state_ninja_jump_low
- - - - - - 0x00BA5A 02:BA4A: 2A BB     .word _off004_BB2A_do_nothing   ; 0C con_state_ninja_jump_high
- - - - - - 0x00BA5C 02:BA4C: 2A BB     .word _off004_BB2A_do_nothing   ; 0D con_state_somersault_run
- - - - - - 0x00BA5E 02:BA4E: 2A BB     .word _off004_BB2A_do_nothing   ; 0E con_state_doppelganger_dispawn
- - - - - - 0x00BA60 02:BA50: 2A BB     .word _off004_BB2A_do_nothing   ; 0F con_state_doppelganger_invisible
- - - - - - 0x00BA62 02:BA52: 2A BB     .word _off004_BB2A_do_nothing   ; 10 con_state_doppelganger_spawn
- - - - - - 0x00BA64 02:BA54: 2A BB     .word _off004_BB2A_do_nothing   ; 11 con_state_pick_up_weapon
- - - - - - 0x00BA66 02:BA56: 2A BB     .word _off004_BB2A_do_nothing   ; 12 con_state_land_after_jump
- - - - - - 0x00BA68 02:BA58: 2A BB     .word _off004_BB2A_do_nothing   ; 13 con_state_fall_after_action
...
- - - - - - 0x00BA74 02:BA64: 2A BB     .word _off004_BB2A_do_nothing   ; 19 con_state_lie_on_the_ground
...
- - - - - - 0x00BA7E 02:BA6E: 2A BB     .word _off004_BB2A_do_nothing   ; 1E con_state_thrown_by_hair_throw
...
- - - - - - 0x00BA8C 02:BA7C: 2A BB     .word _off004_BB2A_do_nothing   ; 25 con_state_player_respawn
- - - - - - 0x00BA8E 02:BA7E: 2A BB     .word _off004_BB2A_do_nothing   ; 26 con_state_death_normal
- - - - - - 0x00BA90 02:BA80: 2A BB     .word _off004_BB2A_do_nothing   ; 27 con_state_death_water
- - - - - - 0x00BA92 02:BA82: 2A BB     .word _off004_BB2A_do_nothing   ; 28 con_state_death_burnov
- - - - - - 0x00BA94 02:BA84: 2A BB     .word _off004_BB2A_do_nothing   ; 29 con_state_burnov_helmet
- - - - - - 0x00BA96 02:BA86: 2A BB     .word _off004_BB2A_do_nothing   ; 2A con_state_burnov_revives
- - - - - - 0x00BA98 02:BA88: 2A BB     .word _off004_BB2A_do_nothing   ; 2B con_state_hit_by_spikes_on_the_ceiling
- - - - - - 0x00BA9A 02:BA8A: 2A BB     .word _off004_BB2A_do_nothing   ; 2C con_state_shadow_warrior_appears
...
- - - - - - 0x00BAB0 02:BAA0: 97 BC     .word _off004_BC97_37   ; unused, index doesn't exist
...
- - - - - - 0x00BB02 02:BAF2: 85 BD     .word _off004_BD85_60   ; unused, index doesn't exist
- - - - - - 0x00BB04 02:BAF4: 85 BD     .word _off004_BD85_61   ; unused, index doesn't exist
- - - - - - 0x00BB06 02:BAF6: 85 BD     .word _off004_BD85_62   ; unused, index doesn't exist
- - - - - - 0x00BB08 02:BAF8: 85 BD     .word _off004_BD85_63   ; unused, index doesn't exist
- - - - - - 0x00BB0A 02:BAFA: 85 BD     .word _off004_BD85_64   ; unused, index doesn't exist
...
; in
    ; A = 
C - - - - - 0x00BE0B 02:BDFB: 85 1B     STA ram_001B_t10
C - - - - - 0x00BE0D 02:BDFD: 8A        TXA
C - - - - - 0x00BE0E 02:BDFE: A8        TAY
C - - - - - 0x00BE0F 02:BDFF: A5 1B     LDA ram_001B_t10
...
C - - - - - 0x00BE19 02:BE09: A5 1B     LDA ram_001B_t10
; / 10
...
; in
    ; A = 
    ; Y = 
C - - - - - 0x00BE6E 02:BE5E: 85 04     STA ram_0004_t04
C - - - - - 0x00BE70 02:BE60: 84 05     STY ram_0005_t02_flags
...
C - - - - - 0x00BE78 02:BE68: 85 06     STA ram_0006_t02
C - - - - - 0x00BE7A 02:BE6A: A5 05     LDA ram_0005_t02_flags
C - - - - - 0x00BE7C 02:BE6C: 29 01     AND #$01
C - - - - - 0x00BE7E 02:BE6E: F0 08     BEQ bra_BE78
; / 10
C - - - - - 0x00BE80 02:BE70: 46 06     LSR ram_0006_t02
C - - - - - 0x00BE82 02:BE72: 46 06     LSR ram_0006_t02
C - - - - - 0x00BE84 02:BE74: 46 06     LSR ram_0006_t02
C - - - - - 0x00BE86 02:BE76: 46 06     LSR ram_0006_t02
bra_BE78:
C - - - - - 0x00BE88 02:BE78: A5 06     LDA ram_0006_t02
C - - - - - 0x00BE8A 02:BE7A: 29 0F     AND #$0F
C - - - - - 0x00BE8C 02:BE7C: 85 06     STA ram_0006_t03
C - - - - - 0x00BE8E 02:BE7E: 18        CLC
C - - - - - 0x00BE8F 02:BE7F: A5 06     LDA ram_0006_t03
C - - - - - 0x00BE91 02:BE81: 65 04     ADC ram_0004_t04
C - - - - - 0x00BE93 02:BE83: 85 04     STA ram_0004_t03_lo
C - - - - - 0x00BE95 02:BE85: C9 0A     CMP #$0A
C - - - - - 0x00BE97 02:BE87: 90 02     BCC bra_BE8B
C - - - - - 0x00BE99 02:BE89: E9 0A     SBC #$0A
bra_BE8B:
C - - - - - 0x00BE9B 02:BE8B: 85 06     STA ram_0006_t04
C - - - - - 0x00BE9D 02:BE8D: A5 05     LDA ram_0005_t02_flags
C - - - - - 0x00BE9F 02:BE8F: 29 01     AND #$01
C - - - - - 0x00BEA1 02:BE91: F0 15     BEQ bra_BEA8
; * 10
C - - - - - 0x00BEA3 02:BE93: 06 06     ASL ram_0006_t04
C - - - - - 0x00BEA5 02:BE95: 06 06     ASL ram_0006_t04
C - - - - - 0x00BEA7 02:BE97: 06 06     ASL ram_0006_t04
C - - - - - 0x00BEA9 02:BE99: 06 06     ASL ram_0006_t04
C - - - - - 0x00BEAB 02:BE9B: B9 86 04  LDA ram_score_player,Y
C - - - - - 0x00BEAE 02:BE9E: 29 0F     AND #$0F
C - - - - - 0x00BEB0 02:BEA0: 05 06     ORA ram_0006_t04
...
sub_BF00:
C - - - - - 0x00BF10 02:BF00: AD 22 04  LDA ram_mission_id_hi
C - - - - - 0x00BF13 02:BF03: C9 03     CMP #con_mission_Undersea_Base_pt1
C - - - - - 0x00BF15 02:BF05: D0 4F     BNE bra_BF56_RTS
C - - - - - 0x00BF17 02:BF07: A9 01     LDA #$01
C - - - - - 0x00BF19 02:BF09: 85 19     STA ram_0019_t08_obj_index
bra_BF0B_loop:
C - - - - - 0x00BF1B 02:BF0B: A9 03     LDA #$03
C - - - - - 0x00BF1D 02:BF0D: 85 1A     STA ram_001A_t02_loop_counter
C - - - - - 0x00BF1F 02:BF0F: A5 19     LDA ram_0019_t08_obj_index
C - - - - - 0x00BF21 02:BF11: 85 1B     STA ram_001B_t11_obj_index
C - - - - - 0x00BF23 02:BF13: 20 94 B3  JSR sub_B394
C - - - - - 0x00BF26 02:BF16: B0 3A     BCS bra_BF52
C - - - - - 0x00BF28 02:BF18: A9 00     LDA #$00
C - - - - - 0x00BF2A 02:BF1A: 85 1C     STA ram_001C_t06
C - - - - - 0x00BF2C 02:BF1C: 20 D8 B3  JSR sub_B3D8_hurtboxes_result
C - - - - - 0x00BF2F 02:BF1F: B0 31     BCS bra_BF52
bra_BF21_loop:
C - - - - - 0x00BF31 02:BF21: A6 1A     LDX ram_001A_t02_loop_counter
...
C - - - - - 0x00BF43 02:BF33: 85 13     STA ram_0013_t02
C - - - - - 0x00BF45 02:BF35: A9 40     LDA #$40
C - - - - - 0x00BF47 02:BF37: 38        SEC
C - - - - - 0x00BF48 02:BF38: E5 13     SBC ram_0013_t02
C - - - - - 0x00BF4A 02:BF3A: 85 11     STA ram_0011_t03
C - - - - - 0x00BF4C 02:BF3C: A9 00     LDA #$00
C - - - - - 0x00BF4E 02:BF3E: 85 12     STA ram_0012_tFF_useless_00
C - - - - - 0x00BF50 02:BF40: A4 1A     LDY ram_001A_t02_loop_counter
C - - - - - 0x00BF52 02:BF42: B9 57 BF  LDA tbl_BF57,Y
C - - - - - 0x00BF55 02:BF45: 85 0E     STA ram_0008_t02_array + $06
C - - - - - 0x00BF57 02:BF47: A9 02     LDA #$02
C - - - - - 0x00BF59 02:BF49: 85 0F     STA ram_000F_tFF_useless_02
C - - - - - 0x00BF5B 02:BF4B: 20 5B BF  JSR sub_BF5B
bra_BF4E:
C - - - - - 0x00BF5E 02:BF4E: C6 1A     DEC ram_001A_t02_loop_counter
C - - - - - 0x00BF60 02:BF50: 10 CF     BPL bra_BF21_loop
bra_BF52:
C - - - - - 0x00BF62 02:BF52: C6 19     DEC ram_0019_t08_obj_index
...
sub_BF5B:
; in
    ; ram_000F_tFF_useless_02
    ; ram_0019_t08_obj_index
C - - - - - 0x00BF6B 02:BF5B: A9 08     LDA #$08
C - - - - - 0x00BF6D 02:BF5D: 85 1B     STA ram_001B_t17
; bzk bug? value can be from ram_001D_t02_damage
C - - - - - 0x00BF6F 02:BF5F: A5 1D     LDA ram_001D_t05_array
C - - - - - 0x00BF71 02:BF61: 38        SEC
C - - - - - 0x00BF72 02:BF62: E5 0E     SBC ram_0008_t02_array + $06
C - - - - - 0x00BF74 02:BF64: 85 29     STA ram_0029_t36_lo
...
C - - - - - 0x00BF82 02:BF72: A5 29     LDA ram_0029_t36_lo
...
C - - - - - 0x00BFA9 02:BF99: A5 21     LDA ram_0021_t01_array
...
C - - - - - 0x00BFB1 02:BFA1: A5 22     LDA ram_0022_t01_array
C - - - - - 0x00BFB3 02:BFA3: 85 1B     STA ram_001B_t18
C - - - - - 0x00BFB5 02:BFA5: A5 29     LDA ram_0029_t37_lo
...
C - - - - - 0x00BFD8 02:BFC8: A4 19     LDY ram_0019_t08_obj_index
C - - - - - 0x00BFDA 02:BFCA: 99 43 00  STA a: ram_obj_state,Y
