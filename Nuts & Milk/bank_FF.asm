...
vec_C000_RESET:
; bzk optimize
C - - - - - 0x000010 00:C000: 4C 94 C0  JMP loc_C094_reset
...
sub_C026_write_A_to_2007:
; bzk optimize, this wastes a lot of cycles just for a single STA
...
C - - - - - 0x0000A9 00:C099: AA        TAX ; 00
bra_C09A_loop:
; 0000-00E7
C - - - - - 0x0000AA 00:C09A: 95 00     STA $00,X
...
bra_C0A4_loop:
C - - - - - 0x0000B4 00:C0A4: 20 B0 C0  JSR sub_C0B0_clear_0200_07FF
C - - - - - 0x0000B7 00:C0A7: 9D 00 05  STA $0500,X
...
sub_C0B0_clear_0200_07FF:
C - - - - - 0x0000C0 00:C0B0: 9D 00 02  STA $0200,X
C - - - - - 0x0000C3 00:C0B3: 9D 00 03  STA $0300,X
C - - - - - 0x0000C6 00:C0B6: 9D 00 04  STA $0400,X
C - - - - - 0x0000C9 00:C0B9: 9D 00 06  STA $0600,X
C - - - - - 0x0000CC 00:C0BC: 9D 00 07  STA $0700,X
C - - - - - 0x0000CF 00:C0BF: 60        RTS



vec_C0C0_NMI:
C - - - - - 0x0000D0 00:C0C0: 85 1C     STA ram_save_A
C - - - - - 0x0000D2 00:C0C2: 86 1D     STX ram_save_X
C - - - - - 0x0000D4 00:C0C4: 84 1E     STY ram_save_Y
...
C - - - - - 0x0000E2 00:C0D2: 85 26     STA ram_nmi_wait_flag
C - - - - - 0x0000E4 00:C0D4: A9 00     LDA #< ram_ppu_buffer
C - - - - - 0x0000E6 00:C0D6: 85 14     STA ram_0014_t01_ppu_buffer
C - - - - - 0x0000E8 00:C0D8: A9 02     LDA #> ram_ppu_buffer
C - - - - - 0x0000EA 00:C0DA: 85 15     STA ram_0014_t01_ppu_buffer + $01
C - - - - - 0x0000EC 00:C0DC: A0 00     LDY #$00
C - - - - - 0x0000EE 00:C0DE: B1 14     LDA (ram_0014_t01_ppu_buffer),Y
C - - - - - 0x0000F0 00:C0E0: F0 27     BEQ bra_C109_skip_writes_to_ppu
C - - - - - 0x0000F2 00:C0E2: A9 00     LDA #$00
C - - - - - 0x0000F4 00:C0E4: 91 14     STA (ram_0014_t01_ppu_buffer),Y
C - - - - - 0x0000F6 00:C0E6: C8        INY ; 01
loc_C0E7_loop:
C D 2 - - - 0x0000F7 00:C0E7: B1 14     LDA (ram_0014_t01_ppu_buffer),Y
...
bra_C0F5:
C - - - - - 0x000105 00:C0F5: 20 90 C1  JSR sub_C190_prepare_ppu_address
C - - - - - 0x000108 00:C0F8: AA        TAX
bra_C0F9_loop:
C - - - - - 0x000109 00:C0F9: B1 14     LDA (ram_0014_t01_ppu_buffer),Y
C - - - - - 0x00010B 00:C0FB: 20 26 C0  JSR sub_C026_write_A_to_2007
C - - - - - 0x00010E 00:C0FE: C8        INY
C - - - - - 0x00010F 00:C0FF: CA        DEX
C - - - - - 0x000110 00:C100: D0 F7     BNE bra_C0F9_loop
C - - - - - 0x000112 00:C102: 4C E7 C0  JMP loc_C0E7_loop
bra_C105:
loc_C105:
C - - - - - 0x000115 00:C105: A9 01     LDA #$01
C - - - - - 0x000117 00:C107: 85 27     STA ram_buffer_index
bra_C109_skip_writes_to_ppu:
...
C - - - - - 0x00014B 00:C13B: A5 CC     LDA ram_00CC_flag
C - - - - - 0x00014D 00:C13D: F0 3E     BEQ bra_C17D
C - - - - - 0x00014F 00:C13F: C9 02     CMP #$02
C - - - - - 0x000151 00:C141: F0 1A     BEQ bra_C15D
C - - - - - 0x000153 00:C143: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x000156 00:C146: AC 20 07  LDY ram_player_pos_Y
C - - - - - 0x000159 00:C149: C8        INY
C - - - - - 0x00015A 00:C14A: C8        INY
C - - - - - 0x00015B 00:C14B: 20 FC DF  JSR sub_DFFC_write_player_position
...
C - - - - - 0x000168 00:C158: E6 CC     INC ram_00CC_flag
C - - - - - 0x00016A 00:C15A: 4C 73 C1  JMP loc_C173
bra_C15D:
C - - - - - 0x00016D 00:C15D: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x000170 00:C160: AC 20 07  LDY ram_player_pos_Y
C - - - - - 0x000173 00:C163: 88        DEY
C - - - - - 0x000174 00:C164: 20 FC DF  JSR sub_DFFC_write_player_position
...
C - - - - - 0x000181 00:C171: 85 CC     STA ram_00CC_flag
bra_C173:
loc_C173:
...
bra_C17D:
C - - - - - 0x00018D 00:C17D: 20 A7 F1  JSR sub_F1A7_sound_engine_1
C - - - - - 0x000190 00:C180: 20 F2 F1  JSR sub_F1F2_sound_engine_2
C - - - - - 0x000193 00:C183: 20 3D F2  JSR sub_F23D_sound_engine_3
C - - - - - 0x000196 00:C186: 20 A4 F2  JSR sub_F2A4_sound_engine_4
C - - - - - 0x000199 00:C189: A5 1C     LDA ram_save_A
C - - - - - 0x00019B 00:C18B: A6 1D     LDX ram_save_X
C - - - - - 0x00019D 00:C18D: A4 1E     LDY ram_save_Y
C - - - - - 0x00019F 00:C18F: 40        RTI



sub_C190_prepare_ppu_address:
C - - - - - 0x0001A0 00:C190: 8A        TXA
C - - - - - 0x0001A1 00:C191: 29 3F     AND #$3F
C - - - - - 0x0001A3 00:C193: 85 1F     STA ram_001F_t01
C - - - - - 0x0001A5 00:C195: C8        INY
C - - - - - 0x0001A6 00:C196: B1 14     LDA (ram_0014_t01_ppu_buffer),Y
C - - - - - 0x0001A8 00:C198: 48        PHA
C - - - - - 0x0001A9 00:C199: C8        INY
C - - - - - 0x0001AA 00:C19A: B1 14     LDA (ram_0014_t01_ppu_buffer),Y
...
C - - - - - 0x0001B5 00:C1A5: 20 83 EF  JSR sub_EF83_set_scroll_00FF
C - - - - - 0x0001B8 00:C1A8: A5 1F     LDA ram_001F_t01
...
C - - - - - 0x0001C5 00:C1B5: 85 27     STA ram_buffer_index
C - - - - - 0x0001C7 00:C1B7: A9 00     LDA #$00
C - - - - - 0x0001C9 00:C1B9: 8D 00 02  STA ram_ppu_buffer
C - - - - - 0x0001CC 00:C1BC: 20 AA EF  JSR sub_EFAA_hide_all_sprites
...
bra_C1CB_loop:
C - - - - - 0x0001DB 00:C1CB: BD 00 06  LDA ram_0600_round_data,X
C - - - - - 0x0001DE 00:C1CE: 9D 00 05  STA ram_0500_round_data,X
C - - - - - 0x0001E1 00:C1D1: E8        INX
C - - - - - 0x0001E2 00:C1D2: D0 F7     BNE bra_C1CB_loop
C - - - - - 0x0001E4 00:C1D4: A9 00     LDA #$00
C - - - - - 0x0001E6 00:C1D6: 85 BA     STA ram_top_score_lo
C - - - - - 0x0001E8 00:C1D8: 85 BB     STA ram_top_score_hi
; bzk optimize, loading same A
C - - - - - 0x0001EA 00:C1DA: A9 00     LDA #$00
C - - - - - 0x0001EC 00:C1DC: 85 B8     STA ram_score_lo_p1
C - - - - - 0x0001EE 00:C1DE: 85 B9     STA ram_score_hi_p1
C - - - - - 0x0001F0 00:C1E0: 85 BC     STA ram_score_lo_p2
C - - - - - 0x0001F2 00:C1E2: 85 BD     STA ram_score_hi_p2
C - - - - - 0x0001F4 00:C1E4: A9 03     LDA #$03
C - - - - - 0x0001F6 00:C1E6: 85 EB     STA ram_demo_counter
C - - - - - 0x0001F8 00:C1E8: A9 80     LDA #$80
C - - - - - 0x0001FA 00:C1EA: 85 2F     STA ram_cursor_pos_Y
; bzk optimize, useless JMP
C - - - - - 0x0001FC 00:C1EC: 4C EF C1  JMP loc_C1EF_restart_game



loc_C1EF_restart_game:
...
C - - - - - 0x000209 00:C1F9: AA        TAX ; 00
bra_C1FA_loop:
; 0000-002E
C - - - - - 0x00020A 00:C1FA: 95 00     STA $00,X
...
bra_C20F_loop:
; 00BE-00E7
C - - - - - 0x00021F 00:C20F: 95 00     STA $00,X
...
C - - - - - 0x000228 00:C218: AA        TAX ; 00
bra_C219_loop:
C - - - - - 0x000229 00:C219: 20 B0 C0  JSR sub_C0B0_clear_0200_07FF
C - - - - - 0x00022C 00:C21C: E8        INX
C - - - - - 0x00022D 00:C21D: D0 FA     BNE bra_C219_loop
C - - - - - 0x00022F 00:C21F: A9 01     LDA #$01
C - - - - - 0x000231 00:C221: 85 27     STA ram_buffer_index
C - - - - - 0x000233 00:C223: A9 00     LDA #$00
C - - - - - 0x000235 00:C225: 8D 00 02  STA ram_ppu_buffer
C - - - - - 0x000238 00:C228: 20 AA EF  JSR sub_EFAA_hide_all_sprites
C - - - - - 0x00023B 00:C22B: A5 EB     LDA ram_demo_counter
C - - - - - 0x00023D 00:C22D: 18        CLC
C - - - - - 0x00023E 00:C22E: 69 01     ADC #$01
C - - - - - 0x000240 00:C230: 29 03     AND #$03
C - - - - - 0x000242 00:C232: 85 EB     STA ram_demo_counter
C - - - - - 0x000244 00:C234: A9 00     LDA #$00
C - - - - - 0x000246 00:C236: 85 E8     STA ram_00E8_game_mode
C - - - - - 0x000248 00:C238: 85 E9     STA ram_00E9_game_mode
C - - - - - 0x00024A 00:C23A: 20 73 EC  JSR sub_EC73
C - - - - - 0x00024D 00:C23D: A9 01     LDA #$01
C - - - - - 0x00024F 00:C23F: A6 A7     LDX ram_sound_channel_4_flag
C - - - - - 0x000251 00:C241: F0 02     BEQ bra_C245
C - - - - - 0x000253 00:C243: A9 0A     LDA #$0A
bra_C245:
C - - - - - 0x000255 00:C245: 85 C4     STA ram_round_p1
C - - - - - 0x000257 00:C247: 85 C5     STA ram_round_p2
C - - - - - 0x000259 00:C249: 85 20     STA ram_current_round
C - - - - - 0x00025B 00:C24B: A9 02     LDA #$02
C - - - - - 0x00025D 00:C24D: 85 BE     STA ram_milk_p1
C - - - - - 0x00025F 00:C24F: 85 BF     STA ram_milk_p2
C - - - - - 0x000261 00:C251: 85 22     STA ram_milk_current_player
C - - - - - 0x000263 00:C253: A9 01     LDA #$01
C - - - - - 0x000265 00:C255: 85 E5     STA ram_00E5
C - - - - - 0x000267 00:C257: A9 00     LDA #$00
C - - - - - 0x000269 00:C259: 85 E2     STA ram_game_over_flag
C - - - - - 0x00026B 00:C25B: 85 CE     STA ram_copy_bonus_round_id
C - - - - - 0x00026D 00:C25D: 85 CF     STA ram_round_skip_flag
C - - - - - 0x00026F 00:C25F: 4C 0C C3  JMP loc_C30C



sub_C262_check_for_bonus_round:
C - - - - - 0x000272 00:C262: A6 20     LDX ram_current_round
C - - - - - 0x000274 00:C264: CA        DEX
C - - - - - 0x000275 00:C265: BD 92 C4  LDA tbl_C492_bonus_rounds,X
...
C - - - - - 0x00028F 00:C27F: 85 26     STA ram_nmi_wait_flag
C - - - - - 0x000291 00:C281: 85 E5     STA ram_00E5
bra_C283_infinite_loop:
C - - - - - 0x000293 00:C283: A5 26     LDA ram_nmi_wait_flag
C - - - - - 0x000295 00:C285: D0 FC     BNE bra_C283_infinite_loop
C - - - - - 0x000297 00:C287: 20 B5 C6  JSR sub_C6B5_add_bonus_points_to_score
C - - - - - 0x00029A 00:C28A: A9 00     LDA #$00    ; not bonus round
C - - - - - 0x00029C 00:C28C: 85 8F     STA ram_bonus_round_id
C - - - - - 0x00029E 00:C28E: 20 69 C2  JSR sub_C269
C - - - - - 0x0002A1 00:C291: 20 21 CD  JSR sub_CD21
C - - - - - 0x0002A4 00:C294: 20 62 C2  JSR sub_C262_check_for_bonus_round
C - - - - - 0x0002A7 00:C297: D0 29     BNE bra_C2C2_bonus_round
; if not bonus round
C - - - - - 0x0002A9 00:C299: 20 AF CC  JSR sub_CCAF
C - - - - - 0x0002AC 00:C29C: 20 08 EC  JSR sub_EC08
C - - - - - 0x0002AF 00:C29F: A9 20     LDA #con_obj_index_20
C - - - - - 0x0002B1 00:C2A1: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
C - - - - - 0x0002B4 00:C2A4: A9 80     LDA #con_obj_index_80
C - - - - - 0x0002B6 00:C2A6: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
C - - - - - 0x0002B9 00:C2A9: 20 79 CE  JSR sub_CE79
C - - - - - 0x0002BC 00:C2AC: A0 40     LDY #con_obj_index_40
...
bra_C2C2_bonus_round:
loc_C2C2_bonus_round:
C D 2 - - - 0x0002D2 00:C2C2: A9 0C     LDA #$0C
C - - - - - 0x0002D4 00:C2C4: 20 0C C6  JSR sub_C60C_long_wait
bra_C2C7_infinite_loop:
C - - - - - 0x0002D7 00:C2C7: A5 34     LDA ram_sound_channel_1_flag
C - - - - - 0x0002D9 00:C2C9: D0 FC     BNE bra_C2C7_infinite_loop
loc_C2CB_load_next_round:
C D 2 - - - 0x0002DB 00:C2CB: 20 AA EF  JSR sub_EFAA_hide_all_sprites
C - - - - - 0x0002DE 00:C2CE: A5 E1     LDA ram_00E1_current_player
C - - - - - 0x0002E0 00:C2D0: F0 1B     BEQ bra_C2ED
C - - - - - 0x0002E2 00:C2D2: A6 C5     LDX ram_round_p2
...
- - - - - - 0x0002EF 00:C2DF: 85 E9     STA ram_00E9_game_mode
bra_C2E1:
C - - - - - 0x0002F1 00:C2E1: E8        INX
C - - - - - 0x0002F2 00:C2E2: 86 C5     STX ram_round_p2
C - - - - - 0x0002F4 00:C2E4: 86 20     STX ram_current_round
C - - - - - 0x0002F6 00:C2E6: A5 BF     LDA ram_milk_p2
C - - - - - 0x0002F8 00:C2E8: 85 22     STA ram_milk_current_player
C - - - - - 0x0002FA 00:C2EA: 4C 49 C3  JMP loc_C349
bra_C2ED:
C - - - - - 0x0002FD 00:C2ED: A6 C4     LDX ram_round_p1
...
C - - - - - 0x00030A 00:C2FA: 85 E8     STA ram_00E8_game_mode
bra_C2FC:
C - - - - - 0x00030C 00:C2FC: E8        INX
C - - - - - 0x00030D 00:C2FD: 86 C4     STX ram_round_p1
C - - - - - 0x00030F 00:C2FF: 86 20     STX ram_current_round
C - - - - - 0x000311 00:C301: A5 BE     LDA ram_milk_p1
C - - - - - 0x000313 00:C303: 85 22     STA ram_milk_current_player
C - - - - - 0x000315 00:C305: 4C 49 C3  JMP loc_C349



loc_C308_not_bonus_round:
...
C - - - - - 0x00031F 00:C30F: 20 AA EF  JSR sub_EFAA_hide_all_sprites
C - - - - - 0x000322 00:C312: A5 E0     LDA ram_players_counter
C - - - - - 0x000324 00:C314: F0 2B     BEQ bra_C341
C - - - - - 0x000326 00:C316: A5 E1     LDA ram_00E1_current_player
C - - - - - 0x000328 00:C318: F0 11     BEQ bra_C32B
C - - - - - 0x00032A 00:C31A: A5 BF     LDA ram_milk_p2
C - - - - - 0x00032C 00:C31C: 30 11     BMI bra_C32F
bra_C31E:
C - - - - - 0x00032E 00:C31E: A5 BF     LDA ram_milk_p2
C - - - - - 0x000330 00:C320: 85 22     STA ram_milk_current_player
C - - - - - 0x000332 00:C322: A5 C5     LDA ram_round_p2
C - - - - - 0x000334 00:C324: 85 20     STA ram_current_round
C - - - - - 0x000336 00:C326: A9 01     LDA #$01
C - - - - - 0x000338 00:C328: 4C 39 C3  JMP loc_C339
bra_C32B:
C - - - - - 0x00033B 00:C32B: A5 BE     LDA ram_milk_p1
C - - - - - 0x00033D 00:C32D: 30 EF     BMI bra_C31E
bra_C32F:
C - - - - - 0x00033F 00:C32F: A5 BE     LDA ram_milk_p1
C - - - - - 0x000341 00:C331: 85 22     STA ram_milk_current_player
C - - - - - 0x000343 00:C333: A5 C4     LDA ram_round_p1
C - - - - - 0x000345 00:C335: 85 20     STA ram_current_round
C - - - - - 0x000347 00:C337: A9 00     LDA #$00
loc_C339:
C D 2 - - - 0x000349 00:C339: 85 E1     STA ram_00E1_current_player
C - - - - - 0x00034B 00:C33B: 20 38 C4  JSR sub_C438
C - - - - - 0x00034E 00:C33E: 4C 49 C3  JMP loc_C349
bra_C341:
C - - - - - 0x000351 00:C341: A5 BE     LDA ram_milk_p1
C - - - - - 0x000353 00:C343: 85 22     STA ram_milk_current_player
C - - - - - 0x000355 00:C345: A5 C4     LDA ram_round_p1
...
C - - - - - 0x000362 00:C352: CA        DEX ; 04
bra_C353:
C - - - - - 0x000363 00:C353: BD 8C C4  LDA tbl_C48C_bonus_points,X
C - - - - - 0x000366 00:C356: 85 21     STA ram_bonus_points
C - - - - - 0x000368 00:C358: A9 00     LDA #$00
C - - - - - 0x00036A 00:C35A: 85 E3     STA ram_00E3
C - - - - - 0x00036C 00:C35C: 85 CC     STA ram_00CC_flag
C - - - - - 0x00036E 00:C35E: 20 10 C4  JSR sub_C410_try_to_display_bonus_round_message
C - - - - - 0x000371 00:C361: 20 4D EF  JSR sub_EF4D_clear_nametable
C - - - - - 0x000374 00:C364: A9 01     LDA #$01
C - - - - - 0x000376 00:C366: 20 0C C6  JSR sub_C60C_long_wait
C - - - - - 0x000379 00:C369: 20 62 C2  JSR sub_C262_check_for_bonus_round
C - - - - - 0x00037C 00:C36C: 85 8F     STA ram_bonus_round_id
C - - - - - 0x00037E 00:C36E: 20 75 E9  JSR sub_E975
C - - - - - 0x000381 00:C371: 20 CD E3  JSR sub_E3CD
C - - - - - 0x000384 00:C374: A5 0F     LDA ram_000F_t03_error_flag
...
- - - - - - 0x00038B 00:C37B: 20 AA EF  JSR sub_EFAA_hide_all_sprites
- - - - - - 0x00038E 00:C37E: 20 6C EF  JSR sub_EF6C
- - - - - - 0x000391 00:C381: A9 00     LDA #< tbl_C400_txt___round_error
- - - - - - 0x000393 00:C383: 85 00     STA ram_0000_t02_ppu_data
- - - - - - 0x000395 00:C385: A9 C4     LDA #> tbl_C400_txt___round_error
- - - - - - 0x000397 00:C387: 85 01     STA ram_0000_t02_ppu_data + $01
- - - - - - 0x000399 00:C389: 20 28 EC  JSR sub_EC28_print_tiles_on_black_background
- - - - - - 0x00039C 00:C38C: 20 76 EF  JSR sub_EF76
- - - - - - 0x00039F 00:C38F: A9 14     LDA #$14
- - - - - - 0x0003A1 00:C391: 20 0C C6  JSR sub_C60C_long_wait
- - - - - - 0x0003A4 00:C394: 4C EF C1  JMP loc_C1EF_restart_game
bra_C397_no_error:
...
C - - - - - 0x0003C2 00:C3B2: A5 A7     LDA ram_sound_channel_4_flag
C - - - - - 0x0003C4 00:C3B4: D0 16     BNE bra_C3CC
C - - - - - 0x0003C6 00:C3B6: A5 E5     LDA ram_00E5
C - - - - - 0x0003C8 00:C3B8: F0 06     BEQ bra_C3C0
C - - - - - 0x0003CA 00:C3BA: A5 8F     LDA ram_bonus_round_id
C - - - - - 0x0003CC 00:C3BC: D0 13     BNE bra_C3D1_bonus_round
C - - - - - 0x0003CE 00:C3BE: F0 04     BEQ bra_C3C4_not_bonus_round    ; jmp
bra_C3C0:
C - - - - - 0x0003D0 00:C3C0: A5 CE     LDA ram_copy_bonus_round_id
C - - - - - 0x0003D2 00:C3C2: F0 08     BEQ bra_C3CC
bra_C3C4_not_bonus_round:
C - - - - - 0x0003D4 00:C3C4: 20 63 F1  JSR sub_F163_play_music___new_round
C - - - - - 0x0003D7 00:C3C7: A9 08     LDA #$08
C - - - - - 0x0003D9 00:C3C9: 20 0C C6  JSR sub_C60C_long_wait
bra_C3CC:
C - - - - - 0x0003DC 00:C3CC: A9 02     LDA #$02
C - - - - - 0x0003DE 00:C3CE: 20 0C C6  JSR sub_C60C_long_wait
bra_C3D1_bonus_round:
C - - - - - 0x0003E1 00:C3D1: A9 86     LDA #$86
C - - - - - 0x0003E3 00:C3D3: 20 E8 DF  JSR sub_DFE8_write_player_animation
C - - - - - 0x0003E6 00:C3D6: A9 02     LDA #$02
C - - - - - 0x0003E8 00:C3D8: 20 0C C6  JSR sub_C60C_long_wait
C - - - - - 0x0003EB 00:C3DB: A5 8F     LDA ram_bonus_round_id
C - - - - - 0x0003ED 00:C3DD: 85 CE     STA ram_copy_bonus_round_id
C - - - - - 0x0003EF 00:C3DF: A9 01     LDA #$01
C - - - - - 0x0003F1 00:C3E1: 85 24     STA ram_btn_AB_flag
C - - - - - 0x0003F3 00:C3E3: A9 00     LDA #$00
C - - - - - 0x0003F5 00:C3E5: 85 E5     STA ram_00E5
C - - - - - 0x0003F7 00:C3E7: 85 3F     STA ram_003F_se_flag
C - - - - - 0x0003F9 00:C3E9: A5 A7     LDA ram_sound_channel_4_flag
C - - - - - 0x0003FB 00:C3EB: D0 10     BNE bra_C3FD
C - - - - - 0x0003FD 00:C3ED: 20 DC F2  JSR sub_F2DC
C - - - - - 0x000400 00:C3F0: A5 8F     LDA ram_bonus_round_id
C - - - - - 0x000402 00:C3F2: D0 06     BNE bra_C3FA_bonus_round
; if not bonus round
C - - - - - 0x000404 00:C3F4: 20 1B F0  JSR sub_F01B_play_music___soundtrack
C - - - - - 0x000407 00:C3F7: 4C C4 C4  JMP loc_C4C4
bra_C3FA_bonus_round:
C - - - - - 0x00040A 00:C3FA: 20 39 F0  JSR sub_F039_play_music___bonus_round_soundtrack
bra_C3FD:
...
- - - - - - 0x000410 00:C400: AA 21     .word $21AA ; ppu address
...
sub_C410_try_to_display_bonus_round_message:
C - - - - - 0x000420 00:C410: 20 62 C2  JSR sub_C262_check_for_bonus_round
C - - - - - 0x000423 00:C413: F0 22     BEQ bra_C437_RTS
; if bonus round
C - - - - - 0x000425 00:C415: 20 4D EF  JSR sub_EF4D_clear_nametable
C - - - - - 0x000428 00:C418: 20 AA EF  JSR sub_EFAA_hide_all_sprites
C - - - - - 0x00042B 00:C41B: 20 6C EF  JSR sub_EF6C
C - - - - - 0x00042E 00:C41E: A9 7B     LDA #< tbl_C47B_txt___bonus_round
C - - - - - 0x000430 00:C420: 85 00     STA ram_0000_t02_ppu_data
C - - - - - 0x000432 00:C422: A9 C4     LDA #> tbl_C47B_txt___bonus_round
C - - - - - 0x000434 00:C424: 85 01     STA ram_0000_t02_ppu_data + $01
C - - - - - 0x000436 00:C426: 20 28 EC  JSR sub_EC28_print_tiles_on_black_background
C - - - - - 0x000439 00:C429: 20 76 EF  JSR sub_EF76
C - - - - - 0x00043C 00:C42C: 20 D4 F2  JSR sub_F2D4
C - - - - - 0x00043F 00:C42F: 20 04 F0  JSR sub_F004_play_music___bonus_round_announcement
C - - - - - 0x000442 00:C432: A9 07     LDA #$07
C - - - - - 0x000444 00:C434: 20 0C C6  JSR sub_C60C_long_wait
bra_C437_RTS:
...
C - - - - - 0x00044B 00:C43B: 20 AA EF  JSR sub_EFAA_hide_all_sprites
C - - - - - 0x00044E 00:C43E: 20 6C EF  JSR sub_EF6C
C - - - - - 0x000451 00:C441: A9 61     LDA #< tbl_C461_txt___player_I
C - - - - - 0x000453 00:C443: 85 00     STA ram_0000_t02_ppu_data
C - - - - - 0x000455 00:C445: A9 C4     LDA #> tbl_C461_txt___player_I
C - - - - - 0x000457 00:C447: 85 01     STA ram_0000_t02_ppu_data + $01
C - - - - - 0x000459 00:C449: A5 E1     LDA ram_00E1_current_player
C - - - - - 0x00045B 00:C44B: F0 08     BEQ bra_C455
C - - - - - 0x00045D 00:C44D: A9 6E     LDA #< tbl_C46E_txt___player_II
C - - - - - 0x00045F 00:C44F: 85 00     STA ram_0000_t02_ppu_data
C - - - - - 0x000461 00:C451: A9 C4     LDA #> tbl_C46E_txt___player_II
C - - - - - 0x000463 00:C453: 85 01     STA ram_0000_t02_ppu_data + $01
bra_C455:
C - - - - - 0x000465 00:C455: 20 28 EC  JSR sub_EC28_print_tiles_on_black_background
C - - - - - 0x000468 00:C458: 20 76 EF  JSR sub_EF76
C - - - - - 0x00046B 00:C45B: A9 08     LDA #$08
C - - - - - 0x00046D 00:C45D: 20 0C C6  JSR sub_C60C_long_wait
C - - - - - 0x000470 00:C460: 60        RTS



tbl_C461_txt___player_I:
- D 2 - I - 0x000471 00:C461: AC 21     .word $21AC ; ppu address
...
- D 2 - I - 0x00047E 00:C46E: AC 21     .word $21AC ; ppu address
...
- D 2 - I - 0x00048B 00:C47B: AA 21     .word $21AA ; ppu address
...
tbl_C48C_bonus_points:
- D 2 - - - 0x00049C 00:C48C: 28        .byte $28   ; 00 4000
- D 2 - - - 0x00049D 00:C48D: 32        .byte $32   ; 01 5000
- D 2 - - - 0x00049E 00:C48E: 3C        .byte $3C   ; 02 6000
- D 2 - - - 0x00049F 00:C48F: 46        .byte $46   ; 03 7000
- D 2 - - - 0x0004A0 00:C490: 50        .byte $50   ; 04 8000
- D 2 - - - 0x0004A1 00:C491: 5A        .byte $5A   ; 05 9000



tbl_C492_bonus_rounds:
; non-zero values are bonus rounds
- D 2 - - - 0x0004A2 00:C492: 00        .byte $00   ; 01 1
- D 2 - - - 0x0004A3 00:C493: 00        .byte $00   ; 02 2
- D 2 - - - 0x0004A4 00:C494: 01        .byte $01   ; 03 3+
- D 2 - - - 0x0004A5 00:C495: 00        .byte $00   ; 04 4
- D 2 - - - 0x0004A6 00:C496: 00        .byte $00   ; 05 5
- D 2 - - - 0x0004A7 00:C497: 00        .byte $00   ; 06 6
- D 2 - - - 0x0004A8 00:C498: 00        .byte $00   ; 07 7
- D 2 - - - 0x0004A9 00:C499: 02        .byte $02   ; 08 8+
- D 2 - - - 0x0004AA 00:C49A: 00        .byte $00   ; 09 9
- D 2 - - - 0x0004AB 00:C49B: 00        .byte $00   ; 0A 10
- D 2 - - - 0x0004AC 00:C49C: 00        .byte $00   ; 0B 11
- D 2 - - - 0x0004AD 00:C49D: 00        .byte $00   ; 0C 12
- D 2 - - - 0x0004AE 00:C49E: 03        .byte $03   ; 0D 13+
- D 2 - - - 0x0004AF 00:C49F: 00        .byte $00   ; 0E 14
- D 2 - - - 0x0004B0 00:C4A0: 00        .byte $00   ; 0F 15
- D 2 - - - 0x0004B1 00:C4A1: 00        .byte $00   ; 10 16
- D 2 - - - 0x0004B2 00:C4A2: 00        .byte $00   ; 11 17
- D 2 - - - 0x0004B3 00:C4A3: 04        .byte $04   ; 12 18+
- D 2 - - - 0x0004B4 00:C4A4: 00        .byte $00   ; 13 19
- D 2 - - - 0x0004B5 00:C4A5: 00        .byte $00   ; 14 20
- D 2 - - - 0x0004B6 00:C4A6: 00        .byte $00   ; 15 21
- D 2 - - - 0x0004B7 00:C4A7: 00        .byte $00   ; 16 22
- D 2 - - - 0x0004B8 00:C4A8: 04        .byte $04   ; 17 23+
- D 2 - - - 0x0004B9 00:C4A9: 00        .byte $00   ; 18 24
- D 2 - - - 0x0004BA 00:C4AA: 00        .byte $00   ; 19 25
- D 2 - - - 0x0004BB 00:C4AB: 00        .byte $00   ; 1A 26
- D 2 - - - 0x0004BC 00:C4AC: 00        .byte $00   ; 1B 27
- D 2 - - - 0x0004BD 00:C4AD: 04        .byte $04   ; 1C 28+
- D 2 - - - 0x0004BE 00:C4AE: 00        .byte $00   ; 1D 29
- D 2 - - - 0x0004BF 00:C4AF: 00        .byte $00   ; 1E 30
- D 2 - - - 0x0004C0 00:C4B0: 00        .byte $00   ; 1F 31
- D 2 - - - 0x0004C1 00:C4B1: 00        .byte $00   ; 20 32
- D 2 - - - 0x0004C2 00:C4B2: 04        .byte $04   ; 21 33+
- D 2 - - - 0x0004C3 00:C4B3: 00        .byte $00   ; 22 34
- D 2 - - - 0x0004C4 00:C4B4: 00        .byte $00   ; 23 35
- D 2 - - - 0x0004C5 00:C4B5: 00        .byte $00   ; 24 36
- D 2 - - - 0x0004C6 00:C4B6: 00        .byte $00   ; 25 37
- D 2 - - - 0x0004C7 00:C4B7: 04        .byte $04   ; 26 38+
- D 2 - - - 0x0004C8 00:C4B8: 00        .byte $00   ; 27 39
- D 2 - - - 0x0004C9 00:C4B9: 00        .byte $00   ; 28 40
- D 2 - - - 0x0004CA 00:C4BA: 00        .byte $00   ; 29 41
- D 2 - - - 0x0004CB 00:C4BB: 00        .byte $00   ; 2A 42
- D 2 - - - 0x0004CC 00:C4BC: 04        .byte $04   ; 2B 43+
- D 2 - - - 0x0004CD 00:C4BD: 00        .byte $00   ; 2C 44
- D 2 - - - 0x0004CE 00:C4BE: 00        .byte $00   ; 2D 45
- D 2 - - - 0x0004CF 00:C4BF: 00        .byte $00   ; 2E 46
- D 2 - - - 0x0004D0 00:C4C0: 00        .byte $00   ; 2F 47
- D 2 - - - 0x0004D1 00:C4C1: 04        .byte $04   ; 30 48+
- D 2 - - - 0x0004D2 00:C4C2: 00        .byte $00   ; 31 49
- D 2 - - - 0x0004D3 00:C4C3: 00        .byte $00   ; 32 50
...
C - - - - - 0x0004D9 00:C4C9: 85 26     STA ram_nmi_wait_flag
C - - - - - 0x0004DB 00:C4CB: A5 A7     LDA ram_sound_channel_4_flag
...
C - - - - - 0x0004E5 00:C4D5: A5 E1     LDA ram_00E1_current_player
...
C - - - - - 0x0004F3 00:C4E3: 85 24     STA ram_btn_AB_flag
; bzk optimize, BEQ
...
C - - - - - 0x000500 00:C4F0: 85 24     STA ram_btn_AB_flag
; bzk optimize, BEQ
C - - - - - 0x000502 00:C4F2: 4C FB C4  JMP loc_C4FB
bra_C4F5:
C - - - - - 0x000505 00:C4F5: A9 00     LDA #$00
C - - - - - 0x000507 00:C4F7: 85 24     STA ram_btn_AB_flag
C - - - - - 0x000509 00:C4F9: 85 25     STA ram_0025_useless
bra_C4FB:
loc_C4FB:
...
C - - - - - 0x00052F 00:C51F: A5 26     LDA ram_nmi_wait_flag
...
bra_C52D:
C - - - - - 0x00053D 00:C52D: 20 8C C6  JSR sub_C68C_useless_code
C - - - - - 0x000540 00:C530: 20 49 C5  JSR sub_C549
C - - - - - 0x000543 00:C533: A5 A7     LDA ram_sound_channel_4_flag
...
bra_C543:
C - - - - - 0x000553 00:C543: 4C EF C1  JMP loc_C1EF_restart_game
bra_C546:
...
sub_C549:
C - - - - - 0x000559 00:C549: A5 A7     LDA ram_sound_channel_4_flag
C - - - - - 0x00055B 00:C54B: D0 12     BNE bra_C55F_RTS
C - - - - - 0x00055D 00:C54D: A5 34     LDA ram_sound_channel_1_flag
C - - - - - 0x00055F 00:C54F: 05 38     ORA ram_sound_channel_2_flag
...
C - - - - - 0x000581 00:C571: 85 CF     STA ram_round_skip_flag
C - - - - - 0x000583 00:C573: 4C CB C2  JMP loc_C2CB_load_next_round
bra_C576:
- - - - - - 0x000586 00:C576: 4C 52 DB  JMP loc_DB52
bra_C579:
C - - - - - 0x000589 00:C579: A5 24     LDA ram_btn_AB_flag
...
C - - - - - 0x000595 00:C585: 20 8D F0  JSR sub_F08D_play_sound___pause
C - - - - - 0x000598 00:C588: A2 00     LDX #$00
bra_C58A_loop:
C - - - - - 0x00059A 00:C58A: BD 00 07  LDA ram_oam,X
C - - - - - 0x00059D 00:C58D: 9D 00 04  STA ram_full_copy_oam,X
C - - - - - 0x0005A0 00:C590: E8        INX
C - - - - - 0x0005A1 00:C591: D0 F7     BNE bra_C58A_loop
; hide all sprites
; bzk optimize, use 0x002FBA subroutine instead
...
bra_C5AB_loop:
C - - - - - 0x0005BB 00:C5AB: BD 00 04  LDA ram_full_copy_oam,X
...
bra_C5C6:
C - - - - - 0x0005D6 00:C5C6: 20 8D F0  JSR sub_F08D_play_sound___pause
C - - - - - 0x0005D9 00:C5C9: A9 05     LDA #$05
C - - - - - 0x0005DB 00:C5CB: 20 0C C6  JSR sub_C60C_long_wait
...
- - - - - - 0x000609 00:C5F9: 20 26 C0  JSR sub_C026_write_A_to_2007
...
- - - - - - 0x000616 00:C606: 20 0C C6  JSR sub_C60C_long_wait
- - - - - - 0x000619 00:C609: 4C CB C2  JMP loc_C2CB_load_next_round
...
bra_C60E_loop:
C - - - - - 0x00061E 00:C60E: 20 17 C6  JSR sub_C617_wait_11_frms
...
sub_C620:
C - - - - - 0x000630 00:C620: A5 A7     LDA ram_sound_channel_4_flag
...
bra_C641:
C - - - - - 0x000651 00:C641: A5 A8     LDA ram_house_flag
; bzk optimize, there is no 02 in this address
C - - - - - 0x000653 00:C643: C9 02     CMP #$02
C - - - - - 0x000655 00:C645: F0 42     BEQ bra_C689
C - - - - - 0x000657 00:C647: A5 E0     LDA ram_players_counter
...
bra_C652:
C - - - - - 0x000662 00:C652: A5 E1     LDA ram_00E1_current_player
...
loc_C65D:
C D 2 - - - 0x00066D 00:C65D: 85 EA     STA ram_00EA_t01
C - - - - - 0x00066F 00:C65F: 29 40     AND #con_btn_B
C - - - - - 0x000671 00:C661: 0A        ASL
C - - - - - 0x000672 00:C662: 05 EA     ORA ram_00EA_t01
...
C - - - - - 0x000679 00:C669: AD 20 07  LDA ram_player_pos_Y
C - - - - - 0x00067C 00:C66C: 29 0F     AND #$0F
C - - - - - 0x00067E 00:C66E: D0 0B     BNE bra_C67B
C - - - - - 0x000680 00:C670: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x000683 00:C673: AC 20 07  LDY ram_player_pos_Y
...
C - - - - - 0x0006A2 00:C692: A5 23     LDA ram_0023_useless
C - - - - - 0x0006A4 00:C694: 18        CLC
C - - - - - 0x0006A5 00:C695: 69 03     ADC #$03
C - - - - - 0x0006A7 00:C697: 85 23     STA ram_0023_useless
bra_C699_nothing_pressed:
C - - - - - 0x0006A9 00:C699: E6 23     INC ram_0023_useless
C - - - - - 0x0006AB 00:C69B: 60        RTS



sub_C69C_add_100_points:
C - - - - - 0x0006AC 00:C69C: A9 01     LDA #$01
C - - - - - 0x0006AE 00:C69E: 4C BA C6  JMP loc_C6BA_add_score    ; bzk optimize, BNE


; bzk garbage
- - - - - - 0x0006B1 00:C6A1: A9 02     LDA #$02
- - - - - - 0x0006B3 00:C6A3: 4C BA C6  JMP loc_C6BA_add_score



sub_C6A6_add_500_points:
C - - - - - 0x0006B6 00:C6A6: A9 05     LDA #$05
C - - - - - 0x0006B8 00:C6A8: 4C BA C6  JMP loc_C6BA_add_score    ; bzk optimize, BNE



sub_C6AB_add_800_points:
C - - - - - 0x0006BB 00:C6AB: A9 08     LDA #$08
C - - - - - 0x0006BD 00:C6AD: 4C BA C6  JMP loc_C6BA_add_score    ; bzk optimize, BNE


; bzk garbage
- - - - - - 0x0006C0 00:C6B0: A9 10     LDA #$10
- - - - - - 0x0006C2 00:C6B2: 4C BA C6  JMP loc_C6BA_add_score



sub_C6B5_add_bonus_points_to_score:
C - - - - - 0x0006C5 00:C6B5: A5 21     LDA ram_bonus_points
C - - - - - 0x0006C7 00:C6B7: 4C BA C6  JMP loc_C6BA_add_score    ; bzk optimize, no need for JMP



loc_C6BA_add_score:
C D 2 - - - 0x0006CA 00:C6BA: 85 A6     STA ram_00A6
C - - - - - 0x0006CC 00:C6BC: A5 A7     LDA ram_sound_channel_4_flag
C - - - - - 0x0006CE 00:C6BE: D0 24     BNE bra_C6E4_RTS
C - - - - - 0x0006D0 00:C6C0: A5 E1     LDA ram_00E1_current_player
C - - - - - 0x0006D2 00:C6C2: F0 10     BEQ bra_C6D4_it_is_p1
; if it is player 2
C - - - - - 0x0006D4 00:C6C4: A5 BC     LDA ram_score_lo_p2
C - - - - - 0x0006D6 00:C6C6: 18        CLC
C - - - - - 0x0006D7 00:C6C7: 65 A6     ADC ram_00A6
C - - - - - 0x0006D9 00:C6C9: 85 BC     STA ram_score_lo_p2
C - - - - - 0x0006DB 00:C6CB: A5 BD     LDA ram_score_hi_p2
C - - - - - 0x0006DD 00:C6CD: 69 00     ADC #$00
C - - - - - 0x0006DF 00:C6CF: 85 BD     STA ram_score_hi_p2
C - - - - - 0x0006E1 00:C6D1: 4C F9 C6  JMP loc_C6F9_update_top_score_from_p2
bra_C6D4_it_is_p1:
C - - - - - 0x0006E4 00:C6D4: A5 B8     LDA ram_score_lo_p1
C - - - - - 0x0006E6 00:C6D6: 18        CLC
C - - - - - 0x0006E7 00:C6D7: 65 A6     ADC ram_00A6
C - - - - - 0x0006E9 00:C6D9: 85 B8     STA ram_score_lo_p1
C - - - - - 0x0006EB 00:C6DB: A5 B9     LDA ram_score_hi_p1
C - - - - - 0x0006ED 00:C6DD: 69 00     ADC #$00
C - - - - - 0x0006EF 00:C6DF: 85 B9     STA ram_score_hi_p1
C - - - - - 0x0006F1 00:C6E1: 4C E5 C6  JMP loc_C6E5_update_top_score_from_p1
bra_C6E4_RTS:
C - - - - - 0x0006F4 00:C6E4: 60        RTS



loc_C6E5_update_top_score_from_p1:
C D 2 - - - 0x0006F5 00:C6E5: A5 B8     LDA ram_score_lo_p1
C - - - - - 0x0006F7 00:C6E7: 38        SEC
C - - - - - 0x0006F8 00:C6E8: E5 BA     SBC ram_top_score_lo
C - - - - - 0x0006FA 00:C6EA: A5 B9     LDA ram_score_hi_p1
C - - - - - 0x0006FC 00:C6EC: E5 BB     SBC ram_top_score_hi
C - - - - - 0x0006FE 00:C6EE: 90 08     BCC bra_C6F8_RTS
; if player 1 score >= top score
C - - - - - 0x000700 00:C6F0: A5 B8     LDA ram_score_lo_p1
C - - - - - 0x000702 00:C6F2: 85 BA     STA ram_top_score_lo
C - - - - - 0x000704 00:C6F4: A5 B9     LDA ram_score_hi_p1
C - - - - - 0x000706 00:C6F6: 85 BB     STA ram_top_score_hi
bra_C6F8_RTS:
C - - - - - 0x000708 00:C6F8: 60        RTS



loc_C6F9_update_top_score_from_p2:
C D 2 - - - 0x000709 00:C6F9: A5 BC     LDA ram_score_lo_p2
C - - - - - 0x00070B 00:C6FB: 38        SEC
C - - - - - 0x00070C 00:C6FC: E5 BA     SBC ram_top_score_lo
C - - - - - 0x00070E 00:C6FE: A5 BD     LDA ram_score_hi_p2
C - - - - - 0x000710 00:C700: E5 BB     SBC ram_top_score_hi
C - - - - - 0x000712 00:C702: 90 08     BCC bra_C70C_RTS
; if player 2 score >= top score
C - - - - - 0x000714 00:C704: A5 BC     LDA ram_score_lo_p2
C - - - - - 0x000716 00:C706: 85 BA     STA ram_top_score_lo
C - - - - - 0x000718 00:C708: A5 BD     LDA ram_score_hi_p2
C - - - - - 0x00071A 00:C70A: 85 BB     STA ram_top_score_hi
bra_C70C_RTS:
C - - - - - 0x00071C 00:C70C: 60        RTS



sub_C70D_print_score_amount:
C - - - - - 0x00071D 00:C70D: 20 3E C7  JSR sub_C73E_write_hud_data_to_buffer
C - - - - - 0x000720 00:C710: A9 B1     LDA #< (ram_decimal_number + $01)
C - - - - - 0x000722 00:C712: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x000724 00:C714: A9 00     LDA #> (ram_decimal_number + $01)
C - - - - - 0x000726 00:C716: 85 01     STA ram_0000_t06_ppu_data + $01
C - - - - - 0x000728 00:C718: 4C 34 C7  JMP loc_C734_print



sub_C71B_print_number_amount:
C - - - - - 0x00072B 00:C71B: 20 3E C7  JSR sub_C73E_write_hud_data_to_buffer
C - - - - - 0x00072E 00:C71E: A9 B3     LDA #< (ram_decimal_number + $03)
C - - - - - 0x000730 00:C720: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x000732 00:C722: A9 00     LDA #> (ram_decimal_number + $03)
C - - - - - 0x000734 00:C724: 85 01     STA ram_0000_t06_ppu_data + $01
C - - - - - 0x000736 00:C726: 4C 34 C7  JMP loc_C734_print



sub_C729_print_milk_amount:
C - - - - - 0x000739 00:C729: 20 3E C7  JSR sub_C73E_write_hud_data_to_buffer
C - - - - - 0x00073C 00:C72C: A9 B4     LDA #< (ram_decimal_number + $04)
C - - - - - 0x00073E 00:C72E: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x000740 00:C730: A9 00     LDA #> (ram_decimal_number + $04)
C - - - - - 0x000742 00:C732: 85 01     STA ram_0000_t06_ppu_data + $01
loc_C734_print:
C D 2 - - - 0x000744 00:C734: A5 E6     LDA ram_nmi_enabled_flag
C - - - - - 0x000746 00:C736: F0 03     BEQ bra_C73B_nmi_enabled
; if nmi disabled
C - - - - - 0x000748 00:C738: 4C 5B EC  JMP loc_EC5B_write_data_to_ppu
bra_C73B_nmi_enabled:
C - - - - - 0x00074B 00:C73B: 4C D7 EB  JMP loc_EBD7_write_data_to_buffer



sub_C73E_write_hud_data_to_buffer:
; out
    ; ram_0002_t06_ppu_addr_lo
    ; ram_0003_t02_ppu_addr_hi
C - - - - - 0x00074E 00:C73E: 8A        TXA
C - - - - - 0x00074F 00:C73F: 48        PHA
C - - - - - 0x000750 00:C740: 98        TYA
C - - - - - 0x000751 00:C741: 48        PHA
C - - - - - 0x000752 00:C742: A5 B6     LDA ram_00B6_number_lo
C - - - - - 0x000754 00:C744: 85 00     STA ram_0000_t08_number_lo
C - - - - - 0x000756 00:C746: A5 B7     LDA ram_00B7_number_hi
C - - - - - 0x000758 00:C748: 85 01     STA ram_0001_t02_number_hi
C - - - - - 0x00075A 00:C74A: A9 BE     LDA #< tbl_C7BE_convertion
C - - - - - 0x00075C 00:C74C: 85 02     STA ram_0002_t03_convertion_data
C - - - - - 0x00075E 00:C74E: A9 C7     LDA #> tbl_C7BE_convertion
C - - - - - 0x000760 00:C750: 85 03     STA ram_0002_t03_convertion_data + $01
C - - - - - 0x000762 00:C752: A9 B0     LDA #< ram_decimal_number
C - - - - - 0x000764 00:C754: 85 06     STA ram_0006_t02_decimal_number_data
C - - - - - 0x000766 00:C756: A9 00     LDA #> ram_decimal_number
C - - - - - 0x000768 00:C758: 85 07     STA ram_0006_t02_decimal_number_data + $01
; convert hex number to decimal tiles
C - - - - - 0x00076A 00:C75A: A2 05     LDX #$05
bra_C75C_loop:
C - - - - - 0x00076C 00:C75C: A9 00     LDA #$00
C - - - - - 0x00076E 00:C75E: 85 08     STA ram_0008_t05_tile_for_number
C - - - - - 0x000770 00:C760: A0 00     LDY #$00
C - - - - - 0x000772 00:C762: B1 02     LDA (ram_0002_t03_convertion_data),Y
C - - - - - 0x000774 00:C764: 85 04     STA ram_0004_t04_lo
C - - - - - 0x000776 00:C766: C8        INY ; 01
C - - - - - 0x000777 00:C767: B1 02     LDA (ram_0002_t03_convertion_data),Y
C - - - - - 0x000779 00:C769: 85 05     STA ram_0005_t03_hi
loc_C76B_loop:
C D 2 - - - 0x00077B 00:C76B: A5 00     LDA ram_0000_t08_number_lo
C - - - - - 0x00077D 00:C76D: 38        SEC
C - - - - - 0x00077E 00:C76E: E5 04     SBC ram_0004_t04_lo
C - - - - - 0x000780 00:C770: 85 00     STA ram_0000_t08_number_lo
C - - - - - 0x000782 00:C772: A5 01     LDA ram_0001_t02_number_hi
C - - - - - 0x000784 00:C774: E5 05     SBC ram_0005_t03_hi
C - - - - - 0x000786 00:C776: 85 01     STA ram_0001_t02_number_hi
C - - - - - 0x000788 00:C778: 90 05     BCC bra_C77F
C - - - - - 0x00078A 00:C77A: E6 08     INC ram_0008_t05_tile_for_number
; bzk optimize, BNE
C - - - - - 0x00078C 00:C77C: 4C 6B C7  JMP loc_C76B_loop
bra_C77F:
C - - - - - 0x00078F 00:C77F: A5 00     LDA ram_0000_t08_number_lo
C - - - - - 0x000791 00:C781: 18        CLC
C - - - - - 0x000792 00:C782: 65 04     ADC ram_0004_t04_lo
C - - - - - 0x000794 00:C784: 85 00     STA ram_0000_t08_number_lo
C - - - - - 0x000796 00:C786: A5 01     LDA ram_0001_t02_number_hi
C - - - - - 0x000798 00:C788: 65 05     ADC ram_0005_t03_hi
C - - - - - 0x00079A 00:C78A: 85 01     STA ram_0001_t02_number_hi
C - - - - - 0x00079C 00:C78C: A0 00     LDY #$00
C - - - - - 0x00079E 00:C78E: A5 08     LDA ram_0008_t05_tile_for_number
C - - - - - 0x0007A0 00:C790: 09 30     ORA #$30    ; tiles for numbers start from 30
C - - - - - 0x0007A2 00:C792: 91 06     STA (ram_0006_t02_decimal_number_data),Y
C - - - - - 0x0007A4 00:C794: A5 02     LDA ram_0002_t03_convertion_data
C - - - - - 0x0007A6 00:C796: 18        CLC
C - - - - - 0x0007A7 00:C797: 69 02     ADC #< $0002
C - - - - - 0x0007A9 00:C799: 85 02     STA ram_0002_t03_convertion_data
C - - - - - 0x0007AB 00:C79B: A5 03     LDA ram_0002_t03_convertion_data + $01
C - - - - - 0x0007AD 00:C79D: 69 00     ADC #> $0002
C - - - - - 0x0007AF 00:C79F: 85 03     STA ram_0002_t03_convertion_data + $01
C - - - - - 0x0007B1 00:C7A1: E6 06     INC ram_0006_t02_decimal_number_data
C - - - - - 0x0007B3 00:C7A3: D0 02     BNE bra_C7A7_not_overflow
- - - - - - 0x0007B5 00:C7A5: E6 07     INC ram_0006_t02_decimal_number_data + $01
bra_C7A7_not_overflow:
C - - - - - 0x0007B7 00:C7A7: CA        DEX
C - - - - - 0x0007B8 00:C7A8: D0 B2     BNE bra_C75C_loop
; 
C - - - - - 0x0007BA 00:C7AA: A9 00     LDA #$00
C - - - - - 0x0007BC 00:C7AC: 85 B5     STA ram_decimal_number + $05
C - - - - - 0x0007BE 00:C7AE: 68        PLA
C - - - - - 0x0007BF 00:C7AF: A8        TAY
C - - - - - 0x0007C0 00:C7B0: 68        PLA
C - - - - - 0x0007C1 00:C7B1: AA        TAX
C - - - - - 0x0007C2 00:C7B2: 20 53 E9  JSR sub_E953_calculate_ppu_address
C - - - - - 0x0007C5 00:C7B5: A5 00     LDA ram_0000_t10_ppu_addr_lo
C - - - - - 0x0007C7 00:C7B7: 85 02     STA ram_0002_t06_ppu_addr_lo
C - - - - - 0x0007C9 00:C7B9: A5 01     LDA ram_0001_t01_ppu_addr_hi
C - - - - - 0x0007CB 00:C7BB: 85 03     STA ram_0003_t02_ppu_addr_hi
C - - - - - 0x0007CD 00:C7BD: 60        RTS



tbl_C7BE_convertion:
- D 2 - I - 0x0007CE 00:C7BE: 10 27     .word $2710 ; 00 10000
- D 2 - I - 0x0007D0 00:C7C0: E8 03     .word $03E8 ; 01  1000
- D 2 - I - 0x0007D2 00:C7C2: 64 00     .word $0064 ; 02   100
- D 2 - I - 0x0007D4 00:C7C4: 0A 00     .word $000A ; 03    10
- D 2 - I - 0x0007D6 00:C7C6: 01 00     .word $0001 ; 04     1



sub_C7C8_game_completed_message:
C - - - - - 0x0007D8 00:C7C8: A5 CF     LDA ram_round_skip_flag
C - - - - - 0x0007DA 00:C7CA: D0 56     BNE bra_C822_RTS
C - - - - - 0x0007DC 00:C7CC: 20 4D EF  JSR sub_EF4D_clear_nametable
C - - - - - 0x0007DF 00:C7CF: 20 AA EF  JSR sub_EFAA_hide_all_sprites
C - - - - - 0x0007E2 00:C7D2: 20 6C EF  JSR sub_EF6C
C - - - - - 0x0007E5 00:C7D5: A9 23     LDA #< tbl_C823_txt___perfect_congratulations
C - - - - - 0x0007E7 00:C7D7: 85 00     STA ram_0000_t02_ppu_data
C - - - - - 0x0007E9 00:C7D9: A9 C8     LDA #> tbl_C823_txt___perfect_congratulations
C - - - - - 0x0007EB 00:C7DB: 85 01     STA ram_0000_t02_ppu_data + $01
C - - - - - 0x0007ED 00:C7DD: 20 28 EC  JSR sub_EC28_print_tiles_on_black_background
C - - - - - 0x0007F0 00:C7E0: A2 84     LDX #$84
C - - - - - 0x0007F2 00:C7E2: A0 70     LDY #$70
C - - - - - 0x0007F4 00:C7E4: 20 FC DF  JSR sub_DFFC_write_player_position
C - - - - - 0x0007F7 00:C7E7: A9 86     LDA #$86
C - - - - - 0x0007F9 00:C7E9: 20 E8 DF  JSR sub_DFE8_write_player_animation
C - - - - - 0x0007FC 00:C7EC: A9 01     LDA #$01
C - - - - - 0x0007FE 00:C7EE: 8D 22 07  STA ram_player_color
C - - - - - 0x000801 00:C7F1: 8D 26 07  STA ram_player_color + $04
C - - - - - 0x000804 00:C7F4: 8D 2A 07  STA ram_player_color + $08
C - - - - - 0x000807 00:C7F7: 8D 2E 07  STA ram_player_color + $0C
C - - - - - 0x00080A 00:C7FA: A2 7C     LDX #$7C    ; pos X
C - - - - - 0x00080C 00:C7FC: A0 74     LDY #$74    ; pos Y
C - - - - - 0x00080E 00:C7FE: 20 83 CD  JSR sub_CD83
C - - - - - 0x000811 00:C801: A2 6C     LDX #$6C    ; pos X
C - - - - - 0x000813 00:C803: A0 70     LDY #$70    ; pos Y
C - - - - - 0x000815 00:C805: 20 4D CD  JSR sub_CD4D_display_girl_with_sprites
C - - - - - 0x000818 00:C808: A9 01     LDA #$01
C - - - - - 0x00081A 00:C80A: 20 0C C6  JSR sub_C60C_long_wait
C - - - - - 0x00081D 00:C80D: 20 76 EF  JSR sub_EF76
C - - - - - 0x000820 00:C810: 20 D4 F2  JSR sub_F2D4
C - - - - - 0x000823 00:C813: 20 46 F0  JSR sub_F046_play_music___title_screen
bra_C816_infinite_loop:
C - - - - - 0x000826 00:C816: A5 34     LDA ram_sound_channel_1_flag
C - - - - - 0x000828 00:C818: D0 FC     BNE bra_C816_infinite_loop
C - - - - - 0x00082A 00:C81A: A9 04     LDA #$04
C - - - - - 0x00082C 00:C81C: 20 0C C6  JSR sub_C60C_long_wait
; bzk optimize, JMP
C - - - - - 0x00082F 00:C81F: 20 AA EF  JSR sub_EFAA_hide_all_sprites
bra_C822_RTS:
...
- D 2 - I - 0x000833 00:C823: 8C 21     .word $218C ; ppu address
- D 2 - I - 0x000835 00:C825: 50        .byte "PERFECT!"
- D 2 - I - 0x00083D 00:C82D: 00        .byte $00   ; 

- D 2 - I - 0x00083E 00:C82E: 28 22     .word $2228 ; ppu address
...
C - - - - - 0x000855 00:C845: 85 8F     STA ram_bonus_round_id
...
C - - - - - 0x00087A 00:C86A: 20 26 C0  JSR sub_C026_write_A_to_2007
C - - - - - 0x00087D 00:C86D: E8        INX
C - - - - - 0x00087E 00:C86E: 88        DEY
C - - - - - 0x00087F 00:C86F: D0 F6     BNE bra_C867_loop
C - - - - - 0x000881 00:C871: C6 44     DEC ram_0044
C - - - - - 0x000883 00:C873: D0 E9     BNE bra_C85E_loop
...
C - - - - - 0x000895 00:C885: 20 26 C0  JSR sub_C026_write_A_to_2007
...
C - - - - - 0x0008B2 00:C8A2: F0 6A     BEQ bra_C90E_exit
...
C - - - - - 0x0008C2 00:C8B2: 20 53 E9  JSR sub_E953_calculate_ppu_address
C - - - - - 0x0008C5 00:C8B5: A5 00     LDA ram_0000_t10_ppu_addr_lo
C - - - - - 0x0008C7 00:C8B7: 85 02     STA ram_0002_t09_ppu_addr_lo
C - - - - - 0x0008C9 00:C8B9: A5 01     LDA ram_0001_t01_ppu_addr_hi
C - - - - - 0x0008CB 00:C8BB: 85 03     STA ram_0003_t01_ppu_addr_hi
C - - - - - 0x0008CD 00:C8BD: A9 31     LDA #< tbl_C931
C - - - - - 0x0008CF 00:C8BF: 85 00     STA ram_0000_t01_ppu_data
C - - - - - 0x0008D1 00:C8C1: A9 C9     LDA #> tbl_C931
C - - - - - 0x0008D3 00:C8C3: 85 01     STA ram_0000_t01_ppu_data + $01
C - - - - - 0x0008D5 00:C8C5: A5 00     LDA ram_0000_t01_ppu_data
C - - - - - 0x0008D7 00:C8C7: 18        CLC
C - - - - - 0x0008D8 00:C8C8: 65 45     ADC ram_0045
C - - - - - 0x0008DA 00:C8CA: 85 00     STA ram_0000_t01_ppu_data
C - - - - - 0x0008DC 00:C8CC: A5 01     LDA ram_0000_t01_ppu_data + $01
C - - - - - 0x0008DE 00:C8CE: 69 00     ADC #$00
C - - - - - 0x0008E0 00:C8D0: 85 01     STA ram_0000_t01_ppu_data + $01
C - - - - - 0x0008E2 00:C8D2: 20 89 C9  JSR sub_C989_write_data_to_ppu
C - - - - - 0x0008E5 00:C8D5: A6 40     LDX ram_0040
C - - - - - 0x0008E7 00:C8D7: A4 42     LDY ram_0042
C - - - - - 0x0008E9 00:C8D9: C8        INY
C - - - - - 0x0008EA 00:C8DA: 20 53 E9  JSR sub_E953_calculate_ppu_address
C - - - - - 0x0008ED 00:C8DD: A5 00     LDA ram_0000_t10_ppu_addr_lo
C - - - - - 0x0008EF 00:C8DF: 85 02     STA ram_0002_t09_ppu_addr_lo
C - - - - - 0x0008F1 00:C8E1: A5 01     LDA ram_0001_t01_ppu_addr_hi
C - - - - - 0x0008F3 00:C8E3: 85 03     STA ram_0003_t01_ppu_addr_hi
C - - - - - 0x0008F5 00:C8E5: A9 35     LDA #< tbl_C935
C - - - - - 0x0008F7 00:C8E7: 85 00     STA ram_0000_t01_ppu_data
C - - - - - 0x0008F9 00:C8E9: A9 C9     LDA #> tbl_C935
C - - - - - 0x0008FB 00:C8EB: 85 01     STA ram_0000_t01_ppu_data + $01
C - - - - - 0x0008FD 00:C8ED: A5 00     LDA ram_0000_t01_ppu_data
C - - - - - 0x0008FF 00:C8EF: 18        CLC
C - - - - - 0x000900 00:C8F0: 65 45     ADC ram_0045
C - - - - - 0x000902 00:C8F2: 85 00     STA ram_0000_t01_ppu_data
C - - - - - 0x000904 00:C8F4: A5 01     LDA ram_0000_t01_ppu_data + $01
C - - - - - 0x000906 00:C8F6: 69 00     ADC #$00
C - - - - - 0x000908 00:C8F8: 85 01     STA ram_0000_t01_ppu_data + $01
C - - - - - 0x00090A 00:C8FA: 20 89 C9  JSR sub_C989_write_data_to_ppu
...
C - - - - - 0x000920 00:C910: 20 0C C6  JSR sub_C60C_long_wait
C - - - - - 0x000923 00:C913: 20 76 EF  JSR sub_EF76
C - - - - - 0x000926 00:C916: 20 64 F0  JSR sub_F064_play_music___bonus_round_completed
C - - - - - 0x000929 00:C919: A9 14     LDA #$14
C - - - - - 0x00092B 00:C91B: 20 0C C6  JSR sub_C60C_long_wait
C - - - - - 0x00092E 00:C91E: A6 22     LDX ram_milk_current_player
C - - - - - 0x000930 00:C920: E0 09     CPX #$09
C - - - - - 0x000932 00:C922: F0 01     BEQ bra_C925
C - - - - - 0x000934 00:C924: E8        INX
bra_C925:
C - - - - - 0x000935 00:C925: 86 22     STX ram_milk_current_player
C - - - - - 0x000937 00:C927: A5 E1     LDA ram_00E1_current_player
C - - - - - 0x000939 00:C929: D0 03     BNE bra_C92E
C - - - - - 0x00093B 00:C92B: 86 BE     STX ram_milk_p1
C - - - - - 0x00093D 00:C92D: 60        RTS
bra_C92E:
- - - - - - 0x00093E 00:C92E: 86 BF     STX ram_milk_p2
...
- D 2 - - - 0x000961 00:C951: 0F        .byte $0F, $30, $1A, $27   ; 00 
- D 2 - - - 0x000965 00:C955: 0F        .byte $0F, $30, $29, $24   ; 01 
- D 2 - - - 0x000969 00:C959: 0F        .byte $0F, $30, $2A, $26   ; 02 
- D 2 - - - 0x00096D 00:C95D: 0F        .byte $0F, $30, $39, $21   ; 03 
...
sub_C989_write_data_to_ppu:
; in
    ; ram_0000_t01_ppu_data
    ; ram_0002_t09_ppu_addr_lo
    ; ram_0003_t01_ppu_addr_hi
C - - - - - 0x000999 00:C989: A5 03     LDA ram_0003_t01_ppu_addr_hi
C - - - - - 0x00099B 00:C98B: 8D 06 20  STA $2006
C - - - - - 0x00099E 00:C98E: A5 02     LDA ram_0002_t09_ppu_addr_lo
C - - - - - 0x0009A0 00:C990: 8D 06 20  STA $2006
C - - - - - 0x0009A3 00:C993: A0 00     LDY #$00
loc_C995_loop:
C D 2 - - - 0x0009A5 00:C995: B1 00     LDA (ram_0000_t01_ppu_data),Y
C - - - - - 0x0009A7 00:C997: F0 07     BEQ bra_C9A0_RTS
C - - - - - 0x0009A9 00:C999: 20 26 C0  JSR sub_C026_write_A_to_2007
C - - - - - 0x0009AC 00:C99C: C8        INY
; bzk optimize, BNE
C - - - - - 0x0009AD 00:C99D: 4C 95 C9  JMP loc_C995_loop
bra_C9A0_RTS:
...
bra_C9A1:
; clear 00AC-00AE
C - - - - - 0x0009B1 00:C9A1: A2 AC     LDX #$AC
C - - - - - 0x0009B3 00:C9A3: A0 04     LDY #$04
C - - - - - 0x0009B5 00:C9A5: 20 34 CD  JSR sub_CD34_clear_00xx
C - - - - - 0x0009B8 00:C9A8: A9 00     LDA #con_obj_index_00
; bzk optimize, JMP
C - - - - - 0x0009BA 00:C9AA: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
...
C - - - - - 0x0009CA 00:C9BA: A5 E1     LDA ram_00E1_current_player
C - - - - - 0x0009CC 00:C9BC: F0 06     BEQ bra_C9C4
C - - - - - 0x0009CE 00:C9BE: A5 E9     LDA ram_00E9_game_mode
C - - - - - 0x0009D0 00:C9C0: F0 06     BEQ bra_C9C8_RTS
C - - - - - 0x0009D2 00:C9C2: D0 05     BNE bra_C9C9    ; jmp
bra_C9C4:
C - - - - - 0x0009D4 00:C9C4: A5 E8     LDA ram_00E8_game_mode
C - - - - - 0x0009D6 00:C9C6: D0 01     BNE bra_C9C9
bra_C9C8_RTS:
C - - - - - 0x0009D8 00:C9C8: 60        RTS
bra_C9C9:
C - - - - - 0x0009D9 00:C9C9: A5 AC     LDA ram_00AC_flag
...
C - - - - - 0x0009E7 00:C9D7: AD 23 07  LDA ram_player_pos_X
...
C - - - - - 0x0009F3 00:C9E3: 85 AD     STA ram_00AD_flag
...
C - - - - - 0x0009FC 00:C9EC: 85 AC     STA ram_00AC_flag
C - - - - - 0x0009FE 00:C9EE: A9 02     LDA #$02
C - - - - - 0x000A00 00:C9F0: 85 AF     STA ram_00AF
C - - - - - 0x000A02 00:C9F2: A0 00     LDY #con_obj_index_00
...
C - - - - - 0x000A10 00:CA00: AD 20 07  LDA ram_player_pos_Y
...
C - - - - - 0x000A2A 00:CA1A: A5 AC     LDA ram_00AC_flag
...
C - - - - - 0x000A35 00:CA25: A5 AD     LDA ram_00AD_flag
...
; bzk optimize, delete CPX 00
C - - - - - 0x000A41 00:CA31: E0 00     CPX #$00
...
sub_CA79:
C - - - - - 0x000A89 00:CA79: A5 AC     LDA ram_00AC_flag
...
C - - - - - 0x000A95 00:CA85: ED 23 07  SBC ram_player_pos_X
...
C - - - - - 0x000AA0 00:CA90: ED 20 07  SBC ram_player_pos_Y
...
C - - - - - 0x000ABD 00:CAAD: 85 AC     STA ram_00AC_flag
C - - - - - 0x000ABF 00:CAAF: 20 B1 F0  JSR sub_F0B1_play_sound___jump_over_enemy
; bzk optimize, JMP
C - - - - - 0x000AC2 00:CAB2: 20 A6 C6  JSR sub_C6A6_add_500_points
bra_CAB5_RTS:
...
C - - - - - 0x000B19 00:CB09: AD 20 07  LDA ram_player_pos_Y
C - - - - - 0x000B1C 00:CB0C: 29 0F     AND #$0F
C - - - - - 0x000B1E 00:CB0E: D0 4D     BNE bra_CB5D_RTS
C - - - - - 0x000B20 00:CB10: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x000B23 00:CB13: AC 20 07  LDY ram_player_pos_Y
C - - - - - 0x000B26 00:CB16: 20 1D E0  JSR sub_E01D_get_block_index_from_round_data
C - - - - - 0x000B29 00:CB19: C9 01     CMP #$01    ; pipe
C - - - - - 0x000B2B 00:CB1B: F0 04     BEQ bra_CB21
C - - - - - 0x000B2D 00:CB1D: C9 02     CMP #$02    ; brick
...
C - - - - - 0x000B3C 00:CB2C: AD 23 07  LDA ram_player_pos_X
...
bra_CB37:
C - - - - - 0x000B47 00:CB37: AD 23 07  LDA ram_player_pos_X
...
C - - - - - 0x000B52 00:CB42: AD 20 07  LDA ram_player_pos_Y
...
C - - - - - 0x000B87 00:CB77: A5 8F     LDA ram_bonus_round_id
C - - - - - 0x000B89 00:CB79: F0 09     BEQ bra_CB84_not_bonus_round
; if bonus round
...
; bzk optimize, delete CPX 00
C - - - - - 0x000B9F 00:CB8F: E0 00     CPX #$00
C - - - - - 0x000BA1 00:CB91: D0 0D     BNE bra_CBA0_RTS
C - - - - - 0x000BA3 00:CB93: C6 21     DEC ram_bonus_points
C - - - - - 0x000BA5 00:CB95: A5 21     LDA ram_bonus_points
C - - - - - 0x000BA7 00:CB97: F0 08     BEQ bra_CBA1_time_up
C - - - - - 0x000BA9 00:CB99: C9 0A     CMP #$0A
C - - - - - 0x000BAB 00:CB9B: B0 03     BCS bra_CBA0_RTS
; make beeps when low time
C - - - - - 0x000BAD 00:CB9D: 20 80 F0  JSR sub_F080_play_sound___low_time
bra_CBA0_RTS:
...
sub_CBA7:
C - - - - - 0x000BB7 00:CBA7: A9 70     LDA #con_obj_index_70
C - - - - - 0x000BB9 00:CBA9: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
C - - - - - 0x000BBC 00:CBAC: A9 80     LDA #con_obj_index_80
C - - - - - 0x000BBE 00:CBAE: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
; clear 00A8-00AA
C - - - - - 0x000BC1 00:CBB1: A2 A8     LDX #$A8
...
bra_CBBE:
C - - - - - 0x000BCE 00:CBBE: A5 8F     LDA ram_bonus_round_id
C - - - - - 0x000BD0 00:CBC0: F0 01     BEQ bra_CBC3_not_bonus_round
; if bonus round
bra_CBC2_RTS:
C - - - - - 0x000BD2 00:CBC2: 60        RTS
bra_CBC3_not_bonus_round:
...
C - - - - - 0x000BDB 00:CBCB: A5 E4     LDA ram_collected_fruit_counter
C - - - - - 0x000BDD 00:CBCD: C5 2C     CMP ram_round_fruit_counter
; bzk optimize, branch to 0x000BD2 or 0x000C51
C - - - - - 0x000BDF 00:CBCF: D0 E7     BNE bra_CBB8_RTS
; if all fruit are collected
C - - - - - 0x000BE1 00:CBD1: 20 79 CC  JSR sub_CC79_draw_opened_house
C - - - - - 0x000BE4 00:CBD4: A2 30     LDX #$30    ; pos X
C - - - - - 0x000BE6 00:CBD6: A0 30     LDY #$30    ; pos Y
C - - - - - 0x000BE8 00:CBD8: 20 4D CD  JSR sub_CD4D_display_girl_with_sprites
C - - - - - 0x000BEB 00:CBDB: E6 AA     INC ram_help_timer
C - - - - - 0x000BED 00:CBDD: A5 AA     LDA ram_help_timer
C - - - - - 0x000BEF 00:CBDF: 29 3F     AND #$3F
C - - - - - 0x000BF1 00:CBE1: C9 20     CMP #$20
C - - - - - 0x000BF3 00:CBE3: 90 0A     BCC bra_CBEF
C - - - - - 0x000BF5 00:CBE5: A2 48     LDX #$48    ; pos X
C - - - - - 0x000BF7 00:CBE7: A0 20     LDY #$20    ; pos Y
C - - - - - 0x000BF9 00:CBE9: 20 68 CD  JSR sub_CD68_display_help_message_with_sprites
C - - - - - 0x000BFC 00:CBEC: 4C F4 CB  JMP loc_CBF4
bra_CBEF:
C - - - - - 0x000BFF 00:CBEF: A9 70     LDA #con_obj_index_70
C - - - - - 0x000C01 00:CBF1: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
loc_CBF4:
C D 2 - - - 0x000C04 00:CBF4: AD 23 07  LDA ram_player_pos_X
...
C - - - - - 0x000C0F 00:CBFF: AD 20 07  LDA ram_player_pos_Y
...
C - - - - - 0x000C22 00:CC12: A9 70     LDA #con_obj_index_70
C - - - - - 0x000C24 00:CC14: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
C - - - - - 0x000C27 00:CC17: A2 3C     LDX #$3C
C - - - - - 0x000C29 00:CC19: A0 30     LDY #$30
C - - - - - 0x000C2B 00:CC1B: 20 FC DF  JSR sub_DFFC_write_player_position
C - - - - - 0x000C2E 00:CC1E: A9 86     LDA #$86
C - - - - - 0x000C30 00:CC20: 20 E8 DF  JSR sub_DFE8_write_player_animation
C - - - - - 0x000C33 00:CC23: A2 34     LDX #$34    ; pos X
C - - - - - 0x000C35 00:CC25: A0 34     LDY #$34    ; pos Y
C - - - - - 0x000C37 00:CC27: 20 83 CD  JSR sub_CD83
C - - - - - 0x000C3A 00:CC2A: A2 24     LDX #$24    ; pos X
C - - - - - 0x000C3C 00:CC2C: A0 30     LDY #$30    ; pos Y
C - - - - - 0x000C3E 00:CC2E: 20 4D CD  JSR sub_CD4D_display_girl_with_sprites
...
; bzk optimize, JMP
C - - - - - 0x000C4E 00:CC3E: 20 44 F1  JSR sub_F144_play_music___round_completed
bra_CC41_RTS:
...
sub_CC79_draw_opened_house:
C - - - - - 0x000C89 00:CC79: A5 A8     LDA ram_house_flag
C - - - - - 0x000C8B 00:CC7B: F0 01     BEQ bra_CC7E
C - - - - - 0x000C8D 00:CC7D: 60        RTS
bra_CC7E:
C - - - - - 0x000C8E 00:CC7E: A9 01     LDA #$01
C - - - - - 0x000C90 00:CC80: 85 A8     STA ram_house_flag
C - - - - - 0x000C92 00:CC82: 20 21 CD  JSR sub_CD21
C - - - - - 0x000C95 00:CC85: A9 C4     LDA #< $20C4
C - - - - - 0x000C97 00:CC87: 85 02     STA ram_0002_t06_ppu_addr_lo
C - - - - - 0x000C99 00:CC89: A9 20     LDA #> $20C4
C - - - - - 0x000C9B 00:CC8B: 85 03     STA ram_0003_t02_ppu_addr_hi
C - - - - - 0x000C9D 00:CC8D: A9 DC     LDA #< tbl_CCDC_tiles___house_window_opened_1
C - - - - - 0x000C9F 00:CC8F: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x000CA1 00:CC91: A9 CC     LDA #> tbl_CCDC_tiles___house_window_opened_1
C - - - - - 0x000CA3 00:CC93: 85 01     STA ram_0000_t06_ppu_data + $01
C - - - - - 0x000CA5 00:CC95: 20 D7 EB  JSR sub_EBD7_write_data_to_buffer
C - - - - - 0x000CA8 00:CC98: A9 E4     LDA #< $20E4
C - - - - - 0x000CAA 00:CC9A: 85 02     STA ram_0002_t06_ppu_addr_lo
C - - - - - 0x000CAC 00:CC9C: A9 20     LDA #> $20E4
C - - - - - 0x000CAE 00:CC9E: 85 03     STA ram_0003_t02_ppu_addr_hi
C - - - - - 0x000CB0 00:CCA0: A9 E3     LDA #< tbl_CCE3_tiles___house_window_opened_2
C - - - - - 0x000CB2 00:CCA2: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x000CB4 00:CCA4: A9 CC     LDA #> tbl_CCE3_tiles___house_window_opened_2
C - - - - - 0x000CB6 00:CCA6: 85 01     STA ram_0000_t06_ppu_data + $01
C - - - - - 0x000CB8 00:CCA8: 20 D7 EB  JSR sub_EBD7_write_data_to_buffer
; bzk optimize, JMP
...
C - - - - - 0x000CC4 00:CCB4: 85 02     STA ram_0002_t06_ppu_addr_lo
C - - - - - 0x000CC6 00:CCB6: A9 20     LDA #> $20C4
C - - - - - 0x000CC8 00:CCB8: 85 03     STA ram_0003_t02_ppu_addr_hi
C - - - - - 0x000CCA 00:CCBA: A9 EA     LDA #< tbl_CCEA_tiles___house_window_closed_1
C - - - - - 0x000CCC 00:CCBC: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x000CCE 00:CCBE: A9 CC     LDA #> tbl_CCEA_tiles___house_window_closed_1
C - - - - - 0x000CD0 00:CCC0: 85 01     STA ram_0000_t06_ppu_data + $01
C - - - - - 0x000CD2 00:CCC2: 20 D7 EB  JSR sub_EBD7_write_data_to_buffer
C - - - - - 0x000CD5 00:CCC5: A9 E4     LDA #< $20E4
C - - - - - 0x000CD7 00:CCC7: 85 02     STA ram_0002_t06_ppu_addr_lo
C - - - - - 0x000CD9 00:CCC9: A9 20     LDA #> $20E4
C - - - - - 0x000CDB 00:CCCB: 85 03     STA ram_0003_t02_ppu_addr_hi
C - - - - - 0x000CDD 00:CCCD: A9 F1     LDA #< tbl_CCF1_tiles___house_window_closed_2
C - - - - - 0x000CDF 00:CCCF: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x000CE1 00:CCD1: A9 CC     LDA #> tbl_CCF1_tiles___house_window_closed_2
C - - - - - 0x000CE3 00:CCD3: 85 01     STA ram_0000_t06_ppu_data + $01
C - - - - - 0x000CE5 00:CCD5: 20 D7 EB  JSR sub_EBD7_write_data_to_buffer
; bzk optimize, JMP
...
C - - - - - 0x000D0D 00:CCFD: 85 02     STA ram_0002_t06_ppu_addr_lo
C - - - - - 0x000D0F 00:CCFF: A9 20     LDA #> $20C4
C - - - - - 0x000D11 00:CD01: 85 03     STA ram_0003_t02_ppu_addr_hi
C - - - - - 0x000D13 00:CD03: 20 15 CD  JSR sub_CD15_print_6_spaces
C - - - - - 0x000D16 00:CD06: A9 E4     LDA #< $20E4
C - - - - - 0x000D18 00:CD08: 85 02     STA ram_0002_t06_ppu_addr_lo
C - - - - - 0x000D1A 00:CD0A: A9 20     LDA #> $20E4
C - - - - - 0x000D1C 00:CD0C: 85 03     STA ram_0003_t02_ppu_addr_hi
C - - - - - 0x000D1E 00:CD0E: 20 15 CD  JSR sub_CD15_print_6_spaces
; bzk optimize, JMP
...
sub_CD15_print_6_spaces:
C - - - - - 0x000D25 00:CD15: A9 2D     LDA #< tbl_CD2D_tiles___6_spaces
C - - - - - 0x000D27 00:CD17: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x000D29 00:CD19: A9 CD     LDA #> tbl_CD2D_tiles___6_spaces
C - - - - - 0x000D2B 00:CD1B: 85 01     STA ram_0000_t06_ppu_data + $01
; bzk optimize, JMP
C - - - - - 0x000D2D 00:CD1D: 20 D7 EB  JSR sub_EBD7_write_data_to_buffer
...
C - - - - - 0x000D36 00:CD26: 85 26     STA ram_nmi_wait_flag
bra_CD28_infinite_loop:
C - - - - - 0x000D38 00:CD28: A5 26     LDA ram_nmi_wait_flag
...
- D 2 - I - 0x000D43 00:CD33: 00        .byte $00   ; end token
...
C - - - - - 0x000D46 00:CD36: 95 00     STA $00,X
...
sub_CD3D_hide_sprites_of_object:
; in
    ; A = object index
...
sub_CD4D_display_girl_with_sprites:
; in
    ; X = pos X
    ; Y = pos Y
C - - - - - 0x000D5D 00:CD4D: 86 40     STX ram_0040
C - - - - - 0x000D5F 00:CD4F: 84 42     STY ram_0042
C - - - - - 0x000D61 00:CD51: A0 80     LDY #con_obj_index_80
...
sub_CD68_display_help_message_with_sprites:
; in
    ; X = pos X
    ; Y = pos Y
C - - - - - 0x000D78 00:CD68: 86 40     STX ram_0040
C - - - - - 0x000D7A 00:CD6A: 84 42     STY ram_0042
C - - - - - 0x000D7C 00:CD6C: A0 70     LDY #con_obj_index_70
...
bra_CD99:
C - - - - - 0x000DA9 00:CD99: A5 8F     LDA ram_bonus_round_id
C - - - - - 0x000DAB 00:CD9B: D0 01     BNE bra_CD9E_bonus_round
; if not bonus round
bra_CD9D_RTS:
C - - - - - 0x000DAD 00:CD9D: 60        RTS
bra_CD9E_bonus_round:
C - - - - - 0x000DAE 00:CD9E: A5 57     LDA ram_0057
C - - - - - 0x000DB0 00:CDA0: D0 FB     BNE bra_CD9D_RTS
C - - - - - 0x000DB2 00:CDA2: A5 A8     LDA ram_house_flag
C - - - - - 0x000DB4 00:CDA4: D0 09     BNE bra_CDAF
C - - - - - 0x000DB6 00:CDA6: A9 01     LDA #$01
C - - - - - 0x000DB8 00:CDA8: 85 A8     STA ram_house_flag
...
C - - - - - 0x000DD0 00:CDC0: 20 4D CD  JSR sub_CD4D_display_girl_with_sprites
C - - - - - 0x000DD3 00:CDC3: E6 AA     INC ram_help_timer
C - - - - - 0x000DD5 00:CDC5: A5 AA     LDA ram_help_timer
C - - - - - 0x000DD7 00:CDC7: 29 3F     AND #$3F
C - - - - - 0x000DD9 00:CDC9: C9 20     CMP #$20
C - - - - - 0x000DDB 00:CDCB: 90 0A     BCC bra_CDD7_skip_help_message
C - - - - - 0x000DDD 00:CDCD: A2 80     LDX #$80    ; pos X
C - - - - - 0x000DDF 00:CDCF: A0 44     LDY #$44    ; pos Y
C - - - - - 0x000DE1 00:CDD1: 20 68 CD  JSR sub_CD68_display_help_message_with_sprites
C - - - - - 0x000DE4 00:CDD4: 4C DC CD  JMP loc_CDDC
bra_CDD7_skip_help_message:
C - - - - - 0x000DE7 00:CDD7: A9 70     LDA #con_obj_index_70
C - - - - - 0x000DE9 00:CDD9: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
loc_CDDC:
C D 2 - - - 0x000DEC 00:CDDC: AD 23 07  LDA ram_player_pos_X
...
C - - - - - 0x000DF7 00:CDE7: AD 20 07  LDA ram_player_pos_Y
...
C - - - - - 0x000E0D 00:CDFD: A9 30     LDA #con_obj_index_30
C - - - - - 0x000E0F 00:CDFF: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
C - - - - - 0x000E12 00:CE02: A9 70     LDA #con_obj_index_70
C - - - - - 0x000E14 00:CE04: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
C - - - - - 0x000E17 00:CE07: A2 84     LDX #$84
C - - - - - 0x000E19 00:CE09: A0 50     LDY #con_obj_index_50
C - - - - - 0x000E1B 00:CE0B: 20 FC DF  JSR sub_DFFC_write_player_position
C - - - - - 0x000E1E 00:CE0E: A9 86     LDA #$86
C - - - - - 0x000E20 00:CE10: 20 E8 DF  JSR sub_DFE8_write_player_animation
C - - - - - 0x000E23 00:CE13: A2 7C     LDX #$7C    ; pos X
C - - - - - 0x000E25 00:CE15: A0 54     LDY #$54    ; pos Y
C - - - - - 0x000E27 00:CE17: 20 83 CD  JSR sub_CD83
C - - - - - 0x000E2A 00:CE1A: A2 6C     LDX #$6C    ; pos X
C - - - - - 0x000E2C 00:CE1C: A0 50     LDY #$50    ; pos Y
C - - - - - 0x000E2E 00:CE1E: 20 4D CD  JSR sub_CD4D_display_girl_with_sprites
...
C - - - - - 0x000E3C 00:CE2C: 20 0C C6  JSR sub_C60C_long_wait
C - - - - - 0x000E3F 00:CE2F: 20 5F CE  JSR sub_CE5F
C - - - - - 0x000E42 00:CE32: 20 9A F0  JSR sub_F09A_play_sound___collect_fruit
C - - - - - 0x000E45 00:CE35: A9 03     LDA #$03
C - - - - - 0x000E47 00:CE37: 20 0C C6  JSR sub_C60C_long_wait
C - - - - - 0x000E4A 00:CE3A: 20 88 CE  JSR sub_CE88
C - - - - - 0x000E4D 00:CE3D: 20 B1 F0  JSR sub_F0B1_play_sound___jump_over_enemy
C - - - - - 0x000E50 00:CE40: A9 04     LDA #$04
C - - - - - 0x000E52 00:CE42: 20 0C C6  JSR sub_C60C_long_wait
...
C - - - - - 0x000E72 00:CE62: A0 40     LDY #con_obj_index_40
...
sub_CE88:
C - - - - - 0x000E98 00:CE88: A0 40     LDY #con_obj_index_40
...
bra_CEF1:
C - - - - - 0x000F01 00:CEF1: A5 8F     LDA ram_bonus_round_id
C - - - - - 0x000F03 00:CEF3: D0 01     BNE bra_CEF6_bonus_round
; if not bonus round
C - - - - - 0x000F05 00:CEF5: 60        RTS
bra_CEF6_bonus_round:
...
C - - - - - 0x000F12 00:CF02: A5 8F     LDA ram_bonus_round_id
...
C - - - - - 0x000F44 00:CF34: D0 D0     BNE bra_CF06_loop
bra_CF36_RTS:
...
C - - - - - 0x000F49 00:CF39: D0 3D     BNE bra_CF78_spinning_fireball
...
; bzk optimize, loading same A
C - - - - - 0x000FC7 00:CFB7: A9 00     LDA #$00
...
C - - - - - 0x000FE4 00:CFD4: AD 23 07  LDA ram_player_pos_X
...
C - - - - - 0x000FFC 00:CFEC: AD 20 07  LDA ram_player_pos_Y
...
bra_D040_loop:
C - - - - - 0x001050 00:D040: BD 00 06  LDA ram_0600_round_data,X
...
C - - - - - 0x001065 00:D055: 9D 00 06  STA ram_0600_round_data,X
bra_D058:
...
sub_D05C:
; clear 0090-0099
C - - - - - 0x00106C 00:D05C: A2 90     LDX #$90
C - - - - - 0x00106E 00:D05E: A0 0A     LDY #$0A
C - - - - - 0x001070 00:D060: 20 34 CD  JSR sub_CD34_clear_00xx
C - - - - - 0x001073 00:D063: A9 00     LDA #$00
C - - - - - 0x001075 00:D065: 85 E4     STA ram_collected_fruit_counter
C - - - - - 0x001077 00:D067: 60        RTS



sub_D068:
C - - - - - 0x001078 00:D068: A9 90     LDA #con_obj_index_90
C - - - - - 0x00107A 00:D06A: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
C - - - - - 0x00107D 00:D06D: A9 A0     LDA #con_obj_index_A0
C - - - - - 0x00107F 00:D06F: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
C - - - - - 0x001082 00:D072: A9 B0     LDA #con_obj_index_B0
C - - - - - 0x001084 00:D074: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
C - - - - - 0x001087 00:D077: A9 C0     LDA #con_obj_index_C0
C - - - - - 0x001089 00:D079: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
C - - - - - 0x00108C 00:D07C: A9 D0     LDA #con_obj_index_D0
C - - - - - 0x00108E 00:D07E: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
...
bra_D087:
C - - - - - 0x001097 00:D087: A9 90     LDA #< ram_0090
C - - - - - 0x001099 00:D089: 85 06     STA ram_0006_t01_data
C - - - - - 0x00109B 00:D08B: A9 00     LDA #> ram_0090
C - - - - - 0x00109D 00:D08D: 85 07     STA ram_0006_t01_data + $01
C - - - - - 0x00109F 00:D08F: A9 90     LDA #< (ram_oam + con_obj_index_90)
C - - - - - 0x0010A1 00:D091: 85 08     STA ram_0008_t01_data
C - - - - - 0x0010A3 00:D093: A9 07     LDA #> (ram_oam + con_obj_index_90)
C - - - - - 0x0010A5 00:D095: 85 09     STA ram_0008_t01_data + $01
C - - - - - 0x0010A7 00:D097: A5 2C     LDA ram_round_fruit_counter
C - - - - - 0x0010A9 00:D099: 85 49     STA ram_0049
bra_D09B_loop:
C - - - - - 0x0010AB 00:D09B: A0 00     LDY #$00
C - - - - - 0x0010AD 00:D09D: B1 06     LDA (ram_0006_t01_data),Y
C - - - - - 0x0010AF 00:D09F: 85 58     STA ram_0058
C - - - - - 0x0010B1 00:D0A1: C8        INY ; 01
C - - - - - 0x0010B2 00:D0A2: B1 06     LDA (ram_0006_t01_data),Y
C - - - - - 0x0010B4 00:D0A4: 85 59     STA ram_0059
C - - - - - 0x0010B6 00:D0A6: A0 03     LDY #$03
bra_D0A8_loop:
C - - - - - 0x0010B8 00:D0A8: B1 08     LDA (ram_0008_t01_data),Y
...
C - - - - - 0x0010C7 00:D0B7: 91 06     STA (ram_0006_t01_data),Y
C - - - - - 0x0010C9 00:D0B9: C8        INY ; 01
C - - - - - 0x0010CA 00:D0BA: A5 59     LDA ram_0059
C - - - - - 0x0010CC 00:D0BC: 91 06     STA (ram_0006_t01_data),Y
C - - - - - 0x0010CE 00:D0BE: A0 03     LDY #$03
bra_D0C0_loop:
C - - - - - 0x0010D0 00:D0C0: B9 5A 00  LDA ram_005A,Y
C - - - - - 0x0010D3 00:D0C3: 91 08     STA (ram_0008_t01_data),Y
C - - - - - 0x0010D5 00:D0C5: 88        DEY
C - - - - - 0x0010D6 00:D0C6: 10 F8     BPL bra_D0C0_loop
C - - - - - 0x0010D8 00:D0C8: A5 06     LDA ram_0006_t01_data
C - - - - - 0x0010DA 00:D0CA: 18        CLC
C - - - - - 0x0010DB 00:D0CB: 69 02     ADC #$02
C - - - - - 0x0010DD 00:D0CD: 85 06     STA ram_0006_t01_data
C - - - - - 0x0010DF 00:D0CF: A5 08     LDA ram_0008_t01_data
C - - - - - 0x0010E1 00:D0D1: 18        CLC
C - - - - - 0x0010E2 00:D0D2: 69 10     ADC #$10
C - - - - - 0x0010E4 00:D0D4: 85 08     STA ram_0008_t01_data
...
C - - - - - 0x0010FD 00:D0ED: ED 23 07  SBC ram_player_pos_X
...
C - - - - - 0x001107 00:D0F7: ED 20 07  SBC ram_player_pos_Y
...
C - - - - - 0x00111E 00:D10E: 20 9A F0  JSR sub_F09A_play_sound___collect_fruit
C - - - - - 0x001121 00:D111: 20 AB C6  JSR sub_C6AB_add_800_points
C - - - - - 0x001124 00:D114: E6 E4     INC ram_collected_fruit_counter
bra_D116_RTS:
...
C - - - - - 0x00114E 00:D13E: A4 08     LDY ram_0008_t01_data
...
bra_D157:
C - - - - - 0x001167 00:D157: A5 08     LDA ram_0008_t01_data
; bzk optimize, JMP
C - - - - - 0x001169 00:D159: 20 3D CD  JSR sub_CD3D_hide_sprites_of_object
C - - - - - 0x00116C 00:D15C: 60        RTS



sub_D15D:
C - - - - - 0x00116D 00:D15D: A5 8F     LDA ram_bonus_round_id
...
C - - - - - 0x001178 00:D168: 65 8F     ADC ram_bonus_round_id
C - - - - - 0x00117A 00:D16A: 85 5A     STA ram_005A
C - - - - - 0x00117C 00:D16C: A4 08     LDY ram_0008_t01_data
...
C - - - - - 0x00118F 00:D17F: E5 8F     SBC ram_bonus_round_id
C - - - - - 0x001191 00:D181: 85 5A     STA ram_005A
C - - - - - 0x001193 00:D183: A4 08     LDY ram_0008_t01_data
...
bra_D1F8:
C - - - - - 0x001208 00:D1F8: A9 88     LDA #< ram_0088
C - - - - - 0x00120A 00:D1FA: 85 02     STA ram_0002_t01_data
C - - - - - 0x00120C 00:D1FC: A9 00     LDA #> ram_0088
C - - - - - 0x00120E 00:D1FE: 85 03     STA ram_0002_t01_data + $01
...
C - - - - - 0x00121B 00:D20B: A5 02     LDA ram_0002_t01_data
C - - - - - 0x00121D 00:D20D: 18        CLC
C - - - - - 0x00121E 00:D20E: 69 02     ADC #$02
C - - - - - 0x001220 00:D210: 85 02     STA ram_0002_t01_data
...
C - - - - - 0x00122B 00:D21B: D0 EB     BNE bra_D208_loop
...
C - - - - - 0x001230 00:D220: B1 02     LDA (ram_0002_t01_data),Y
C - - - - - 0x001232 00:D222: F0 16     BEQ bra_D23A_RTS
C - - - - - 0x001234 00:D224: C8        INY ; 01
C - - - - - 0x001235 00:D225: B1 02     LDA (ram_0002_t01_data),Y
C - - - - - 0x001237 00:D227: 38        SEC
C - - - - - 0x001238 00:D228: E9 01     SBC #$01
C - - - - - 0x00123A 00:D22A: 91 02     STA (ram_0002_t01_data),Y
C - - - - - 0x00123C 00:D22C: D0 0C     BNE bra_D23A_RTS
C - - - - - 0x00123E 00:D22E: 88        DEY ; 00
C - - - - - 0x00123F 00:D22F: A9 00     LDA #$00
C - - - - - 0x001241 00:D231: 91 02     STA (ram_0002_t01_data),Y
...
C - - - - - 0x00124D 00:D23D: 85 02     STA ram_0002_t02_data
C - - - - - 0x00124F 00:D23F: A9 00     LDA #> ram_0088
C - - - - - 0x001251 00:D241: 85 03     STA ram_0002_t02_data + $01
C - - - - - 0x001253 00:D243: A9 E0     LDA #con_obj_index_E0
...
C - - - - - 0x001262 00:D252: A5 02     LDA ram_0002_t02_data
C - - - - - 0x001264 00:D254: 18        CLC
C - - - - - 0x001265 00:D255: 69 02     ADC #$02
C - - - - - 0x001267 00:D257: 85 02     STA ram_0002_t02_data
...
C - - - - - 0x001279 00:D269: B1 02     LDA (ram_0002_t02_data),Y
C - - - - - 0x00127B 00:D26B: D0 33     BNE bra_D2A0_RTS
C - - - - - 0x00127D 00:D26D: A4 45     LDY ram_0045
C - - - - - 0x00127F 00:D26F: A5 28     LDA ram_0028_temp_pos_X
...
C - - - - - 0x00128B 00:D27B: A5 29     LDA ram_0029_temp_pos_Y
...
C - - - - - 0x00129B 00:D28B: 91 02     STA (ram_0002_t02_data),Y
C - - - - - 0x00129D 00:D28D: C8        INY ; 01
C - - - - - 0x00129E 00:D28E: A9 03     LDA #$03
C - - - - - 0x0012A0 00:D290: 91 02     STA (ram_0002_t02_data),Y
...
; bzk optimize, JMP
C - - - - - 0x0012AD 00:D29D: 20 C8 F0  JSR sub_F0C8_play_sound___spring_jump
bra_D2A0_RTS:
...
sub_D2BC:
C - - - - - 0x0012CC 00:D2BC: 86 C0     STX ram_00C0_save_X
C - - - - - 0x0012CE 00:D2BE: 84 C1     STY ram_00C1_save_Y
C - - - - - 0x0012D0 00:D2C0: A9 00     LDA #$00
C - - - - - 0x0012D2 00:D2C2: 85 0F     STA ram_000F_t02_save_A
C - - - - - 0x0012D4 00:D2C4: A5 5F     LDA ram_005F
C - - - - - 0x0012D6 00:D2C6: D0 12     BNE bra_D2DA
C - - - - - 0x0012D8 00:D2C8: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0012DA 00:D2CA: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x0012DC 00:D2CC: 20 7B E0  JSR sub_E07B
C - - - - - 0x0012DF 00:D2CF: D0 0C     BNE bra_D2DD
C - - - - - 0x0012E1 00:D2D1: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0012E3 00:D2D3: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x0012E5 00:D2D5: 20 42 E0  JSR sub_E042
C - - - - - 0x0012E8 00:D2D8: D0 03     BNE bra_D2DD
bra_D2DA:
C - - - - - 0x0012EA 00:D2DA: 4C 32 D5  JMP loc_D532_restore_AXY
bra_D2DD:
C - - - - - 0x0012ED 00:D2DD: A5 5C     LDA ram_005C
C - - - - - 0x0012EF 00:D2DF: F0 3B     BEQ bra_D31C
C - - - - - 0x0012F1 00:D2E1: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x0012F3 00:D2E3: C9 D0     CMP #$D0
C - - - - - 0x0012F5 00:D2E5: F0 1F     BEQ bra_D306
C - - - - - 0x0012F7 00:D2E7: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x0012F9 00:D2E9: 29 0F     AND #$0F
C - - - - - 0x0012FB 00:D2EB: D0 0B     BNE bra_D2F8
C - - - - - 0x0012FD 00:D2ED: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0012FF 00:D2EF: A4 D0     LDY ram_00D0_obj_pos_Y
...
C - - - - - 0x00130A 00:D2FA: 85 0F     STA ram_000F_t02_save_A
C - - - - - 0x00130C 00:D2FC: 4C 32 D5  JMP loc_D532_restore_AXY
bra_D2FF:
...
- - - - - - 0x00131B 00:D30B: 85 0F     STA ram_000F_t02_save_A
- - - - - - 0x00131D 00:D30D: 4C 32 D5  JMP loc_D532_restore_AXY



sub_D310:
; bzk optimize
C - - - - - 0x001320 00:D310: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x001322 00:D312: 38        SEC
C - - - - - 0x001323 00:D313: ED 20 07  SBC ram_player_pos_Y
...
bra_D324:
loc_D324:
C D 2 - - - 0x001334 00:D324: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x001336 00:D326: CD 23 07  CMP ram_player_pos_X
C - - - - - 0x001339 00:D329: 90 46     BCC bra_D371
C - - - - - 0x00133B 00:D32B: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x00133D 00:D32D: A4 D0     LDY ram_00D0_obj_pos_Y
...
C - - - - - 0x00134A 00:D33A: 85 0F     STA ram_000F_t02_save_A
C - - - - - 0x00134C 00:D33C: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x00134E 00:D33E: C9 10     CMP #$10
C - - - - - 0x001350 00:D340: 90 28     BCC bra_D36A
C - - - - - 0x001352 00:D342: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001354 00:D344: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x001356 00:D346: 20 42 E0  JSR sub_E042
C - - - - - 0x001359 00:D349: A0 0F     LDY #$0F
C - - - - - 0x00135B 00:D34B: B1 00     LDA (ram_0000_t04_round_data),Y
C - - - - - 0x00135D 00:D34D: D0 1B     BNE bra_D36A
C - - - - - 0x00135F 00:D34F: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001361 00:D351: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x001363 00:D353: 20 AB E0  JSR sub_E0AB_read_byte_from_round_data
C - - - - - 0x001366 00:D356: D0 12     BNE bra_D36A
C - - - - - 0x001368 00:D358: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x00136A 00:D35A: 29 0F     AND #$0F
C - - - - - 0x00136C 00:D35C: D0 0C     BNE bra_D36A
C - - - - - 0x00136E 00:D35E: A9 82     LDA #$82
C - - - - - 0x001370 00:D360: 85 0F     STA ram_000F_t02_save_A
C - - - - - 0x001372 00:D362: A9 02     LDA #$02
C - - - - - 0x001374 00:D364: 85 5B     STA ram_005B
; bzk optimize, loading same A
C - - - - - 0x001376 00:D366: A9 02     LDA #$02
C - - - - - 0x001378 00:D368: 85 5A     STA ram_005A
bra_D36A:
C - - - - - 0x00137A 00:D36A: A9 00     LDA #$00
C - - - - - 0x00137C 00:D36C: 85 5E     STA ram_005E
C - - - - - 0x00137E 00:D36E: 4C 32 D5  JMP loc_D532_restore_AXY
bra_D371:
C - - - - - 0x001381 00:D371: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001383 00:D373: A4 D0     LDY ram_00D0_obj_pos_Y
...
C - - - - - 0x001390 00:D380: 85 0F     STA ram_000F_t02_save_A
C - - - - - 0x001392 00:D382: A9 E0     LDA #$E0
C - - - - - 0x001394 00:D384: C5 D3     CMP ram_00D0_obj_pos_X
C - - - - - 0x001396 00:D386: 90 28     BCC bra_D3B0
C - - - - - 0x001398 00:D388: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x00139A 00:D38A: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x00139C 00:D38C: 20 42 E0  JSR sub_E042
C - - - - - 0x00139F 00:D38F: A0 11     LDY #$11
C - - - - - 0x0013A1 00:D391: B1 00     LDA (ram_0000_t04_round_data),Y
C - - - - - 0x0013A3 00:D393: D0 1B     BNE bra_D3B0
C - - - - - 0x0013A5 00:D395: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0013A7 00:D397: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x0013A9 00:D399: 20 AB E0  JSR sub_E0AB_read_byte_from_round_data
C - - - - - 0x0013AC 00:D39C: D0 12     BNE bra_D3B0
C - - - - - 0x0013AE 00:D39E: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x0013B0 00:D3A0: 29 0F     AND #$0F
C - - - - - 0x0013B2 00:D3A2: D0 0C     BNE bra_D3B0
C - - - - - 0x0013B4 00:D3A4: A9 81     LDA #$81
C - - - - - 0x0013B6 00:D3A6: 85 0F     STA ram_000F_t02_save_A
...
C - - - - - 0x0013C4 00:D3B4: 4C 32 D5  JMP loc_D532_restore_AXY
bra_D3B7:
- - - - - - 0x0013C7 00:D3B7: A9 01     LDA #$01
- - - - - - 0x0013C9 00:D3B9: 85 5C     STA ram_005C
- - - - - - 0x0013CB 00:D3BB: A9 04     LDA #$04
- - - - - - 0x0013CD 00:D3BD: 85 0F     STA ram_000F_t02_save_A
- - - - - - 0x0013CF 00:D3BF: 4C 32 D5  JMP loc_D532_restore_AXY



loc_D3C2:
C D 2 - - - 0x0013D2 00:D3C2: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x0013D4 00:D3C4: CD 20 07  CMP ram_player_pos_Y
C - - - - - 0x0013D7 00:D3C7: 90 7B     BCC bra_D444
C - - - - - 0x0013D9 00:D3C9: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0013DB 00:D3CB: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x0013DD 00:D3CD: 20 7B E0  JSR sub_E07B
C - - - - - 0x0013E0 00:D3D0: C9 03     CMP #$03
C - - - - - 0x0013E2 00:D3D2: D0 39     BNE bra_D40D
C - - - - - 0x0013E4 00:D3D4: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x0013E6 00:D3D6: 38        SEC
C - - - - - 0x0013E7 00:D3D7: ED 23 07  SBC ram_player_pos_X
C - - - - - 0x0013EA 00:D3DA: 20 A1 D2  JSR sub_D2A1
C - - - - - 0x0013ED 00:D3DD: C9 10     CMP #$10
C - - - - - 0x0013EF 00:D3DF: 90 18     BCC bra_D3F9
C - - - - - 0x0013F1 00:D3E1: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0013F3 00:D3E3: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x0013F5 00:D3E5: 20 AB E0  JSR sub_E0AB_read_byte_from_round_data
...
C - - - - - 0x001404 00:D3F4: 85 0F     STA ram_000F_t02_save_A
C - - - - - 0x001406 00:D3F6: 4C 32 D5  JMP loc_D532_restore_AXY
bra_D3F9:
C - - - - - 0x001409 00:D3F9: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x00140B 00:D3FB: 18        CLC
C - - - - - 0x00140C 00:D3FC: 69 08     ADC #$08
C - - - - - 0x00140E 00:D3FE: 29 F0     AND #$F0
C - - - - - 0x001410 00:D400: AA        TAX
C - - - - - 0x001411 00:D401: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x001413 00:D403: 20 61 DA  JSR sub_DA61_write_object_position
bra_D406:
C - - - - - 0x001416 00:D406: A9 08     LDA #$08
C - - - - - 0x001418 00:D408: 85 0F     STA ram_000F_t02_save_A
C - - - - - 0x00141A 00:D40A: 4C 32 D5  JMP loc_D532_restore_AXY
bra_D40D:
C - - - - - 0x00141D 00:D40D: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x00141F 00:D40F: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x001421 00:D411: 20 AB E0  JSR sub_E0AB_read_byte_from_round_data
C - - - - - 0x001424 00:D414: C9 03     CMP #$03
C - - - - - 0x001426 00:D416: D0 63     BNE bra_D47B
C - - - - - 0x001428 00:D418: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x00142A 00:D41A: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x00142C 00:D41C: 20 42 E0  JSR sub_E042
C - - - - - 0x00142F 00:D41F: C9 03     CMP #$03
C - - - - - 0x001431 00:D421: F0 58     BEQ bra_D47B
C - - - - - 0x001433 00:D423: A5 50     LDA ram_jump_flag
C - - - - - 0x001435 00:D425: F0 03     BEQ bra_D42A
C - - - - - 0x001437 00:D427: 4C 24 D3  JMP loc_D324
bra_D42A:
C - - - - - 0x00143A 00:D42A: A5 D3     LDA ram_00D0_obj_pos_X
...
C - - - - - 0x00144A 00:D43A: 20 45 DA  JSR sub_DA45_write_object_animation
C - - - - - 0x00144D 00:D43D: A9 80     LDA #$80
C - - - - - 0x00144F 00:D43F: 85 0F     STA ram_000F_t02_save_A
C - - - - - 0x001451 00:D441: 4C 32 D5  JMP loc_D532_restore_AXY
bra_D444:
C - - - - - 0x001454 00:D444: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001456 00:D446: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x001458 00:D448: 20 7B E0  JSR sub_E07B
C - - - - - 0x00145B 00:D44B: C9 03     CMP #$03
C - - - - - 0x00145D 00:D44D: D0 14     BNE bra_D463
C - - - - - 0x00145F 00:D44F: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001461 00:D451: A4 D0     LDY ram_00D0_obj_pos_Y
...
C - - - - - 0x00146E 00:D45E: 85 0F     STA ram_000F_t02_save_A
C - - - - - 0x001470 00:D460: 4C 32 D5  JMP loc_D532_restore_AXY
bra_D463:
C - - - - - 0x001473 00:D463: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x001475 00:D465: 29 0F     AND #$0F
C - - - - - 0x001477 00:D467: D0 12     BNE bra_D47B
C - - - - - 0x001479 00:D469: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x00147B 00:D46B: A4 D0     LDY ram_00D0_obj_pos_Y
...
C - - - - - 0x001486 00:D476: 85 0F     STA ram_000F_t02_save_A
C - - - - - 0x001488 00:D478: 4C 32 D5  JMP loc_D532_restore_AXY
bra_D47B:
C - - - - - 0x00148B 00:D47B: A5 5E     LDA ram_005E
C - - - - - 0x00148D 00:D47D: D0 5E     BNE bra_D4DD
C - - - - - 0x00148F 00:D47F: A9 02     LDA #$02
C - - - - - 0x001491 00:D481: 85 0F     STA ram_000F_t02_save_A
C - - - - - 0x001493 00:D483: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x001495 00:D485: C9 08     CMP #$08
C - - - - - 0x001497 00:D487: B0 03     BCS bra_D48C
C - - - - - 0x001499 00:D489: 4C D4 D4  JMP loc_D4D4
bra_D48C:
C - - - - - 0x00149C 00:D48C: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x00149E 00:D48E: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x0014A0 00:D490: 20 42 E0  JSR sub_E042
C - - - - - 0x0014A3 00:D493: A0 0F     LDY #$0F
C - - - - - 0x0014A5 00:D495: B1 00     LDA (ram_0000_t04_round_data),Y
C - - - - - 0x0014A7 00:D497: D0 1B     BNE bra_D4B4
C - - - - - 0x0014A9 00:D499: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0014AB 00:D49B: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x0014AD 00:D49D: 20 AB E0  JSR sub_E0AB_read_byte_from_round_data
C - - - - - 0x0014B0 00:D4A0: D0 12     BNE bra_D4B4
C - - - - - 0x0014B2 00:D4A2: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x0014B4 00:D4A4: 29 0F     AND #$0F
C - - - - - 0x0014B6 00:D4A6: D0 1F     BNE bra_D4C7
C - - - - - 0x0014B8 00:D4A8: A9 82     LDA #$82
C - - - - - 0x0014BA 00:D4AA: 85 0F     STA ram_000F_t02_save_A
C - - - - - 0x0014BC 00:D4AC: A9 02     LDA #$02
C - - - - - 0x0014BE 00:D4AE: 85 5B     STA ram_005B
; bzk optimize, loading same A
C - - - - - 0x0014C0 00:D4B0: A9 02     LDA #$02
C - - - - - 0x0014C2 00:D4B2: 85 5A     STA ram_005A
bra_D4B4:
C - - - - - 0x0014C4 00:D4B4: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x0014C6 00:D4B6: 29 0F     AND #$0F
C - - - - - 0x0014C8 00:D4B8: D0 0D     BNE bra_D4C7
C - - - - - 0x0014CA 00:D4BA: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0014CC 00:D4BC: A4 D0     LDY ram_00D0_obj_pos_Y
...
bra_D4C7:
C - - - - - 0x0014D7 00:D4C7: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0014D9 00:D4C9: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x0014DB 00:D4CB: 29 F0     AND #$F0
C - - - - - 0x0014DD 00:D4CD: A8        TAY
C - - - - - 0x0014DE 00:D4CE: 20 61 DA  JSR sub_DA61_write_object_position
C - - - - - 0x0014E1 00:D4D1: 4C 32 D5  JMP loc_D532_restore_AXY
bra_D4D4:
loc_D4D4:
C D 2 - - - 0x0014E4 00:D4D4: A5 5E     LDA ram_005E
C - - - - - 0x0014E6 00:D4D6: 49 01     EOR #$01
C - - - - - 0x0014E8 00:D4D8: 85 5E     STA ram_005E
C - - - - - 0x0014EA 00:D4DA: 4C 32 D5  JMP loc_D532_restore_AXY
bra_D4DD:
C - - - - - 0x0014ED 00:D4DD: A9 01     LDA #$01
C - - - - - 0x0014EF 00:D4DF: 85 0F     STA ram_000F_t02_save_A
C - - - - - 0x0014F1 00:D4E1: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x0014F3 00:D4E3: C9 E8     CMP #$E8
C - - - - - 0x0014F5 00:D4E5: 90 03     BCC bra_D4EA
C - - - - - 0x0014F7 00:D4E7: 4C D4 D4  JMP loc_D4D4
bra_D4EA:
C - - - - - 0x0014FA 00:D4EA: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0014FC 00:D4EC: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x0014FE 00:D4EE: 20 42 E0  JSR sub_E042
C - - - - - 0x001501 00:D4F1: A0 11     LDY #$11
C - - - - - 0x001503 00:D4F3: B1 00     LDA (ram_0000_t04_round_data),Y
C - - - - - 0x001505 00:D4F5: D0 1B     BNE bra_D512
C - - - - - 0x001507 00:D4F7: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001509 00:D4F9: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x00150B 00:D4FB: 20 AB E0  JSR sub_E0AB_read_byte_from_round_data
C - - - - - 0x00150E 00:D4FE: D0 12     BNE bra_D512
C - - - - - 0x001510 00:D500: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x001512 00:D502: 29 0F     AND #$0F
C - - - - - 0x001514 00:D504: D0 1F     BNE bra_D525
C - - - - - 0x001516 00:D506: A9 81     LDA #$81
C - - - - - 0x001518 00:D508: 85 0F     STA ram_000F_t02_save_A
...
bra_D512:
C - - - - - 0x001522 00:D512: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x001524 00:D514: 29 0F     AND #$0F
C - - - - - 0x001526 00:D516: D0 0D     BNE bra_D525
C - - - - - 0x001528 00:D518: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x00152A 00:D51A: A4 D0     LDY ram_00D0_obj_pos_Y
...
bra_D525:
C - - - - - 0x001535 00:D525: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001537 00:D527: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x001539 00:D529: 29 F0     AND #$F0
C - - - - - 0x00153B 00:D52B: A8        TAY
C - - - - - 0x00153C 00:D52C: 20 61 DA  JSR sub_DA61_write_object_position
; bzk optimize, useless JMP
C - - - - - 0x00153F 00:D52F: 4C 32 D5  JMP loc_D532_restore_AXY



loc_D532_restore_AXY:
C D 2 - - - 0x001542 00:D532: A6 C0     LDX ram_00C0_save_X
C - - - - - 0x001544 00:D534: A4 C1     LDY ram_00C1_save_Y
C - - - - - 0x001546 00:D536: A5 0F     LDA ram_000F_t02_save_A
...
sub_D539:
; clear 0058-0077
C - - - - - 0x001549 00:D539: A2 58     LDX #$58
...
; bzk optimize, BNE to 0x001577, delete following RTS
...
C - - - - - 0x00158A 00:D57A: 85 06     STA ram_0006_t03_data
C - - - - - 0x00158C 00:D57C: A9 00     LDA #> ram_0060
C - - - - - 0x00158E 00:D57E: 85 07     STA ram_0006_t03_data + $01
C - - - - - 0x001590 00:D580: A9 40     LDA #< (ram_oam + con_obj_index_40)
C - - - - - 0x001592 00:D582: 85 08     STA ram_0008_t02_data
C - - - - - 0x001594 00:D584: A9 07     LDA #> (ram_oam + con_obj_index_40)
C - - - - - 0x001596 00:D586: 85 09     STA ram_0008_t02_data + $01
C - - - - - 0x001598 00:D588: A9 00     LDA #$00
C - - - - - 0x00159A 00:D58A: 85 0D     STA ram_000D_t01
...
C - - - - - 0x0015A2 00:D592: 85 E7     STA ram_00E7_flag
bra_D594_loop:
C - - - - - 0x0015A4 00:D594: A2 00     LDX #$00
C - - - - - 0x0015A6 00:D596: A0 00     LDY #$00
bra_D598_loop:
C - - - - - 0x0015A8 00:D598: B1 06     LDA (ram_0006_t03_data),Y
...
bra_D5A4_loop:
C - - - - - 0x0015B4 00:D5A4: B1 08     LDA (ram_0008_t02_data),Y
C - - - - - 0x0015B6 00:D5A6: 99 D0 00  STA ram_00D0_obj_data,Y
C - - - - - 0x0015B9 00:D5A9: C8        INY
C - - - - - 0x0015BA 00:D5AA: C0 10     CPY #$10
C - - - - - 0x0015BC 00:D5AC: D0 F6     BNE bra_D5A4_loop
C - - - - - 0x0015BE 00:D5AE: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x0015C0 00:D5B0: 85 C2     STA ram_00C2_temp_pos_X
C - - - - - 0x0015C2 00:D5B2: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x0015C4 00:D5B4: 85 C3     STA ram_00C3_temp_pos_Y
...
C - - - - - 0x0015D8 00:D5C8: 91 06     STA (ram_0006_t03_data),Y
...
bra_D5D2_loop:
C - - - - - 0x0015E2 00:D5D2: B9 D0 00  LDA ram_00D0_obj_data,Y
C - - - - - 0x0015E5 00:D5D5: 91 08     STA (ram_0008_t02_data),Y
C - - - - - 0x0015E7 00:D5D7: C8        INY
C - - - - - 0x0015E8 00:D5D8: C0 10     CPY #$10
C - - - - - 0x0015EA 00:D5DA: D0 F6     BNE bra_D5D2_loop
C - - - - - 0x0015EC 00:D5DC: A5 06     LDA ram_0006_t03_data
C - - - - - 0x0015EE 00:D5DE: 18        CLC
C - - - - - 0x0015EF 00:D5DF: 69 08     ADC #$08
C - - - - - 0x0015F1 00:D5E1: 85 06     STA ram_0006_t03_data
C - - - - - 0x0015F3 00:D5E3: A5 08     LDA ram_0008_t02_data
C - - - - - 0x0015F5 00:D5E5: 18        CLC
C - - - - - 0x0015F6 00:D5E6: 69 10     ADC #$10
C - - - - - 0x0015F8 00:D5E8: 85 08     STA ram_0008_t02_data
C - - - - - 0x0015FA 00:D5EA: E6 0D     INC ram_000D_t01
C - - - - - 0x0015FC 00:D5EC: E6 0D     INC ram_000D_t01
...
C - - - - - 0x001630 00:D620: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001632 00:D622: A5 D0     LDA ram_00D0_obj_pos_Y
...
C - - - - - 0x001650 00:D640: 20 B1 F0  JSR sub_F0B1_play_sound___jump_over_enemy
; bzk optimize, JMP
C - - - - - 0x001653 00:D643: 20 9C C6  JSR sub_C69C_add_100_points
bra_D646_RTS:
...
C - - - - - 0x00165D 00:D64D: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x00165F 00:D64F: 38        SEC
C - - - - - 0x001660 00:D650: ED 23 07  SBC ram_player_pos_X
C - - - - - 0x001663 00:D653: 20 A1 D2  JSR sub_D2A1
C - - - - - 0x001666 00:D656: AA        TAX
C - - - - - 0x001667 00:D657: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x001669 00:D659: 38        SEC
C - - - - - 0x00166A 00:D65A: ED 20 07  SBC ram_player_pos_Y
...
C - - - - - 0x00167F 00:D66F: 85 51     STA ram_0051_jump_timer
C - - - - - 0x001681 00:D671: A9 14     LDA #$14
C - - - - - 0x001683 00:D673: 85 55     STA ram_0055
C - - - - - 0x001685 00:D675: 20 E8 F0  JSR sub_F0E8_play_sound___death
bra_D678_RTS:
...
sub_D679:
C - - - - - 0x001689 00:D679: A5 E7     LDA ram_00E7_flag
C - - - - - 0x00168B 00:D67B: 05 5F     ORA ram_005F
C - - - - - 0x00168D 00:D67D: 05 58     ORA ram_0058
C - - - - - 0x00168F 00:D67F: D0 69     BNE bra_D6EA_RTS
C - - - - - 0x001691 00:D681: A9 40     LDA #< (ram_oam + con_obj_index_40)
C - - - - - 0x001693 00:D683: 85 0A     STA ram_000A_t01_data
C - - - - - 0x001695 00:D685: A9 07     LDA #> (ram_oam + con_obj_index_40)
C - - - - - 0x001697 00:D687: 85 0B     STA ram_000A_t01_data + $01
C - - - - - 0x001699 00:D689: A9 60     LDA #< ram_0060
C - - - - - 0x00169B 00:D68B: 85 10     STA ram_0010_t01_data
C - - - - - 0x00169D 00:D68D: A9 00     LDA #> ram_0060
C - - - - - 0x00169F 00:D68F: 85 11     STA ram_0010_t01_data + $01
C - - - - - 0x0016A1 00:D691: A5 2B     LDA ram_002B
C - - - - - 0x0016A3 00:D693: 85 0C     STA ram_000C_t01_loop_counter
bra_D695_loop:
C - - - - - 0x0016A5 00:D695: A5 0C     LDA ram_000C_t01_loop_counter
C - - - - - 0x0016A7 00:D697: C5 49     CMP ram_0049
C - - - - - 0x0016A9 00:D699: F0 3D     BEQ bra_D6D8
C - - - - - 0x0016AB 00:D69B: A0 07     LDY #$07
C - - - - - 0x0016AD 00:D69D: B1 10     LDA (ram_0010_t01_data),Y
C - - - - - 0x0016AF 00:D69F: D0 37     BNE bra_D6D8
C - - - - - 0x0016B1 00:D6A1: A0 00     LDY #$00
C - - - - - 0x0016B3 00:D6A3: B1 10     LDA (ram_0010_t01_data),Y
C - - - - - 0x0016B5 00:D6A5: D0 31     BNE bra_D6D8
C - - - - - 0x0016B7 00:D6A7: A0 03     LDY #$03
C - - - - - 0x0016B9 00:D6A9: B1 0A     LDA (ram_000A_t01_data),Y
C - - - - - 0x0016BB 00:D6AB: 38        SEC
C - - - - - 0x0016BC 00:D6AC: E5 D3     SBC ram_00D0_obj_pos_X
C - - - - - 0x0016BE 00:D6AE: 20 A1 D2  JSR sub_D2A1
C - - - - - 0x0016C1 00:D6B1: AA        TAX
C - - - - - 0x0016C2 00:D6B2: A0 00     LDY #$00
C - - - - - 0x0016C4 00:D6B4: B1 0A     LDA (ram_000A_t01_data),Y
C - - - - - 0x0016C6 00:D6B6: 38        SEC
C - - - - - 0x0016C7 00:D6B7: E5 D0     SBC ram_00D0_obj_pos_Y
...
C - - - - - 0x0016D5 00:D6C5: A6 C2     LDX ram_00C2_temp_pos_X
C - - - - - 0x0016D7 00:D6C7: A4 C3     LDY ram_00C3_temp_pos_Y
C - - - - - 0x0016D9 00:D6C9: 20 61 DA  JSR sub_DA61_write_object_position
...
C - - - - - 0x0016E5 00:D6D5: 85 E7     STA ram_00E7_flag
C - - - - - 0x0016E7 00:D6D7: 60        RTS
bra_D6D8:
C - - - - - 0x0016E8 00:D6D8: A5 0A     LDA ram_000A_t01_data
C - - - - - 0x0016EA 00:D6DA: 18        CLC
C - - - - - 0x0016EB 00:D6DB: 69 10     ADC #$10
C - - - - - 0x0016ED 00:D6DD: 85 0A     STA ram_000A_t01_data
C - - - - - 0x0016EF 00:D6DF: A5 10     LDA ram_0010_t01_data
C - - - - - 0x0016F1 00:D6E1: 18        CLC
C - - - - - 0x0016F2 00:D6E2: 69 08     ADC #$08
C - - - - - 0x0016F4 00:D6E4: 85 10     STA ram_0010_t01_data
C - - - - - 0x0016F6 00:D6E6: C6 0C     DEC ram_000C_temp
...
; bzk optimize, JMP
C - - - - - 0x00173C 00:D72C: 20 45 DA  JSR sub_DA45_write_object_animation
...
C - - - - - 0x001746 00:D736: 20 45 DA  JSR sub_DA45_write_object_animation
C - - - - - 0x001749 00:D739: A2 F8     LDX #$F8
C - - - - - 0x00174B 00:D73B: A0 F8     LDY #$F8
; bzk optimize, JMP
C - - - - - 0x00174D 00:D73D: 20 61 DA  JSR sub_DA61_write_object_position
C - - - - - 0x001750 00:D740: 60        RTS
bra_D741:
C - - - - - 0x001751 00:D741: 8A        TXA
C - - - - - 0x001752 00:D742: 20 45 DA  JSR sub_DA45_write_object_animation
C - - - - - 0x001755 00:D745: A6 0D     LDX ram_000D_t01
...
; bzk optimize, JMP
C - - - - - 0x00175D 00:D74D: 20 61 DA  JSR sub_DA61_write_object_position
...
bra_D75A:
; bzk optimize, change to LDA 86
; bzk is this a hacking protection? the game won't
; break, but someone's graphics will be messed up
C - - - - - 0x00176A 00:D75A: AD 35 E9  LDA tbl_E935_86
C - - - - - 0x00176D 00:D75D: 20 45 DA  JSR sub_DA45_write_object_animation
...
bra_D78A:
C - - - - - 0x00179A 00:D78A: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x00179C 00:D78C: 20 AB D2  JSR sub_D2AB
C - - - - - 0x00179F 00:D78F: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0017A1 00:D791: 20 61 DA  JSR sub_DA61_write_object_position
loc_D794:
C D 2 - - - 0x0017A4 00:D794: A9 6C     LDA #$6C
C - - - - - 0x0017A6 00:D796: 20 45 DA  JSR sub_DA45_write_object_animation
C - - - - - 0x0017A9 00:D799: A5 D0     LDA ram_00D0_obj_pos_Y
...
C - - - - - 0x0017BF 00:D7AF: 85 48     STA ram_0048_flag
C - - - - - 0x0017C1 00:D7B1: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0017C3 00:D7B3: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x0017C5 00:D7B5: 86 4A     STX ram_004A_pos_X
C - - - - - 0x0017C7 00:D7B7: 84 4B     STY ram_004B_pos_Y
...
C - - - - - 0x0017EA 00:D7DA: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0017EC 00:D7DC: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x0017EE 00:D7DE: 20 7B E0  JSR sub_E07B
C - - - - - 0x0017F1 00:D7E1: C9 03     CMP #$03
C - - - - - 0x0017F3 00:D7E3: D0 23     BNE bra_D808
C - - - - - 0x0017F5 00:D7E5: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0017F7 00:D7E7: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x0017F9 00:D7E9: 20 BF E0  JSR sub_E0BF
C - - - - - 0x0017FC 00:D7EC: C9 03     CMP #$03
C - - - - - 0x0017FE 00:D7EE: D0 0B     BNE bra_D7FB
C - - - - - 0x001800 00:D7F0: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001802 00:D7F2: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x001804 00:D7F4: 20 C7 E0  JSR sub_E0C7
C - - - - - 0x001807 00:D7F7: C9 03     CMP #$03
C - - - - - 0x001809 00:D7F9: F0 0D     BEQ bra_D808
bra_D7FB:
C - - - - - 0x00180B 00:D7FB: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x00180D 00:D7FD: 18        CLC
C - - - - - 0x00180E 00:D7FE: 69 08     ADC #$08
C - - - - - 0x001810 00:D800: 29 F0     AND #$F0
C - - - - - 0x001812 00:D802: AA        TAX
C - - - - - 0x001813 00:D803: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x001815 00:D805: 20 61 DA  JSR sub_DA61_write_object_position
bra_D808:
C - - - - - 0x001818 00:D808: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x00181A 00:D80A: A4 D0     LDY ram_00D0_obj_pos_Y
...
C - - - - - 0x00182F 00:D81F: A5 D1     LDA ram_00D0_obj_graphics
...
bra_D831:
C - - - - - 0x001841 00:D831: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x001843 00:D833: 20 AB D2  JSR sub_D2AB
C - - - - - 0x001846 00:D836: A6 D3     LDX ram_00D0_obj_pos_X
...
C - - - - - 0x00185E 00:D84E: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001860 00:D850: A0 D8     LDY #$D8
C - - - - - 0x001862 00:D852: 20 61 DA  JSR sub_DA61_write_object_position
bra_D855_RTS:
C - - - - - 0x001865 00:D855: 60        RTS
bra_D856:
C - - - - - 0x001866 00:D856: A9 01     LDA #$01
C - - - - - 0x001868 00:D858: 85 48     STA ram_0048_flag
C - - - - - 0x00186A 00:D85A: A5 5A     LDA ram_005A
loc_D85C:
C D 2 - - - 0x00186C 00:D85C: 85 44     STA ram_0044
C - - - - - 0x00186E 00:D85E: A5 D1     LDA ram_00D0_obj_graphics
...
C - - - - - 0x0018A6 00:D896: A5 D1     LDA ram_00D0_obj_graphics
C - - - - - 0x0018A8 00:D898: 29 F8     AND #$F8
C - - - - - 0x0018AA 00:D89A: 05 44     ORA ram_0044
loc_D89C:
C D 2 - - - 0x0018AC 00:D89C: 20 45 DA  JSR sub_DA45_write_object_animation
...
C - - - - - 0x0018C0 00:D8B0: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0018C2 00:D8B2: A4 D0     LDY ram_00D0_obj_pos_Y
...
C - - - - - 0x0018CD 00:D8BD: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0018CF 00:D8BF: A4 D0     LDY ram_00D0_obj_pos_Y
...
- - - - - - 0x0018DE 00:D8CE: A6 4A     LDX ram_004A_pos_X
- - - - - - 0x0018E0 00:D8D0: A5 D0     LDA ram_00D0_obj_pos_Y
- - - - - - 0x0018E2 00:D8D2: 29 F8     AND #$F8
- - - - - - 0x0018E4 00:D8D4: A8        TAY
- - - - - - 0x0018E5 00:D8D5: 20 61 DA  JSR sub_DA61_write_object_position
- - - - - - 0x0018E8 00:D8D8: 60        RTS
bra_D8D9:
C - - - - - 0x0018E9 00:D8D9: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0018EB 00:D8DB: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x0018ED 00:D8DD: 29 F8     AND #$F8
C - - - - - 0x0018EF 00:D8DF: A8        TAY
C - - - - - 0x0018F0 00:D8E0: 20 61 DA  JSR sub_DA61_write_object_position
bra_D8E3_RTS:
C - - - - - 0x0018F3 00:D8E3: 60        RTS
bra_D8E4:
C - - - - - 0x0018F4 00:D8E4: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0018F6 00:D8E6: A4 D0     LDY ram_00D0_obj_pos_Y
...
C - - - - - 0x001905 00:D8F5: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001907 00:D8F7: A4 D0     LDY ram_00D0_obj_pos_Y
...
- - - - - - 0x001912 00:D902: A6 4A     LDX ram_004A_pos_X
- - - - - - 0x001914 00:D904: A4 4B     LDY ram_004B_pos_Y
- - - - - - 0x001916 00:D906: 4C 61 DA  JMP loc_DA61_write_object_position
bra_D909:
...
C - - - - - 0x001936 00:D926: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001938 00:D928: A4 D0     LDY ram_00D0_obj_pos_Y
...
C - - - - - 0x001943 00:D933: A6 4A     LDX ram_004A_pos_X
C - - - - - 0x001945 00:D935: A4 4B     LDY ram_004B_pos_Y
C - - - - - 0x001947 00:D937: 20 61 DA  JSR sub_DA61_write_object_position
C - - - - - 0x00194A 00:D93A: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x00194C 00:D93C: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x00194E 00:D93E: 20 42 E0  JSR sub_E042
C - - - - - 0x001951 00:D941: D0 27     BNE bra_D96A
C - - - - - 0x001953 00:D943: A5 D1     LDA ram_00D0_obj_graphics
C - - - - - 0x001955 00:D945: 29 FB     AND #$FB
C - - - - - 0x001957 00:D947: 09 02     ORA #$02
C - - - - - 0x001959 00:D949: 20 45 DA  JSR sub_DA45_write_object_animation
...
bra_D957:
C - - - - - 0x001967 00:D957: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001969 00:D959: A4 D0     LDY ram_00D0_obj_pos_Y
...
bra_D96A:
C - - - - - 0x00197A 00:D96A: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x00197C 00:D96C: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x00197E 00:D96E: 29 F8     AND #$F8
C - - - - - 0x001980 00:D970: A8        TAY
C - - - - - 0x001981 00:D971: 20 61 DA  JSR sub_DA61_write_object_position
bra_D974:
...
bra_D985:
C - - - - - 0x001995 00:D985: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001997 00:D987: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x001999 00:D989: 29 F0     AND #$F0
C - - - - - 0x00199B 00:D98B: A8        TAY
C - - - - - 0x00199C 00:D98C: 20 61 DA  JSR sub_DA61_write_object_position
C - - - - - 0x00199F 00:D98F: A5 D3     LDA ram_00D0_obj_pos_X
C - - - - - 0x0019A1 00:D991: 85 28     STA ram_0028_temp_pos_X
C - - - - - 0x0019A3 00:D993: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x0019A5 00:D995: 85 29     STA ram_0029_temp_pos_Y
...
C - - - - - 0x0019D8 00:D9C8: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0019DA 00:D9CA: A5 D0     LDA ram_00D0_obj_pos_Y
C - - - - - 0x0019DC 00:D9CC: 18        CLC
C - - - - - 0x0019DD 00:D9CD: 69 04     ADC #$04
C - - - - - 0x0019DF 00:D9CF: A8        TAY
C - - - - - 0x0019E0 00:D9D0: 20 61 DA  JSR sub_DA61_write_object_position
bra_D9D3_RTS:
...
C - - - - - 0x0019F1 00:D9E1: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x0019F3 00:D9E3: A4 D0     LDY ram_00D0_obj_pos_Y
...
C - - - - - 0x0019FE 00:D9EE: A6 4A     LDX ram_004A_pos_X
C - - - - - 0x001A00 00:D9F0: A4 4B     LDY ram_004B_pos_Y
C - - - - - 0x001A02 00:D9F2: 20 61 DA  JSR sub_DA61_write_object_position
C - - - - - 0x001A05 00:D9F5: A5 5E     LDA ram_005E
C - - - - - 0x001A07 00:D9F7: 49 01     EOR #$01
C - - - - - 0x001A09 00:D9F9: 85 5E     STA ram_005E
C - - - - - 0x001A0B 00:D9FB: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001A0D 00:D9FD: A4 D0     LDY ram_00D0_obj_pos_Y
C - - - - - 0x001A0F 00:D9FF: 20 42 E0  JSR sub_E042
C - - - - - 0x001A12 00:DA02: D0 15     BNE bra_DA19_RTS
- - - - - - 0x001A14 00:DA04: A5 D1     LDA ram_00D0_obj_graphics
- - - - - - 0x001A16 00:DA06: 29 FB     AND #$FB
- - - - - - 0x001A18 00:DA08: 09 02     ORA #$02
- - - - - - 0x001A1A 00:DA0A: 20 45 DA  JSR sub_DA45_write_object_animation
...
C - - - - - 0x001A35 00:DA25: A6 D3     LDX ram_00D0_obj_pos_X
C - - - - - 0x001A37 00:DA27: A4 D0     LDY ram_00D0_obj_pos_Y
...
; bzk optimize, delete LDA 01, move STA after 0x001A4A
C - - - - - 0x001A50 00:DA40: A9 01     LDA #$01
C - - - - - 0x001A52 00:DA42: 85 48     STA ram_0048_flag
bra_DA44_RTS:
C - - - - - 0x001A54 00:DA44: 60        RTS



sub_DA45_write_object_animation:
; in
    ; A = tile index
C - - - - - 0x001A55 00:DA45: 48        PHA
C - - - - - 0x001A56 00:DA46: A5 8F     LDA ram_bonus_round_id
C - - - - - 0x001A58 00:DA48: F0 06     BEQ bra_DA50_not_bonus_round
; if bonus round
C - - - - - 0x001A5A 00:DA4A: 68        PLA
C - - - - - 0x001A5B 00:DA4B: A9 60     LDA #$60
; bzk optimize, BNE
C - - - - - 0x001A5D 00:DA4D: 4C 51 DA  JMP loc_DA51
bra_DA50_not_bonus_round:
C - - - - - 0x001A60 00:DA50: 68        PLA
loc_DA51:
C D 2 - - - 0x001A61 00:DA51: AA        TAX
C - - - - - 0x001A62 00:DA52: 86 D1     STX ram_00D0_obj_graphics
C - - - - - 0x001A64 00:DA54: E8        INX
C - - - - - 0x001A65 00:DA55: 86 D5     STX ram_00D0_obj_graphics + $04
C - - - - - 0x001A67 00:DA57: 18        CLC
C - - - - - 0x001A68 00:DA58: 69 10     ADC #$10
C - - - - - 0x001A6A 00:DA5A: 85 DD     STA ram_00D0_obj_graphics + $0C
C - - - - - 0x001A6C 00:DA5C: AA        TAX
C - - - - - 0x001A6D 00:DA5D: E8        INX
C - - - - - 0x001A6E 00:DA5E: 86 D9     STX ram_00D0_obj_graphics + $08
C - - - - - 0x001A70 00:DA60: 60        RTS



sub_DA61_write_object_position:
loc_DA61_write_object_position:
; in
    ; X = pos X
    ; Y = pos Y
C - - - - - 0x001A71 00:DA61: 86 D3     STX ram_00D0_obj_pos_X
C - - - - - 0x001A73 00:DA63: 86 DF     STX ram_00D0_obj_pos_X + $0C
C - - - - - 0x001A75 00:DA65: 8A        TXA
C - - - - - 0x001A76 00:DA66: 18        CLC
C - - - - - 0x001A77 00:DA67: 69 08     ADC #$08
C - - - - - 0x001A79 00:DA69: 85 D7     STA ram_00D0_obj_pos_X + $04
C - - - - - 0x001A7B 00:DA6B: 85 DB     STA ram_00D0_obj_pos_X + $08
C - - - - - 0x001A7D 00:DA6D: 84 D0     STY ram_00D0_obj_pos_Y
C - - - - - 0x001A7F 00:DA6F: 84 D4     STY ram_00D0_obj_pos_Y + $04
C - - - - - 0x001A81 00:DA71: 98        TYA
C - - - - - 0x001A82 00:DA72: 18        CLC
C - - - - - 0x001A83 00:DA73: 69 08     ADC #$08
C - - - - - 0x001A85 00:DA75: 85 D8     STA ram_00D0_obj_pos_Y + $08
C - - - - - 0x001A87 00:DA77: 85 DC     STA ram_00D0_obj_pos_Y + $0C
...
sub_DA7A:
; clear 0050-0057
C - - - - - 0x001A8A 00:DA7A: A2 50     LDX #$50
...
- D 2 - I - 0x001AA4 00:DA94: 00        .byte $00   ; end token
...
- D 2 - I - 0x001AB1 00:DAA1: 00        .byte $00   ; end token
...
- D 2 - I - 0x001ABE 00:DAAE: 00        .byte $00   ; end token



tbl_DAAF_tiles___12_spaces:
- D 2 - I - 0x001ABF 00:DAAF: 20        .byte "            "
- D 2 - I - 0x001ACB 00:DABB: 00        .byte $00   ; end token



tbl_DABC_txt___no_bonus:
- D 2 - I - 0x001ACC 00:DABC: 20        .byte "  NO BONUS  "
- D 2 - I - 0x001AD8 00:DAC8: 00        .byte $00   ; end token
...
C - - - - - 0x001B04 00:DAF4: 20 82 F1  JSR sub_F182_play_music___death
...
C - - - - - 0x001B1D 00:DB0D: 20 E8 DF  JSR sub_DFE8_write_player_animation
C - - - - - 0x001B20 00:DB10: A9 00     LDA #$00
C - - - - - 0x001B22 00:DB12: 8D 22 07  STA ram_player_color
C - - - - - 0x001B25 00:DB15: 8D 26 07  STA ram_player_color + $04
C - - - - - 0x001B28 00:DB18: 8D 2A 07  STA ram_player_color + $08
C - - - - - 0x001B2B 00:DB1B: 8D 2E 07  STA ram_player_color + $0C
...
bra_DB28:
C - - - - - 0x001B38 00:DB28: A6 51     LDX ram_0051_jump_timer
C - - - - - 0x001B3A 00:DB2A: E0 12     CPX #$12
C - - - - - 0x001B3C 00:DB2C: F0 02     BEQ bra_DB30
C - - - - - 0x001B3E 00:DB2E: E6 51     INC ram_0051_jump_timer
bra_DB30:
C - - - - - 0x001B40 00:DB30: AD 20 07  LDA ram_player_pos_Y
C - - - - - 0x001B43 00:DB33: 20 AB D2  JSR sub_D2AB
C - - - - - 0x001B46 00:DB36: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001B49 00:DB39: 20 FC DF  JSR sub_DFFC_write_player_position
loc_DB3C:
C D 2 - - - 0x001B4C 00:DB3C: A9 6C     LDA #$6C
C - - - - - 0x001B4E 00:DB3E: 20 E8 DF  JSR sub_DFE8_write_player_animation
C - - - - - 0x001B51 00:DB41: AD 20 07  LDA ram_player_pos_Y
C - - - - - 0x001B54 00:DB44: C9 D8     CMP #$D8
C - - - - - 0x001B56 00:DB46: 90 09     BCC bra_DB51_RTS
C - - - - - 0x001B58 00:DB48: A5 51     LDA ram_0051_jump_timer
...
bra_DB52:
loc_DB52:
C - - - - - 0x001B62 00:DB52: A5 A7     LDA ram_sound_channel_4_flag
C - - - - - 0x001B64 00:DB54: F0 03     BEQ bra_DB59
C - - - - - 0x001B66 00:DB56: 4C EF C1  JMP loc_C1EF_restart_game
bra_DB59:
C - - - - - 0x001B69 00:DB59: A5 8F     LDA ram_bonus_round_id
C - - - - - 0x001B6B 00:DB5B: F0 19     BEQ bra_DB76_not_bonus_round
; if bonus round
C - - - - - 0x001B6D 00:DB5D: 20 AA EF  JSR sub_EFAA_hide_all_sprites
C - - - - - 0x001B70 00:DB60: A9 BC     LDA #< tbl_DABC_txt___no_bonus
C - - - - - 0x001B72 00:DB62: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x001B74 00:DB64: A9 DA     LDA #> tbl_DABC_txt___no_bonus
C - - - - - 0x001B76 00:DB66: 85 01     STA ram_0000_t06_ppu_data + $01
C - - - - - 0x001B78 00:DB68: A9 2A     LDA #< $212A
C - - - - - 0x001B7A 00:DB6A: 85 02     STA ram_0002_t06_ppu_addr_lo
C - - - - - 0x001B7C 00:DB6C: A9 21     LDA #> $212A
C - - - - - 0x001B7E 00:DB6E: 85 03     STA ram_0003_t02_ppu_addr_hi
C - - - - - 0x001B80 00:DB70: 20 D7 EB  JSR sub_EBD7_write_data_to_buffer
C - - - - - 0x001B83 00:DB73: 4C 26 DC  JMP loc_DC26
bra_DB76_not_bonus_round:
C - - - - - 0x001B86 00:DB76: A5 E0     LDA ram_players_counter
C - - - - - 0x001B88 00:DB78: D0 47     BNE bra_DBC1_2_players
; if 1 player
C - - - - - 0x001B8A 00:DB7A: C6 BE     DEC ram_milk_p1
C - - - - - 0x001B8C 00:DB7C: 10 40     BPL bra_DBBE_still_has_milk
C - - - - - 0x001B8E 00:DB7E: A9 FF     LDA #$FF
C - - - - - 0x001B90 00:DB80: 85 E2     STA ram_game_over_flag
loc_DB82:
C D 2 - - - 0x001B92 00:DB82: 20 AA EF  JSR sub_EFAA_hide_all_sprites
C - - - - - 0x001B95 00:DB85: A9 AF     LDA #< tbl_DAAF_tiles___12_spaces
C - - - - - 0x001B97 00:DB87: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x001B99 00:DB89: A9 DA     LDA #> tbl_DAAF_tiles___12_spaces
C - - - - - 0x001B9B 00:DB8B: 85 01     STA ram_0000_t06_ppu_data + $01
C - - - - - 0x001B9D 00:DB8D: A9 CA     LDA #< $21CA
C - - - - - 0x001B9F 00:DB8F: 85 02     STA ram_0002_t06_ppu_addr_lo
C - - - - - 0x001BA1 00:DB91: A9 21     LDA #> $21CA
C - - - - - 0x001BA3 00:DB93: 85 03     STA ram_0003_t02_ppu_addr_hi
C - - - - - 0x001BA5 00:DB95: 20 D7 EB  JSR sub_EBD7_write_data_to_buffer
C - - - - - 0x001BA8 00:DB98: A9 88     LDA #< tbl_DA88_txt___game_over
C - - - - - 0x001BAA 00:DB9A: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x001BAC 00:DB9C: A9 DA     LDA #> tbl_DA88_txt___game_over
C - - - - - 0x001BAE 00:DB9E: 85 01     STA ram_0000_t06_ppu_data + $01
C - - - - - 0x001BB0 00:DBA0: A9 EA     LDA #< $21EA
C - - - - - 0x001BB2 00:DBA2: 85 02     STA ram_0002_t06_ppu_addr_lo
C - - - - - 0x001BB4 00:DBA4: A9 21     LDA #> $21EA
C - - - - - 0x001BB6 00:DBA6: 85 03     STA ram_0003_t02_ppu_addr_hi
C - - - - - 0x001BB8 00:DBA8: 20 D7 EB  JSR sub_EBD7_write_data_to_buffer
C - - - - - 0x001BBB 00:DBAB: A9 AF     LDA #< tbl_DAAF_tiles___12_spaces
C - - - - - 0x001BBD 00:DBAD: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x001BBF 00:DBAF: A9 DA     LDA #> tbl_DAAF_tiles___12_spaces
C - - - - - 0x001BC1 00:DBB1: 85 01     STA ram_0000_t06_ppu_data + $01
C - - - - - 0x001BC3 00:DBB3: A9 0A     LDA #< $220A
C - - - - - 0x001BC5 00:DBB5: 85 02     STA ram_0002_t06_ppu_addr_lo
C - - - - - 0x001BC7 00:DBB7: A9 22     LDA #> $220A
C - - - - - 0x001BC9 00:DBB9: 85 03     STA ram_0003_t02_ppu_addr_hi
C - - - - - 0x001BCB 00:DBBB: 20 D7 EB  JSR sub_EBD7_write_data_to_buffer
bra_DBBE_still_has_milk:
C - - - - - 0x001BCE 00:DBBE: 4C 26 DC  JMP loc_DC26
bra_DBC1_2_players:
C - - - - - 0x001BD1 00:DBC1: A5 E1     LDA ram_00E1_current_player
C - - - - - 0x001BD3 00:DBC3: D0 1F     BNE bra_DBE4_it_is_p2
; it is p1
C - - - - - 0x001BD5 00:DBC5: A9 01     LDA #$01
C - - - - - 0x001BD7 00:DBC7: 85 E1     STA ram_00E1_current_player
C - - - - - 0x001BD9 00:DBC9: C6 BE     DEC ram_milk_p1
C - - - - - 0x001BDB 00:DBCB: 10 F1     BPL bra_DBBE_still_has_milk
; game over for player 1
C - - - - - 0x001BDD 00:DBCD: A5 E2     LDA ram_game_over_flag
C - - - - - 0x001BDF 00:DBCF: 09 F0     ORA #$F0
C - - - - - 0x001BE1 00:DBD1: 85 E2     STA ram_game_over_flag
C - - - - - 0x001BE3 00:DBD3: 20 03 DC  JSR sub_DC03_print_12_spaces
C - - - - - 0x001BE6 00:DBD6: A9 95     LDA #< tbl_DA95_txt___player_I
C - - - - - 0x001BE8 00:DBD8: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x001BEA 00:DBDA: A9 DA     LDA #> tbl_DA95_txt___player_I
C - - - - - 0x001BEC 00:DBDC: 85 01     STA ram_0000_t06_ppu_data + $01
C - - - - - 0x001BEE 00:DBDE: 20 17 DC  JSR sub_DC17
C - - - - - 0x001BF1 00:DBE1: 4C 82 DB  JMP loc_DB82
bra_DBE4_it_is_p2:
C - - - - - 0x001BF4 00:DBE4: A9 00     LDA #$00
C - - - - - 0x001BF6 00:DBE6: 85 E1     STA ram_00E1_current_player
C - - - - - 0x001BF8 00:DBE8: C6 BF     DEC ram_milk_p2
C - - - - - 0x001BFA 00:DBEA: 10 D2     BPL bra_DBBE_still_has_milk
; game over for player 2
C - - - - - 0x001BFC 00:DBEC: A5 E2     LDA ram_game_over_flag
C - - - - - 0x001BFE 00:DBEE: 09 0F     ORA #$0F
C - - - - - 0x001C00 00:DBF0: 85 E2     STA ram_game_over_flag
C - - - - - 0x001C02 00:DBF2: 20 03 DC  JSR sub_DC03_print_12_spaces
C - - - - - 0x001C05 00:DBF5: A9 A2     LDA #< tbl_DAA2_txt___player_II
C - - - - - 0x001C07 00:DBF7: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x001C09 00:DBF9: A9 DA     LDA #> tbl_DAA2_txt___player_II
C - - - - - 0x001C0B 00:DBFB: 85 01     STA ram_0000_t06_ppu_data + $01
...
C - - - - - 0x001C15 00:DC05: 85 00     STA ram_0000_t06_ppu_data
C - - - - - 0x001C17 00:DC07: A9 DA     LDA #> tbl_DAAF_tiles___12_spaces
C - - - - - 0x001C19 00:DC09: 85 01     STA ram_0000_t06_ppu_data + $01
C - - - - - 0x001C1B 00:DC0B: A9 8A     LDA #< $218A
C - - - - - 0x001C1D 00:DC0D: 85 02     STA ram_0002_t06_ppu_addr_lo
C - - - - - 0x001C1F 00:DC0F: A9 21     LDA #> $218A
C - - - - - 0x001C21 00:DC11: 85 03     STA ram_0003_t02_ppu_addr_hi
; bzk optimize, JMP
C - - - - - 0x001C23 00:DC13: 20 D7 EB  JSR sub_EBD7_write_data_to_buffer
...
sub_DC17:
; in
    ; ram_0000_t06_ppu_data
C - - - - - 0x001C27 00:DC17: A9 AA     LDA #< $21AA
C - - - - - 0x001C29 00:DC19: 85 02     STA ram_0002_t06_ppu_addr_lo
C - - - - - 0x001C2B 00:DC1B: A9 21     LDA #> $21AA
C - - - - - 0x001C2D 00:DC1D: 85 03     STA ram_0003_t02_ppu_addr_hi
C - - - - - 0x001C2F 00:DC1F: 20 D7 EB  JSR sub_EBD7_write_data_to_buffer
; bzk optimize, JMP
...
C - - - - - 0x001C39 00:DC29: A9 00     LDA #$00    ; not bonus round
C - - - - - 0x001C3B 00:DC2B: 85 8F     STA ram_bonus_round_id
C - - - - - 0x001C3D 00:DC2D: 20 70 C2  JSR sub_C270
C - - - - - 0x001C40 00:DC30: A9 07     LDA #$07
C - - - - - 0x001C42 00:DC32: 20 0C C6  JSR sub_C60C_long_wait
C - - - - - 0x001C45 00:DC35: A5 E2     LDA ram_game_over_flag
C - - - - - 0x001C47 00:DC37: F0 0E     BEQ bra_DC47
C - - - - - 0x001C49 00:DC39: A9 14     LDA #$14
C - - - - - 0x001C4B 00:DC3B: 20 0C C6  JSR sub_C60C_long_wait
C - - - - - 0x001C4E 00:DC3E: A5 E2     LDA ram_game_over_flag
C - - - - - 0x001C50 00:DC40: C9 FF     CMP #$FF
C - - - - - 0x001C52 00:DC42: D0 03     BNE bra_DC47
; if total game over
C - - - - - 0x001C54 00:DC44: 4C EF C1  JMP loc_C1EF_restart_game
bra_DC47:
C - - - - - 0x001C57 00:DC47: 20 62 C2  JSR sub_C262_check_for_bonus_round
C - - - - - 0x001C5A 00:DC4A: F0 03     BEQ bra_DC4F_not_bonus_round
; if bonus round
C - - - - - 0x001C5C 00:DC4C: 4C C2 C2  JMP loc_C2C2_bonus_round
bra_DC4F_not_bonus_round:
C - - - - - 0x001C5F 00:DC4F: 4C 08 C3  JMP loc_C308_not_bonus_round



loc_DC52:
C D 2 - - - 0x001C62 00:DC52: A9 00     LDA #$00
C - - - - - 0x001C64 00:DC54: 85 48     STA ram_0048_flag
C - - - - - 0x001C66 00:DC56: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001C69 00:DC59: AC 20 07  LDY ram_player_pos_Y
C - - - - - 0x001C6C 00:DC5C: 86 4A     STX ram_004A_pos_X
C - - - - - 0x001C6E 00:DC5E: 84 4B     STY ram_004B_pos_Y
C - - - - - 0x001C70 00:DC60: A5 50     LDA ram_jump_flag
...
C - - - - - 0x001C8B 00:DC7B: 20 E8 DF  JSR sub_DFE8_write_player_animation
...
C - - - - - 0x001C9F 00:DC8F: 20 E8 DF  JSR sub_DFE8_write_player_animation
...
C - - - - - 0x001CB7 00:DCA7: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001CBA 00:DCAA: AC 20 07  LDY ram_player_pos_Y
C - - - - - 0x001CBD 00:DCAD: 20 56 E0  JSR sub_E056
C - - - - - 0x001CC0 00:DCB0: C9 03     CMP #$03
C - - - - - 0x001CC2 00:DCB2: D0 29     BNE bra_DCDD
C - - - - - 0x001CC4 00:DCB4: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001CC7 00:DCB7: AC 20 07  LDY ram_player_pos_Y
C - - - - - 0x001CCA 00:DCBA: 20 BF E0  JSR sub_E0BF
C - - - - - 0x001CCD 00:DCBD: C9 03     CMP #$03
C - - - - - 0x001CCF 00:DCBF: D0 0D     BNE bra_DCCE
C - - - - - 0x001CD1 00:DCC1: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001CD4 00:DCC4: AC 20 07  LDY ram_player_pos_Y
C - - - - - 0x001CD7 00:DCC7: 20 C7 E0  JSR sub_E0C7
C - - - - - 0x001CDA 00:DCCA: C9 03     CMP #$03
C - - - - - 0x001CDC 00:DCCC: F0 0F     BEQ bra_DCDD
bra_DCCE:
C - - - - - 0x001CDE 00:DCCE: AD 23 07  LDA ram_player_pos_X
C - - - - - 0x001CE1 00:DCD1: 18        CLC
C - - - - - 0x001CE2 00:DCD2: 69 08     ADC #$08
C - - - - - 0x001CE4 00:DCD4: 29 F0     AND #$F0
C - - - - - 0x001CE6 00:DCD6: AA        TAX
C - - - - - 0x001CE7 00:DCD7: AC 20 07  LDY ram_player_pos_Y
C - - - - - 0x001CEA 00:DCDA: 20 FC DF  JSR sub_DFFC_write_player_position
bra_DCDD:
C - - - - - 0x001CED 00:DCDD: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001CF0 00:DCE0: AC 20 07  LDY ram_player_pos_Y
...
loc_DD05:
C D 2 - - - 0x001D15 00:DD05: A6 51     LDX ram_0051_jump_timer
...
C - - - - - 0x001D23 00:DD13: 20 ED EF  JSR sub_EFED_play_sound___long_fall
bra_DD16:
C - - - - - 0x001D26 00:DD16: 4C 1B DD  JMP loc_DD1B
bra_DD19:
C - - - - - 0x001D29 00:DD19: E6 51     INC ram_0051_jump_timer
loc_DD1B:
C D 2 - - - 0x001D2B 00:DD1B: AD 20 07  LDA ram_player_pos_Y
C - - - - - 0x001D2E 00:DD1E: 20 AB D2  JSR sub_D2AB
C - - - - - 0x001D31 00:DD21: AE 23 07  LDX ram_player_pos_X
...
C - - - - - 0x001D44 00:DD34: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001D47 00:DD37: A0 D8     LDY #$D8
C - - - - - 0x001D49 00:DD39: 20 FC DF  JSR sub_DFFC_write_player_position
C - - - - - 0x001D4C 00:DD3C: A9 00     LDA #$00
C - - - - - 0x001D4E 00:DD3E: 85 34     STA ram_sound_channel_1_flag
C - - - - - 0x001D50 00:DD40: 85 3C     STA ram_sound_channel_3_flag
C - - - - - 0x001D52 00:DD42: 60        RTS
bra_DD43:
C - - - - - 0x001D53 00:DD43: A9 01     LDA #$01
C - - - - - 0x001D55 00:DD45: 85 48     STA ram_0048_flag
...
C - - - - - 0x001D7C 00:DD6C: 20 FC DF  JSR sub_DFFC_write_player_position
C - - - - - 0x001D7F 00:DD6F: A5 50     LDA ram_jump_flag
...
C - - - - - 0x001DB5 00:DDA5: 20 E8 DF  JSR sub_DFE8_write_player_animation
...
sub_DDC2:
C - - - - - 0x001DD2 00:DDC2: A5 CC     LDA ram_00CC_flag
C - - - - - 0x001DD4 00:DDC4: D0 3E     BNE bra_DE04_RTS
C - - - - - 0x001DD6 00:DDC6: A5 50     LDA ram_jump_flag
C - - - - - 0x001DD8 00:DDC8: D0 3A     BNE bra_DE04_RTS
C - - - - - 0x001DDA 00:DDCA: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001DDD 00:DDCD: AC 20 07  LDY ram_player_pos_Y
C - - - - - 0x001DE0 00:DDD0: 20 1D E0  JSR sub_E01D_get_block_index_from_round_data
C - - - - - 0x001DE3 00:DDD3: F0 30     BEQ bra_DE05_empty_block
C - - - - - 0x001DE5 00:DDD5: C9 03     CMP #$03    ; ladder
C - - - - - 0x001DE7 00:DDD7: F0 2B     BEQ bra_DE04_RTS
C - - - - - 0x001DE9 00:DDD9: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001DEC 00:DDDC: AC 20 07  LDY ram_player_pos_Y
...
C - - - - - 0x001DFC 00:DDEC: A6 4A     LDX ram_004A_pos_X
C - - - - - 0x001DFE 00:DDEE: AD 20 07  LDA ram_player_pos_Y
C - - - - - 0x001E01 00:DDF1: 29 F8     AND #$F8
C - - - - - 0x001E03 00:DDF3: A8        TAY
C - - - - - 0x001E04 00:DDF4: 20 FC DF  JSR sub_DFFC_write_player_position
C - - - - - 0x001E07 00:DDF7: 60        RTS
bra_DDF8:
C - - - - - 0x001E08 00:DDF8: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001E0B 00:DDFB: AD 20 07  LDA ram_player_pos_Y
C - - - - - 0x001E0E 00:DDFE: 29 F8     AND #$F8
C - - - - - 0x001E10 00:DE00: A8        TAY
C - - - - - 0x001E11 00:DE01: 20 FC DF  JSR sub_DFFC_write_player_position
bra_DE04_RTS:
C - - - - - 0x001E14 00:DE04: 60        RTS
bra_DE05_empty_block:
C - - - - - 0x001E15 00:DE05: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001E18 00:DE08: AC 20 07  LDY ram_player_pos_Y
...
C - - - - - 0x001E28 00:DE18: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001E2B 00:DE1B: AC 20 07  LDY ram_player_pos_Y
...
- - - - - - 0x001E37 00:DE27: A6 4A     LDX ram_004A_pos_X
- - - - - - 0x001E39 00:DE29: A4 4B     LDY ram_004B_pos_Y
- - - - - - 0x001E3B 00:DE2B: 4C FC DF  JMP loc_DFFC_write_player_position
bra_DE2E:
...
bra_DE3E:
; player is falling off a ladder
C - - - - - 0x001E4E 00:DE3E: A9 01     LDA #$01
C - - - - - 0x001E50 00:DE40: 85 50     STA ram_jump_flag
C - - - - - 0x001E52 00:DE42: A9 0B     LDA #$0B
C - - - - - 0x001E54 00:DE44: 85 51     STA ram_0051_jump_timer
bra_DE46_RTS:
...
sub_DE47:
C - - - - - 0x001E57 00:DE47: A5 50     LDA ram_jump_flag
C - - - - - 0x001E59 00:DE49: F0 FB     BEQ bra_DE46_RTS
C - - - - - 0x001E5B 00:DE4B: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001E5E 00:DE4E: AC 20 07  LDY ram_player_pos_Y
...
C - - - - - 0x001E6A 00:DE5A: A6 4A     LDX ram_004A_pos_X
C - - - - - 0x001E6C 00:DE5C: A4 4B     LDY ram_004B_pos_Y
C - - - - - 0x001E6E 00:DE5E: 20 FC DF  JSR sub_DFFC_write_player_position
C - - - - - 0x001E71 00:DE61: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001E74 00:DE64: AC 20 07  LDY ram_player_pos_Y
C - - - - - 0x001E77 00:DE67: 20 1D E0  JSR sub_E01D_get_block_index_from_round_data
C - - - - - 0x001E7A 00:DE6A: D0 40     BNE bra_DEAC_not_empty_block
; if empty block
...
C - - - - - 0x001E87 00:DE77: 20 E8 DF  JSR sub_DFE8_write_player_animation
bra_DE7A:
C - - - - - 0x001E8A 00:DE7A: A9 01     LDA #$01    ; player is jumping
C - - - - - 0x001E8C 00:DE7C: 85 50     STA ram_jump_flag
C - - - - - 0x001E8E 00:DE7E: A9 0B     LDA #$0B
C - - - - - 0x001E90 00:DE80: 85 51     STA ram_0051_jump_timer
C - - - - - 0x001E92 00:DE82: 4C D5 DE  JMP loc_DED5
bra_DE85:
C - - - - - 0x001E95 00:DE85: A6 52     LDX ram_0052
C - - - - - 0x001E97 00:DE87: BD B9 DD  LDA tbl_DDB9,X
C - - - - - 0x001E9A 00:DE8A: 20 E8 DF  JSR sub_DFE8_write_player_animation
C - - - - - 0x001E9D 00:DE8D: 20 E8 EF  JSR sub_EFE8
bra_DE90:
C - - - - - 0x001EA0 00:DE90: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001EA3 00:DE93: AC 20 07  LDY ram_player_pos_Y
C - - - - - 0x001EA6 00:DE96: 20 1D E0  JSR sub_E01D_get_block_index_from_round_data
C - - - - - 0x001EA9 00:DE99: F0 3E     BEQ bra_DED9_RTS    ; if empty block
C - - - - - 0x001EAB 00:DE9B: C9 07     CMP #$07    ; spring
C - - - - - 0x001EAD 00:DE9D: F0 4A     BEQ bra_DEE9_spring
C - - - - - 0x001EAF 00:DE9F: C9 03     CMP #$03    ; ladder
C - - - - - 0x001EB1 00:DEA1: F0 03     BEQ bra_DEA6_ladder
; if brick
C - - - - - 0x001EB3 00:DEA3: 20 28 F1  JSR sub_F128_play_sound___falling_on_ground
bra_DEA6_ladder:
C - - - - - 0x001EB6 00:DEA6: A5 51     LDA ram_0051_jump_timer
C - - - - - 0x001EB8 00:DEA8: C9 0B     CMP #$0B
C - - - - - 0x001EBA 00:DEAA: 90 0F     BCC bra_DEBB
bra_DEAC_not_empty_block:
C - - - - - 0x001EBC 00:DEAC: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001EBF 00:DEAF: AD 20 07  LDA ram_player_pos_Y
C - - - - - 0x001EC2 00:DEB2: 29 F8     AND #$F8
C - - - - - 0x001EC4 00:DEB4: A8        TAY
C - - - - - 0x001EC5 00:DEB5: 20 FC DF  JSR sub_DFFC_write_player_position
C - - - - - 0x001EC8 00:DEB8: 20 05 CB  JSR sub_CB05
bra_DEBB:
C - - - - - 0x001ECB 00:DEBB: A9 00     LDA #$00
C - - - - - 0x001ECD 00:DEBD: 85 50     STA ram_jump_flag
...
C - - - - - 0x001EE1 00:DED1: A5 24     LDA ram_btn_AB_flag
...
bra_DEDA:
C - - - - - 0x001EEA 00:DEDA: 20 0C F1  JSR sub_F10C_play_sound___jump
...
C - - - - - 0x001EF4 00:DEE4: 85 CC     STA ram_00CC_flag
C - - - - - 0x001EF6 00:DEE6: 4C D5 DE  JMP loc_DED5
bra_DEE9_spring:
C - - - - - 0x001EF9 00:DEE9: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001EFC 00:DEEC: AD 20 07  LDA ram_player_pos_Y
C - - - - - 0x001EFF 00:DEEF: 29 F0     AND #$F0
C - - - - - 0x001F01 00:DEF1: A8        TAY
C - - - - - 0x001F02 00:DEF2: 20 FC DF  JSR sub_DFFC_write_player_position
C - - - - - 0x001F05 00:DEF5: AD 23 07  LDA ram_player_pos_X
C - - - - - 0x001F08 00:DEF8: 85 28     STA ram_0028_temp_pos_X
C - - - - - 0x001F0A 00:DEFA: AD 20 07  LDA ram_player_pos_Y
C - - - - - 0x001F0D 00:DEFD: 85 29     STA ram_0029_temp_pos_Y
...
C - - - - - 0x001F43 00:DF33: A5 24     LDA ram_btn_AB_flag
C - - - - - 0x001F45 00:DF35: D0 06     BNE bra_DF3D
C - - - - - 0x001F47 00:DF37: A9 01     LDA #$01
C - - - - - 0x001F49 00:DF39: 85 24     STA ram_btn_AB_flag
C - - - - - 0x001F4B 00:DF3B: A2 00     LDX #$00
bra_DF3D:
C - - - - - 0x001F4D 00:DF3D: 86 51     STX ram_0051_jump_timer
C - - - - - 0x001F4F 00:DF3F: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001F52 00:DF42: AD 20 07  LDA ram_player_pos_Y
C - - - - - 0x001F55 00:DF45: 18        CLC
C - - - - - 0x001F56 00:DF46: 69 04     ADC #$04
C - - - - - 0x001F58 00:DF48: A8        TAY
C - - - - - 0x001F59 00:DF49: 20 FC DF  JSR sub_DFFC_write_player_position
bra_DF4C_RTS:
...
sub_DF56:
C - - - - - 0x001F66 00:DF56: A5 50     LDA ram_jump_flag
C - - - - - 0x001F68 00:DF58: D0 3B     BNE bra_DF95_RTS
C - - - - - 0x001F6A 00:DF5A: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001F6D 00:DF5D: AC 20 07  LDY ram_player_pos_Y
...
C - - - - - 0x001F79 00:DF69: A6 4A     LDX ram_004A_pos_X
C - - - - - 0x001F7B 00:DF6B: A4 4B     LDY ram_004B_pos_Y
C - - - - - 0x001F7D 00:DF6D: 20 FC DF  JSR sub_DFFC_write_player_position
C - - - - - 0x001F80 00:DF70: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001F83 00:DF73: AC 20 07  LDY ram_player_pos_Y
C - - - - - 0x001F86 00:DF76: 20 1D E0  JSR sub_E01D_get_block_index_from_round_data
...
- - - - - - 0x001F96 00:DF86: 20 E8 DF  JSR sub_DFE8_write_player_animation
bra_DF89:
- - - - - - 0x001F99 00:DF89: A9 01     LDA #$01    ; player is jumping
- - - - - - 0x001F9B 00:DF8B: 85 50     STA ram_jump_flag
- - - - - - 0x001F9D 00:DF8D: A9 0B     LDA #$0B
- - - - - - 0x001F9F 00:DF8F: 85 51     STA ram_0051_jump_timer
...
sub_DF96:
C - - - - - 0x001FA6 00:DF96: A5 50     LDA ram_jump_flag
...
C - - - - - 0x001FB8 00:DFA8: A5 24     LDA ram_btn_AB_flag
C - - - - - 0x001FBA 00:DFAA: D0 28     BNE bra_DFD4_RTS
C - - - - - 0x001FBC 00:DFAC: A9 01     LDA #$01
C - - - - - 0x001FBE 00:DFAE: 85 24     STA ram_btn_AB_flag
C - - - - - 0x001FC0 00:DFB0: AE 23 07  LDX ram_player_pos_X
C - - - - - 0x001FC3 00:DFB3: AC 20 07  LDY ram_player_pos_Y
C - - - - - 0x001FC6 00:DFB6: 20 1D E0  JSR sub_E01D_get_block_index_from_round_data
C - - - - - 0x001FC9 00:DFB9: C9 01     CMP #$01    ; pipe
C - - - - - 0x001FCB 00:DFBB: F0 08     BEQ bra_DFC5_is_able_to_jump
C - - - - - 0x001FCD 00:DFBD: C9 02     CMP #$02    ; brick
C - - - - - 0x001FCF 00:DFBF: F0 04     BEQ bra_DFC5_is_able_to_jump
C - - - - - 0x001FD1 00:DFC1: C9 07     CMP #$07    ; spring
C - - - - - 0x001FD3 00:DFC3: D0 0F     BNE bra_DFD4_RTS
bra_DFC5_is_able_to_jump:
; player is jumping off a platform
C - - - - - 0x001FD5 00:DFC5: A9 01     LDA #$01
C - - - - - 0x001FD7 00:DFC7: 85 50     STA ram_jump_flag
C - - - - - 0x001FD9 00:DFC9: A9 03     LDA #$03
C - - - - - 0x001FDB 00:DFCB: 85 51     STA ram_0051_jump_timer
C - - - - - 0x001FDD 00:DFCD: A9 01     LDA #$01
C - - - - - 0x001FDF 00:DFCF: 85 48     STA ram_0048_flag
; bzk optimize, JMP
C - - - - - 0x001FE1 00:DFD1: 20 0C F1  JSR sub_F10C_play_sound___jump
bra_DFD4_RTS:
...
sub_DFE8_write_player_animation:
; in
    ; A = tile index
...
sub_DFFC_write_player_position:
loc_DFFC_write_player_position:
; in
    ; X = pos X
    ; Y = pos Y
C - - - - - 0x00200C 00:DFFC: 8E 23 07  STX ram_player_pos_X
C - - - - - 0x00200F 00:DFFF: 8E 2F 07  STX ram_player_pos_X + $0C
C - - - - - 0x002012 00:E002: 8A        TXA
C - - - - - 0x002013 00:E003: 18        CLC
C - - - - - 0x002014 00:E004: 69 08     ADC #$08
C - - - - - 0x002016 00:E006: 8D 27 07  STA ram_player_pos_X + $04
C - - - - - 0x002019 00:E009: 8D 2B 07  STA ram_player_pos_X + $08
C - - - - - 0x00201C 00:E00C: 8C 20 07  STY ram_player_pos_Y
C - - - - - 0x00201F 00:E00F: 8C 24 07  STY ram_player_pos_Y + $04
C - - - - - 0x002022 00:E012: 98        TYA
C - - - - - 0x002023 00:E013: 18        CLC
C - - - - - 0x002024 00:E014: 69 08     ADC #$08
C - - - - - 0x002026 00:E016: 8D 28 07  STA ram_player_pos_Y + $08
C - - - - - 0x002029 00:E019: 8D 2C 07  STA ram_player_pos_Y + $0C
C - - - - - 0x00202C 00:E01C: 60        RTS



sub_E01D_get_block_index_from_round_data:
; out
    ; A = block id
    ; Z
        ; 0 = empty block
...
loc_E03D:
C D 3 - - - 0x00204D 00:E03D: 85 28     STA ram_0028_temp_pos_X
C - - - - - 0x00204F 00:E03F: 4C 48 E0  JMP loc_E048
bra_E042:
sub_E042:
; out
    ; ram_0000_t04_round_data
    ; A = 
    ; Z
        ; 0 = 
        ; 1 = 
...
C - - - - - 0x002056 00:E046: 85 28     STA ram_0028_temp_pos_X
loc_E048:
C D 3 - - - 0x002058 00:E048: 98        TYA
C - - - - - 0x002059 00:E049: 38        SEC
C - - - - - 0x00205A 00:E04A: E9 20     SBC #$20
C - - - - - 0x00205C 00:E04C: 85 29     STA ram_0029_temp_pos_Y
C - - - - - 0x00205E 00:E04E: 20 CF E0  JSR sub_E0CF_calculate_round_data_address
C - - - - - 0x002061 00:E051: A0 10     LDY #$10
C - - - - - 0x002063 00:E053: B1 00     LDA (ram_0000_t04_round_data),Y
...
loc_E076:
C D 3 - - - 0x002086 00:E076: 85 28     STA ram_0028_temp_pos_X
...
C - - - - - 0x00208F 00:E07F: 85 28     STA ram_0028_temp_pos_X
loc_E081:
C D 3 - - - 0x002091 00:E081: 98        TYA
C - - - - - 0x002092 00:E082: 38        SEC
C - - - - - 0x002093 00:E083: E9 18     SBC #$18
C - - - - - 0x002095 00:E085: 85 29     STA ram_0029_temp_pos_Y
C - - - - - 0x002097 00:E087: 20 CF E0  JSR sub_E0CF_calculate_round_data_address
C - - - - - 0x00209A 00:E08A: A0 00     LDY #$00
C - - - - - 0x00209C 00:E08C: B1 00     LDA (ram_0000_t04_round_data),Y
...
sub_E0AB_read_byte_from_round_data:
C - - - - - 0x0020BB 00:E0AB: 8A        TXA
C - - - - - 0x0020BC 00:E0AC: 18        CLC
C - - - - - 0x0020BD 00:E0AD: 69 08     ADC #$08
C - - - - - 0x0020BF 00:E0AF: 85 28     STA ram_0028_temp_pos_X
C - - - - - 0x0020C1 00:E0B1: 98        TYA
C - - - - - 0x0020C2 00:E0B2: 38        SEC
C - - - - - 0x0020C3 00:E0B3: E9 28     SBC #$28
C - - - - - 0x0020C5 00:E0B5: 85 29     STA ram_0029_temp_pos_Y
C - - - - - 0x0020C7 00:E0B7: 20 CF E0  JSR sub_E0CF_calculate_round_data_address
C - - - - - 0x0020CA 00:E0BA: A0 00     LDY #$00
C - - - - - 0x0020CC 00:E0BC: B1 00     LDA (ram_0000_t04_round_data),Y
...
C - - - - - 0x0020D2 00:E0C2: C6 00     DEC ram_0000_t04_round_data
C - - - - - 0x0020D4 00:E0C4: B1 00     LDA (ram_0000_t04_round_data),Y
...
C - - - - - 0x0020DA 00:E0CA: E6 00     INC ram_0000_t04_round_data
C - - - - - 0x0020DC 00:E0CC: B1 00     LDA (ram_0000_t04_round_data),Y
C - - - - - 0x0020DE 00:E0CE: 60        RTS



sub_E0CF_calculate_round_data_address:
; out
    ; ram_0000_t04_round_data
C - - - - - 0x0020DF 00:E0CF: 20 DC E8  JSR sub_E8DC_divide_position_by_10
; bzk optimize, JMP
C - - - - - 0x0020E2 00:E0D2: 20 6D E3  JSR sub_E36D_calculate_round_data_address
C - - - - - 0x0020E5 00:E0D5: 60        RTS



sub_E0D6_animation:
; animation cycle or something
...
C - - - - - 0x0020F2 00:E0E2: A5 48     LDA ram_0048_flag
...
; bzk optimize, ORA 00 does nothing useful
...
C - - - - - 0x00214A 00:E13A: 9D 80 02  STA ram_copy_oam,X
...
C - - - - - 0x002154 00:E144: 85 8E     STA ram_008E_flag
; bzk optimize, loading same A
C - - - - - 0x002156 00:E146: A9 01     LDA #$01
C - - - - - 0x002158 00:E148: 85 E0     STA ram_players_counter
C - - - - - 0x00215A 00:E14A: A9 01     LDA #$01
C - - - - - 0x00215C 00:E14C: 85 20     STA ram_current_round
C - - - - - 0x00215E 00:E14E: A9 07     LDA #$07
C - - - - - 0x002160 00:E150: 85 28     STA ram_0028_temp_pos_X
C - - - - - 0x002162 00:E152: A9 05     LDA #$05
C - - - - - 0x002164 00:E154: 85 29     STA ram_0029_temp_pos_Y
C - - - - - 0x002166 00:E156: A9 00     LDA #$00
C - - - - - 0x002168 00:E158: 85 2A     STA ram_constructor_block_id
...
C - - - - - 0x00217F 00:E16F: A5 9E     LDA ram_009E_flag
C - - - - - 0x002181 00:E171: D0 3B     BNE bra_E1AE
C - - - - - 0x002183 00:E173: A5 9F     LDA ram_009F_flag
C - - - - - 0x002185 00:E175: D0 37     BNE bra_E1AE
; check all 8 buttons
C - - - - - 0x002187 00:E177: A9 80     LDA #$80
C - - - - - 0x002189 00:E179: 85 00     STA ram_0000_t09
C - - - - - 0x00218B 00:E17B: A0 00     LDY #$00
bra_E17D_loop:
C - - - - - 0x00218D 00:E17D: A5 1A     LDA ram_btn_hold
C - - - - - 0x00218F 00:E17F: 25 00     AND ram_0000_t09
C - - - - - 0x002191 00:E181: D0 09     BNE bra_E18C_match
C - - - - - 0x002193 00:E183: C8        INY
C - - - - - 0x002194 00:E184: C8        INY
C - - - - - 0x002195 00:E185: 46 00     LSR ram_0000_t09
C - - - - - 0x002197 00:E187: 90 F4     BCC bra_E17D_loop
; if nothing pressed
C - - - - - 0x002199 00:E189: 4C 9F E1  JMP loc_E19F
bra_E18C_match:
C - - - - - 0x00219C 00:E18C: B9 C1 E1  LDA tbl_E1C1_level_editor_control,Y
C - - - - - 0x00219F 00:E18F: 85 00     STA ram_0000_t07_jmp
C - - - - - 0x0021A1 00:E191: B9 C2 E1  LDA tbl_E1C1_level_editor_control + $01,Y
C - - - - - 0x0021A4 00:E194: 85 01     STA ram_0000_t07_jmp + $01
C - - - - - 0x0021A6 00:E196: 20 9C E1  JSR sub_E19C_indirect_jump
C - - - - - 0x0021A9 00:E199: 4C 9F E1  JMP loc_E19F



sub_E19C_indirect_jump:
C - - - - - 0x0021AC 00:E19C: 6C 00 00  JMP (ram_0000_t07_jmp)
...
C - - - - - 0x0021C8 00:E1B8: 85 9E     STA ram_009E_flag
; bzk optimize, loading same A
C - - - - - 0x0021CA 00:E1BA: A9 00     LDA #$00
C - - - - - 0x0021CC 00:E1BC: 85 9F     STA ram_009F_flag
C - - - - - 0x0021CE 00:E1BE: 4C 69 E1  JMP loc_E169



tbl_E1C1_level_editor_control:
; press buttons to do something in the editor
...
C - - - - - 0x0021E3 00:E1D3: 85 8E     STA ram_008E_flag
...
- - - - - - 0x0021F5 00:E1E5: 85 9F     STA ram_009F_flag
...
- - - - - - 0x00220A 00:E1FA: 85 9F     STA ram_009F_flag
...
C - - - - - 0x00222B 00:E21B: A6 2A     LDX ram_constructor_block_id
...
bra_E229:
C - - - - - 0x002239 00:E229: 86 2A     STX ram_constructor_block_id
C - - - - - 0x00223B 00:E22B: 4C 41 E2  JMP loc_E241
bra_E22E:
ofs_000_E22E_02_Select:
C - - J - - 0x00223E 00:E22E: A6 2A     LDX ram_constructor_block_id
; bzk optimize, delete CPX 00
C - - - - - 0x002240 00:E230: E0 00     CPX #$00
...
bra_E23C:
C - - - - - 0x00224C 00:E23C: 86 2A     STX ram_constructor_block_id
...
C - - - - - 0x002268 00:E258: 85 00     STA ram_0000_t05_block_data
C - - - - - 0x00226A 00:E25A: A9 E8     LDA #> tbl_E8F5_block_data
C - - - - - 0x00226C 00:E25C: 69 00     ADC #$00
C - - - - - 0x00226E 00:E25E: 85 01     STA ram_0000_t05_block_data + $01
loc_E260_read_block_data:
C D 3 - - - 0x002270 00:E260: A0 00     LDY #$00
C - - - - - 0x002272 00:E262: B1 00     LDA (ram_0000_t05_block_data),Y
C - - - - - 0x002274 00:E264: 8D 91 02  STA ram_copy_oam + $11
C - - - - - 0x002277 00:E267: C8        INY ; 01
C - - - - - 0x002278 00:E268: B1 00     LDA (ram_0000_t05_block_data),Y
C - - - - - 0x00227A 00:E26A: 8D 95 02  STA ram_copy_oam + $15
C - - - - - 0x00227D 00:E26D: C8        INY ; 02
C - - - - - 0x00227E 00:E26E: B1 00     LDA (ram_0000_t05_block_data),Y
C - - - - - 0x002280 00:E270: 8D 99 02  STA ram_copy_oam + $19
C - - - - - 0x002283 00:E273: C8        INY ; 03
C - - - - - 0x002284 00:E274: B1 00     LDA (ram_0000_t05_block_data),Y
C - - - - - 0x002286 00:E276: 8D 9D 02  STA ram_copy_oam + $1D
C - - - - - 0x002289 00:E279: A2 02     LDX #$02
C - - - - - 0x00228B 00:E27B: A5 2A     LDA ram_constructor_block_id
C - - - - - 0x00228D 00:E27D: C9 08     CMP #$08
C - - - - - 0x00228F 00:E27F: 90 03     BCC bra_E284_00_07
; enemy 08/player 09
C - - - - - 0x002291 00:E281: 29 01     AND #$01
C - - - - - 0x002293 00:E283: AA        TAX
bra_E284_00_07:
C - - - - - 0x002294 00:E284: 8A        TXA
C - - - - - 0x002295 00:E285: 8D 92 02  STA ram_copy_oam + $12
C - - - - - 0x002298 00:E288: 8D 96 02  STA ram_copy_oam + $16
C - - - - - 0x00229B 00:E28B: 8D 9A 02  STA ram_copy_oam + $1A
C - - - - - 0x00229E 00:E28E: 8D 9E 02  STA ram_copy_oam + $1E
C - - - - - 0x0022A1 00:E291: 20 9C E2  JSR sub_E29C_RTS
C - - - - - 0x0022A4 00:E294: 20 70 C2  JSR sub_C270
C - - - - - 0x0022A7 00:E297: A9 01     LDA #$01
C - - - - - 0x0022A9 00:E299: 85 9E     STA ram_009E_flag
...
C - - - - - 0x0022B0 00:E2A0: 20 6D E3  JSR sub_E36D_calculate_round_data_address
C - - - - - 0x0022B3 00:E2A3: A0 00     LDY #$00
C - - - - - 0x0022B5 00:E2A5: B1 00     LDA (ram_0000_t04_round_data),Y
C - - - - - 0x0022B7 00:E2A7: 85 9D     STA ram_009D
C - - - - - 0x0022B9 00:E2A9: A5 2A     LDA ram_constructor_block_id
C - - - - - 0x0022BB 00:E2AB: 91 00     STA (ram_0000_t04_round_data),Y
C - - - - - 0x0022BD 00:E2AD: A9 01     LDA #$01
C - - - - - 0x0022BF 00:E2AF: 85 9E     STA ram_009E_flag
loc_E2B1:
C - - - - - 0x0022C1 00:E2B1: 20 62 C2  JSR sub_C262_check_for_bonus_round
C - - - - - 0x0022C4 00:E2B4: D0 14     BNE bra_E2CA
C - - - - - 0x0022C6 00:E2B6: A9 00     LDA #$00
C - - - - - 0x0022C8 00:E2B8: 8D 42 06  STA ram_0600_round_data + $42
C - - - - - 0x0022CB 00:E2BB: 8D 43 06  STA ram_0600_round_data + $43
C - - - - - 0x0022CE 00:E2BE: 8D 44 06  STA ram_0600_round_data + $44
C - - - - - 0x0022D1 00:E2C1: 8D 52 06  STA ram_0600_round_data + $52
C - - - - - 0x0022D4 00:E2C4: 8D 53 06  STA ram_0600_round_data + $53
C - - - - - 0x0022D7 00:E2C7: 8D 54 06  STA ram_0600_round_data + $54
bra_E2CA:
...
ofs_000_E2D7_04_Up:
C - - J - - 0x0022E7 00:E2D7: A6 29     LDX ram_0029_temp_pos_Y
...
C - - - - - 0x0022F0 00:E2E0: 86 29     STX ram_0029_temp_pos_Y
C - - - - - 0x0022F2 00:E2E2: 4C 0F E3  JMP loc_E30F



ofs_000_E2E5_05_Down:
C - - J - - 0x0022F5 00:E2E5: A6 29     LDX ram_0029_temp_pos_Y
...
C - - - - - 0x0022FE 00:E2EE: 86 29     STX ram_0029_temp_pos_Y
C - - - - - 0x002300 00:E2F0: 4C 0F E3  JMP loc_E30F



ofs_000_E2F3_06_Left:
C - - J - - 0x002303 00:E2F3: A6 28     LDX ram_0028_temp_pos_X
; bzk optimize, delete CPX 00
...
C - - - - - 0x00230C 00:E2FC: 86 28     STX ram_0028_temp_pos_X
C - - - - - 0x00230E 00:E2FE: 4C 0F E3  JMP loc_E30F



ofs_000_E301_07_Right:
C - - J - - 0x002311 00:E301: A6 28     LDX ram_0028_temp_pos_X
...
C - - - - - 0x00231A 00:E30A: 86 28     STX ram_0028_temp_pos_X
...
sub_E30F:
loc_E30F:
C D 3 - - - 0x00231F 00:E30F: A5 28     LDA ram_0028_temp_pos_X
C - - - - - 0x002321 00:E311: 85 40     STA ram_0040
C - - - - - 0x002323 00:E313: A5 29     LDA ram_0029_temp_pos_Y
...
C - - - - - 0x00232E 00:E31E: 8C 80 02  STY ram_copy_oam
C - - - - - 0x002331 00:E321: 8E 83 02  STX ram_copy_oam + $03
C - - - - - 0x002334 00:E324: 8C 90 02  STY ram_copy_oam + $10
C - - - - - 0x002337 00:E327: 8E 93 02  STX ram_copy_oam + $13
C - - - - - 0x00233A 00:E32A: E6 40     INC ram_0040
C - - - - - 0x00233C 00:E32C: 20 64 E3  JSR sub_E364
C - - - - - 0x00233F 00:E32F: 8C 84 02  STY ram_copy_oam + $04
C - - - - - 0x002342 00:E332: 8E 87 02  STX ram_copy_oam + $07
C - - - - - 0x002345 00:E335: 8C 94 02  STY ram_copy_oam + $14
C - - - - - 0x002348 00:E338: 8E 97 02  STX ram_copy_oam + $17
C - - - - - 0x00234B 00:E33B: E6 42     INC ram_0042
C - - - - - 0x00234D 00:E33D: 20 64 E3  JSR sub_E364
C - - - - - 0x002350 00:E340: 8C 8C 02  STY ram_copy_oam + $0C
C - - - - - 0x002353 00:E343: 8E 8F 02  STX ram_copy_oam + $0F
C - - - - - 0x002356 00:E346: 8C 9C 02  STY ram_copy_oam + $1C
C - - - - - 0x002359 00:E349: 8E 9F 02  STX ram_copy_oam + $1F
C - - - - - 0x00235C 00:E34C: C6 40     DEC ram_0040
C - - - - - 0x00235E 00:E34E: 20 64 E3  JSR sub_E364
C - - - - - 0x002361 00:E351: 8C 88 02  STY ram_copy_oam + $08
C - - - - - 0x002364 00:E354: 8E 8B 02  STX ram_copy_oam + $0B
C - - - - - 0x002367 00:E357: 8C 98 02  STY ram_copy_oam + $18
C - - - - - 0x00236A 00:E35A: 8E 9B 02  STX ram_copy_oam + $1B
C - - - - - 0x00236D 00:E35D: C6 42     DEC ram_0042
C - - - - - 0x00236F 00:E35F: A9 01     LDA #$01
C - - - - - 0x002371 00:E361: 85 9E     STA ram_009E_flag
C - - - - - 0x002373 00:E363: 60        RTS



sub_E364:
C - - - - - 0x002374 00:E364: 20 CF E8  JSR sub_E8CF_multiply_position_by_08
...
sub_E36D_calculate_round_data_address:
; out
    ; ram_0000_t04_round_data
C - - - - - 0x00237D 00:E36D: A5 29     LDA ram_0029_temp_pos_Y
; * 10
...
C - - - - - 0x002384 00:E374: 69 40     ADC #< (ram_0600_round_data + $40)
C - - - - - 0x002386 00:E376: 18        CLC
C - - - - - 0x002387 00:E377: 65 28     ADC ram_0028_temp_pos_X
C - - - - - 0x002389 00:E379: 85 00     STA ram_0000_t04_round_data
C - - - - - 0x00238B 00:E37B: A9 06     LDA #> (ram_0600_round_data + $40)
C - - - - - 0x00238D 00:E37D: 69 00     ADC #$00
C - - - - - 0x00238F 00:E37F: 85 01     STA ram_0000_t04_round_data + $01
...
bra_E386_loop:
C - - - - - 0x002396 00:E386: B9 80 02  LDA ram_copy_oam,Y
...
C - - - - - 0x0023A4 00:E394: E6 4D     INC ram_frm_cnt
C - - - - - 0x0023A6 00:E396: A5 4D     LDA ram_frm_cnt
...
bra_E3A0:
C - - - - - 0x0023B0 00:E3A0: 8E 81 02  STX ram_copy_oam + $01
C - - - - - 0x0023B3 00:E3A3: 8E 85 02  STX ram_copy_oam + $05
C - - - - - 0x0023B6 00:E3A6: 8E 89 02  STX ram_copy_oam + $09
C - - - - - 0x0023B9 00:E3A9: 8E 8D 02  STX ram_copy_oam + $0D
...
sub_E3CD:
; out
    ; ram_000F_t03_error_flag
C - - - - - 0x0023DD 00:E3CD: 20 AA EF  JSR sub_EFAA_hide_all_sprites
...
C - - - - - 0x0023F2 00:E3E2: 20 26 C0  JSR sub_C026_write_A_to_2007
...
C - - - - - 0x002413 00:E403: 20 26 C0  JSR sub_C026_write_A_to_2007
...
C - - - - - 0x002428 00:E418: 20 26 C0  JSR sub_C026_write_A_to_2007
...
C - - - - - 0x002442 00:E432: 20 26 C0  JSR sub_C026_write_A_to_2007
...
C - - - - - 0x00244C 00:E43C: 20 26 C0  JSR sub_C026_write_A_to_2007
C - - - - - 0x00244F 00:E43F: CA        DEX
C - - - - - 0x002450 00:E440: D0 F8     BNE bra_E43A_loop
C - - - - - 0x002452 00:E442: A9 86     LDA #< tbl_E486_txt___hud_info
C - - - - - 0x002454 00:E444: 85 00     STA ram_0000_t02_ppu_data
C - - - - - 0x002456 00:E446: A9 E4     LDA #> tbl_E486_txt___hud_info
C - - - - - 0x002458 00:E448: 85 01     STA ram_0000_t02_ppu_data + $01
C - - - - - 0x00245A 00:E44A: 20 28 EC  JSR sub_EC28_print_tiles_on_black_background
C - - - - - 0x00245D 00:E44D: A5 E0     LDA ram_players_counter
C - - - - - 0x00245F 00:E44F: F0 0B     BEQ bra_E45C_skip_p2
C - - - - - 0x002461 00:E451: A9 CD     LDA #< tbl_E4CD_txt___hud_info_p2
C - - - - - 0x002463 00:E453: 85 00     STA ram_0000_t02_ppu_data
C - - - - - 0x002465 00:E455: A9 E4     LDA #> tbl_E4CD_txt___hud_info_p2
C - - - - - 0x002467 00:E457: 85 01     STA ram_0000_t02_ppu_data + $01
C - - - - - 0x002469 00:E459: 20 28 EC  JSR sub_EC28_print_tiles_on_black_background
bra_E45C_skip_p2:
C - - - - - 0x00246C 00:E45C: 20 62 C2  JSR sub_C262_check_for_bonus_round
C - - - - - 0x00246F 00:E45F: F0 0E     BEQ bra_E46F_not_bonus_round
C - - - - - 0x002471 00:E461: A9 DA     LDA #< tbl_E4DA_tiles___big_bonus_box
C - - - - - 0x002473 00:E463: 85 00     STA ram_0000_t02_ppu_data
C - - - - - 0x002475 00:E465: A9 E4     LDA #> tbl_E4DA_tiles___big_bonus_box
C - - - - - 0x002477 00:E467: 85 01     STA ram_0000_t02_ppu_data + $01
C - - - - - 0x002479 00:E469: 20 28 EC  JSR sub_EC28_print_tiles_on_black_background
C - - - - - 0x00247C 00:E46C: 4C 7A E4  JMP loc_E47A
bra_E46F_not_bonus_round:
C - - - - - 0x00247F 00:E46F: A9 1E     LDA #< tbl_E51E_tiles___house
C - - - - - 0x002481 00:E471: 85 00     STA ram_0000_t02_ppu_data
C - - - - - 0x002483 00:E473: A9 E5     LDA #> tbl_E51E_tiles___house
C - - - - - 0x002485 00:E475: 85 01     STA ram_0000_t02_ppu_data + $01
C - - - - - 0x002487 00:E477: 20 28 EC  JSR sub_EC28_print_tiles_on_black_background
loc_E47A:
...
- D 3 - I - 0x002496 00:E486: 63 20     .word $2063 ; ppu address
...
- D 3 - I - 0x0024B3 00:E4A3: 8C 20     .word $208C ; ppu address
...
- D 3 - I - 0x0024C7 00:E4B7: AC 20     .word $20AC ; ppu address
...
- D 3 - I - 0x0024DD 00:E4CD: 75 20     .word $2075 ; ppu address
...
sub_E544:
; milk (lives)
C - - - - - 0x002554 00:E544: A2 0E     LDX #$0E    ; 20AE
C - - - - - 0x002556 00:E546: A0 05     LDY #$05
C - - - - - 0x002558 00:E548: A5 22     LDA ram_milk_current_player
C - - - - - 0x00255A 00:E54A: 85 B6     STA ram_00B6_number_lo
C - - - - - 0x00255C 00:E54C: A9 00     LDA #$00
C - - - - - 0x00255E 00:E54E: 85 B7     STA ram_00B7_number_hi
C - - - - - 0x002560 00:E550: 20 29 C7  JSR sub_C729_print_milk_amount
; bonus
C - - - - - 0x002563 00:E553: A2 12     LDX #$12    ; 20B2
C - - - - - 0x002565 00:E555: A0 05     LDY #$05
C - - - - - 0x002567 00:E557: A5 21     LDA ram_bonus_points
C - - - - - 0x002569 00:E559: 85 B6     STA ram_00B6_number_lo
C - - - - - 0x00256B 00:E55B: 20 AB E5  JSR sub_E5AB_print_number_amount
; round
C - - - - - 0x00256E 00:E55E: A2 19     LDX #$19    ; 20B9
C - - - - - 0x002570 00:E560: A0 05     LDY #$05
C - - - - - 0x002572 00:E562: A5 20     LDA ram_current_round
C - - - - - 0x002574 00:E564: 85 B6     STA ram_00B6_number_lo
C - - - - - 0x002576 00:E566: 20 AB E5  JSR sub_E5AB_print_number_amount
C - - - - - 0x002579 00:E569: A5 8F     LDA ram_bonus_round_id
C - - - - - 0x00257B 00:E56B: F0 0B     BEQ bra_E578_RTS
; if bonus round
; bonus (center)
C - - - - - 0x00257D 00:E56D: A2 0E     LDX #$0E    ; 21EE
C - - - - - 0x00257F 00:E56F: A0 0F     LDY #$0F
C - - - - - 0x002581 00:E571: A5 21     LDA ram_bonus_points
C - - - - - 0x002583 00:E573: 85 B6     STA ram_00B6_number_lo
C - - - - - 0x002585 00:E575: 20 AB E5  JSR sub_E5AB_print_number_amount
bra_E578_RTS:
...
sub_E579:
; 1st player score
C - - - - - 0x002589 00:E579: A2 04     LDX #$04    ; 2064
C - - - - - 0x00258B 00:E57B: A0 03     LDY #$03
C - - - - - 0x00258D 00:E57D: A5 B8     LDA ram_score_lo_p1
C - - - - - 0x00258F 00:E57F: 85 B6     STA ram_00B6_number_lo
C - - - - - 0x002591 00:E581: A5 B9     LDA ram_score_hi_p1
C - - - - - 0x002593 00:E583: 85 B7     STA ram_00B7_number_hi
C - - - - - 0x002595 00:E585: 20 0D C7  JSR sub_C70D_print_score_amount
; top score
C - - - - - 0x002598 00:E588: A2 0E     LDX #$0E    ; 206E
C - - - - - 0x00259A 00:E58A: A0 03     LDY #$03
C - - - - - 0x00259C 00:E58C: A5 BA     LDA ram_top_score_lo
C - - - - - 0x00259E 00:E58E: 85 B6     STA ram_00B6_number_lo
C - - - - - 0x0025A0 00:E590: A5 BB     LDA ram_top_score_hi
C - - - - - 0x0025A2 00:E592: 85 B7     STA ram_00B7_number_hi
C - - - - - 0x0025A4 00:E594: 20 0D C7  JSR sub_C70D_print_score_amount
C - - - - - 0x0025A7 00:E597: A5 E0     LDA ram_players_counter
C - - - - - 0x0025A9 00:E599: F0 0F     BEQ bra_E5AA_RTS
; 2nd player score
C - - - - - 0x0025AB 00:E59B: A2 17     LDX #$17    ; 2077
C - - - - - 0x0025AD 00:E59D: A0 03     LDY #$03
C - - - - - 0x0025AF 00:E59F: A5 BC     LDA ram_score_lo_p2
C - - - - - 0x0025B1 00:E5A1: 85 B6     STA ram_00B6_number_lo
C - - - - - 0x0025B3 00:E5A3: A5 BD     LDA ram_score_hi_p2
C - - - - - 0x0025B5 00:E5A5: 85 B7     STA ram_00B7_number_hi
; bzk optimize, JMP
C - - - - - 0x0025B7 00:E5A7: 20 0D C7  JSR sub_C70D_print_score_amount
bra_E5AA_RTS:
C - - - - - 0x0025BA 00:E5AA: 60        RTS



sub_E5AB_print_number_amount:
C - - - - - 0x0025BB 00:E5AB: A9 00     LDA #$00
C - - - - - 0x0025BD 00:E5AD: 85 B7     STA ram_00B7_number_hi
; bzk optimize, JMP
C - - - - - 0x0025BF 00:E5AF: 20 1B C7  JSR sub_C71B_print_number_amount
...
bra_E5B5_loop:
C - - - - - 0x0025C5 00:E5B5: BD 00 06  LDA ram_0600_round_data,X
C - - - - - 0x0025C8 00:E5B8: C9 0A     CMP #$0A
C - - - - - 0x0025CA 00:E5BA: 90 05     BCC bra_E5C1
- - - - - - 0x0025CC 00:E5BC: A9 00     LDA #$00
- - - - - - 0x0025CE 00:E5BE: 9D 00 06  STA ram_0600_round_data,X
bra_E5C1:
...
; out
    ; ram_000F_t03_error_flag
C - - - - - 0x0025D7 00:E5C7: A9 40     LDA #< (ram_0600_round_data + $40)
C - - - - - 0x0025D9 00:E5C9: 85 10     STA ram_0010_t02_round_data
C - - - - - 0x0025DB 00:E5CB: A9 06     LDA #> (ram_0600_round_data + $40)
C - - - - - 0x0025DD 00:E5CD: 85 11     STA ram_0010_t02_round_data + $01
C - - - - - 0x0025DF 00:E5CF: A9 C8     LDA #< $23C8
C - - - - - 0x0025E1 00:E5D1: 85 16     STA ram_0016_ppu_lo
C - - - - - 0x0025E3 00:E5D3: A9 23     LDA #> $23C8
C - - - - - 0x0025E5 00:E5D5: 85 17     STA ram_0017_ppu_hi
C - - - - - 0x0025E7 00:E5D7: A9 40     LDA #< (ram_oam + con_obj_index_40)
C - - - - - 0x0025E9 00:E5D9: 85 02     STA ram_0002_t05_data
C - - - - - 0x0025EB 00:E5DB: A9 07     LDA #> (ram_oam + con_obj_index_40)
C - - - - - 0x0025ED 00:E5DD: 85 03     STA ram_0002_t05_data + $01
C - - - - - 0x0025EF 00:E5DF: A9 90     LDA #< (ram_oam + con_obj_index_90)
C - - - - - 0x0025F1 00:E5E1: 85 04     STA ram_0004_t01_data
C - - - - - 0x0025F3 00:E5E3: A9 07     LDA #> (ram_oam + con_obj_index_90)
C - - - - - 0x0025F5 00:E5E5: 85 05     STA ram_0004_t01_data + $01
C - - - - - 0x0025F7 00:E5E7: A9 E0     LDA #< (ram_oam + con_obj_index_E0)
C - - - - - 0x0025F9 00:E5E9: 85 06     STA ram_0006_t04_data
C - - - - - 0x0025FB 00:E5EB: A9 07     LDA #> (ram_oam + con_obj_index_E0)
C - - - - - 0x0025FD 00:E5ED: 85 07     STA ram_0006_t04_data + $01
C - - - - - 0x0025FF 00:E5EF: A9 C6     LDA #< ram_00C6
C - - - - - 0x002601 00:E5F1: 85 08     STA ram_0008_t03_data
C - - - - - 0x002603 00:E5F3: A9 00     LDA #> ram_00C6
C - - - - - 0x002605 00:E5F5: 85 09     STA ram_0008_t03_data + $01
C - - - - - 0x002607 00:E5F7: A9 00     LDA #$00
C - - - - - 0x002609 00:E5F9: 85 2B     STA ram_002B
C - - - - - 0x00260B 00:E5FB: 85 2C     STA ram_round_fruit_counter
C - - - - - 0x00260D 00:E5FD: 85 2D     STA ram_002D
C - - - - - 0x00260F 00:E5FF: 85 2E     STA ram_002E_flag
...
C - - - - - 0x002620 00:E610: 85 43     STA ram_0043_t01_loop_counter
bra_E612_loop:
C - - - - - 0x002622 00:E612: A9 00     LDA #$00
C - - - - - 0x002624 00:E614: 85 40     STA ram_0040
C - - - - - 0x002626 00:E616: A9 08     LDA #$08
C - - - - - 0x002628 00:E618: 85 41     STA ram_0041_temp_loop_counter
bra_E61A_loop:
C - - - - - 0x00262A 00:E61A: 20 58 E6  JSR sub_E658
C - - - - - 0x00262D 00:E61D: E6 10     INC ram_0010_t02_round_data
C - - - - - 0x00262F 00:E61F: E6 10     INC ram_0010_t02_round_data
...
C - - - - - 0x002638 00:E628: C6 41     DEC ram_0041_temp_loop_counter
C - - - - - 0x00263A 00:E62A: D0 EE     BNE bra_E61A_loop
C - - - - - 0x00263C 00:E62C: A5 10     LDA ram_0010_t02_round_data
C - - - - - 0x00263E 00:E62E: 18        CLC
C - - - - - 0x00263F 00:E62F: 69 10     ADC #$10
C - - - - - 0x002641 00:E631: 85 10     STA ram_0010_t02_round_data
...
C - - - - - 0x00264A 00:E63A: C6 43     DEC ram_0043_t01_loop_counter
C - - - - - 0x00264C 00:E63C: D0 D4     BNE bra_E612_loop
C - - - - - 0x00264E 00:E63E: A5 2B     LDA ram_002B
C - - - - - 0x002650 00:E640: F0 11     BEQ bra_E653
C - - - - - 0x002652 00:E642: A5 2C     LDA ram_round_fruit_counter
C - - - - - 0x002654 00:E644: F0 0D     BEQ bra_E653
C - - - - - 0x002656 00:E646: A5 2D     LDA ram_002D
C - - - - - 0x002658 00:E648: F0 09     BEQ bra_E653
C - - - - - 0x00265A 00:E64A: A5 2E     LDA ram_002E_flag
C - - - - - 0x00265C 00:E64C: F0 05     BEQ bra_E653
C - - - - - 0x00265E 00:E64E: A9 00     LDA #$00    ; no errors
C - - - - - 0x002660 00:E650: 85 0F     STA ram_000F_t03_error_flag
C - - - - - 0x002662 00:E652: 60        RTS
bra_E653:
C - - - - - 0x002663 00:E653: A9 01     LDA #$01    ; error
C - - - - - 0x002665 00:E655: 85 0F     STA ram_000F_t03_error_flag
...
C - - - - - 0x002684 00:E674: B1 10     LDA (ram_0010_t02_round_data),Y
C - - - - - 0x002686 00:E676: 20 C6 E6  JSR sub_E6C6
C - - - - - 0x002689 00:E679: A0 01     LDY #$01
C - - - - - 0x00268B 00:E67B: 91 10     STA (ram_0010_t02_round_data),Y
...
C - - - - - 0x00269A 00:E68A: B1 10     LDA (ram_0010_t02_round_data),Y
C - - - - - 0x00269C 00:E68C: 20 C6 E6  JSR sub_E6C6
C - - - - - 0x00269F 00:E68F: A0 11     LDY #$11
C - - - - - 0x0026A1 00:E691: 91 10     STA (ram_0010_t02_round_data),Y
...
C - - - - - 0x0026B0 00:E6A0: B1 10     LDA (ram_0010_t02_round_data),Y
C - - - - - 0x0026B2 00:E6A2: 20 C6 E6  JSR sub_E6C6
C - - - - - 0x0026B5 00:E6A5: A0 10     LDY #$10
C - - - - - 0x0026B7 00:E6A7: 91 10     STA (ram_0010_t02_round_data),Y
...
C - - - - - 0x0026C4 00:E6B4: A5 17     LDA ram_0017_ppu_hi
C - - - - - 0x0026C6 00:E6B6: 8D 06 20  STA $2006
C - - - - - 0x0026C9 00:E6B9: A5 16     LDA ram_0016_ppu_lo
C - - - - - 0x0026CB 00:E6BB: 8D 06 20  STA $2006
C - - - - - 0x0026CE 00:E6BE: A5 44     LDA ram_0044
C - - - - - 0x0026D0 00:E6C0: 20 26 C0  JSR sub_C026_write_A_to_2007
C - - - - - 0x0026D3 00:E6C3: E6 16     INC ram_0016_ppu_lo
...
C - - - - - 0x0026E0 00:E6D0: 85 12     STA ram_0012_t01_block_data
C - - - - - 0x0026E2 00:E6D2: 85 18     STA ram_0018_t01_block_data
C - - - - - 0x0026E4 00:E6D4: A9 E8     LDA #> tbl_E8F5_block_data
C - - - - - 0x0026E6 00:E6D6: 69 00     ADC #$00
C - - - - - 0x0026E8 00:E6D8: 85 13     STA ram_0012_t01_block_data + $01
C - - - - - 0x0026EA 00:E6DA: 85 19     STA ram_0018_t01_block_data + $01
...
C - - - - - 0x0026F4 00:E6E4: 85 12     STA ram_0012_t01_block_data
C - - - - - 0x0026F6 00:E6E6: A9 E8     LDA #> tbl_E8F5_block_data
C - - - - - 0x0026F8 00:E6E8: 85 13     STA ram_0012_t01_block_data + $01
bra_E6EA:
C - - - - - 0x0026FA 00:E6EA: A6 40     LDX ram_0040
C - - - - - 0x0026FC 00:E6EC: A4 42     LDY ram_0042
C - - - - - 0x0026FE 00:E6EE: 20 45 E9  JSR sub_E945_calculate_and_set_ppu_address
C - - - - - 0x002701 00:E6F1: A0 00     LDY #$00
C - - - - - 0x002703 00:E6F3: B1 12     LDA (ram_0012_t01_block_data),Y
C - - - - - 0x002705 00:E6F5: 20 26 C0  JSR sub_C026_write_A_to_2007
C - - - - - 0x002708 00:E6F8: C8        INY ; 01
C - - - - - 0x002709 00:E6F9: B1 12     LDA (ram_0012_t01_block_data),Y
C - - - - - 0x00270B 00:E6FB: 20 26 C0  JSR sub_C026_write_A_to_2007
C - - - - - 0x00270E 00:E6FE: A6 40     LDX ram_0040
C - - - - - 0x002710 00:E700: A4 42     LDY ram_0042
C - - - - - 0x002712 00:E702: C8        INY
C - - - - - 0x002713 00:E703: 20 45 E9  JSR sub_E945_calculate_and_set_ppu_address
C - - - - - 0x002716 00:E706: A0 02     LDY #$02
C - - - - - 0x002718 00:E708: B1 12     LDA (ram_0012_t01_block_data),Y
C - - - - - 0x00271A 00:E70A: 20 26 C0  JSR sub_C026_write_A_to_2007
C - - - - - 0x00271D 00:E70D: C8        INY ; 03
C - - - - - 0x00271E 00:E70E: B1 12     LDA (ram_0012_t01_block_data),Y
C - - - - - 0x002720 00:E710: 20 26 C0  JSR sub_C026_write_A_to_2007
C - - - - - 0x002723 00:E713: C8        INY ; 04
C - - - - - 0x002724 00:E714: B1 12     LDA (ram_0012_t01_block_data),Y
C - - - - - 0x002726 00:E716: 85 4F     STA ram_004F_t01
...
bra_E725:
C - - - - - 0x002735 00:E725: A6 4F     LDX ram_004F_t01
...
C - - - - - 0x002777 00:E767: A5 02     LDA ram_0002_t05_data
C - - - - - 0x002779 00:E769: 85 0A     STA ram_000A_t02_data
C - - - - - 0x00277B 00:E76B: A5 03     LDA ram_0002_t05_data + $01
C - - - - - 0x00277D 00:E76D: 85 0B     STA ram_000A_t02_data + $01
C - - - - - 0x00277F 00:E76F: 20 F5 E7  JSR sub_E7F5
C - - - - - 0x002782 00:E772: A5 0A     LDA ram_000A_t02_data
C - - - - - 0x002784 00:E774: 85 02     STA ram_0002_t05_data
C - - - - - 0x002786 00:E776: A5 0B     LDA ram_000A_t02_data + $01
C - - - - - 0x002788 00:E778: 85 03     STA ram_0002_t05_data + $01
...
C - - - - - 0x002791 00:E781: 91 08     STA (ram_0008_t03_data),Y
...
C - - - - - 0x00279A 00:E78A: 91 08     STA (ram_0008_t03_data),Y
C - - - - - 0x00279C 00:E78C: A5 08     LDA ram_0008_t03_data
C - - - - - 0x00279E 00:E78E: 18        CLC
C - - - - - 0x00279F 00:E78F: 69 02     ADC #$02
C - - - - - 0x0027A1 00:E791: 85 08     STA ram_0008_t03_data
...
; in
    ; ram_0004_t01_data
C D 3 - - - 0x0027A6 00:E796: A5 2C     LDA ram_round_fruit_counter
...
C - - - - - 0x0027B3 00:E7A3: E6 2C     INC ram_round_fruit_counter
C - - - - - 0x0027B5 00:E7A5: A5 04     LDA ram_0004_t01_data
C - - - - - 0x0027B7 00:E7A7: 85 0A     STA ram_000A_t02_data
C - - - - - 0x0027B9 00:E7A9: A5 05     LDA ram_0004_t01_data + $01
C - - - - - 0x0027BB 00:E7AB: 85 0B     STA ram_000A_t02_data + $01
C - - - - - 0x0027BD 00:E7AD: 20 F5 E7  JSR sub_E7F5
C - - - - - 0x0027C0 00:E7B0: A5 0A     LDA ram_000A_t02_data
C - - - - - 0x0027C2 00:E7B2: 85 04     STA ram_0004_t01_data
C - - - - - 0x0027C4 00:E7B4: A5 0B     LDA ram_000A_t02_data + $01
C - - - - - 0x0027C6 00:E7B6: 85 05     STA ram_0004_t01_data + $01
...
C - - - - - 0x0027DA 00:E7CA: A5 06     LDA ram_0006_t04_data
C - - - - - 0x0027DC 00:E7CC: 85 0A     STA ram_000A_t02_data
C - - - - - 0x0027DE 00:E7CE: A5 07     LDA ram_0006_t04_data + $01
C - - - - - 0x0027E0 00:E7D0: 85 0B     STA ram_000A_t02_data + $01
C - - - - - 0x0027E2 00:E7D2: 20 F5 E7  JSR sub_E7F5
C - - - - - 0x0027E5 00:E7D5: A5 0A     LDA ram_000A_t02_data
C - - - - - 0x0027E7 00:E7D7: 85 06     STA ram_0006_t04_data
C - - - - - 0x0027E9 00:E7D9: A5 0B     LDA ram_000A_t02_data + $01
C - - - - - 0x0027EB 00:E7DB: 85 07     STA ram_0006_t04_data + $01
...
; in
    ; ram_000A_t02_data
    ; ram_0018_t01_block_data
C - - - - - 0x002805 00:E7F5: 20 CF E8  JSR sub_E8CF_multiply_position_by_08
C - - - - - 0x002808 00:E7F8: A0 00     LDY #$00
C - - - - - 0x00280A 00:E7FA: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x00280C 00:E7FC: A0 03     LDY #$03
C - - - - - 0x00280E 00:E7FE: 8A        TXA
C - - - - - 0x00280F 00:E7FF: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x002811 00:E801: E6 40     INC ram_0040
C - - - - - 0x002813 00:E803: 20 CF E8  JSR sub_E8CF_multiply_position_by_08
C - - - - - 0x002816 00:E806: A0 04     LDY #$04
C - - - - - 0x002818 00:E808: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x00281A 00:E80A: A0 07     LDY #$07
C - - - - - 0x00281C 00:E80C: 8A        TXA
C - - - - - 0x00281D 00:E80D: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x00281F 00:E80F: E6 42     INC ram_0042
C - - - - - 0x002821 00:E811: 20 CF E8  JSR sub_E8CF_multiply_position_by_08
C - - - - - 0x002824 00:E814: A0 08     LDY #$08
C - - - - - 0x002826 00:E816: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x002828 00:E818: A0 0B     LDY #$0B
C - - - - - 0x00282A 00:E81A: 8A        TXA
C - - - - - 0x00282B 00:E81B: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x00282D 00:E81D: C6 40     DEC ram_0040
C - - - - - 0x00282F 00:E81F: 20 CF E8  JSR sub_E8CF_multiply_position_by_08
C - - - - - 0x002832 00:E822: A0 0C     LDY #$0C
C - - - - - 0x002834 00:E824: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x002836 00:E826: A0 0F     LDY #$0F
C - - - - - 0x002838 00:E828: 8A        TXA
C - - - - - 0x002839 00:E829: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x00283B 00:E82B: C6 42     DEC ram_0042
C - - - - - 0x00283D 00:E82D: A0 00     LDY #$00
C - - - - - 0x00283F 00:E82F: B1 18     LDA (ram_0018_t01_block_data),Y
C - - - - - 0x002841 00:E831: A0 01     LDY #$01
C - - - - - 0x002843 00:E833: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x002845 00:E835: A0 01     LDY #$01
C - - - - - 0x002847 00:E837: B1 18     LDA (ram_0018_t01_block_data),Y
C - - - - - 0x002849 00:E839: A0 05     LDY #$05
C - - - - - 0x00284B 00:E83B: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x00284D 00:E83D: A0 03     LDY #$03
C - - - - - 0x00284F 00:E83F: B1 18     LDA (ram_0018_t01_block_data),Y
C - - - - - 0x002851 00:E841: A0 09     LDY #$09
C - - - - - 0x002853 00:E843: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x002855 00:E845: A0 02     LDY #$02
C - - - - - 0x002857 00:E847: B1 18     LDA (ram_0018_t01_block_data),Y
C - - - - - 0x002859 00:E849: A0 0D     LDY #$0D
C - - - - - 0x00285B 00:E84B: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x00285D 00:E84D: A0 04     LDY #$04
C - - - - - 0x00285F 00:E84F: B1 18     LDA (ram_0018_t01_block_data),Y
C - - - - - 0x002861 00:E851: 29 03     AND #$03
C - - - - - 0x002863 00:E853: A0 02     LDY #$02
C - - - - - 0x002865 00:E855: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x002867 00:E857: A0 06     LDY #$06
C - - - - - 0x002869 00:E859: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x00286B 00:E85B: A0 0A     LDY #$0A
C - - - - - 0x00286D 00:E85D: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x00286F 00:E85F: A0 0E     LDY #$0E
C - - - - - 0x002871 00:E861: 91 0A     STA (ram_000A_t02_data),Y
C - - - - - 0x002873 00:E863: A5 0A     LDA ram_000A_t02_data
C - - - - - 0x002875 00:E865: 18        CLC
C - - - - - 0x002876 00:E866: 69 10     ADC #< $0010
C - - - - - 0x002878 00:E868: 85 0A     STA ram_000A_t02_data
C - - - - - 0x00287A 00:E86A: A5 0B     LDA ram_000A_t02_data + $01
C - - - - - 0x00287C 00:E86C: 69 00     ADC #> $0010
C - - - - - 0x00287E 00:E86E: 85 0B     STA ram_000A_t02_data + $01
C - - - - - 0x002880 00:E870: 60        RTS



loc_E871:
C D 3 - - - 0x002881 00:E871: A5 2E     LDA ram_002E_flag
...
bra_E882:
C - - - - - 0x002892 00:E882: E6 2E     INC ram_002E_flag
C - - - - - 0x002894 00:E884: 20 CF E8  JSR sub_E8CF_multiply_position_by_08
C - - - - - 0x002897 00:E887: 8D 20 07  STA ram_player_pos_Y
C - - - - - 0x00289A 00:E88A: 8E 23 07  STX ram_player_pos_X
C - - - - - 0x00289D 00:E88D: E6 40     INC ram_0040
C - - - - - 0x00289F 00:E88F: 20 CF E8  JSR sub_E8CF_multiply_position_by_08
C - - - - - 0x0028A2 00:E892: 8D 24 07  STA ram_player_pos_Y + $04
C - - - - - 0x0028A5 00:E895: 8E 27 07  STX ram_player_pos_X + $04
C - - - - - 0x0028A8 00:E898: E6 42     INC ram_0042
C - - - - - 0x0028AA 00:E89A: 20 CF E8  JSR sub_E8CF_multiply_position_by_08
C - - - - - 0x0028AD 00:E89D: 8D 28 07  STA ram_player_pos_Y + $08
C - - - - - 0x0028B0 00:E8A0: 8E 2B 07  STX ram_player_pos_X + $08
C - - - - - 0x0028B3 00:E8A3: C6 40     DEC ram_0040
C - - - - - 0x0028B5 00:E8A5: 20 CF E8  JSR sub_E8CF_multiply_position_by_08
C - - - - - 0x0028B8 00:E8A8: 8D 2C 07  STA ram_player_pos_Y + $0C
C - - - - - 0x0028BB 00:E8AB: 8E 2F 07  STX ram_player_pos_X + $0C
C - - - - - 0x0028BE 00:E8AE: C6 42     DEC ram_0042
C - - - - - 0x0028C0 00:E8B0: A9 60     LDA #$60
C - - - - - 0x0028C2 00:E8B2: 20 E8 DF  JSR sub_DFE8_write_player_animation
C - - - - - 0x0028C5 00:E8B5: A5 8E     LDA ram_008E_flag
C - - - - - 0x0028C7 00:E8B7: F0 05     BEQ bra_E8BE
C - - - - - 0x0028C9 00:E8B9: A9 86     LDA #$86
C - - - - - 0x0028CB 00:E8BB: 20 E8 DF  JSR sub_DFE8_write_player_animation
bra_E8BE:
C - - - - - 0x0028CE 00:E8BE: A9 01     LDA #$01
C - - - - - 0x0028D0 00:E8C0: 8D 22 07  STA ram_player_color
C - - - - - 0x0028D3 00:E8C3: 8D 26 07  STA ram_player_color + $04
C - - - - - 0x0028D6 00:E8C6: 8D 2A 07  STA ram_player_color + $08
C - - - - - 0x0028D9 00:E8C9: 8D 2E 07  STA ram_player_color + $0C
C - - - - - 0x0028DC 00:E8CC: 4C E3 E7  JMP loc_E7E3



sub_E8CF_multiply_position_by_08:
...
sub_E8DC_divide_position_by_10:
C - - - - - 0x0028EC 00:E8DC: A5 28     LDA ram_0028_temp_pos_X
; / 10
C - - - - - 0x0028EE 00:E8DE: 4A        LSR
C - - - - - 0x0028EF 00:E8DF: 4A        LSR
C - - - - - 0x0028F0 00:E8E0: 4A        LSR
C - - - - - 0x0028F1 00:E8E1: 4A        LSR
C - - - - - 0x0028F2 00:E8E2: 85 28     STA ram_0028_temp_pos_X
C - - - - - 0x0028F4 00:E8E4: A5 29     LDA ram_0029_temp_pos_Y
; / 10
C - - - - - 0x0028F6 00:E8E6: 4A        LSR
C - - - - - 0x0028F7 00:E8E7: 4A        LSR
C - - - - - 0x0028F8 00:E8E8: 4A        LSR
C - - - - - 0x0028F9 00:E8E9: 4A        LSR
C - - - - - 0x0028FA 00:E8EA: 85 29     STA ram_0029_temp_pos_Y
...
- - - - - - 0x002912 00:E902: 00        .byte $00   ; placeholder
- - - - - - 0x002913 00:E903: 00        .byte $00   ; placeholder
- - - - - - 0x002914 00:E904: 00        .byte $00   ; placeholder
; 02 brick
...
- - - - - - 0x00291A 00:E90A: 00        .byte $00   ; placeholder
- - - - - - 0x00291B 00:E90B: 00        .byte $00   ; placeholder
- - - - - - 0x00291C 00:E90C: 00        .byte $00   ; placeholder
; 03 ladder
...
- - - - - - 0x002922 00:E912: 00        .byte $00   ; placeholder
- - - - - - 0x002923 00:E913: 00        .byte $00   ; placeholder
- - - - - - 0x002924 00:E914: 00        .byte $00   ; placeholder
; 04 heart (unused)
...
- - - - - - 0x00292A 00:E91A: 00        .byte $00   ; placeholder
- - - - - - 0x00292B 00:E91B: 00        .byte $00   ; placeholder
- - - - - - 0x00292C 00:E91C: 00        .byte $00   ; placeholder
; 05 apple
...
- - - - - - 0x002932 00:E922: 00        .byte $00   ; placeholder
- - - - - - 0x002933 00:E923: 00        .byte $00   ; placeholder
- - - - - - 0x002934 00:E924: 00        .byte $00   ; placeholder
; 06 banana
...
- - - - - - 0x00293A 00:E92A: 00        .byte $00   ; placeholder
- - - - - - 0x00293B 00:E92B: 00        .byte $00   ; placeholder
- - - - - - 0x00293C 00:E92C: 00        .byte $00   ; placeholder
; 07 spring (пружина)
...
- - - - - - 0x002942 00:E932: 00        .byte $00   ; placeholder
- - - - - - 0x002943 00:E933: 00        .byte $00   ; placeholder
- - - - - - 0x002944 00:E934: 00        .byte $00   ; placeholder
; 08 enemy
tbl_E935_86:
...
- - - - - - 0x00294A 00:E93A: 00        .byte $00   ; placeholder
- - - - - - 0x00294B 00:E93B: 00        .byte $00   ; placeholder
- - - - - - 0x00294C 00:E93C: 00        .byte $00   ; placeholder
; 09 player
...
- - - - - - 0x002952 00:E942: 00        .byte $00   ; placeholder
- - - - - - 0x002953 00:E943: 00        .byte $00   ; placeholder
- - - - - - 0x002954 00:E944: 00        .byte $00   ; placeholder



sub_E945_calculate_and_set_ppu_address:
C - - - - - 0x002955 00:E945: 20 53 E9  JSR sub_E953_calculate_ppu_address
C - - - - - 0x002958 00:E948: A5 01     LDA ram_0001_t01_ppu_addr_hi
C - - - - - 0x00295A 00:E94A: 8D 06 20  STA $2006
C - - - - - 0x00295D 00:E94D: A5 00     LDA ram_0000_t10_ppu_addr_lo
C - - - - - 0x00295F 00:E94F: 8D 06 20  STA $2006
C - - - - - 0x002962 00:E952: 60        RTS



sub_E953_calculate_ppu_address:
; in
    ; X = 
    ; Y = 
; out
    ; ram_0000_t10_ppu_addr_lo
    ; ram_0001_t01_ppu_addr_hi
C - - - - - 0x002963 00:E953: 84 00     STY ram_0000_t10_ppu_addr_lo
C - - - - - 0x002965 00:E955: A9 00     LDA #$00
; * 20
C - - - - - 0x002967 00:E957: 06 00     ASL ram_0000_t10_ppu_addr_lo
C - - - - - 0x002969 00:E959: 2A        ROL
C - - - - - 0x00296A 00:E95A: 06 00     ASL ram_0000_t10_ppu_addr_lo
C - - - - - 0x00296C 00:E95C: 2A        ROL
C - - - - - 0x00296D 00:E95D: 06 00     ASL ram_0000_t10_ppu_addr_lo
C - - - - - 0x00296F 00:E95F: 2A        ROL
C - - - - - 0x002970 00:E960: 06 00     ASL ram_0000_t10_ppu_addr_lo
C - - - - - 0x002972 00:E962: 2A        ROL
C - - - - - 0x002973 00:E963: 06 00     ASL ram_0000_t10_ppu_addr_lo
C - - - - - 0x002975 00:E965: 2A        ROL
C - - - - - 0x002976 00:E966: 85 01     STA ram_0001_t01_ppu_addr_hi
C - - - - - 0x002978 00:E968: 8A        TXA
C - - - - - 0x002979 00:E969: 18        CLC
C - - - - - 0x00297A 00:E96A: 65 00     ADC ram_0000_t10_ppu_addr_lo
C - - - - - 0x00297C 00:E96C: 85 00     STA ram_0000_t10_ppu_addr_lo
C - - - - - 0x00297E 00:E96E: A5 01     LDA ram_0001_t01_ppu_addr_hi
C - - - - - 0x002980 00:E970: 69 20     ADC #$20
C - - - - - 0x002982 00:E972: 85 01     STA ram_0001_t01_ppu_addr_hi
...
bra_E97A_loop:
C - - - - - 0x00298A 00:E97A: BD 00 05  LDA ram_0500_round_data,X
C - - - - - 0x00298D 00:E97D: 9D 00 06  STA ram_0600_round_data,X
...
C - - - - - 0x00299B 00:E98B: 84 05     STY ram_0005_t04
C - - - - - 0x00299D 00:E98D: A0 0D     LDY #$0D
C - - - - - 0x00299F 00:E98F: 84 04     STY ram_0004_t07_data_index
bra_E991_loop:
C - - - - - 0x0029A1 00:E991: A4 04     LDY ram_0004_t07_data_index
C - - - - - 0x0029A3 00:E993: B1 00     LDA (ram_0000_t03_rounds_data),Y
C - - - - - 0x0029A5 00:E995: 85 08     STA ram_0008_t06
C - - - - - 0x0029A7 00:E997: E6 04     INC ram_0004_t07_data_index
bra_E999_loop:
C - - - - - 0x0029A9 00:E999: A9 00     LDA #$00
C - - - - - 0x0029AB 00:E99B: 85 07     STA ram_0007_t03
C - - - - - 0x0029AD 00:E99D: 85 06     STA ram_0006_t07
; / 04
C - - - - - 0x0029AF 00:E99F: 46 08     LSR ram_0008_t06
C - - - - - 0x0029B1 00:E9A1: 66 06     ROR ram_0006_t07
C - - - - - 0x0029B3 00:E9A3: 46 08     LSR ram_0008_t06
C - - - - - 0x0029B5 00:E9A5: 26 06     ROL ram_0006_t07
; 
C - - - - - 0x0029B7 00:E9A7: 26 06     ROL ram_0006_t07
; / 04
C - - - - - 0x0029B9 00:E9A9: 46 08     LSR ram_0008_t06
C - - - - - 0x0029BB 00:E9AB: 66 07     ROR ram_0007_t03
C - - - - - 0x0029BD 00:E9AD: 46 08     LSR ram_0008_t06
C - - - - - 0x0029BF 00:E9AF: 26 07     ROL ram_0007_t03
; 
C - - - - - 0x0029C1 00:E9B1: 26 07     ROL ram_0007_t03
C - - - - - 0x0029C3 00:E9B3: E6 07     INC ram_0007_t03
bra_E9B5_loop:
C - - - - - 0x0029C5 00:E9B5: C6 05     DEC ram_0005_t04
C - - - - - 0x0029C7 00:E9B7: A4 05     LDY ram_0005_t04
C - - - - - 0x0029C9 00:E9B9: A5 06     LDA ram_0006_t07
C - - - - - 0x0029CB 00:E9BB: 99 50 06  STA ram_0600_round_data + $50,Y
C - - - - - 0x0029CE 00:E9BE: 98        TYA
C - - - - - 0x0029CF 00:E9BF: F0 0C     BEQ bra_E9CD
C - - - - - 0x0029D1 00:E9C1: C6 07     DEC ram_0007_t03
...
C - - - - - 0x0029DB 00:E9CB: D0 CC     BNE bra_E999_loop    ; jmp
bra_E9CD:
; bzk optimize, use LDX instead of LDY, delete LDX at 0x0029E9
C - - - - - 0x0029DD 00:E9CD: A0 01     LDY #$01
C - - - - - 0x0029DF 00:E9CF: 84 04     STY ram_0004_t02_data_index
C - - - - - 0x0029E1 00:E9D1: A9 00     LDA #$00
C - - - - - 0x0029E3 00:E9D3: 85 05     STA ram_0005_t05
C - - - - - 0x0029E5 00:E9D5: A9 09     LDA #$09
C - - - - - 0x0029E7 00:E9D7: 85 08     STA ram_0008_t04
C - - - - - 0x0029E9 00:E9D9: A2 01     LDX #$01
C - - - - - 0x0029EB 00:E9DB: 20 F8 E9  JSR sub_E9F8
C - - - - - 0x0029EE 00:E9DE: C6 08     DEC ram_0008_t04    ; -> 08
C - - - - - 0x0029F0 00:E9E0: A2 03     LDX #$03
C - - - - - 0x0029F2 00:E9E2: 20 F8 E9  JSR sub_E9F8
C - - - - - 0x0029F5 00:E9E5: C6 08     DEC ram_0008_t04    ; -> 07
C - - - - - 0x0029F7 00:E9E7: A2 02     LDX #$02
C - - - - - 0x0029F9 00:E9E9: 20 F8 E9  JSR sub_E9F8
C - - - - - 0x0029FC 00:E9EC: C6 08     DEC ram_0008_t04
C - - - - - 0x0029FE 00:E9EE: C6 08     DEC ram_0008_t04    ; -> 05
C - - - - - 0x002A00 00:E9F0: A0 0C     LDY #$0C
C - - - - - 0x002A02 00:E9F2: B1 00     LDA (ram_0000_t03_rounds_data),Y
C - - - - - 0x002A04 00:E9F4: 85 05     STA ram_0005_t05
C - - - - - 0x002A06 00:E9F6: A2 05     LDX #$05
bra_E9F8_loop:
sub_E9F8:
C - - - - - 0x002A08 00:E9F8: A4 04     LDY ram_0004_t02_data_index
C - - - - - 0x002A0A 00:E9FA: B1 00     LDA (ram_0000_t03_rounds_data),Y
C - - - - - 0x002A0C 00:E9FC: A8        TAY
C - - - - - 0x002A0D 00:E9FD: C8        INY
C - - - - - 0x002A0E 00:E9FE: D0 06     BNE bra_EA06
loc_EA00:
C D 3 - - - 0x002A10 00:EA00: E6 04     INC ram_0004_t02_data_index
C - - - - - 0x002A12 00:EA02: CA        DEX
C - - - - - 0x002A13 00:EA03: D0 F3     BNE bra_E9F8_loop
C - - - - - 0x002A15 00:EA05: 60        RTS
bra_EA06:
C - - - - - 0x002A16 00:EA06: 88        DEY
C - - - - - 0x002A17 00:EA07: A5 08     LDA ram_0008_t04
C - - - - - 0x002A19 00:EA09: 26 05     ROL ram_0005_t05
C - - - - - 0x002A1B 00:EA0B: 69 00     ADC #$00
C - - - - - 0x002A1D 00:EA0D: 99 50 06  STA ram_0600_round_data + $50,Y
...
bra_EA18_loop:
C - - - - - 0x002A28 00:EA18: BD 00 06  LDA ram_0600_round_data,X
C - - - - - 0x002A2B 00:EA1B: 9D 00 05  STA ram_0500_round_data,X
...
- - - - - - 0x002A4B 00:EA3B: 85 05     STA ram_0005_t01
- - - - - - 0x002A4D 00:EA3D: A9 06     LDA #$06
- - - - - - 0x002A4F 00:EA3F: 85 06     STA ram_0006_t06
- - - - - - 0x002A51 00:EA41: A9 80     LDA #$80
- - - - - - 0x002A53 00:EA43: 85 07     STA ram_0007_t01
- - - - - - 0x002A55 00:EA45: A9 00     LDA #$00
- - - - - - 0x002A57 00:EA47: 8D 0C 04  STA ram_0400_data + $0C
- - - - - - 0x002A5A 00:EA4A: A2 05     LDX #$05
bra_EA4C_loop:
- - - - - - 0x002A5C 00:EA4C: A5 06     LDA ram_0006_t06
- - - - - - 0x002A5E 00:EA4E: 20 8A EB  JSR sub_EB8A
- - - - - - 0x002A61 00:EA51: B0 13     BCS bra_EA66
- - - - - - 0x002A63 00:EA53: 99 00 04  STA ram_0400_data,Y
- - - - - - 0x002A66 00:EA56: C8        INY
- - - - - - 0x002A67 00:EA57: A5 07     LDA ram_0007_t01
- - - - - - 0x002A69 00:EA59: 0D 0C 04  ORA ram_0400_data + $0C
- - - - - - 0x002A6C 00:EA5C: 8D 0C 04  STA ram_0400_data + $0C
- - - - - - 0x002A6F 00:EA5F: 46 07     LSR ram_0007_t01
- - - - - - 0x002A71 00:EA61: CA        DEX
- - - - - - 0x002A72 00:EA62: D0 E8     BNE bra_EA4C_loop
- - - - - - 0x002A74 00:EA64: F0 19     BEQ bra_EA7F    ; jmp
bra_EA66:
- - - - - - 0x002A76 00:EA66: A9 B0     LDA #$B0
- - - - - - 0x002A78 00:EA68: 85 05     STA ram_0005_t01
- - - - - - 0x002A7A 00:EA6A: A9 00     LDA #$00
- - - - - - 0x002A7C 00:EA6C: 85 07     STA ram_0007_t01
- - - - - - 0x002A7E 00:EA6E: C6 06     DEC ram_0006_t06
- - - - - - 0x002A80 00:EA70: A5 06     LDA ram_0006_t06
- - - - - - 0x002A82 00:EA72: C9 04     CMP #$04
- - - - - - 0x002A84 00:EA74: D0 D6     BNE bra_EA4C_loop
bra_EA76_loop:
- - - - - - 0x002A86 00:EA76: A9 FF     LDA #$FF
- - - - - - 0x002A88 00:EA78: 99 00 04  STA ram_0400_data,Y
...
- - - - - - 0x002A92 00:EA82: 85 06     STA ram_0006_t05
- - - - - - 0x002A94 00:EA84: 85 08     STA ram_0008_t07
- - - - - - 0x002A96 00:EA86: AA        TAX
- - - - - - 0x002A97 00:EA87: A9 B0     LDA #$B0
- - - - - - 0x002A99 00:EA89: 85 05     STA ram_0005_t02
- - - - - - 0x002A9B 00:EA8B: 84 04     STY ram_0004_t08
- - - - - - 0x002A9D 00:EA8D: A9 00     LDA #$00
- - - - - - 0x002A9F 00:EA8F: 85 07     STA ram_0007_t02
bra_EA91_loop:
- - - - - - 0x002AA1 00:EA91: C6 05     DEC ram_0005_t02
- - - - - - 0x002AA3 00:EA93: A4 05     LDY ram_0005_t02
- - - - - - 0x002AA5 00:EA95: B9 50 06  LDA ram_0600_round_data + $50,Y
- - - - - - 0x002AA8 00:EA98: A8        TAY
- - - - - - 0x002AA9 00:EA99: C9 04     CMP #$04
- - - - - - 0x002AAB 00:EA9B: B0 08     BCS bra_EAA5
- - - - - - 0x002AAD 00:EA9D: C5 06     CMP ram_0006_t05
- - - - - - 0x002AAF 00:EA9F: F0 04     BEQ bra_EAA5
- - - - - - 0x002AB1 00:EAA1: E6 05     INC ram_0005_t02
- - - - - - 0x002AB3 00:EAA3: D0 0E     BNE bra_EAB3
bra_EAA5:
- - - - - - 0x002AB5 00:EAA5: E6 07     INC ram_0007_t02
- - - - - - 0x002AB7 00:EAA7: A5 07     LDA ram_0007_t02
- - - - - - 0x002AB9 00:EAA9: C9 04     CMP #$04
- - - - - - 0x002ABB 00:EAAB: F0 10     BEQ bra_EABD
- - - - - - 0x002ABD 00:EAAD: A4 05     LDY ram_0005_t02
- - - - - - 0x002ABF 00:EAAF: F0 0C     BEQ bra_EABD
- - - - - - 0x002AC1 00:EAB1: D0 DE     BNE bra_EA91_loop
bra_EAB3:
- - - - - - 0x002AC3 00:EAB3: A5 07     LDA ram_0007_t02
- - - - - - 0x002AC5 00:EAB5: D0 06     BNE bra_EABD
- - - - - - 0x002AC7 00:EAB7: 84 06     STY ram_0006_t08
- - - - - - 0x002AC9 00:EAB9: F0 D6     BEQ bra_EA91_loop
- - - - - - 0x002ACB 00:EABB: E6 05     INC ram_0005_t02
bra_EABD:
bra_EABD_loop:
- - - - - - 0x002ACD 00:EABD: C6 07     DEC ram_0007_t02
; / 04
- - - - - - 0x002ACF 00:EABF: 46 06     LSR ram_0006_t08
- - - - - - 0x002AD1 00:EAC1: 66 08     ROR ram_0008_t07
- - - - - - 0x002AD3 00:EAC3: 46 06     LSR ram_0006_t08
- - - - - - 0x002AD5 00:EAC5: 66 08     ROR ram_0008_t07
; / 04
- - - - - - 0x002AD7 00:EAC7: 46 07     LSR ram_0007_t02
- - - - - - 0x002AD9 00:EAC9: 66 08     ROR ram_0008_t07
- - - - - - 0x002ADB 00:EACB: 46 07     LSR ram_0007_t02
- - - - - - 0x002ADD 00:EACD: 66 08     ROR ram_0008_t07
- - - - - - 0x002ADF 00:EACF: A9 00     LDA #$00
; bzk optimize, useless STA
- - - - - - 0x002AE1 00:EAD1: 85 07     STA ram_0007_t04_useless
- - - - - - 0x002AE3 00:EAD3: E8        INX
- - - - - - 0x002AE4 00:EAD4: 8A        TXA
- - - - - - 0x002AE5 00:EAD5: 29 01     AND #$01
- - - - - - 0x002AE7 00:EAD7: F0 06     BEQ bra_EADF
- - - - - - 0x002AE9 00:EAD9: A4 05     LDY ram_0005_t02
- - - - - - 0x002AEB 00:EADB: F0 E0     BEQ bra_EABD_loop
- - - - - - 0x002AED 00:EADD: D0 B2     BNE bra_EA91_loop    ; jmp
bra_EADF:
- - - - - - 0x002AEF 00:EADF: A4 04     LDY ram_0004_t08
- - - - - - 0x002AF1 00:EAE1: A5 08     LDA ram_0008_t07
- - - - - - 0x002AF3 00:EAE3: 99 00 04  STA ram_0400_data,Y
- - - - - - 0x002AF6 00:EAE6: E6 04     INC ram_0004_t08
- - - - - - 0x002AF8 00:EAE8: A4 05     LDY ram_0005_t02
- - - - - - 0x002AFA 00:EAEA: F0 02     BEQ bra_EAEE
- - - - - - 0x002AFC 00:EAEC: D0 A3     BNE bra_EA91_loop    ; jmp
bra_EAEE:
- - - - - - 0x002AFE 00:EAEE: A5 04     LDA ram_0004_t08
- - - - - - 0x002B00 00:EAF0: 8D 00 04  STA ram_0400_data
- - - - - - 0x002B03 00:EAF3: 20 B9 EB  JSR sub_EBB9
- - - - - - 0x002B06 00:EAF6: A2 00     LDX #$00
- - - - - - 0x002B08 00:EAF8: AD 00 04  LDA ram_0400_data
- - - - - - 0x002B0B 00:EAFB: 38        SEC
- - - - - - 0x002B0C 00:EAFC: E1 00     SBC (ram_0000_t03_rounds_data,X)
- - - - - - 0x002B0E 00:EAFE: F0 79     BEQ bra_EB79
- - - - - - 0x002B10 00:EB00: B0 49     BCS bra_EB4B
- - - - - - 0x002B12 00:EB02: 85 04     STA ram_0004_t06
; invert
- - - - - - 0x002B14 00:EB04: A9 00     LDA #$00
- - - - - - 0x002B16 00:EB06: 38        SEC
- - - - - - 0x002B17 00:EB07: E5 04     SBC ram_0004_t06
- - - - - - 0x002B19 00:EB09: 85 04     STA ram_0004_t06
; 
- - - - - - 0x002B1B 00:EB0B: A9 F8     LDA #< $FFF8
- - - - - - 0x002B1D 00:EB0D: 85 02     STA ram_0002_t07_lo
- - - - - - 0x002B1F 00:EB0F: A9 FF     LDA #> $FFF8
- - - - - - 0x002B21 00:EB11: 85 03     STA ram_0003_t03_hi
...
- - - - - - 0x002B2A 00:EB1A: A5 00     LDA ram_0000_t03_rounds_data
- - - - - - 0x002B2C 00:EB1C: 38        SEC
- - - - - - 0x002B2D 00:EB1D: E5 04     SBC ram_0004_t06
- - - - - - 0x002B2F 00:EB1F: 85 00     STA ram_0000_t03_rounds_data
- - - - - - 0x002B31 00:EB21: A5 01     LDA ram_0000_t03_rounds_data + $01
- - - - - - 0x002B33 00:EB23: E9 00     SBC #$00
- - - - - - 0x002B35 00:EB25: 85 01     STA ram_0000_t03_rounds_data + $01
- - - - - - 0x002B37 00:EB27: A4 04     LDY ram_0004_t06
- - - - - - 0x002B39 00:EB29: A2 00     LDX #$00
- - - - - - 0x002B3B 00:EB2B: A5 00     LDA ram_0000_t03_rounds_data
- - - - - - 0x002B3D 00:EB2D: D0 02     BNE bra_EB31
- - - - - - 0x002B3F 00:EB2F: C6 01     DEC ram_0000_t03_rounds_data + $01
bra_EB31:
- - - - - - 0x002B41 00:EB31: C6 00     DEC ram_0000_t03_rounds_data
bra_EB33_loop:
- - - - - - 0x002B43 00:EB33: E6 00     INC ram_0000_t03_rounds_data
- - - - - - 0x002B45 00:EB35: D0 02     BNE bra_EB39_not_overflow
- - - - - - 0x002B47 00:EB37: E6 01     INC ram_0000_t03_rounds_data + $01
bra_EB39_not_overflow:
- - - - - - 0x002B49 00:EB39: B1 00     LDA (ram_0000_t03_rounds_data),Y
- - - - - - 0x002B4B 00:EB3B: 81 00     STA (ram_0000_t03_rounds_data,X)
- - - - - - 0x002B4D 00:EB3D: A5 01     LDA ram_0000_t03_rounds_data + $01
- - - - - - 0x002B4F 00:EB3F: C5 03     CMP ram_0003_t03_hi
- - - - - - 0x002B51 00:EB41: D0 F0     BNE bra_EB33_loop
- - - - - - 0x002B53 00:EB43: A5 00     LDA ram_0000_t03_rounds_data
- - - - - - 0x002B55 00:EB45: C5 02     CMP ram_0002_t07_lo
- - - - - - 0x002B57 00:EB47: D0 EA     BNE bra_EB33_loop
- - - - - - 0x002B59 00:EB49: F0 2E     BEQ bra_EB79    ; jmp
bra_EB4B:
- - - - - - 0x002B5B 00:EB4B: 85 04     STA ram_0004_t05_data_index
- - - - - - 0x002B5D 00:EB4D: 20 B9 EB  JSR sub_EBB9
- - - - - - 0x002B60 00:EB50: A9 F8     LDA #< $FFF8
- - - - - - 0x002B62 00:EB52: 38        SEC
- - - - - - 0x002B63 00:EB53: E5 04     SBC ram_0004_t05_data_index
- - - - - - 0x002B65 00:EB55: 85 02     STA ram_0002_t04_data
- - - - - - 0x002B67 00:EB57: A9 FF     LDA #> $FFF8
- - - - - - 0x002B69 00:EB59: E9 00     SBC #$00
- - - - - - 0x002B6B 00:EB5B: 85 03     STA ram_0002_t04_data + $01
- - - - - - 0x002B6D 00:EB5D: A2 00     LDX #$00
- - - - - - 0x002B6F 00:EB5F: A4 04     LDY ram_0004_t05_data_index
bra_EB61_loop:
- - - - - - 0x002B71 00:EB61: A1 02     LDA (ram_0002_t04_data,X)
- - - - - - 0x002B73 00:EB63: 91 02     STA (ram_0002_t04_data),Y
- - - - - - 0x002B75 00:EB65: A5 02     LDA ram_0002_t04_data
- - - - - - 0x002B77 00:EB67: D0 02     BNE bra_EB6B
- - - - - - 0x002B79 00:EB69: C6 03     DEC ram_0002_t04_data + $01
bra_EB6B:
- - - - - - 0x002B7B 00:EB6B: C6 02     DEC ram_0002_t04_data
- - - - - - 0x002B7D 00:EB6D: A5 01     LDA ram_0000_t03_rounds_data + $01
- - - - - - 0x002B7F 00:EB6F: C5 03     CMP ram_0002_t04_data + $01
- - - - - - 0x002B81 00:EB71: D0 EE     BNE bra_EB61_loop
- - - - - - 0x002B83 00:EB73: A5 00     LDA ram_0000_t03_rounds_data
- - - - - - 0x002B85 00:EB75: C5 02     CMP ram_0002_t04_data
- - - - - - 0x002B87 00:EB77: D0 E8     BNE bra_EB61_loop
bra_EB79:
- - - - - - 0x002B89 00:EB79: 20 B9 EB  JSR sub_EBB9
- - - - - - 0x002B8C 00:EB7C: A0 00     LDY #$00
bra_EB7E_loop:
- - - - - - 0x002B8E 00:EB7E: B9 00 04  LDA ram_0400_data,Y
- - - - - - 0x002B91 00:EB81: 91 00     STA (ram_0000_t03_rounds_data),Y
- - - - - - 0x002B93 00:EB83: C8        INY
- - - - - - 0x002B94 00:EB84: CC 00 04  CPY ram_0400_data
- - - - - - 0x002B97 00:EB87: D0 F5     BNE bra_EB7E_loop
...
; out
    ; A = 
- - - - - - 0x002B9A 00:EB8A: 84 04     STY ram_0004_t03_save_Y
- - - - - - 0x002B9C 00:EB8C: 20 A5 EB  JSR sub_EBA5
- - - - - - 0x002B9F 00:EB8F: A4 04     LDY ram_0004_t03_save_Y
...
- - - - - - 0x002BA5 00:EB95: 85 05     STA ram_0005_t01
- - - - - - 0x002BA7 00:EB97: 68        PLA
bra_EB98_loop:
- - - - - - 0x002BA8 00:EB98: 48        PHA
- - - - - - 0x002BA9 00:EB99: 20 8A EB  JSR sub_EB8A
- - - - - - 0x002BAC 00:EB9C: 99 00 04  STA ram_0400_data,Y
...
; out
    ; A = 
bra_EBA5_loop:
- - - - - - 0x002BB5 00:EBA5: A4 05     LDY ram_0005_t01
- - - - - - 0x002BB7 00:EBA7: D0 04     BNE bra_EBAD
- - - - - - 0x002BB9 00:EBA9: A9 FF     LDA #$FF
; bzk optimize, C will not be checked
- - - - - - 0x002BBB 00:EBAB: 38        SEC
- - - - - - 0x002BBC 00:EBAC: 60        RTS
bra_EBAD:
- - - - - - 0x002BBD 00:EBAD: C6 05     DEC ram_0005_t01
- - - - - - 0x002BBF 00:EBAF: A4 05     LDY ram_0005_t01
- - - - - - 0x002BC1 00:EBB1: D9 50 06  CMP ram_0600_round_data + $50,Y
...
; bzk I suppose this byte with size also used as a counter of how
...
C - - - - - 0x002BCD 00:EBBD: 85 00     STA ram_0000_t03_rounds_data
C - - - - - 0x002BCF 00:EBBF: A9 F6     LDA #> tbl_F600_rounds_data
C - - - - - 0x002BD1 00:EBC1: 85 01     STA ram_0000_t03_rounds_data + $01
...
C - - - - - 0x002BD9 00:EBC9: B1 00     LDA (ram_0000_t03_rounds_data),Y
C - - - - - 0x002BDB 00:EBCB: 18        CLC
C - - - - - 0x002BDC 00:EBCC: 65 00     ADC ram_0000_t03_rounds_data
C - - - - - 0x002BDE 00:EBCE: 85 00     STA ram_0000_t03_rounds_data
C - - - - - 0x002BE0 00:EBD0: 90 02     BCC bra_EBD4_not_overflow
C - - - - - 0x002BE2 00:EBD2: E6 01     INC ram_0000_t03_rounds_data + $01
bra_EBD4_not_overflow:
C - - - - - 0x002BE4 00:EBD4: 4C C5 EB  JMP loc_EBC5_loop



loc_EBD7_write_data_to_buffer:
sub_EBD7_write_data_to_buffer:
; in
    ; ram_0000_t06_ppu_data
    ; ram_0002_t06_ppu_addr_lo
    ; ram_0003_t02_ppu_addr_hi
bra_EBD7_infinite_loop:
C D 3 - - - 0x002BE7 00:EBD7: AD 00 02  LDA ram_ppu_buffer
C - - - - - 0x002BEA 00:EBDA: D0 FB     BNE bra_EBD7_infinite_loop
C - - - - - 0x002BEC 00:EBDC: A0 00     LDY #$00
bra_EBDE_loop:
; calculate text size
C - - - - - 0x002BEE 00:EBDE: B1 00     LDA (ram_0000_t06_ppu_data),Y
C - - - - - 0x002BF0 00:EBE0: F0 03     BEQ bra_EBE5_00
C - - - - - 0x002BF2 00:EBE2: C8        INY
C - - - - - 0x002BF3 00:EBE3: D0 F9     BNE bra_EBDE_loop   ; jmp
bra_EBE5_00:
C - - - - - 0x002BF5 00:EBE5: 84 0F     STY ram_000F_t01_text_size
C - - - - - 0x002BF7 00:EBE7: A6 27     LDX ram_buffer_index
C - - - - - 0x002BF9 00:EBE9: 98        TYA
C - - - - - 0x002BFA 00:EBEA: 09 80     ORA #$80
C - - - - - 0x002BFC 00:EBEC: 20 17 EC  JSR sub_EC17_write_to_buffer
C - - - - - 0x002BFF 00:EBEF: A5 03     LDA ram_0003_t02_ppu_addr_hi
C - - - - - 0x002C01 00:EBF1: 20 17 EC  JSR sub_EC17_write_to_buffer
C - - - - - 0x002C04 00:EBF4: A5 02     LDA ram_0002_t06_ppu_addr_lo
C - - - - - 0x002C06 00:EBF6: 20 17 EC  JSR sub_EC17_write_to_buffer
C - - - - - 0x002C09 00:EBF9: A0 00     LDY #$00
bra_EBFB_loop:
C - - - - - 0x002C0B 00:EBFB: B1 00     LDA (ram_0000_t06_ppu_data),Y
C - - - - - 0x002C0D 00:EBFD: 20 17 EC  JSR sub_EC17_write_to_buffer
C - - - - - 0x002C10 00:EC00: C8        INY
C - - - - - 0x002C11 00:EC01: C4 0F     CPY ram_000F_t01_text_size
C - - - - - 0x002C13 00:EC03: D0 F6     BNE bra_EBFB_loop
C - - - - - 0x002C15 00:EC05: 86 27     STX ram_buffer_index
C - - - - - 0x002C17 00:EC07: 60        RTS



sub_EC08:
C - - - - - 0x002C18 00:EC08: A6 27     LDX ram_buffer_index
C - - - - - 0x002C1A 00:EC0A: A9 00     LDA #$00
C - - - - - 0x002C1C 00:EC0C: 20 17 EC  JSR sub_EC17_write_to_buffer
C - - - - - 0x002C1F 00:EC0F: 86 27     STX ram_buffer_index
C - - - - - 0x002C21 00:EC11: A9 01     LDA #$01
C - - - - - 0x002C23 00:EC13: 8D 00 02  STA ram_ppu_buffer
C - - - - - 0x002C26 00:EC16: 60        RTS



sub_EC17_write_to_buffer:
C - - - - - 0x002C27 00:EC17: 9D 00 02  STA ram_ppu_buffer,X
...
- - - - - - 0x002C32 00:EC22: 8D 01 02  STA ram_ppu_buffer + $01
- - - - - - 0x002C35 00:EC25: A2 02     LDX #$02
- - - - - - 0x002C37 00:EC27: 60        RTS



sub_EC28_print_tiles_on_black_background:
; in
    ; ram_0000_t02_ppu_data
; compared to 0x002BE7, this one doesn't use buffer,
; and can print several lines at once
bra_EC28_loop:
C - - - - - 0x002C38 00:EC28: A0 00     LDY #$00
C - - - - - 0x002C3A 00:EC2A: B1 00     LDA (ram_0000_t02_ppu_data),Y
C - - - - - 0x002C3C 00:EC2C: 85 02     STA ram_0002_t08_ppu_addr_lo
C - - - - - 0x002C3E 00:EC2E: C8        INY ; 01
C - - - - - 0x002C3F 00:EC2F: B1 00     LDA (ram_0000_t02_ppu_data),Y
C - - - - - 0x002C41 00:EC31: 85 03     STA ram_0003_t04_ppu_addr_hi
C - - - - - 0x002C43 00:EC33: C8        INY
C - - - - - 0x002C44 00:EC34: 25 02     AND ram_0002_t08_ppu_addr_lo
C - - - - - 0x002C46 00:EC36: C9 FF     CMP #$FF
C - - - - - 0x002C48 00:EC38: F0 20     BEQ bra_EC5A_RTS
C - - - - - 0x002C4A 00:EC3A: A5 03     LDA ram_0003_t04_ppu_addr_hi
C - - - - - 0x002C4C 00:EC3C: 8D 06 20  STA $2006
C - - - - - 0x002C4F 00:EC3F: A5 02     LDA ram_0002_t08_ppu_addr_lo
C - - - - - 0x002C51 00:EC41: 8D 06 20  STA $2006
bra_EC44_loop:
C - - - - - 0x002C54 00:EC44: B1 00     LDA (ram_0000_t02_ppu_data),Y
C - - - - - 0x002C56 00:EC46: F0 06     BEQ bra_EC4E
C - - - - - 0x002C58 00:EC48: 20 26 C0  JSR sub_C026_write_A_to_2007
C - - - - - 0x002C5B 00:EC4B: C8        INY
C - - - - - 0x002C5C 00:EC4C: D0 F6     BNE bra_EC44_loop
bra_EC4E:
C - - - - - 0x002C5E 00:EC4E: 98        TYA
C - - - - - 0x002C5F 00:EC4F: 38        SEC
C - - - - - 0x002C60 00:EC50: 65 00     ADC ram_0000_t02_ppu_data
C - - - - - 0x002C62 00:EC52: 85 00     STA ram_0000_t02_ppu_data
C - - - - - 0x002C64 00:EC54: 90 D2     BCC bra_EC28_loop
C - - - - - 0x002C66 00:EC56: E6 01     INC ram_0000_t02_ppu_data + $01
...
loc_EC5B_write_data_to_ppu:
; in
    ; ram_0000_t06_ppu_data
C D 3 - - - 0x002C6B 00:EC5B: A5 03     LDA ram_0003_t02_ppu_addr_hi
C - - - - - 0x002C6D 00:EC5D: 8D 06 20  STA $2006
C - - - - - 0x002C70 00:EC60: A5 02     LDA ram_0002_t06_ppu_addr_lo
C - - - - - 0x002C72 00:EC62: 8D 06 20  STA $2006
C - - - - - 0x002C75 00:EC65: A0 00     LDY #$00
loc_EC67_loop:
C D 3 - - - 0x002C77 00:EC67: B1 00     LDA (ram_0000_t06_ppu_data),Y
C - - - - - 0x002C79 00:EC69: F0 07     BEQ bra_EC72_RTS
C - - - - - 0x002C7B 00:EC6B: 20 26 C0  JSR sub_C026_write_A_to_2007
C - - - - - 0x002C7E 00:EC6E: C8        INY
C - - - - - 0x002C7F 00:EC6F: 4C 67 EC  JMP loc_EC67_loop
bra_EC72_RTS:
...
sub_EC73:
loc_EC73:
C D 3 - - - 0x002C83 00:EC73: 20 AA EF  JSR sub_EFAA_hide_all_sprites
...
C - - - - - 0x002C9B 00:EC8B: 20 26 C0  JSR sub_C026_write_A_to_2007
...
C - - - - - 0x002CAF 00:EC9F: 20 26 C0  JSR sub_C026_write_A_to_2007
C - - - - - 0x002CB2 00:ECA2: A9 21     LDA #con_ppu_color + $21
C - - - - - 0x002CB4 00:ECA4: 20 26 C0  JSR sub_C026_write_A_to_2007
...
C - - - - - 0x002CC3 00:ECB3: 20 26 C0  JSR sub_C026_write_A_to_2007
...
C - - - - - 0x002CD4 00:ECC4: 20 26 C0  JSR sub_C026_write_A_to_2007
...
C - - - - - 0x002CDE 00:ECCE: 20 26 C0  JSR sub_C026_write_A_to_2007
...
C - - - - - 0x002CE8 00:ECD8: 20 26 C0  JSR sub_C026_write_A_to_2007
...
C - - - - - 0x002CF0 00:ECE0: 85 00     STA ram_0000_t02_ppu_data
C - - - - - 0x002CF2 00:ECE2: A9 ED     LDA #> tbl_EDDC_tiles___title_screen
C - - - - - 0x002CF4 00:ECE4: 85 01     STA ram_0000_t02_ppu_data + $01
C - - - - - 0x002CF6 00:ECE6: 20 28 EC  JSR sub_EC28_print_tiles_on_black_background
C - - - - - 0x002CF9 00:ECE9: 20 76 EF  JSR sub_EF76
C - - - - - 0x002CFC 00:ECEC: 20 1B F3  JSR sub_F31B
C - - - - - 0x002CFF 00:ECEF: A5 EB     LDA ram_demo_counter
C - - - - - 0x002D01 00:ECF1: D0 06     BNE bra_ECF9
C - - - - - 0x002D03 00:ECF3: 20 D4 F2  JSR sub_F2D4
C - - - - - 0x002D06 00:ECF6: 20 46 F0  JSR sub_F046_play_music___title_screen
bra_ECF9:
C - - - - - 0x002D09 00:ECF9: A9 00     LDA #$00
C - - - - - 0x002D0B 00:ECFB: 85 A7     STA ram_sound_channel_4_flag
...
; bzk optimize, loading same A
C - - - - - 0x002D15 00:ED05: A9 00     LDA #$00
C - - - - - 0x002D17 00:ED07: 85 A5     STA ram_00A5
C - - - - - 0x002D19 00:ED09: A9 00     LDA #$00
C - - - - - 0x002D1B 00:ED0B: 85 E1     STA ram_00E1_current_player
; write option index based on cursor position.
; this is needed when you return from demo
C - - - - - 0x002D1D 00:ED0D: A5 2F     LDA ram_cursor_pos_Y
...
C - - - - - 0x002D26 00:ED16: 85 E0     STA ram_option_game_mode
C - - - - - 0x002D28 00:ED18: 20 C7 ED  JSR sub_EDC7_write_sprite_cursor_data
C - - - - - 0x002D2B 00:ED1B: A9 01     LDA #$01
C - - - - - 0x002D2D 00:ED1D: 85 26     STA ram_nmi_wait_flag
bra_ED1F_infinite_loop:
C - - - - - 0x002D2F 00:ED1F: A5 26     LDA ram_nmi_wait_flag
...
bra_ED27_loop:
loc_ED27_loop:
C D 3 - - - 0x002D37 00:ED27: A5 EB     LDA ram_demo_counter
C - - - - - 0x002D39 00:ED29: D0 07     BNE bra_ED32
C - - - - - 0x002D3B 00:ED2B: A5 34     LDA ram_sound_channel_1_flag
...
C - - - - - 0x002D57 00:ED47: AD 71 C0  LDA tbl_C070 + $01
C - - - - - 0x002D5A 00:ED4A: 85 A2     STA ram_00A2
C - - - - - 0x002D5C 00:ED4C: A9 00     LDA #$00
C - - - - - 0x002D5E 00:ED4E: 85 E0     STA ram_players_counter
C - - - - - 0x002D60 00:ED50: A9 01     LDA #$01
C - - - - - 0x002D62 00:ED52: 85 A7     STA ram_sound_channel_4_flag
C - - - - - 0x002D64 00:ED54: 20 AA EF  JSR sub_EFAA_hide_all_sprites
; bzk optimize, JMP
C - - - - - 0x002D67 00:ED57: 20 1B F3  JSR sub_F31B
C - - - - - 0x002D6A 00:ED5A: 60        RTS
bra_ED5B:
loc_ED5B:
C D 3 - - - 0x002D6B 00:ED5B: 20 C7 ED  JSR sub_EDC7_write_sprite_cursor_data
...
C - - - - - 0x002D7A 00:ED6A: A4 E0     LDY ram_option_game_mode
C - - - - - 0x002D7C 00:ED6C: A6 2F     LDX ram_cursor_pos_Y
C - - - - - 0x002D7E 00:ED6E: C0 04     CPY #$04
C - - - - - 0x002D80 00:ED70: D0 04     BNE bra_ED76
; if at the last option
...
C - - - - - 0x002D8A 00:ED7A: 85 2F     STA ram_cursor_pos_Y
C - - - - - 0x002D8C 00:ED7C: 8D 00 07  STA ram_spr_Y
C - - - - - 0x002D8F 00:ED7F: C8        INY
C - - - - - 0x002D90 00:ED80: 84 E0     STY ram_option_game_mode
...
bra_ED8F:
C - - - - - 0x002D9F 00:ED8F: 20 AA EF  JSR sub_EFAA_hide_all_sprites
C - - - - - 0x002DA2 00:ED92: 20 1B F3  JSR sub_F31B
C - - - - - 0x002DA5 00:ED95: A5 E0     LDA ram_option_game_mode
C - - - - - 0x002DA7 00:ED97: C9 04     CMP #$04
C - - - - - 0x002DA9 00:ED99: F0 26     BEQ bra_EDC1_04_game_editor
C - - - - - 0x002DAB 00:ED9B: AA        TAX
C - - - - - 0x002DAC 00:ED9C: 4A        LSR
C - - - - - 0x002DAD 00:ED9D: 85 E0     STA ram_players_counter
C - - - - - 0x002DAF 00:ED9F: 8A        TXA
C - - - - - 0x002DB0 00:EDA0: 29 01     AND #$01
C - - - - - 0x002DB2 00:EDA2: 85 E8     STA ram_00E8_game_mode
C - - - - - 0x002DB4 00:EDA4: 85 E9     STA ram_00E9_game_mode
C - - - - - 0x002DB6 00:EDA6: A9 00     LDA #$00
C - - - - - 0x002DB8 00:EDA8: 85 A0     STA ram_00A0
; bzk optimize, loading same A
C - - - - - 0x002DBA 00:EDAA: A9 00     LDA #$00
C - - - - - 0x002DBC 00:EDAC: 85 A1     STA ram_00A1
C - - - - - 0x002DBE 00:EDAE: A9 00     LDA #$00
C - - - - - 0x002DC0 00:EDB0: 85 A2     STA ram_00A2
C - - - - - 0x002DC2 00:EDB2: A9 00     LDA #$00
C - - - - - 0x002DC4 00:EDB4: 85 A7     STA ram_sound_channel_4_flag
C - - - - - 0x002DC6 00:EDB6: A9 00     LDA #$00
C - - - - - 0x002DC8 00:EDB8: 85 B8     STA ram_score_lo_p1
C - - - - - 0x002DCA 00:EDBA: 85 B9     STA ram_score_hi_p1
C - - - - - 0x002DCC 00:EDBC: 85 BC     STA ram_score_lo_p2
C - - - - - 0x002DCE 00:EDBE: 85 BD     STA ram_score_hi_p2
C - - - - - 0x002DD0 00:EDC0: 60        RTS
bra_EDC1_04_game_editor:
C - - - - - 0x002DD1 00:EDC1: 20 35 E1  JSR sub_E135
C - - - - - 0x002DD4 00:EDC4: 4C 73 EC  JMP loc_EC73



sub_EDC7_write_sprite_cursor_data:
C - - - - - 0x002DD7 00:EDC7: A5 2F     LDA ram_cursor_pos_Y
...
C - - - - - 0x002F70 00:EF60: 20 26 C0  JSR sub_C026_write_A_to_2007
...
sub_EF6C:
C - - - - - 0x002F7C 00:EF6C: A9 01     LDA #$01    ; disabled
C - - - - - 0x002F7E 00:EF6E: 85 E6     STA ram_nmi_enabled_flag
...
sub_EF76:
loc_EF76:
C D 3 - - - 0x002F86 00:EF76: A9 00     LDA #$00    ; enabled
C - - - - - 0x002F88 00:EF78: 85 E6     STA ram_nmi_enabled_flag
C - - - - - 0x002F8A 00:EF7A: 20 83 EF  JSR sub_EF83_set_scroll_00FF
C - - - - - 0x002F8D 00:EF7D: 20 8E EF  JSR sub_EF8E
C - - - - - 0x002F90 00:EF80: 4C C7 EF  JMP loc_EFC7



sub_EF83_set_scroll_00FF:
...
sub_EFAA_hide_all_sprites:
; bzk optimize, use a loop with absolute indexed addressing mode
C - - - - - 0x002FBA 00:EFAA: A9 00     LDA #< ram_oam
C - - - - - 0x002FBC 00:EFAC: 85 10     STA ram_0010_t03_oam_data
C - - - - - 0x002FBE 00:EFAE: A9 07     LDA #> ram_oam
C - - - - - 0x002FC0 00:EFB0: 85 11     STA ram_0010_t03_oam_data + $01
C - - - - - 0x002FC2 00:EFB2: A0 00     LDY #$00
C - - - - - 0x002FC4 00:EFB4: A9 F8     LDA #$F8
bra_EFB6_loop:
C - - - - - 0x002FC6 00:EFB6: 91 10     STA (ram_0010_t03_oam_data),Y
...
C - - - - - 0x002FE2 00:EFD2: 8D 00 02  STA ram_ppu_buffer
C - - - - - 0x002FE5 00:EFD5: 8D 01 02  STA ram_ppu_buffer + $01
bra_EFD8_infinite_loop:
C - - - - - 0x002FE8 00:EFD8: AD 00 02  LDA ram_ppu_buffer
...
- - - - - - 0x002FF5 00:EFE5: 85 34     STA ram_sound_channel_1_flag
- - - - - - 0x002FF7 00:EFE7: 60        RTS



sub_EFE8:
; bzk optimize, transfer this code instead of JSR
C - - - - - 0x002FF8 00:EFE8: A9 00     LDA #$00
C - - - - - 0x002FFA 00:EFEA: 85 38     STA ram_sound_channel_2_flag
C - - - - - 0x002FFC 00:EFEC: 60        RTS



sub_EFED_play_sound___long_fall:
C - - - - - 0x002FFD 00:EFED: 48        PHA
C - - - - - 0x002FFE 00:EFEE: A5 A7     LDA ram_sound_channel_4_flag
C - - - - - 0x003000 00:EFF0: D0 10     BNE bra_F002
C - - - - - 0x003002 00:EFF2: A9 DA     LDA #< tbl_F5DA_sound___long_fall
C - - - - - 0x003004 00:EFF4: 85 36     STA ram_0036_se_t01_ch2_data
C - - - - - 0x003006 00:EFF6: A9 F5     LDA #> tbl_F5DA_sound___long_fall
C - - - - - 0x003008 00:EFF8: 85 37     STA ram_0036_se_t01_ch2_data + $01
C - - - - - 0x00300A 00:EFFA: A9 01     LDA #$01
C - - - - - 0x00300C 00:EFFC: 85 38     STA ram_sound_channel_2_flag
C - - - - - 0x00300E 00:EFFE: A9 02     LDA #$02
C - - - - - 0x003010 00:F000: 85 39     STA ram_sound_channel_2_timer
bra_F002:
...
sub_F004_play_music___bonus_round_announcement:
C - - - - - 0x003014 00:F004: A9 B9     LDA #< tbl_F5B9_music___bonus_round_announcement
C - - - - - 0x003016 00:F006: 85 32     STA ram_0032_se_t01_ch1_data
C - - - - - 0x003018 00:F008: A9 F5     LDA #> tbl_F5B9_music___bonus_round_announcement
C - - - - - 0x00301A 00:F00A: 85 33     STA ram_0032_se_t01_ch1_data + $01
C - - - - - 0x00301C 00:F00C: A9 BA     LDA #< (tbl_F5B9_music___bonus_round_announcement + $01)
C - - - - - 0x00301E 00:F00E: 85 36     STA ram_0036_se_t01_ch2_data
C - - - - - 0x003020 00:F010: A9 F5     LDA #> (tbl_F5B9_music___bonus_round_announcement + $01)
C - - - - - 0x003022 00:F012: 85 37     STA ram_0036_se_t01_ch2_data + $01
sub_F014:
C - - - - - 0x003024 00:F014: A9 01     LDA #$01
C - - - - - 0x003026 00:F016: 85 34     STA ram_sound_channel_1_flag
C - - - - - 0x003028 00:F018: 85 38     STA ram_sound_channel_2_flag
C - - - - - 0x00302A 00:F01A: 60        RTS



sub_F01B_play_music___soundtrack:
; background music during rounds
C - - - - - 0x00302B 00:F01B: A5 20     LDA ram_current_round
C - - - - - 0x00302D 00:F01D: 29 01     AND #$01
C - - - - - 0x00302F 00:F01F: D0 0B     BNE bra_F02C
C - - - - - 0x003031 00:F021: A9 44     LDA #< tbl_F544_music___soundtrack_1
C - - - - - 0x003033 00:F023: 85 3A     STA ram_003A_se_t01_ch3_data
C - - - - - 0x003035 00:F025: A9 F5     LDA #> tbl_F544_music___soundtrack_1
C - - - - - 0x003037 00:F027: 85 3B     STA ram_003A_se_t01_ch3_data + $01
C - - - - - 0x003039 00:F029: 4C 34 F0  JMP loc_F034
bra_F02C:
C - - - - - 0x00303C 00:F02C: A9 03     LDA #< tbl_F503_music___soundtrack_2
C - - - - - 0x00303E 00:F02E: 85 3A     STA ram_003A_se_t01_ch3_data
C - - - - - 0x003040 00:F030: A9 F5     LDA #> tbl_F503_music___soundtrack_2
C - - - - - 0x003042 00:F032: 85 3B     STA ram_003A_se_t01_ch3_data + $01
loc_F034:
C D 3 - - - 0x003044 00:F034: A9 01     LDA #$01
C - - - - - 0x003046 00:F036: 85 3C     STA ram_sound_channel_3_flag
C - - - - - 0x003048 00:F038: 60        RTS



sub_F039_play_music___bonus_round_soundtrack:
; !!!
C - - - - - 0x003049 00:F039: A9 7B     LDA #< (tbl_F37A_music___title_screen + $01)
C - - - - - 0x00304B 00:F03B: 85 3A     STA ram_003A_se_t01_ch3_data
C - - - - - 0x00304D 00:F03D: A9 F3     LDA #> (tbl_F37A_music___title_screen + $01)
C - - - - - 0x00304F 00:F03F: 85 3B     STA ram_003A_se_t01_ch3_data + $01
C - - - - - 0x003051 00:F041: A9 01     LDA #$01
C - - - - - 0x003053 00:F043: 85 3C     STA ram_sound_channel_3_flag
C - - - - - 0x003055 00:F045: 60        RTS



sub_F046_play_music___title_screen:
C - - - - - 0x003056 00:F046: A9 7A     LDA #< tbl_F37A_music___title_screen
C - - - - - 0x003058 00:F048: 85 32     STA ram_0032_se_t01_ch1_data
C - - - - - 0x00305A 00:F04A: A9 F3     LDA #> tbl_F37A_music___title_screen
C - - - - - 0x00305C 00:F04C: 85 33     STA ram_0032_se_t01_ch1_data + $01
C - - - - - 0x00305E 00:F04E: A9 7B     LDA #< (tbl_F37A_music___title_screen + $01)
C - - - - - 0x003060 00:F050: 85 36     STA ram_0036_se_t01_ch2_data
C - - - - - 0x003062 00:F052: A9 F3     LDA #> (tbl_F37A_music___title_screen + $01)
C - - - - - 0x003064 00:F054: 85 37     STA ram_0036_se_t01_ch2_data + $01
C - - - - - 0x003066 00:F056: A9 7C     LDA #< (tbl_F37A_music___title_screen + $02)
C - - - - - 0x003068 00:F058: 85 3A     STA ram_003A_se_t01_ch3_data
C - - - - - 0x00306A 00:F05A: A9 F3     LDA #> (tbl_F37A_music___title_screen + $02)
C - - - - - 0x00306C 00:F05C: 85 3B     STA ram_003A_se_t01_ch3_data + $01
sub_F05E:
C - - - - - 0x00306E 00:F05E: 20 14 F0  JSR sub_F014
C - - - - - 0x003071 00:F061: 85 3C     STA ram_sound_channel_3_flag
C - - - - - 0x003073 00:F063: 60        RTS



sub_F064_play_music___bonus_round_completed:
C - - - - - 0x003074 00:F064: A9 DA     LDA #< tbl_F3DA_music___bonus_round_completed
C - - - - - 0x003076 00:F066: 85 32     STA ram_0032_se_t01_ch1_data
C - - - - - 0x003078 00:F068: A9 F3     LDA #> tbl_F3DA_music___bonus_round_completed
C - - - - - 0x00307A 00:F06A: 85 33     STA ram_0032_se_t01_ch1_data + $01
C - - - - - 0x00307C 00:F06C: A9 DB     LDA #< (tbl_F3DA_music___bonus_round_completed + $01)
C - - - - - 0x00307E 00:F06E: 85 36     STA ram_0036_se_t01_ch2_data
C - - - - - 0x003080 00:F070: A9 F3     LDA #> (tbl_F3DA_music___bonus_round_completed + $01)
C - - - - - 0x003082 00:F072: 85 37     STA ram_0036_se_t01_ch2_data + $01
C - - - - - 0x003084 00:F074: A9 DC     LDA #< (tbl_F3DA_music___bonus_round_completed + $02)
C - - - - - 0x003086 00:F076: 85 3A     STA ram_003A_se_t01_ch3_data
C - - - - - 0x003088 00:F078: A9 F3     LDA #> (tbl_F3DA_music___bonus_round_completed + $02)
C - - - - - 0x00308A 00:F07A: 85 3B     STA ram_003A_se_t01_ch3_data + $01
; bzk optimize, JMP
...
sub_F080_play_sound___low_time:
C - - - - - 0x003090 00:F080: A9 B6     LDA #< tbl_F5B6_low_time
C - - - - - 0x003092 00:F082: 85 32     STA ram_0032_se_t01_ch1_data
C - - - - - 0x003094 00:F084: A9 F5     LDA #> tbl_F5B6_low_time
C - - - - - 0x003096 00:F086: 85 33     STA ram_0032_se_t01_ch1_data + $01
C - - - - - 0x003098 00:F088: A9 01     LDA #$01
C - - - - - 0x00309A 00:F08A: 85 34     STA ram_sound_channel_1_flag
C - - - - - 0x00309C 00:F08C: 60        RTS



sub_F08D_play_sound___pause:
C - - - - - 0x00309D 00:F08D: A9 AA     LDA #< tbl_F5AA_sound___pause
C - - - - - 0x00309F 00:F08F: 85 32     STA ram_0032_se_t01_ch1_data
C - - - - - 0x0030A1 00:F091: A9 F5     LDA #> tbl_F5AA_sound___pause
C - - - - - 0x0030A3 00:F093: 85 33     STA ram_0032_se_t01_ch1_data + $01
C - - - - - 0x0030A5 00:F095: A9 01     LDA #$01
C - - - - - 0x0030A7 00:F097: 85 34     STA ram_sound_channel_1_flag
C - - - - - 0x0030A9 00:F099: 60        RTS



sub_F09A_play_sound___collect_fruit:
C - - - - - 0x0030AA 00:F09A: 48        PHA
C - - - - - 0x0030AB 00:F09B: A5 A7     LDA ram_sound_channel_4_flag
C - - - - - 0x0030AD 00:F09D: D0 10     BNE bra_F0AF
C - - - - - 0x0030AF 00:F09F: A9 85     LDA #< tbl_F585_sound___collect_fruit
C - - - - - 0x0030B1 00:F0A1: 85 32     STA ram_0032_se_t01_ch1_data
C - - - - - 0x0030B3 00:F0A3: A9 F5     LDA #> tbl_F585_sound___collect_fruit
C - - - - - 0x0030B5 00:F0A5: 85 33     STA ram_0032_se_t01_ch1_data + $01
C - - - - - 0x0030B7 00:F0A7: A9 01     LDA #$01
C - - - - - 0x0030B9 00:F0A9: 85 34     STA ram_sound_channel_1_flag
C - - - - - 0x0030BB 00:F0AB: A9 04     LDA #$04
C - - - - - 0x0030BD 00:F0AD: 85 35     STA ram_sound_channel_1_timer
bra_F0AF:
...
sub_F0B1_play_sound___jump_over_enemy:
C - - - - - 0x0030C1 00:F0B1: 48        PHA
C - - - - - 0x0030C2 00:F0B2: A5 A7     LDA ram_sound_channel_4_flag
C - - - - - 0x0030C4 00:F0B4: D0 10     BNE bra_F0C6
C - - - - - 0x0030C6 00:F0B6: A9 8B     LDA #< tbl_F58B_sound___jump_over_enemy
C - - - - - 0x0030C8 00:F0B8: 85 32     STA ram_0032_se_t01_ch1_data
C - - - - - 0x0030CA 00:F0BA: A9 F5     LDA #> tbl_F58B_sound___jump_over_enemy
C - - - - - 0x0030CC 00:F0BC: 85 33     STA ram_0032_se_t01_ch1_data + $01
C - - - - - 0x0030CE 00:F0BE: A9 01     LDA #$01
C - - - - - 0x0030D0 00:F0C0: 85 34     STA ram_sound_channel_1_flag
C - - - - - 0x0030D2 00:F0C2: A9 04     LDA #$04
C - - - - - 0x0030D4 00:F0C4: 85 35     STA ram_sound_channel_1_timer
bra_F0C6:
...
sub_F0C8_play_sound___spring_jump:
C - - - - - 0x0030D8 00:F0C8: 48        PHA
C - - - - - 0x0030D9 00:F0C9: A5 A7     LDA ram_sound_channel_4_flag
C - - - - - 0x0030DB 00:F0CB: D0 19     BNE bra_F0E6
C - - - - - 0x0030DD 00:F0CD: A5 38     LDA ram_sound_channel_2_flag
C - - - - - 0x0030DF 00:F0CF: D0 15     BNE bra_F0E6
C - - - - - 0x0030E1 00:F0D1: A9 94     LDA #< tbl_F594_sound___spring_jump
C - - - - - 0x0030E3 00:F0D3: 85 36     STA ram_0036_se_t01_ch2_data
C - - - - - 0x0030E5 00:F0D5: A9 F5     LDA #> tbl_F594_sound___spring_jump
C - - - - - 0x0030E7 00:F0D7: 85 37     STA ram_0036_se_t01_ch2_data + $01
C - - - - - 0x0030E9 00:F0D9: A9 01     LDA #$01
C - - - - - 0x0030EB 00:F0DB: 85 38     STA ram_sound_channel_2_flag
C - - - - - 0x0030ED 00:F0DD: A9 02     LDA #$02
C - - - - - 0x0030EF 00:F0DF: 85 39     STA ram_sound_channel_2_timer
...
sub_F0E8_play_sound___death:
C - - - - - 0x0030F8 00:F0E8: 48        PHA
C - - - - - 0x0030F9 00:F0E9: A5 A7     LDA ram_sound_channel_4_flag
C - - - - - 0x0030FB 00:F0EB: D0 1D     BNE bra_F10A
C - - - - - 0x0030FD 00:F0ED: A9 00     LDA #$00
C - - - - - 0x0030FF 00:F0EF: 85 3C     STA ram_sound_channel_3_flag
C - - - - - 0x003101 00:F0F1: A9 01     LDA #$01
C - - - - - 0x003103 00:F0F3: 85 3F     STA ram_003F_se_flag
C - - - - - 0x003105 00:F0F5: A9 99     LDA #< tbl_F599_sound___death
C - - - - - 0x003107 00:F0F7: 85 36     STA ram_0036_se_t01_ch2_data
C - - - - - 0x003109 00:F0F9: A9 F5     LDA #> tbl_F599_sound___death
C - - - - - 0x00310B 00:F0FB: 85 37     STA ram_0036_se_t01_ch2_data + $01
C - - - - - 0x00310D 00:F0FD: A9 01     LDA #$01
C - - - - - 0x00310F 00:F0FF: 85 38     STA ram_sound_channel_2_flag
C - - - - - 0x003111 00:F101: A9 02     LDA #$02
C - - - - - 0x003113 00:F103: 85 39     STA ram_sound_channel_2_timer
...
sub_F10C_play_sound___jump:
C - - - - - 0x00311C 00:F10C: 48        PHA
C - - - - - 0x00311D 00:F10D: A5 A7     LDA ram_sound_channel_4_flag
C - - - - - 0x00311F 00:F10F: D0 15     BNE bra_F126
C - - - - - 0x003121 00:F111: A9 91     LDA #< tbl_F591_sound___jump
C - - - - - 0x003123 00:F113: 85 36     STA ram_0036_se_t01_ch2_data
C - - - - - 0x003125 00:F115: A9 F5     LDA #> tbl_F591_sound___jump
C - - - - - 0x003127 00:F117: 85 37     STA ram_0036_se_t01_ch2_data + $01
C - - - - - 0x003129 00:F119: A9 01     LDA #$01
C - - - - - 0x00312B 00:F11B: 85 38     STA ram_sound_channel_2_flag
C - - - - - 0x00312D 00:F11D: A9 02     LDA #$02
C - - - - - 0x00312F 00:F11F: 85 39     STA ram_sound_channel_2_timer
...
sub_F128_play_sound___falling_on_ground:
C - - - - - 0x003138 00:F128: 48        PHA
C - - - - - 0x003139 00:F129: A5 A7     LDA ram_sound_channel_4_flag
C - - - - - 0x00313B 00:F12B: D0 15     BNE bra_F142
C - - - - - 0x00313D 00:F12D: A9 97     LDA #< tbl_F597_sound___falling_on_ground
C - - - - - 0x00313F 00:F12F: 85 36     STA ram_0036_se_t01_ch2_data
C - - - - - 0x003141 00:F131: A9 F5     LDA #> tbl_F597_sound___falling_on_ground
C - - - - - 0x003143 00:F133: 85 37     STA ram_0036_se_t01_ch2_data + $01
C - - - - - 0x003145 00:F135: A9 01     LDA #$01
C - - - - - 0x003147 00:F137: 85 38     STA ram_sound_channel_2_flag
C - - - - - 0x003149 00:F139: A9 02     LDA #$02
C - - - - - 0x00314B 00:F13B: 85 39     STA ram_sound_channel_2_timer
...
sub_F144_play_music___round_completed:
C - - - - - 0x003154 00:F144: 20 D4 F2  JSR sub_F2D4
C - - - - - 0x003157 00:F147: A9 3D     LDA #< tbl_F43D
C - - - - - 0x003159 00:F149: 85 32     STA ram_0032_se_t01_ch1_data
C - - - - - 0x00315B 00:F14B: A9 F4     LDA #> tbl_F43D
C - - - - - 0x00315D 00:F14D: 85 33     STA ram_0032_se_t01_ch1_data + $01
C - - - - - 0x00315F 00:F14F: A9 3E     LDA #< (tbl_F43D + $01)
C - - - - - 0x003161 00:F151: 85 36     STA ram_0036_se_t01_ch2_data
C - - - - - 0x003163 00:F153: A9 F4     LDA #> (tbl_F43D + $01)
C - - - - - 0x003165 00:F155: 85 37     STA ram_0036_se_t01_ch2_data + $01
C - - - - - 0x003167 00:F157: A9 3F     LDA #< (tbl_F43D + $02)
C - - - - - 0x003169 00:F159: 85 3A     STA ram_003A_se_t01_ch3_data
C - - - - - 0x00316B 00:F15B: A9 F4     LDA #> (tbl_F43D + $02)
C - - - - - 0x00316D 00:F15D: 85 3B     STA ram_003A_se_t01_ch3_data + $01
; bzk optimize, JMP
...
sub_F163_play_music___new_round:
C - - - - - 0x003173 00:F163: 20 D4 F2  JSR sub_F2D4
C - - - - - 0x003176 00:F166: A9 9D     LDA #< tbl_F49D_music___new_round
C - - - - - 0x003178 00:F168: 85 32     STA ram_0032_se_t01_ch1_data
C - - - - - 0x00317A 00:F16A: A9 F4     LDA #> tbl_F49D_music___new_round
C - - - - - 0x00317C 00:F16C: 85 33     STA ram_0032_se_t01_ch1_data + $01
C - - - - - 0x00317E 00:F16E: A9 9E     LDA #< (tbl_F49D_music___new_round + $01)
C - - - - - 0x003180 00:F170: 85 36     STA ram_0036_se_t01_ch2_data
C - - - - - 0x003182 00:F172: A9 F4     LDA #> (tbl_F49D_music___new_round + $01)
C - - - - - 0x003184 00:F174: 85 37     STA ram_0036_se_t01_ch2_data + $01
C - - - - - 0x003186 00:F176: A9 9F     LDA #< (tbl_F49D_music___new_round + $02)
C - - - - - 0x003188 00:F178: 85 3A     STA ram_003A_se_t01_ch3_data
C - - - - - 0x00318A 00:F17A: A9 F4     LDA #> (tbl_F49D_music___new_round + $02)
C - - - - - 0x00318C 00:F17C: 85 3B     STA ram_003A_se_t01_ch3_data + $01
; bzk optimize, JMP
...
sub_F182_play_music___death:
C - - - - - 0x003192 00:F182: 48        PHA
C - - - - - 0x003193 00:F183: A5 A7     LDA ram_sound_channel_4_flag
C - - - - - 0x003195 00:F185: D0 1E     BNE bra_F1A5
C - - - - - 0x003197 00:F187: 20 D4 F2  JSR sub_F2D4
C - - - - - 0x00319A 00:F18A: A9 D0     LDA #< tbl_F4D0_music___death
C - - - - - 0x00319C 00:F18C: 85 32     STA ram_0032_se_t01_ch1_data
C - - - - - 0x00319E 00:F18E: A9 F4     LDA #> tbl_F4D0_music___death
C - - - - - 0x0031A0 00:F190: 85 33     STA ram_0032_se_t01_ch1_data + $01
C - - - - - 0x0031A2 00:F192: A9 D1     LDA #< (tbl_F4D0_music___death + $01)
C - - - - - 0x0031A4 00:F194: 85 36     STA ram_0036_se_t01_ch2_data
C - - - - - 0x0031A6 00:F196: A9 F4     LDA #> (tbl_F4D0_music___death + $01)
C - - - - - 0x0031A8 00:F198: 85 37     STA ram_0036_se_t01_ch2_data + $01
C - - - - - 0x0031AA 00:F19A: A9 D2     LDA #< (tbl_F4D0_music___death + $02)
C - - - - - 0x0031AC 00:F19C: 85 3A     STA ram_003A_se_t01_ch3_data
C - - - - - 0x0031AE 00:F19E: A9 F4     LDA #> (tbl_F4D0_music___death + $02)
C - - - - - 0x0031B0 00:F1A0: 85 3B     STA ram_003A_se_t01_ch3_data + $01
...
sub_F1A7_sound_engine_1:
C - - - - - 0x0031B7 00:F1A7: A5 34     LDA ram_sound_channel_1_flag
C - - - - - 0x0031B9 00:F1A9: D0 01     BNE bra_F1AC
C - - - - - 0x0031BB 00:F1AB: 60        RTS
bra_F1AC:
C - - - - - 0x0031BC 00:F1AC: A2 05     LDX #$05
C - - - - - 0x0031BE 00:F1AE: A5 3E     LDA ram_003E_se_flag
C - - - - - 0x0031C0 00:F1B0: F0 02     BEQ bra_F1B4
C - - - - - 0x0031C2 00:F1B2: A2 09     LDX #$09
bra_F1B4:
C - - - - - 0x0031C4 00:F1B4: E6 35     INC ram_sound_channel_1_timer
C - - - - - 0x0031C6 00:F1B6: E4 35     CPX ram_sound_channel_1_timer
C - - - - - 0x0031C8 00:F1B8: F0 01     BEQ bra_F1BB
C - - - - - 0x0031CA 00:F1BA: 60        RTS
bra_F1BB:
C - - - - - 0x0031CB 00:F1BB: A9 00     LDA #$00
C - - - - - 0x0031CD 00:F1BD: 85 35     STA ram_sound_channel_1_timer
C - - - - - 0x0031CF 00:F1BF: A0 00     LDY #$00
C - - - - - 0x0031D1 00:F1C1: B1 32     LDA (ram_0032_se_t01_ch1_data),Y
C - - - - - 0x0031D3 00:F1C3: D0 05     BNE bra_F1CA
; bzk optimize, A is already 00
C - - - - - 0x0031D5 00:F1C5: A9 00     LDA #$00
C - - - - - 0x0031D7 00:F1C7: 85 34     STA ram_sound_channel_1_flag
C - - - - - 0x0031D9 00:F1C9: 60        RTS
bra_F1CA:
C - - - - - 0x0031DA 00:F1CA: 20 29 F3  JSR sub_F329_get_sound_registers_data
C - - - - - 0x0031DD 00:F1CD: F0 0C     BEQ bra_F1DB
C - - - - - 0x0031DF 00:F1CF: A5 30     LDA ram_0030_se_t02_timer_lo
C - - - - - 0x0031E1 00:F1D1: 8D 02 40  STA $4002
C - - - - - 0x0031E4 00:F1D4: A5 31     LDA ram_0031_se_t01_timer_hi
C - - - - - 0x0031E6 00:F1D6: 09 20     ORA #$20
C - - - - - 0x0031E8 00:F1D8: 8D 03 40  STA $4003
bra_F1DB:
C - - - - - 0x0031EB 00:F1DB: A5 3E     LDA ram_003E_se_flag
C - - - - - 0x0031ED 00:F1DD: F0 0C     BEQ bra_F1EB
C - - - - - 0x0031EF 00:F1DF: E6 32     INC ram_0032_se_t01_ch1_data
C - - - - - 0x0031F1 00:F1E1: D0 02     BNE bra_F1E5_not_overflow
; if overflow
- - - - - - 0x0031F3 00:F1E3: E6 33     INC ram_0032_se_t01_ch1_data + $01
bra_F1E5_not_overflow:
C - - - - - 0x0031F5 00:F1E5: E6 32     INC ram_0032_se_t01_ch1_data
C - - - - - 0x0031F7 00:F1E7: D0 02     BNE bra_F1EB
; if overflow
C - - - - - 0x0031F9 00:F1E9: E6 33     INC ram_0032_se_t01_ch1_data + $01
bra_F1EB:
C - - - - - 0x0031FB 00:F1EB: E6 32     INC ram_0032_se_t01_ch1_data
C - - - - - 0x0031FD 00:F1ED: D0 02     BNE bra_F1F1_RTS
; if overflow
C - - - - - 0x0031FF 00:F1EF: E6 33     INC ram_0032_se_t01_ch1_data + $01
bra_F1F1_RTS:
C - - - - - 0x003201 00:F1F1: 60        RTS



sub_F1F2_sound_engine_2:
C - - - - - 0x003202 00:F1F2: A5 38     LDA ram_sound_channel_2_flag
C - - - - - 0x003204 00:F1F4: D0 01     BNE bra_F1F7
C - - - - - 0x003206 00:F1F6: 60        RTS
bra_F1F7:
C - - - - - 0x003207 00:F1F7: A2 03     LDX #$03
C - - - - - 0x003209 00:F1F9: A5 3E     LDA ram_003E_se_flag
C - - - - - 0x00320B 00:F1FB: F0 02     BEQ bra_F1FF
C - - - - - 0x00320D 00:F1FD: A2 09     LDX #$09
bra_F1FF:
C - - - - - 0x00320F 00:F1FF: E6 39     INC ram_sound_channel_2_timer
C - - - - - 0x003211 00:F201: E4 39     CPX ram_sound_channel_2_timer
C - - - - - 0x003213 00:F203: F0 01     BEQ bra_F206
C - - - - - 0x003215 00:F205: 60        RTS
bra_F206:
C - - - - - 0x003216 00:F206: A9 00     LDA #$00
C - - - - - 0x003218 00:F208: 85 39     STA ram_sound_channel_2_timer
; bzk optimize, TAY
C - - - - - 0x00321A 00:F20A: A0 00     LDY #$00
C - - - - - 0x00321C 00:F20C: B1 36     LDA (ram_0036_se_t01_ch2_data),Y
C - - - - - 0x00321E 00:F20E: D0 05     BNE bra_F215    
; bzk optimize, A is already 00
C - - - - - 0x003220 00:F210: A9 00     LDA #$00
C - - - - - 0x003222 00:F212: 85 38     STA ram_sound_channel_2_flag
C - - - - - 0x003224 00:F214: 60        RTS
bra_F215:
C - - - - - 0x003225 00:F215: 20 29 F3  JSR sub_F329_get_sound_registers_data
C - - - - - 0x003228 00:F218: F0 0C     BEQ bra_F226
C - - - - - 0x00322A 00:F21A: A5 30     LDA ram_0030_se_t02_timer_lo
C - - - - - 0x00322C 00:F21C: 8D 06 40  STA $4006
C - - - - - 0x00322F 00:F21F: A5 31     LDA ram_0031_se_t01_timer_hi
C - - - - - 0x003231 00:F221: 09 20     ORA #$20
C - - - - - 0x003233 00:F223: 8D 07 40  STA $4007
bra_F226:
C - - - - - 0x003236 00:F226: A5 3E     LDA ram_003E_se_flag
C - - - - - 0x003238 00:F228: F0 0C     BEQ bra_F236
C - - - - - 0x00323A 00:F22A: E6 36     INC ram_0036_se_t01_ch2_data
C - - - - - 0x00323C 00:F22C: D0 02     BNE bra_F230_not_overflow
; if overflow
C - - - - - 0x00323E 00:F22E: E6 37     INC ram_0036_se_t01_ch2_data + $01
bra_F230_not_overflow:
C - - - - - 0x003240 00:F230: E6 36     INC ram_0036_se_t01_ch2_data
C - - - - - 0x003242 00:F232: D0 02     BNE bra_F236
; if overflow
C - - - - - 0x003244 00:F234: E6 37     INC ram_0036_se_t01_ch2_data + $01
bra_F236:
C - - - - - 0x003246 00:F236: E6 36     INC ram_0036_se_t01_ch2_data
C - - - - - 0x003248 00:F238: D0 02     BNE bra_F23C_RTS
; if overflow
- - - - - - 0x00324A 00:F23A: E6 37     INC ram_0036_se_t01_ch2_data + $01
bra_F23C_RTS:
C - - - - - 0x00324C 00:F23C: 60        RTS



sub_F23D_sound_engine_3:
C - - - - - 0x00324D 00:F23D: A5 3C     LDA ram_sound_channel_3_flag
C - - - - - 0x00324F 00:F23F: D0 01     BNE bra_F242
C - - - - - 0x003251 00:F241: 60        RTS
bra_F242:
C - - - - - 0x003252 00:F242: A2 09     LDX #$09
C - - - - - 0x003254 00:F244: E6 3D     INC ram_sound_channel_3_timer
C - - - - - 0x003256 00:F246: E4 3D     CPX ram_sound_channel_3_timer
C - - - - - 0x003258 00:F248: F0 01     BEQ bra_F24B
C - - - - - 0x00325A 00:F24A: 60        RTS
bra_F24B:
C - - - - - 0x00325B 00:F24B: A9 00     LDA #$00
C - - - - - 0x00325D 00:F24D: 85 3D     STA ram_sound_channel_3_timer
bra_F24F_loop:
C - - - - - 0x00325F 00:F24F: A0 00     LDY #$00
C - - - - - 0x003261 00:F251: B1 3A     LDA (ram_003A_se_t01_ch3_data),Y
C - - - - - 0x003263 00:F253: D0 1A     BNE bra_F26F
C - - - - - 0x003265 00:F255: A5 8F     LDA ram_bonus_round_id
C - - - - - 0x003267 00:F257: D0 06     BNE bra_F25F_bonus_round
; if not bonus round
C - - - - - 0x003269 00:F259: 20 1B F0  JSR sub_F01B_play_music___soundtrack
C - - - - - 0x00326C 00:F25C: 4C 62 F2  JMP loc_F262
bra_F25F_bonus_round:
C - - - - - 0x00326F 00:F25F: 20 39 F0  JSR sub_F039_play_music___bonus_round_soundtrack
loc_F262:
C D 3 - - - 0x003272 00:F262: A5 3F     LDA ram_003F_se_flag
C - - - - - 0x003274 00:F264: D0 04     BNE bra_F26A
C - - - - - 0x003276 00:F266: A5 3E     LDA ram_003E_se_flag
C - - - - - 0x003278 00:F268: F0 E5     BEQ bra_F24F_loop
bra_F26A:
C - - - - - 0x00327A 00:F26A: A9 00     LDA #$00
C - - - - - 0x00327C 00:F26C: 85 3C     STA ram_sound_channel_3_flag
C - - - - - 0x00327E 00:F26E: 60        RTS
bra_F26F:
C - - - - - 0x00327F 00:F26F: 20 29 F3  JSR sub_F329_get_sound_registers_data
C - - - - - 0x003282 00:F272: F0 15     BEQ bra_F289
C - - - - - 0x003284 00:F274: A5 30     LDA ram_0030_se_t02_timer_lo
C - - - - - 0x003286 00:F276: 8D 0A 40  STA $400A
C - - - - - 0x003289 00:F279: A5 31     LDA ram_0031_se_t01_timer_hi
...
bra_F289:
C - - - - - 0x003299 00:F289: A5 8F     LDA ram_bonus_round_id
C - - - - - 0x00329B 00:F28B: D0 04     BNE bra_F291_bonus_round
; if not bonus round
C - - - - - 0x00329D 00:F28D: A5 3E     LDA ram_003E_se_flag
C - - - - - 0x00329F 00:F28F: F0 0C     BEQ bra_F29D
bra_F291_bonus_round:
C - - - - - 0x0032A1 00:F291: E6 3A     INC ram_003A_se_t01_ch3_data
C - - - - - 0x0032A3 00:F293: D0 02     BNE bra_F297_not_overflow
; if overflow
C - - - - - 0x0032A5 00:F295: E6 3B     INC ram_003A_se_t01_ch3_data + $01
bra_F297_not_overflow:
C - - - - - 0x0032A7 00:F297: E6 3A     INC ram_003A_se_t01_ch3_data
C - - - - - 0x0032A9 00:F299: D0 02     BNE bra_F29D
; if overflow
- - - - - - 0x0032AB 00:F29B: E6 3B     INC ram_003A_se_t01_ch3_data + $01
bra_F29D:
C - - - - - 0x0032AD 00:F29D: E6 3A     INC ram_003A_se_t01_ch3_data
C - - - - - 0x0032AF 00:F29F: D0 02     BNE bra_F2A3_RTS
; if overflow
C - - - - - 0x0032B1 00:F2A1: E6 3B     INC ram_003A_se_t01_ch3_data + $01
bra_F2A3_RTS:
C - - - - - 0x0032B3 00:F2A3: 60        RTS



sub_F2A4_sound_engine_4:
C - - - - - 0x0032B4 00:F2A4: A5 A7     LDA ram_sound_channel_4_flag
...
C - - - - - 0x0032E9 00:F2D9: 85 3E     STA ram_003E_se_flag
...
C - - - - - 0x0032F1 00:F2E1: 85 3E     STA ram_003E_se_flag
...
C - - - - - 0x0032FB 00:F2EB: 85 35     STA ram_sound_channel_1_timer
C - - - - - 0x0032FD 00:F2ED: 85 34     STA ram_sound_channel_1_flag
C - - - - - 0x0032FF 00:F2EF: 85 39     STA ram_sound_channel_2_timer
C - - - - - 0x003301 00:F2F1: 85 38     STA ram_sound_channel_2_flag
C - - - - - 0x003303 00:F2F3: 85 3D     STA ram_sound_channel_3_timer
C - - - - - 0x003305 00:F2F5: 85 3C     STA ram_sound_channel_3_flag
...
C - - - - - 0x003332 00:F322: 85 34     STA ram_sound_channel_1_flag
C - - - - - 0x003334 00:F324: 85 38     STA ram_sound_channel_2_flag
C - - - - - 0x003336 00:F326: 85 3C     STA ram_sound_channel_3_flag
C - - - - - 0x003338 00:F328: 60        RTS



sub_F329_get_sound_registers_data:
; in
    ; A
        ; .... xxxx = data offset
        ; xxxx .... = ???
...
; out
    ; Z
        ; 0 = 
        ; 1 = 
    ; ram_0030_se_t02_timer_lo
    ; ram_0031_se_t01_timer_hi
C - - - - - 0x003339 00:F329: A2 00     LDX #$00
C - - - - - 0x00333B 00:F32B: 86 30     STX ram_0030_se_t02_timer_lo
C - - - - - 0x00333D 00:F32D: 86 31     STX ram_0031_se_t01_timer_hi
...
C - - - - - 0x003348 00:F338: 69 62     ADC #< tbl_F362_sound_registers_timers
C - - - - - 0x00334A 00:F33A: 85 30     STA ram_0030_se_t01_data
C - - - - - 0x00334C 00:F33C: A9 F3     LDA #> tbl_F362_sound_registers_timers
C - - - - - 0x00334E 00:F33E: 69 00     ADC #$00
C - - - - - 0x003350 00:F340: 85 31     STA ram_0030_se_t01_data + $01
C - - - - - 0x003352 00:F342: A0 00     LDY #$00
C - - - - - 0x003354 00:F344: B1 30     LDA (ram_0030_se_t01_data),Y
C - - - - - 0x003356 00:F346: AA        TAX
C - - - - - 0x003357 00:F347: C8        INY ; 01
C - - - - - 0x003358 00:F348: B1 30     LDA (ram_0030_se_t01_data),Y
C - - - - - 0x00335A 00:F34A: 85 31     STA ram_0031_se_t01_timer_hi
C - - - - - 0x00335C 00:F34C: 86 30     STX ram_0030_se_t02_timer_lo
...
; bzk optimize, BEQ first, then TAX
C - - - - - 0x003363 00:F353: AA        TAX
C - - - - - 0x003364 00:F354: F0 07     BEQ bra_F35D
bra_F356_loop:
C - - - - - 0x003366 00:F356: 46 31     LSR ram_0031_se_t01_timer_hi
C - - - - - 0x003368 00:F358: 66 30     ROR ram_0030_se_t02_timer_lo
C - - - - - 0x00336A 00:F35A: CA        DEX
C - - - - - 0x00336B 00:F35B: D0 F9     BNE bra_F356_loop
bra_F35D:
C - - - - - 0x00336D 00:F35D: A5 30     LDA ram_0030_se_t02_timer_lo
C - - - - - 0x00336F 00:F35F: 05 31     ORA ram_0031_se_t01_timer_hi
C - - - - - 0x003371 00:F361: 60        RTS



tbl_F362_sound_registers_timers:
...
tbl_F3DA_music___bonus_round_completed:
...
tbl_F585_sound___collect_fruit:
...
- D 3 - I - 0x00359A 00:F58A: 00        .byte $00   ; end token



tbl_F58B_sound___jump_over_enemy:
...
- D 3 - I - 0x0035A0 00:F590: 00        .byte $00   ; end token



tbl_F591_sound___jump:
- D 3 - I - 0x0035A1 00:F591: 20        .byte $20   ; 
- D 3 - I - 0x0035A2 00:F592: 22        .byte $22   ; 
- D 3 - I - 0x0035A3 00:F593: 00        .byte $00   ; end token



tbl_F594_sound___spring_jump:
- D 3 - I - 0x0035A4 00:F594: 24        .byte $24   ; 
- D 3 - I - 0x0035A5 00:F595: 28        .byte $28   ; 
- D 3 - I - 0x0035A6 00:F596: 00        .byte $00   ; end token



tbl_F597_sound___falling_on_ground:
- D 3 - I - 0x0035A7 00:F597: 10        .byte $10   ; 
- D 3 - I - 0x0035A8 00:F598: 00        .byte $00   ; end token



tbl_F599_sound___death:
...
- D 3 - I - 0x0035B9 00:F5A9: 00        .byte $00   ; end token



tbl_F5AA_sound___pause:
...
- D 3 - I - 0x0035C3 00:F5B3: 00        .byte $00   ; end token
...
- D 3 - I - 0x0035C8 00:F5B8: 00        .byte $00   ; end token



tbl_F5B9_music___bonus_round_announcement:
...
- D 3 - I - 0x0035E8 00:F5D8: 00        .byte $00   ; end token
; bzk garbage
- - - - - - 0x0035E9 00:F5D9: 00        .byte $00   ; placeholder




tbl_F5DA_sound___long_fall:
...
- D 3 - I - 0x0035F2 00:F5E2: 00        .byte $00   ; end token
...
- - - - - - 0x00400E 00:FFFE: F9 FF     .word $FFF9 ; this game doesn't use IRQ
