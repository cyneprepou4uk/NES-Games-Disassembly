...
C - - - - - 0x007E3B 01:FE2B: 85 48     STA ram_0048_temp
C - - - - - 0x007E3D 01:FE2D: 68        PLA
C - - - - - 0x007E3E 01:FE2E: 85 49     STA ram_0049_temp
C - - - - - 0x007E40 01:FE30: A0 01     LDY #$01
C - - - - - 0x007E42 01:FE32: B1 48     LDA (ram_0048_temp),Y
C - - - - - 0x007E44 01:FE34: A8        TAY
; prepare new return address, which is located after index byte
C - - - - - 0x007E45 01:FE35: E6 48     INC ram_0048_temp
C - - - - - 0x007E47 01:FE37: D0 02     BNE bra_FE3B_not_overflow
C - - - - - 0x007E49 01:FE39: E6 49     INC ram_0049_temp
bra_FE3B_not_overflow:
; push new return address to stack
C - - - - - 0x007E4B 01:FE3B: A5 49     LDA ram_0049_temp
C - - - - - 0x007E4D 01:FE3D: 48        PHA
C - - - - - 0x007E4E 01:FE3E: A5 48     LDA ram_0048_temp
...
sub_FE5C:
- - - - - - 0x007E6C 01:FE5C: B9 7D FF  LDA tbl_FF7B_hi + $02,Y
- - - - - - 0x007E6F 01:FE5F: 48        PHA
- - - - - - 0x007E70 01:FE60: B9 7C FF  LDA tbl_FF7B_lo + $01,Y
...
- - - - - - 0x007EDF 01:FECF: 85 16     STA ram_0016_temp
- - - - - - 0x007EE1 01:FED1: BD FD 80  LDA tbl_out_0x01810D_room_data_hi,X
- - - - - - 0x007EE4 01:FED4: 85 17     STA ram_0017_temp
...
- - - - - - 0x007EF5 01:FEE5: B1 16     LDA (ram_0016_temp),Y
...
- - - - - - 0x007F06 01:FEF6: B1 1A     LDA (ram_001A_temp),Y
...
- - - - - - 0x007F2C 01:FF1C: B1 1A     LDA (ram_001A_temp),Y
...
- - - - - - 0x007F3F 01:FF2F: B1 22     LDA (ram_0022_temp),Y
...
- - - - - - 0x007F50 01:FF40: B1 18     LDA (ram_0018_t01_data),Y
