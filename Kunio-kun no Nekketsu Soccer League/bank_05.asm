...
C - - - - - 0x0153B0 05:93A0: 8D 75 00  STA a: ram_номер_анимации + 1
C - - - - - 0x0153B3 05:93A3: 8D 76 00  STA a: ram_номер_анимации + 2
C - - - - - 0x0153B6 05:93A6: 8D 77 00  STA a: ram_номер_анимации + 3
...
C - - - - - 0x0168D7 05:A8C7: 8D 75 00  STA a: ram_номер_анимации + 1
C - - - - - 0x0168DA 05:A8CA: A9 7F     LDA #$7F
C - - - - - 0x0168DC 05:A8CC: 8D 76 00  STA a: ram_номер_анимации + 2
...
C - - - - - 0x016991 05:A981: 8D 75 00  STA a: ram_номер_анимации + 1
C - - - - - 0x016994 05:A984: A9 96     LDA #$96
C - - - - - 0x016996 05:A986: 8D 76 00  STA a: ram_номер_анимации + 2
...
C - - - - - 0x017C8C 05:BC7C: 8D 8D 06  STA ram_управление_кипером + 1
