...
tbl_C000_lo:
- D 2 - - - 0x000010 00:C000: 01        .byte < ram_0301 ;   00 ; logo screen, mountain counter
- D 2 - - - 0x000011 00:C001: 4C        .byte < ram_054C ;   01 ; logo screen palette
...
- D 2 - - - 0x000015 00:C005: 00        .byte < ram_0400 ;   05 ; logo screen bg data
- D 2 - - - 0x000016 00:C006: ED        .byte < _off000_C6ED_06 ; 
- D 2 - - - 0x000017 00:C007: DF        .byte < ram_04DF ;   07 ; score counting screen palette
- D 2 - - - 0x000018 00:C008: 81        .byte < ram_0481 ;   08 ; score counting screen bg data (additional data for 2nd player)
- D 2 - - - 0x000019 00:C009: 00        .byte < ram_0600 ;   09 ; 

tbl_C00A_hi:
- D 2 - - - 0x00001A 00:C00A: 03        .byte > ram_0301 ;   00 ; 
- D 2 - - - 0x00001B 00:C00B: 05        .byte > ram_054C ;   01 ; 
...
- D 2 - - - 0x00001F 00:C00F: 04        .byte > ram_0400 ;   04 ; 
- D 2 - - - 0x000020 00:C010: C6        .byte > _off000_C6ED_06 ; 
- D 2 - - - 0x000021 00:C011: 04        .byte > ram_04DF ;   06 ; 
- D 2 - - - 0x000022 00:C012: 04        .byte > ram_0481 ;   07 ; 
- D 2 - - - 0x000023 00:C013: 06        .byte > ram_0600 ;   08 ; 
...
C - - - - - 0x00004A 00:C03A: EC 81 07  CPX ram_reset_check + 1
...
C - - - - - 0x00005F 00:C04F: 8D 81 07  STA ram_reset_check + 1
C - - - - - 0x000062 00:C052: 20 5E C0  JSR sub_C05E
C - - - - - 0x000065 00:C055: 20 41 C1  JSR sub_C141
loc_C058_infinite_loop:
C D 2 - - - 0x000068 00:C058: 20 CE CA  JSR sub_CACE
...
C - - - - - 0x000083 00:C073: 4C 1D C8  JMP loc_C81D
...
C - - - - - 0x0000B6 00:C0A6: 85 DE     STA ram_00DE
...
C - - - - - 0x0000CE 00:C0BE: A5 10     LDA ram_0010
C - - - - - 0x0000D0 00:C0C0: 8D 00 20  STA $2000
C - - - - - 0x0000D3 00:C0C3: 20 ED CA  JSR sub_CAED_read_joy_regs
C - - - - - 0x0000D6 00:C0C6: 20 1E F9  JSR sub_F91E_sound_driver
C - - - - - 0x0000D9 00:C0C9: A5 53     LDA ram_0053
...
bra_C126:
loc_C126:
C D 2 - - - 0x000136 00:C126: 20 9D CB  JSR sub_CB9D_decrease_spawn_timers
C - - - - - 0x000139 00:C129: E6 50     INC ram_0050
C - - - - - 0x00013B 00:C12B: A5 51     LDA ram_0051
C - - - - - 0x00013D 00:C12D: D0 06     BNE bra_C135
C - - - - - 0x00013F 00:C12F: 20 37 C4  JSR sub_C437
C - - - - - 0x000142 00:C132: 4C 38 C1  JMP loc_C138
bra_C135:
C - - - - - 0x000145 00:C135: 20 4A C4  JSR sub_C44A
bra_C138:
loc_C138:
C D 2 - - - 0x000148 00:C138: 20 41 C1  JSR sub_C141
...
C - - - - - 0x000154 00:C144: A5 10     LDA ram_0010
C - - - - - 0x000156 00:C146: 09 80     ORA #$80
sub_C148:
C - - - - - 0x000158 00:C148: 85 10     STA ram_0010
...
C - - - - - 0x00016F 00:C15F: 8D 00 03  STA ram_0300
C - - - - - 0x000172 00:C162: 8D 01 03  STA ram_0301
C - - - - - 0x000175 00:C165: 60        RTS



ofs_000_C166_00:
C - - J - - 0x000176 00:C166: A5 43     LDA ram_0043
C - - - - - 0x000178 00:C168: D0 6C     BNE bra_C1D6_RTS
C - - - - - 0x00017A 00:C16A: 20 91 C8  JSR sub_C891_set_00_to_2001
C - - - - - 0x00017D 00:C16D: A6 57     LDX ram_0057
...
C - - - - - 0x00018A 00:C17A: 20 FB C6  JSR sub_C6FB_read_data_from_ppu
...
C - - - - - 0x000197 00:C187: D0 F6     BNE bra_C17F_loop
bra_C189:
...
C - - - - - 0x0001AD 00:C19D: 85 56     STA ram_0056
C - - - - - 0x0001AF 00:C19F: 85 57     STA ram_0057
...
C - - - - - 0x0001B9 00:C1A9: 85 22     STA ram_0022
C - - - - - 0x0001BB 00:C1AB: 85 23     STA ram_0023
C - - - - - 0x0001BD 00:C1AD: A2 09     LDX #$09
bra_C1AF_loop:
C - - - - - 0x0001BF 00:C1AF: 9D 60 03  STA ram_0360,X
C - - - - - 0x0001C2 00:C1B2: CA        DEX
C - - - - - 0x0001C3 00:C1B3: 10 FA     BPL bra_C1AF_loop
C - - - - - 0x0001C5 00:C1B5: 85 4D     STA ram_004D
C - - - - - 0x0001C7 00:C1B7: 20 E0 C8  JSR sub_C8E0
C - - - - - 0x0001CA 00:C1BA: 20 C0 C4  JSR sub_C4C0
C - - - - - 0x0001CD 00:C1BD: A5 54     LDA ram_0054
C - - - - - 0x0001CF 00:C1BF: D0 0F     BNE bra_C1D0
C - - - - - 0x0001D1 00:C1C1: A9 03     LDA #$03
C - - - - - 0x0001D3 00:C1C3: 85 54     STA ram_0054
C - - - - - 0x0001D5 00:C1C5: A9 58     LDA #$58
C - - - - - 0x0001D7 00:C1C7: 85 4D     STA ram_004D
C - - - - - 0x0001D9 00:C1C9: A9 09     LDA #$09
C - - - - - 0x0001DB 00:C1CB: 85 31     STA ram_0031
C - - - - - 0x0001DD 00:C1CD: 4A        LSR ; con_music_logo
...
sub_C1D7:
ofs_000_C1D7_01:
C - - - - - 0x0001E7 00:C1D7: 20 91 C8  JSR sub_C891_set_00_to_2001
C - - - - - 0x0001EA 00:C1DA: A5 57     LDA ram_0057
C - - - - - 0x0001EC 00:C1DC: D0 12     BNE bra_C1F0
C - - - - - 0x0001EE 00:C1DE: 20 70 C0  JSR sub_C070
C - - - - - 0x0001F1 00:C1E1: A5 10     LDA ram_0010
C - - - - - 0x0001F3 00:C1E3: 29 FD     AND #$FD
C - - - - - 0x0001F5 00:C1E5: 85 10     STA ram_0010
...
C - - - - - 0x000237 00:C227: 20 42 C5  JSR sub_C542
...
C - - - - - 0x00025F 00:C24F: 85 65     STA ram_plr_pos_X + 1
C - - - - - 0x000261 00:C251: A2 01     LDX #$01
bra_C253_loop:
C - - - - - 0x000263 00:C253: A9 00     LDA #$00
C - - - - - 0x000265 00:C255: 95 5A     STA ram_005A,X
C - - - - - 0x000267 00:C257: 95 6A     STA ram_006A,X
C - - - - - 0x000269 00:C259: B5 20     LDA ram_lives,X
C - - - - - 0x00026B 00:C25B: 30 17     BMI bra_C274
C - - - - - 0x00026D 00:C25D: A9 01     LDA #$01
C - - - - - 0x00026F 00:C25F: 8D 7A 03  STA ram_037A
C - - - - - 0x000272 00:C262: 85 62     STA ram_0062
C - - - - - 0x000274 00:C264: 95 5A     STA ram_005A,X
C - - - - - 0x000276 00:C266: 95 6A     STA ram_006A,X
C - - - - - 0x000278 00:C268: 4A        LSR
C - - - - - 0x000279 00:C269: 95 2F     STA ram_002F,X
C - - - - - 0x00027B 00:C26B: 8D 3F 06  STA ram_063F
C - - - - - 0x00027E 00:C26E: 95 2D     STA ram_002D,X
...
C - - - - - 0x00029D 00:C28D: 85 4A     STA ram_004A
C - - - - - 0x00029F 00:C28F: A9 21     LDA #$21
C - - - - - 0x0002A1 00:C291: 85 4B     STA ram_004B
C - - - - - 0x0002A3 00:C293: A9 22     LDA #$22
C - - - - - 0x0002A5 00:C295: 85 39     STA ram_0039
...
bra_C2AB:
loc_C2AB:
C D 2 - - - 0x0002BB 00:C2AB: E6 57     INC ram_0057
ofs_000_C2AD_03:
...
ofs_000_C2B0_04:
C - - J - - 0x0002C0 00:C2B0: 20 91 C8  JSR sub_C891_set_00_to_2001
C - - - - - 0x0002C3 00:C2B3: A6 57     LDX ram_0057
...
C - - - - - 0x0002CC 00:C2BC: 20 FB C6  JSR sub_C6FB_read_data_from_ppu
...
C - - - - - 0x0002E3 00:C2D3: F0 04     BEQ bra_C2D9
...
C - - - - - 0x0002EE 00:C2DE: 85 84     STA ram_0084
C - - - - - 0x0002F0 00:C2E0: A9 10     LDA #$10
C - - - - - 0x0002F2 00:C2E2: 85 37     STA ram_0037
C - - - - - 0x0002F4 00:C2E4: 85 38     STA ram_0038
C - - - - - 0x0002F6 00:C2E6: A9 68     LDA #$68
C - - - - - 0x0002F8 00:C2E8: 85 34     STA ram_0034
C - - - - - 0x0002FA 00:C2EA: 4C AB C2  JMP loc_C2AB



ofs_000_C2ED_02:
C - - J - - 0x0002FD 00:C2ED: A6 57     LDX ram_0057
C - - - - - 0x0002FF 00:C2EF: D0 33     BNE bra_C324
C - - - - - 0x000301 00:C2F1: 20 1D C8  JSR sub_C81D
C - - - - - 0x000304 00:C2F4: A9 01     LDA #$01
C - - - - - 0x000306 00:C2F6: 85 27     STA ram_0027
C - - - - - 0x000308 00:C2F8: 4A        LSR
C - - - - - 0x000309 00:C2F9: 8D FB 05  STA ram_05FB
C - - - - - 0x00030C 00:C2FC: A2 07     LDX #$07
; 07F8-07FF
bra_C2FE_loop:
C - - - - - 0x00030E 00:C2FE: 9D F8 07  STA ram_07F8,X
...
bra_C30E_loop:
C - - - - - 0x00031E 00:C30E: B5 6A     LDA ram_006A,X
C - - - - - 0x000320 00:C310: C9 07     CMP #$07
C - - - - - 0x000322 00:C312: D0 06     BNE bra_C31A
- - - - - - 0x000324 00:C314: B5 5A     LDA ram_005A,X
- - - - - - 0x000326 00:C316: F0 02     BEQ bra_C31A
- - - - - - 0x000328 00:C318: D6 20     DEC ram_lives,X
bra_C31A:
...
C - - - - - 0x00033B 00:C32B: A6 26     LDX ram_0026
...
C - - - - - 0x00035C 00:C34C: E6 57     INC ram_0057
C - - - - - 0x00035E 00:C34E: A2 0A     LDX #$0A
C - - - - - 0x000360 00:C350: 4C 91 F6  JMP loc_F691
bra_C353:
C - - - - - 0x000363 00:C353: A9 00     LDA #$00
C - - - - - 0x000365 00:C355: 85 6A     STA ram_006A
C - - - - - 0x000367 00:C357: 85 6B     STA ram_006B
C - - - - - 0x000369 00:C359: 85 5A     STA ram_005A
C - - - - - 0x00036B 00:C35B: 85 5B     STA ram_005B
C - - - - - 0x00036D 00:C35D: 8D 52 03  STA ram_0352
C - - - - - 0x000370 00:C360: 8D 53 03  STA ram_0353
C - - - - - 0x000373 00:C363: A6 26     LDX ram_0026
...
C - - - - - 0x000385 00:C375: 85 D7     STA ram_00D7
C - - - - - 0x000387 00:C377: A9 00     LDA #$00
C - - - - - 0x000389 00:C379: 85 D5     STA ram_00D5
...
C - - - - - 0x0003A3 00:C393: 95 70     STA ram_0070,X
C - - - - - 0x0003A5 00:C395: 95 6C     STA ram_006C,X
...
C - - - - - 0x0003AB 00:C39B: 95 6A     STA ram_006A,X
C - - - - - 0x0003AD 00:C39D: 95 5A     STA ram_005A,X
bra_C39F:
C - - - - - 0x0003AF 00:C39F: 86 5F     STX ram_005F
C - - - - - 0x0003B1 00:C3A1: 4C FF CD  JMP loc_CDFF



ofs_000_C3A4_05:
C - - J - - 0x0003B4 00:C3A4: A5 57     LDA ram_0057
C - - - - - 0x0003B6 00:C3A6: C9 06     CMP #$06
C - - - - - 0x0003B8 00:C3A8: F0 22     BEQ bra_C3CC
C - - - - - 0x0003BA 00:C3AA: 20 D7 C1  JSR sub_C1D7
C - - - - - 0x0003BD 00:C3AD: A5 57     LDA ram_0057
C - - - - - 0x0003BF 00:C3AF: C9 05     CMP #$05
C - - - - - 0x0003C1 00:C3B1: D0 18     BNE bra_C3CB_RTS
C - - - - - 0x0003C3 00:C3B3: A5 53     LDA ram_0053
...
bra_C3C1:
C - - - - - 0x0003D1 00:C3C1: 20 1D C8  JSR sub_C81D
C - - - - - 0x0003D4 00:C3C4: 20 0F F6  JSR sub_F60F
C - - - - - 0x0003D7 00:C3C7: E6 57     INC ram_0057
...
C - - - - - 0x0003E3 00:C3D3: 85 D6     STA ram_00D6
C - - - - - 0x0003E5 00:C3D5: 0A        ASL
C - - - - - 0x0003E6 00:C3D6: 85 D7     STA ram_00D7
C - - - - - 0x0003E8 00:C3D8: A9 00     LDA #$00
C - - - - - 0x0003EA 00:C3DA: 85 D4     STA ram_00D4
C - - - - - 0x0003EC 00:C3DC: 85 D5     STA ram_00D5
C - - - - - 0x0003EE 00:C3DE: A9 04     LDA #$04
C - - - - - 0x0003F0 00:C3E0: 85 1F     STA ram_001F
C - - - - - 0x0003F2 00:C3E2: 4A        LSR
...
ofs_001_C3E8_05:
C - - J - - 0x0003F8 00:C3E8: A5 D7     LDA ram_00D7
...
C - - - - - 0x000444 00:C434: C6 54     DEC ram_0054
bra_C436_RTS:
...
sub_C437:
C - - - - - 0x000447 00:C437: A5 34     LDA ram_0034
...
C - - - - - 0x00045C 00:C44C: 85 57     STA ram_0057
...
tbl_C45D:
- D 2 - - - 0x00046D 00:C45D: 6F        .byte $6F   ; 00
- D 2 - - - 0x00046E 00:C45E: 00        .byte $00   ; 01
- D 2 - - - 0x00046F 00:C45F: 38        .byte $38   ; 02



ofs_001_C460_00:
C - - J - - 0x000470 00:C460: A5 59     LDA ram_mountain
C - - - - - 0x000472 00:C462: 29 1F     AND #$1F
C - - - - - 0x000474 00:C464: 85 59     STA ram_mountain
C - - - - - 0x000476 00:C466: 20 3E F5  JSR sub_F53E
C - - - - - 0x000479 00:C469: A5 4E     LDA ram_spawn_timer_lo_bird
C - - - - - 0x00047B 00:C46B: D0 17     BNE bra_C484
C - - - - - 0x00047D 00:C46D: 8D 15 40  STA $4015
C - - - - - 0x000480 00:C470: 85 58     STA ram_game_mode
C - - - - - 0x000482 00:C472: A5 59     LDA ram_mountain
C - - - - - 0x000484 00:C474: 8D FE 03  STA ram_03FE
C - - - - - 0x000487 00:C477: AD FD 03  LDA ram_03FD
C - - - - - 0x00048A 00:C47A: 29 03     AND #$03
C - - - - - 0x00048C 00:C47C: 85 59     STA ram_mountain
C - - - - - 0x00048E 00:C47E: A9 01     LDA #$01
C - - - - - 0x000490 00:C480: 85 53     STA ram_0053
C - - - - - 0x000492 00:C482: D0 20     BNE bra_C4A4
bra_C484:
C - - - - - 0x000494 00:C484: A5 4D     LDA ram_004D
C - - - - - 0x000496 00:C486: C9 01     CMP #$01
C - - - - - 0x000498 00:C488: D0 06     BNE bra_C490
C - - - - - 0x00049A 00:C48A: 4A        LSR
C - - - - - 0x00049B 00:C48B: 85 4D     STA ram_004D
C - - - - - 0x00049D 00:C48D: 6A        ROR
...
C - - - - - 0x0004A6 00:C496: 20 BA C4  JSR sub_C4BA
...
C - - - - - 0x0004BF 00:C4AF: 85 20     STA ram_lives
C - - - - - 0x0004C1 00:C4B1: A4 58     LDY ram_game_mode
C - - - - - 0x0004C3 00:C4B3: D0 02     BNE bra_C4B7
C - - - - - 0x0004C5 00:C4B5: A9 FC     LDA #$FC
bra_C4B7:
C - - - - - 0x0004C7 00:C4B7: 85 21     STA ram_lives + 1
bra_C4B9_RTS:
...
C - - - - - 0x0004D4 00:C4C4: F0 02     BEQ bra_C4C8
C - - - - - 0x0004D6 00:C4C6: A9 8F     LDA #$8F
bra_C4C8:
C - - - - - 0x0004D8 00:C4C8: 8D 00 02  STA ram_spr_Y
C - - - - - 0x0004DB 00:C4CB: A2 02     LDX #$02
bra_C4CD_loop:
C - - - - - 0x0004DD 00:C4CD: BD 5D C4  LDA tbl_C45D,X
C - - - - - 0x0004E0 00:C4D0: 9D 01 02  STA ram_spr_T,X
...
C - - - - - 0x0004EB 00:C4DB: 99 C0 04  STA ram_04C0,Y
C - - - - - 0x0004EE 00:C4DE: A9 FF     LDA #$FF
C - - - - - 0x0004F0 00:C4E0: 99 C0 05  STA ram_05C0,Y
C - - - - - 0x0004F3 00:C4E3: 88        DEY
C - - - - - 0x0004F4 00:C4E4: 10 F3     BPL bra_C4D9_loop
C - - - - - 0x0004F6 00:C4E6: A0 01     LDY #$01
bra_C4E8_loop:
C - - - - - 0x0004F8 00:C4E8: 99 C3 04  STA ram_04C3,Y
C - - - - - 0x0004FB 00:C4EB: 99 CB 04  STA ram_04CB,Y
C - - - - - 0x0004FE 00:C4EE: 99 D3 04  STA ram_04D3,Y
...
C - - - - - 0x000508 00:C4F8: 9D 30 04  STA ram_0430,X
C - - - - - 0x00050B 00:C4FB: 9D 47 04  STA ram_0447,X
C - - - - - 0x00050E 00:C4FE: E0 48     CPX #$48
C - - - - - 0x000510 00:C500: 90 06     BCC bra_C508
C - - - - - 0x000512 00:C502: 9D 31 04  STA ram_0431,X
C - - - - - 0x000515 00:C505: 9D 46 04  STA ram_0446,X
bra_C508:
...
C - - - - - 0x000555 00:C545: A9 BF     LDA #$BF
C - - - - - 0x000557 00:C547: 85 0C     STA ram_000C
C - - - - - 0x000559 00:C549: A9 00     LDA #$00
C - - - - - 0x00055B 00:C54B: 85 0D     STA ram_000D
C - - - - - 0x00055D 00:C54D: A9 04     LDA #$04
...
C - - - - - 0x00056F 00:C55F: B9 13 C5  LDA tbl_C512 + 1,Y
C - - - - - 0x000572 00:C562: 85 01     STA ram_0001
C - - - - - 0x000574 00:C564: B9 14 C5  LDA tbl_C512 + 2,Y
C - - - - - 0x000577 00:C567: 85 02     STA ram_0002
C - - - - - 0x000579 00:C569: A4 0C     LDY ram_000C
C - - - - - 0x00057B 00:C56B: A9 01     LDA #$01
C - - - - - 0x00057D 00:C56D: 85 1F     STA ram_001F
C - - - - - 0x00057F 00:C56F: 20 D3 C5  JSR sub_C5D3
...
C - - - - - 0x0005BB 00:C5AB: 20 CE CA  JSR sub_CACE
C - - - - - 0x0005BE 00:C5AE: A2 02     LDX #$02
bra_C5B0_loop:
C - - - - - 0x0005C0 00:C5B0: B5 18     LDA ram_0018,X
...
C - - - - - 0x0005CF 00:C5BF: A9 00     LDA #$00
C - - - - - 0x0005D1 00:C5C1: 85 0D     STA ram_000D
C - - - - - 0x0005D3 00:C5C3: A9 05     LDA #$05
C - - - - - 0x0005D5 00:C5C5: 85 0E     STA ram_000E
C - - - - - 0x0005D7 00:C5C7: A9 00     LDA #$00
C - - - - - 0x0005D9 00:C5C9: 85 1F     STA ram_001F
C - - - - - 0x0005DB 00:C5CB: 20 D3 C5  JSR sub_C5D3
...
C - - - - - 0x0005E9 00:C5D9: 85 03     STA ram_0003
bra_C5DB_loop:
...
C - - - - - 0x0005F2 00:C5E2: A5 1F     LDA ram_001F
...
C - - - - - 0x00061B 00:C60B: C6 03     DEC ram_0003
...
C - - - - - 0x000663 00:C653: BC 0F C6  LDY tbl_C610 - 1,X
...
C - - - - - 0x000686 00:C676: A5 50     LDA ram_0050
...
sub_C6FB_read_data_from_ppu:
C - - - - - 0x00070B 00:C6FB: 20 91 C8  JSR sub_C891_set_00_to_2001
...
C - - - - - 0x00071D 00:C70D: A9 00     LDA #< ram_0400
C - - - - - 0x00071F 00:C70F: 85 00     STA ram_0000
C - - - - - 0x000721 00:C711: A8        TAY ; 00
C - - - - - 0x000722 00:C712: A9 04     LDA #> ram_0400
...
C - - - - - 0x000833 00:C823: A9 02     LDA #$02
...
C - - - - - 0x000850 00:C840: B5 E0     LDA ram_00E0,X
C - - - - - 0x000852 00:C842: D0 0F     BNE bra_C853
C - - - - - 0x000854 00:C844: 95 E6     STA ram_00E6,X
C - - - - - 0x000856 00:C846: A9 08     LDA #$08
C - - - - - 0x000858 00:C848: 95 E8     STA ram_00E8,X
C - - - - - 0x00085A 00:C84A: A9 F0     LDA #$F0
C - - - - - 0x00085C 00:C84C: 95 EA     STA ram_00EA,X
C - - - - - 0x00085E 00:C84E: F6 E0     INC ram_00E0,X
C - - - - - 0x000860 00:C850: 4C 68 C8  JMP loc_C868
bra_C853:
C - - - - - 0x000863 00:C853: B5 E6     LDA ram_00E6,X
C - - - - - 0x000865 00:C855: C9 08     CMP #$08
C - - - - - 0x000867 00:C857: B0 0F     BCS bra_C868
C - - - - - 0x000869 00:C859: B4 2F     LDY ram_002F,X
C - - - - - 0x00086B 00:C85B: B5 E8     LDA ram_00E8,X
C - - - - - 0x00086D 00:C85D: 79 39 C8  ADC tbl_C839,Y
C - - - - - 0x000870 00:C860: 95 E8     STA ram_00E8,X
C - - - - - 0x000872 00:C862: B5 E6     LDA ram_00E6,X
C - - - - - 0x000874 00:C864: 69 00     ADC #$00
C - - - - - 0x000876 00:C866: 95 E6     STA ram_00E6,X
bra_C868:
loc_C868:
C D 2 - - - 0x000878 00:C868: B5 EA     LDA ram_00EA,X
C - - - - - 0x00087A 00:C86A: 38        SEC
C - - - - - 0x00087B 00:C86B: F5 E2     SBC ram_00E2,X
C - - - - - 0x00087D 00:C86D: 95 EA     STA ram_00EA,X
C - - - - - 0x00087F 00:C86F: A5 01     LDA ram_0001
C - - - - - 0x000881 00:C871: F5 E4     SBC ram_00E4,X
C - - - - - 0x000883 00:C873: 48        PHA
C - - - - - 0x000884 00:C874: 18        CLC
C - - - - - 0x000885 00:C875: B5 EA     LDA ram_00EA,X
C - - - - - 0x000887 00:C877: 75 E8     ADC ram_00E8,X
C - - - - - 0x000889 00:C879: 95 EA     STA ram_00EA,X
C - - - - - 0x00088B 00:C87B: 68        PLA
C - - - - - 0x00088C 00:C87C: 75 E6     ADC ram_00E6,X
...
C - - - - - 0x000895 00:C885: 20 48 C1  JSR sub_C148
...
sub_C89A:
C - - - - - 0x0008AA 00:C89A: 20 91 C8  JSR sub_C891_set_00_to_2001
...
C - - - - - 0x0008B9 00:C8A9: A5 10     LDA ram_0010
...
C - - - - - 0x000925 00:C915: 9D 01 03  STA ram_0301,X
...
C - - - - - 0x000932 00:C922: 8E 00 03  STX ram_0300
C - - - - - 0x000935 00:C925: A9 00     LDA #$00
C - - - - - 0x000937 00:C927: 9D 01 03  STA ram_0301,X
...
C - - - - - 0x000941 00:C931: 9D 01 03  STA ram_0301,X
...
C - - - - - 0x000952 00:C942: 9D 01 03  STA ram_0301,X
...
C - - - - - 0x000AE2 00:CAD2: A5 18     LDA ram_0018
...
C - - - - - 0x000AEC 00:CADC: A5 19     LDA ram_0019
...
bra_CAE6:
bra_CAE6_loop:
C - - - - - 0x000AF6 00:CAE6: 76 18     ROR ram_0018,X
...
- - - - - - 0x000BA2 00:CB92: AE 00 03  LDX ram_0300
- - - - - - 0x000BA5 00:CB95: A9 00     LDA #$00
- - - - - - 0x000BA7 00:CB97: 9D 01 03  STA ram_0301,X
...
sub_CB9D_decrease_spawn_timers:
C - - - - - 0x000BAD 00:CB9D: A2 09     LDX #$09
C - - - - - 0x000BAF 00:CB9F: C6 31     DEC ram_0031
C - - - - - 0x000BB1 00:CBA1: 10 06     BPL bra_CBA9
C - - - - - 0x000BB3 00:CBA3: A9 0A     LDA #$0A
C - - - - - 0x000BB5 00:CBA5: 85 31     STA ram_0031
C - - - - - 0x000BB7 00:CBA7: A2 1D     LDX #$1D
bra_CBA9:
bra_CBA9_loop:
C - - - - - 0x000BB9 00:CBA9: B5 32     LDA ram_0032,X
C - - - - - 0x000BBB 00:CBAB: F0 02     BEQ bra_CBAF
C - - - - - 0x000BBD 00:CBAD: D6 32     DEC ram_0032,X
bra_CBAF:
...
tbl_CBBF:
- D 2 - - - 0x000BCF 00:CBBF: 00        .byte $00   ; 00
- D 2 - - - 0x000BD0 00:CBC0: 24        .byte $24   ; 01
...
C - - - - - 0x000C1F 00:CC0F: F0 0E     BEQ bra_CC1F
C - - - - - 0x000C21 00:CC11: A5 17     LDA ram_btn_press + 2
C - - - - - 0x000C23 00:CC13: 85 71     STA ram_0071
...
C - - - - - 0x000C82 00:CC72: A5 45     LDA ram_0045
...
C - - - - - 0x000CB0 00:CCA0: C5 6A     CMP ram_006A
C - - - - - 0x000CB2 00:CCA2: F0 49     BEQ bra_CCED
C - - - - - 0x000CB4 00:CCA4: C5 6B     CMP ram_006B
C - - - - - 0x000CB6 00:CCA6: F0 45     BEQ bra_CCED
C - - - - - 0x000CB8 00:CCA8: A5 8C     LDA ram_008C
C - - - - - 0x000CBA 00:CCAA: D0 38     BNE bra_CCE4
C - - - - - 0x000CBC 00:CCAC: A6 26     LDX ram_0026
...
C - - - - - 0x000CED 00:CCDD: A5 27     LDA ram_0027
...
bra_CCED:
C - - - - - 0x000CFD 00:CCED: A5 4D     LDA ram_004D
...
sub_CCF6:
C - - - - - 0x000D06 00:CCF6: 86 5F     STX ram_005F
...
C - - - - - 0x000D0E 00:CCFE: 95 70     STA ram_0070,X
C - - - - - 0x000D10 00:CD00: 20 52 D5  JSR sub_D552
C - - - - - 0x000D13 00:CD03: BD 52 03  LDA ram_0352,X
C - - - - - 0x000D16 00:CD06: D0 05     BNE bra_CD0D
C - - - - - 0x000D18 00:CD08: A6 5F     LDX ram_005F
C - - - - - 0x000D1A 00:CD0A: 20 9C D5  JSR sub_D59C
bra_CD0D:
C - - - - - 0x000D1D 00:CD0D: A6 5F     LDX ram_005F
...
sub_CD13:
C - - - - - 0x000D23 00:CD13: 86 5F     STX ram_005F
C - - - - - 0x000D25 00:CD15: B5 5A     LDA ram_005A,X
C - - - - - 0x000D27 00:CD17: F0 48     BEQ bra_CD61_RTS
C - - - - - 0x000D29 00:CD19: B4 6A     LDY ram_006A,X
...
C - - - - - 0x000D52 00:CD42: 95 E8     STA ram_00E8,X
C - - - - - 0x000D54 00:CD44: 95 6E     STA ram_006E,X
C - - - - - 0x000D56 00:CD46: A9 04     LDA #$04
C - - - - - 0x000D58 00:CD48: 95 E6     STA ram_00E6,X
C - - - - - 0x000D5A 00:CD4A: 4A        LSR
C - - - - - 0x000D5B 00:CD4B: 95 6A     STA ram_006A,X
C - - - - - 0x000D5D 00:CD4D: 4A        LSR
C - - - - - 0x000D5E 00:CD4E: 95 E0     STA ram_00E0,X
C - - - - - 0x000D60 00:CD50: 95 86     STA ram_0086,X
C - - - - - 0x000D62 00:CD52: 4A        LSR
C - - - - - 0x000D63 00:CD53: 95 88     STA ram_0088,X
C - - - - - 0x000D65 00:CD55: B4 68     LDY ram_0068,X
...
C - - - - - 0x000D74 00:CD64: 95 82     STA ram_0082,X
...
sub_CD95:
C - - - - - 0x000DA5 00:CD95: F6 60     INC ram_0060,X
C - - - - - 0x000DA7 00:CD97: B5 60     LDA ram_0060,X
C - - - - - 0x000DA9 00:CD99: D9 8D CD  CMP tbl_CD8D,Y
C - - - - - 0x000DAC 00:CD9C: 90 11     BCC bra_CDAF_RTS
C - - - - - 0x000DAE 00:CD9E: A9 00     LDA #$00
C - - - - - 0x000DB0 00:CDA0: 95 60     STA ram_0060,X
C - - - - - 0x000DB2 00:CDA2: F6 6C     INC ram_006C,X
C - - - - - 0x000DB4 00:CDA4: B5 6C     LDA ram_006C,X
C - - - - - 0x000DB6 00:CDA6: D9 91 CD  CMP tbl_CD91,Y
C - - - - - 0x000DB9 00:CDA9: 90 04     BCC bra_CDAF_RTS
C - - - - - 0x000DBB 00:CDAB: A9 00     LDA #$00
C - - - - - 0x000DBD 00:CDAD: 95 6C     STA ram_006C,X
bra_CDAF_RTS:
...
C - - - - - 0x000E1C 00:CE0C: BC BF CB  LDY tbl_CBBF,X
...
C - - - - - 0x000E37 00:CE27: A6 5F     LDX ram_005F
bra_CE29:
C - - - - - 0x000E39 00:CE29: B5 70     LDA ram_0070,X
C - - - - - 0x000E3B 00:CE2B: 29 03     AND #$03
C - - - - - 0x000E3D 00:CE2D: D0 14     BNE bra_CE43
C - - - - - 0x000E3F 00:CE2F: 98        TYA
C - - - - - 0x000E40 00:CE30: 48        PHA
C - - - - - 0x000E41 00:CE31: BC BF CB  LDY tbl_CBBF,X
C - - - - - 0x000E44 00:CE34: B5 62     LDA ram_0062,X
...
loc_CE43:
sub_CE43:
C D 2 - - - 0x000E53 00:CE43: B5 70     LDA ram_0070,X
...
C - - - - - 0x000E66 00:CE56: 95 6A     STA ram_006A,X
C - - - - - 0x000E68 00:CE58: A9 04     LDA #con_sfx_2_04
C - - - - - 0x000E6A 00:CE5A: 85 FF     STA ram_sfx_2
bra_CE5C_RTS:
...
C - - - - - 0x000E6F 00:CE5F: 95 E2     STA ram_00E2,X
C - - - - - 0x000E71 00:CE61: A9 03     LDA #$03
C - - - - - 0x000E73 00:CE63: 95 E4     STA ram_00E4,X
C - - - - - 0x000E75 00:CE65: B5 68     LDA ram_0068,X
C - - - - - 0x000E77 00:CE67: D0 2A     BNE bra_CE93
C - - - - - 0x000E79 00:CE69: B5 E6     LDA ram_00E6,X
C - - - - - 0x000E7B 00:CE6B: C9 03     CMP #$03
C - - - - - 0x000E7D 00:CE6D: 90 24     BCC bra_CE93
C - - - - - 0x000E7F 00:CE6F: B5 70     LDA ram_0070,X
C - - - - - 0x000E81 00:CE71: 29 03     AND #$03
C - - - - - 0x000E83 00:CE73: F0 1E     BEQ bra_CE93
C - - - - - 0x000E85 00:CE75: 95 68     STA ram_0068,X
...
C - - - - - 0x000E90 00:CE80: 95 62     STA ram_0062,X
C - - - - - 0x000E92 00:CE82: A9 0F     LDA #$0F
C - - - - - 0x000E94 00:CE84: 95 6E     STA ram_006E,X
...
C - - - - - 0x000E9D 00:CE8D: 95 E2     STA ram_00E2,X
C - - - - - 0x000E9F 00:CE8F: A9 00     LDA #$00
C - - - - - 0x000EA1 00:CE91: 95 E4     STA ram_00E4,X
bra_CE93:
C - - - - - 0x000EA3 00:CE93: B5 68     LDA ram_0068,X
...
C - - - - - 0x000EBE 00:CEAE: 95 E0     STA ram_00E0,X
C - - - - - 0x000EC0 00:CEB0: 95 86     STA ram_0086,X
C - - - - - 0x000EC2 00:CEB2: 95 88     STA ram_0088,X
C - - - - - 0x000EC4 00:CEB4: 95 60     STA ram_0060,X
C - - - - - 0x000EC6 00:CEB6: A6 5F     LDX ram_005F
C - - - - - 0x000EC8 00:CEB8: A9 01     LDA #$01
C - - - - - 0x000ECA 00:CEBA: 95 6A     STA ram_006A,X
C - - - - - 0x000ECC 00:CEBC: B5 68     LDA ram_0068,X
C - - - - - 0x000ECE 00:CEBE: F0 2E     BEQ bra_CEEE_RTS
C - - - - - 0x000ED0 00:CEC0: A9 03     LDA #$03
C - - - - - 0x000ED2 00:CEC2: 95 6A     STA ram_006A,X
C - - - - - 0x000ED4 00:CEC4: B5 6E     LDA ram_006E,X
C - - - - - 0x000ED6 00:CEC6: B4 5A     LDY ram_005A,X
C - - - - - 0x000ED8 00:CEC8: C0 08     CPY #$08
C - - - - - 0x000EDA 00:CECA: B0 01     BCS bra_CECD
C - - - - - 0x000EDC 00:CECC: 4A        LSR
bra_CECD:
C - - - - - 0x000EDD 00:CECD: 4A        LSR
C - - - - - 0x000EDE 00:CECE: 95 32     STA ram_0032,X
bra_CED0:
C - - - - - 0x000EE0 00:CED0: B5 6A     LDA ram_006A,X
...
C - - - - - 0x000EF2 00:CEE2: D9 DD CB  CMP tbl_CBDC + 1,Y
...
sub_CEEF:
C - - - - - 0x000EFF 00:CEEF: B5 86     LDA ram_0086,X
...
C - - - - - 0x000F27 00:CF17: 95 6A     STA ram_006A,X
bra_CF19_RTS:
...
C - - - - - 0x000F63 00:CF53: 95 88     STA ram_0088,X
bra_CF55:
...
C - - - - - 0x000F6D 00:CF5D: 95 82     STA ram_0082,X
C - - - - - 0x000F6F 00:CF5F: 4A        LSR
...
C - - - - - 0x000F7B 00:CF6B: D0 3A     BNE bra_CFA7
bra_CF6D:
C - - - - - 0x000F7D 00:CF6D: B5 68     LDA ram_0068,X
...
C - - - - - 0x000F97 00:CF87: D0 1E     BNE bra_CFA7
bra_CF89:
C - - - - - 0x000F99 00:CF89: A9 01     LDA #$01
C - - - - - 0x000F9B 00:CF8B: 85 0C     STA ram_000C
C - - - - - 0x000F9D 00:CF8D: B4 62     LDY ram_0062,X
...
bra_CF99:
C - - - - - 0x000FA9 00:CF99: B4 68     LDY ram_0068,X
...
sub_CFC6:
loc_CFC6:
C D 2 - - - 0x000FD6 00:CFC6: B5 68     LDA ram_0068,X
...
C - - - - - 0x000FE8 00:CFD8: B5 32     LDA ram_0032,X
C - - - - - 0x000FEA 00:CFDA: F0 0F     BEQ bra_CFEB
C - - - - - 0x000FEC 00:CFDC: B5 5A     LDA ram_005A,X
C - - - - - 0x000FEE 00:CFDE: C9 06     CMP #$06
C - - - - - 0x000FF0 00:CFE0: 90 09     BCC bra_CFEB
C - - - - - 0x000FF2 00:CFE2: B5 70     LDA ram_0070,X
...
C - - - - - 0x000FFD 00:CFED: 95 6A     STA ram_006A,X
loc_CFEF:
C D 2 - - - 0x000FFF 00:CFEF: A9 00     LDA #$00
C - - - - - 0x001001 00:CFF1: 95 32     STA ram_0032,X
C - - - - - 0x001003 00:CFF3: 95 68     STA ram_0068,X
C - - - - - 0x001005 00:CFF5: 95 60     STA ram_0060,X
C - - - - - 0x001007 00:CFF7: 95 6C     STA ram_006C,X
C - - - - - 0x001009 00:CFF9: 95 6E     STA ram_006E,X
bra_CFFB_RTS:
C - - - - - 0x00100B 00:CFFB: 60        RTS
bra_CFFC:
C - - - - - 0x00100C 00:CFFC: B5 70     LDA ram_0070,X
...
ofs_002_D008_06:
ofs_002_D008_08:
C - - J - - 0x001018 00:D008: B5 6A     LDA ram_006A,X
...
loc_D021:
C D 2 - - - 0x001031 00:D021: B5 E0     LDA ram_00E0,X
C - - - - - 0x001033 00:D023: F0 D6     BEQ bra_CFFB_RTS
C - - - - - 0x001035 00:D025: A6 5F     LDX ram_005F
C - - - - - 0x001037 00:D027: B5 86     LDA ram_0086,X
C - - - - - 0x001039 00:D029: D0 24     BNE bra_D04F
C - - - - - 0x00103B 00:D02B: B5 6A     LDA ram_006A,X
C - - - - - 0x00103D 00:D02D: C9 04     CMP #$04
C - - - - - 0x00103F 00:D02F: F0 1E     BEQ bra_D04F
C - - - - - 0x001041 00:D031: A5 5F     LDA ram_005F
...
C - - - - - 0x001051 00:D041: B5 E6     LDA ram_00E6,X
C - - - - - 0x001053 00:D043: C9 03     CMP #$03
C - - - - - 0x001055 00:D045: B0 08     BCS bra_D04F
C - - - - - 0x001057 00:D047: A9 01     LDA #$01
C - - - - - 0x001059 00:D049: 95 80     STA ram_0080,X
C - - - - - 0x00105B 00:D04B: 95 86     STA ram_0086,X
C - - - - - 0x00105D 00:D04D: 95 82     STA ram_0082,X
bra_D04F:
C - - - - - 0x00105F 00:D04F: A0 07     LDY #$07
C - - - - - 0x001061 00:D051: B5 60     LDA ram_0060,X
C - - - - - 0x001063 00:D053: C9 0B     CMP #$0B
C - - - - - 0x001065 00:D055: B0 03     BCS bra_D05A
C - - - - - 0x001067 00:D057: F6 60     INC ram_0060,X
...
ofs_002_D05D_05:
C - - J - - 0x00106D 00:D05D: F6 60     INC ram_0060,X
C - - - - - 0x00106F 00:D05F: B5 60     LDA ram_0060,X
...
C - - - - - 0x00108E 00:D07E: 95 6A     STA ram_006A,X
C - - - - - 0x001090 00:D080: 4A        LSR ; 00
C - - - - - 0x001091 00:D081: 95 60     STA ram_0060,X
C - - - - - 0x001093 00:D083: A8        TAY
C - - - - - 0x001094 00:D084: F0 F3     BEQ bra_D079    ; jmp



tbl_D086_spr_T:
- D 2 - - - 0x001096 00:D086: 8E D0     .word _off001_D08E_00
- D 2 - - - 0x001098 00:D088: 94 D0     .word _off001_D094_01
- D 2 - - - 0x00109A 00:D08A: 9A D0     .word _off001_D09A_02
- D 2 - - - 0x00109C 00:D08C: A0 D0     .word _off001_D0A0_03
...
ofs_002_D0AA_07:
C - - J - - 0x0010BA 00:D0AA: B5 32     LDA ram_0032,X
...
C - - - - - 0x0010C6 00:D0B6: D0 0F     BNE bra_D0C7
bra_D0B8:
sub_D0B8:
...
C - - - - - 0x0010D2 00:D0C2: 95 E0     STA ram_00E0,X
...
bra_D0CA:
C - - - - - 0x0010DA 00:D0CA: A6 5F     LDX ram_005F
...
C - - - - - 0x0010E7 00:D0D7: B5 6C     LDA ram_006C,X
...
C - - - - - 0x0010F0 00:D0E0: B9 87 D0  LDA tbl_D086_spr_T + 1,Y
C - - - - - 0x0010F3 00:D0E3: 85 01     STA ram_0001
C - - - - - 0x0010F5 00:D0E5: B4 6C     LDY ram_006C,X
...
C - - - - - 0x001109 00:D0F9: 9D 00 02  STA ram_spr_T - 1,X
C - - - - - 0x00110C 00:D0FC: E8        INX
C - - - - - 0x00110D 00:D0FD: BD 00 02  LDA ram_spr_A - 2,X
C - - - - - 0x001110 00:D100: 29 03     AND #$03
C - - - - - 0x001112 00:D102: 05 02     ORA ram_0002
C - - - - - 0x001114 00:D104: 9D 00 02  STA ram_spr_A - 2,X
...
C - - - - - 0x001139 00:D129: 95 E4     STA ram_00E4,X
C - - - - - 0x00113B 00:D12B: A9 80     LDA #$80
C - - - - - 0x00113D 00:D12D: 95 E2     STA ram_00E2,X
C - - - - - 0x00113F 00:D12F: A9 01     LDA #$01
C - - - - - 0x001141 00:D131: 95 2F     STA ram_002F,X
sub_D133:
C - - - - - 0x001143 00:D133: B5 66     LDA ram_plr_pos_Y,X
C - - - - - 0x001145 00:D135: 85 01     STA ram_0001
C - - - - - 0x001147 00:D137: A5 5F     LDA ram_005F
C - - - - - 0x001149 00:D139: 20 3D C8  JSR sub_C83D
C - - - - - 0x00114C 00:D13C: A6 5F     LDX ram_005F
...
sub_D143:
C - - - - - 0x001153 00:D143: B4 6A     LDY ram_006A,X
C - - - - - 0x001155 00:D145: C0 01     CPY #$01
C - - - - - 0x001157 00:D147: D0 17     BNE bra_D160
C - - - - - 0x001159 00:D149: B5 6E     LDA ram_006E,X
C - - - - - 0x00115B 00:D14B: C9 18     CMP #$18
C - - - - - 0x00115D 00:D14D: B0 02     BCS bra_D151
C - - - - - 0x00115F 00:D14F: F6 6E     INC ram_006E,X
bra_D151:
C - - - - - 0x001161 00:D151: B5 76     LDA ram_0076,X
C - - - - - 0x001163 00:D153: 18        CLC
C - - - - - 0x001164 00:D154: 69 20     ADC #$20
C - - - - - 0x001166 00:D156: 95 76     STA ram_0076,X
...
C - - - - - 0x001172 00:D162: B4 6E     LDY ram_006E,X
...
C - - - - - 0x00117B 00:D16B: 75 72     ADC ram_0072,X
C - - - - - 0x00117D 00:D16D: 95 72     STA ram_0072,X
C - - - - - 0x00117F 00:D16F: 90 0A     BCC bra_D17B_RTS
bra_D171:
sub_D171:
loc_D171:
C D 2 - - - 0x001181 00:D171: B4 62     LDY ram_0062,X
...
C - - - - - 0x001193 00:D183: A6 5F     LDX ram_005F
...
C - - - - - 0x0011A4 00:D194: B5 62     LDA ram_0062,X
...
C - - - - - 0x0011CC 00:D1BC: A6 5F     LDX ram_005F
C - - - - - 0x0011CE 00:D1BE: B5 62     LDA ram_0062,X
...
C - - - - - 0x0011DC 00:D1CC: B9 C7 CB  LDA tbl_CBC6 + 1,Y
...
C - - - - - 0x0011F2 00:D1E2: A6 5F     LDX ram_005F
...
bra_D1E7_loop:
C - - - - - 0x0011F7 00:D1E7: B5 5A     LDA ram_005A,X
...
C - - - - - 0x001203 00:D1F3: 95 5A     STA ram_005A,X
bra_D1F5:
...
sub_D212:
C - - - - - 0x001222 00:D212: A5 5A     LDA ram_005A
C - - - - - 0x001224 00:D214: 25 5B     AND ram_005B
C - - - - - 0x001226 00:D216: F0 F9     BEQ bra_D211_RTS
C - - - - - 0x001228 00:D218: A5 2D     LDA ram_002D
C - - - - - 0x00122A 00:D21A: 05 2E     ORA ram_002E
C - - - - - 0x00122C 00:D21C: D0 F3     BNE bra_D211_RTS
C - - - - - 0x00122E 00:D21E: A9 07     LDA #$07
C - - - - - 0x001230 00:D220: C5 6A     CMP ram_006A
C - - - - - 0x001232 00:D222: F0 ED     BEQ bra_D211_RTS
C - - - - - 0x001234 00:D224: C5 6B     CMP ram_006B
...
C - - - - - 0x001241 00:D231: A5 6A     LDA ram_006A
...
C - - - - - 0x00124E 00:D23E: C5 67     CMP ram_plr_pos_Y + 1
...
bra_D24B:
C - - - - - 0x00125B 00:D24B: A5 62     LDA ram_0062
...
C - - - - - 0x001268 00:D258: D0 0F     BNE bra_D269
bra_D25A:
...
bra_D269:
C - - - - - 0x001279 00:D269: A5 6B     LDA ram_006B
...
C - - - - - 0x001285 00:D275: A5 67     LDA ram_plr_pos_Y + 1
...
C - - - - - 0x00128F 00:D27F: C6 67     DEC ram_plr_pos_Y + 1
C - - - - - 0x001291 00:D281: 2C        .byte $2C   ; BIT opcode
bra_D282:
C - - - - - 0x001292 00:D282: E6 67     INC ram_plr_pos_Y + 1
bra_D284:
C - - - - - 0x001294 00:D284: A5 02     LDA ram_0002
C - - - - - 0x001296 00:D286: F0 2D     BEQ bra_D2B5_RTS
C - - - - - 0x001298 00:D288: A5 E6     LDA ram_00E6
C - - - - - 0x00129A 00:D28A: 48        PHA
C - - - - - 0x00129B 00:D28B: A5 E7     LDA ram_00E7
C - - - - - 0x00129D 00:D28D: 85 E6     STA ram_00E6
C - - - - - 0x00129F 00:D28F: 68        PLA
C - - - - - 0x0012A0 00:D290: 85 E7     STA ram_00E7
C - - - - - 0x0012A2 00:D292: A5 E8     LDA ram_00E8
C - - - - - 0x0012A4 00:D294: 48        PHA
C - - - - - 0x0012A5 00:D295: A5 E9     LDA ram_00E9
C - - - - - 0x0012A7 00:D297: 85 E8     STA ram_00E8
C - - - - - 0x0012A9 00:D299: 68        PLA
C - - - - - 0x0012AA 00:D29A: 85 E9     STA ram_00E9
C - - - - - 0x0012AC 00:D29C: A2 01     LDX #$01
bra_D29E_loop:
C - - - - - 0x0012AE 00:D29E: B5 E6     LDA ram_00E6,X
C - - - - - 0x0012B0 00:D2A0: C9 06     CMP #$06
C - - - - - 0x0012B2 00:D2A2: 90 04     BCC bra_D2A8
C - - - - - 0x0012B4 00:D2A4: A9 05     LDA #$05
C - - - - - 0x0012B6 00:D2A6: 95 E6     STA ram_00E6,X
bra_D2A8:
C - - - - - 0x0012B8 00:D2A8: CA        DEX
C - - - - - 0x0012B9 00:D2A9: 10 F3     BPL bra_D29E_loop
C - - - - - 0x0012BB 00:D2AB: A9 00     LDA #$00
C - - - - - 0x0012BD 00:D2AD: 85 86     STA ram_0086
C - - - - - 0x0012BF 00:D2AF: 85 87     STA ram_0087
C - - - - - 0x0012C1 00:D2B1: 85 88     STA ram_0088
C - - - - - 0x0012C3 00:D2B3: 85 89     STA ram_0089
bra_D2B5_RTS:
C - - - - - 0x0012C5 00:D2B5: 60        RTS
bra_D2B6:
C - - - - - 0x0012C6 00:D2B6: A2 01     LDX #$01
C - - - - - 0x0012C8 00:D2B8: A5 62     LDA ram_0062
C - - - - - 0x0012CA 00:D2BA: 49 01     EOR #$01
sub_D2BC:
C - - - - - 0x0012CC 00:D2BC: 95 62     STA ram_0062,X
...
C - - - - - 0x0012EC 00:D2DC: E5 65     SBC ram_plr_pos_X + 1
...
C - - - - - 0x0012FC 00:D2EC: E5 67     SBC ram_plr_pos_Y + 1
...
sub_D308:
C - - - - - 0x001318 00:D308: B5 5A     LDA ram_005A,X
C - - - - - 0x00131A 00:D30A: F0 65     BEQ bra_D371_RTS
C - - - - - 0x00131C 00:D30C: B5 6A     LDA ram_006A,X
...
C - - - - - 0x001328 00:D318: B5 2D     LDA ram_002D,X
...
C - - - - - 0x00135D 00:D34D: 99 91 00  STA ram_0091,Y
...
C - - - - - 0x00136A 00:D35A: B0 0B     BCS bra_D367
C - - - - - 0x00136C 00:D35C: B9 94 00  LDA ram_0094,Y
C - - - - - 0x00136F 00:D35F: 10 10     BPL bra_D371_RTS
- - - - - - 0x001371 00:D361: A9 20     LDA #$20
- - - - - - 0x001373 00:D363: 99 94 00  STA ram_0094,Y
- - - - - - 0x001376 00:D366: 60        RTS
bra_D367:
C - - - - - 0x001377 00:D367: B9 8E 00  LDA ram_008E,Y
C - - - - - 0x00137A 00:D36A: 10 05     BPL bra_D371_RTS
C - - - - - 0x00137C 00:D36C: A9 20     LDA #$20
C - - - - - 0x00137E 00:D36E: 99 8E 00  STA ram_008E,Y
bra_D371_RTS:
...
tbl_D391:
- D 2 - - - 0x0013A1 00:D391: 00        .byte $00   ; 00
- D 2 - - - 0x0013A2 00:D392: 05        .byte $05   ; 01
...
C - - - - - 0x0013AD 00:D39D: 99 91 00  STA ram_0091,Y
C - - - - - 0x0013B0 00:D3A0: BD 91 D3  LDA tbl_D391,X
C - - - - - 0x0013B3 00:D3A3: AA        TAX
C - - - - - 0x0013B4 00:D3A4: FE 61 03  INC ram_0361,X
C - - - - - 0x0013B7 00:D3A7: A9 10     LDA #con_sfx_1_10
C - - - - - 0x0013B9 00:D3A9: 85 FE     STA ram_sfx_1
bra_D3AB_RTS:
...
sub_D3B3:
C - - - - - 0x0013C3 00:D3B3: B5 5A     LDA ram_005A,X
...
bra_D400:
C - - - - - 0x001410 00:D400: 99 91 00  STA ram_0091,Y
C - - - - - 0x001413 00:D403: A9 00     LDA #$00
C - - - - - 0x001415 00:D405: 99 B1 03  STA ram_03B1,Y
C - - - - - 0x001418 00:D408: A9 FF     LDA #$FF
C - - - - - 0x00141A 00:D40A: 99 D2 03  STA ram_03D2,Y
...
C - - - - - 0x00142C 00:D41C: 86 5F     STX ram_005F
C - - - - - 0x00142E 00:D41E: 4C 7C D0  JMP loc_D07C



sub_D421:
C - - - - - 0x001431 00:D421: BD 91 D3  LDA tbl_D391,X
C - - - - - 0x001434 00:D424: AA        TAX
C - - - - - 0x001435 00:D425: C0 00     CPY #$00
C - - - - - 0x001437 00:D427: D0 08     BNE bra_D431
C - - - - - 0x001439 00:D429: FE 63 03  INC ram_0363,X
C - - - - - 0x00143C 00:D42C: A9 01     LDA #con_sfx_1_01
C - - - - - 0x00143E 00:D42E: 85 FE     STA ram_sfx_1
...
C - - - - - 0x001449 00:D439: FE 62 03  INC ram_0362,X
bra_D43C:
C - - - - - 0x00144C 00:D43C: A9 08     LDA #con_sfx_2_08
C - - - - - 0x00144E 00:D43E: 85 FF     STA ram_sfx_2
C - - - - - 0x001450 00:D440: 60        RTS
bra_D441:
C - - - - - 0x001451 00:D441: A9 02     LDA #$02
C - - - - - 0x001453 00:D443: 85 FC     STA ram_copy_music
...
C - - - - - 0x001458 00:D448: 95 6A     STA ram_006A,X
C - - - - - 0x00145A 00:D44A: B5 5A     LDA ram_005A,X
C - - - - - 0x00145C 00:D44C: 9D 82 03  STA ram_0382,X
...
C - - - - - 0x00146C 00:D45C: 95 32     STA ram_0032,X
C - - - - - 0x00146E 00:D45E: A9 01     LDA #con_sfx_2_01
C - - - - - 0x001470 00:D460: 85 FF     STA ram_sfx_2
...
bra_D465_loop:
C - - - - - 0x001475 00:D465: B5 5A     LDA ram_005A,X
...
C - - - - - 0x001489 00:D479: 95 5A     STA ram_005A,X
C - - - - - 0x00148B 00:D47B: 95 E0     STA ram_00E0,X
C - - - - - 0x00148D 00:D47D: B5 2D     LDA ram_002D,X
C - - - - - 0x00148F 00:D47F: D0 02     BNE bra_D483
C - - - - - 0x001491 00:D481: D6 20     DEC ram_lives,X
bra_D483:
C - - - - - 0x001493 00:D483: A9 08     LDA #$08
C - - - - - 0x001495 00:D485: 95 3F     STA ram_003F,X
bra_D487:
...
bra_D495_loop:
C - - - - - 0x0014A5 00:D495: B5 5A     LDA ram_005A,X
...
C - - - - - 0x0014BC 00:D4AC: 30 20     BMI bra_D4CE
bra_D4AE:
C - - - - - 0x0014BE 00:D4AE: B5 E6     LDA ram_00E6,X
...
C - - - - - 0x0014CE 00:D4BE: 90 0E     BCC bra_D4CE
bra_D4C0:
...
- - - - - - 0x0014DC 00:D4CC: 95 E6     STA ram_00E6,X
bra_D4CE:
...
C - - - - - 0x0014E8 00:D4D8: C5 5A     CMP ram_005A
C - - - - - 0x0014EA 00:D4DA: F0 08     BEQ bra_D4E4
C - - - - - 0x0014EC 00:D4DC: C5 5B     CMP ram_005B
...
C - - - - - 0x00150C 00:D4FC: 85 34     STA ram_0034
...
C - - - - - 0x001521 00:D511: AD 61 03  LDA ram_0361
C - - - - - 0x001524 00:D514: 6D 66 03  ADC ram_0366
...
C - - - - - 0x001530 00:D520: A4 D5     LDY ram_00D5
C - - - - - 0x001532 00:D522: B9 05 D5  LDA tbl_D505,Y
C - - - - - 0x001535 00:D525: 18        CLC
C - - - - - 0x001536 00:D526: 65 D6     ADC ram_00D6
...
C - - - - - 0x00154E 00:D53E: 95 6A     STA ram_006A,X
...
C - - - - - 0x001555 00:D545: 85 4D     STA ram_004D
bra_D547:
C - - - - - 0x001557 00:D547: A5 5F     LDA ram_005F
...
sub_D552:
C - - - - - 0x001562 00:D552: B5 6A     LDA ram_006A,X
...
C - - - - - 0x001579 00:D569: 95 E2     STA ram_00E2,X
C - - - - - 0x00157B 00:D56B: A9 03     LDA #$03
C - - - - - 0x00157D 00:D56D: 95 E4     STA ram_00E4,X
C - - - - - 0x00157F 00:D56F: B5 68     LDA ram_0068,X
C - - - - - 0x001581 00:D571: D0 1A     BNE bra_D58D
C - - - - - 0x001583 00:D573: B5 E6     LDA ram_00E6,X
C - - - - - 0x001585 00:D575: C9 03     CMP #$03
C - - - - - 0x001587 00:D577: 90 14     BCC bra_D58D
C - - - - - 0x001589 00:D579: B5 70     LDA ram_0070,X
C - - - - - 0x00158B 00:D57B: 29 03     AND #$03
C - - - - - 0x00158D 00:D57D: F0 0E     BEQ bra_D58D
C - - - - - 0x00158F 00:D57F: 95 68     STA ram_0068,X
C - - - - - 0x001591 00:D581: C9 01     CMP #$01
C - - - - - 0x001593 00:D583: F0 02     BEQ bra_D587
C - - - - - 0x001595 00:D585: A9 00     LDA #$00
bra_D587:
C - - - - - 0x001597 00:D587: 95 62     STA ram_0062,X
C - - - - - 0x001599 00:D589: A9 0F     LDA #$0F
C - - - - - 0x00159B 00:D58B: 95 6E     STA ram_006E,X
bra_D58D:
C - - - - - 0x00159D 00:D58D: B5 68     LDA ram_0068,X
...
C - - - - - 0x0015AE 00:D59E: 95 2A     STA ram_002A,X
...
C - - - - - 0x0015B7 00:D5A7: 95 28     STA ram_0028,X
C - - - - - 0x0015B9 00:D5A9: A4 27     LDY ram_0027
C - - - - - 0x0015BB 00:D5AB: F0 07     BEQ bra_D5B4
C - - - - - 0x0015BD 00:D5AD: 38        SEC
C - - - - - 0x0015BE 00:D5AE: E9 10     SBC #$10
bra_D5B0:
C - - - - - 0x0015C0 00:D5B0: 95 28     STA ram_0028,X
C - - - - - 0x0015C2 00:D5B2: F6 2A     INC ram_002A,X
bra_D5B4:
C - - - - - 0x0015C4 00:D5B4: B5 2A     LDA ram_002A,X
C - - - - - 0x0015C6 00:D5B6: 85 09     STA ram_0009
C - - - - - 0x0015C8 00:D5B8: B5 28     LDA ram_0028,X
...
C - - - - - 0x001616 00:D606: D0 CD     BNE bra_D5D5
C - - - - - 0x001618 00:D608: A9 02     LDA #$02
C - - - - - 0x00161A 00:D60A: D5 6A     CMP ram_006A,X
C - - - - - 0x00161C 00:D60C: F0 2D     BEQ bra_D63B
C - - - - - 0x00161E 00:D60E: 95 6A     STA ram_006A,X
C - - - - - 0x001620 00:D610: A9 03     LDA #$03
C - - - - - 0x001622 00:D612: 95 E6     STA ram_00E6,X
C - - - - - 0x001624 00:D614: 4A        LSR
C - - - - - 0x001625 00:D615: D0 22     BNE bra_D639
bra_D617:
C - - - - - 0x001627 00:D617: 98        TYA
C - - - - - 0x001628 00:D618: 9D 83 07  STA ram_0783,X
C - - - - - 0x00162B 00:D61B: B5 6A     LDA ram_006A,X
...
bra_D648:
C - - - - - 0x001658 00:D648: A6 5F     LDX ram_005F
C - - - - - 0x00165A 00:D64A: A9 00     LDA #$00
C - - - - - 0x00165C 00:D64C: 9D 52 03  STA ram_0352,X
C - - - - - 0x00165F 00:D64F: B5 6A     LDA ram_006A,X
C - - - - - 0x001661 00:D651: F0 78     BEQ bra_D6CB_RTS
C - - - - - 0x001663 00:D653: A5 13     LDA ram_scroll_Y
C - - - - - 0x001665 00:D655: 15 2A     ORA ram_002A,X
...
C - - - - - 0x001673 00:D663: B5 28     LDA ram_0028,X
...
bra_D680:
C - - - - - 0x001690 00:D680: B4 2A     LDY ram_002A,X
...
bra_D6C9:
C - - - - - 0x0016D9 00:D6C9: 95 62     STA ram_0062,X
bra_D6CB_RTS:
C - - - - - 0x0016DB 00:D6CB: 60        RTS
bra_D6CC:
C - - - - - 0x0016DC 00:D6CC: A9 02     LDA #$02
C - - - - - 0x0016DE 00:D6CE: D5 6A     CMP ram_006A,X
C - - - - - 0x0016E0 00:D6D0: F0 0A     BEQ bra_D6DC
- - - - - - 0x0016E2 00:D6D2: 95 6A     STA ram_006A,X
- - - - - - 0x0016E4 00:D6D4: A9 03     LDA #$03
- - - - - - 0x0016E6 00:D6D6: 95 E6     STA ram_00E6,X
- - - - - - 0x0016E8 00:D6D8: A9 01     LDA #$01
- - - - - - 0x0016EA 00:D6DA: 95 E0     STA ram_00E0,X
bra_D6DC:
C - - - - - 0x0016EC 00:D6DC: FE 52 03  INC ram_0352,X
C - - - - - 0x0016EF 00:D6DF: 60        RTS



sub_D6E0:
C - - - - - 0x0016F0 00:D6E0: B5 E6     LDA ram_00E6,X
C - - - - - 0x0016F2 00:D6E2: C9 04     CMP #$04
C - - - - - 0x0016F4 00:D6E4: B0 34     BCS bra_D71A_RTS
C - - - - - 0x0016F6 00:D6E6: A0 00     LDY #$00
bra_D6E8_loop:
C - - - - - 0x0016F8 00:D6E8: B9 E0 06  LDA ram_06E0,Y
C - - - - - 0x0016FB 00:D6EB: 30 28     BMI bra_D715
C - - - - - 0x0016FD 00:D6ED: D5 2A     CMP ram_002A,X
...
C - - - - - 0x00172D 00:D71D: 95 E6     STA ram_00E6,X
C - - - - - 0x00172F 00:D71F: A9 20     LDA #$20
C - - - - - 0x001731 00:D721: 95 E8     STA ram_00E8,X
bra_D723_RTS:
...
bra_D726_loop:
C - - - - - 0x001736 00:D726: B5 6A     LDA ram_006A,X
...
tbl_D762:
- D 2 - - - 0x001772 00:D762: 02        .byte $02   ; 00
- D 2 - - - 0x001773 00:D763: 00        .byte $00   ; 01
- D 2 - - - 0x001774 00:D764: 18        .byte $18   ; 02
- D 2 - - - 0x001775 00:D765: 30        .byte $30   ; 03
- D 2 - - - 0x001776 00:D766: 48        .byte $48   ; 04
- D 2 - - - 0x001777 00:D767: 60        .byte $60   ; 05
- D 2 - - - 0x001778 00:D768: 78        .byte $78   ; 06
- D 2 - - - 0x001779 00:D769: 90        .byte $90   ; 07
- D 2 - - - 0x00177A 00:D76A: A8        .byte $A8   ; 08
- D 2 - - - 0x00177B 00:D76B: C0        .byte $C0   ; 09
- - - - - - 0x00177C 00:D76C: D8        .byte $D8   ; 0A



tbl_D76D_ppu_hi:
- D 2 - I - 0x00177D 00:D76D: 2A        .byte $2A   ; 00
- D 2 - I - 0x00177E 00:D76E: 29        .byte $29   ; 01
- D 2 - I - 0x00177F 00:D76F: 28        .byte $28   ; 02
- D 2 - I - 0x001780 00:D770: 23        .byte $23   ; 03
- D 2 - I - 0x001781 00:D771: 22        .byte $22   ; 04
- D 2 - I - 0x001782 00:D772: 22        .byte $22   ; 05
- D 2 - I - 0x001783 00:D773: 21        .byte $21   ; 06
- D 2 - I - 0x001784 00:D774: 20        .byte $20   ; 07
- D 2 - I - 0x001785 00:D775: 2B        .byte $2B   ; 08

tbl_D776_ppu_lo:
- D 2 - I - 0x001786 00:D776: 20        .byte $20   ; 00
- D 2 - I - 0x001787 00:D777: 60        .byte $60   ; 01
- D 2 - I - 0x001788 00:D778: A0        .byte $A0   ; 02
- D 2 - I - 0x001789 00:D779: A0        .byte $A0   ; 03
- D 2 - I - 0x00178A 00:D77A: E0        .byte $E0   ; 04
- D 2 - I - 0x00178B 00:D77B: 20        .byte $20   ; 05
- D 2 - I - 0x00178C 00:D77C: 60        .byte $60   ; 06
- D 2 - I - 0x00178D 00:D77D: A0        .byte $A0   ; 07
- D 2 - I - 0x00178E 00:D77E: A0        .byte $A0   ; 08
...
tbl_D78B_ppu_hi:
- - - - - - 0x00179B 00:D78B: 2A        .byte $2A   ; 00
- D 2 - - - 0x00179C 00:D78C: 29        .byte $29   ; 01
- D 2 - - - 0x00179D 00:D78D: 28        .byte $28   ; 02
- D 2 - - - 0x00179E 00:D78E: 28        .byte $28   ; 03
- D 2 - - - 0x00179F 00:D78F: 23        .byte $23   ; 04
- D 2 - - - 0x0017A0 00:D790: 22        .byte $22   ; 05
- D 2 - - - 0x0017A1 00:D791: 21        .byte $21   ; 06
- D 2 - - - 0x0017A2 00:D792: 20        .byte $20   ; 07
- D 2 - - - 0x0017A3 00:D793: 20        .byte $20   ; 08

tbl_D794_ppu_lo:
- - - - - - 0x0017A4 00:D794: 40        .byte $40   ; 00
- D 2 - - - 0x0017A5 00:D795: 80        .byte $80   ; 01
- D 2 - - - 0x0017A6 00:D796: C0        .byte $C0   ; 02
- D 2 - - - 0x0017A7 00:D797: 00        .byte $00   ; 03
- D 2 - - - 0x0017A8 00:D798: 00        .byte $00   ; 04
- D 2 - - - 0x0017A9 00:D799: 40        .byte $40   ; 05
- D 2 - - - 0x0017AA 00:D79A: 80        .byte $80   ; 06
- D 2 - - - 0x0017AB 00:D79B: C0        .byte $C0   ; 07
- D 2 - - - 0x0017AC 00:D79C: 00        .byte $00   ; 08
...
loc_D7DE:
C D 2 - - - 0x0017EE 00:D7DE: A5 8C     LDA ram_008C
...
C - - - - - 0x001833 00:D823: 85 8C     STA ram_008C
...
sub_D82F:
C - - - - - 0x00183F 00:D82F: A5 8C     LDA ram_008C
...
C - - - - - 0x001869 00:D859: 85 8C     STA ram_008C
...
- - - - - - 0x001891 00:D881: 9D 82 03  STA ram_0382,X
bra_D884:
...
C - - - - - 0x00189C 00:D88C: 9D E8 03  STA ram_03E8,X
C - - - - - 0x00189F 00:D88F: 60        RTS



loc_D890:
C D 2 - - - 0x0018A0 00:D890: A5 8C     LDA ram_008C
C - - - - - 0x0018A2 00:D892: D0 11     BNE bra_D8A5_RTS
C - - - - - 0x0018A4 00:D894: A2 01     LDX #$01
bra_D896_loop:
C - - - - - 0x0018A6 00:D896: B5 6A     LDA ram_006A,X
...
C - - - - - 0x0018B8 00:D8A8: 05 27     ORA ram_0027
...
sub_D8AF:
C - - - - - 0x0018BF 00:D8AF: A5 8C     LDA ram_008C
...
C - - - - - 0x0018CE 00:D8BE: A5 27     LDA ram_0027
C - - - - - 0x0018D0 00:D8C0: D0 04     BNE bra_D8C6
C - - - - - 0x0018D2 00:D8C2: 85 13     STA ram_scroll_Y
C - - - - - 0x0018D4 00:D8C4: F0 02     BEQ bra_D8C8
bra_D8C6:
C - - - - - 0x0018D6 00:D8C6: C6 27     DEC ram_0027
bra_D8C8:
...
C - - - - - 0x0018EE 00:D8DE: 85 8C     STA ram_008C
...
C - - - - - 0x001908 00:D8F8: E6 DE     INC ram_00DE
...
C D 2 - - - 0x00190D 00:D8FD: A4 56     LDY ram_0056
...
C - - - - - 0x00193E 00:D92E: B5 62     LDA ram_0062,X
...
C - - - - - 0x001948 00:D938: BD 64 03  LDA ram_0364,X
C - - - - - 0x00194B 00:D93B: C9 63     CMP #$63
C - - - - - 0x00194D 00:D93D: B0 03     BCS bra_D942_not_overflow
C - - - - - 0x00194F 00:D93F: FE 64 03  INC ram_0364,X
...
bra_D957:
C - - - - - 0x001967 00:D957: B5 D7     LDA ram_00D7,X
...
C - - - - - 0x001991 00:D981: AE 3E 06  LDX ram_063E
...
C - - - - - 0x0019A1 00:D991: 99 50 06  STA ram_0650,Y
C - - - - - 0x0019A4 00:D994: 99 40 06  STA ram_0640,Y
C - - - - - 0x0019A7 00:D997: 99 60 06  STA ram_0660,Y
C - - - - - 0x0019AA 00:D99A: A9 FE     LDA #$FE
C - - - - - 0x0019AC 00:D99C: 99 48 06  STA ram_0648,Y
C - - - - - 0x0019AF 00:D99F: A5 0C     LDA ram_000C
C - - - - - 0x0019B1 00:D9A1: D0 02     BNE bra_D9A5
C - - - - - 0x0019B3 00:D9A3: A9 FF     LDA #$FF
bra_D9A5:
C - - - - - 0x0019B5 00:D9A5: 99 58 06  STA ram_0658,Y
bra_D9A8:
...
sub_D9AD:
C - - - - - 0x0019BD 00:D9AD: AD 3F 06  LDA ram_063F
C - - - - - 0x0019C0 00:D9B0: 0D 01 03  ORA ram_0301
...
C - - - - - 0x0019CE 00:D9BE: 8D 3F 06  STA ram_063F
...
C - - - - - 0x0019E9 00:D9D9: BD 50 06  LDA ram_0650,X
C - - - - - 0x0019EC 00:D9DC: 18        CLC
C - - - - - 0x0019ED 00:D9DD: 7D 40 06  ADC ram_0640,X
C - - - - - 0x0019F0 00:D9E0: 9D 40 06  STA ram_0640,X
C - - - - - 0x0019F3 00:D9E3: B9 D0 02  LDA ram_spr_Y + $D0,Y
C - - - - - 0x0019F6 00:D9E6: 7D 48 06  ADC ram_0648,X
C - - - - - 0x0019F9 00:D9E9: 99 D0 02  STA ram_spr_Y + $D0,Y
C - - - - - 0x0019FC 00:D9EC: C9 F4     CMP #$F4
C - - - - - 0x0019FE 00:D9EE: B0 4A     BCS bra_DA3A
C - - - - - 0x001A00 00:D9F0: BD 58 06  LDA ram_0658,X
...
C - - - - - 0x001A0B 00:D9FB: FE 60 06  INC ram_0660,X
C - - - - - 0x001A0E 00:D9FE: 8A        TXA
C - - - - - 0x001A0F 00:D9FF: 48        PHA
C - - - - - 0x001A10 00:DA00: BD 60 06  LDA ram_0660,X
...
C - - - - - 0x001A2F 00:DA1F: BD 48 06  LDA ram_0648,X
C - - - - - 0x001A32 00:DA22: C9 05     CMP #$05
C - - - - - 0x001A34 00:DA24: 10 1E     BPL bra_DA44
C - - - - - 0x001A36 00:DA26: BD 50 06  LDA ram_0650,X
C - - - - - 0x001A39 00:DA29: 18        CLC
C - - - - - 0x001A3A 00:DA2A: 69 40     ADC #$40
C - - - - - 0x001A3C 00:DA2C: 9D 50 06  STA ram_0650,X
C - - - - - 0x001A3F 00:DA2F: BD 48 06  LDA ram_0648,X
C - - - - - 0x001A42 00:DA32: 69 00     ADC #$00
C - - - - - 0x001A44 00:DA34: 9D 48 06  STA ram_0648,X
...
bra_DA64:
C - - - - - 0x001A74 00:DA64: B9 2F 06  LDA ram_062F,Y
...
C - - - - - 0x001AA1 00:DA91: 94 62     STY ram_0062,X
bra_DA93:
...
C - - - - - 0x001AB0 00:DAA0: 95 80     STA ram_0080,X
...
C - - - - - 0x001ABB 00:DAAB: B4 62     LDY ram_0062,X
...
C - - - - - 0x001B04 00:DAF4: 8D 3E 06  STA ram_063E
...
C - - - - - 0x001B1A 00:DB0A: 8D 3E 06  STA ram_063E
...
C - - - - - 0x001B35 00:DB25: B9 91 00  LDA ram_0091,Y
C - - - - - 0x001B38 00:DB28: C9 02     CMP #$02
C - - - - - 0x001B3A 00:DB2A: F0 05     BEQ bra_DB31
bra_DB2C:
C - - - - - 0x001B3C 00:DB2C: B9 91 00  LDA ram_0091,Y
...
C - - - - - 0x001B4D 00:DB3D: B6 B2     LDX ram_00B2,Y
C - - - - - 0x001B4F 00:DB3F: A5 08     LDA ram_0008
C - - - - - 0x001B51 00:DB41: D0 11     BNE bra_DB54
C - - - - - 0x001B53 00:DB43: B9 9C 00  LDA ram_009C,Y
...
C - - - - - 0x001B5E 00:DB4E: 79 9C 00  ADC ram_009C,Y
C - - - - - 0x001B61 00:DB51: 4C 57 DB  JMP loc_DB57
bra_DB54:
C - - - - - 0x001B64 00:DB54: B9 9C 00  LDA ram_009C,Y
loc_DB57:
C D 2 - - - 0x001B67 00:DB57: 18        CLC
C - - - - - 0x001B68 00:DB58: 79 BD D7  ADC tbl_D7BD,Y
C - - - - - 0x001B6B 00:DB5B: DD A3 D7  CMP tbl_D7A3,X
C - - - - - 0x001B6E 00:DB5E: 90 44     BCC bra_DBA4
C - - - - - 0x001B70 00:DB60: DD AD D7  CMP tbl_D7AD,X
C - - - - - 0x001B73 00:DB63: B0 3F     BCS bra_DBA4
bra_DB65:
C - - - - - 0x001B75 00:DB65: B9 9C 00  LDA ram_009C,Y
C - - - - - 0x001B78 00:DB68: 18        CLC
C - - - - - 0x001B79 00:DB69: 79 BD D7  ADC tbl_D7BD,Y
...
C - - - - - 0x001B8F 00:DB7F: 90 05     BCC bra_DB86
bra_DB81:
C - - - - - 0x001B91 00:DB81: 68        PLA
C - - - - - 0x001B92 00:DB82: C9 0C     CMP #$0C
C - - - - - 0x001B94 00:DB84: B0 1E     BCS bra_DBA4
bra_DB86:
C - - - - - 0x001B96 00:DB86: B9 A7 00  LDA ram_00A7,Y
C - - - - - 0x001B99 00:DB89: 18        CLC
C - - - - - 0x001B9A 00:DB8A: 79 B7 D7  ADC tbl_D7B7,Y
...
C - - - - - 0x001BCC 00:DBBC: 9D 83 07  STA ram_0783,X
C - - - - - 0x001BCF 00:DBBF: A9 00     LDA #$00
C - - - - - 0x001BD1 00:DBC1: 9D 43 03  STA ram_0343,X
C - - - - - 0x001BD4 00:DBC4: B4 5A     LDY ram_005A,X
C - - - - - 0x001BD6 00:DBC6: B5 82     LDA ram_0082,X
C - - - - - 0x001BD8 00:DBC8: F0 01     BEQ bra_DBCB
C - - - - - 0x001BDA 00:DBCA: C8        INY
bra_DBCB:
C - - - - - 0x001BDB 00:DBCB: 94 D7     STY ram_00D7,X
C - - - - - 0x001BDD 00:DBCD: C0 0A     CPY #$0A
C - - - - - 0x001BDF 00:DBCF: B0 DC     BCS bra_DBAD
C - - - - - 0x001BE1 00:DBD1: A5 00     LDA ram_0000
C - - - - - 0x001BE3 00:DBD3: D9 A3 D7  CMP tbl_D7A3,Y
C - - - - - 0x001BE6 00:DBD6: 90 7E     BCC bra_DC56
C - - - - - 0x001BE8 00:DBD8: D9 AD D7  CMP tbl_D7AD,Y
...
C - - - - - 0x001BF8 00:DBE8: B4 D7     LDY ram_00D7,X
...
C - - - - - 0x001C0A 00:DBFA: FE 43 03  INC ram_0343,X
bra_DBFD:
C - - - - - 0x001C0D 00:DBFD: B5 D7     LDA ram_00D7,X
...
C - - - - - 0x001C1E 00:DC0E: B5 6A     LDA ram_006A,X
...
bra_DC18:
C - - - - - 0x001C28 00:DC18: B5 68     LDA ram_0068,X
C - - - - - 0x001C2A 00:DC1A: F0 18     BEQ bra_DC34
C - - - - - 0x001C2C 00:DC1C: B9 D7 07  LDA ram_07D7,Y
C - - - - - 0x001C2F 00:DC1F: F0 0A     BEQ bra_DC2B
C - - - - - 0x001C31 00:DC21: B5 68     LDA ram_0068,X
C - - - - - 0x001C33 00:DC23: C9 01     CMP #$01
C - - - - - 0x001C35 00:DC25: D0 0D     BNE bra_DC34
C - - - - - 0x001C37 00:DC27: A9 14     LDA #$14
C - - - - - 0x001C39 00:DC29: D0 0B     BNE bra_DC36
bra_DC2B:
C - - - - - 0x001C3B 00:DC2B: B5 68     LDA ram_0068,X
...
bra_DC4D:
C - - - - - 0x001C5D 00:DC4D: B5 2D     LDA ram_002D,X
...
C - - - - - 0x001C6B 00:DC5B: 9D 83 07  STA ram_0783,X
bra_DC5E:
...
sub_DC6A:
C - - - - - 0x001C7A 00:DC6A: AD 01 03  LDA ram_0301
C - - - - - 0x001C7D 00:DC6D: D0 E9     BNE bra_DC58_RTS
C - - - - - 0x001C7F 00:DC6F: 8D 00 03  STA ram_0300
C - - - - - 0x001C82 00:DC72: A5 84     LDA ram_0084
...
bra_DC80:
C - - - - - 0x001C90 00:DC80: A5 85     LDA ram_0085
C - - - - - 0x001C92 00:DC82: F0 D4     BEQ bra_DC58_RTS
C - - - - - 0x001C94 00:DC84: A2 01     LDX #$01
C - - - - - 0x001C96 00:DC86: AC 00 03  LDY ram_0300
...
tbl_DC8F:
; 03
- D 2 - - - 0x001C9F 00:DC8F: 6C D7     .word tbl_D76D_ppu_hi - 1
- D 2 - - - 0x001CA1 00:DC91: 75 D7     .word tbl_D776_ppu_lo - 1
; 07
- D 2 - - - 0x001CA3 00:DC93: 8A D7     .word tbl_D78B_ppu_hi - 1
- D 2 - - - 0x001CA5 00:DC95: 93 D7     .word tbl_D794_ppu_lo - 1



sub_DC97:
C - - - - - 0x001CA7 00:DC97: B5 84     LDA ram_0084,X
C - - - - - 0x001CA9 00:DC99: 29 01     AND #$01
C - - - - - 0x001CAB 00:DC9B: D0 07     BNE bra_DCA4
C - - - - - 0x001CAD 00:DC9D: B5 84     LDA ram_0084,X
...
C - - - - - 0x001CFC 00:DCEC: 99 01 03  STA ram_0301,Y
...
loc_DD24_loop:
C D 2 - - - 0x001D34 00:DD24: B5 DA     LDA ram_00DA,X
...
C - - - - - 0x001D4E 00:DD3E: 8D 02 03  STA ram_0302
C - - - - - 0x001D51 00:DD41: BD 0C DD  LDA tbl_DD0C,X
C - - - - - 0x001D54 00:DD44: 8D 03 03  STA ram_0303
C - - - - - 0x001D57 00:DD47: B1 05     LDA (ram_0005),Y
C - - - - - 0x001D59 00:DD49: 8D 01 03  STA ram_0301
C - - - - - 0x001D5C 00:DD4C: A0 00     LDY #$00
C - - - - - 0x001D5E 00:DD4E: 84 02     STY ram_0002
bra_DD50_loop:
C - - - - - 0x001D60 00:DD50: 20 12 DE  JSR sub_DE12
C - - - - - 0x001D63 00:DD53: A4 02     LDY ram_0002
C - - - - - 0x001D65 00:DD55: 99 04 03  STA ram_0304,Y
...
C - - - - - 0x001D73 00:DD63: 99 04 03  STA ram_0304,Y
C - - - - - 0x001D76 00:DD66: A6 0B     LDX ram_000B
C - - - - - 0x001D78 00:DD68: D0 2D     BNE bra_DD97
C - - - - - 0x001D7A 00:DD6A: B4 DA     LDY ram_00DA,X
C - - - - - 0x001D7C 00:DD6C: B9 2F 06  LDA ram_062F,Y
...
C - - - - - 0x001D87 00:DD77: BE 01 03  LDX ram_0301,Y
...
bra_DD91:
C - - - - - 0x001DA1 00:DD91: 99 01 03  STA ram_0301,Y
bra_DD94:
...
C - - - - - 0x001DAC 00:DD9C: F6 DA     INC ram_00DA,X
...
sub_DDA9:
loc_DDA9:
C D 2 - - - 0x001DB9 00:DDA9: A9 02     LDA #$02
C - - - - - 0x001DBB 00:DDAB: 85 FC     STA ram_copy_music
C - - - - - 0x001DBD 00:DDAD: A5 0E     LDA ram_000E
C - - - - - 0x001DBF 00:DDAF: 49 FF     EOR #$FF
C - - - - - 0x001DC1 00:DDB1: 35 84     AND ram_0084,X
C - - - - - 0x001DC3 00:DDB3: 95 84     STA ram_0084,X
...
C - - - - - 0x001DD0 00:DDC0: D9 7F D7  CMP tbl_D77F,Y
C - - - - - 0x001DD3 00:DDC3: D0 FA     BNE bra_DDBF_loop
C - - - - - 0x001DD5 00:DDC5: B9 85 D7  LDA tbl_D785,Y
C - - - - - 0x001DD8 00:DDC8: 60        RTS



sub_DDC9:
C - - - - - 0x001DD9 00:DDC9: B5 80     LDA ram_0080,X
C - - - - - 0x001DDB 00:DDCB: F0 43     BEQ bra_DE10
C - - - - - 0x001DDD 00:DDCD: A9 00     LDA #$00
C - - - - - 0x001DDF 00:DDCF: 95 80     STA ram_0080,X
...
C - - - - - 0x001DEA 00:DDDA: B4 62     LDY ram_0062,X
...
C - - - - - 0x001DF6 00:DDE6: A9 04     LDA #$04
C - - - - - 0x001DF8 00:DDE8: 85 FC     STA ram_copy_music
...
C - - - - - 0x001E5F 00:DE4F: 94 5C     STY ram_005C,X
C - - - - - 0x001E61 00:DE51: A5 03     LDA ram_0003
C - - - - - 0x001E63 00:DE53: 95 7D     STA ram_007D,X
C - - - - - 0x001E65 00:DE55: A5 0E     LDA ram_000E
C - - - - - 0x001E67 00:DE57: 20 BF ED  JSR sub_EDBF
C - - - - - 0x001E6A 00:DE5A: 85 D6     STA ram_00D6
C - - - - - 0x001E6C 00:DE5C: 20 F0 DC  JSR sub_DCF0
C - - - - - 0x001E6F 00:DE5F: AC 00 03  LDY ram_0300
...
C - - - - - 0x001E7B 00:DE6B: B9 2F 06  LDA ram_062F,Y
...
bra_DE7D:
- - - - - - 0x001E8D 00:DE7D: AC 00 03  LDY ram_0300
- - - - - - 0x001E90 00:DE80: 99 00 03  STA ram_0300,Y
bra_DE83:
C - - - - - 0x001E93 00:DE83: A5 0D     LDA ram_000D
C - - - - - 0x001E95 00:DE85: D0 22     BNE bra_DEA9
C - - - - - 0x001E97 00:DE87: A6 0F     LDX ram_000F
C - - - - - 0x001E99 00:DE89: B5 BD     LDA ram_00BD,X
...
C - - - - - 0x001EB2 00:DEA2: 90 8A     BCC bra_DE2E
C - - - - - 0x001EB4 00:DEA4: 60        RTS
bra_DEA5:
C - - - - - 0x001EB5 00:DEA5: A5 0D     LDA ram_000D
C - - - - - 0x001EB7 00:DEA7: F0 F3     BEQ bra_DE9C
bra_DEA9:
C - - - - - 0x001EB9 00:DEA9: A9 02     LDA #$02
C - - - - - 0x001EBB 00:DEAB: 85 FC     STA ram_copy_music
...
C - - - - - 0x001EC4 00:DEB4: B5 B2     LDA ram_00B2,X
...
C - - - - - 0x001EFD 00:DEED: D9 7F D7  CMP tbl_D77F,Y
C - - - - - 0x001F00 00:DEF0: D0 FA     BNE bra_DEEC_loop
C - - - - - 0x001F02 00:DEF2: B9 9D D7  LDA tbl_D79D,Y
...
tbl_DF1B:
- - - - - - 0x001F2B 00:DF1B: 89        .byte $89   ; 00
- D 2 - - - 0x001F2C 00:DF1C: 85        .byte $85   ; 01
- D 2 - - - 0x001F2D 00:DF1D: B2        .byte $B2   ; 02
- D 2 - - - 0x001F2E 00:DF1E: 91        .byte $91   ; 03
- D 2 - - - 0x001F2F 00:DF1F: AB        .byte $AB   ; 04
- D 2 - - - 0x001F30 00:DF20: 27        .byte $27   ; 05
- D 2 - - - 0x001F31 00:DF21: 67        .byte $67   ; 06
- D 2 - - - 0x001F32 00:DF22: 6C        .byte $6C   ; 07
- D 2 - - - 0x001F33 00:DF23: 93        .byte $93   ; 08
- D 2 - - - 0x001F34 00:DF24: 27        .byte $27   ; 09
- D 2 - - - 0x001F35 00:DF25: 65        .byte $65   ; 0A
- D 2 - - - 0x001F36 00:DF26: 81        .byte $81   ; 0B
- D 2 - - - 0x001F37 00:DF27: 8D        .byte $8D   ; 0C
- D 2 - - - 0x001F38 00:DF28: CB        .byte $CB   ; 0D
- D 2 - - - 0x001F39 00:DF29: F2        .byte $F2   ; 0E
- D 2 - - - 0x001F3A 00:DF2A: 22        .byte $22   ; 0F
- D 2 - - - 0x001F3B 00:DF2B: A2        .byte $A2   ; 10
- D 2 - - - 0x001F3C 00:DF2C: AE        .byte $AE   ; 11
- D 2 - - - 0x001F3D 00:DF2D: C8        .byte $C8   ; 12
- D 2 - - - 0x001F3E 00:DF2E: 27        .byte $27   ; 13
- D 2 - - - 0x001F3F 00:DF2F: C7        .byte $C7   ; 14
- D 2 - - - 0x001F40 00:DF30: D0        .byte $D0   ; 15
- D 2 - - - 0x001F41 00:DF31: C4        .byte $C4   ; 16
- D 2 - - - 0x001F42 00:DF32: D2        .byte $D2   ; 17
- D 2 - - - 0x001F43 00:DF33: 81        .byte $81   ; 18
- D 2 - - - 0x001F44 00:DF34: 4A        .byte $4A   ; 19
- D 2 - - - 0x001F45 00:DF35: 84        .byte $84   ; 1A
- D 2 - - - 0x001F46 00:DF36: 8C        .byte $8C   ; 1B
- D 2 - - - 0x001F47 00:DF37: 94        .byte $94   ; 1C
- D 2 - - - 0x001F48 00:DF38: A8        .byte $A8   ; 1D
- D 2 - - - 0x001F49 00:DF39: C2        .byte $C2   ; 1E
- D 2 - - - 0x001F4A 00:DF3A: 44        .byte $44   ; 1F
- D 2 - - - 0x001F4B 00:DF3B: 4A        .byte $4A   ; 20
- D 2 - - - 0x001F4C 00:DF3C: 50        .byte $50   ; 21
- D 2 - - - 0x001F4D 00:DF3D: CA        .byte $CA   ; 22
- D 2 - - - 0x001F4E 00:DF3E: D1        .byte $D1   ; 23
- D 2 - - - 0x001F4F 00:DF3F: 48        .byte $48   ; 24
- D 2 - - - 0x001F50 00:DF40: 70        .byte $70   ; 25
- D 2 - - - 0x001F51 00:DF41: 84        .byte $84   ; 26
- D 2 - - - 0x001F52 00:DF42: 26        .byte $26   ; 27
- D 2 - - - 0x001F53 00:DF43: 2E        .byte $2E   ; 28
- D 2 - - - 0x001F54 00:DF44: 64        .byte $64   ; 29
- D 2 - - - 0x001F55 00:DF45: 70        .byte $70   ; 2A
- D 2 - - - 0x001F56 00:DF46: C7        .byte $C7   ; 2B
- D 2 - - - 0x001F57 00:DF47: CD        .byte $CD   ; 2C
- D 2 - - - 0x001F58 00:DF48: D3        .byte $D3   ; 2D
- D 2 - - - 0x001F59 00:DF49: A2        .byte $A2   ; 2E
- D 2 - - - 0x001F5A 00:DF4A: AB        .byte $AB   ; 2F
- D 2 - - - 0x001F5B 00:DF4B: B1        .byte $B1   ; 30
- D 2 - - - 0x001F5C 00:DF4C: 2C        .byte $2C   ; 31
- D 2 - - - 0x001F5D 00:DF4D: 85        .byte $85   ; 32
- D 2 - - - 0x001F5E 00:DF4E: 8B        .byte $8B   ; 33
- D 2 - - - 0x001F5F 00:DF4F: 91        .byte $91   ; 34
- D 2 - - - 0x001F60 00:DF50: 96        .byte $96   ; 35
- D 2 - - - 0x001F61 00:DF51: A7        .byte $A7   ; 36
- D 2 - - - 0x001F62 00:DF52: AE        .byte $AE   ; 37
- D 2 - - - 0x001F63 00:DF53: CF        .byte $CF   ; 38
- D 2 - - - 0x001F64 00:DF54: D4        .byte $D4   ; 39
- D 2 - - - 0x001F65 00:DF55: 27        .byte $27   ; 3A
- D 2 - - - 0x001F66 00:DF56: 44        .byte $44   ; 3B
- D 2 - - - 0x001F67 00:DF57: 50        .byte $50   ; 3C
- D 2 - - - 0x001F68 00:DF58: 63        .byte $63   ; 3D
- D 2 - - - 0x001F69 00:DF59: 6D        .byte $6D   ; 3E
- D 2 - - - 0x001F6A 00:DF5A: 86        .byte $86   ; 3F
- D 2 - - - 0x001F6B 00:DF5B: 90        .byte $90   ; 40
- D 2 - - - 0x001F6C 00:DF5C: A3        .byte $A3   ; 41
- D 2 - - - 0x001F6D 00:DF5D: A9        .byte $A9   ; 42
- D 2 - - - 0x001F6E 00:DF5E: AF        .byte $AF   ; 43
- D 2 - - - 0x001F6F 00:DF5F: E3        .byte $E3   ; 44
- D 2 - - - 0x001F70 00:DF60: E5        .byte $E5   ; 45
- D 2 - - - 0x001F71 00:DF61: ED        .byte $ED   ; 46
- D 2 - - - 0x001F72 00:DF62: F4        .byte $F4   ; 47
- D 2 - - - 0x001F73 00:DF63: 48        .byte $48   ; 48
- D 2 - - - 0x001F74 00:DF64: 4F        .byte $4F   ; 49
- D 2 - - - 0x001F75 00:DF65: A3        .byte $A3   ; 4A
- D 2 - - - 0x001F76 00:DF66: AB        .byte $AB   ; 4B
- D 2 - - - 0x001F77 00:DF67: B3        .byte $B3   ; 4C
- D 2 - - - 0x001F78 00:DF68: C3        .byte $C3   ; 4D
- D 2 - - - 0x001F79 00:DF69: CB        .byte $CB   ; 4E
- D 2 - - - 0x001F7A 00:DF6A: 6D        .byte $6D   ; 4F
- D 2 - - - 0x001F7B 00:DF6B: 92        .byte $92   ; 50
- D 2 - - - 0x001F7C 00:DF6C: A5        .byte $A5   ; 51
- D 2 - - - 0x001F7D 00:DF6D: AF        .byte $AF   ; 52
- D 2 - - - 0x001F7E 00:DF6E: EB        .byte $EB   ; 53
- D 2 - - - 0x001F7F 00:DF6F: 64        .byte $64   ; 54
- D 2 - - - 0x001F80 00:DF70: 88        .byte $88   ; 55
- D 2 - - - 0x001F81 00:DF71: 8E        .byte $8E   ; 56
- D 2 - - - 0x001F82 00:DF72: 94        .byte $94   ; 57
- D 2 - - - 0x001F83 00:DF73: AC        .byte $AC   ; 58
- D 2 - - - 0x001F84 00:DF74: EC        .byte $EC   ; 59
- D 2 - - - 0x001F85 00:DF75: F2        .byte $F2   ; 5A
- D 2 - - - 0x001F86 00:DF76: A7        .byte $A7   ; 5B
- D 2 - - - 0x001F87 00:DF77: AE        .byte $AE   ; 5C
- D 2 - - - 0x001F88 00:DF78: C4        .byte $C4   ; 5D
- D 2 - - - 0x001F89 00:DF79: C7        .byte $C7   ; 5E
- D 2 - - - 0x001F8A 00:DF7A: D3        .byte $D3   ; 5F
- D 2 - - - 0x001F8B 00:DF7B: CE        .byte $CE   ; 60
- D 2 - - - 0x001F8C 00:DF7C: 23        .byte $23   ; 61
- D 2 - - - 0x001F8D 00:DF7D: 64        .byte $64   ; 62
- D 2 - - - 0x001F8E 00:DF7E: 8E        .byte $8E   ; 63
- D 2 - - - 0x001F8F 00:DF7F: A9        .byte $A9   ; 64
- D 2 - - - 0x001F90 00:DF80: D0        .byte $D0   ; 65
- D 2 - - - 0x001F91 00:DF81: E4        .byte $E4   ; 66
- D 2 - - - 0x001F92 00:DF82: E9        .byte $E9   ; 67
- D 2 - - - 0x001F93 00:DF83: C8        .byte $C8   ; 68
- D 2 - - - 0x001F94 00:DF84: D0        .byte $D0   ; 69
- D 2 - - - 0x001F95 00:DF85: D4        .byte $D4   ; 6A
- D 2 - - - 0x001F96 00:DF86: 8B        .byte $8B   ; 6B
- D 2 - - - 0x001F97 00:DF87: C9        .byte $C9   ; 6C
- D 2 - - - 0x001F98 00:DF88: D4        .byte $D4   ; 6D
- D 2 - - - 0x001F99 00:DF89: CF        .byte $CF   ; 6E
- D 2 - - - 0x001F9A 00:DF8A: CB        .byte $CB   ; 6F
- D 2 - - - 0x001F9B 00:DF8B: 88        .byte $88   ; 70
- D 2 - - - 0x001F9C 00:DF8C: 90        .byte $90   ; 71
- D 2 - - - 0x001F9D 00:DF8D: A4        .byte $A4   ; 72
- D 2 - - - 0x001F9E 00:DF8E: D4        .byte $D4   ; 73
- D 2 - - - 0x001F9F 00:DF8F: C7        .byte $C7   ; 74
- D 2 - - - 0x001FA0 00:DF90: D0        .byte $D0   ; 75
- D 2 - - - 0x001FA1 00:DF91: E2        .byte $E2   ; 76
- D 2 - - - 0x001FA2 00:DF92: E9        .byte $E9   ; 77
- D 2 - - - 0x001FA3 00:DF93: F1        .byte $F1   ; 78
- D 2 - - - 0x001FA4 00:DF94: 2B        .byte $2B   ; 79
- D 2 - - - 0x001FA5 00:DF95: 50        .byte $50   ; 7A
- D 2 - - - 0x001FA6 00:DF96: 67        .byte $67   ; 7B
- D 2 - - - 0x001FA7 00:DF97: 70        .byte $70   ; 7C
- D 2 - - - 0x001FA8 00:DF98: 82        .byte $82   ; 7D
- D 2 - - - 0x001FA9 00:DF99: 8B        .byte $8B   ; 7E
- D 2 - - - 0x001FAA 00:DF9A: C2        .byte $C2   ; 7F
- D 2 - - - 0x001FAB 00:DF9B: C9        .byte $C9   ; 80
- D 2 - - - 0x001FAC 00:DF9C: D1        .byte $D1   ; 81
- D 2 - - - 0x001FAD 00:DF9D: 48        .byte $48   ; 82
- D 2 - - - 0x001FAE 00:DF9E: 51        .byte $51   ; 83
- D 2 - - - 0x001FAF 00:DF9F: 87        .byte $87   ; 84
- D 2 - - - 0x001FB0 00:DFA0: 95        .byte $95   ; 85
- D 2 - - - 0x001FB1 00:DFA1: B0        .byte $B0   ; 86
- D 2 - - - 0x001FB2 00:DFA2: E4        .byte $E4   ; 87
- D 2 - - - 0x001FB3 00:DFA3: ED        .byte $ED   ; 88
- D 2 - - - 0x001FB4 00:DFA4: F5        .byte $F5   ; 89



sub_DFA5:
C - - - - - 0x001FB5 00:DFA5: A5 59     LDA ram_mountain
...
C - - - - - 0x002002 00:DFF2: B9 FB DE  LDA tbl_DEFA + 1,Y
...
C - - - - - 0x002016 00:E006: 9D 00 06  STA ram_0600,X
C - - - - - 0x002019 00:E009: 9D 10 06  STA ram_0610,X
C - - - - - 0x00201C 00:E00C: 9D 20 06  STA ram_0620,X
...
C - - - - - 0x002044 00:E034: 9D 10 06  STA ram_0610,X
...
C - - - - - 0x002053 00:E043: 9D 00 06  STA ram_0600,X
...
C - - - - - 0x002061 00:E051: 9D 20 06  STA ram_0620,X
bra_E054:
...
C - - - - - 0x0020A1 00:E091: 8C 00 03  STY ram_0300
...
C - - - - - 0x0020A9 00:E099: 99 03 03  STA ram_0303,Y
C - - - - - 0x0020AC 00:E09C: A9 EB     LDA #$EB
C - - - - - 0x0020AE 00:E09E: 99 04 03  STA ram_0304,Y
C - - - - - 0x0020B1 00:E0A1: A9 00     LDA #$00
C - - - - - 0x0020B3 00:E0A3: 99 05 03  STA ram_0305,Y
C - - - - - 0x0020B6 00:E0A6: 60        RTS



sub_E0A7:
C - - - - - 0x0020B7 00:E0A7: 20 EA DC  JSR sub_DCEA
...
C - - - - - 0x0020C5 00:E0B5: 99 02 03  STA ram_0302,Y
...
sub_E0C0:
C - - - - - 0x0020D0 00:E0C0: B5 3A     LDA ram_003A,X
C - - - - - 0x0020D2 00:E0C2: D0 57     BNE bra_E11B
C - - - - - 0x0020D4 00:E0C4: B5 5A     LDA ram_005A,X
C - - - - - 0x0020D6 00:E0C6: F0 52     BEQ bra_E11A_RTS
C - - - - - 0x0020D8 00:E0C8: B5 6A     LDA ram_006A,X
C - - - - - 0x0020DA 00:E0CA: C9 07     CMP #$07
C - - - - - 0x0020DC 00:E0CC: F0 4C     BEQ bra_E11A_RTS
C - - - - - 0x0020DE 00:E0CE: B5 2D     LDA ram_002D,X
...
bra_E0E2_loop:
C - - - - - 0x0020F2 00:E0E2: B9 00 06  LDA ram_0600,Y
...
C - - - - - 0x002106 00:E0F6: B9 10 06  LDA ram_0610,Y
...
C - - - - - 0x002113 00:E103: B5 E6     LDA ram_00E6,X
...
bra_E11B:
C - - - - - 0x00212B 00:E11B: A5 50     LDA ram_0050
C - - - - - 0x00212D 00:E11D: 29 01     AND #$01
C - - - - - 0x00212F 00:E11F: F0 0D     BEQ bra_E12E_RTS
C - - - - - 0x002131 00:E121: B5 68     LDA ram_0068,X
...
C - - - - - 0x002140 00:E130: B5 E6     LDA ram_00E6,X
...
bra_E142:
C - - - - - 0x002152 00:E142: B5 68     LDA ram_0068,X
...
C - - - - - 0x00218D 00:E17D: 0A        ASL
bra_E17E:
C - - - - - 0x00218E 00:E17E: 95 68     STA ram_0068,X
C - - - - - 0x002190 00:E180: 29 01     AND #$01
C - - - - - 0x002192 00:E182: 95 62     STA ram_0062,X
bra_E184_RTS:
...
bra_E196:
C - - - - - 0x0021A6 00:E196: B5 99     LDA ram_0099,X
C - - - - - 0x0021A8 00:E198: D0 46     BNE bra_E1E0_RTS
C - - - - - 0x0021AA 00:E19A: CA        DEX
C - - - - - 0x0021AB 00:E19B: 10 F9     BPL bra_E196
C - - - - - 0x0021AD 00:E19D: A4 92     LDY ram_0092
C - - - - - 0x0021AF 00:E19F: D0 3F     BNE bra_E1E0_RTS
C - - - - - 0x0021B1 00:E1A1: 8A        TXA
C - - - - - 0x0021B2 00:E1A2: 20 3E E2  JSR sub_E23E
C - - - - - 0x0021B5 00:E1A5: 85 92     STA ram_0092
C - - - - - 0x0021B7 00:E1A7: 8D D3 03  STA ram_03D3
C - - - - - 0x0021BA 00:E1AA: 8C 76 03  STY ram_0376
C - - - - - 0x0021BD 00:E1AD: 8C B2 03  STY ram_03B2
C - - - - - 0x0021C0 00:E1B0: 8C C8 03  STY ram_03C8
C - - - - - 0x0021C3 00:E1B3: A9 40     LDA #$40
C - - - - - 0x0021C5 00:E1B5: 8D BD 03  STA ram_03BD
C - - - - - 0x0021C8 00:E1B8: 0A        ASL ; 80
C - - - - - 0x0021C9 00:E1B9: 8D A7 03  STA ram_03A7
C - - - - - 0x0021CC 00:E1BC: C8        INY
C - - - - - 0x0021CD 00:E1BD: 84 BE     STY ram_00BE
C - - - - - 0x0021CF 00:E1BF: A9 04     LDA #$04
C - - - - - 0x0021D1 00:E1C1: 85 9D     STA ram_009D
...
C - - - - - 0x0021E1 00:E1D1: 86 B3     STX ram_00B3
C - - - - - 0x0021E3 00:E1D3: A5 90     LDA ram_0090
C - - - - - 0x0021E5 00:E1D5: 38        SEC
C - - - - - 0x0021E6 00:E1D6: E5 B3     SBC ram_00B3
C - - - - - 0x0021E8 00:E1D8: AA        TAX
C - - - - - 0x0021E9 00:E1D9: BD 85 E1  LDA tbl_E185,X
C - - - - - 0x0021EC 00:E1DC: 85 A8     STA ram_00A8
...
bra_E1E4:
C - - - - - 0x0021F4 00:E1E4: AD 76 03  LDA ram_0376
C - - - - - 0x0021F7 00:E1E7: D0 2C     BNE bra_E215
C - - - - - 0x0021F9 00:E1E9: C6 DF     DEC ram_00DF
...
C - - - - - 0x002201 00:E1F1: AD 76 03  LDA ram_0376
C - - - - - 0x002204 00:E1F4: D0 1F     BNE bra_E215
C - - - - - 0x002206 00:E1F6: A5 A8     LDA ram_00A8
C - - - - - 0x002208 00:E1F8: C9 17     CMP #$17
C - - - - - 0x00220A 00:E1FA: D0 E8     BNE bra_E1E4
- - - - - - 0x00220C 00:E1FC: A5 9D     LDA ram_009D
...
C - - - - - 0x002218 00:E208: 85 DF     STA ram_00DF
C - - - - - 0x00221A 00:E20A: A5 92     LDA ram_0092
C - - - - - 0x00221C 00:E20C: C9 FF     CMP #$FF
C - - - - - 0x00221E 00:E20E: D0 04     BNE bra_E214_RTS
C - - - - - 0x002220 00:E210: A9 04     LDA #$04
C - - - - - 0x002222 00:E212: 85 92     STA ram_0092
bra_E214_RTS:
...
C - - - - - 0x00225C 00:E24C: 65 A8     ADC ram_00A8
C - - - - - 0x00225E 00:E24E: 85 A8     STA ram_00A8
bra_E250_RTS:
C - - - - - 0x002260 00:E250: 60        RTS
bra_E251:
C - - - - - 0x002261 00:E251: CA        DEX
C - - - - - 0x002262 00:E252: D0 FC     BNE bra_E250_RTS
C - - - - - 0x002264 00:E254: C6 DF     DEC ram_00DF
C - - - - - 0x002266 00:E256: D0 F8     BNE bra_E250_RTS
C - - - - - 0x002268 00:E258: A5 92     LDA ram_0092
C - - - - - 0x00226A 00:E25A: C9 04     CMP #$04
C - - - - - 0x00226C 00:E25C: D0 07     BNE bra_E265
C - - - - - 0x00226E 00:E25E: A9 FF     LDA #$FF
C - - - - - 0x002270 00:E260: 85 92     STA ram_0092
C - - - - - 0x002272 00:E262: 8D D3 03  STA ram_03D3
bra_E265:
C - - - - - 0x002275 00:E265: AD 76 03  LDA ram_0376
C - - - - - 0x002278 00:E268: D0 AB     BNE bra_E215
C - - - - - 0x00227A 00:E26A: A9 80     LDA #$80
C - - - - - 0x00227C 00:E26C: 85 7C     STA ram_007C
C - - - - - 0x00227E 00:E26E: A9 02     LDA #con_sfx_2_02
C - - - - - 0x002280 00:E270: 85 FF     STA ram_sfx_2
...
C - - - - - 0x002290 00:E280: BD 86 07  LDA ram_0786,X
...
C - - - - - 0x00229E 00:E28E: 9D 86 07  STA ram_0786,X
C - - - - - 0x0022A1 00:E291: A9 FF     LDA #$FF
C - - - - - 0x0022A3 00:E293: 9D F5 06  STA ram_06F5,X
bra_E296:
...
bra_E2B0_loop:
C - - - - - 0x0022C0 00:E2B0: BD B7 07  LDA ram_07B7,X
...
bra_E2C5_loop:
C - - - - - 0x0022D5 00:E2C5: B9 6A 00  LDA ram_006A,Y
...
bra_E2D0:
C - - - - - 0x0022E0 00:E2D0: B6 5A     LDX ram_005A,Y
...
C - - - - - 0x0022EC 00:E2DC: B9 2D 00  LDA ram_002D,Y
C - - - - - 0x0022EF 00:E2DF: D0 05     BNE bra_E2E6
C - - - - - 0x0022F1 00:E2E1: B9 43 03  LDA ram_0343,Y
C - - - - - 0x0022F4 00:E2E4: D0 06     BNE bra_E2EC
bra_E2E6:
C - - - - - 0x0022F6 00:E2E6: BD AE 07  LDA ram_07AE,X
C - - - - - 0x0022F9 00:E2E9: 20 FB E2  JSR sub_E2FB
bra_E2EC:
C - - - - - 0x0022FC 00:E2EC: BE 83 07  LDX ram_0783,Y
...
sub_E2F8:
C - - - - - 0x002308 00:E2F8: BD B7 07  LDA ram_07B7,X
sub_E2FB:
...
sub_E303:
bra_E303_loop:
C - - - - - 0x002313 00:E303: BD C0 07  LDA ram_07C0,X
C - - - - - 0x002316 00:E306: 18        CLC
C - - - - - 0x002317 00:E307: 7D A0 07  ADC ram_07A0,X
C - - - - - 0x00231A 00:E30A: 9D C0 07  STA ram_07C0,X
C - - - - - 0x00231D 00:E30D: A9 00     LDA #$00
C - - - - - 0x00231F 00:E30F: 7D 90 07  ADC ram_0790,X
C - - - - - 0x002322 00:E312: BC D0 07  LDY ram_07D0,X
C - - - - - 0x002325 00:E315: F0 03     BEQ bra_E31A
C - - - - - 0x002327 00:E317: 20 FB D2  JSR sub_D2FB_EOR
bra_E31A:
C - - - - - 0x00232A 00:E31A: 9D B0 07  STA ram_07B0,X
...
bra_E325_loop:
C - - - - - 0x002335 00:E325: BD B7 07  LDA ram_07B7,X
...
bra_E343_loop:
C - - - - - 0x002353 00:E343: BD 86 07  LDA ram_0786,X
...
C - - - - - 0x00235F 00:E34F: BD B7 07  LDA ram_07B7,X
C - - - - - 0x002362 00:E352: 48        PHA
C - - - - - 0x002363 00:E353: 18        CLC
C - - - - - 0x002364 00:E354: 7D 82 06  ADC ram_0682,X
C - - - - - 0x002367 00:E357: 9D 82 06  STA ram_0682,X
C - - - - - 0x00236A 00:E35A: 68        PLA
C - - - - - 0x00236B 00:E35B: 18        CLC
C - - - - - 0x00236C 00:E35C: 7D A0 06  ADC ram_06A0,X
C - - - - - 0x00236F 00:E35F: 9D A0 06  STA ram_06A0,X
bra_E362:
C - - - - - 0x002372 00:E362: CA        DEX
C - - - - - 0x002373 00:E363: 10 DE     BPL bra_E343_loop
C - - - - - 0x002375 00:E365: A0 01     LDY #$01
bra_E367_loop:
C - - - - - 0x002377 00:E367: B9 6A 00  LDA ram_006A,Y
...
bra_E372:
C - - - - - 0x002382 00:E372: B9 83 07  LDA ram_0783,Y
...
C - - - - - 0x002502 00:E4F2: 99 90 07  STA ram_0790,Y
C - - - - - 0x002505 00:E4F5: BD A3 E4  LDA tbl_E4A2 + 1,X
C - - - - - 0x002508 00:E4F8: 99 A0 07  STA ram_07A0,Y
C - - - - - 0x00250B 00:E4FB: A5 01     LDA ram_0001
C - - - - - 0x00250D 00:E4FD: 29 10     AND #$10
C - - - - - 0x00250F 00:E4FF: 99 D0 07  STA ram_07D0,Y
bra_E502:
...
bra_E527_loop:
C - - - - - 0x002537 00:E527: 9D 90 07  STA ram_0790,X
...
C - - - - - 0x002579 00:E569: A5 59     LDA ram_mountain
...
C - - - - - 0x0025AC 00:E59C: 99 D7 07  STA ram_07D7,Y
...
C - - - - - 0x0025BA 00:E5AA: 99 A7 07  STA ram_07A7,Y
C - - - - - 0x0025BD 00:E5AD: A9 00     LDA #$00
C - - - - - 0x0025BF 00:E5AF: 99 97 07  STA ram_0797,Y
C - - - - - 0x0025C2 00:E5B2: A2 06     LDX #$06
C - - - - - 0x0025C4 00:E5B4: A5 59     LDA ram_mountain
...
C - - - - - 0x0025DB 00:E5CB: 99 FA 06  STA ram_06FA,Y
...
C - - - - - 0x0025EA 00:E5DA: 99 BE 06  STA ram_06BE,Y
C - - - - - 0x0025ED 00:E5DD: 18        CLC
C - - - - - 0x0025EE 00:E5DE: 69 05     ADC #$05
C - - - - - 0x0025F0 00:E5E0: 99 DC 06  STA ram_06DC,Y
C - - - - - 0x0025F3 00:E5E3: A9 E8     LDA #$E8
C - - - - - 0x0025F5 00:E5E5: 99 82 06  STA ram_0682,Y
...
bra_E5F2:
C - - - - - 0x002602 00:E5F2: 99 A0 06  STA ram_06A0,Y
C - - - - - 0x002605 00:E5F5: A5 27     LDA ram_0027
...
C - - - - - 0x002668 00:E658: BD 80 E3  LDA tbl_E382 - 2,X
...
C - - - - - 0x002693 00:E683: BD A3 E4  LDA tbl_E4A2 + 1,X
C - - - - - 0x002696 00:E686: 85 07     STA ram_0007
C - - - - - 0x002698 00:E688: A5 19     LDA ram_0019
...
C - - - - - 0x0026BC 00:E6AC: E8        INX
bra_E6AD:
C - - - - - 0x0026BD 00:E6AD: A5 05     LDA ram_0005
C - - - - - 0x0026BF 00:E6AF: 9D D7 07  STA ram_07D7,X
C - - - - - 0x0026C2 00:E6B2: A5 06     LDA ram_0006
C - - - - - 0x0026C4 00:E6B4: 9D 97 07  STA ram_0797,X
C - - - - - 0x0026C7 00:E6B7: A5 07     LDA ram_0007
C - - - - - 0x0026C9 00:E6B9: 9D A7 07  STA ram_07A7,X
C - - - - - 0x0026CC 00:E6BC: A0 00     LDY #$00
bra_E6BE_loop:
C - - - - - 0x0026CE 00:E6BE: B9 00 00  LDA ram_0000,Y
C - - - - - 0x0026D1 00:E6C1: 9D 86 07  STA ram_0786,X
...
sub_E719:
C - - - - - 0x002729 00:E719: A5 59     LDA ram_mountain
...
sub_E72B:
C - - - - - 0x00273B 00:E72B: A5 59     LDA ram_mountain
...
C - - - - - 0x00278E 00:E77E: 99 30 06  STA ram_0630,Y
...
C - - - - - 0x002798 00:E788: 4A        LSR
C - - - - - 0x002799 00:E789: 99 30 06  STA ram_0630,Y
...
C - - - - - 0x002809 00:E7F9: 99 00 06  STA ram_0600,Y
...
C - - - - - 0x002818 00:E808: 99 FF 05  STA ram_05FF,Y
...
C - - - - - 0x00282F 00:E81F: 9D 00 06  STA ram_0600,X
...
C - - - - - 0x002857 00:E847: 7E 39 06  ROR ram_0639,X
C - - - - - 0x00285A 00:E84A: 7E 42 06  ROR ram_0642,X
C - - - - - 0x00285D 00:E84D: 7E 4B 06  ROR ram_064B,X
C - - - - - 0x002860 00:E850: 7E 54 06  ROR ram_0654,X
C - - - - - 0x002863 00:E853: 7E 5D 06  ROR ram_065D,X
C - - - - - 0x002866 00:E856: 7E 66 06  ROR ram_0666,X
C - - - - - 0x002869 00:E859: 26 08     ROL ram_0008
C - - - - - 0x00286B 00:E85B: 26 09     ROL ram_0009
C - - - - - 0x00286D 00:E85D: 3E 30 06  ROL ram_0630,X
C - - - - - 0x002870 00:E860: 3E 27 06  ROL ram_0627,X
C - - - - - 0x002873 00:E863: 3E 1E 06  ROL ram_061E,X
C - - - - - 0x002876 00:E866: 3E 15 06  ROL ram_0615,X
C - - - - - 0x002879 00:E869: 3E 0C 06  ROL ram_060C,X
C - - - - - 0x00287C 00:E86C: 3E 03 06  ROL ram_0603,X
...
bra_E891_loop:
C - - - - - 0x0028A1 00:E891: B5 22     LDA ram_0022,X
C - - - - - 0x0028A3 00:E893: D0 16     BNE bra_E8AB
C - - - - - 0x0028A5 00:E895: B5 20     LDA ram_lives,X
C - - - - - 0x0028A7 00:E897: 30 12     BMI bra_E8AB
C - - - - - 0x0028A9 00:E899: BC 8D E8  LDY tbl_E88D,X
C - - - - - 0x0028AC 00:E89C: B9 61 03  LDA ram_0361,Y
C - - - - - 0x0028AF 00:E89F: F0 0A     BEQ bra_E8AB
C - - - - - 0x0028B1 00:E8A1: A5 56     LDA ram_0056
C - - - - - 0x0028B3 00:E8A3: C9 04     CMP #$04
C - - - - - 0x0028B5 00:E8A5: D0 04     BNE bra_E8AB
C - - - - - 0x0028B7 00:E8A7: 95 22     STA ram_0022,X
C - - - - - 0x0028B9 00:E8A9: F6 20     INC ram_lives,X
bra_E8AB:
...
bra_E911_loop:
C - - - - - 0x002921 00:E911: BD 60 03  LDA ram_0360,X
...
bra_E91C_loop:
C - - - - - 0x00292C 00:E91C: BD AE E8  LDA tbl_E8AF - 1,X
C - - - - - 0x00292F 00:E91F: 9D 00 03  STA ram_0301 - 1,X
...
C - - - - - 0x00293A 00:E92A: BD 02 03  LDA ram_0302,X
C - - - - - 0x00293D 00:E92D: 18        CLC
C - - - - - 0x00293E 00:E92E: 69 40     ADC #$40
C - - - - - 0x002940 00:E930: 9D 02 03  STA ram_0302,X
C - - - - - 0x002943 00:E933: BD 01 03  LDA ram_0301,X
C - - - - - 0x002946 00:E936: 69 00     ADC #$00
C - - - - - 0x002948 00:E938: 9D 01 03  STA ram_0301,X
...
C - - - - - 0x002961 00:E951: 20 4A EA  JSR sub_EA4A
C - - - - - 0x002964 00:E954: 9D 0A 03  STA ram_030A,X
C - - - - - 0x002967 00:E957: 98        TYA
C - - - - - 0x002968 00:E958: 9D 09 03  STA ram_0309,X
...
C - - - - - 0x0029B0 00:E9A0: BD CB E8  LDA tbl_E8CC - 1,X
...
loc_E9CE:
C D 3 - - - 0x0029DE 00:E9CE: B9 60 03  LDA ram_0360,Y
C - - - - - 0x0029E1 00:E9D1: 19 65 03  ORA ram_0365,Y
...
C - - - - - 0x0029ED 00:E9DD: BD 60 03  LDA ram_0360,X
C - - - - - 0x0029F0 00:E9E0: F0 44     BEQ bra_EA26
C - - - - - 0x0029F2 00:E9E2: DE 60 03  DEC ram_0360,X
...
bra_EA14:
C - - - - - 0x002A24 00:EA14: 20 97 EA  JSR sub_EA97
bra_EA17:
C - - - - - 0x002A27 00:EA17: 20 4A EA  JSR sub_EA4A
...
C - - - - - 0x002A41 00:EA31: A9 08     LDA #con_sfx_1_08
C - - - - - 0x002A43 00:EA33: 85 FE     STA ram_sfx_1
loc_EA35:
...
C - - - - - 0x002A50 00:EA40: 86 45     STX ram_0045
bra_EA42:
C - - - - - 0x002A52 00:EA42: EE A3 03  INC ram_03A3
C - - - - - 0x002A55 00:EA45: A9 40     LDA #$40
C - - - - - 0x002A57 00:EA47: 85 34     STA ram_0034
bra_EA49_RTS:
...
C - - - - - 0x002A63 00:EA53: D0 F7     BNE bra_EA4C_loop
...
C - - - - - 0x002A7A 00:EA6A: 9D 05 03  STA ram_0305,X
C - - - - - 0x002A7D 00:EA6D: 60        RTS
bra_EA6E:
C - - - - - 0x002A7E 00:EA6E: 20 55 EA  JSR sub_EA55
C - - - - - 0x002A81 00:EA71: 20 4A EA  JSR sub_EA4A
C - - - - - 0x002A84 00:EA74: 9D 05 03  STA ram_0305,X
C - - - - - 0x002A87 00:EA77: 98        TYA
C - - - - - 0x002A88 00:EA78: F0 03     BEQ bra_EA7D_RTS
C - - - - - 0x002A8A 00:EA7A: 9D 04 03  STA ram_0304,X
bra_EA7D_RTS:
C - - - - - 0x002A8D 00:EA7D: 60        RTS
bra_EA7E:
C - - - - - 0x002A8E 00:EA7E: 20 97 EA  JSR sub_EA97
C - - - - - 0x002A91 00:EA81: 20 4A EA  JSR sub_EA4A
C - - - - - 0x002A94 00:EA84: 9D 06 03  STA ram_0306,X
C - - - - - 0x002A97 00:EA87: 98        TYA
C - - - - - 0x002A98 00:EA88: F0 03     BEQ bra_EA8D_RTS
C - - - - - 0x002A9A 00:EA8A: 9D 05 03  STA ram_0305,X
bra_EA8D_RTS:
...
sub_EA8E:
C - - - - - 0x002A9E 00:EA8E: A4 56     LDY ram_0056
...
sub_EA97:
C - - - - - 0x002AA7 00:EA97: A4 59     LDY ram_mountain
C - - - - - 0x002AA9 00:EA99: C8        INY
C - - - - - 0x002AAA 00:EA9A: 98        TYA
C - - - - - 0x002AAB 00:EA9B: C9 21     CMP #$21
C - - - - - 0x002AAD 00:EA9D: 90 02     BCC bra_EAA1_RTS
...
tbl_EAA2:
- D 3 - - - 0x002AB2 00:EAA2: 00        .byte $00   ; 01
- D 3 - - - 0x002AB3 00:EAA3: 24        .byte $24   ; 02
- D 3 - - - 0x002AB4 00:EAA4: 60        .byte $60   ; 03
- D 3 - - - 0x002AB5 00:EAA5: 40        .byte $40   ; 04
- D 3 - - - 0x002AB6 00:EAA6: 70        .byte $70   ; 05
- D 3 - - - 0x002AB7 00:EAA7: 88        .byte $88   ; 06
- - - - - - 0x002AB8 00:EAA8: A0        .byte $A0   ; 07
- D 3 - - - 0x002AB9 00:EAA9: 80        .byte $80   ; 08
- D 3 - - - 0x002ABA 00:EAAA: 98        .byte $98   ; 09
- - - - - - 0x002ABB 00:EAAB: B0        .byte $B0   ; 0A
- D 3 - - - 0x002ABC 00:EAAC: 1C        .byte $1C   ; 0B
- D 3 - - - 0x002ABD 00:EAAD: 20        .byte $20   ; 0C
- D 3 - - - 0x002ABE 00:EAAE: E0        .byte $E0   ; 0D
- D 3 - - - 0x002ABF 00:EAAF: 40        .byte $40   ; 0E
- D 3 - - - 0x002AC0 00:EAB0: 60        .byte $60   ; 0F
- D 3 - - - 0x002AC1 00:EAB1: 70        .byte $70   ; 10
- D 3 - - - 0x002AC2 00:EAB2: 80        .byte $80   ; 11
- D 3 - - - 0x002AC3 00:EAB3: 90        .byte $90   ; 12
- D 3 - - - 0x002AC4 00:EAB4: A0        .byte $A0   ; 13
- D 3 - - - 0x002AC5 00:EAB5: B0        .byte $B0   ; 14
- D 3 - - - 0x002AC6 00:EAB6: 5C        .byte $5C   ; 15
- D 3 - - - 0x002AC7 00:EAB7: 6C        .byte $6C   ; 16
- - - - - - 0x002AC8 00:EAB8: 7C        .byte $7C   ; 17
- D 3 - - - 0x002AC9 00:EAB9: 40        .byte $40   ; 18
- D 3 - - - 0x002ACA 00:EABA: 48        .byte $48   ; 19
- D 3 - - - 0x002ACB 00:EABB: 50        .byte $50   ; 1A
- D 3 - - - 0x002ACC 00:EABC: 1C        .byte $1C   ; 1B
- D 3 - - - 0x002ACD 00:EABD: 20        .byte $20   ; 1C
- D 3 - - - 0x002ACE 00:EABE: 00        .byte $00   ; 1D
- D 3 - - - 0x002ACF 00:EABF: 20        .byte $20   ; 1E
...
C - - - - - 0x002B0E 00:EAFE: B9 A1 EA  LDA tbl_EAA2 - 1,Y
C - - - - - 0x002B11 00:EB01: 85 04     STA ram_0004
C - - - - - 0x002B13 00:EB03: B9 BF EA  LDA tbl_EAC0_attributes - 1,Y
...
C - - - - - 0x002B1E 00:EB0E: B9 DD EA  LDA tbl_EADE - 1,Y
...
bra_EB30_loop:
C - - - - - 0x002B40 00:EB30: BD E8 03  LDA ram_03E8,X
...
C - - - - - 0x002B52 00:EB42: B5 9C     LDA ram_009C,X
C - - - - - 0x002B54 00:EB44: 85 00     STA ram_0000
C - - - - - 0x002B56 00:EB46: B5 A7     LDA ram_00A7,X
C - - - - - 0x002B58 00:EB48: 85 01     STA ram_0001
C - - - - - 0x002B5A 00:EB4A: BD DD 03  LDA ram_03DD,X
C - - - - - 0x002B5D 00:EB4D: 85 02     STA ram_0002
C - - - - - 0x002B5F 00:EB4F: B5 BD     LDA ram_00BD,X
...
C - - - - - 0x002B75 00:EB65: 9D E8 03  STA ram_03E8,X
bra_EB68:
...
C - - - - - 0x002B7E 00:EB6E: 95 91     STA ram_0091,X
C - - - - - 0x002B80 00:EB70: 8A        TXA
C - - - - - 0x002B81 00:EB71: 48        PHA
C - - - - - 0x002B82 00:EB72: B9 13 EB  LDA tbl_EB14 - 1,Y
C - - - - - 0x002B85 00:EB75: AA        TAX
C - - - - - 0x002B86 00:EB76: B9 A1 EA  LDA tbl_EAA2 - 1,Y
C - - - - - 0x002B89 00:EB79: 20 21 C8  JSR sub_C821
...
C - - - - - 0x002B96 00:EB86: F0 E3     BEQ bra_EB6B_RTS
C - - - - - 0x002B98 00:EB88: A2 01     LDX #$01
sub_EB8A:
C - - - - - 0x002B9A 00:EB8A: B5 5A     LDA ram_005A,X
C - - - - - 0x002B9C 00:EB8C: D0 DD     BNE bra_EB6B_RTS
C - - - - - 0x002B9E 00:EB8E: B5 20     LDA ram_lives,X
...
C - - - - - 0x002BAC 00:EB9C: BD A2 EA  LDA tbl_EAA2,X
C - - - - - 0x002BAF 00:EB9F: A2 06     LDX #$06
C - - - - - 0x002BB1 00:EBA1: 20 21 C8  JSR sub_C821
C - - - - - 0x002BB4 00:EBA4: 68        PLA
C - - - - - 0x002BB5 00:EBA5: AA        TAX
C - - - - - 0x002BB6 00:EBA6: B5 3F     LDA ram_003F,X
C - - - - - 0x002BB8 00:EBA8: D0 C1     BNE bra_EB6B_RTS
C - - - - - 0x002BBA 00:EBAA: 20 EB CF  JSR sub_CFEB
C - - - - - 0x002BBD 00:EBAD: 95 E0     STA ram_00E0,X
C - - - - - 0x002BBF 00:EBAF: 95 80     STA ram_0080,X
C - - - - - 0x002BC1 00:EBB1: 95 86     STA ram_0086,X
C - - - - - 0x002BC3 00:EBB3: A9 00     LDA #$00
C - - - - - 0x002BC5 00:EBB5: 95 2F     STA ram_002F,X
...
C - - - - - 0x002BCE 00:EBBE: BD 82 03  LDA ram_0382,X
...
C - - - - - 0x002BF2 00:EBE2: B0 EF     BCS bra_EBD3
C - - - - - 0x002BF4 00:EBE4: 69 03     ADC #$03
C - - - - - 0x002BF6 00:EBE6: 4C D3 EB  JMP loc_EBD3
bra_EBE9:
C - - - - - 0x002BF9 00:EBE9: 95 5A     STA ram_005A,X
...
C - - - - - 0x002C03 00:EBF3: B5 5A     LDA ram_005A,X
...
C - - - - - 0x002C20 00:EC10: 90 EC     BCC bra_EBFE
bra_EC12:
...
C - - - - - 0x002C2B 00:EC1B: 95 2D     STA ram_002D,X
...
sub_EC2A:
C - - - - - 0x002C3A 00:EC2A: B5 2D     LDA ram_002D,X
C - - - - - 0x002C3C 00:EC2C: F0 22     BEQ bra_EC50_RTS
C - - - - - 0x002C3E 00:EC2E: B5 20     LDA ram_lives,X
...
bra_EC53_loop:
C - - - - - 0x002C63 00:EC53: B5 91     LDA ram_0091,X
C - - - - - 0x002C65 00:EC55: F0 1D     BEQ bra_EC74
C - - - - - 0x002C67 00:EC57: B5 A7     LDA ram_00A7,X
...
C - - - - - 0x002C76 00:EC66: 95 A7     STA ram_00A7,X
...
C - - - - - 0x002C82 00:EC72: 95 91     STA ram_0091,X
bra_EC74:
C - - - - - 0x002C84 00:EC74: E0 02     CPX #$02
C - - - - - 0x002C86 00:EC76: B0 0A     BCS bra_EC82
C - - - - - 0x002C88 00:EC78: B5 5A     LDA ram_005A,X
...
C - - - - - 0x002C96 00:EC86: B5 AF     LDA ram_00AF,X
...
C - - - - - 0x002CA0 00:EC90: 95 AF     STA ram_00AF,X
bra_EC92:
...
bra_ECC1_loop:
C - - - - - 0x002CD1 00:ECC1: B5 20     LDA ram_lives,X
...
C - - - - - 0x002CE1 00:ECD1: C5 20     CMP ram_lives
C - - - - - 0x002CE3 00:ECD3: D0 33     BNE bra_ED08_RTS
C - - - - - 0x002CE5 00:ECD5: A4 58     LDY ram_game_mode
C - - - - - 0x002CE7 00:ECD7: F0 04     BEQ bra_ECDD
C - - - - - 0x002CE9 00:ECD9: C5 21     CMP ram_lives + 1
C - - - - - 0x002CEB 00:ECDB: D0 2B     BNE bra_ED08_RTS
bra_ECDD:
C - - - - - 0x002CED 00:ECDD: A4 43     LDY ram_0043
...
C - - - - - 0x002CF6 00:ECE6: 85 20     STA ram_lives
...
C - - - - - 0x002D14 00:ED04: 85 43     STA ram_0043
C - - - - - 0x002D16 00:ED06: D6 20     DEC ram_lives,X
bra_ED08_RTS:
ofs_003_ED08_03_RTS:
...
ofs_003_ED09_02:
C - - J - - 0x002D19 00:ED09: A4 43     LDY ram_0043
C - - - - - 0x002D1B 00:ED0B: 88        DEY
C - - - - - 0x002D1C 00:ED0C: D0 FA     BNE bra_ED08_RTS
C - - - - - 0x002D1E 00:ED0E: F0 04     BEQ bra_ED14    ; jmp
ofs_003_ED10_00:
C - - J - - 0x002D20 00:ED10: A9 01     LDA #$01
C - - - - - 0x002D22 00:ED12: 85 FC     STA ram_copy_music
bra_ED14:
C - - - - - 0x002D24 00:ED14: D6 20     DEC ram_lives,X
C - - - - - 0x002D26 00:ED16: 20 63 ED  JSR sub_ED63
bra_ED19_loop:
...
C - - - - - 0x002D37 00:ED27: 20 63 ED  JSR sub_ED63
...
C - - - - - 0x002D64 00:ED54: 20 63 ED  JSR sub_ED63
C - - - - - 0x002D67 00:ED57: B9 59 03  LDA ram_0359,Y
C - - - - - 0x002D6A 00:ED5A: 38        SEC
C - - - - - 0x002D6B 00:ED5B: E9 02     SBC #$02
C - - - - - 0x002D6D 00:ED5D: 99 59 03  STA ram_0359,Y
...
tbl_ED68:
- D 3 - - - 0x002D78 00:ED68: E8        .byte $E8   ; 00
- D 3 - - - 0x002D79 00:ED69: F4        .byte $F4   ; 01
...
C - - - - - 0x002D88 00:ED78: BD 68 ED  LDA tbl_ED68,X
C - - - - - 0x002D8B 00:ED7B: A2 03     LDX #$03
C - - - - - 0x002D8D 00:ED7D: 20 21 C8  JSR sub_C821
C - - - - - 0x002D90 00:ED80: 68        PLA
C - - - - - 0x002D91 00:ED81: 48        PHA
C - - - - - 0x002D92 00:ED82: AA        TAX
C - - - - - 0x002D93 00:ED83: B4 20     LDY ram_lives,X
...
; bzk garbage
- - - - - - 0x002DE0 00:EDD0: A5 5A     LDA ram_005A
- - - - - - 0x002DE2 00:EDD2: 2C        .byte $2C   ; BIT opcode
- - - - - - 0x002DE3 00:EDD3: A5 5B     LDA ram_005B
...
C - - - - - 0x002E23 00:EE13: BD E8 03  LDA ram_03E8,X
C - - - - - 0x002E26 00:EE16: 30 3C     BMI bra_EE54
C - - - - - 0x002E28 00:EE18: B5 91     LDA ram_0091,X
...
bra_EE31:
C - - - - - 0x002E41 00:EE31: B5 9C     LDA ram_009C,X
...
C - - - - - 0x002E51 00:EE41: 9D B1 03  STA ram_03B1,X
bra_EE44:
C - - - - - 0x002E54 00:EE44: 20 8E EF  JSR sub_EF8E
C - - - - - 0x002E57 00:EE47: 9D DD 03  STA ram_03DD,X
bra_EE4A:
loc_EE4A:
C D 3 - - - 0x002E5A 00:EE4A: 8A        TXA
C - - - - - 0x002E5B 00:EE4B: 18        CLC
C - - - - - 0x002E5C 00:EE4C: 69 03     ADC #$03
C - - - - - 0x002E5E 00:EE4E: 1D E8 03  ORA ram_03E8,X
C - - - - - 0x002E61 00:EE51: 9D E8 03  STA ram_03E8,X
bra_EE54:
...
C - - - - - 0x002E76 00:EE66: 9D 82 03  STA ram_0382,X
C - - - - - 0x002E79 00:EE69: FE D2 03  INC ram_03D2,X
C - - - - - 0x002E7C 00:EE6C: BD D2 03  LDA ram_03D2,X
...
bra_EF19:
- - - - - - 0x002F29 00:EF19: B5 9C     LDA ram_009C,X
- - - - - - 0x002F2B 00:EF1B: F0 A0     BEQ bra_EEBD
- - - - - - 0x002F2D 00:EF1D: 20 83 EF  JSR sub_EF83
- - - - - - 0x002F30 00:EF20: 90 18     BCC bra_EF3A
- - - - - - 0x002F32 00:EF22: BD B1 03  LDA ram_03B1,X
- - - - - - 0x002F35 00:EF25: A8        TAY
- - - - - - 0x002F36 00:EF26: B9 00 EE  LDA tbl_EE00,Y
- - - - - - 0x002F39 00:EF29: 18        CLC
- - - - - - 0x002F3A 00:EF2A: 75 A7     ADC ram_00A7,X
- - - - - - 0x002F3C 00:EF2C: 95 A7     STA ram_00A7,X
- - - - - - 0x002F3E 00:EF2E: FE B1 03  INC ram_03B1,X
- - - - - - 0x002F41 00:EF31: C0 0C     CPY #$0C
- - - - - - 0x002F43 00:EF33: D0 05     BNE bra_EF3A
- - - - - - 0x002F45 00:EF35: A9 00     LDA #$00
- - - - - - 0x002F47 00:EF37: 9D B1 03  STA ram_03B1,X
bra_EF3A:
- - - - - - 0x002F4A 00:EF3A: A9 98     LDA #$98
- - - - - - 0x002F4C 00:EF3C: 9D DD 03  STA ram_03DD,X
- - - - - - 0x002F4F 00:EF3F: 4C A2 EE  JMP loc_EEA2



sub_EF42:
C - - - - - 0x002F52 00:EF42: B5 9C     LDA ram_009C,X
...
sub_EF70:
C - - - - - 0x002F80 00:EF70: BD A6 03  LDA ram_03A6,X
C - - - - - 0x002F83 00:EF73: 18        CLC
C - - - - - 0x002F84 00:EF74: 7D C7 03  ADC ram_03C7,X
C - - - - - 0x002F87 00:EF77: 9D C7 03  STA ram_03C7,X
C - - - - - 0x002F8A 00:EF7A: 60        RTS



sub_EF7B:
C - - - - - 0x002F8B 00:EF7B: B5 BD     LDA ram_00BD,X
sub_EF7D:
loc_EF7D:
C D 3 - - - 0x002F8D 00:EF7D: 18        CLC
C - - - - - 0x002F8E 00:EF7E: 75 9C     ADC ram_009C,X
C - - - - - 0x002F90 00:EF80: 95 9C     STA ram_009C,X
C - - - - - 0x002F92 00:EF82: 60        RTS



sub_EF83:
C - - - - - 0x002F93 00:EF83: BD BC 03  LDA ram_03BC,X
C - - - - - 0x002F96 00:EF86: 18        CLC
C - - - - - 0x002F97 00:EF87: 7D D2 03  ADC ram_03D2,X
C - - - - - 0x002F9A 00:EF8A: 9D D2 03  STA ram_03D2,X
C - - - - - 0x002F9D 00:EF8D: 60        RTS



sub_EF8E:
C - - - - - 0x002F9E 00:EF8E: BD B1 03  LDA ram_03B1,X
C - - - - - 0x002FA1 00:EF91: 18        CLC
C - - - - - 0x002FA2 00:EF92: 7D E5 ED  ADC tbl_EDE6_offset - 1,X
...
tbl_EFE2:
- D 3 - - - 0x002FF2 00:EFE2: 18        .byte $18   ; 
- D 3 - - - 0x002FF3 00:EFE3: 30        .byte $30   ; 
...
sub_EFF3:
C - - - - - 0x003003 00:EFF3: B5 91     LDA ram_0091,X
...
C - - - - - 0x00300E 00:EFFE: BD A6 03  LDA ram_03A6,X
C - - - - - 0x003011 00:F001: C9 C0     CMP #$C0
C - - - - - 0x003013 00:F003: D0 10     BNE bra_F015
C - - - - - 0x003015 00:F005: A9 04     LDA #con_sfx_1_04
C - - - - - 0x003017 00:F007: 85 FE     STA ram_sfx_1
C - - - - - 0x003019 00:F009: 4A        LSR ; 02
C - - - - - 0x00301A 00:F00A: 95 91     STA ram_0091,X
C - - - - - 0x00301C 00:F00C: A9 00     LDA #$00
C - - - - - 0x00301E 00:F00E: 9D D2 03  STA ram_03D2,X
C - - - - - 0x003021 00:F011: 9D 82 03  STA ram_0382,X
bra_F014_RTS:
C - - - - - 0x003024 00:F014: 60        RTS
bra_F015:
C - - - - - 0x003025 00:F015: B5 B2     LDA ram_00B2,X
C - - - - - 0x003027 00:F017: 9D 86 03  STA ram_0386,X
C - - - - - 0x00302A 00:F01A: B5 BD     LDA ram_00BD,X
C - - - - - 0x00302C 00:F01C: 9D 82 03  STA ram_0382,X
C - - - - - 0x00302F 00:F01F: A9 C0     LDA #$C0
C - - - - - 0x003031 00:F021: 9D A6 03  STA ram_03A6,X
C - - - - - 0x003034 00:F024: BD E0 EF  LDA tbl_EFE2 - 2,X
C - - - - - 0x003037 00:F027: 95 48     STA ram_0048,X
...
C - - - - - 0x00307E 00:F06E: A5 19     LDA ram_0019
...
C - - - - - 0x0030B3 00:F0A3: 95 B2     STA ram_00B2,X
C - - - - - 0x0030B5 00:F0A5: A9 FF     LDA #$FF
C - - - - - 0x0030B7 00:F0A7: 95 91     STA ram_0091,X
; !!!
C D 3 - - - 0x0030B9 00:F0A9: 9D D2 03  STA ram_03D2,X
C - - - - - 0x0030BC 00:F0AC: A5 56     LDA ram_0056
C - - - - - 0x0030BE 00:F0AE: 29 07     AND #$07
C - - - - - 0x0030C0 00:F0B0: A8        TAY
C - - - - - 0x0030C1 00:F0B1: B9 E4 EF  LDA tbl_EFE4,Y
C - - - - - 0x0030C4 00:F0B4: 9D A6 03  STA ram_03A6,X
C - - - - - 0x0030C7 00:F0B7: A9 40     LDA #$40
C - - - - - 0x0030C9 00:F0B9: 9D BC 03  STA ram_03BC,X
C - - - - - 0x0030CC 00:F0BC: B5 B2     LDA ram_00B2,X
C - - - - - 0x0030CE 00:F0BE: 20 D5 ED  JSR sub_EDD5
C - - - - - 0x0030D1 00:F0C1: 95 A7     STA ram_00A7,X
C - - - - - 0x0030D3 00:F0C3: BD E0 EF  LDA tbl_EFE2 - 2,X
C - - - - - 0x0030D6 00:F0C6: 95 48     STA ram_0048,X
bra_F0C8_RTS:
...
loc_F0C9:
C D 3 - - - 0x0030D9 00:F0C9: 95 BD     STA ram_00BD,X
C - - - - - 0x0030DB 00:F0CB: 95 9C     STA ram_009C,X
C - - - - - 0x0030DD 00:F0CD: A9 00     LDA #$00
C - - - - - 0x0030DF 00:F0CF: 9D 82 03  STA ram_0382,X
C - - - - - 0x0030E2 00:F0D2: 85 00     STA ram_0000
C - - - - - 0x0030E4 00:F0D4: BD 86 03  LDA ram_0386,X
C - - - - - 0x0030E7 00:F0D7: 20 75 F0  JSR sub_F075
C - - - - - 0x0030EA 00:F0DA: 8A        TXA
C - - - - - 0x0030EB 00:F0DB: 48        PHA
bra_F0DC_loop:
C - - - - - 0x0030EC 00:F0DC: B5 91     LDA ram_0091,X
C - - - - - 0x0030EE 00:F0DE: 95 94     STA ram_0094,X
C - - - - - 0x0030F0 00:F0E0: BD A6 03  LDA ram_03A6,X
C - - - - - 0x0030F3 00:F0E3: 9D A9 03  STA ram_03A9,X
...
C - - - - - 0x003103 00:F0F3: B4 BD     LDY ram_00BD,X
C - - - - - 0x003105 00:F0F5: 10 02     BPL bra_F0F9
C - - - - - 0x003107 00:F0F7: A9 FA     LDA #$FA
bra_F0F9:
C - - - - - 0x003109 00:F0F9: 18        CLC
C - - - - - 0x00310A 00:F0FA: 75 9C     ADC ram_009C,X
C - - - - - 0x00310C 00:F0FC: 95 9F     STA ram_009F,X
C - - - - - 0x00310E 00:F0FE: A9 00     LDA #$00
C - - - - - 0x003110 00:F100: 9D B4 03  STA ram_03B4,X
C - - - - - 0x003113 00:F103: 9D BF 03  STA ram_03BF,X
...
C - - - - - 0x00311D 00:F10D: A5 59     LDA ram_mountain
C - - - - - 0x00311F 00:F10F: C9 20     CMP #$20
C - - - - - 0x003121 00:F111: B0 09     BCS bra_F11C
C - - - - - 0x003123 00:F113: A6 56     LDX ram_0056
...
C - - - - - 0x003132 00:F122: 9D F0 03  STA ram_03F0,X
C - - - - - 0x003135 00:F125: B5 C5     LDA ram_00C5,X
C - - - - - 0x003137 00:F127: 69 60     ADC #$60
C - - - - - 0x003139 00:F129: 95 C5     STA ram_00C5,X
C - - - - - 0x00313B 00:F12B: B5 99     LDA ram_0099,X
...
ofs_004_F148_00:
C - - J - - 0x003158 00:F148: DE CF 03  DEC ram_03CF,X
C - - - - - 0x00315B 00:F14B: D0 03     BNE bra_F150
C - - - - - 0x00315D 00:F14D: 20 AE F1  JSR sub_F1AE
bra_F150:
ofs_004_F150_03:
C - - - - - 0x003160 00:F150: A9 00     LDA #$00
C - - - - - 0x003162 00:F152: 9D F0 03  STA ram_03F0,X
C - - - - - 0x003165 00:F155: 60        RTS



ofs_004_F156_02:
C - - J - - 0x003166 00:F156: DE DA 03  DEC ram_03DA,X
C - - - - - 0x003169 00:F159: D0 08     BNE bra_F163
C - - - - - 0x00316B 00:F15B: A9 02     LDA #con_sfx_1_02
C - - - - - 0x00316D 00:F15D: 85 FE     STA ram_sfx_1
C - - - - - 0x00316F 00:F15F: A9 FF     LDA #$FF
C - - - - - 0x003171 00:F161: 95 99     STA ram_0099,X
bra_F163:
...
C - - - - - 0x00317F 00:F16F: 79 88 07  ADC ram_0788,Y
C - - - - - 0x003182 00:F172: 95 A4     STA ram_00A4,X
bra_F174:
C - - - - - 0x003184 00:F174: BD DA 03  LDA ram_03DA,X
...
C - - - - - 0x003190 00:F180: 9D E5 03  STA ram_03E5,X
C - - - - - 0x003193 00:F183: B5 AF     LDA ram_00AF,X
C - - - - - 0x003195 00:F185: 29 F8     AND #$F8
C - - - - - 0x003197 00:F187: 95 AF     STA ram_00AF,X
...
C - - - - - 0x00319F 00:F18F: 20 15 F2  JSR sub_F215
C - - - - - 0x0031A2 00:F192: C9 F0     CMP #$F0
C - - - - - 0x0031A4 00:F194: 90 F6     BCC bra_F18C_RTS
bra_F196:
ofs_004_F196_01:
C - - J - - 0x0031A6 00:F196: BD F0 03  LDA ram_03F0,X
C - - - - - 0x0031A9 00:F199: 09 80     ORA #$80
C - - - - - 0x0031AB 00:F19B: 9D F0 03  STA ram_03F0,X
sub_F19E:
C - - - - - 0x0031AE 00:F19E: 20 AB F7  JSR sub_F7AB
C - - - - - 0x0031B1 00:F1A1: 0A        ASL
C - - - - - 0x0031B2 00:F1A2: 0A        ASL
C - - - - - 0x0031B3 00:F1A3: 9D CF 03  STA ram_03CF,X
C - - - - - 0x0031B6 00:F1A6: A9 00     LDA #$00
C - - - - - 0x0031B8 00:F1A8: 9D DA 03  STA ram_03DA,X
...
sub_F1AE:
C - - - - - 0x0031BE 00:F1AE: A5 92     LDA ram_0092
C - - - - - 0x0031C0 00:F1B0: 05 7C     ORA ram_007C
C - - - - - 0x0031C2 00:F1B2: D0 E2     BNE bra_F196
C - - - - - 0x0031C4 00:F1B4: B5 18     LDA ram_0018,X
...
bra_F1C5:
C - - - - - 0x0031D5 00:F1C5: C5 A4     CMP ram_00A4
C - - - - - 0x0031D7 00:F1C7: F0 54     BEQ bra_F21D
C - - - - - 0x0031D9 00:F1C9: C5 A5     CMP ram_00A5
C - - - - - 0x0031DB 00:F1CB: F0 50     BEQ bra_F21D
C - - - - - 0x0031DD 00:F1CD: C5 A6     CMP ram_00A6
C - - - - - 0x0031DF 00:F1CF: F0 4C     BEQ bra_F21D
C - - - - - 0x0031E1 00:F1D1: 95 A4     STA ram_00A4,X
...
C - - - - - 0x0031EF 00:F1DF: A9 20     LDA #$20
...
C - - - - - 0x0031F9 00:F1E9: 95 AF     STA ram_00AF,X
C - - - - - 0x0031FB 00:F1EB: C8        INY
C - - - - - 0x0031FC 00:F1EC: 98        TYA
C - - - - - 0x0031FD 00:F1ED: 95 BA     STA ram_00BA,X
C - - - - - 0x0031FF 00:F1EF: A9 02     LDA #$02
C - - - - - 0x003201 00:F1F1: 95 99     STA ram_0099,X
sub_F1F3:
...
C - - - - - 0x00320A 00:F1FA: B5 A4     LDA ram_00A4,X
C - - - - - 0x00320C 00:F1FC: 85 0E     STA ram_000E
C - - - - - 0x00320E 00:F1FE: B5 BA     LDA ram_00BA,X
...
C - - - - - 0x003222 00:F212: B9 AB F1  LDA tbl_F1AC - 1,Y
sub_F215:
C - - - - - 0x003225 00:F215: 18        CLC
C - - - - - 0x003226 00:F216: 75 AF     ADC ram_00AF,X
C - - - - - 0x003228 00:F218: 95 AF     STA ram_00AF,X
...
C - - - - - 0x00322F 00:F21F: 95 99     STA ram_0099,X
bra_F221_RTS:
...
C - - - - - 0x003234 00:F224: B5 BA     LDA ram_00BA,X
bra_F226_loop:
C - - - - - 0x003236 00:F226: D9 86 07  CMP ram_0786,Y
...
C - - - - - 0x0032FE 00:F2EE: 0D 00 03  ORA ram_0300
...
bra_F309_loop:
C - - - - - 0x003319 00:F309: 9D 68 06  STA ram_0668,X
...
C - - - - - 0x00332F 00:F31F: A5 59     LDA ram_mountain
...
C - - - - - 0x003361 00:F351: 99 05 03  STA ram_0305,Y
...
bra_F362_loop:
C - - - - - 0x003372 00:F362: 99 04 03  STA ram_0304,Y
C - - - - - 0x003375 00:F365: 88        DEY
C - - - - - 0x003376 00:F366: 10 FA     BPL bra_F362_loop
C - - - - - 0x003378 00:F368: A9 23     LDA #$23
C - - - - - 0x00337A 00:F36A: 8D 00 03  STA ram_0300
C - - - - - 0x00337D 00:F36D: AD 49 03  LDA ram_0349
C - - - - - 0x003380 00:F370: 8D 01 03  STA ram_0301
C - - - - - 0x003383 00:F373: AD 48 03  LDA ram_0348
C - - - - - 0x003386 00:F376: 8D 02 03  STA ram_0302
C - - - - - 0x003389 00:F379: A9 20     LDA #$20
C - - - - - 0x00338B 00:F37B: 8D 03 03  STA ram_0303
C - - - - - 0x00338E 00:F37E: A9 00     LDA #$00
C - - - - - 0x003390 00:F380: 8D 24 03  STA ram_0324
...
C - - - - - 0x0033A3 00:F393: B0 F8     BCS bra_F38D_loop
bra_F395:
...
C - - - - - 0x0033D8 00:F3C8: 99 04 03  STA ram_0304,Y
C - - - - - 0x0033DB 00:F3CB: 99 05 03  STA ram_0305,Y
C - - - - - 0x0033DE 00:F3CE: 99 06 03  STA ram_0306,Y
bra_F3D1_RTS:
...
bra_F3F8_loop:
C - - - - - 0x003408 00:F3F8: 99 04 03  STA ram_0304,Y
...
C - - - - - 0x003418 00:F408: 99 68 06  STA ram_0668,Y
...
C - - - - - 0x003422 00:F412: 99 86 06  STA ram_0686,Y
...
C - - - - - 0x00342E 00:F41E: 99 C2 06  STA ram_06C2,Y
...
bra_F42A:
C - - - - - 0x00343A 00:F42A: 99 E0 06  STA ram_06E0,Y
...
C - - - - - 0x00344F 00:F43F: AD 48 03  LDA ram_0348
C - - - - - 0x003452 00:F442: 38        SEC
C - - - - - 0x003453 00:F443: E9 20     SBC #$20
C - - - - - 0x003455 00:F445: 8D 48 03  STA ram_0348
C - - - - - 0x003458 00:F448: AD 49 03  LDA ram_0349
C - - - - - 0x00345B 00:F44B: E9 00     SBC #$00
C - - - - - 0x00345D 00:F44D: 8D 49 03  STA ram_0349
...
C - - - - - 0x003468 00:F458: A9 23     LDA #$23
C - - - - - 0x00346A 00:F45A: 2C        .byte $2C   ; BIT opcode
bra_F45B:
sub_F45B:
C - - - - - 0x00346B 00:F45B: A9 2B     LDA #$2B
C - - - - - 0x00346D 00:F45D: 8D 49 03  STA ram_0349
C - - - - - 0x003470 00:F460: A9 A0     LDA #$A0
C - - - - - 0x003472 00:F462: 8D 48 03  STA ram_0348
bra_F465_RTS:
...
C - - - - - 0x003483 00:F473: A5 84     LDA ram_0084
C - - - - - 0x003485 00:F475: D0 22     BNE bra_F499_loop
bra_F477_loop:
C - - - - - 0x003487 00:F477: A0 00     LDY #$00
C - - - - - 0x003489 00:F479: 94 6C     STY ram_006C,X
C - - - - - 0x00348B 00:F47B: C8        INY
C - - - - - 0x00348C 00:F47C: 94 E4     STY ram_00E4,X
C - - - - - 0x00348E 00:F47E: C8        INY
C - - - - - 0x00348F 00:F47F: 94 6A     STY ram_006A,X
C - - - - - 0x003491 00:F481: A9 F0     LDA #$F0
C - - - - - 0x003493 00:F483: 95 E2     STA ram_00E2,X
...
C - - - - - 0x0034A2 00:F492: 95 69     STA ram_0069,X
bra_F494:
C - - - - - 0x0034A4 00:F494: E6 84     INC ram_0084
C - - - - - 0x0034A6 00:F496: 4C 3B F6  JMP loc_F63B
bra_F499_loop:
C - - - - - 0x0034A9 00:F499: B5 37     LDA ram_0037,X
...
C - - - - - 0x0034B4 00:F4A4: B5 6A     LDA ram_006A,X
C - - - - - 0x0034B6 00:F4A6: 15 6C     ORA ram_006C,X
...
C - - - - - 0x0034C3 00:F4B3: A9 04     LDA #con_sfx_2_04
C - - - - - 0x0034C5 00:F4B5: 85 FF     STA ram_sfx_2
bra_F4B7:
C - - - - - 0x0034C7 00:F4B7: A9 00     LDA #$00
C - - - - - 0x0034C9 00:F4B9: 95 2F     STA ram_002F,X
...
sub_F504:
C - - - - - 0x003514 00:F504: B4 6A     LDY ram_006A,X
C - - - - - 0x003516 00:F506: B9 6C F4  LDA tbl_F46C,Y
C - - - - - 0x003519 00:F509: 95 37     STA ram_0037,X
C - - - - - 0x00351B 00:F50B: B5 6C     LDA ram_006C,X
C - - - - - 0x00351D 00:F50D: 49 01     EOR #$01
C - - - - - 0x00351F 00:F50F: 95 6C     STA ram_006C,X
C - - - - - 0x003521 00:F511: D0 04     BNE bra_F517
C - - - - - 0x003523 00:F513: A9 08     LDA #con_sfx_2_08
C - - - - - 0x003525 00:F515: 85 FF     STA ram_sfx_2
bra_F517:
C - - - - - 0x003527 00:F517: A9 00     LDA #$00
C - - - - - 0x003529 00:F519: 95 E0     STA ram_00E0,X
C - - - - - 0x00352B 00:F51B: 60        RTS



tbl_F51C:
- D 3 - - - 0x00352C 00:F51C: 20        .byte $20   ; 01
- D 3 - - - 0x00352D 00:F51D: 89        .byte $89   ; 02
...
C - - - - - 0x003538 00:F528: BC 1B F5  LDY tbl_F51C - 1,X
C - - - - - 0x00353B 00:F52B: A2 05     LDX #$05
bra_F52D_loop:
C - - - - - 0x00353D 00:F52D: BD 1E F5  LDA tbl_F51E,X
C - - - - - 0x003540 00:F530: 99 00 04  STA ram_0400,Y
...
sub_F53E:
C - - - - - 0x00354E 00:F53E: A4 59     LDY ram_mountain
...
C - - - - - 0x003560 00:F550: A4 37     LDY ram_0037
C - - - - - 0x003562 00:F552: D0 0E     BNE bra_F562
C - - - - - 0x003564 00:F554: 85 59     STA ram_mountain
C - - - - - 0x003566 00:F556: A9 80     LDA #$80
C - - - - - 0x003568 00:F558: 85 4E     STA ram_spawn_timer_lo_bird
C - - - - - 0x00356A 00:F55A: A9 08     LDA #con_sfx_1_08
C - - - - - 0x00356C 00:F55C: 85 FE     STA ram_sfx_1
C - - - - - 0x00356E 00:F55E: A9 0F     LDA #$0F
bra_F560:
C - - - - - 0x003570 00:F560: 85 37     STA ram_0037
bra_F562:
...
C - - - - - 0x003579 00:F569: 9D 01 03  STA ram_0301,X
C - - - - - 0x00357C 00:F56C: 88        DEY
C - - - - - 0x00357D 00:F56D: CA        DEX
C - - - - - 0x00357E 00:F56E: 10 F6     BPL bra_F566_loop
C - - - - - 0x003580 00:F570: E8        INX
C - - - - - 0x003581 00:F571: 8E 06 03  STX ram_0306
C - - - - - 0x003584 00:F574: A4 59     LDY ram_mountain
C - - - - - 0x003586 00:F576: C8        INY
C - - - - - 0x003587 00:F577: 98        TYA
C - - - - - 0x003588 00:F578: 20 4A EA  JSR sub_EA4A
C - - - - - 0x00358B 00:F57B: 8C 04 03  STY ram_0304
C - - - - - 0x00358E 00:F57E: 8D 05 03  STA ram_0305
...
C - - - - - 0x00359C 00:F58C: 8D 01 03  STA ram_0301
C - - - - - 0x00359F 00:F58F: A9 48     LDA #$48
C - - - - - 0x0035A1 00:F591: 18        CLC
C - - - - - 0x0035A2 00:F592: 7D 83 F5  ADC tbl_F584 - 1,X
C - - - - - 0x0035A5 00:F595: 8D 02 03  STA ram_0302
C - - - - - 0x0035A8 00:F598: A9 05     LDA #$05
C - - - - - 0x0035AA 00:F59A: 8D 03 03  STA ram_0303
C - - - - - 0x0035AD 00:F59D: 20 55 EA  JSR sub_EA55
C - - - - - 0x0035B0 00:F5A0: A6 1E     LDX ram_001E
C - - - - - 0x0035B2 00:F5A2: BC 81 F5  LDY tbl_F582 - 1,X
C - - - - - 0x0035B5 00:F5A5: 99 60 03  STA ram_0360,Y
C - - - - - 0x0035B8 00:F5A8: 20 4A EA  JSR sub_EA4A
C - - - - - 0x0035BB 00:F5AB: C0 00     CPY #$00
C - - - - - 0x0035BD 00:F5AD: D0 02     BNE bra_F5B1
C - - - - - 0x0035BF 00:F5AF: A0 38     LDY #$38
bra_F5B1:
C - - - - - 0x0035C1 00:F5B1: 8C 04 03  STY ram_0304
C - - - - - 0x0035C4 00:F5B4: 8D 05 03  STA ram_0305
C - - - - - 0x0035C7 00:F5B7: A2 03     LDX #$03
C - - - - - 0x0035C9 00:F5B9: A9 00     LDA #$00
bra_F5BB_loop:
C - - - - - 0x0035CB 00:F5BB: 9D 06 03  STA ram_0306,X
...
sub_F630:
C - - - - - 0x003640 00:F630: A5 D5     LDA ram_00D5
...
loc_F63B:
sub_F63B:
C D 3 - - - 0x00364B 00:F63B: A5 56     LDA ram_0056
bra_F63D_loop:
...
C - - - - - 0x00367C 00:F66C: AE 00 03  LDX ram_0300
C - - - - - 0x00367F 00:F66F: A0 00     LDY #$00
bra_F671_loop:
C - - - - - 0x003681 00:F671: B9 09 F6  LDA tbl_F609,Y
C - - - - - 0x003684 00:F674: 9D 01 03  STA ram_0301,X
...
C - - - - - 0x0036AB 00:F69B: AC 00 03  LDY ram_0300
C - - - - - 0x0036AE 00:F69E: 99 02 03  STA ram_0302,Y
...
sub_F6A4:
C - - - - - 0x0036B4 00:F6A4: A5 3B     LDA ram_003B
...
C - - - - - 0x0036E0 00:F6D0: 8D 06 03  STA ram_0306
C - - - - - 0x0036E3 00:F6D3: 8D 0D 03  STA ram_030D
C - - - - - 0x0036E6 00:F6D6: A9 06     LDA #$06
C - - - - - 0x0036E8 00:F6D8: 85 3B     STA ram_003B
bra_F6DA_RTS:
C - - - - - 0x0036EA 00:F6DA: 60        RTS
bra_F6DB:
C - - - - - 0x0036EB 00:F6DB: 85 1E     STA ram_001E
C - - - - - 0x0036ED 00:F6DD: A9 06     LDA #$06
C - - - - - 0x0036EF 00:F6DF: 85 6A     STA ram_006A
C - - - - - 0x0036F1 00:F6E1: A9 0A     LDA #$0A
C - - - - - 0x0036F3 00:F6E3: 85 4D     STA ram_004D
...
C - - - - - 0x003706 00:F6F6: 95 91     STA ram_0091,X
C - - - - - 0x003708 00:F6F8: E0 04     CPX #$04
C - - - - - 0x00370A 00:F6FA: B0 1D     BCS bra_F719
C - - - - - 0x00370C 00:F6FC: BD EE F6  LDA tbl_F6EE,X
C - - - - - 0x00370F 00:F6FF: 95 9F     STA ram_009F,X
C - - - - - 0x003711 00:F701: BD EA F6  LDA tbl_F6EA,X
C - - - - - 0x003714 00:F704: 95 AA     STA ram_00AA,X
C - - - - - 0x003716 00:F706: A9 FF     LDA #$FF
C - - - - - 0x003718 00:F708: 95 94     STA ram_0094,X
C - - - - - 0x00371A 00:F70A: 95 C0     STA ram_00C0,X
C - - - - - 0x00371C 00:F70C: AD FE 05  LDA ram_05FE
C - - - - - 0x00371F 00:F70F: 9D E0 03  STA ram_03E0,X
C - - - - - 0x003722 00:F712: 8A        TXA
C - - - - - 0x003723 00:F713: 18        CLC
C - - - - - 0x003724 00:F714: 69 4F     ADC #$4F
C - - - - - 0x003726 00:F716: 9D EB 03  STA ram_03EB,X
bra_F719:
...
bra_F71F_loop:
C - - - - - 0x00372F 00:F71F: B5 94     LDA ram_0094,X
...
C - - - - - 0x003739 00:F729: 9D EB 03  STA ram_03EB,X
bra_F72C:
...
C - - - - - 0x003768 00:F758: A5 D6     LDA ram_00D6
C - - - - - 0x00376A 00:F75A: 85 00     STA ram_0000
C - - - - - 0x00376C 00:F75C: A5 D7     LDA ram_00D7
...
C - - - - - 0x00377D 00:F76D: A5 D5     LDA ram_00D5
C - - - - - 0x00377F 00:F76F: D0 02     BNE bra_F773
C - - - - - 0x003781 00:F771: A2 51     LDX #$51
bra_F773:
bra_F773_loop:
C - - - - - 0x003783 00:F773: A5 D5     LDA ram_00D5
...
sub_F7AB:
C - - - - - 0x0037BB 00:F7AB: A5 56     LDA ram_0056
...
C - - - - - 0x0037C5 00:F7B5: 35 18     AND ram_0018,X
...
sub_F80C:
C - - - - - 0x00381C 00:F80C: A5 18     LDA ram_0018
C - - - - - 0x00381E 00:F80E: 29 03     AND #$03
C - - - - - 0x003820 00:F810: A8        TAY
C - - - - - 0x003821 00:F811: A9 20     LDA #$20
C - - - - - 0x003823 00:F813: 85 A7     STA ram_00A7
C - - - - - 0x003825 00:F815: B9 E8 F7  LDA tbl_F7E8,Y
C - - - - - 0x003828 00:F818: 85 9C     STA ram_009C
C - - - - - 0x00382A 00:F81A: B9 B8 F7  LDA tbl_F7B8,Y
C - - - - - 0x00382D 00:F81D: 8D BC 03  STA ram_03BC
C - - - - - 0x003830 00:F820: A9 00     LDA #$00
C - - - - - 0x003832 00:F822: 8D B1 03  STA ram_03B1
C - - - - - 0x003835 00:F825: 85 91     STA ram_0091
C - - - - - 0x003837 00:F827: A5 56     LDA ram_0056
...
C - - - - - 0x003844 00:F834: 8D A6 03  STA ram_03A6
...
C - - - - - 0x00384A 00:F83A: 8D E8 03  STA ram_03E8
C - - - - - 0x00384D 00:F83D: A5 91     LDA ram_0091
...
sub_F8AC:
C - - - - - 0x0038BC 00:F8AC: AC B1 03  LDY ram_03B1
C - - - - - 0x0038BF 00:F8AF: B9 EC F7  LDA tbl_F7EC,Y
C - - - - - 0x0038C2 00:F8B2: 48        PHA
C - - - - - 0x0038C3 00:F8B3: A5 B2     LDA ram_00B2
...
C - - - - - 0x0038D2 00:F8C2: A5 B2     LDA ram_00B2
C - - - - - 0x0038D4 00:F8C4: 29 02     AND #$02
C - - - - - 0x0038D6 00:F8C6: F0 03     BEQ bra_F8CB
C - - - - - 0x0038D8 00:F8C8: C6 A7     DEC ram_00A7
C - - - - - 0x0038DA 00:F8CA: 2C        .byte $2C   ; BIT opcode
bra_F8CB:
C - - - - - 0x0038DB 00:F8CB: E6 A7     INC ram_00A7
C - - - - - 0x0038DD 00:F8CD: A5 B2     LDA ram_00B2
C - - - - - 0x0038DF 00:F8CF: 29 04     AND #$04
C - - - - - 0x0038E1 00:F8D1: D0 04     BNE bra_F8D7
C - - - - - 0x0038E3 00:F8D3: EE B1 03  INC ram_03B1
C - - - - - 0x0038E6 00:F8D6: 60        RTS
bra_F8D7:
C - - - - - 0x0038E7 00:F8D7: CE B1 03  DEC ram_03B1
C - - - - - 0x0038EA 00:F8DA: 60        RTS



sub_F8DB:
C - - - - - 0x0038EB 00:F8DB: AD B1 03  LDA ram_03B1
C - - - - - 0x0038EE 00:F8DE: 29 1F     AND #$1F
C - - - - - 0x0038F0 00:F8E0: D0 12     BNE bra_F8F4
bra_F8E2:
C - - - - - 0x0038F2 00:F8E2: EE BC 03  INC ram_03BC
C - - - - - 0x0038F5 00:F8E5: AC BC 03  LDY ram_03BC
...
bra_F8F1:
C - - - - - 0x003901 00:F8F1: 8D B1 03  STA ram_03B1
bra_F8F4:
C - - - - - 0x003904 00:F8F4: A5 9C     LDA ram_009C
...
C - - - - - 0x00390E 00:F8FE: A5 A7     LDA ram_00A7
C - - - - - 0x003910 00:F900: C9 F0     CMP #$F0
C - - - - - 0x003912 00:F902: B0 0D     BCS bra_F911
C - - - - - 0x003914 00:F904: AC BC 03  LDY ram_03BC
C - - - - - 0x003917 00:F907: 30 D9     BMI bra_F8E2
...
C - - - - - 0x003926 00:F916: 85 91     STA ram_0091
C - - - - - 0x003928 00:F918: 68        PLA
bra_F919:
C - - - - - 0x003929 00:F919: 85 B2     STA ram_00B2
...
sub_F91E_sound_driver:
C - - - - - 0x00392E 00:F91E: A9 FF     LDA #$FF
C - - - - - 0x003930 00:F920: 8D 17 40  STA $4017
C - - - - - 0x003933 00:F923: 20 EB F9  JSR sub_F9EB_play_sfx_2
C - - - - - 0x003936 00:F926: 20 C4 FA  JSR sub_FAC4_play_sfx_1
C - - - - - 0x003939 00:F929: 20 A1 FB  JSR sub_FBA1_play_music
C - - - - - 0x00393C 00:F92C: 20 FC FB  JSR sub_FBFC_initialize_music
C - - - - - 0x00393F 00:F92F: A9 00     LDA #$00
C - - - - - 0x003941 00:F931: 85 FF     STA ram_sfx_2    ; con_sfx_2_00
C - - - - - 0x003943 00:F933: 85 FE     STA ram_sfx_1    ; con_sfx_1_00
C - - - - - 0x003945 00:F935: 85 FC     STA ram_copy_music
C - - - - - 0x003947 00:F937: 85 FB     STA ram_music_1    ; con_music_00
C - - - - - 0x003949 00:F939: AC 11 07  LDY ram_0711
C - - - - - 0x00394C 00:F93C: A5 F3     LDA ram_music_2
C - - - - - 0x00394E 00:F93E: 29 0C     AND #$0C
C - - - - - 0x003950 00:F940: F0 07     BEQ bra_F949
C - - - - - 0x003952 00:F942: EE 11 07  INC ram_0711
...
C - - - - - 0x00395C 00:F94C: CE 11 07  DEC ram_0711
bra_F94F:
...
C - - - - - 0x00399C 00:F98C: 65 F5     ADC ram_00F5
...
bra_F9AB_FF_01:
C - - - - - 0x0039BB 00:F9AB: 84 F0     STY ram_copy_sfx_2
...
bra_F9C8_FF_02:
C - - - - - 0x0039D8 00:F9C8: 84 F0     STY ram_copy_sfx_2
...
bra_FA0C_FF_04:
C - - - - - 0x003A1C 00:FA0C: 84 F0     STY ram_copy_sfx_2
...
C - - - - - 0x003A48 00:FA38: 85 F0     STA ram_copy_sfx_2
sub_FA3A:
...
bra_FA64_FE_01:
C D 3 - - - 0x003A74 00:FA64: 84 F1     STY ram_copy_sfx_1
C - - - - - 0x003A76 00:FA66: A9 30     LDA #$30
C - - - - - 0x003A78 00:FA68: 8D 12 07  STA ram_0712
bra_FA6B_F1_01:
C - - - - - 0x003A7B 00:FA6B: AD 12 07  LDA ram_0712
...
C - - - - - 0x003A87 00:FA77: B9 5F FA  LDA tbl_FA60 - 1,Y
...
bra_FAB5_F1_10:
loc_FAB5:
C D 3 - - - 0x003AC5 00:FAB5: CE 12 07  DEC ram_0712
C - - - - - 0x003AC8 00:FAB8: D0 09     BNE bra_FAC3_RTS
C - - - - - 0x003ACA 00:FABA: A9 00     LDA #$00
C - - - - - 0x003ACC 00:FABC: 85 F1     STA ram_copy_sfx_1
...
C - - - - - 0x003AF0 00:FAE0: 46 FE     LSR ram_sfx_1
C - - - - - 0x003AF2 00:FAE2: B0 15     BCS bra_FAF9_FE_08
C - - - - - 0x003AF4 00:FAE4: 46 FE     LSR ram_sfx_1
...
bra_FAEC_FE_04:
C - - - - - 0x003AFC 00:FAEC: 84 F1     STY ram_copy_sfx_1
C - - - - - 0x003AFE 00:FAEE: A9 20     LDA #$20
C - - - - - 0x003B00 00:FAF0: 8D 12 07  STA ram_0712
C - - - - - 0x003B03 00:FAF3: A9 18     LDA #$18
C - - - - - 0x003B05 00:FAF5: A0 B3     LDY #$B3
C - - - - - 0x003B07 00:FAF7: D0 83     BNE bra_FA7C
bra_FAF9_FE_08:
C - - - - - 0x003B09 00:FAF9: 84 F1     STY ram_copy_sfx_1
C - - - - - 0x003B0B 00:FAFB: A9 08     LDA #$08
C - - - - - 0x003B0D 00:FAFD: 8D 12 07  STA ram_0712
...
bra_FB09_F1_08:
C - - - - - 0x003B19 00:FB09: AD 12 07  LDA ram_0712
...
bra_FB17_FE_10:
C - - - - - 0x003B27 00:FB17: 84 F1     STY ram_copy_sfx_1
C - - - - - 0x003B29 00:FB19: A9 18     LDA #$18
C - - - - - 0x003B2B 00:FB1B: 8D 12 07  STA ram_0712
...
C - - - - - 0x003B3C 00:FB2C: AD 12 07  LDA ram_0712
...
bra_FB71_FC_01:
C - - - - - 0x003B81 00:FB71: 84 F2     STY ram_00F2
C - - - - - 0x003B83 00:FB73: A9 7F     LDA #$7F
C - - - - - 0x003B85 00:FB75: 8D 0E 07  STA ram_070E
bra_FB78_F2_01:
C - - - - - 0x003B88 00:FB78: AD 0E 07  LDA ram_070E
...
C - - - - - 0x003B93 00:FB83: AD 0E 07  LDA ram_070E
...
C - - - - - 0x003BA7 00:FB97: CE 0E 07  DEC ram_070E
C - - - - - 0x003BAA 00:FB9A: D0 04     BNE bra_FBA0_RTS
C - - - - - 0x003BAC 00:FB9C: A9 00     LDA #$00
C - - - - - 0x003BAE 00:FB9E: 85 F2     STA ram_00F2
bra_FBA0_RTS:
...
- - - - - - 0x003C1D 00:FC0D: 85 FD     STA ram_00FD
- - - - - - 0x003C1F 00:FC0F: A5 FB     LDA ram_music_1
bra_FC11:
C - - - - - 0x003C21 00:FC11: 85 F3     STA ram_music_2
C - - - - - 0x003C23 00:FC13: A0 00     LDY #$00
C - - - - - 0x003C25 00:FC15: 84 F8     STY ram_00F8
bra_FC17_loop:
C - - - - - 0x003C27 00:FC17: C8        INY
C - - - - - 0x003C28 00:FC18: 4A        LSR
C - - - - - 0x003C29 00:FC19: 90 FC     BCC bra_FC17_loop
C - - - - - 0x003C2B 00:FC1B: B9 21 FD  LDA tbl_FD22_offset - 1,Y
C - - - - - 0x003C2E 00:FC1E: A8        TAY
C - - - - - 0x003C2F 00:FC1F: B9 22 FD  LDA tbl_FD2A - 8,Y
C - - - - - 0x003C32 00:FC22: 85 F5     STA ram_00F5
C - - - - - 0x003C34 00:FC24: B9 23 FD  LDA tbl_FD2A - 7,Y
C - - - - - 0x003C37 00:FC27: 85 F6     STA ram_00F6
C - - - - - 0x003C39 00:FC29: B9 24 FD  LDA tbl_FD2A - 6,Y
C - - - - - 0x003C3C 00:FC2C: 85 F7     STA ram_00F7
C - - - - - 0x003C3E 00:FC2E: B9 25 FD  LDA tbl_FD2A - 5,Y
C - - - - - 0x003C41 00:FC31: 85 FA     STA ram_00FA
C - - - - - 0x003C43 00:FC33: B9 26 FD  LDA tbl_FD2A - 4,Y
C - - - - - 0x003C46 00:FC36: 85 F9     STA ram_00F9
C - - - - - 0x003C48 00:FC38: B9 27 FD  LDA tbl_FD2A - 3,Y
C - - - - - 0x003C4B 00:FC3B: 8D 05 07  STA ram_0705
C - - - - - 0x003C4E 00:FC3E: A9 01     LDA #$01
C - - - - - 0x003C50 00:FC40: 8D 01 07  STA ram_0701
C - - - - - 0x003C53 00:FC43: 8D 03 07  STA ram_0703
C - - - - - 0x003C56 00:FC46: 8D 04 07  STA ram_0704
C - - - - - 0x003C59 00:FC49: 8D 06 07  STA ram_0706
C - - - - - 0x003C5C 00:FC4C: A9 7F     LDA #$7F
C - - - - - 0x003C5E 00:FC4E: 8D 00 07  STA ram_0700
bra_FC51:
C - - - - - 0x003C61 00:FC51: CE 01 07  DEC ram_0701
C - - - - - 0x003C64 00:FC54: D0 56     BNE bra_FCAC
C - - - - - 0x003C66 00:FC56: A4 F8     LDY ram_00F8
C - - - - - 0x003C68 00:FC58: E6 F8     INC ram_00F8
C - - - - - 0x003C6A 00:FC5A: B1 F6     LDA (ram_00F6),Y
...
- - - - - - 0x003C74 00:FC64: A5 FD     LDA ram_00FD
...
C - - - - - 0x003C97 00:FC87: 8D 01 07  STA ram_0701
C - - - - - 0x003C9A 00:FC8A: A5 F1     LDA ram_copy_sfx_1
...
bra_FC99:
C - - - - - 0x003CA9 00:FC99: 8C 02 07  STY ram_0702
C - - - - - 0x003CAC 00:FC9C: A2 84     LDX #$84
C - - - - - 0x003CAE 00:FC9E: AD 01 07  LDA ram_0701
...
bra_FCAC:
C - - - - - 0x003CBC 00:FCAC: A5 F1     LDA ram_copy_sfx_1
...
C - - - - - 0x003CC6 00:FCB6: AC 02 07  LDY ram_0702
C - - - - - 0x003CC9 00:FCB9: F0 03     BEQ bra_FCBE
C - - - - - 0x003CCB 00:FCBB: CE 02 07  DEC ram_0702
bra_FCBE:
C - - - - - 0x003CCE 00:FCBE: B9 D9 FF  LDA tbl_FFD9,Y
C - - - - - 0x003CD1 00:FCC1: 8D 04 40  STA $4004
bra_FCC4:
C - - - - - 0x003CD4 00:FCC4: A4 F9     LDY ram_00F9
C - - - - - 0x003CD6 00:FCC6: F0 32     BEQ bra_FCFA
C - - - - - 0x003CD8 00:FCC8: CE 03 07  DEC ram_0703
C - - - - - 0x003CDB 00:FCCB: D0 2D     BNE bra_FCFA
bra_FCCD:
C - - - - - 0x003CDD 00:FCCD: A4 F9     LDY ram_00F9
C - - - - - 0x003CDF 00:FCCF: E6 F9     INC ram_00F9
C - - - - - 0x003CE1 00:FCD1: B1 F6     LDA (ram_00F6),Y
C - - - - - 0x003CE3 00:FCD3: D0 0B     BNE bra_FCE0
- - - - - - 0x003CE5 00:FCD5: A4 F9     LDY ram_00F9
- - - - - - 0x003CE7 00:FCD7: E6 F9     INC ram_00F9
- - - - - - 0x003CE9 00:FCD9: B1 F6     LDA (ram_00F6),Y
- - - - - - 0x003CEB 00:FCDB: 8D 00 07  STA ram_0700
- - - - - - 0x003CEE 00:FCDE: D0 ED     BNE bra_FCCD
bra_FCE0:
C - - - - - 0x003CF0 00:FCE0: 20 83 F9  JSR sub_F983
C - - - - - 0x003CF3 00:FCE3: 8D 03 07  STA ram_0703
...
bra_FCF4:
C - - - - - 0x003D04 00:FCF4: AC 00 07  LDY ram_0700
C - - - - - 0x003D07 00:FCF7: 20 53 F9  JSR sub_F953_set_4000_4001
bra_FCFA:
C - - - - - 0x003D0A 00:FCFA: A4 FA     LDY ram_00FA
C - - - - - 0x003D0C 00:FCFC: F0 23     BEQ bra_FD21_RTS
C - - - - - 0x003D0E 00:FCFE: CE 04 07  DEC ram_0704
C - - - - - 0x003D11 00:FD01: D0 1E     BNE bra_FD21_RTS
C - - - - - 0x003D13 00:FD03: E6 FA     INC ram_00FA
C - - - - - 0x003D15 00:FD05: B1 F6     LDA (ram_00F6),Y
C - - - - - 0x003D17 00:FD07: 20 83 F9  JSR sub_F983
C - - - - - 0x003D1A 00:FD0A: 8D 04 07  STA ram_0704
