...
C - - - - - 0x03C910 0F:C900: A4 32     LDY ram_blk_id_hi
...
C - - - - - 0x03C931 0F:C921: A5 34     LDA ram_blk_id_fr
C - - - - - 0x03C933 0F:C923: D0 EA     BNE bra_C90F
C - - - - - 0x03C935 0F:C925: F0 06     BEQ bra_C92D    ; jmp
bra_C927:
C - - - - - 0x03C937 0F:C927: A5 34     LDA ram_blk_id_fr
...
bra_C931:
C - - - - - 0x03C941 0F:C931: A5 34     LDA ram_blk_id_fr
...
sub_C95A_calculate_camera_speed:
; out
    ; ram_000A_t028_spd_Y_fr
    ; ram_000B_t009_spd_Y_lo
    ; ram_0017_t002_flag
...
bra_C964:
C - - - - - 0x03C974 0F:C964: AD 37 05  LDA ram_plr_spd_Y_fr
C - - - - - 0x03C977 0F:C967: 85 0A     STA ram_000A_t028_spd_Y_fr
C - - - - - 0x03C979 0F:C969: AD 20 05  LDA ram_plr_spd_Y_lo
C - - - - - 0x03C97C 0F:C96C: 85 0B     STA ram_000B_t009_spd_Y_lo
...
C - - - - - 0x03C99D 0F:C98D: 85 0A     STA ram_000A_t028_spd_Y_fr
C - - - - - 0x03C99F 0F:C98F: B9 31 CA  LDA tbl_CA30 + $01,Y
C - - - - - 0x03C9A2 0F:C992: 85 0B     STA ram_000B_t009_spd_Y_lo
...
C - - - - - 0x03C9B0 0F:C9A0: 85 0B     STA ram_000B_t009_spd_Y_lo
; bzk bug? ram_000A_t028_spd_Y_fr is not specified
...
C - - - - - 0x03C9BB 0F:C9AB: C5 71     CMP ram_0071_blk_config_cam_pos_hi
...
bra_C9B5:
C - - - - - 0x03C9C5 0F:C9B5: AC A4 07  LDY ram_unk_07A4
C - - - - - 0x03C9C8 0F:C9B8: D0 19     BNE bra_C9D3
C - - - - - 0x03C9CA 0F:C9BA: A9 00     LDA #$00
C - - - - - 0x03C9CC 0F:C9BC: 85 0A     STA ram_000A_t028_spd_Y_fr
C - - - - - 0x03C9CE 0F:C9BE: 85 0B     STA ram_000B_t009_spd_Y_lo
C - - - - - 0x03C9D0 0F:C9C0: EE A3 07  INC ram_unk_07A3_scroll_X
C - - - - - 0x03C9D3 0F:C9C3: AD A3 07  LDA ram_unk_07A3_scroll_X
...
C - - - - - 0x03CA0A 0F:C9FA: CE A3 07  DEC ram_unk_07A3_scroll_X
...
C - - - - - 0x03CA1A 0F:CA0A: 85 0B     STA ram_000B_t009_spd_Y_lo
C - - - - - 0x03CA1C 0F:CA0C: A9 00     LDA #$00
C - - - - - 0x03CA1E 0F:CA0E: 85 0A     STA ram_000A_t028_spd_Y_fr
C - - - - - 0x03CA20 0F:CA10: 60        RTS
bra_CA11:
C - - - - - 0x03CA21 0F:CA11: CE A3 07  DEC ram_unk_07A3_scroll_X
C - - - - - 0x03CA24 0F:CA14: D0 08     BNE bra_CA1E
C - - - - - 0x03CA26 0F:CA16: A9 00     LDA #$00
C - - - - - 0x03CA28 0F:CA18: 8D A4 07  STA ram_unk_07A4
C - - - - - 0x03CA2B 0F:CA1B: 8D A3 07  STA ram_unk_07A3_scroll_X
bra_CA1E:
C - - - - - 0x03CA2E 0F:CA1E: E6 17     INC ram_0017_t002_flag
C - - - - - 0x03CA30 0F:CA20: AD A3 07  LDA ram_unk_07A3_scroll_X
...
tbl_CA36:
; 00 
- D 2 - - - 0x03CA46 0F:CA36: 01        .byte $01   ; spd_Y_lo
- D 2 - - - 0x03CA47 0F:CA37: 01        .byte $01   ; camera movement direction (right)
; 01 
- D 2 - - - 0x03CA48 0F:CA38: FF        .byte $FF   ; spd_Y_lo
...
tbl_CA3A:
; 00 
- D 2 - - - 0x03CA4A 0F:CA3A: 02        .byte $02   ; spd_Y_lo
- D 2 - - - 0x03CA4B 0F:CA3B: 01        .byte $01   ; camera movement direction (right)
; 01 
- D 2 - - - 0x03CA4C 0F:CA3C: FE        .byte $FE   ; spd_Y_lo
...
C - - - - - 0x03CA53 0F:CA43: 85 08     STA ram_0008_t037_cam_pos_lo
...
C - - - - - 0x03CA5D 0F:CA4D: A5 08     LDA ram_0008_t037_cam_pos_lo
...
C - - - - - 0x03CA68 0F:CA58: 65 0A     ADC ram_000A_t028_spd_Y_fr
C - - - - - 0x03CA6A 0F:CA5A: 85 58     STA ram_0058
C - - - - - 0x03CA6C 0F:CA5C: A5 56     LDA ram_cam_pos_lo
C - - - - - 0x03CA6E 0F:CA5E: 65 0B     ADC ram_000B_t009_spd_Y_lo
...
C - - - - - 0x03CA7D 0F:CA6D: A5 08     LDA ram_0008_t037_cam_pos_lo
C - - - - - 0x03CA7F 0F:CA6F: 18        CLC
C - - - - - 0x03CA80 0F:CA70: 69 10     ADC #$10
C - - - - - 0x03CA82 0F:CA72: 85 08     STA ram_0008_t037_cam_pos_lo
bra_CA74:
C - - - - - 0x03CA84 0F:CA74: A5 71     LDA ram_0071_blk_config_cam_pos_hi
...
C - - - - - 0x03CAA5 0F:CA95: 65 0A     ADC ram_000A_t028_spd_Y_fr
C - - - - - 0x03CAA7 0F:CA97: 85 58     STA ram_0058
C - - - - - 0x03CAA9 0F:CA99: A5 56     LDA ram_cam_pos_lo
C - - - - - 0x03CAAB 0F:CA9B: 65 0B     ADC ram_000B_t009_spd_Y_lo
...
C - - - - - 0x03CABC 0F:CAAC: A5 08     LDA ram_0008_t037_cam_pos_lo
C - - - - - 0x03CABE 0F:CAAE: 38        SEC
C - - - - - 0x03CABF 0F:CAAF: E9 10     SBC #$10
C - - - - - 0x03CAC1 0F:CAB1: 85 08     STA ram_0008_t037_cam_pos_lo
loc_CAB3:
bra_CAB3:
...
C - - - - - 0x03CAFF 0F:CAEF: A5 08     LDA ram_0008_t037_cam_pos_lo
...
C - - - - - 0x03CB52 0F:CB42: 85 12     STA ram_0012_t004_data_index
...
C - - - - - 0x03CBAF 0F:CB9F: A4 12     LDY ram_0012_t004_data_index
...
C - - - - - 0x03CBB7 0F:CBA7: A4 12     LDY ram_0012_t004_data_index
...
C - - - - - 0x03CBBF 0F:CBAF: A4 12     LDY ram_0012_t004_data_index
...
C - - - - - 0x03CBC7 0F:CBB7: A4 12     LDY ram_0012_t004_data_index
...
C - - - - - 0x03CBCF 0F:CBBF: A4 12     LDY ram_0012_t004_data_index
...
C - - - - - 0x03CBD7 0F:CBC7: A4 12     LDY ram_0012_t004_data_index
...
C - - - - - 0x03CBDF 0F:CBCF: A4 12     LDY ram_0012_t004_data_index
...
C - - - - - 0x03CBE7 0F:CBD7: A4 12     LDY ram_0012_t004_data_index
...
; in
    ; Y = ram_0012_t004_data_index
; bzk optimize, put LDY ram_0012_t004_data_index here instead of before JSRs
...
C - - - - - 0x03CC36 0F:CC26: 20 B9 D3  JSR sub_D3B9_convert_byte
...
C - - - - - 0x03CC63 0F:CC53: 26 11     ROL ram_0011_t00F_pos_Y_lo
C - - - - - 0x03CC65 0F:CC55: 0A        ASL
C - - - - - 0x03CC66 0F:CC56: 26 11     ROL ram_0011_t00F_pos_Y_lo
C - - - - - 0x03CC68 0F:CC58: 85 10     STA ram_0010_t010_data_ptr_lo
C - - - - - 0x03CC6A 0F:CC5A: A5 11     LDA ram_0011_t00F_pos_Y_lo
C - - - - - 0x03CC6C 0F:CC5C: 29 03     AND #$03
C - - - - - 0x03CC6E 0F:CC5E: 85 11     STA ram_0011_t01F_data_ptr_hi
C - - - - - 0x03CC70 0F:CC60: A5 B6     LDA ram_00B6
C - - - - - 0x03CC72 0F:CC62: A2 10     LDX #< ram_0010_t010_data_ptr_lo
...
C - - - - - 0x03CC79 0F:CC69: A2 10     LDX #< ram_0010_t010_data_ptr_lo
...
C - - - - - 0x03CC81 0F:CC71: 65 10     ADC ram_0010_t010_data_ptr_lo
C - - - - - 0x03CC83 0F:CC73: 85 10     STA ram_0010_t010_data_ptr_lo
C - - - - - 0x03CC85 0F:CC75: A5 51     LDA ram_0050_t000_data + $01
C - - - - - 0x03CC87 0F:CC77: 65 11     ADC ram_0011_t01F_data_ptr_hi
C - - - - - 0x03CC89 0F:CC79: 85 11     STA ram_0011_t01F_data_ptr_hi
loc_CC7B:
...
C - - - - - 0x03CCE8 0F:CCD8: 20 B9 D3  JSR sub_D3B9_convert_byte
...
C - - - - - 0x03CCF5 0F:CCE5: 20 B9 D3  JSR sub_D3B9_convert_byte
...
C - - - - - 0x03CD05 0F:CCF5: 99 E0 06  STA ram_06E0_level_data,Y
...
C - - - - - 0x03CD2C 0F:CD1C: 85 04     STA ram_0004_t02E
C - - - - - 0x03CD2E 0F:CD1E: A6 1D     LDX ram_index_ppu_buffer
C - - - - - 0x03CD30 0F:CD20: A5 04     LDA ram_0004_t02E
...
C - - - - - 0x03CD48 0F:CD38: A2 10     LDX #< ram_0010_t010_data_ptr_lo
...
C - - - - - 0x03CDFB 0F:CDEB: 85 10     STA ram_0010_t011_data_ptr_lo
C - - - - - 0x03CDFD 0F:CDED: 85 11     STA ram_0011_t020_data_ptr_hi
loc_CDEF_loop:
C D 2 - - - 0x03CDFF 0F:CDEF: 88        DEY
C - - - - - 0x03CE00 0F:CDF0: 30 0A     BMI bra_CDFC
C - - - - - 0x03CE02 0F:CDF2: A9 30     LDA #$30
C - - - - - 0x03CE04 0F:CDF4: A2 10     LDX #< ram_0010_t011_data_ptr_lo
...
C - - - - - 0x03CE11 0F:CE01: A2 10     LDX #< ram_0010_t011_data_ptr_lo
...
C - - - - - 0x03CE1D 0F:CE0D: A2 10     LDX #< ram_0010_t011_data_ptr_lo
...
C - - - - - 0x03CE42 0F:CE32: 69 40     ADC #< $0140
C - - - - - 0x03CE44 0F:CE34: 85 61     STA ram_ppu_address_lo
C - - - - - 0x03CE46 0F:CE36: A5 62     LDA ram_ppu_address_hi
C - - - - - 0x03CE48 0F:CE38: 69 01     ADC #> $0140
C - - - - - 0x03CE4A 0F:CE3A: 85 62     STA ram_ppu_address_hi
bra_CE3C:
C - - - - - 0x03CE4C 0F:CE3C: A5 50     LDA ram_0050_t000_data
C - - - - - 0x03CE4E 0F:CE3E: 18        CLC
C - - - - - 0x03CE4F 0F:CE3F: 65 10     ADC ram_0010_t011_data_ptr_lo
C - - - - - 0x03CE51 0F:CE41: 85 10     STA ram_0010_t011_data_ptr_lo
C - - - - - 0x03CE53 0F:CE43: A5 51     LDA ram_0050_t000_data + $01
C - - - - - 0x03CE55 0F:CE45: 65 11     ADC ram_0011_t020_data_ptr_hi
C - - - - - 0x03CE57 0F:CE47: 85 11     STA ram_0011_t020_data_ptr_hi
loc_CE49_loop:
...
C - - - - - 0x03CE7D 0F:CE6D: 99 E0 06  STA ram_06E0_level_data,Y
...
C - - - - - 0x03CEB8 0F:CEA8: 20 B9 D3  JSR sub_D3B9_convert_byte
...
C - - - - - 0x03CEEE 0F:CEDE: 85 04     STA ram_0004_t00E_ppu_lo
...
bra_CEEE:
C - - - - - 0x03CEFE 0F:CEEE: 85 05     STA ram_0005_t01D_ppu_hi
C - - - - - 0x03CF00 0F:CEF0: A6 1D     LDX ram_index_ppu_buffer
C - - - - - 0x03CF02 0F:CEF2: A5 04     LDA ram_0004_t00E_ppu_lo
C - - - - - 0x03CF04 0F:CEF4: 9D 00 03  STA ram_ppu_buffer,X
C - - - - - 0x03CF07 0F:CEF7: E8        INX
C - - - - - 0x03CF08 0F:CEF8: A5 05     LDA ram_0005_t01D_ppu_hi
...
C - - - - - 0x03CF1E 0F:CF0E: A2 10     LDX #< ram_0010_t011_data_ptr_lo
...
C - - - - - 0x03CF4F 0F:CF3F: 84 03     STY ram_0002_t004_data + $01
...
- - - - - - 0x03CF72 0F:CF62: 85 03     STA ram_0002_t004_data + $01
...
C - - - - - 0x03CF78 0F:CF68: 84 03     STY ram_0002_t004_data + $01
...
C - - - - - 0x03CFA2 0F:CF92: 8D A3 07  STA ram_unk_07A3_scroll_X
C - - - - - 0x03CFA5 0F:CF95: 8D A4 07  STA ram_unk_07A4
...
C - - - - - 0x03D03E 0F:D02E: 85 05     STA ram_0005_t01A_hi
C - - - - - 0x03D040 0F:D030: B5 59     LDA ram_blk_section,X
C - - - - - 0x03D042 0F:D032: 29 F8     AND #$F8
C - - - - - 0x03D044 0F:D034: 0A        ASL
C - - - - - 0x03D045 0F:D035: 85 04     STA ram_0004_t00D_lo
C - - - - - 0x03D047 0F:D037: 18        CLC
C - - - - - 0x03D048 0F:D038: 65 04     ADC ram_0004_t00D_lo
C - - - - - 0x03D04A 0F:D03A: 90 03     BCC bra_D03F_not_overflow
- - - - - - 0x03D04C 0F:D03C: E6 05     INC ram_0005_t01A_hi
- - - - - - 0x03D04E 0F:D03E: 18        CLC
bra_D03F_not_overflow:
C - - - - - 0x03D04F 0F:D03F: 65 04     ADC ram_0004_t00D_lo
C - - - - - 0x03D051 0F:D041: 90 02     BCC bra_D045_not_overflow
C - - - - - 0x03D053 0F:D043: E6 05     INC ram_0005_t01A_hi
bra_D045_not_overflow:
C - - - - - 0x03D055 0F:D045: 85 04     STA ram_0004_t00D_lo
...
C - - - - - 0x03D05F 0F:D04F: 65 04     ADC ram_0004_t00D_lo
C - - - - - 0x03D061 0F:D051: 85 04     STA ram_0004_t00D_lo
C - - - - - 0x03D063 0F:D053: 90 02     BCC bra_D057_not_overflow
- - - - - - 0x03D065 0F:D055: E6 05     INC ram_0005_t01A_hi
bra_D057_not_overflow:
C - - - - - 0x03D067 0F:D057: A5 04     LDA ram_0004_t00D_lo
C - - - - - 0x03D069 0F:D059: 18        CLC
C - - - - - 0x03D06A 0F:D05A: 65 50     ADC ram_0050_t000_data
C - - - - - 0x03D06C 0F:D05C: 99 52 00  STA ram_0052,Y
C - - - - - 0x03D06F 0F:D05F: A5 05     LDA ram_0005_t01A_hi
...
C - - - - - 0x03D07E 0F:D06E: A5 32     LDA ram_blk_id_hi
C - - - - - 0x03D080 0F:D070: 0A        ASL
C - - - - - 0x03D081 0F:D071: 85 0C     STA ram_000C_t015_blk_id_hi_x2
C - - - - - 0x03D083 0F:D073: A8        TAY
C - - - - - 0x03D084 0F:D074: B9 2E D6  LDA tbl_D62E_blk_scroll_type,Y
C - - - - - 0x03D087 0F:D077: 85 08     STA ram_0008_t002_blk_scroll_type_data_ptr
C - - - - - 0x03D089 0F:D079: B9 2F D6  LDA tbl_D62E_blk_scroll_type + $01,Y
C - - - - - 0x03D08C 0F:D07C: 85 09     STA ram_0008_t002_blk_scroll_type_data_ptr + $01
C - - - - - 0x03D08E 0F:D07E: A5 33     LDA ram_blk_id_lo
C - - - - - 0x03D090 0F:D080: 0A        ASL
; bzk optimize, useless STA
C - - - - - 0x03D091 0F:D081: 85 0D     STA ram_000D_tFFF_useless
C - - - - - 0x03D093 0F:D083: A8        TAY
C - - - - - 0x03D094 0F:D084: B1 08     LDA (ram_0008_t002_blk_scroll_type_data_ptr),Y
C - - - - - 0x03D096 0F:D086: 85 0A     STA ram_000A_t005_blk_scroll_type_data
C - - - - - 0x03D098 0F:D088: C8        INY
C - - - - - 0x03D099 0F:D089: B1 08     LDA (ram_0008_t002_blk_scroll_type_data_ptr),Y
C - - - - - 0x03D09B 0F:D08B: 85 0B     STA ram_000A_t005_blk_scroll_type_data + $01
C - - - - - 0x03D09D 0F:D08D: A4 34     LDY ram_blk_id_fr
C - - - - - 0x03D09F 0F:D08F: B1 0A     LDA (ram_000A_t005_blk_scroll_type_data),Y
...
; if vertical
C - - - - - 0x03D10C 0F:D0FC: AD 20 05  LDA ram_plr_spd_Y_lo
C - - - - - 0x03D10F 0F:D0FF: 0D 37 05  ORA ram_plr_spd_Y_fr
C - - - - - 0x03D112 0F:D102: F0 0D     BEQ bra_D111
C - - - - - 0x03D114 0F:D104: AD 20 05  LDA ram_plr_spd_Y_lo
...
C - - - - - 0x03D133 0F:D123: 85 00     STA ram_0000_t037_cam_pos_lo
C - - - - - 0x03D135 0F:D125: A5 57     LDA ram_cam_pos_hi
; * 08
C - - - - - 0x03D137 0F:D127: 06 00     ASL ram_0000_t037_cam_pos_lo
C - - - - - 0x03D139 0F:D129: 2A        ROL
C - - - - - 0x03D13A 0F:D12A: 06 00     ASL ram_0000_t037_cam_pos_lo
C - - - - - 0x03D13C 0F:D12C: 2A        ROL
C - - - - - 0x03D13D 0F:D12D: 06 00     ASL ram_0000_t037_cam_pos_lo
...
C - - - - - 0x03D155 0F:D145: 85 00     STA ram_0000_t036_cam_pos_hi
C - - - - - 0x03D157 0F:D147: A5 56     LDA ram_cam_pos_lo
; / 10
C - - - - - 0x03D159 0F:D149: 46 00     LSR ram_0000_t036_cam_pos_hi
C - - - - - 0x03D15B 0F:D14B: 6A        ROR
C - - - - - 0x03D15C 0F:D14C: 46 00     LSR ram_0000_t036_cam_pos_hi
C - - - - - 0x03D15E 0F:D14E: 6A        ROR
C - - - - - 0x03D15F 0F:D14F: 46 00     LSR ram_0000_t036_cam_pos_hi
...
C - - - - - 0x03D16E 0F:D15E: A5 71     LDA ram_0071_blk_config_cam_pos_hi
; * 08
...
bra_D16D:
C - - - - - 0x03D17D 0F:D16D: A5 71     LDA ram_0071_blk_config_cam_pos_hi
; * 08
...
C - - - - - 0x03D1C5 0F:D1B5: 85 10     STA ram_0010_t002_data
C - - - - - 0x03D1C7 0F:D1B7: B5 53     LDA ram_0053,X
C - - - - - 0x03D1C9 0F:D1B9: 85 11     STA ram_0010_t002_data + $01
...
C - - - - - 0x03D227 0F:D217: 85 10     STA ram_0010_t025
...
C - - - - - 0x03D230 0F:D220: A4 10     LDY ram_0010_t025
C - - - - - 0x03D232 0F:D222: A9 00     LDA #$00
C - - - - - 0x03D234 0F:D224: 99 E0 06  STA ram_06E0_level_data,Y
C - - - - - 0x03D237 0F:D227: E6 10     INC ram_0010_t025
...
C - - - - - 0x03D28E 0F:D27E: 84 07     STY ram_0007_t018
...
C - - - - - 0x03D299 0F:D289: 20 B9 D3  JSR sub_D3B9_convert_byte
...
C - - - - - 0x03D2A1 0F:D291: 85 11     STA ram_0011_t01D
C - - - - - 0x03D2A3 0F:D293: BD FE 02  LDA ram_ppu_buffer - $02,X
C - - - - - 0x03D2A6 0F:D296: 20 B9 D3  JSR sub_D3B9_convert_byte
C - - - - - 0x03D2A9 0F:D299: 98        TYA
C - - - - - 0x03D2AA 0F:D29A: 05 11     ORA ram_0011_t01D
C - - - - - 0x03D2AC 0F:D29C: A4 10     LDY ram_0010_t025
C - - - - - 0x03D2AE 0F:D29E: 99 E0 06  STA ram_06E0_level_data,Y
C - - - - - 0x03D2B1 0F:D2A1: E6 10     INC ram_0010_t025
bra_D2A3:
C - - - - - 0x03D2B3 0F:D2A3: A4 07     LDY ram_0007_t018
...
C - - - - - 0x03D337 0F:D327: 85 08     STA ram_0008_t035_cam_pos_lo
...
C - - - - - 0x03D343 0F:D333: E5 08     SBC ram_0008_t035_cam_pos_lo
...
C - - - - - 0x03D353 0F:D343: 6D 09 05  ADC ram_plr_spd_X_fr
C - - - - - 0x03D356 0F:D346: 85 58     STA ram_0058
C - - - - - 0x03D358 0F:D348: A5 56     LDA ram_cam_pos_lo
C - - - - - 0x03D35A 0F:D34A: 6D F2 04  ADC ram_plr_spd_X_lo
...
bra_D361:
C - - - - - 0x03D371 0F:D361: C5 71     CMP ram_0071_blk_config_cam_pos_hi
...
sub_D3B9_convert_byte:
; in
    ; A = byte from ppu buffer
    ; N
        ; 0 = 
        ; 1 = 
; out
    ; Y = 
C - - - - - 0x03D3C9 0F:D3B9: 30 0D     BMI bra_D3C8_80_FF
; 00-7F
...
C - - - - - 0x03D419 0F:D409: 84 00     STY ram_0000_tFF7_useless_01
C - - - - - 0x03D41B 0F:D40B: 0A        ASL
C - - - - - 0x03D41C 0F:D40C: 18        CLC
C - - - - - 0x03D41D 0F:D40D: 65 00     ADC ram_0000_tFF7_useless_01
...
C - - - - - 0x03D42A 0F:D41A: AD 20 05  LDA ram_plr_spd_Y_lo
...
C - - - - - 0x03D458 0F:D448: 85 34     STA ram_blk_id_fr
...
C - - - - - 0x03D4AB 0F:D49B: A5 32     LDA ram_blk_id_hi
...
C - - - - - 0x03D4B9 0F:D4A9: A5 33     LDA ram_blk_id_lo
...
C - - - - - 0x03D4C6 0F:D4B6: A5 34     LDA ram_blk_id_fr
C - - - - - 0x03D4C8 0F:D4B8: 0A        ASL
C - - - - - 0x03D4C9 0F:D4B9: 85 0E     STA ram_000E_t014_blk_id_fr_x2
...
C - - - - - 0x03D4EF 0F:D4DF: 85 0F     STA ram_000F_t00B_ppu_hi
C - - - - - 0x03D4F1 0F:D4E1: B9 61 D5  LDA tbl_D55E + $03,Y
C - - - - - 0x03D4F4 0F:D4E4: 85 0E     STA ram_000E_t001_ppu_lo
...
C - - - - - 0x03D507 0F:D4F7: 65 0E     ADC ram_000E_t001_ppu_lo
C - - - - - 0x03D509 0F:D4F9: 85 0E     STA ram_000E_t001_ppu_lo
bra_D4FB_loop:
C - - - - - 0x03D50B 0F:D4FB: B9 63 D5  LDA tbl_D55E + $05,Y
C - - - - - 0x03D50E 0F:D4FE: C8        INY
C - - - - - 0x03D50F 0F:D4FF: 84 09     STY ram_0009_t012_table_index
...
C - - - - - 0x03D544 0F:D534: A5 0E     LDA ram_000E_t001_ppu_lo
C - - - - - 0x03D546 0F:D536: 9D 00 03  STA ram_ppu_buffer,X
C - - - - - 0x03D549 0F:D539: E8        INX
C - - - - - 0x03D54A 0F:D53A: A5 0F     LDA ram_000F_t00B_ppu_hi
...
C - - - - - 0x03D55C 0F:D54C: A2 0E     LDX #< ram_000E_t001_ppu_lo
C - - - - - 0x03D55E 0F:D54E: 20 99 E8  JSR sub_E899_increase_indirect_address
C - - - - - 0x03D561 0F:D551: A4 09     LDY ram_0009_t012_table_index
...
.export sub_0x03E323_write_chr_banks___7F_5120_5121_5122_5123
.export sub_0x03E332_write_chr_banks___7F_5120_5121
.export sub_0x03E33D_write_chr_banks___7F_5128_5129_512A_512B
.export sub_0x03E34C_write_chr_banks___5120_5121_5122_5123_5125
.export loc_0x03E34C_write_chr_banks___5120_5121_5122_5123_5125
.export sub_0x03E352_write_chr_banks___5122_5123_5125
.export loc_0x03E352_write_chr_banks___5122_5123_5125
.export sub_0x03E362_write_chr_banks___5120_5121
.export sub_0x03E36D_write_chr_banks___5124_5126_5127_5128_5129_512A_512B
.export loc_0x03E36D_write_chr_banks___5124_5126_5127_5128_5129_512A_512B
.export sub_0x03E37D_write_chr_banks___5126_5129_512A
...
.export sub_0x03E666_decrease_blk_timer
.export sub_0x03E676
.export sub_0x03E687
.export sub_0x03E694
.export sub_0x03E69F
...
.export sub_0x03E7BB_calculate_weapon_drop
.export sub_0x03E7C6
.export sub_0x03E7D1_kill_enemy
.export sub_0x03E7DC_add_points_for_killing
.export sub_0x03E7EC
.export sub_0x03E7FC
.export loc_0x03E7FC
...
.export sub_0x03EABF_get_tiles_for_2x2_block___1
.export sub_0x03EACE_get_tiles_for_2x2_block___2
...
.export sub_0x03EB96
.export sub_0x03EBA0_read_nametable_attribute
.export sub_0x03EBAC_read_byte_from_blk_data
.export sub_0x03EBE5_draw_screen
.export sub_0x03EBF0_draw_screen
...
.export sub_0x03EF70
.export sub_0x03EF7E_object_animation_handler
.export loc_0x03EF7E_object_animation_handler
.export sub_0x03EF83_player_animation_handler
.export loc_0x03EF83_player_animation_handler
.export sub_0x03EF85_object_animation_handler
.export loc_0x03EF85_object_animation_handler
.export sub_0x03EF8B_object_animation_handler
...
.export sub_0x03FBF8
.export sub_0x03FC26_check_tile
.export sub_0x03FC2E_check_for_reaching_position
.export loc_0x03FC2E_check_for_reaching_position
.export sub_0x03FCED
.export tbl_0x03FD5C
.export tbl_0x03FD68
.export tbl_0x03FD71
.export tbl_0x03FD91_speed_fr
.export tbl_0x03FDD2
.export sub_0x03FEAC
.export sub_0x03FEC9_find_empty_object_slot_01_0C
.export loc_0x03FEC9_find_empty_object_slot_01_0C
.export sub_0x03FED8_clear_XY_speed
.export loc_0x03FED8_clear_XY_speed
...
; 02
C - - - - - 0x03E306 0F:E2F6: 20 19 E3  JSR sub_E319_write_chr_banks___7F_5122_5123
C - - - - - 0x03E309 0F:E2F9: 4C 05 E3  JMP loc_E305_write_chr_banks___41_5129___42_5126_512A
bra_E2FC_00:
C - - - - - 0x03E30C 0F:E2FC: 20 3C E3  JSR sub_E33C_write_chr_banks___5120_5121_5122_5123_5125
C - - - - - 0x03E30F 0F:E2FF: 4C 5D E3  JMP loc_E35D_write_chr_banks___5124_5126_5127_5128_5129_512A_512B
bra_E302_03:
C - - - - - 0x03E312 0F:E302: 20 3C E3  JSR sub_E33C_write_chr_banks___5120_5121_5122_5123_5125
loc_E305_write_chr_banks___41_5129___42_5126_512A:
bra_E305_01:
...
sub_0x03E323_write_chr_banks___7F_5120_5121_5122_5123:
C - - - - - 0x03E323 0F:E313: 20 19 E3  JSR sub_E319_write_chr_banks___7F_5122_5123
C - - - - - 0x03E326 0F:E316: 4C 22 E3  JMP loc_E322_write_chr_banks___7F_5120_5121



sub_E319_write_chr_banks___7F_5122_5123:
...
loc_E322_write_chr_banks___7F_5120_5121:
sub_0x03E332_write_chr_banks___7F_5120_5121:
C D 3 - - - 0x03E332 0F:E322: A9 7F     LDA #con_chr_bank_spr + $7F
C - - - - - 0x03E334 0F:E324: 8D 20 51  STA $5120
; bzk optimize, loading the same A
; however that could also be for timing purposes
...
sub_0x03E33D_write_chr_banks___7F_5128_5129_512A_512B:
...
sub_E33C_write_chr_banks___5120_5121_5122_5123_5125:
sub_0x03E34C_write_chr_banks___5120_5121_5122_5123_5125:
loc_0x03E34C_write_chr_banks___5120_5121_5122_5123_5125:
C D 3 - - - 0x03E34C 0F:E33C: 20 42 E3  JSR sub_E342_write_chr_banks___5122_5123_5125
C - - - - - 0x03E34F 0F:E33F: 4C 52 E3  JMP loc_E352_write_chr_banks___5120_5121



sub_E342_write_chr_banks___5122_5123_5125:
sub_0x03E352_write_chr_banks___5122_5123_5125:
loc_0x03E352_write_chr_banks___5122_5123_5125:
...
loc_E352_write_chr_banks___5120_5121:
sub_0x03E362_write_chr_banks___5120_5121:
...
loc_E35D_write_chr_banks___5124_5126_5127_5128_5129_512A_512B:
sub_0x03E36D_write_chr_banks___5124_5126_5127_5128_5129_512A_512B:
loc_0x03E36D_write_chr_banks___5124_5126_5127_5128_5129_512A_512B:
...
sub_0x03E37D_write_chr_banks___5126_5129_512A:
...
; 03
C - - - - - 0x03E3FA 0F:E3EA: 20 B9 EB  JSR sub_EBB9_draw_title_screen
...
sub_0x03E666_decrease_blk_timer:
...
C - - - - - 0x03E66F 0F:E65F: 20 A3 89  JSR sub_0x0389B3_decrease_blk_timer
...
sub_0x03E7BB_calculate_weapon_drop:
C - - - - - 0x03E7BB 0F:E7AB: A9 88     LDA #con_prg_bank + $88
C - - - - - 0x03E7BD 0F:E7AD: 20 E0 E2  JSR sub_E2E0_prg_bankswitch
C - - - - - 0x03E7C0 0F:E7B0: 20 B7 B5  JSR sub_0x0135C7_calculate_weapon_drop
...
C - - - - - 0x03E7E5 0F:E7D5: 20 11 B7  JSR sub_0x013721_add_points_for_killing
...
C - - - - - 0x03E80E 0F:E7FE: 9D 1C 04  STA ram_obj_pos_Y_lo,X
C - - - - - 0x03E811 0F:E801: 9D 38 04  STA ram_obj_pos_X_lo,X
C - - - - - 0x03E814 0F:E804: 9D 54 04  STA ram_obj_spr_A,X
...
; in
    ; ram_0008_t05A_number
C D 3 - - - 0x03E90C 0F:E8FC: 20 B5 E8  JSR sub_E8B5_set_buffer_mode_01
; tens
C - - - - - 0x03E90F 0F:E8FF: A5 08     LDA ram_0008_t05A_number
; / 10
...
; ones
C - - - - - 0x03E91D 0F:E90D: A5 08     LDA ram_0008_t05A_number
...
; bzk garbage
- - - - - - 0x03E93B 0F:E92B: BC 1C 04  LDY ram_obj_pos_Y_lo,X
- - - - - - 0x03E93E 0F:E92E: 84 14     STY ram_0014_t007_pos_Y_lo
- - - - - - 0x03E940 0F:E930: BC 38 04  LDY ram_obj_pos_X_lo,X
- - - - - - 0x03E943 0F:E933: 84 15     STY ram_0015_t008_pos_X_lo
...
C - - - - - 0x03E94C 0F:E93C: A5 14     LDA ram_0014_t007_pos_Y_lo
C - - - - - 0x03E94E 0F:E93E: 38        SEC
C - - - - - 0x03E94F 0F:E93F: E9 28     SBC #$28
C - - - - - 0x03E951 0F:E941: 85 14     STA ram_0014_t007_pos_Y_lo
...
C - - - - - 0x03E95B 0F:E94B: 65 14     ADC ram_0014_t007_pos_Y_lo
...
C - - - - - 0x03E98E 0F:E97E: A5 15     LDA ram_0015_t008_pos_X_lo
; / 20
...
C - - - - - 0x03E9CE 0F:E9BE: A5 0E     LDA ram_000E_t014_blk_id_fr_x2
C - - - - - 0x03E9D0 0F:E9C0: 85 11     STA ram_0011_t004
C - - - - - 0x03E9D2 0F:E9C2: A5 0F     LDA ram_000F_t015
C - - - - - 0x03E9D4 0F:E9C4: 85 10     STA ram_0010_t00B
C - - - - - 0x03E9D6 0F:E9C6: 20 20 EA  JSR sub_EA20
C - - - - - 0x03E9D9 0F:E9C9: AD 1C 04  LDA ram_plr_pos_Y_lo
...
C - - - - - 0x03E9EC 0F:E9DC: BD 38 04  LDA ram_obj_pos_X_lo,X
...
C - - - - - 0x03E9FD 0F:E9ED: BD 1C 04  LDA ram_obj_pos_Y_lo,X
...
C - - - - - 0x03EA1B 0F:EA0B: A5 32     LDA ram_blk_id_hi
...
C - - - - - 0x03EA4D 0F:EA3D: A5 32     LDA ram_blk_id_hi
...
C - - - - - 0x03EA5B 0F:EA4B: A5 33     LDA ram_blk_id_lo
...
C - - - - - 0x03EA68 0F:EA58: A5 34     LDA ram_blk_id_fr
...
C - - - - - 0x03EA9C 0F:EA8C: 20 29 EB  JSR sub_EB29_calculate_data_index
C - - - - - 0x03EA9F 0F:EA8F: A4 11     LDY ram_0011_t00C_data_index
C - - - - - 0x03EAA1 0F:EA91: B1 00     LDA (ram_0000_t00E_nmt_attr_index_data),Y
C - - - - - 0x03EAA3 0F:EA93: 85 11     STA ram_0011_t00D_nmt_attr_data_index
C - - - - - 0x03EAA5 0F:EA95: A5 32     LDA ram_blk_id_hi
...
C - - - - - 0x03EAB3 0F:EAA3: A4 11     LDY ram_0011_t00D_nmt_attr_data_index
...
sub_0x03EABF_get_tiles_for_2x2_block___1:
; in
    ; ram_0009_t011
; out
    ; ram_0010_t012_2x2_block
...
; bzk optimize, useless STA
C - - - - - 0x03EAC9 0F:EAB9: 85 0F     STA ram_000F_tFFF_useless
C - - - - - 0x03EACB 0F:EABB: 4C CA EA  JMP loc_EACA_get_2x2_block



sub_0x03EACE_get_tiles_for_2x2_block___2:
; in
    ; ram_0009_t011
; out
    ; ram_0010_t012_2x2_block
C - - - - - 0x03EACE 0F:EABE: 20 50 EB  JSR sub_EB50_prg_bank_8C_or_8E
C - - - - - 0x03EAD1 0F:EAC1: 20 29 EB  JSR sub_EB29_calculate_data_index
C - - - - - 0x03EAD4 0F:EAC4: A4 11     LDY ram_0011_t00C_data_index
C - - - - - 0x03EAD6 0F:EAC6: B1 00     LDA (ram_0000_t01A_nmt_attr_index_data),Y
C - - - - - 0x03EAD8 0F:EAC8: 85 11     STA ram_0011_t00A_pointer_lo
loc_EACA_get_2x2_block:
; in
    ; ram_0011_t00A_pointer_lo
...
C - - - - - 0x03EAEA 0F:EADA: A5 32     LDA ram_blk_id_hi
...
C - - - - - 0x03EAF8 0F:EAE8: A4 09     LDY ram_0009_t011
C - - - - - 0x03EAFA 0F:EAEA: B9 21 EB  LDA tbl_EB21,Y
; bzk optimize, add directly to 0011, without 0009
C - - - - - 0x03EAFD 0F:EAED: 85 09     STA ram_0009_t02A
C - - - - - 0x03EAFF 0F:EAEF: A5 11     LDA ram_0011_t00A_pointer_lo
C - - - - - 0x03EB01 0F:EAF1: 18        CLC
C - - - - - 0x03EB02 0F:EAF2: 65 09     ADC ram_0009_t02A
...
C - - - - - 0x03EB1D 0F:EB0D: 85 09     STA ram_0009_t002_loop_counter
bra_EB0F_loop:
C - - - - - 0x03EB1F 0F:EB0F: BC 25 EB  LDY tbl_EB25_index,X
C - - - - - 0x03EB22 0F:EB12: B1 00     LDA (ram_0000_t00D_data),Y
C - - - - - 0x03EB24 0F:EB14: 95 10     STA ram_0010_t012_2x2_block,X ; 0010 0011 0012 0013 
C - - - - - 0x03EB26 0F:EB16: E8        INX
C - - - - - 0x03EB27 0F:EB17: C6 09     DEC ram_0009_t002_loop_counter
...
sub_EB29_calculate_data_index:
; out
    ; ram_0011_t00C_data_index
C - - - - - 0x03EB39 0F:EB29: BD 38 04  LDA ram_obj_pos_X_lo,X
C - - - - - 0x03EB3C 0F:EB2C: 18        CLC
C - - - - - 0x03EB3D 0F:EB2D: 65 56     ADC ram_cam_pos_lo
C - - - - - 0x03EB3F 0F:EB2F: 85 11     STA ram_0011_t00C_data_index
; bzk optimize, useless LDA + ADC + STA
C - - - - - 0x03EB41 0F:EB31: A5 57     LDA ram_cam_pos_hi
C - - - - - 0x03EB43 0F:EB33: 69 00     ADC #$00
C - - - - - 0x03EB45 0F:EB35: 85 10     STA ram_0010_tFFD_useless
C - - - - - 0x03EB47 0F:EB37: A5 11     LDA ram_0011_t00C_data_index
; / 20
...
C - - - - - 0x03EB4E 0F:EB3E: 85 11     STA ram_0011_t00C_data_index
C - - - - - 0x03EB50 0F:EB40: BD 1C 04  LDA ram_obj_pos_Y_lo,X
...
C - - - - - 0x03EB5B 0F:EB4B: 65 11     ADC ram_0011_t00C_data_index
; bzk optimize, TAY,
; also delete LDY after JSRs to here
C - - - - - 0x03EB5D 0F:EB4D: 85 11     STA ram_0011_t00C_data_index
...
sub_0x03EBA0_read_nametable_attribute:
C - - - - - 0x03EBA0 0F:EB90: 20 AA EB  JSR sub_EBAA_prg_bankswitch_8E_or_90
C - - - - - 0x03EBA3 0F:EB93: A4 00     LDY ram_0000_t079
C - - - - - 0x03EBA5 0F:EB95: B1 02     LDA (ram_0002_t008_data),Y
C - - - - - 0x03EBA7 0F:EB97: 85 16     STA ram_0016_t00A_nametable_attribute
...
C - - - - - 0x03EBD3 0F:EBC3: 20 D5 EB  JSR sub_EBD5_draw_screen
...
C - - - - - 0x03EC05 0F:EBF5: A2 00     LDX #< ram_0000_t000_data
C - - - - - 0x03EC07 0F:EBF7: 20 2E EC  JSR sub_EC2E_draw_screen
C - - - - - 0x03EC0A 0F:EBFA: 4C DB EB  JMP loc_EBDB_restore_prg_basnk
...
sub_EC2E_draw_screen:
; in
    ; X = offset for 0x03EC64
    ; ram_0000_t000_data
...
C - - - - - 0x03EC5D 0F:EC4D: D0 F4     BNE bra_EC43_loop   ; JMP
bra_EC4F_enough:
...
sub_0x03EF7E_object_animation_handler:
loc_0x03EF7E_object_animation_handler:
C D 3 - - - 0x03EF7E 0F:EF6E: 20 5C EF  JSR sub_EF5C_prepare_animation
C - - - - - 0x03EF81 0F:EF71: D0 02     BNE bra_EF75    ; jmp



loc_EF73_player_animation_handler:
sub_0x03EF83_player_animation_handler:
loc_0x03EF83_player_animation_handler:
C D 3 - - - 0x03EF83 0F:EF73: A2 00     LDX #$00
bra_EF75:
sub_EF75_object_animation_handler:
sub_0x03EF85_object_animation_handler:
loc_0x03EF85_object_animation_handler:
; in
    ; X = object index
...
bra_EF7B:
sub_0x03EF8B_object_animation_handler:
; in
    ; X = object index
C - - - - - 0x03EF8B 0F:EF7B: BC 8C 04  LDY ram_obj_type,X
C - - - - - 0x03EF8E 0F:EF7E: B9 B4 EF  LDA tbl_EFB4_animation_data,Y
C - - - - - 0x03EF91 0F:EF81: 85 08     STA ram_0008_t000_animation_data
C - - - - - 0x03EF93 0F:EF83: B9 B5 EF  LDA tbl_EFB4_animation_data + $01,Y
C - - - - - 0x03EF96 0F:EF86: 85 09     STA ram_0008_t000_animation_data + $01
...
C - - - - - 0x03EFA1 0F:EF91: B1 08     LDA (ram_0008_t000_animation_data),Y
...
C - - - - - 0x03EFAB 0F:EF9B: B1 08     LDA (ram_0008_t000_animation_data),Y
...
C - - - - - 0x03EFBA 0F:EFAA: D1 08     CMP (ram_0008_t000_animation_data),Y
...
tbl_EFB4_animation_data:
tbl_0x03EFC4_animation_data_0A: ; Y = 0A
...
C - - - - - 0x03F54E 0F:F53E: 20 9D AF  JSR sub_0x00AFAD_object_slots_1A_1B
...
C - - - - - 0x03F569 0F:F559: 4C 0C 80  JMP loc_0x00801C_object_handler_79_8F
bra_F55C_RTS:
...
C - - - - - 0x03F5FA 0F:F5EA: 20 9D AF  JSR sub_0x00AFAD_object_slots_1A_1B
...
; bzk optimize, JMP
C - - - - - 0x03F615 0F:F605: 20 0C 80  JSR sub_0x00801C_object_handler_79_8F
bra_F608_RTS:
...
C - - - - - 0x03F6B1 0F:F6A1: A9 4D     LDA #con_sfx_4D
...
C - - - - - 0x03F722 0F:F712: 8C 38 04  STY ram_plr_pos_X_lo
bra_F715:
...
C - - - - - 0x03F7AC 0F:F79C: A9 6A     LDA #con_music_pressure
...
C - - - - - 0x03F80F 0F:F7FF: 20 9D AF  JSR sub_0x00AFAD_object_slots_1A_1B
...
; bzk optimize, JMP
C - - - - - 0x03F82A 0F:F81A: 20 0C 80  JSR sub_0x00801C_object_handler_79_8F
bra_F81D_RTS:
...
C - - - - - 0x03F924 0F:F914: 20 9D AF  JSR sub_0x00AFAD_object_slots_1A_1B
...
C - - - - - 0x03F93F 0F:F92F: 20 0C 80  JSR sub_0x00801C_object_handler_79_8F
...
C - - - - - 0x03FA0B 0F:F9FB: A9 0C     LDA #con_sfx_door
...
C - - - - - 0x03FA18 0F:FA08: A2 13     LDX #con_obj_index_weapon
...
C - - - - - 0x03FA22 0F:FA12: 9D 54 04  STA ram_obj_spr_A,X
C - - - - - 0x03FA25 0F:FA15: 9D 70 04  STA ram_obj_flags,X ; con_obj_flag_00
C - - - - - 0x03FA28 0F:FA18: AD 1C 04  LDA ram_plr_pos_Y_lo
C - - - - - 0x03FA2B 0F:FA1B: 69 08     ADC #$08
C - - - - - 0x03FA2D 0F:FA1D: 29 F0     AND #$F0
C - - - - - 0x03FA2F 0F:FA1F: 9D 1C 04  STA ram_obj_pos_Y_lo,X
...
C - - - - - 0x03FA39 0F:FA29: 9D 38 04  STA ram_obj_pos_X_lo,X
...
C - - - - - 0x03FA49 0F:FA39: AD 1C 04  LDA ram_plr_pos_Y_lo
C - - - - - 0x03FA4C 0F:FA3C: 38        SEC
C - - - - - 0x03FA4D 0F:FA3D: F9 91 FA  SBC tbl_FA91_pos_Y_lo,Y
; * 04
...
C - - - - - 0x03FA86 0F:FA76: 8D EB 05  STA ram_05D8_wpn + con_obj_index_weapon
C - - - - - 0x03FA89 0F:FA79: A5 61     LDA ram_ppu_address_lo
C - - - - - 0x03FA8B 0F:FA7B: 8D D4 05  STA ram_05C1_wpn + con_obj_index_weapon
...
bra_FAA9:
C - - - - - 0x03FAB9 0F:FAA9: A2 13     LDX #con_obj_index_weapon
C - - - - - 0x03FABB 0F:FAAB: 20 75 EF  JSR sub_EF75_object_animation_handler
...
C - - - - - 0x03FAD1 0F:FAC1: A2 13     LDX #con_obj_index_weapon
...
; if right
C - - - - - 0x03FADD 0F:FACD: AD 38 04  LDA ram_plr_pos_X_lo
C - - - - - 0x03FAE0 0F:FAD0: 18        CLC
C - - - - - 0x03FAE1 0F:FAD1: 69 01     ADC #$01
C - - - - - 0x03FAE3 0F:FAD3: D0 06     BNE bra_FADB
bra_FAD5_left:
C - - - - - 0x03FAE5 0F:FAD5: AD 38 04  LDA ram_plr_pos_X_lo
C - - - - - 0x03FAE8 0F:FAD8: 38        SEC
C - - - - - 0x03FAE9 0F:FAD9: E9 01     SBC #$01
bra_FADB:
C - - - - - 0x03FAEB 0F:FADB: 8D 38 04  STA ram_plr_pos_X_lo
C - - - - - 0x03FAEE 0F:FADE: 4C 73 EF  JMP loc_EF73_player_animation_handler



ofs_003_FAE1_06_close_door:
C - - J - - 0x03FAF1 0F:FAE1: A2 13     LDX #con_obj_index_weapon
...
C - - - - - 0x03FB05 0F:FAF5: A9 0C     LDA #con_sfx_door
...
C - - - - - 0x03FB47 0F:FB37: A5 71     LDA ram_0071_blk_config_cam_pos_hi
...
C - - - - - 0x03FB9E 0F:FB8E: 8D 88 04  STA ram_obj_flags + con_obj_index_18
C - - - - - 0x03FBA1 0F:FB91: 8D 89 04  STA ram_obj_flags + con_obj_index_19
...
C - - - - - 0x03FC05 0F:FBF5: A5 10     LDA ram_0010_t01D_pos_X_lo
C - - - - - 0x03FC07 0F:FBF7: 18        CLC
C - - - - - 0x03FC08 0F:FBF8: 7D 38 04  ADC ram_obj_pos_X_lo,X
C - - - - - 0x03FC0B 0F:FBFB: 85 10     STA ram_0010_t01D_pos_X_lo
C - - - - - 0x03FC0D 0F:FBFD: 98        TYA
C - - - - - 0x03FC0E 0F:FBFE: 18        CLC
C - - - - - 0x03FC0F 0F:FBFF: 7D 1C 04  ADC ram_obj_pos_Y_lo,X
C - - - - - 0x03FC12 0F:FC02: 38        SEC
C - - - - - 0x03FC13 0F:FC03: E9 33     SBC #$33
C - - - - - 0x03FC15 0F:FC05: 85 11     STA ram_0011_t014_cam_pos_lo
...
bra_FC0F:
C - - - - - 0x03FC1F 0F:FC0F: 85 13     STA ram_0013_t007
C - - - - - 0x03FC21 0F:FC11: A4 10     LDY ram_0010_t01D_pos_X_lo
C - - - - - 0x03FC23 0F:FC13: 4C A1 FC  JMP loc_FCA1



sub_0x03FC26_check_tile:
; in
    ; Y = 
; out
    ; A
    ; Z
        ; 0 = 
        ; 1 = 
C - - - - - 0x03FC26 0F:FC16: 84 10     STY ram_0010_t030
C - - - - - 0x03FC28 0F:FC18: A8        TAY
C - - - - - 0x03FC29 0F:FC19: A5 10     LDA ram_0010_t030
C - - - - - 0x03FC2B 0F:FC1B: 4C ED FC  JMP loc_FCED



sub_0x03FC2E_check_for_reaching_position:
loc_0x03FC2E_check_for_reaching_position:
; in
    ; A = pos_X_lo
    ; Y = pos_Y_lo
; out
    ...
    ; Z
        ; 0 = has reached
        ; 1 = hasn't reached yet
C D 3 - - - 0x03FC2E 0F:FC1E: 85 10     STA ram_0010_t01D_pos_X_lo
C - - - - - 0x03FC30 0F:FC20: A5 68     LDA ram_blk_scroll_type
C - - - - - 0x03FC32 0F:FC22: 30 D1     BMI bra_FBF5_vertical
; if horisontal
C - - - - - 0x03FC34 0F:FC24: A5 10     LDA ram_0010_t01D_pos_X_lo
...
bra_FC30:
C - - - - - 0x03FC40 0F:FC30: 85 05     STA ram_0005_t012_pos_Y_lo
...
C - - - - - 0x03FC49 0F:FC39: BD 38 04  LDA ram_obj_pos_X_lo,X
...
bra_FC46:
C - - - - - 0x03FC56 0F:FC46: 85 11     STA ram_0011_t00F_pos_Y_lo
C - - - - - 0x03FC58 0F:FC48: A5 10     LDA ram_0010_t01D_pos_X_lo
C - - - - - 0x03FC5A 0F:FC4A: 18        CLC
C - - - - - 0x03FC5B 0F:FC4B: 7D 38 04  ADC ram_obj_pos_X_lo,X
C - - - - - 0x03FC5E 0F:FC4E: 85 10     STA ram_0010_t01D_pos_X_lo
C - - - - - 0x03FC60 0F:FC50: A5 11     LDA ram_0011_t00F_pos_Y_lo
C - - - - - 0x03FC62 0F:FC52: 65 05     ADC ram_0005_t012_pos_Y_lo
C - - - - - 0x03FC64 0F:FC54: 85 14     STA ram_0014_t002
C - - - - - 0x03FC66 0F:FC56: 98        TYA
C - - - - - 0x03FC67 0F:FC57: 18        CLC
C - - - - - 0x03FC68 0F:FC58: 7D 1C 04  ADC ram_obj_pos_Y_lo,X
...
C - - - - - 0x03FC74 0F:FC64: 85 11     STA ram_0011_t00F_pos_Y_lo
; / 10
C - - - - - 0x03FC76 0F:FC66: 46 11     LSR ram_0011_t00F_pos_Y_lo
C - - - - - 0x03FC78 0F:FC68: 46 11     LSR ram_0011_t00F_pos_Y_lo
C - - - - - 0x03FC7A 0F:FC6A: 46 11     LSR ram_0011_t00F_pos_Y_lo
C - - - - - 0x03FC7C 0F:FC6C: 46 11     LSR ram_0011_t00F_pos_Y_lo
C - - - - - 0x03FC7E 0F:FC6E: A5 56     LDA ram_cam_pos_lo
C - - - - - 0x03FC80 0F:FC70: 18        CLC
C - - - - - 0x03FC81 0F:FC71: 65 10     ADC ram_0010_t01D_pos_X_lo
C - - - - - 0x03FC83 0F:FC73: 85 13     STA ram_0013_t003
C - - - - - 0x03FC85 0F:FC75: A5 57     LDA ram_cam_pos_hi
C - - - - - 0x03FC87 0F:FC77: 65 14     ADC ram_0014_t002
...
C - - - - - 0x03FC91 0F:FC81: 6D 38 04  ADC ram_plr_pos_X_lo
C - - - - - 0x03FC94 0F:FC84: A8        TAY
; bzk optimize, useless STA
C - - - - - 0x03FC95 0F:FC85: 85 13     STA ram_0013_tFFF_useless
C - - - - - 0x03FC97 0F:FC87: 8A        TXA
C - - - - - 0x03FC98 0F:FC88: 18        CLC
C - - - - - 0x03FC99 0F:FC89: 6D 1C 04  ADC ram_plr_pos_Y_lo
C - - - - - 0x03FC9C 0F:FC8C: C5 D0     CMP ram_00D0_pos_X_lo
C - - - - - 0x03FC9E 0F:FC8E: 90 EC     BCC bra_FC7C
C - - - - - 0x03FCA0 0F:FC90: 38        SEC
C - - - - - 0x03FCA1 0F:FC91: E9 33     SBC #$33
C - - - - - 0x03FCA3 0F:FC93: 85 11     STA ram_0011_t014_cam_pos_lo
...
bra_FC9D:
C - - - - - 0x03FCAD 0F:FC9D: 85 13     STA ram_0013_t007
C - - - - - 0x03FCAF 0F:FC9F: 84 10     STY ram_0010_t01D_pos_X_lo
loc_FCA1:
...
C - - - - - 0x03FCB7 0F:FCA7: 85 12     STA ram_0012_t00A
C - - - - - 0x03FCB9 0F:FCA9: A5 13     LDA ram_0013_t007
C - - - - - 0x03FCBB 0F:FCAB: 30 0D     BMI bra_FCBA
C - - - - - 0x03FCBD 0F:FCAD: 18        CLC
C - - - - - 0x03FCBE 0F:FCAE: A5 56     LDA ram_cam_pos_lo
C - - - - - 0x03FCC0 0F:FCB0: 65 11     ADC ram_0011_t014_cam_pos_lo
...
C - - - - - 0x03FCCD 0F:FCBD: 65 11     ADC ram_0011_t014_cam_pos_lo
...
C - - - - - 0x03FCE2 0F:FCD2: 65 12     ADC ram_0012_t00A
C - - - - - 0x03FCE4 0F:FCD4: A8        TAY
C - - - - - 0x03FCE5 0F:FCD5: A5 10     LDA ram_0010_t01D_pos_X_lo
...
C - - - - - 0x03FCF4 0F:FCE4: 6D 38 04  ADC ram_plr_pos_X_lo
C - - - - - 0x03FCF7 0F:FCE7: A8        TAY
C - - - - - 0x03FCF8 0F:FCE8: 8A        TXA
C - - - - - 0x03FCF9 0F:FCE9: 18        CLC
C - - - - - 0x03FCFA 0F:FCEA: 6D 1C 04  ADC ram_plr_pos_Y_lo
loc_FCED:
...
C - - - - - 0x03FD06 0F:FCF6: 85 11     STA ram_0011_t00F_pos_Y_lo
C - - - - - 0x03FD08 0F:FCF8: 84 10     STY ram_0010_t018_pos_X_lo
; / 10
C - - - - - 0x03FD0A 0F:FCFA: 46 11     LSR ram_0011_t00F_pos_Y_lo
C - - - - - 0x03FD0C 0F:FCFC: 46 11     LSR ram_0011_t00F_pos_Y_lo
C - - - - - 0x03FD0E 0F:FCFE: 46 11     LSR ram_0011_t00F_pos_Y_lo
C - - - - - 0x03FD10 0F:FD00: 46 11     LSR ram_0011_t00F_pos_Y_lo
C - - - - - 0x03FD12 0F:FD02: A5 56     LDA ram_cam_pos_lo
C - - - - - 0x03FD14 0F:FD04: 18        CLC
C - - - - - 0x03FD15 0F:FD05: 65 10     ADC ram_0010_t018_pos_X_lo
C - - - - - 0x03FD17 0F:FD07: 85 13     STA ram_0013_t003
C - - - - - 0x03FD19 0F:FD09: A5 57     LDA ram_cam_pos_hi
C - - - - - 0x03FD1B 0F:FD0B: 69 00     ADC #$00
loc_FD0D:
C D 3 - - - 0x03FD1D 0F:FD0D: 85 14     STA ram_0014_t002
C - - - - - 0x03FD1F 0F:FD0F: A8        TAY
C - - - - - 0x03FD20 0F:FD10: A5 13     LDA ram_0013_t003
; / 20
...
C - - - - - 0x03FD30 0F:FD20: 4C 1A FD  JMP loc_FD1A_loop
bra_FD23:
C - - - - - 0x03FD33 0F:FD23: A8        TAY
C - - - - - 0x03FD34 0F:FD24: B9 4C FD  LDA tbl_FD4C,Y
C - - - - - 0x03FD37 0F:FD27: 18        CLC
C - - - - - 0x03FD38 0F:FD28: 65 11     ADC ram_0011_t00F_pos_Y_lo
C - - - - - 0x03FD3A 0F:FD2A: A8        TAY
C - - - - - 0x03FD3B 0F:FD2B: A5 13     LDA ram_0013_t003
...
C - - - - - 0x03FD45 0F:FD35: B9 E0 06  LDA ram_06E0_level_data,Y
; / 10
...
C - - - - - 0x03FD53 0F:FD43: B9 E0 06  LDA ram_06E0_level_data,Y
...
bra_FE41:
C - - - - - 0x03FE51 0F:FE41: 20 F9 BC  JSR sub_0x02FD09_ai_script_handler
loc_FE44:
...
C - - - - - 0x03FE80 0F:FE70: 20 75 EF  JSR sub_EF75_object_animation_handler
bra_FE73:
loc_FE73:
...
C - - - - - 0x03FE8F 0F:FE7F: E0 13     CPX #con_obj_index_weapon
C - - - - - 0x03FE91 0F:FE81: B0 03     BCS bra_FE86_weapons
; if not weapons
...
C - - - - - 0x03FE9B 0F:FE8B: 20 EA 84  JSR sub_0x0284FA_spawners_handler
...
C - - - - - 0x03FEB6 0F:FEA6: BD 1C 04  LDA ram_obj_pos_Y_lo,X
C - - - - - 0x03FEB9 0F:FEA9: F9 83 B8  SBC tbl_0x013893_pos_Y_lo,Y
C - - - - - 0x03FEBC 0F:FEAC: A4 82     LDY ram_copy_plr_id
C - - - - - 0x03FEBE 0F:FEAE: F9 D1 B8  SBC tbl_0x0138E1_pos_Y_lo,Y
C - - - - - 0x03FEC1 0F:FEB1: 8D 1C 04  STA ram_plr_pos_Y_lo
C - - - - - 0x03FEC4 0F:FEB4: A9 9C     LDA #con_prg_bank + $9C
C - - - - - 0x03FEC6 0F:FEB6: 4C E6 E2  JMP loc_E2E6_prg_bankswitch



sub_0x03FEC9_find_empty_object_slot_01_0C:
loc_0x03FEC9_find_empty_object_slot_01_0C:
; out
    ; Z
        ; 0 = not found
        ; 1 = found
...
C - - - - - 0x03FEE0 0F:FED0: 9D 20 05  STA ram_obj_spd_Y_lo,X
C - - - - - 0x03FEE3 0F:FED3: 9D 37 05  STA ram_obj_spd_Y_fr,X
...
C - - - - - 0x03FEF2 0F:FEE2: 9D 54 04  STA ram_obj_spr_A,X
...
C - - - - - 0x03FEFD 0F:FEED: 9D 65 05  STA ram_obj_stun_timer,X
...
C - - - - - 0x03FF27 0F:FF17: BD 65 05  LDA ram_obj_stun_timer,X
...
C - - - - - 0x03FF32 0F:FF22: BD 65 05  LDA ram_obj_stun_timer,X
C - - - - - 0x03FF35 0F:FF25: 29 C0     AND #$C0
C - - - - - 0x03FF37 0F:FF27: 05 17     ORA ram_0017_t001
C - - - - - 0x03FF39 0F:FF29: 9D 65 05  STA ram_obj_stun_timer,X
...
sub_0x03FF40:
; in
    ; ram_0004_t013_pos_X_lo
    ; ram_0005_t009_pos_Y_lo
; out
    ; ram_0000_t07B
...
C - - - - - 0x03FFA6 0F:FF96: 9D 65 05  STA ram_obj_stun_timer,X
